...
llvm::Value *EmitOverflowIntrinsic(CodeGenFunction &CGF,
  ...
  if (X->getType()->isByteOrByteVectorTy())
    X = CGF.Builder.CreateByteCastToInt(X);
  if (Y->getType()->isByteOrByteVectorTy())
    Y = CGF.Builder.CreateByteCastToInt(Y);
...
RValue CodeGenFunction::emitRotate(const CallExpr *E, bool IsRotateRight) {
  ...
  if (Src->getType()->isByteOrByteVectorTy())
    Src = Builder.CreateByteCastToInt(Src);
...
RValue CodeGenFunction::EmitBuiltinExpr(const GlobalDecl GD, unsigned BuiltinID,
  ...
  case Builtin::BI__builtin_bitreverse8: {
    ...
    Value *ArgValue = EmitScalarExpr(E->getArg(0));
    Args.push_back(
      Builder.CreateByteCastToInt(ArgValue, "cast"));
    llvm::Function *F
  ...
  case Builtin::BI__builtin_elementwise_abs: {
    ...
    if (QT->isIntegerType()) {
      Value *ArgValue = EmitScalarExpr(E->getArg(0));
      if (ArgValue->getType()->isByteOrByteVectorTy())
        ArgValue = Builder.CreateByteCastToInt(ArgValue);
  ...
  case Builtin::BI__builtin_elementwise_sub_sat: {
    ...
    if (Op0->getType()->isByteOrByteVectorTy())
      Op0 = Builder.CreateByteCastToInt(Op0, "cast");
    if (Op1->getType()->isByteOrByteVectorTy())
      Op1 = Builder.CreateByteCastToInt(Op1, "cast");
  ...
  case Builtin::BI__builtin_elementwise_max: {
    ...
    if (Op1->getType()->isByteOrByteVectorTy())
      Op1 = Builder.CreateByteCastToInt(Op1);
  ...
  case Builtin::BI__builtin_annotation: {
    ...
    if (AnnVal->getType()->isByteTy())
      AnnVal = Builder.CreateByteCastToInt(AnnVal);
  ...
  case Builtin::BI__builtin_mul_overflow: {
    ...
    if (Left->getType()->isByteOrByteVectorTy())
      Left = Builder.CreateByteCastToInt(Left);
    llvm::Value *Right = EmitScalarExpr(RightArg);
    if (Right->getType()->isByteOrByteVectorTy())
      Right = Builder.CreateByteCastToInt(Right);
      ...
      if (PTy != ArgValue->getType()) {
        ...
        if (PTy->isX86_AMXTy())
          ...
          ArgValue = ArgValue->getType()->isByteOrByteVectorTy() &&
            ...
            ? Builder.CreateByteCast(ArgValue, PTy)
