  ...
  Value *EmitMul(const BinOpInfo &Ops) {
    ...
    if (Ops.LHS->getType()->isByteOrByteVectorTy() &&
      ...
      return Builder.CreateAdd(
          Builder.CreateByteCastToInt(Ops.LHS, "", /*IsExact*/ true),
          Builder.CreateByteCastToInt(Ops.RHS, "", /*IsExact*/ true), "add");
  ...
  Value *EmitAnd(const BinOpInfo &Ops) {
    if (Ops.LHS->getType()->isByteOrByteVectorTy() &&
      ...
      return Builder.CreateAnd(
        Builder.CreateByteCastToInt(Ops.LHS, "", /*IsExact*/ true),
        Builder.CreateByteCastToInt(Ops.RHS, "", /*IsExact*/ true), "and");
  ...
  Value *EmitXor(const BinOpInfo &Ops) {
    if (Ops.LHS->getType()->isByteOrByteVectorTy() &&
      ...
      return Builder.CreateXor(
        Builder.CreateByteCastToInt(Ops.LHS, "", /*IsExact*/ true),
        Builder.CreateByteCastToInt(Ops.RHS, "", /*IsExact*/ true), "xor");
  ...
  Value *EmitOr (const BinOpInfo &Ops) {
    if (Ops.LHS->getType()->isByteOrByteVectorTy() &&
      ...
      return Builder.CreateOr(
        Builder.CreateByteCastToInt(Ops.LHS, "", /*IsExact*/ true),
        Builder.CreateByteCastToInt(Ops.RHS, "", /*IsExact*/ true), "Or");
...
Value *ScalarExprEmitter::EmitConversionToBool(Value *Src, QualType SrcType) {
  ...
  if (isa<llvm::ByteType>(Src->getType()))
    Src = Builder.CreateByteCastToInt(Src, "conv", /*IsExact=*/true);
...
EmitIntegerTruncationCheckHelper(Value *Src, QualType SrcType, Value *Dst,
  ...
  if (DstTy->isByteTy(8) && !SrcTy->isByteTy(8)) {
    Check = Builder.CreateByteCastToInt(Dst, "conv", /*IsExact*/ true);
...
static llvm::Value *EmitIsNegativeTestHelper(Value *V, QualType VType,
  ...
  if (V->getType()->isByteOrByteVectorTy())
    V = Builder.CreateByteCastToInt(V, "conv", /*IsExact=*/true);
...
void CodeGenFunction::EmitBitfieldConversionCheck(Value *Src, QualType SrcType,
  ...
  if (Dst->getType()->isByteOrByteVectorTy())
    Dst = Builder.CreateByteCastToInt(Dst, "conv", /*IsExact=*/true);
  ...
  if (isa<llvm::VectorType>(SrcTy) || isa<llvm::VectorType>(DstTy)) {
    ...
    if (SrcSize == DstSize)
      return SrcTy->isByteOrByteVectorTy()
                 ? Builder.CreateByteCast(Src, DstTy, "conv", /*IsExact*/ true)
...
Value *ScalarExprEmitter::VisitShuffleVectorExpr(ShuffleVectorExpr *E) {
  ...
  if (E->getNumSubExprs() == 2) {
    ...
    if (RHS->getType()->isByteOrByteVectorTy())
      RHS = Builder.CreateByteCastToInt(RHS, "conv", true);
    Value *Mask;
...
Value *ScalarExprEmitter::VisitConvertVectorExpr(ConvertVectorExpr *E) {
  ...
  if (isa<llvm::IntegerType>(SrcEltTy)) {
    ...
    if (SrcEltTy->isFloatingPointTy())
      ...
      Res = Builder.CreateByteCastToInt(Src, "conv", /*IsExact*/ true);
        ...
        if (FixedSrcTy->getElementType() == ScalableDstTy->getElementType()) {
          ...
          if (Result->getType() != DstTy)
            Result->getType()->isByteOrByteVectorTy()
                ? Result = Builder.CreateByteCast(Result, DstTy, "", /*IsExact*/ true)
      ...
      if (auto *FixedDstTy = dyn_cast<llvm::FixedVectorType>(DstTy)) {
        ...
        if (ScalableSrcTy->getElementType()->isIntegerTy(1) &&
          ...
          Src->getType()->isByteOrByteVectorTy()
              ? Src = Builder.CreateByteCast(Src, ScalableSrcTy, "", /*IsExact*/ true)
  ...
  // Most common case by far: integer increment.
    ...
    if (CGF.SanOpts.hasOneOf(
      ...
      if (isa<llvm::ByteType>(OldTy))
        value = Builder.CreateByteCastToInt(value, "conv", /*IsExact=*/true);
...
Value *ScalarExprEmitter::VisitUnaryNot(const UnaryOperator *E) {
  ...
  if (Op->getType()->isVectorTy() && Op->getType()->getScalarType()->isByteTy(8))
    Op = Builder.CreateByteCastToInt(Op, "conv", /*IsExact*/ true);
...
Value *ScalarExprEmitter::EmitPromotedValue(Value *result,
  ...
  if (result->getType()->isByteOrByteVectorTy() && !Ty->isByteOrByteVectorTy())
    return CGF.Builder.CreateByteCast(result, Ty, "ext", /*IsExact*/ true);
...
Value *ScalarExprEmitter::EmitAdd(const BinOpInfo &op) {
  ...
  if (op.LHS->getType()->isByteOrByteVectorTy() &&
    ...
    return Builder.CreateAdd(
        Builder.CreateByteCastToInt(op.LHS, "", /*IsExact*/ true),
        Builder.CreateByteCastToInt(op.RHS, "", /*IsExact*/ true), "add");
...
Value *ScalarExprEmitter::EmitShl(const BinOpInfo &Ops) {
  ...
  if (Ops.LHS->getType() != RHS->getType()) {
    if (RHS->getType()->isByteTy())
      RHS = Builder.CreateByteCastToInt(RHS, "sh_prom", /*IsExact*/ true);
    else if (RHS->getType()->isByteOrByteVectorTy())
      RHS = Builder.CreateByteCastToInt(RHS, "", /*IsExact*/ true);
  ...
  if (Ops.LHS->getType()->isByteOrByteVectorTy() &&
    ...
    return Builder.CreateShl(
      Builder.CreateByteCastToInt(Ops.LHS, "", /*IsExact*/ true),
      Builder.CreateByteCastToInt(Ops.RHS, "", /*IsExact*/ true), "shl");
  ...
  if (Ops.Ty->hasUnsignedIntegerRepresentation()) {
    if (Ops.LHS->getType()->isByteOrByteVectorTy() &&
      ...
      return Builder.CreateLShr(
        Builder.CreateByteCastToInt(Ops.LHS, "", /*IsExact*/ true),
        Builder.CreateByteCastToInt(Ops.RHS, "", /*IsExact*/ true), "shr");
  ...
  if (const MemberPointerType *MPT = LHSTy->getAs<MemberPointerType>()) {
    ...
    if (LHSTy->isVectorType() && !E->getType()->isVectorType()) {
      ...
      if (FirstVecArg->getType()->isByteOrByteVectorTy() &&
        ...
        FirstVecArg = Builder.CreateByteCastToInt(FirstVecArg, "", /*IsExact*/ true);
      if (SecondVecArg->getType()->isByteOrByteVectorTy() &&
          !FTy->getParamType(1)->isByteOrByteVectorTy())
        SecondVecArg = Builder.CreateByteCastToInt(SecondVecArg, "", /*IsExact*/ true);
    ...
    if (BOInfo.isFixedPointOp()) {
      ...
      if (LHS->getType()->isByteOrByteVectorTy())
        LHS = Builder.CreateByteCastToInt(LHS, "", /*IsExact*/ true);
      if (RHS->getType()->isByteOrByteVectorTy())
        RHS = Builder.CreateByteCastToInt(RHS, "", /*IsExact*/ true);
...
static Value *createCastsForTypeOfSameSize(CGBuilderTy &Builder,
  ...
  if (SrcTy->isByteOrByteVectorTy() &&
    ...
    return Builder.CreateByteCast(Src, DstTy, Name, /*IsExact*/ true);
