...
#undef PPC_FAWORD_CPUID
  ...
  case PPC::BI__builtin_vsx_lxvll:
  {
    ...
    if (Op0->getType()->isByteOrByteVectorTy())
      Op0 = Builder.CreateByteCastToInt(Op0, "", true);
    Ops.push_back(Op0);
    ...
    auto StoreSubVec = [&](unsigned Width, unsigned Offset, unsigned EltNo) {
      ...
      Value *Vec = Op2->getType()->isByteOrByteVectorTy()
        ? Builder.CreateByteCast(
          Op2, llvm::FixedVectorType::get(ConvTy, NumElts), "", true)
  ...
  case PPC::BI__builtin_altivec_vclzd: {
    ...
    if (X->getType()->isByteOrByteVectorTy())
      X = Builder.CreateByteCastToInt(X, "", true);
  ...
  case PPC::BI__builtin_altivec_vinsw_elt: {
    ...
    if (Is32bit) {
      Op0 = Op0->getType()->isByteOrByteVectorTy()
        ? Builder.CreateByteCast(Op0, llvm::FixedVectorType::get(Int32Ty, 4),
                                 "", true)
        : Builder.CreateBitCast(Op0, llvm::FixedVectorType::get(Int32Ty, 4));
    } else {
      Op0 = Op0->getType()->isByteOrByteVectorTy()
        ? Builder.CreateByteCast(Op0, llvm::FixedVectorType::get(Int64Ty, 2),
                                 "", true)
        : Builder.CreateBitCast(Op0, llvm::FixedVectorType::get(Int64Ty, 2));
    }

    Value *Call = Builder.CreateCall(CGM.getIntrinsic(ID), {Op0, Op1, Op2});
    return Call->getType()->isByteOrByteVectorTy()
      ? Builder.CreateByteCast(Call, ResultType, "", true)
      : Builder.CreateBitCast(Call, ResultType);
  }
  ...
  case PPC::BI__builtin_altivec_vsubuqm: {
    ...
    Op0 = Op0->getType()->isByteOrByteVectorTy()
      ? Builder.CreateByteCast(Op0, llvm::FixedVectorType::get(Int128Ty, 1),
                               "", true)
      : Builder.CreateBitCast(Op0, llvm::FixedVectorType::get(Int128Ty, 1));
    Op1 = Op1->getType()->isByteOrByteVectorTy()
      ? Builder.CreateByteCast(Op1, llvm::FixedVectorType::get(Int128Ty, 1),
                               "", true)
  ...
  case PPC::BI__builtin_altivec_vsubcuq_c: {
    ...
    Ops.push_back(Op0->getType()->isByteOrByteVectorTy()
                     ? Builder.CreateByteCast(Op0, V1I128Ty, "", true)
                     : Builder.CreateBitCast(Op0, V1I128Ty));
    Ops.push_back(Op1->getType()->isByteOrByteVectorTy()
                     ? Builder.CreateByteCast(Op1, V1I128Ty, "", true)
  ...
  case PPC::BI__builtin_altivec_vsubecuq_c: {
    ...
    Ops.push_back(Op1->getType()->isByteOrByteVectorTy()
                     ? Builder.CreateByteCast(Op1, V1I128Ty, "", true)
                     : Builder.CreateBitCast(Op1, V1I128Ty));
    Ops.push_back(Op2->getType()->isByteOrByteVectorTy()
                     ? Builder.CreateByteCast(Op2, V1I128Ty, "", true)
  ...
  case PPC::BI__builtin_vsx_xxpermdi: {
    ...
    Op0 = Op0->getType()->isByteOrByteVectorTy()
      ...
      : Builder.CreateBitCast(Op0, llvm::FixedVectorType::get(Int64Ty, 2));
    Op1 = Op1->getType()->isByteOrByteVectorTy()
      ? Builder.CreateByteCast(Op1, llvm::FixedVectorType::get(Int64Ty, 2),
                               "", true)
      : Builder.CreateBitCast(Op1, llvm::FixedVectorType::get(Int64Ty, 2));
  ...
  case PPC::BI__builtin_vsx_xxsldwi: {
    ...
    Op0 = Op0->getType()->isByteOrByteVectorTy()
      ...
      : Builder.CreateBitCast(Op0, llvm::FixedVectorType::get(Int32Ty, 4));
    Op1 = Op1->getType()->isByteOrByteVectorTy()
      ? Builder.CreateByteCast(Op1, llvm::FixedVectorType::get(Int32Ty, 4),
                               "", true)
      : Builder.CreateBitCast(Op1, llvm::FixedVectorType::get(Int32Ty, 4));
  ...
  #include "clang/Basic/BuiltinsPPC.def"
    ...
    for (unsigned i=1; i<Ops.size(); i++) {
      if (Ops[i]->getType()->isByteOrByteVectorTy())
        Ops[i] = Builder.CreateByteCastToInt(Ops[i], "", true);
