...
#undef INTRINSIC_X86_XSAVE_ID
  ...
  case X86::BI__builtin_ia32_pmovqw512_mask: {
    if (Ops[1]->getType()->isByteOrByteVectorTy())
      Ops[1] = Builder.CreateByteCastToInt(Ops[1], "", true);
    if (Ops[2]->getType()->isByteOrByteVectorTy())
      Ops[2] = Builder.CreateByteCastToInt(Ops[2], "", true);
  ...
  case X86::BI__builtin_ia32_sqrtss_round_mask: {
    ...
    if (CC != 4) {
      ...
      if (Ops[3]->getType()->isByteTy())
        Ops[3] = Builder.CreateByteCastToInt(Ops[3], "", true);
  ...
  case X86::BI__builtin_ia32_subborrow_u64: {
    ...
    if (Ops[0]->getType()->isByteTy())
      Ops[0] = Builder.CreateByteCastToInt(Ops[0], "", true);
