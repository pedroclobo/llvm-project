...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[R:%.*]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x bfloat> [[A:%.*]] to <8 x b8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <4 x bfloat> [[B:%.*]] to <8 x b8>
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[R:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <8 x bfloat> [[A:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x bfloat> [[B:%.*]] to <16 x b8>
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__REINT_794:%.*]] = alloca <4 x bfloat>, align 8
// CHECK-NEXT:    [[__REINT1_794:%.*]] = alloca <2 x float>, align 8
// CHECK-NEXT:    store <4 x bfloat> [[B:%.*]], ptr [[__REINT_794]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load <2 x float>, ptr [[__REINT_794]], align 8
...
// CHECK-NEXT:    store <2 x float> [[LANE]], ptr [[__REINT1_794]], align 8
// CHECK-NEXT:    [[TMP4:%.*]] = load <4 x bfloat>, ptr [[__REINT1_794]], align 8
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <2 x float> [[R:%.*]] to <8 x b8>
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <4 x bfloat> [[A:%.*]] to <8 x b8>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <4 x bfloat> [[TMP4]] to <8 x b8>
// CHECK-NEXT:    [[VBFDOT3_I:%.*]] = call <2 x float> @llvm.aarch64.neon.bfdot.v2f32.v4bf16(<2 x float> [[R]], <4 x bfloat> [[A]], <4 x bfloat> [[TMP4]])
// CHECK-NEXT:    ret <2 x float> [[VBFDOT3_I]]
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__REINT_796:%.*]] = alloca <8 x bfloat>, align 16
// CHECK-NEXT:    [[__REINT1_796:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    store <8 x bfloat> [[B:%.*]], ptr [[__REINT_796]], align 16
// CHECK-NEXT:    [[TMP0:%.*]] = load <4 x float>, ptr [[__REINT_796]], align 16
...
// CHECK-NEXT:    store <4 x float> [[LANE]], ptr [[__REINT1_796]], align 16
// CHECK-NEXT:    [[TMP4:%.*]] = load <8 x bfloat>, ptr [[__REINT1_796]], align 16
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <4 x float> [[R:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <8 x bfloat> [[A:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <8 x bfloat> [[TMP4]] to <16 x b8>
// CHECK-NEXT:    [[VBFDOT3_I:%.*]] = call <4 x float> @llvm.aarch64.neon.bfdot.v4f32.v8bf16(<4 x float> [[R]], <8 x bfloat> [[A]], <8 x bfloat> [[TMP4]])
// CHECK-NEXT:    ret <4 x float> [[VBFDOT3_I]]
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__REINT_798:%.*]] = alloca <8 x bfloat>, align 16
// CHECK-NEXT:    [[__REINT1_798:%.*]] = alloca <2 x float>, align 8
// CHECK-NEXT:    store <8 x bfloat> [[B:%.*]], ptr [[__REINT_798]], align 16
// CHECK-NEXT:    [[TMP0:%.*]] = load <4 x float>, ptr [[__REINT_798]], align 16
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x float> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <16 x i8> [[TMP2]] to <4 x float>
// CHECK-NEXT:    [[LANE:%.*]] = shufflevector <4 x float> [[TMP3]], <4 x float> [[TMP3]], <2 x i32> <i32 3, i32 3>
// CHECK-NEXT:    store <2 x float> [[LANE]], ptr [[__REINT1_798]], align 8
// CHECK-NEXT:    [[TMP4:%.*]] = load <4 x bfloat>, ptr [[__REINT1_798]], align 8
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <2 x float> [[R:%.*]] to <8 x b8>
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <4 x bfloat> [[A:%.*]] to <8 x b8>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <4 x bfloat> [[TMP4]] to <8 x b8>
// CHECK-NEXT:    [[VBFDOT3_I:%.*]] = call <2 x float> @llvm.aarch64.neon.bfdot.v2f32.v4bf16(<2 x float> [[R]], <4 x bfloat> [[A]], <4 x bfloat> [[TMP4]])
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__REINT_792:%.*]] = alloca <4 x bfloat>, align 8
// CHECK-NEXT:    [[__REINT1_792:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    store <4 x bfloat> [[B:%.*]], ptr [[__REINT_792]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load <2 x float>, ptr [[__REINT_792]], align 8
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x float> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <8 x i8> [[TMP2]] to <2 x float>
// CHECK-NEXT:    [[LANE:%.*]] = shufflevector <2 x float> [[TMP3]], <2 x float> [[TMP3]], <4 x i32> zeroinitializer
// CHECK-NEXT:    store <4 x float> [[LANE]], ptr [[__REINT1_792]], align 16
// CHECK-NEXT:    [[TMP4:%.*]] = load <8 x bfloat>, ptr [[__REINT1_792]], align 16
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <4 x float> [[R:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <8 x bfloat> [[A:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <8 x bfloat> [[TMP4]] to <16 x b8>
// CHECK-NEXT:    [[VBFDOT3_I:%.*]] = call <4 x float> @llvm.aarch64.neon.bfdot.v4f32.v8bf16(<4 x float> [[R]], <8 x bfloat> [[A]], <8 x bfloat> [[TMP4]])
...
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <16 x b8> [[VBFMMLAQ_F324_I]] to <16 x i8>
...
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <16 x b8> [[VBFMLALBQ_F324_I]] to <16 x i8>
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <16 x i8> [[TMP3]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP4]]
//
...
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <16 x b8> [[VBFMLALTQ_F324_I]] to <16 x i8>
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <16 x i8> [[TMP3]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP4]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[R:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <8 x bfloat> [[A:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x bfloat> [[VECINIT35]] to <16 x b8>
