...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x bfloat> [[SRC:%.*]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[TMP1]] to <4 x bfloat>
// CHECK-NEXT:    [[TMP3:%.*]] = load bfloat, ptr [[PTR:%.*]], align 2
// CHECK-NEXT:    [[VLD1_LANE:%.*]] = insertelement <4 x bfloat> [[TMP2]], bfloat [[TMP3]], i64 0
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x bfloat> [[SRC:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[TMP1]] to <8 x bfloat>
// CHECK-NEXT:    [[TMP3:%.*]] = load bfloat, ptr [[PTR:%.*]], align 2
// CHECK-NEXT:    [[VLD1_LANE:%.*]] = insertelement <8 x bfloat> [[TMP2]], bfloat [[TMP3]], i64 7
...
// CHECK64-NEXT:    [[TMP0:%.*]] = bitcast <4 x bfloat> [[SRC_COERCE_FCA_0_EXTRACT]] to <8 x b8>
// CHECK64-NEXT:    [[TMP1:%.*]] = bitcast <4 x bfloat> [[SRC_COERCE_FCA_1_EXTRACT]] to <8 x b8>
// CHECK64-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK64-NEXT:    [[TMP3:%.*]] = bitcast <8 x i8> [[TMP2]] to <4 x bfloat>
// CHECK64-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK64-NEXT:    [[TMP5:%.*]] = bitcast <8 x i8> [[TMP4]] to <4 x bfloat>
// CHECK64-NEXT:    [[VLD2_LANE:%.*]] = tail call { <4 x bfloat>, <4 x bfloat> } @llvm.aarch64.neon.ld2lane.v4bf16.p0(<4 x bfloat> [[TMP3]], <4 x bfloat> [[TMP5]], i64 1, ptr [[PTR:%.*]])
...
// CHECK32-NEXT:    [[TMP0:%.*]] = bitcast <2 x i32> [[SRC_COERCE_FCA_0_EXTRACT]] to <8 x b8>
// CHECK32-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[SRC_COERCE_FCA_1_EXTRACT]] to <8 x b8>
// CHECK32-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK32-NEXT:    [[TMP3:%.*]] = bitcast <8 x i8> [[TMP2]] to <4 x bfloat>
// CHECK32-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK32-NEXT:    [[TMP5:%.*]] = bitcast <8 x i8> [[TMP4]] to <4 x bfloat>
// CHECK32-NEXT:    [[VLD2_LANE_V:%.*]] = tail call { <4 x bfloat>, <4 x bfloat> } @llvm.arm.neon.vld2lane.v4bf16.p0(ptr [[PTR:%.*]], <4 x bfloat> [[TMP3]], <4 x bfloat> [[TMP5]], i32 1, i32 2)
...
// CHECK32-NEXT:    [[TMP6:%.*]] = bitcast <4 x bfloat> [[VLD2_LANE_V_FCA_0_EXTRACT]] to <2 x i32>
// CHECK32-NEXT:    [[TMP7:%.*]] = bitcast <4 x bfloat> [[VLD2_LANE_V_FCA_1_EXTRACT]] to <2 x i32>
// CHECK32-NEXT:    [[DOTFCA_0_INSERT:%.*]] = insertvalue [2 x <2 x i32>] poison, <2 x i32> [[TMP6]], 0
// CHECK32-NEXT:    [[DOTFCA_1_INSERT:%.*]] = insertvalue [2 x <2 x i32>] [[DOTFCA_0_INSERT]], <2 x i32> [[TMP7]], 1
// CHECK32-NEXT:    ret [2 x <2 x i32>] [[DOTFCA_1_INSERT]]
//
...
// CHECK64-NEXT:    [[TMP0:%.*]] = bitcast <8 x bfloat> [[SRC_COERCE_FCA_0_EXTRACT]] to <16 x b8>
// CHECK64-NEXT:    [[TMP1:%.*]] = bitcast <8 x bfloat> [[SRC_COERCE_FCA_1_EXTRACT]] to <16 x b8>
// CHECK64-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK64-NEXT:    [[TMP3:%.*]] = bitcast <16 x i8> [[TMP2]] to <8 x bfloat>
// CHECK64-NEXT:    [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK64-NEXT:    [[TMP5:%.*]] = bitcast <16 x i8> [[TMP4]] to <8 x bfloat>
// CHECK64-NEXT:    [[VLD2_LANE:%.*]] = tail call { <8 x bfloat>, <8 x bfloat> } @llvm.aarch64.neon.ld2lane.v8bf16.p0(<8 x bfloat> [[TMP3]], <8 x bfloat> [[TMP5]], i64 7, ptr [[PTR:%.*]])
...
// CHECK32-NEXT:    [[TMP0:%.*]] = bitcast <4 x i32> [[SRC_COERCE_FCA_0_EXTRACT]] to <16 x b8>
// CHECK32-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[SRC_COERCE_FCA_1_EXTRACT]] to <16 x b8>
// CHECK32-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK32-NEXT:    [[TMP3:%.*]] = bitcast <16 x i8> [[TMP2]] to <8 x bfloat>
// CHECK32-NEXT:    [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK32-NEXT:    [[TMP5:%.*]] = bitcast <16 x i8> [[TMP4]] to <8 x bfloat>
// CHECK32-NEXT:    [[VLD2Q_LANE_V:%.*]] = tail call { <8 x bfloat>, <8 x bfloat> } @llvm.arm.neon.vld2lane.v8bf16.p0(ptr [[PTR:%.*]], <8 x bfloat> [[TMP3]], <8 x bfloat> [[TMP5]], i32 7, i32 2)
...
// CHECK32-NEXT:    [[TMP6:%.*]] = bitcast <8 x bfloat> [[VLD2Q_LANE_V_FCA_0_EXTRACT]] to <4 x i32>
// CHECK32-NEXT:    [[TMP7:%.*]] = bitcast <8 x bfloat> [[VLD2Q_LANE_V_FCA_1_EXTRACT]] to <4 x i32>
// CHECK32-NEXT:    [[DOTFCA_0_INSERT:%.*]] = insertvalue [2 x <4 x i32>] poison, <4 x i32> [[TMP6]], 0
// CHECK32-NEXT:    [[DOTFCA_1_INSERT:%.*]] = insertvalue [2 x <4 x i32>] [[DOTFCA_0_INSERT]], <4 x i32> [[TMP7]], 1
// CHECK32-NEXT:    ret [2 x <4 x i32>] [[DOTFCA_1_INSERT]]
//
...
// CHECK64-NEXT:    [[TMP0:%.*]] = bitcast <4 x bfloat> [[SRC_COERCE_FCA_0_EXTRACT]] to <8 x b8>
// CHECK64-NEXT:    [[TMP1:%.*]] = bitcast <4 x bfloat> [[SRC_COERCE_FCA_1_EXTRACT]] to <8 x b8>
// CHECK64-NEXT:    [[TMP2:%.*]] = bitcast <4 x bfloat> [[SRC_COERCE_FCA_2_EXTRACT]] to <8 x b8>
// CHECK64-NEXT:    [[TMP3:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK64-NEXT:    [[TMP4:%.*]] = bitcast <8 x i8> [[TMP3]] to <4 x bfloat>
// CHECK64-NEXT:    [[TMP5:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK64-NEXT:    [[TMP6:%.*]] = bitcast <8 x i8> [[TMP5]] to <4 x bfloat>
// CHECK64-NEXT:    [[TMP7:%.*]] = bytecast exact <8 x b8> [[TMP2]] to <8 x i8>
// CHECK64-NEXT:    [[TMP8:%.*]] = bitcast <8 x i8> [[TMP7]] to <4 x bfloat>
// CHECK64-NEXT:    [[VLD3_LANE:%.*]] = tail call { <4 x bfloat>, <4 x bfloat>, <4 x bfloat> } @llvm.aarch64.neon.ld3lane.v4bf16.p0(<4 x bfloat> [[TMP4]], <4 x bfloat> [[TMP6]], <4 x bfloat> [[TMP8]], i64 1, ptr [[PTR:%.*]])
...
// CHECK32-NEXT:    [[TMP0:%.*]] = bitcast <2 x i32> [[SRC_COERCE_FCA_0_EXTRACT]] to <8 x b8>
// CHECK32-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[SRC_COERCE_FCA_1_EXTRACT]] to <8 x b8>
// CHECK32-NEXT:    [[TMP2:%.*]] = bitcast <2 x i32> [[SRC_COERCE_FCA_2_EXTRACT]] to <8 x b8>
// CHECK32-NEXT:    [[TMP3:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK32-NEXT:    [[TMP4:%.*]] = bitcast <8 x i8> [[TMP3]] to <4 x bfloat>
// CHECK32-NEXT:    [[TMP5:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK32-NEXT:    [[TMP6:%.*]] = bitcast <8 x i8> [[TMP5]] to <4 x bfloat>
// CHECK32-NEXT:    [[TMP7:%.*]] = bytecast exact <8 x b8> [[TMP2]] to <8 x i8>
// CHECK32-NEXT:    [[TMP8:%.*]] = bitcast <8 x i8> [[TMP7]] to <4 x bfloat>
// CHECK32-NEXT:    [[VLD3_LANE_V:%.*]] = tail call { <4 x bfloat>, <4 x bfloat>, <4 x bfloat> } @llvm.arm.neon.vld3lane.v4bf16.p0(ptr [[PTR:%.*]], <4 x bfloat> [[TMP4]], <4 x bfloat> [[TMP6]], <4 x bfloat> [[TMP8]], i32 1, i32 2)
...
// CHECK32-NEXT:    [[TMP9:%.*]] = bitcast <4 x bfloat> [[VLD3_LANE_V_FCA_0_EXTRACT]] to <2 x i32>
// CHECK32-NEXT:    [[TMP10:%.*]] = bitcast <4 x bfloat> [[VLD3_LANE_V_FCA_1_EXTRACT]] to <2 x i32>
// CHECK32-NEXT:    [[TMP11:%.*]] = bitcast <4 x bfloat> [[VLD3_LANE_V_FCA_2_EXTRACT]] to <2 x i32>
// CHECK32-NEXT:    [[DOTFCA_0_INSERT:%.*]] = insertvalue [3 x <2 x i32>] poison, <2 x i32> [[TMP9]], 0
// CHECK32-NEXT:    [[DOTFCA_1_INSERT:%.*]] = insertvalue [3 x <2 x i32>] [[DOTFCA_0_INSERT]], <2 x i32> [[TMP10]], 1
// CHECK32-NEXT:    [[DOTFCA_2_INSERT:%.*]] = insertvalue [3 x <2 x i32>] [[DOTFCA_1_INSERT]], <2 x i32> [[TMP11]], 2
// CHECK32-NEXT:    ret [3 x <2 x i32>] [[DOTFCA_2_INSERT]]
//
...
// CHECK64-NEXT:    [[TMP0:%.*]] = bitcast <8 x bfloat> [[SRC_COERCE_FCA_0_EXTRACT]] to <16 x b8>
// CHECK64-NEXT:    [[TMP1:%.*]] = bitcast <8 x bfloat> [[SRC_COERCE_FCA_1_EXTRACT]] to <16 x b8>
// CHECK64-NEXT:    [[TMP2:%.*]] = bitcast <8 x bfloat> [[SRC_COERCE_FCA_2_EXTRACT]] to <16 x b8>
// CHECK64-NEXT:    [[TMP3:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK64-NEXT:    [[TMP4:%.*]] = bitcast <16 x i8> [[TMP3]] to <8 x bfloat>
// CHECK64-NEXT:    [[TMP5:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK64-NEXT:    [[TMP6:%.*]] = bitcast <16 x i8> [[TMP5]] to <8 x bfloat>
// CHECK64-NEXT:    [[TMP7:%.*]] = bytecast exact <16 x b8> [[TMP2]] to <16 x i8>
// CHECK64-NEXT:    [[TMP8:%.*]] = bitcast <16 x i8> [[TMP7]] to <8 x bfloat>
// CHECK64-NEXT:    [[VLD3_LANE:%.*]] = tail call { <8 x bfloat>, <8 x bfloat>, <8 x bfloat> } @llvm.aarch64.neon.ld3lane.v8bf16.p0(<8 x bfloat> [[TMP4]], <8 x bfloat> [[TMP6]], <8 x bfloat> [[TMP8]], i64 7, ptr [[PTR:%.*]])
...
// CHECK32-NEXT:    [[TMP0:%.*]] = bitcast <4 x i32> [[SRC_COERCE_FCA_0_EXTRACT]] to <16 x b8>
// CHECK32-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[SRC_COERCE_FCA_1_EXTRACT]] to <16 x b8>
// CHECK32-NEXT:    [[TMP2:%.*]] = bitcast <4 x i32> [[SRC_COERCE_FCA_2_EXTRACT]] to <16 x b8>
// CHECK32-NEXT:    [[TMP3:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK32-NEXT:    [[TMP4:%.*]] = bitcast <16 x i8> [[TMP3]] to <8 x bfloat>
// CHECK32-NEXT:    [[TMP5:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK32-NEXT:    [[TMP6:%.*]] = bitcast <16 x i8> [[TMP5]] to <8 x bfloat>
// CHECK32-NEXT:    [[TMP7:%.*]] = bytecast exact <16 x b8> [[TMP2]] to <16 x i8>
// CHECK32-NEXT:    [[TMP8:%.*]] = bitcast <16 x i8> [[TMP7]] to <8 x bfloat>
// CHECK32-NEXT:    [[VLD3Q_LANE_V:%.*]] = tail call { <8 x bfloat>, <8 x bfloat>, <8 x bfloat> } @llvm.arm.neon.vld3lane.v8bf16.p0(ptr [[PTR:%.*]], <8 x bfloat> [[TMP4]], <8 x bfloat> [[TMP6]], <8 x bfloat> [[TMP8]], i32 7, i32 2)
...
// CHECK32-NEXT:    [[TMP9:%.*]] = bitcast <8 x bfloat> [[VLD3Q_LANE_V_FCA_0_EXTRACT]] to <4 x i32>
// CHECK32-NEXT:    [[TMP10:%.*]] = bitcast <8 x bfloat> [[VLD3Q_LANE_V_FCA_1_EXTRACT]] to <4 x i32>
// CHECK32-NEXT:    [[TMP11:%.*]] = bitcast <8 x bfloat> [[VLD3Q_LANE_V_FCA_2_EXTRACT]] to <4 x i32>
// CHECK32-NEXT:    [[DOTFCA_0_INSERT:%.*]] = insertvalue [3 x <4 x i32>] poison, <4 x i32> [[TMP9]], 0
// CHECK32-NEXT:    [[DOTFCA_1_INSERT:%.*]] = insertvalue [3 x <4 x i32>] [[DOTFCA_0_INSERT]], <4 x i32> [[TMP10]], 1
// CHECK32-NEXT:    [[DOTFCA_2_INSERT:%.*]] = insertvalue [3 x <4 x i32>] [[DOTFCA_1_INSERT]], <4 x i32> [[TMP11]], 2
// CHECK32-NEXT:    ret [3 x <4 x i32>] [[DOTFCA_2_INSERT]]
//
...
// CHECK64-NEXT:    [[TMP1:%.*]] = bitcast <4 x bfloat> [[SRC_COERCE_FCA_1_EXTRACT]] to <8 x b8>
// CHECK64-NEXT:    [[TMP2:%.*]] = bitcast <4 x bfloat> [[SRC_COERCE_FCA_2_EXTRACT]] to <8 x b8>
// CHECK64-NEXT:    [[TMP3:%.*]] = bitcast <4 x bfloat> [[SRC_COERCE_FCA_3_EXTRACT]] to <8 x b8>
// CHECK64-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK64-NEXT:    [[TMP5:%.*]] = bitcast <8 x i8> [[TMP4]] to <4 x bfloat>
// CHECK64-NEXT:    [[TMP6:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK64-NEXT:    [[TMP7:%.*]] = bitcast <8 x i8> [[TMP6]] to <4 x bfloat>
// CHECK64-NEXT:    [[TMP8:%.*]] = bytecast exact <8 x b8> [[TMP2]] to <8 x i8>
// CHECK64-NEXT:    [[TMP9:%.*]] = bitcast <8 x i8> [[TMP8]] to <4 x bfloat>
// CHECK64-NEXT:    [[TMP10:%.*]] = bytecast exact <8 x b8> [[TMP3]] to <8 x i8>
// CHECK64-NEXT:    [[TMP11:%.*]] = bitcast <8 x i8> [[TMP10]] to <4 x bfloat>
// CHECK64-NEXT:    [[VLD4_LANE:%.*]] = tail call { <4 x bfloat>, <4 x bfloat>, <4 x bfloat>, <4 x bfloat> } @llvm.aarch64.neon.ld4lane.v4bf16.p0(<4 x bfloat> [[TMP5]], <4 x bfloat> [[TMP7]], <4 x bfloat> [[TMP9]], <4 x bfloat> [[TMP11]], i64 1, ptr [[PTR:%.*]])
...
// CHECK32-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[SRC_COERCE_FCA_1_EXTRACT]] to <8 x b8>
// CHECK32-NEXT:    [[TMP2:%.*]] = bitcast <2 x i32> [[SRC_COERCE_FCA_2_EXTRACT]] to <8 x b8>
// CHECK32-NEXT:    [[TMP3:%.*]] = bitcast <2 x i32> [[SRC_COERCE_FCA_3_EXTRACT]] to <8 x b8>
// CHECK32-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK32-NEXT:    [[TMP5:%.*]] = bitcast <8 x i8> [[TMP4]] to <4 x bfloat>
// CHECK32-NEXT:    [[TMP6:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK32-NEXT:    [[TMP7:%.*]] = bitcast <8 x i8> [[TMP6]] to <4 x bfloat>
// CHECK32-NEXT:    [[TMP8:%.*]] = bytecast exact <8 x b8> [[TMP2]] to <8 x i8>
// CHECK32-NEXT:    [[TMP9:%.*]] = bitcast <8 x i8> [[TMP8]] to <4 x bfloat>
// CHECK32-NEXT:    [[TMP10:%.*]] = bytecast exact <8 x b8> [[TMP3]] to <8 x i8>
// CHECK32-NEXT:    [[TMP11:%.*]] = bitcast <8 x i8> [[TMP10]] to <4 x bfloat>
// CHECK32-NEXT:    [[VLD4_LANE_V:%.*]] = tail call { <4 x bfloat>, <4 x bfloat>, <4 x bfloat>, <4 x bfloat> } @llvm.arm.neon.vld4lane.v4bf16.p0(ptr [[PTR:%.*]], <4 x bfloat> [[TMP5]], <4 x bfloat> [[TMP7]], <4 x bfloat> [[TMP9]], <4 x bfloat> [[TMP11]], i32 1, i32 2)
...
// CHECK32-NEXT:    [[TMP12:%.*]] = bitcast <4 x bfloat> [[VLD4_LANE_V_FCA_0_EXTRACT]] to <2 x i32>
// CHECK32-NEXT:    [[TMP13:%.*]] = bitcast <4 x bfloat> [[VLD4_LANE_V_FCA_1_EXTRACT]] to <2 x i32>
// CHECK32-NEXT:    [[TMP14:%.*]] = bitcast <4 x bfloat> [[VLD4_LANE_V_FCA_2_EXTRACT]] to <2 x i32>
// CHECK32-NEXT:    [[TMP15:%.*]] = bitcast <4 x bfloat> [[VLD4_LANE_V_FCA_3_EXTRACT]] to <2 x i32>
// CHECK32-NEXT:    [[DOTFCA_0_INSERT:%.*]] = insertvalue [4 x <2 x i32>] poison, <2 x i32> [[TMP12]], 0
// CHECK32-NEXT:    [[DOTFCA_1_INSERT:%.*]] = insertvalue [4 x <2 x i32>] [[DOTFCA_0_INSERT]], <2 x i32> [[TMP13]], 1
// CHECK32-NEXT:    [[DOTFCA_2_INSERT:%.*]] = insertvalue [4 x <2 x i32>] [[DOTFCA_1_INSERT]], <2 x i32> [[TMP14]], 2
// CHECK32-NEXT:    [[DOTFCA_3_INSERT:%.*]] = insertvalue [4 x <2 x i32>] [[DOTFCA_2_INSERT]], <2 x i32> [[TMP15]], 3
// CHECK32-NEXT:    ret [4 x <2 x i32>] [[DOTFCA_3_INSERT]]
//
...
// CHECK64-NEXT:    [[TMP1:%.*]] = bitcast <8 x bfloat> [[SRC_COERCE_FCA_1_EXTRACT]] to <16 x b8>
// CHECK64-NEXT:    [[TMP2:%.*]] = bitcast <8 x bfloat> [[SRC_COERCE_FCA_2_EXTRACT]] to <16 x b8>
// CHECK64-NEXT:    [[TMP3:%.*]] = bitcast <8 x bfloat> [[SRC_COERCE_FCA_3_EXTRACT]] to <16 x b8>
// CHECK64-NEXT:    [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK64-NEXT:    [[TMP5:%.*]] = bitcast <16 x i8> [[TMP4]] to <8 x bfloat>
// CHECK64-NEXT:    [[TMP6:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK64-NEXT:    [[TMP7:%.*]] = bitcast <16 x i8> [[TMP6]] to <8 x bfloat>
// CHECK64-NEXT:    [[TMP8:%.*]] = bytecast exact <16 x b8> [[TMP2]] to <16 x i8>
// CHECK64-NEXT:    [[TMP9:%.*]] = bitcast <16 x i8> [[TMP8]] to <8 x bfloat>
// CHECK64-NEXT:    [[TMP10:%.*]] = bytecast exact <16 x b8> [[TMP3]] to <16 x i8>
// CHECK64-NEXT:    [[TMP11:%.*]] = bitcast <16 x i8> [[TMP10]] to <8 x bfloat>
// CHECK64-NEXT:    [[VLD4_LANE:%.*]] = tail call { <8 x bfloat>, <8 x bfloat>, <8 x bfloat>, <8 x bfloat> } @llvm.aarch64.neon.ld4lane.v8bf16.p0(<8 x bfloat> [[TMP5]], <8 x bfloat> [[TMP7]], <8 x bfloat> [[TMP9]], <8 x bfloat> [[TMP11]], i64 7, ptr [[PTR:%.*]])
...
// CHECK32-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[SRC_COERCE_FCA_1_EXTRACT]] to <16 x b8>
// CHECK32-NEXT:    [[TMP2:%.*]] = bitcast <4 x i32> [[SRC_COERCE_FCA_2_EXTRACT]] to <16 x b8>
// CHECK32-NEXT:    [[TMP3:%.*]] = bitcast <4 x i32> [[SRC_COERCE_FCA_3_EXTRACT]] to <16 x b8>
// CHECK32-NEXT:    [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK32-NEXT:    [[TMP5:%.*]] = bitcast <16 x i8> [[TMP4]] to <8 x bfloat>
// CHECK32-NEXT:    [[TMP6:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK32-NEXT:    [[TMP7:%.*]] = bitcast <16 x i8> [[TMP6]] to <8 x bfloat>
// CHECK32-NEXT:    [[TMP8:%.*]] = bytecast exact <16 x b8> [[TMP2]] to <16 x i8>
// CHECK32-NEXT:    [[TMP9:%.*]] = bitcast <16 x i8> [[TMP8]] to <8 x bfloat>
// CHECK32-NEXT:    [[TMP10:%.*]] = bytecast exact <16 x b8> [[TMP3]] to <16 x i8>
// CHECK32-NEXT:    [[TMP11:%.*]] = bitcast <16 x i8> [[TMP10]] to <8 x bfloat>
// CHECK32-NEXT:    [[VLD4Q_LANE_V:%.*]] = tail call { <8 x bfloat>, <8 x bfloat>, <8 x bfloat>, <8 x bfloat> } @llvm.arm.neon.vld4lane.v8bf16.p0(ptr [[PTR:%.*]], <8 x bfloat> [[TMP5]], <8 x bfloat> [[TMP7]], <8 x bfloat> [[TMP9]], <8 x bfloat> [[TMP11]], i32 7, i32 2)
...
// CHECK32-NEXT:    [[TMP12:%.*]] = bitcast <8 x bfloat> [[VLD4Q_LANE_V_FCA_0_EXTRACT]] to <4 x i32>
// CHECK32-NEXT:    [[TMP13:%.*]] = bitcast <8 x bfloat> [[VLD4Q_LANE_V_FCA_1_EXTRACT]] to <4 x i32>
// CHECK32-NEXT:    [[TMP14:%.*]] = bitcast <8 x bfloat> [[VLD4Q_LANE_V_FCA_2_EXTRACT]] to <4 x i32>
// CHECK32-NEXT:    [[TMP15:%.*]] = bitcast <8 x bfloat> [[VLD4Q_LANE_V_FCA_3_EXTRACT]] to <4 x i32>
// CHECK32-NEXT:    [[DOTFCA_0_INSERT:%.*]] = insertvalue [4 x <4 x i32>] poison, <4 x i32> [[TMP12]], 0
// CHECK32-NEXT:    [[DOTFCA_1_INSERT:%.*]] = insertvalue [4 x <4 x i32>] [[DOTFCA_0_INSERT]], <4 x i32> [[TMP13]], 1
// CHECK32-NEXT:    [[DOTFCA_2_INSERT:%.*]] = insertvalue [4 x <4 x i32>] [[DOTFCA_1_INSERT]], <4 x i32> [[TMP14]], 2
// CHECK32-NEXT:    [[DOTFCA_3_INSERT:%.*]] = insertvalue [4 x <4 x i32>] [[DOTFCA_2_INSERT]], <4 x i32> [[TMP15]], 3
// CHECK32-NEXT:    ret [4 x <4 x i32>] [[DOTFCA_3_INSERT]]
//
...
// CHECK64-NEXT:  entry:
// CHECK64-NEXT:    [[TMP0:%.*]] = bitcast <4 x bfloat> [[VAL:%.*]] to <8 x b8>
// CHECK64-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK64-NEXT:    store <8 x i8> [[TMP1]], ptr [[PTR:%.*]], align 2
...
// CHECK64-NEXT:  entry:
// CHECK64-NEXT:    [[TMP0:%.*]] = bitcast <8 x bfloat> [[VAL:%.*]] to <16 x b8>
// CHECK64-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK64-NEXT:    store <16 x i8> [[TMP1]], ptr [[PTR:%.*]], align 2
// CHECK64-NEXT:    ret void
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x bfloat> [[VAL:%.*]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[TMP1]] to <4 x bfloat>
// CHECK-NEXT:    [[TMP3:%.*]] = extractelement <4 x bfloat> [[TMP2]], i64 1
// CHECK-NEXT:    store bfloat [[TMP3]], ptr [[PTR:%.*]], align 2
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x bfloat> [[VAL:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[TMP1]] to <8 x bfloat>
// CHECK-NEXT:    [[TMP3:%.*]] = extractelement <8 x bfloat> [[TMP2]], i64 7
// CHECK-NEXT:    store bfloat [[TMP3]], ptr [[PTR:%.*]], align 2
// CHECK-NEXT:    ret void
//
...
// CHECK32-NEXT:    [[TMP0:%.*]] = bitcast <2 x i32> [[VAL_COERCE_FCA_0_EXTRACT]] to <8 x b8>
// CHECK32-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[VAL_COERCE_FCA_1_EXTRACT]] to <8 x b8>
// CHECK32-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <4 x bfloat>
// CHECK32-NEXT:    [[TMP3:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <4 x bfloat>
// CHECK32-NEXT:    tail call void @llvm.arm.neon.vst1x2.p0.v4bf16(ptr [[PTR:%.*]], <4 x bfloat> [[TMP2]], <4 x bfloat> [[TMP3]])
// CHECK32-NEXT:    ret void
//
...
// CHECK32-NEXT:    [[TMP0:%.*]] = bitcast <4 x i32> [[VAL_COERCE_FCA_0_EXTRACT]] to <16 x b8>
// CHECK32-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[VAL_COERCE_FCA_1_EXTRACT]] to <16 x b8>
// CHECK32-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x bfloat>
// CHECK32-NEXT:    [[TMP3:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <8 x bfloat>
// CHECK32-NEXT:    tail call void @llvm.arm.neon.vst1x2.p0.v8bf16(ptr [[PTR:%.*]], <8 x bfloat> [[TMP2]], <8 x bfloat> [[TMP3]])
// CHECK32-NEXT:    ret void
//
...
// CHECK32-NEXT:    [[TMP0:%.*]] = bitcast <2 x i32> [[VAL_COERCE_FCA_0_EXTRACT]] to <8 x b8>
// CHECK32-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[VAL_COERCE_FCA_1_EXTRACT]] to <8 x b8>
// CHECK32-NEXT:    [[TMP2:%.*]] = bitcast <2 x i32> [[VAL_COERCE_FCA_2_EXTRACT]] to <8 x b8>
// CHECK32-NEXT:    [[TMP3:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <4 x bfloat>
// CHECK32-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <4 x bfloat>
// CHECK32-NEXT:    [[TMP5:%.*]] = bytecast exact <8 x b8> [[TMP2]] to <4 x bfloat>
// CHECK32-NEXT:    tail call void @llvm.arm.neon.vst1x3.p0.v4bf16(ptr [[PTR:%.*]], <4 x bfloat> [[TMP3]], <4 x bfloat> [[TMP4]], <4 x bfloat> [[TMP5]])
// CHECK32-NEXT:    ret void
//
...
// CHECK32-NEXT:    [[TMP0:%.*]] = bitcast <4 x i32> [[VAL_COERCE_FCA_0_EXTRACT]] to <16 x b8>
// CHECK32-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[VAL_COERCE_FCA_1_EXTRACT]] to <16 x b8>
// CHECK32-NEXT:    [[TMP2:%.*]] = bitcast <4 x i32> [[VAL_COERCE_FCA_2_EXTRACT]] to <16 x b8>
// CHECK32-NEXT:    [[TMP3:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x bfloat>
// CHECK32-NEXT:    [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <8 x bfloat>
// CHECK32-NEXT:    [[TMP5:%.*]] = bytecast exact <16 x b8> [[TMP2]] to <8 x bfloat>
// CHECK32-NEXT:    tail call void @llvm.arm.neon.vst1x3.p0.v8bf16(ptr [[PTR:%.*]], <8 x bfloat> [[TMP3]], <8 x bfloat> [[TMP4]], <8 x bfloat> [[TMP5]])
// CHECK32-NEXT:    ret void
//
...
// CHECK32-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[VAL_COERCE_FCA_1_EXTRACT]] to <8 x b8>
// CHECK32-NEXT:    [[TMP2:%.*]] = bitcast <2 x i32> [[VAL_COERCE_FCA_2_EXTRACT]] to <8 x b8>
// CHECK32-NEXT:    [[TMP3:%.*]] = bitcast <2 x i32> [[VAL_COERCE_FCA_3_EXTRACT]] to <8 x b8>
// CHECK32-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <4 x bfloat>
// CHECK32-NEXT:    [[TMP5:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <4 x bfloat>
// CHECK32-NEXT:    [[TMP6:%.*]] = bytecast exact <8 x b8> [[TMP2]] to <4 x bfloat>
// CHECK32-NEXT:    [[TMP7:%.*]] = bytecast exact <8 x b8> [[TMP3]] to <4 x bfloat>
// CHECK32-NEXT:    tail call void @llvm.arm.neon.vst1x4.p0.v4bf16(ptr [[PTR:%.*]], <4 x bfloat> [[TMP4]], <4 x bfloat> [[TMP5]], <4 x bfloat> [[TMP6]], <4 x bfloat> [[TMP7]])
// CHECK32-NEXT:    ret void
//
...
// CHECK32-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[VAL_COERCE_FCA_1_EXTRACT]] to <16 x b8>
// CHECK32-NEXT:    [[TMP2:%.*]] = bitcast <4 x i32> [[VAL_COERCE_FCA_2_EXTRACT]] to <16 x b8>
// CHECK32-NEXT:    [[TMP3:%.*]] = bitcast <4 x i32> [[VAL_COERCE_FCA_3_EXTRACT]] to <16 x b8>
// CHECK32-NEXT:    [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x bfloat>
// CHECK32-NEXT:    [[TMP5:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <8 x bfloat>
// CHECK32-NEXT:    [[TMP6:%.*]] = bytecast exact <16 x b8> [[TMP2]] to <8 x bfloat>
// CHECK32-NEXT:    [[TMP7:%.*]] = bytecast exact <16 x b8> [[TMP3]] to <8 x bfloat>
// CHECK32-NEXT:    tail call void @llvm.arm.neon.vst1x4.p0.v8bf16(ptr [[PTR:%.*]], <8 x bfloat> [[TMP4]], <8 x bfloat> [[TMP5]], <8 x bfloat> [[TMP6]], <8 x bfloat> [[TMP7]])
// CHECK32-NEXT:    ret void
//
...
// CHECK32-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <4 x bfloat>
// CHECK32-NEXT:    [[TMP3:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <4 x bfloat>
// CHECK32-NEXT:    tail call void @llvm.arm.neon.vst2.p0.v4bf16(ptr [[PTR:%.*]], <4 x bfloat> [[TMP2]], <4 x bfloat> [[TMP3]], i32 2)
// CHECK32-NEXT:    ret void
//
...
// CHECK32-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x bfloat>
// CHECK32-NEXT:    [[TMP3:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <8 x bfloat>
// CHECK32-NEXT:    tail call void @llvm.arm.neon.vst2.p0.v8bf16(ptr [[PTR:%.*]], <8 x bfloat> [[TMP2]], <8 x bfloat> [[TMP3]], i32 2)
// CHECK32-NEXT:    ret void
//
...
// CHECK32-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <4 x bfloat>
// CHECK32-NEXT:    [[TMP3:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <4 x bfloat>
// CHECK32-NEXT:    tail call void @llvm.arm.neon.vst2lane.p0.v4bf16(ptr [[PTR:%.*]], <4 x bfloat> [[TMP2]], <4 x bfloat> [[TMP3]], i32 1, i32 2)
// CHECK32-NEXT:    ret void
//
...
// CHECK32-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x bfloat>
// CHECK32-NEXT:    [[TMP3:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <8 x bfloat>
// CHECK32-NEXT:    tail call void @llvm.arm.neon.vst2lane.p0.v8bf16(ptr [[PTR:%.*]], <8 x bfloat> [[TMP2]], <8 x bfloat> [[TMP3]], i32 7, i32 2)
// CHECK32-NEXT:    ret void
//
...
// CHECK32-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <4 x bfloat>
// CHECK32-NEXT:    [[TMP5:%.*]] = bytecast exact <8 x b8> [[TMP2]] to <4 x bfloat>
// CHECK32-NEXT:    tail call void @llvm.arm.neon.vst3.p0.v4bf16(ptr [[PTR:%.*]], <4 x bfloat> [[TMP3]], <4 x bfloat> [[TMP4]], <4 x bfloat> [[TMP5]], i32 2)
// CHECK32-NEXT:    ret void
//
...
// CHECK32-NEXT:    [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <8 x bfloat>
// CHECK32-NEXT:    [[TMP5:%.*]] = bytecast exact <16 x b8> [[TMP2]] to <8 x bfloat>
// CHECK32-NEXT:    tail call void @llvm.arm.neon.vst3.p0.v8bf16(ptr [[PTR:%.*]], <8 x bfloat> [[TMP3]], <8 x bfloat> [[TMP4]], <8 x bfloat> [[TMP5]], i32 2)
// CHECK32-NEXT:    ret void
//
...
// CHECK32-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <4 x bfloat>
// CHECK32-NEXT:    [[TMP5:%.*]] = bytecast exact <8 x b8> [[TMP2]] to <4 x bfloat>
// CHECK32-NEXT:    tail call void @llvm.arm.neon.vst3lane.p0.v4bf16(ptr [[PTR:%.*]], <4 x bfloat> [[TMP3]], <4 x bfloat> [[TMP4]], <4 x bfloat> [[TMP5]], i32 1, i32 2)
// CHECK32-NEXT:    ret void
//
...
// CHECK32-NEXT:    [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <8 x bfloat>
// CHECK32-NEXT:    [[TMP5:%.*]] = bytecast exact <16 x b8> [[TMP2]] to <8 x bfloat>
// CHECK32-NEXT:    tail call void @llvm.arm.neon.vst3lane.p0.v8bf16(ptr [[PTR:%.*]], <8 x bfloat> [[TMP3]], <8 x bfloat> [[TMP4]], <8 x bfloat> [[TMP5]], i32 7, i32 2)
// CHECK32-NEXT:    ret void
//
...
// CHECK32-NEXT:    [[TMP6:%.*]] = bytecast exact <8 x b8> [[TMP2]] to <4 x bfloat>
// CHECK32-NEXT:    [[TMP7:%.*]] = bytecast exact <8 x b8> [[TMP3]] to <4 x bfloat>
// CHECK32-NEXT:    tail call void @llvm.arm.neon.vst4.p0.v4bf16(ptr [[PTR:%.*]], <4 x bfloat> [[TMP4]], <4 x bfloat> [[TMP5]], <4 x bfloat> [[TMP6]], <4 x bfloat> [[TMP7]], i32 2)
// CHECK32-NEXT:    ret void
//
...
// CHECK32-NEXT:    [[TMP6:%.*]] = bytecast exact <16 x b8> [[TMP2]] to <8 x bfloat>
// CHECK32-NEXT:    [[TMP7:%.*]] = bytecast exact <16 x b8> [[TMP3]] to <8 x bfloat>
// CHECK32-NEXT:    tail call void @llvm.arm.neon.vst4.p0.v8bf16(ptr [[PTR:%.*]], <8 x bfloat> [[TMP4]], <8 x bfloat> [[TMP5]], <8 x bfloat> [[TMP6]], <8 x bfloat> [[TMP7]], i32 2)
// CHECK32-NEXT:    ret void
//
...
// CHECK32-NEXT:    [[TMP6:%.*]] = bytecast exact <8 x b8> [[TMP2]] to <4 x bfloat>
// CHECK32-NEXT:    [[TMP7:%.*]] = bytecast exact <8 x b8> [[TMP3]] to <4 x bfloat>
// CHECK32-NEXT:    tail call void @llvm.arm.neon.vst4lane.p0.v4bf16(ptr [[PTR:%.*]], <4 x bfloat> [[TMP4]], <4 x bfloat> [[TMP5]], <4 x bfloat> [[TMP6]], <4 x bfloat> [[TMP7]], i32 1, i32 2)
// CHECK32-NEXT:    ret void
//
...
// CHECK32-NEXT:    [[TMP6:%.*]] = bytecast exact <16 x b8> [[TMP2]] to <8 x bfloat>
// CHECK32-NEXT:    [[TMP7:%.*]] = bytecast exact <16 x b8> [[TMP3]] to <8 x bfloat>
// CHECK32-NEXT:    tail call void @llvm.arm.neon.vst4lane.p0.v8bf16(ptr [[PTR:%.*]], <8 x bfloat> [[TMP4]], <8 x bfloat> [[TMP5]], <8 x bfloat> [[TMP6]], <8 x bfloat> [[TMP7]], i32 7, i32 2)
// CHECK32-NEXT:    ret void
//
