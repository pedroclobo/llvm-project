...
// CHECK-NEXT:    call void @llvm.aarch64.set.fpmr(i64 [[FPM]])
// CHECK-NEXT:    [[VFCVTN_I:%.*]] = bytecast exact <8 x b8> [[TMP2]] to <4 x half>
// CHECK-NEXT:    [[VFCVTN1_I:%.*]] = bytecast exact <8 x b8> [[TMP3]] to <4 x half>
...
// CHECK-CXX-NEXT:    call void @llvm.aarch64.set.fpmr(i64 [[FPM]])
// CHECK-CXX-NEXT:    [[VFCVTN_I:%.*]] = bytecast exact <8 x b8> [[TMP2]] to <4 x half>
// CHECK-CXX-NEXT:    [[VFCVTN1_I:%.*]] = bytecast exact <8 x b8> [[TMP3]] to <4 x half>
...
// CHECK-NEXT:    call void @llvm.aarch64.set.fpmr(i64 [[FPM]])
// CHECK-NEXT:    [[VFCVTN_I:%.*]] = bytecast exact <16 x b8> [[TMP2]] to <8 x half>
// CHECK-NEXT:    [[VFCVTN1_I:%.*]] = bytecast exact <16 x b8> [[TMP3]] to <8 x half>
...
// CHECK-CXX-NEXT:    call void @llvm.aarch64.set.fpmr(i64 [[FPM]])
// CHECK-CXX-NEXT:    [[VFCVTN_I:%.*]] = bytecast exact <16 x b8> [[TMP2]] to <8 x half>
// CHECK-CXX-NEXT:    [[VFCVTN1_I:%.*]] = bytecast exact <16 x b8> [[TMP3]] to <8 x half>
