...
// CHECK-NEXT:    [[VMLAL_I:%.*]] = bytecast <16 x b8> [[TMP1]] to <8 x half>
...
// CHECK-CXX-NEXT:    [[VMLAL_I:%.*]] = bytecast <16 x b8> [[TMP1]] to <8 x half>
...
// CHECK-NEXT:    call void @llvm.aarch64.set.fpmr(i64 [[FPM]])
// CHECK-NEXT:    [[VMLAL_LANE:%.*]] = bytecast <16 x b8> [[TMP1]] to <8 x half>
...
// CHECK-CXX-NEXT:    call void @llvm.aarch64.set.fpmr(i64 [[FPM]])
// CHECK-CXX-NEXT:    [[VMLAL_LANE:%.*]] = bytecast <16 x b8> [[TMP1]] to <8 x half>
