...
// CHECK-C-NEXT:    [[EXT_I:%.*]] = bytecast <16 x b8> [[TMP2]] to <16 x i8>
// CHECK-C-NEXT:    [[TMP3:%.*]] = load <16 x b8>, ptr [[__P1_ADDR_I]], align 16
// CHECK-C-NEXT:    [[EXT1_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <16 x i8>
...
// CHECK-CPP-NEXT:    [[EXT_I:%.*]] = bytecast <16 x b8> [[TMP2]] to <16 x i8>
// CHECK-CPP-NEXT:    [[TMP3:%.*]] = load <16 x b8>, ptr [[__P1_ADDR_I]], align 16
// CHECK-CPP-NEXT:    [[EXT1_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <16 x i8>
