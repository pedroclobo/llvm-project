...
// CHECK:   [[EXT_A:%.*]] = bytecast exact <8 x b8> %a to <8 x i8>
// CHECK:   [[EXT_B:%.*]] = bytecast exact <8 x b8> %b to <8 x i8>
...
// CHECK:   [[EXT_A:%.*]] = bytecast exact <16 x b8> %a to <16 x i8>
// CHECK:   [[EXT_B:%.*]] = bytecast exact <16 x b8> %b to <16 x i8>
