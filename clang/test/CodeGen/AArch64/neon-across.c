...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDLV_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VADDLV1_I:%.*]] = call i32 @llvm.aarch64.neon.saddlv.i32.v8i8(<8 x i8> [[VADDLV_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VADDLV1_I]] to i16
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDLV_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VADDLV1_I:%.*]] = call i32 @llvm.aarch64.neon.uaddlv.i32.v8i8(<8 x i8> [[VADDLV_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VADDLV1_I]] to i16
// CHECK-NEXT:    ret i16 [[TMP0]]
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDLV_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VADDLV1_I:%.*]] = call i32 @llvm.aarch64.neon.saddlv.i32.v16i8(<16 x i8> [[VADDLV_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VADDLV1_I]] to i16
// CHECK-NEXT:    ret i16 [[TMP0]]
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDLV_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VADDLV1_I:%.*]] = call i32 @llvm.aarch64.neon.uaddlv.i32.v16i8(<16 x i8> [[VADDLV_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VADDLV1_I]] to i16
// CHECK-NEXT:    ret i16 [[TMP0]]
//
...
// CHECK-SAME: (<8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__RET_I:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[VMAXV_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VMAXV1_I:%.*]] = call i32 @llvm.aarch64.neon.smaxv.i32.v8i8(<8 x i8> [[VMAXV_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMAXV1_I]] to i8
// CHECK-NEXT:    store i8 [[TMP0]], ptr [[__RET_I]], align 1
// CHECK-NEXT:    [[TMP1:%.*]] = load b8, ptr [[__RET_I]], align 1
...
// CHECK-NEXT:    [[__RET_I:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[VMAXV_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VMAXV1_I:%.*]] = call i32 @llvm.aarch64.neon.umaxv.i32.v8i8(<8 x i8> [[VMAXV_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMAXV1_I]] to i8
// CHECK-NEXT:    store i8 [[TMP0]], ptr [[__RET_I]], align 1
// CHECK-NEXT:    [[TMP1:%.*]] = load b8, ptr [[__RET_I]], align 1
// CHECK-NEXT:    ret b8 [[TMP1]]
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__RET_I:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[VMAXV_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VMAXV1_I:%.*]] = call i32 @llvm.aarch64.neon.smaxv.i32.v16i8(<16 x i8> [[VMAXV_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMAXV1_I]] to i8
// CHECK-NEXT:    store i8 [[TMP0]], ptr [[__RET_I]], align 1
// CHECK-NEXT:    [[TMP1:%.*]] = load b8, ptr [[__RET_I]], align 1
// CHECK-NEXT:    ret b8 [[TMP1]]
...
// CHECK-NEXT:    [[__RET_I:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[VMAXV_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VMAXV1_I:%.*]] = call i32 @llvm.aarch64.neon.umaxv.i32.v16i8(<16 x i8> [[VMAXV_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMAXV1_I]] to i8
// CHECK-NEXT:    store i8 [[TMP0]], ptr [[__RET_I]], align 1
// CHECK-NEXT:    [[TMP1:%.*]] = load b8, ptr [[__RET_I]], align 1
// CHECK-NEXT:    ret b8 [[TMP1]]
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__RET_I:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[VMINV_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VMINV1_I:%.*]] = call i32 @llvm.aarch64.neon.sminv.i32.v8i8(<8 x i8> [[VMINV_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMINV1_I]] to i8
// CHECK-NEXT:    store i8 [[TMP0]], ptr [[__RET_I]], align 1
// CHECK-NEXT:    [[TMP1:%.*]] = load b8, ptr [[__RET_I]], align 1
// CHECK-NEXT:    ret b8 [[TMP1]]
//
...
// CHECK-NEXT:    [[__RET_I:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[VMINV_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VMINV1_I:%.*]] = call i32 @llvm.aarch64.neon.uminv.i32.v8i8(<8 x i8> [[VMINV_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMINV1_I]] to i8
// CHECK-NEXT:    store i8 [[TMP0]], ptr [[__RET_I]], align 1
// CHECK-NEXT:    [[TMP1:%.*]] = load b8, ptr [[__RET_I]], align 1
// CHECK-NEXT:    ret b8 [[TMP1]]
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__RET_I:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[VMINV_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VMINV1_I:%.*]] = call i32 @llvm.aarch64.neon.sminv.i32.v16i8(<16 x i8> [[VMINV_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMINV1_I]] to i8
// CHECK-NEXT:    store i8 [[TMP0]], ptr [[__RET_I]], align 1
// CHECK-NEXT:    [[TMP1:%.*]] = load b8, ptr [[__RET_I]], align 1
// CHECK-NEXT:    ret b8 [[TMP1]]
...
// CHECK-NEXT:    [[__RET_I:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[VMINV_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VMINV1_I:%.*]] = call i32 @llvm.aarch64.neon.uminv.i32.v16i8(<16 x i8> [[VMINV_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMINV1_I]] to i8
// CHECK-NEXT:    store i8 [[TMP0]], ptr [[__RET_I]], align 1
// CHECK-NEXT:    [[TMP1:%.*]] = load b8, ptr [[__RET_I]], align 1
// CHECK-NEXT:    ret b8 [[TMP1]]
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__RET_I:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[VADDV_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VADDV1_I:%.*]] = call i32 @llvm.aarch64.neon.saddv.i32.v8i8(<8 x i8> [[VADDV_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VADDV1_I]] to i8
// CHECK-NEXT:    store i8 [[TMP0]], ptr [[__RET_I]], align 1
// CHECK-NEXT:    [[TMP1:%.*]] = load b8, ptr [[__RET_I]], align 1
// CHECK-NEXT:    ret b8 [[TMP1]]
//
...
// CHECK-NEXT:    [[__RET_I:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[VADDV_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VADDV1_I:%.*]] = call i32 @llvm.aarch64.neon.uaddv.i32.v8i8(<8 x i8> [[VADDV_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VADDV1_I]] to i8
// CHECK-NEXT:    store i8 [[TMP0]], ptr [[__RET_I]], align 1
// CHECK-NEXT:    [[TMP1:%.*]] = load b8, ptr [[__RET_I]], align 1
// CHECK-NEXT:    ret b8 [[TMP1]]
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__RET_I:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[VADDV_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VADDV1_I:%.*]] = call i32 @llvm.aarch64.neon.saddv.i32.v16i8(<16 x i8> [[VADDV_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VADDV1_I]] to i8
// CHECK-NEXT:    store i8 [[TMP0]], ptr [[__RET_I]], align 1
// CHECK-NEXT:    [[TMP1:%.*]] = load b8, ptr [[__RET_I]], align 1
// CHECK-NEXT:    ret b8 [[TMP1]]
...
// CHECK-NEXT:    [[__RET_I:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[VADDV_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VADDV1_I:%.*]] = call i32 @llvm.aarch64.neon.uaddv.i32.v16i8(<16 x i8> [[VADDV_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VADDV1_I]] to i8
// CHECK-NEXT:    store i8 [[TMP0]], ptr [[__RET_I]], align 1
// CHECK-NEXT:    [[TMP1:%.*]] = load b8, ptr [[__RET_I]], align 1
// CHECK-NEXT:    ret b8 [[TMP1]]
