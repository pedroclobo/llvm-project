...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDLV_I:%.*]] = bytecast <8 x b8> [[A]] to <8 x i8>
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDLV_I:%.*]] = bytecast <16 x b8> [[A]] to <16 x i8>
...
// CHECK-NEXT:    [[VMAXV_I:%.*]] = bytecast <8 x b8> [[A]] to <8 x i8>
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__RET_I:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[VMAXV_I:%.*]] = bytecast <16 x b8> [[A]] to <16 x i8>
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__RET_I:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[VMINV_I:%.*]] = bytecast <8 x b8> [[A]] to <8 x i8>
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__RET_I:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[VMINV_I:%.*]] = bytecast <16 x b8> [[A]] to <16 x i8>
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__RET_I:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[VADDV_I:%.*]] = bytecast <8 x b8> [[A]] to <8 x i8>
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__RET_I:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[VADDV_I:%.*]] = bytecast <16 x b8> [[A]] to <16 x i8>
