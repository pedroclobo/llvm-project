...
// CHECK-LABEL: define{{.*}} <8 x b8> @test_vext_s8(<8 x b8> noundef %a, <8 x b8> noundef %b) #0 {
...
// CHECK:   [[TMP1:%.*]] = bitcast <4 x i16> %b to <8 x b8>
// CHECK:   [[TMP2:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK:   [[TMP3:%.*]] = bitcast <8 x i8> [[TMP2]] to <4 x i16>
// CHECK:   [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK:   [[TMP5:%.*]] = bitcast <8 x i8> [[TMP4]] to <4 x i16>
// CHECK:   [[VEXT:%.*]] = shufflevector <4 x i16> [[TMP3]], <4 x i16> [[TMP5]], <4 x i32> <i32 3, i32 4, i32 5, i32 6>
...
// CHECK:   [[TMP1:%.*]] = bitcast <2 x i32> %b to <8 x b8>
// CHECK:   [[TMP2:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK:   [[TMP3:%.*]] = bitcast <8 x i8> [[TMP2]] to <2 x i32>
// CHECK:   [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK:   [[TMP5:%.*]] = bitcast <8 x i8> [[TMP4]] to <2 x i32>
// CHECK:   [[VEXT:%.*]] = shufflevector <2 x i32> [[TMP3]], <2 x i32> [[TMP5]], <2 x i32> <i32 1, i32 2>
...
// CHECK:   [[TMP1:%.*]] = bitcast <1 x i64> %b to <8 x b8>
// CHECK:   [[TMP2:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK:   [[TMP3:%.*]] = bitcast <8 x i8> [[TMP2]] to <1 x i64>
// CHECK:   [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK:   [[TMP5:%.*]] = bitcast <8 x i8> [[TMP4]] to <1 x i64>
// CHECK:   [[VEXT:%.*]] = shufflevector <1 x i64> [[TMP3]], <1 x i64> [[TMP5]], <1 x i32> zeroinitializer
// CHECK:   ret <1 x i64> [[VEXT]]
int64x1_t test_vext_s64(int64x1_t a, int64x1_t b) {
  return vext_s64(a, b, 0);
}

// CHECK-LABEL: define{{.*}} <16 x b8> @test_vextq_s8(<16 x b8> noundef %a, <16 x b8> noundef %b) #0 {
...
// CHECK:   [[TMP1:%.*]] = bitcast <8 x i16> %b to <16 x b8>
// CHECK:   [[TMP2:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK:   [[TMP3:%.*]] = bitcast <16 x i8> [[TMP2]] to <8 x i16>
// CHECK:   [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK:   [[TMP5:%.*]] = bitcast <16 x i8> [[TMP4]] to <8 x i16>
// CHECK:   [[VEXT:%.*]] = shufflevector <8 x i16> [[TMP3]], <8 x i16> [[TMP5]], <8 x i32> <i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10>
...
// CHECK:   [[TMP1:%.*]] = bitcast <4 x i32> %b to <16 x b8>
// CHECK:   [[TMP2:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK:   [[TMP3:%.*]] = bitcast <16 x i8> [[TMP2]] to <4 x i32>
// CHECK:   [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK:   [[TMP5:%.*]] = bitcast <16 x i8> [[TMP4]] to <4 x i32>
// CHECK:   [[VEXT:%.*]] = shufflevector <4 x i32> [[TMP3]], <4 x i32> [[TMP5]], <4 x i32> <i32 1, i32 2, i32 3, i32 4>
...
// CHECK:   [[TMP1:%.*]] = bitcast <2 x i64> %b to <16 x b8>
// CHECK:   [[TMP2:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK:   [[TMP3:%.*]] = bitcast <16 x i8> [[TMP2]] to <2 x i64>
// CHECK:   [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK:   [[TMP5:%.*]] = bitcast <16 x i8> [[TMP4]] to <2 x i64>
// CHECK:   [[VEXT:%.*]] = shufflevector <2 x i64> [[TMP3]], <2 x i64> [[TMP5]], <2 x i32> <i32 1, i32 2>
...
// CHECK:   [[TMP1:%.*]] = bitcast <2 x float> %b to <8 x b8>
// CHECK:   [[TMP2:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK:   [[TMP3:%.*]] = bitcast <8 x i8> [[TMP2]] to <2 x float>
// CHECK:   [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK:   [[TMP5:%.*]] = bitcast <8 x i8> [[TMP4]] to <2 x float>
// CHECK:   [[VEXT:%.*]] = shufflevector <2 x float> [[TMP3]], <2 x float> [[TMP5]], <2 x i32> <i32 1, i32 2>
...
// CHECK:   [[TMP1:%.*]] = bitcast <1 x double> %b to <8 x b8>
// CHECK:   [[TMP2:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK:   [[TMP3:%.*]] = bitcast <8 x i8> [[TMP2]] to <1 x double>
// CHECK:   [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK:   [[TMP5:%.*]] = bitcast <8 x i8> [[TMP4]] to <1 x double>
// CHECK:   [[VEXT:%.*]] = shufflevector <1 x double> [[TMP3]], <1 x double> [[TMP5]], <1 x i32> zeroinitializer
...
// CHECK:   [[TMP1:%.*]] = bitcast <4 x float> %b to <16 x b8>
// CHECK:   [[TMP2:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK:   [[TMP3:%.*]] = bitcast <16 x i8> [[TMP2]] to <4 x float>
// CHECK:   [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK:   [[TMP5:%.*]] = bitcast <16 x i8> [[TMP4]] to <4 x float>
// CHECK:   [[VEXT:%.*]] = shufflevector <4 x float> [[TMP3]], <4 x float> [[TMP5]], <4 x i32> <i32 1, i32 2, i32 3, i32 4>
...
// CHECK:   [[TMP1:%.*]] = bitcast <2 x double> %b to <16 x b8>
// CHECK:   [[TMP2:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK:   [[TMP3:%.*]] = bitcast <16 x i8> [[TMP2]] to <2 x double>
// CHECK:   [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK:   [[TMP5:%.*]] = bitcast <16 x i8> [[TMP4]] to <2 x double>
// CHECK:   [[VEXT:%.*]] = shufflevector <2 x double> [[TMP3]], <2 x double> [[TMP5]], <2 x i32> <i32 1, i32 2>
