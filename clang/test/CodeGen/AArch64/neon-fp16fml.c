...
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x half> [[B:%.*]] to <8 x b8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <4 x half> [[C:%.*]] to <8 x b8>
...
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <8 x half> [[B:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x half> [[C:%.*]] to <16 x b8>
...
// CHECK-NEXT:    [[__REINT_8314:%.*]] = alloca <4 x half>, align 8
// CHECK-NEXT:    [[__REINT1_8315:%.*]] = alloca i16, align 2
// CHECK-NEXT:    [[__REINT_83114:%.*]] = alloca <4 x half>, align 8
// CHECK-NEXT:    [[__REINT1_83115:%.*]] = alloca i16, align 2
// CHECK-NEXT:    [[__REINT_83124:%.*]] = alloca <4 x half>, align 8
// CHECK-NEXT:    [[__REINT1_83125:%.*]] = alloca i16, align 2
// CHECK-NEXT:    store <4 x half> [[C:%.*]], ptr [[__REINT_831]], align 8
...
// CHECK-NEXT:    store <4 x half> [[C]], ptr [[__REINT_8314]], align 8
// CHECK-NEXT:    [[TMP2:%.*]] = load <4 x i16>, ptr [[__REINT_8314]], align 8
// CHECK-NEXT:    [[VGET_LANE8:%.*]] = extractelement <4 x i16> [[TMP2]], i32 0
// CHECK-NEXT:    store i16 [[VGET_LANE8]], ptr [[__REINT1_8315]], align 2
// CHECK-NEXT:    [[TMP3:%.*]] = load half, ptr [[__REINT1_8315]], align 2
// CHECK-NEXT:    [[VECINIT11:%.*]] = insertelement <4 x half> [[VECINIT]], half [[TMP3]], i32 1
// CHECK-NEXT:    store <4 x half> [[C]], ptr [[__REINT_83114]], align 8
// CHECK-NEXT:    [[TMP4:%.*]] = load <4 x i16>, ptr [[__REINT_83114]], align 8
// CHECK-NEXT:    [[VGET_LANE18:%.*]] = extractelement <4 x i16> [[TMP4]], i32 0
// CHECK-NEXT:    store i16 [[VGET_LANE18]], ptr [[__REINT1_83115]], align 2
// CHECK-NEXT:    [[TMP5:%.*]] = load half, ptr [[__REINT1_83115]], align 2
// CHECK-NEXT:    [[VECINIT21:%.*]] = insertelement <4 x half> [[VECINIT11]], half [[TMP5]], i32 2
// CHECK-NEXT:    store <4 x half> [[C]], ptr [[__REINT_83124]], align 8
// CHECK-NEXT:    [[TMP6:%.*]] = load <4 x i16>, ptr [[__REINT_83124]], align 8
// CHECK-NEXT:    [[VGET_LANE28:%.*]] = extractelement <4 x i16> [[TMP6]], i32 0
// CHECK-NEXT:    store i16 [[VGET_LANE28]], ptr [[__REINT1_83125]], align 2
// CHECK-NEXT:    [[TMP7:%.*]] = load half, ptr [[__REINT1_83125]], align 2
// CHECK-NEXT:    [[VECINIT31:%.*]] = insertelement <4 x half> [[VECINIT21]], half [[TMP7]], i32 3
// CHECK-NEXT:    [[TMP8:%.*]] = bitcast <2 x float> [[A:%.*]] to <8 x b8>
// CHECK-NEXT:    [[TMP9:%.*]] = bitcast <4 x half> [[B:%.*]] to <8 x b8>
// CHECK-NEXT:    [[TMP10:%.*]] = bitcast <4 x half> [[VECINIT31]] to <8 x b8>
...
// CHECK-NEXT:    [[__REINT_83124:%.*]] = alloca <4 x half>, align 8
// CHECK-NEXT:    [[__REINT1_83125:%.*]] = alloca i16, align 2
// CHECK-NEXT:    [[__REINT_83134:%.*]] = alloca <4 x half>, align 8
// CHECK-NEXT:    [[__REINT1_83135:%.*]] = alloca i16, align 2
// CHECK-NEXT:    [[__REINT_83144:%.*]] = alloca <4 x half>, align 8
// CHECK-NEXT:    [[__REINT1_83145:%.*]] = alloca i16, align 2
// CHECK-NEXT:    [[__REINT_83154:%.*]] = alloca <4 x half>, align 8
// CHECK-NEXT:    [[__REINT1_83155:%.*]] = alloca i16, align 2
// CHECK-NEXT:    [[__REINT_83164:%.*]] = alloca <4 x half>, align 8
// CHECK-NEXT:    [[__REINT1_83165:%.*]] = alloca i16, align 2
// CHECK-NEXT:    store <4 x half> [[C:%.*]], ptr [[__REINT_831]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load <4 x i16>, ptr [[__REINT_831]], align 8
...
// CHECK-NEXT:    store <4 x half> [[C]], ptr [[__REINT_83134]], align 8
// CHECK-NEXT:    [[TMP8:%.*]] = load <4 x i16>, ptr [[__REINT_83134]], align 8
// CHECK-NEXT:    [[VGET_LANE38:%.*]] = extractelement <4 x i16> [[TMP8]], i32 2
// CHECK-NEXT:    store i16 [[VGET_LANE38]], ptr [[__REINT1_83135]], align 2
// CHECK-NEXT:    [[TMP9:%.*]] = load half, ptr [[__REINT1_83135]], align 2
// CHECK-NEXT:    [[VECINIT41:%.*]] = insertelement <8 x half> [[VECINIT31]], half [[TMP9]], i32 4
// CHECK-NEXT:    store <4 x half> [[C]], ptr [[__REINT_83144]], align 8
// CHECK-NEXT:    [[TMP10:%.*]] = load <4 x i16>, ptr [[__REINT_83144]], align 8
// CHECK-NEXT:    [[VGET_LANE48:%.*]] = extractelement <4 x i16> [[TMP10]], i32 2
// CHECK-NEXT:    store i16 [[VGET_LANE48]], ptr [[__REINT1_83145]], align 2
// CHECK-NEXT:    [[TMP11:%.*]] = load half, ptr [[__REINT1_83145]], align 2
// CHECK-NEXT:    [[VECINIT51:%.*]] = insertelement <8 x half> [[VECINIT41]], half [[TMP11]], i32 5
// CHECK-NEXT:    store <4 x half> [[C]], ptr [[__REINT_83154]], align 8
// CHECK-NEXT:    [[TMP12:%.*]] = load <4 x i16>, ptr [[__REINT_83154]], align 8
// CHECK-NEXT:    [[VGET_LANE58:%.*]] = extractelement <4 x i16> [[TMP12]], i32 2
// CHECK-NEXT:    store i16 [[VGET_LANE58]], ptr [[__REINT1_83155]], align 2
// CHECK-NEXT:    [[TMP13:%.*]] = load half, ptr [[__REINT1_83155]], align 2
// CHECK-NEXT:    [[VECINIT61:%.*]] = insertelement <8 x half> [[VECINIT51]], half [[TMP13]], i32 6
// CHECK-NEXT:    store <4 x half> [[C]], ptr [[__REINT_83164]], align 8
// CHECK-NEXT:    [[TMP14:%.*]] = load <4 x i16>, ptr [[__REINT_83164]], align 8
// CHECK-NEXT:    [[VGET_LANE68:%.*]] = extractelement <4 x i16> [[TMP14]], i32 2
// CHECK-NEXT:    store i16 [[VGET_LANE68]], ptr [[__REINT1_83165]], align 2
// CHECK-NEXT:    [[TMP15:%.*]] = load half, ptr [[__REINT1_83165]], align 2
// CHECK-NEXT:    [[VECINIT71:%.*]] = insertelement <8 x half> [[VECINIT61]], half [[TMP15]], i32 7
// CHECK-NEXT:    [[TMP16:%.*]] = bitcast <4 x float> [[A:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP17:%.*]] = bitcast <8 x half> [[B:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP18:%.*]] = bitcast <8 x half> [[VECINIT71]] to <16 x b8>
...
// CHECK-NEXT:    [[__REINT_8344:%.*]] = alloca <8 x half>, align 16
// CHECK-NEXT:    [[__REINT1_8345:%.*]] = alloca i16, align 2
// CHECK-NEXT:    [[__REINT_83414:%.*]] = alloca <8 x half>, align 16
// CHECK-NEXT:    [[__REINT1_83415:%.*]] = alloca i16, align 2
// CHECK-NEXT:    [[__REINT_83424:%.*]] = alloca <8 x half>, align 16
// CHECK-NEXT:    [[__REINT1_83425:%.*]] = alloca i16, align 2
// CHECK-NEXT:    store <8 x half> [[C:%.*]], ptr [[__REINT_834]], align 16
// CHECK-NEXT:    [[TMP0:%.*]] = load <8 x i16>, ptr [[__REINT_834]], align 16
// CHECK-NEXT:    [[VGETQ_LANE:%.*]] = extractelement <8 x i16> [[TMP0]], i32 4
// CHECK-NEXT:    store i16 [[VGETQ_LANE]], ptr [[__REINT1_834]], align 2
// CHECK-NEXT:    [[TMP1:%.*]] = load half, ptr [[__REINT1_834]], align 2
// CHECK-NEXT:    [[VECINIT:%.*]] = insertelement <4 x half> poison, half [[TMP1]], i32 0
// CHECK-NEXT:    store <8 x half> [[C]], ptr [[__REINT_8344]], align 16
// CHECK-NEXT:    [[TMP2:%.*]] = load <8 x i16>, ptr [[__REINT_8344]], align 16
// CHECK-NEXT:    [[VGETQ_LANE8:%.*]] = extractelement <8 x i16> [[TMP2]], i32 4
// CHECK-NEXT:    store i16 [[VGETQ_LANE8]], ptr [[__REINT1_8345]], align 2
// CHECK-NEXT:    [[TMP3:%.*]] = load half, ptr [[__REINT1_8345]], align 2
// CHECK-NEXT:    [[VECINIT11:%.*]] = insertelement <4 x half> [[VECINIT]], half [[TMP3]], i32 1
// CHECK-NEXT:    store <8 x half> [[C]], ptr [[__REINT_83414]], align 16
// CHECK-NEXT:    [[TMP4:%.*]] = load <8 x i16>, ptr [[__REINT_83414]], align 16
// CHECK-NEXT:    [[VGETQ_LANE18:%.*]] = extractelement <8 x i16> [[TMP4]], i32 4
// CHECK-NEXT:    store i16 [[VGETQ_LANE18]], ptr [[__REINT1_83415]], align 2
// CHECK-NEXT:    [[TMP5:%.*]] = load half, ptr [[__REINT1_83415]], align 2
// CHECK-NEXT:    [[VECINIT21:%.*]] = insertelement <4 x half> [[VECINIT11]], half [[TMP5]], i32 2
// CHECK-NEXT:    store <8 x half> [[C]], ptr [[__REINT_83424]], align 16
// CHECK-NEXT:    [[TMP6:%.*]] = load <8 x i16>, ptr [[__REINT_83424]], align 16
// CHECK-NEXT:    [[VGETQ_LANE28:%.*]] = extractelement <8 x i16> [[TMP6]], i32 4
// CHECK-NEXT:    store i16 [[VGETQ_LANE28]], ptr [[__REINT1_83425]], align 2
// CHECK-NEXT:    [[TMP7:%.*]] = load half, ptr [[__REINT1_83425]], align 2
// CHECK-NEXT:    [[VECINIT31:%.*]] = insertelement <4 x half> [[VECINIT21]], half [[TMP7]], i32 3
// CHECK-NEXT:    [[TMP8:%.*]] = bitcast <2 x float> [[A:%.*]] to <8 x b8>
// CHECK-NEXT:    [[TMP9:%.*]] = bitcast <4 x half> [[B:%.*]] to <8 x b8>
// CHECK-NEXT:    [[TMP10:%.*]] = bitcast <4 x half> [[VECINIT31]] to <8 x b8>
...
// CHECK-NEXT:    [[__REINT_83424:%.*]] = alloca <8 x half>, align 16
// CHECK-NEXT:    [[__REINT1_83425:%.*]] = alloca i16, align 2
// CHECK-NEXT:    [[__REINT_83434:%.*]] = alloca <8 x half>, align 16
// CHECK-NEXT:    [[__REINT1_83435:%.*]] = alloca i16, align 2
// CHECK-NEXT:    [[__REINT_83444:%.*]] = alloca <8 x half>, align 16
// CHECK-NEXT:    [[__REINT1_83445:%.*]] = alloca i16, align 2
// CHECK-NEXT:    [[__REINT_83454:%.*]] = alloca <8 x half>, align 16
// CHECK-NEXT:    [[__REINT1_83455:%.*]] = alloca i16, align 2
// CHECK-NEXT:    [[__REINT_83464:%.*]] = alloca <8 x half>, align 16
// CHECK-NEXT:    [[__REINT1_83465:%.*]] = alloca i16, align 2
// CHECK-NEXT:    store <8 x half> [[C:%.*]], ptr [[__REINT_834]], align 16
// CHECK-NEXT:    [[TMP0:%.*]] = load <8 x i16>, ptr [[__REINT_834]], align 16
...
// CHECK-NEXT:    [[TMP7:%.*]] = load half, ptr [[__REINT1_83425]], align 2
// CHECK-NEXT:    [[VECINIT31:%.*]] = insertelement <8 x half> [[VECINIT21]], half [[TMP7]], i32 3
// CHECK-NEXT:    store <8 x half> [[C]], ptr [[__REINT_83434]], align 16
// CHECK-NEXT:    [[TMP8:%.*]] = load <8 x i16>, ptr [[__REINT_83434]], align 16
// CHECK-NEXT:    [[VGETQ_LANE38:%.*]] = extractelement <8 x i16> [[TMP8]], i32 6
// CHECK-NEXT:    store i16 [[VGETQ_LANE38]], ptr [[__REINT1_83435]], align 2
// CHECK-NEXT:    [[TMP9:%.*]] = load half, ptr [[__REINT1_83435]], align 2
// CHECK-NEXT:    [[VECINIT41:%.*]] = insertelement <8 x half> [[VECINIT31]], half [[TMP9]], i32 4
// CHECK-NEXT:    store <8 x half> [[C]], ptr [[__REINT_83444]], align 16
// CHECK-NEXT:    [[TMP10:%.*]] = load <8 x i16>, ptr [[__REINT_83444]], align 16
// CHECK-NEXT:    [[VGETQ_LANE48:%.*]] = extractelement <8 x i16> [[TMP10]], i32 6
// CHECK-NEXT:    store i16 [[VGETQ_LANE48]], ptr [[__REINT1_83445]], align 2
// CHECK-NEXT:    [[TMP11:%.*]] = load half, ptr [[__REINT1_83445]], align 2
// CHECK-NEXT:    [[VECINIT51:%.*]] = insertelement <8 x half> [[VECINIT41]], half [[TMP11]], i32 5
// CHECK-NEXT:    store <8 x half> [[C]], ptr [[__REINT_83454]], align 16
// CHECK-NEXT:    [[TMP12:%.*]] = load <8 x i16>, ptr [[__REINT_83454]], align 16
// CHECK-NEXT:    [[VGETQ_LANE58:%.*]] = extractelement <8 x i16> [[TMP12]], i32 6
// CHECK-NEXT:    store i16 [[VGETQ_LANE58]], ptr [[__REINT1_83455]], align 2
// CHECK-NEXT:    [[TMP13:%.*]] = load half, ptr [[__REINT1_83455]], align 2
// CHECK-NEXT:    [[VECINIT61:%.*]] = insertelement <8 x half> [[VECINIT51]], half [[TMP13]], i32 6
// CHECK-NEXT:    store <8 x half> [[C]], ptr [[__REINT_83464]], align 16
// CHECK-NEXT:    [[TMP14:%.*]] = load <8 x i16>, ptr [[__REINT_83464]], align 16
// CHECK-NEXT:    [[VGETQ_LANE68:%.*]] = extractelement <8 x i16> [[TMP14]], i32 6
// CHECK-NEXT:    store i16 [[VGETQ_LANE68]], ptr [[__REINT1_83465]], align 2
// CHECK-NEXT:    [[TMP15:%.*]] = load half, ptr [[__REINT1_83465]], align 2
// CHECK-NEXT:    [[VECINIT71:%.*]] = insertelement <8 x half> [[VECINIT61]], half [[TMP15]], i32 7
// CHECK-NEXT:    [[TMP16:%.*]] = bitcast <4 x float> [[A:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP17:%.*]] = bitcast <8 x half> [[B:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP18:%.*]] = bitcast <8 x half> [[VECINIT71]] to <16 x b8>
