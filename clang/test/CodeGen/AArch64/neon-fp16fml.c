...
// CHECK-NEXT:    [[VFMLAL_LOW_I:%.*]] = bytecast <8 x b8> [[TMP3]] to <2 x float>
// CHECK-NEXT:    [[VFMLAL_LOW1_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <4 x half>
// CHECK-NEXT:    [[VFMLAL_LOW2_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <4 x half>
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <4 x i16> [[TMP1]] to <8 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <4 x i16> [[TMP2]] to <8 x b8>
// CHECK-NEXT:    [[VFMLSL_LOW_I:%.*]] = bytecast <8 x b8> [[TMP3]] to <2 x float>
// CHECK-NEXT:    [[VFMLSL_LOW1_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <4 x half>
// CHECK-NEXT:    [[VFMLSL_LOW2_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <4 x half>
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <4 x i16> [[TMP1]] to <8 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <4 x i16> [[TMP2]] to <8 x b8>
// CHECK-NEXT:    [[VFMLAL_HIGH_I:%.*]] = bytecast <8 x b8> [[TMP3]] to <2 x float>
// CHECK-NEXT:    [[VFMLAL_HIGH1_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <4 x half>
// CHECK-NEXT:    [[VFMLAL_HIGH2_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <4 x half>
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <4 x i16> [[TMP1]] to <8 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <4 x i16> [[TMP2]] to <8 x b8>
// CHECK-NEXT:    [[VFMLSL_HIGH_I:%.*]] = bytecast <8 x b8> [[TMP3]] to <2 x float>
// CHECK-NEXT:    [[VFMLSL_HIGH1_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <4 x half>
// CHECK-NEXT:    [[VFMLSL_HIGH2_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <4 x half>
...
// CHECK-NEXT:    [[VFMLAL_LOW_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <4 x float>
// CHECK-NEXT:    [[VFMLAL_LOW1_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <8 x half>
// CHECK-NEXT:    [[VFMLAL_LOW2_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <8 x half>
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <8 x i16> [[TMP1]] to <16 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <8 x i16> [[TMP2]] to <16 x b8>
// CHECK-NEXT:    [[VFMLSL_LOW_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <4 x float>
// CHECK-NEXT:    [[VFMLSL_LOW1_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <8 x half>
// CHECK-NEXT:    [[VFMLSL_LOW2_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <8 x half>
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <8 x i16> [[TMP1]] to <16 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <8 x i16> [[TMP2]] to <16 x b8>
// CHECK-NEXT:    [[VFMLAL_HIGH_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <4 x float>
// CHECK-NEXT:    [[VFMLAL_HIGH1_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <8 x half>
// CHECK-NEXT:    [[VFMLAL_HIGH2_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <8 x half>
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <8 x i16> [[TMP1]] to <16 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <8 x i16> [[TMP2]] to <16 x b8>
// CHECK-NEXT:    [[VFMLSL_HIGH_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <4 x float>
// CHECK-NEXT:    [[VFMLSL_HIGH1_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <8 x half>
// CHECK-NEXT:    [[VFMLSL_HIGH2_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <8 x half>
...
// CHECK-NEXT:    [[VFMLAL_LOW_I:%.*]] = bytecast <8 x b8> [[TMP11]] to <2 x float>
// CHECK-NEXT:    [[VFMLAL_LOW1_I:%.*]] = bytecast <8 x b8> [[TMP12]] to <4 x half>
// CHECK-NEXT:    [[VFMLAL_LOW2_I:%.*]] = bytecast <8 x b8> [[TMP13]] to <4 x half>
// CHECK-NEXT:    [[VFMLAL_LOW3_I:%.*]] = call <2 x float> @llvm.aarch64.neon.fmlal.v2f32.v4f16(<2 x float> [[VFMLAL_LOW_I]], <4 x half> [[VFMLAL_LOW1_I]], <4 x half> [[VFMLAL_LOW2_I]])
// CHECK-NEXT:    ret <2 x float> [[VFMLAL_LOW3_I]]
//
...
// CHECK-NEXT:    [[TMP12:%.*]] = bitcast <4 x i16> [[TMP9]] to <8 x b8>
// CHECK-NEXT:    [[TMP13:%.*]] = bitcast <4 x i16> [[TMP10]] to <8 x b8>
// CHECK-NEXT:    [[VFMLAL_HIGH_I:%.*]] = bytecast <8 x b8> [[TMP11]] to <2 x float>
// CHECK-NEXT:    [[VFMLAL_HIGH1_I:%.*]] = bytecast <8 x b8> [[TMP12]] to <4 x half>
// CHECK-NEXT:    [[VFMLAL_HIGH2_I:%.*]] = bytecast <8 x b8> [[TMP13]] to <4 x half>
// CHECK-NEXT:    [[VFMLAL_HIGH3_I:%.*]] = call <2 x float> @llvm.aarch64.neon.fmlal2.v2f32.v4f16(<2 x float> [[VFMLAL_HIGH_I]], <4 x half> [[VFMLAL_HIGH1_I]], <4 x half> [[VFMLAL_HIGH2_I]])
// CHECK-NEXT:    ret <2 x float> [[VFMLAL_HIGH3_I]]
//
...
// CHECK-NEXT:    [[VFMLAL_LOW_I:%.*]] = bytecast <16 x b8> [[TMP19]] to <4 x float>
// CHECK-NEXT:    [[VFMLAL_LOW1_I:%.*]] = bytecast <16 x b8> [[TMP20]] to <8 x half>
// CHECK-NEXT:    [[VFMLAL_LOW2_I:%.*]] = bytecast <16 x b8> [[TMP21]] to <8 x half>
// CHECK-NEXT:    [[VFMLAL_LOW3_I:%.*]] = call <4 x float> @llvm.aarch64.neon.fmlal.v4f32.v8f16(<4 x float> [[VFMLAL_LOW_I]], <8 x half> [[VFMLAL_LOW1_I]], <8 x half> [[VFMLAL_LOW2_I]])
// CHECK-NEXT:    ret <4 x float> [[VFMLAL_LOW3_I]]
//
...
// CHECK-NEXT:    [[TMP20:%.*]] = bitcast <8 x i16> [[TMP17]] to <16 x b8>
// CHECK-NEXT:    [[TMP21:%.*]] = bitcast <8 x i16> [[TMP18]] to <16 x b8>
// CHECK-NEXT:    [[VFMLAL_HIGH_I:%.*]] = bytecast <16 x b8> [[TMP19]] to <4 x float>
// CHECK-NEXT:    [[VFMLAL_HIGH1_I:%.*]] = bytecast <16 x b8> [[TMP20]] to <8 x half>
// CHECK-NEXT:    [[VFMLAL_HIGH2_I:%.*]] = bytecast <16 x b8> [[TMP21]] to <8 x half>
// CHECK-NEXT:    [[VFMLAL_HIGH3_I:%.*]] = call <4 x float> @llvm.aarch64.neon.fmlal2.v4f32.v8f16(<4 x float> [[VFMLAL_HIGH_I]], <8 x half> [[VFMLAL_HIGH1_I]], <8 x half> [[VFMLAL_HIGH2_I]])
// CHECK-NEXT:    ret <4 x float> [[VFMLAL_HIGH3_I]]
//
...
// CHECK-NEXT:    [[TMP12:%.*]] = bitcast <4 x i16> [[TMP9]] to <8 x b8>
// CHECK-NEXT:    [[TMP13:%.*]] = bitcast <4 x i16> [[TMP10]] to <8 x b8>
// CHECK-NEXT:    [[VFMLSL_LOW_I:%.*]] = bytecast <8 x b8> [[TMP11]] to <2 x float>
// CHECK-NEXT:    [[VFMLSL_LOW1_I:%.*]] = bytecast <8 x b8> [[TMP12]] to <4 x half>
// CHECK-NEXT:    [[VFMLSL_LOW2_I:%.*]] = bytecast <8 x b8> [[TMP13]] to <4 x half>
// CHECK-NEXT:    [[VFMLSL_LOW3_I:%.*]] = call <2 x float> @llvm.aarch64.neon.fmlsl.v2f32.v4f16(<2 x float> [[VFMLSL_LOW_I]], <4 x half> [[VFMLSL_LOW1_I]], <4 x half> [[VFMLSL_LOW2_I]])
// CHECK-NEXT:    ret <2 x float> [[VFMLSL_LOW3_I]]
//
...
// CHECK-NEXT:    [[TMP12:%.*]] = bitcast <4 x i16> [[TMP9]] to <8 x b8>
// CHECK-NEXT:    [[TMP13:%.*]] = bitcast <4 x i16> [[TMP10]] to <8 x b8>
// CHECK-NEXT:    [[VFMLSL_HIGH_I:%.*]] = bytecast <8 x b8> [[TMP11]] to <2 x float>
// CHECK-NEXT:    [[VFMLSL_HIGH1_I:%.*]] = bytecast <8 x b8> [[TMP12]] to <4 x half>
// CHECK-NEXT:    [[VFMLSL_HIGH2_I:%.*]] = bytecast <8 x b8> [[TMP13]] to <4 x half>
// CHECK-NEXT:    [[VFMLSL_HIGH3_I:%.*]] = call <2 x float> @llvm.aarch64.neon.fmlsl2.v2f32.v4f16(<2 x float> [[VFMLSL_HIGH_I]], <4 x half> [[VFMLSL_HIGH1_I]], <4 x half> [[VFMLSL_HIGH2_I]])
// CHECK-NEXT:    ret <2 x float> [[VFMLSL_HIGH3_I]]
//
...
// CHECK-NEXT:    [[TMP20:%.*]] = bitcast <8 x i16> [[TMP17]] to <16 x b8>
// CHECK-NEXT:    [[TMP21:%.*]] = bitcast <8 x i16> [[TMP18]] to <16 x b8>
// CHECK-NEXT:    [[VFMLSL_LOW_I:%.*]] = bytecast <16 x b8> [[TMP19]] to <4 x float>
// CHECK-NEXT:    [[VFMLSL_LOW1_I:%.*]] = bytecast <16 x b8> [[TMP20]] to <8 x half>
// CHECK-NEXT:    [[VFMLSL_LOW2_I:%.*]] = bytecast <16 x b8> [[TMP21]] to <8 x half>
// CHECK-NEXT:    [[VFMLSL_LOW3_I:%.*]] = call <4 x float> @llvm.aarch64.neon.fmlsl.v4f32.v8f16(<4 x float> [[VFMLSL_LOW_I]], <8 x half> [[VFMLSL_LOW1_I]], <8 x half> [[VFMLSL_LOW2_I]])
// CHECK-NEXT:    ret <4 x float> [[VFMLSL_LOW3_I]]
//
...
// CHECK-NEXT:    [[TMP20:%.*]] = bitcast <8 x i16> [[TMP17]] to <16 x b8>
// CHECK-NEXT:    [[TMP21:%.*]] = bitcast <8 x i16> [[TMP18]] to <16 x b8>
// CHECK-NEXT:    [[VFMLSL_HIGH_I:%.*]] = bytecast <16 x b8> [[TMP19]] to <4 x float>
// CHECK-NEXT:    [[VFMLSL_HIGH1_I:%.*]] = bytecast <16 x b8> [[TMP20]] to <8 x half>
// CHECK-NEXT:    [[VFMLSL_HIGH2_I:%.*]] = bytecast <16 x b8> [[TMP21]] to <8 x half>
// CHECK-NEXT:    [[VFMLSL_HIGH3_I:%.*]] = call <4 x float> @llvm.aarch64.neon.fmlsl2.v4f32.v8f16(<4 x float> [[VFMLSL_HIGH_I]], <8 x half> [[VFMLSL_HIGH1_I]], <8 x half> [[VFMLSL_HIGH2_I]])
// CHECK-NEXT:    ret <4 x float> [[VFMLSL_HIGH3_I]]
//
