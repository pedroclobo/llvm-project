...
// CHECK-LABEL: define dso_local <8 x b8> @test_vceqz_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = icmp eq <8 x i8> [[TMP0]], zeroinitializer
// CHECK-NEXT:    [[VCEQZ_I:%.*]] = sext <8 x i1> [[TMP1]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[VCEQZ_I]] to <8 x b8>
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <4 x i16>
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <2 x i32>
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <1 x i64>
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vceqzq_s8(
...
// CHECK-NEXT:    [[VCEQZ_I:%.*]] = sext <16 x i1> [[TMP1]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[VCEQZ_I]] to <16 x b8>
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x i16>
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <4 x i32>
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <2 x i64>
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vceqz_u8(
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vceqzq_u8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = icmp eq <16 x i8> [[TMP0]], zeroinitializer
...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <1 x i64> [[__P0_ADDR_I_SROA_0_0_VEC_INSERT]] to <8 x b8>
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <1 x double>
...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vceqz_p8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = icmp eq <8 x i8> [[TMP0]], zeroinitializer
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vceqzq_p8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = icmp eq <16 x i8> [[TMP0]], zeroinitializer
...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x double>
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vcgez_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = icmp sge <8 x i8> [[TMP0]], zeroinitializer
// CHECK-NEXT:    [[VCGEZ_I:%.*]] = sext <8 x i1> [[TMP1]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[VCGEZ_I]] to <8 x b8>
// CHECK-NEXT:    ret <8 x b8> [[TMP2]]
//
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vcgezq_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = icmp sge <16 x i8> [[TMP0]], zeroinitializer
// CHECK-NEXT:    [[VCGEZ_I:%.*]] = sext <16 x i1> [[TMP1]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[VCGEZ_I]] to <16 x b8>
// CHECK-NEXT:    ret <16 x b8> [[TMP2]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vclez_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = icmp sle <8 x i8> [[TMP0]], zeroinitializer
// CHECK-NEXT:    [[VCLEZ_I:%.*]] = sext <8 x i1> [[TMP1]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[VCLEZ_I]] to <8 x b8>
// CHECK-NEXT:    ret <8 x b8> [[TMP2]]
//
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vclezq_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = icmp sle <16 x i8> [[TMP0]], zeroinitializer
// CHECK-NEXT:    [[VCLEZ_I:%.*]] = sext <16 x i1> [[TMP1]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[VCLEZ_I]] to <16 x b8>
// CHECK-NEXT:    ret <16 x b8> [[TMP2]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vcgtz_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = icmp sgt <8 x i8> [[TMP0]], zeroinitializer
// CHECK-NEXT:    [[VCGTZ_I:%.*]] = sext <8 x i1> [[TMP1]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[VCGTZ_I]] to <8 x b8>
// CHECK-NEXT:    ret <8 x b8> [[TMP2]]
//
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vcgtzq_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = icmp sgt <16 x i8> [[TMP0]], zeroinitializer
// CHECK-NEXT:    [[VCGTZ_I:%.*]] = sext <16 x i1> [[TMP1]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[VCGTZ_I]] to <16 x b8>
// CHECK-NEXT:    ret <16 x b8> [[TMP2]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vcltz_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = icmp slt <8 x i8> [[TMP0]], zeroinitializer
// CHECK-NEXT:    [[VCLTZ_I:%.*]] = sext <8 x i1> [[TMP1]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[VCLTZ_I]] to <8 x b8>
// CHECK-NEXT:    ret <8 x b8> [[TMP2]]
//
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vcltzq_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = icmp slt <16 x i8> [[TMP0]], zeroinitializer
// CHECK-NEXT:    [[VCLTZ_I:%.*]] = sext <16 x i1> [[TMP1]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[VCLTZ_I]] to <16 x b8>
// CHECK-NEXT:    ret <16 x b8> [[TMP2]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vrev16_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[A]], <8 x i32> <i32 1, i32 0, i32 3, i32 2, i32 5, i32 4, i32 7, i32 6>
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vrev16_u8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[A]], <8 x i32> <i32 1, i32 0, i32 3, i32 2, i32 5, i32 4, i32 7, i32 6>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vrev16_p8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[A]], <8 x i32> <i32 1, i32 0, i32 3, i32 2, i32 5, i32 4, i32 7, i32 6>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vrev16q_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[A]], <16 x i32> <i32 1, i32 0, i32 3, i32 2, i32 5, i32 4, i32 7, i32 6, i32 9, i32 8, i32 11, i32 10, i32 13, i32 12, i32 15, i32 14>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
//
int8x16_t test_vrev16q_s8(int8x16_t a) {
  return vrev16q_s8(a);
}

// CHECK-LABEL: define dso_local <16 x b8> @test_vrev16q_u8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[A]], <16 x i32> <i32 1, i32 0, i32 3, i32 2, i32 5, i32 4, i32 7, i32 6, i32 9, i32 8, i32 11, i32 10, i32 13, i32 12, i32 15, i32 14>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vrev16q_p8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[A]], <16 x i32> <i32 1, i32 0, i32 3, i32 2, i32 5, i32 4, i32 7, i32 6, i32 9, i32 8, i32 11, i32 10, i32 13, i32 12, i32 15, i32 14>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vrev32_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[A]], <8 x i32> <i32 3, i32 2, i32 1, i32 0, i32 7, i32 6, i32 5, i32 4>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vrev32_u8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[A]], <8 x i32> <i32 3, i32 2, i32 1, i32 0, i32 7, i32 6, i32 5, i32 4>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vrev32_p8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[A]], <8 x i32> <i32 3, i32 2, i32 1, i32 0, i32 7, i32 6, i32 5, i32 4>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vrev32q_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[A]], <16 x i32> <i32 3, i32 2, i32 1, i32 0, i32 7, i32 6, i32 5, i32 4, i32 11, i32 10, i32 9, i32 8, i32 15, i32 14, i32 13, i32 12>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
//
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vrev32q_u8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[A]], <16 x i32> <i32 3, i32 2, i32 1, i32 0, i32 7, i32 6, i32 5, i32 4, i32 11, i32 10, i32 9, i32 8, i32 15, i32 14, i32 13, i32 12>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vrev32q_p8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[A]], <16 x i32> <i32 3, i32 2, i32 1, i32 0, i32 7, i32 6, i32 5, i32 4, i32 11, i32 10, i32 9, i32 8, i32 15, i32 14, i32 13, i32 12>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vrev64_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[A]], <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vrev64_u8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[A]], <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vrev64_p8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[A]], <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vrev64q_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[A]], <16 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0, i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
//
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vrev64q_u8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[A]], <16 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0, i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vrev64q_p8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[A]], <16 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0, i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
...
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VPADDL_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VPADDL1_I:%.*]] = call <4 x i16> @llvm.aarch64.neon.saddlp.v4i16.v8i8(<8 x i8> [[VPADDL_I]])
// CHECK-NEXT:    ret <4 x i16> [[VPADDL1_I]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i16> [[A]] to <8 x b8>
// CHECK-NEXT:    [[VPADDL_I:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <4 x i16>
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x i32> [[A]] to <8 x b8>
// CHECK-NEXT:    [[VPADDL_I:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <2 x i32>
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VPADDL_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VPADDL1_I:%.*]] = call <4 x i16> @llvm.aarch64.neon.uaddlp.v4i16.v8i8(<8 x i8> [[VPADDL_I]])
// CHECK-NEXT:    ret <4 x i16> [[VPADDL1_I]]
//
...
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VPADDL_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VPADDL1_I:%.*]] = call <8 x i16> @llvm.aarch64.neon.saddlp.v8i16.v16i8(<16 x i8> [[VPADDL_I]])
// CHECK-NEXT:    ret <8 x i16> [[VPADDL1_I]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VPADDL_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x i16>
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i32> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VPADDL_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <4 x i32>
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VPADDL_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VPADDL1_I:%.*]] = call <8 x i16> @llvm.aarch64.neon.uaddlp.v8i16.v16i8(<16 x i8> [[VPADDL_I]])
// CHECK-NEXT:    ret <8 x i16> [[VPADDL1_I]]
//
...
// CHECK-SAME: <4 x i16> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i16> [[A]] to <8 x b8>
// CHECK-NEXT:    [[VPADAL_I:%.*]] = bytecast exact <8 x b8> [[B]] to <8 x i8>
// CHECK-NEXT:    [[VPADAL1_I:%.*]] = call <4 x i16> @llvm.aarch64.neon.saddlp.v4i16.v8i8(<8 x i8> [[VPADAL_I]])
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <4 x i16>
// CHECK-NEXT:    [[TMP2:%.*]] = add <4 x i16> [[VPADAL1_I]], [[TMP1]]
...
// CHECK-NEXT:    [[VPADAL_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <4 x i16>
...
// CHECK-NEXT:    [[VPADAL_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x i32>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i16> [[A]] to <8 x b8>
// CHECK-NEXT:    [[VPADAL_I:%.*]] = bytecast exact <8 x b8> [[B]] to <8 x i8>
// CHECK-NEXT:    [[VPADAL1_I:%.*]] = call <4 x i16> @llvm.aarch64.neon.uaddlp.v4i16.v8i8(<8 x i8> [[VPADAL_I]])
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <4 x i16>
// CHECK-NEXT:    [[TMP2:%.*]] = add <4 x i16> [[VPADAL1_I]], [[TMP1]]
// CHECK-NEXT:    ret <4 x i16> [[TMP2]]
//
...
// CHECK-SAME: <8 x i16> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VPADAL_I:%.*]] = bytecast exact <16 x b8> [[B]] to <16 x i8>
// CHECK-NEXT:    [[VPADAL1_I:%.*]] = call <8 x i16> @llvm.aarch64.neon.saddlp.v8i16.v16i8(<16 x i8> [[VPADAL_I]])
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x i16>
// CHECK-NEXT:    [[TMP2:%.*]] = add <8 x i16> [[VPADAL1_I]], [[TMP1]]
...
// CHECK-NEXT:    [[VPADAL_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <8 x i16>
...
// CHECK-NEXT:    [[VPADAL_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x i32>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VPADAL_I:%.*]] = bytecast exact <16 x b8> [[B]] to <16 x i8>
// CHECK-NEXT:    [[VPADAL1_I:%.*]] = call <8 x i16> @llvm.aarch64.neon.uaddlp.v8i16.v16i8(<16 x i8> [[VPADAL_I]])
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x i16>
// CHECK-NEXT:    [[TMP2:%.*]] = add <8 x i16> [[VPADAL1_I]], [[TMP1]]
// CHECK-NEXT:    ret <8 x i16> [[TMP2]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vqabs_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VQABS_V_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VQABS_V1_I:%.*]] = call <8 x i8> @llvm.aarch64.neon.sqabs.v8i8(<8 x i8> [[VQABS_V_I]])
// CHECK-NEXT:    [[VQABS_V2_I:%.*]] = bitcast <8 x i8> [[VQABS_V1_I]] to <8 x b8>
// CHECK-NEXT:    ret <8 x b8> [[VQABS_V2_I]]
//
int8x8_t test_vqabs_s8(int8x8_t a) {
  return vqabs_s8(a);
}

// CHECK-LABEL: define dso_local <16 x b8> @test_vqabsq_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VQABSQ_V_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VQABSQ_V1_I:%.*]] = call <16 x i8> @llvm.aarch64.neon.sqabs.v16i8(<16 x i8> [[VQABSQ_V_I]])
// CHECK-NEXT:    [[VQABSQ_V2_I:%.*]] = bitcast <16 x i8> [[VQABSQ_V1_I]] to <16 x b8>
// CHECK-NEXT:    ret <16 x b8> [[VQABSQ_V2_I]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i16> [[A]] to <8 x b8>
// CHECK-NEXT:    [[VQABS_V_I:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <4 x i16>
// CHECK-NEXT:    [[VQABS_V1_I:%.*]] = call <4 x i16> @llvm.aarch64.neon.sqabs.v4i16(<4 x i16> [[VQABS_V_I]])
// CHECK-NEXT:    [[VQABS_V2_I:%.*]] = bitcast <4 x i16> [[VQABS_V1_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VQABS_V2_I]] to <4 x i16>
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VQABSQ_V_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x i16>
// CHECK-NEXT:    [[VQABSQ_V1_I:%.*]] = call <8 x i16> @llvm.aarch64.neon.sqabs.v8i16(<8 x i16> [[VQABSQ_V_I]])
// CHECK-NEXT:    [[VQABSQ_V2_I:%.*]] = bitcast <8 x i16> [[VQABSQ_V1_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VQABSQ_V2_I]] to <8 x i16>
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x i32> [[A]] to <8 x b8>
// CHECK-NEXT:    [[VQABS_V_I:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <2 x i32>
// CHECK-NEXT:    [[VQABS_V1_I:%.*]] = call <2 x i32> @llvm.aarch64.neon.sqabs.v2i32(<2 x i32> [[VQABS_V_I]])
// CHECK-NEXT:    [[VQABS_V2_I:%.*]] = bitcast <2 x i32> [[VQABS_V1_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VQABS_V2_I]] to <2 x i32>
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i32> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VQABSQ_V_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[VQABSQ_V1_I:%.*]] = call <4 x i32> @llvm.aarch64.neon.sqabs.v4i32(<4 x i32> [[VQABSQ_V_I]])
// CHECK-NEXT:    [[VQABSQ_V2_I:%.*]] = bitcast <4 x i32> [[VQABSQ_V1_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VQABSQ_V2_I]] to <4 x i32>
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x i64> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VQABSQ_V_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <2 x i64>
// CHECK-NEXT:    [[VQABSQ_V1_I:%.*]] = call <2 x i64> @llvm.aarch64.neon.sqabs.v2i64(<2 x i64> [[VQABSQ_V_I]])
// CHECK-NEXT:    [[VQABSQ_V2_I:%.*]] = bitcast <2 x i64> [[VQABSQ_V1_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VQABSQ_V2_I]] to <2 x i64>
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vqneg_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VQNEG_V_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VQNEG_V1_I:%.*]] = call <8 x i8> @llvm.aarch64.neon.sqneg.v8i8(<8 x i8> [[VQNEG_V_I]])
// CHECK-NEXT:    [[VQNEG_V2_I:%.*]] = bitcast <8 x i8> [[VQNEG_V1_I]] to <8 x b8>
// CHECK-NEXT:    ret <8 x b8> [[VQNEG_V2_I]]
//
int8x8_t test_vqneg_s8(int8x8_t a) {
  return vqneg_s8(a);
}

// CHECK-LABEL: define dso_local <16 x b8> @test_vqnegq_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VQNEGQ_V_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VQNEGQ_V1_I:%.*]] = call <16 x i8> @llvm.aarch64.neon.sqneg.v16i8(<16 x i8> [[VQNEGQ_V_I]])
// CHECK-NEXT:    [[VQNEGQ_V2_I:%.*]] = bitcast <16 x i8> [[VQNEGQ_V1_I]] to <16 x b8>
// CHECK-NEXT:    ret <16 x b8> [[VQNEGQ_V2_I]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i16> [[A]] to <8 x b8>
// CHECK-NEXT:    [[VQNEG_V_I:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <4 x i16>
// CHECK-NEXT:    [[VQNEG_V1_I:%.*]] = call <4 x i16> @llvm.aarch64.neon.sqneg.v4i16(<4 x i16> [[VQNEG_V_I]])
// CHECK-NEXT:    [[VQNEG_V2_I:%.*]] = bitcast <4 x i16> [[VQNEG_V1_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VQNEG_V2_I]] to <4 x i16>
// CHECK-NEXT:    ret <4 x i16> [[TMP1]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VQNEGQ_V_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x i16>
// CHECK-NEXT:    [[VQNEGQ_V1_I:%.*]] = call <8 x i16> @llvm.aarch64.neon.sqneg.v8i16(<8 x i16> [[VQNEGQ_V_I]])
// CHECK-NEXT:    [[VQNEGQ_V2_I:%.*]] = bitcast <8 x i16> [[VQNEGQ_V1_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VQNEGQ_V2_I]] to <8 x i16>
// CHECK-NEXT:    ret <8 x i16> [[TMP1]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x i32> [[A]] to <8 x b8>
// CHECK-NEXT:    [[VQNEG_V_I:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <2 x i32>
// CHECK-NEXT:    [[VQNEG_V1_I:%.*]] = call <2 x i32> @llvm.aarch64.neon.sqneg.v2i32(<2 x i32> [[VQNEG_V_I]])
// CHECK-NEXT:    [[VQNEG_V2_I:%.*]] = bitcast <2 x i32> [[VQNEG_V1_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VQNEG_V2_I]] to <2 x i32>
// CHECK-NEXT:    ret <2 x i32> [[TMP1]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i32> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VQNEGQ_V_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[VQNEGQ_V1_I:%.*]] = call <4 x i32> @llvm.aarch64.neon.sqneg.v4i32(<4 x i32> [[VQNEGQ_V_I]])
// CHECK-NEXT:    [[VQNEGQ_V2_I:%.*]] = bitcast <4 x i32> [[VQNEGQ_V1_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VQNEGQ_V2_I]] to <4 x i32>
// CHECK-NEXT:    ret <4 x i32> [[TMP1]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x i64> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VQNEGQ_V_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <2 x i64>
// CHECK-NEXT:    [[VQNEGQ_V1_I:%.*]] = call <2 x i64> @llvm.aarch64.neon.sqneg.v2i64(<2 x i64> [[VQNEGQ_V_I]])
// CHECK-NEXT:    [[VQNEGQ_V2_I:%.*]] = bitcast <2 x i64> [[VQNEGQ_V1_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VQNEGQ_V2_I]] to <2 x i64>
// CHECK-NEXT:    ret <2 x i64> [[TMP1]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vneg_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[EXT_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[SUB_I:%.*]] = sub <8 x i8> zeroinitializer, [[EXT_I]]
// CHECK-NEXT:    [[UNPROMOTION_I:%.*]] = bitcast <8 x i8> [[SUB_I]] to <8 x b8>
// CHECK-NEXT:    ret <8 x b8> [[UNPROMOTION_I]]
//
int8x8_t test_vneg_s8(int8x8_t a) {
  return vneg_s8(a);
}

// CHECK-LABEL: define dso_local <16 x b8> @test_vnegq_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[EXT_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[SUB_I:%.*]] = sub <16 x i8> zeroinitializer, [[EXT_I]]
// CHECK-NEXT:    [[UNPROMOTION_I:%.*]] = bitcast <16 x i8> [[SUB_I]] to <16 x b8>
// CHECK-NEXT:    ret <16 x b8> [[UNPROMOTION_I]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vabs_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VABS_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VABS1_I:%.*]] = call <8 x i8> @llvm.aarch64.neon.abs.v8i8(<8 x i8> [[VABS_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i8> [[VABS1_I]] to <8 x b8>
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vabsq_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VABS_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VABS1_I:%.*]] = call <16 x i8> @llvm.aarch64.neon.abs.v16i8(<16 x i8> [[VABS_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <16 x i8> [[VABS1_I]] to <16 x b8>
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i16> [[A]] to <8 x b8>
// CHECK-NEXT:    [[VABS_I:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <4 x i16>
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VABS_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x i16>
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x i32> [[A]] to <8 x b8>
// CHECK-NEXT:    [[VABS_I:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <2 x i32>
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i32> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VABS_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <4 x i32>
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x i64> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VABS_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <2 x i64>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VABS_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VABS_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x double> [[A]] to <2 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i64> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VABS_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x double>
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vuqadd_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VUQADD_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VUQADD1_I:%.*]] = bytecast exact <8 x b8> [[B]] to <8 x i8>
// CHECK-NEXT:    [[VUQADD2_I:%.*]] = call <8 x i8> @llvm.aarch64.neon.suqadd.v8i8(<8 x i8> [[VUQADD_I]], <8 x i8> [[VUQADD1_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i8> [[VUQADD2_I]] to <8 x b8>
// CHECK-NEXT:    ret <8 x b8> [[TMP0]]
//
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vuqaddq_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VUQADD_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VUQADD1_I:%.*]] = bytecast exact <16 x b8> [[B]] to <16 x i8>
// CHECK-NEXT:    [[VUQADD2_I:%.*]] = call <16 x i8> @llvm.aarch64.neon.suqadd.v16i8(<16 x i8> [[VUQADD_I]], <16 x i8> [[VUQADD1_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <16 x i8> [[VUQADD2_I]] to <16 x b8>
// CHECK-NEXT:    ret <16 x b8> [[TMP0]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i16> [[A]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i16> [[B]] to <8 x b8>
// CHECK-NEXT:    [[VUQADD_I:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <4 x i16>
// CHECK-NEXT:    [[VUQADD1_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <4 x i16>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[A]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <8 x i16> [[B]] to <16 x b8>
// CHECK-NEXT:    [[VUQADD_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x i16>
// CHECK-NEXT:    [[VUQADD1_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <8 x i16>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x i32> [[A]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[B]] to <8 x b8>
// CHECK-NEXT:    [[VUQADD_I:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <2 x i32>
// CHECK-NEXT:    [[VUQADD1_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x i32>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i32> [[A]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[B]] to <16 x b8>
// CHECK-NEXT:    [[VUQADD_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[VUQADD1_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x i32>
...
// CHECK-NEXT:    [[VUQADD_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <2 x i64>
// CHECK-NEXT:    [[VUQADD1_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x i64>
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vcls_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VCLS_V_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VCLS_V1_I:%.*]] = call <8 x i8> @llvm.aarch64.neon.cls.v8i8(<8 x i8> [[VCLS_V_I]])
// CHECK-NEXT:    [[VCLS_V2_I:%.*]] = bitcast <8 x i8> [[VCLS_V1_I]] to <8 x b8>
// CHECK-NEXT:    ret <8 x b8> [[VCLS_V2_I]]
//
int8x8_t test_vcls_s8(int8x8_t a) {
  return vcls_s8(a);
}

// CHECK-LABEL: define dso_local <8 x b8> @test_vcls_u8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VCLS_V_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VCLS_V1_I:%.*]] = call <8 x i8> @llvm.aarch64.neon.cls.v8i8(<8 x i8> [[VCLS_V_I]])
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vclsq_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VCLSQ_V_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VCLSQ_V1_I:%.*]] = call <16 x i8> @llvm.aarch64.neon.cls.v16i8(<16 x i8> [[VCLSQ_V_I]])
// CHECK-NEXT:    [[VCLSQ_V2_I:%.*]] = bitcast <16 x i8> [[VCLSQ_V1_I]] to <16 x b8>
// CHECK-NEXT:    ret <16 x b8> [[VCLSQ_V2_I]]
//
int8x16_t test_vclsq_s8(int8x16_t a) {
  return vclsq_s8(a);
}

// CHECK-LABEL: define dso_local <16 x b8> @test_vclsq_u8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VCLSQ_V_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VCLSQ_V1_I:%.*]] = call <16 x i8> @llvm.aarch64.neon.cls.v16i8(<16 x i8> [[VCLSQ_V_I]])
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i16> [[A]] to <8 x b8>
// CHECK-NEXT:    [[VCLS_V_I:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <4 x i16>
// CHECK-NEXT:    [[VCLS_V1_I:%.*]] = call <4 x i16> @llvm.aarch64.neon.cls.v4i16(<4 x i16> [[VCLS_V_I]])
// CHECK-NEXT:    [[VCLS_V2_I:%.*]] = bitcast <4 x i16> [[VCLS_V1_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VCLS_V2_I]] to <4 x i16>
// CHECK-NEXT:    ret <4 x i16> [[TMP1]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VCLSQ_V_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x i16>
// CHECK-NEXT:    [[VCLSQ_V1_I:%.*]] = call <8 x i16> @llvm.aarch64.neon.cls.v8i16(<8 x i16> [[VCLSQ_V_I]])
// CHECK-NEXT:    [[VCLSQ_V2_I:%.*]] = bitcast <8 x i16> [[VCLSQ_V1_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VCLSQ_V2_I]] to <8 x i16>
// CHECK-NEXT:    ret <8 x i16> [[TMP1]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x i32> [[A]] to <8 x b8>
// CHECK-NEXT:    [[VCLS_V_I:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <2 x i32>
// CHECK-NEXT:    [[VCLS_V1_I:%.*]] = call <2 x i32> @llvm.aarch64.neon.cls.v2i32(<2 x i32> [[VCLS_V_I]])
// CHECK-NEXT:    [[VCLS_V2_I:%.*]] = bitcast <2 x i32> [[VCLS_V1_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VCLS_V2_I]] to <2 x i32>
// CHECK-NEXT:    ret <2 x i32> [[TMP1]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i32> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VCLSQ_V_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[VCLSQ_V1_I:%.*]] = call <4 x i32> @llvm.aarch64.neon.cls.v4i32(<4 x i32> [[VCLSQ_V_I]])
// CHECK-NEXT:    [[VCLSQ_V2_I:%.*]] = bitcast <4 x i32> [[VCLSQ_V1_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VCLSQ_V2_I]] to <4 x i32>
// CHECK-NEXT:    ret <4 x i32> [[TMP1]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vclz_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VCLZ_V_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VCLZ_V1_I:%.*]] = call <8 x i8> @llvm.ctlz.v8i8(<8 x i8> [[VCLZ_V_I]], i1 false)
// CHECK-NEXT:    [[VCLZ_V2_I:%.*]] = bitcast <8 x i8> [[VCLZ_V1_I]] to <8 x b8>
// CHECK-NEXT:    ret <8 x b8> [[VCLZ_V2_I]]
//
int8x8_t test_vclz_s8(int8x8_t a) {
  return vclz_s8(a);
}

// CHECK-LABEL: define dso_local <16 x b8> @test_vclzq_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VCLZQ_V_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VCLZQ_V1_I:%.*]] = call <16 x i8> @llvm.ctlz.v16i8(<16 x i8> [[VCLZQ_V_I]], i1 false)
// CHECK-NEXT:    [[VCLZQ_V2_I:%.*]] = bitcast <16 x i8> [[VCLZQ_V1_I]] to <16 x b8>
// CHECK-NEXT:    ret <16 x b8> [[VCLZQ_V2_I]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i16> [[A]] to <8 x b8>
// CHECK-NEXT:    [[VCLZ_V_I:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <4 x i16>
// CHECK-NEXT:    [[VCLZ_V1_I:%.*]] = call <4 x i16> @llvm.ctlz.v4i16(<4 x i16> [[VCLZ_V_I]], i1 false)
// CHECK-NEXT:    [[VCLZ_V2_I:%.*]] = bitcast <4 x i16> [[VCLZ_V1_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VCLZ_V2_I]] to <4 x i16>
// CHECK-NEXT:    ret <4 x i16> [[TMP1]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VCLZQ_V_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x i16>
// CHECK-NEXT:    [[VCLZQ_V1_I:%.*]] = call <8 x i16> @llvm.ctlz.v8i16(<8 x i16> [[VCLZQ_V_I]], i1 false)
// CHECK-NEXT:    [[VCLZQ_V2_I:%.*]] = bitcast <8 x i16> [[VCLZQ_V1_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VCLZQ_V2_I]] to <8 x i16>
// CHECK-NEXT:    ret <8 x i16> [[TMP1]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x i32> [[A]] to <8 x b8>
// CHECK-NEXT:    [[VCLZ_V_I:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <2 x i32>
// CHECK-NEXT:    [[VCLZ_V1_I:%.*]] = call <2 x i32> @llvm.ctlz.v2i32(<2 x i32> [[VCLZ_V_I]], i1 false)
// CHECK-NEXT:    [[VCLZ_V2_I:%.*]] = bitcast <2 x i32> [[VCLZ_V1_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VCLZ_V2_I]] to <2 x i32>
// CHECK-NEXT:    ret <2 x i32> [[TMP1]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i32> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VCLZQ_V_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[VCLZQ_V1_I:%.*]] = call <4 x i32> @llvm.ctlz.v4i32(<4 x i32> [[VCLZQ_V_I]], i1 false)
// CHECK-NEXT:    [[VCLZQ_V2_I:%.*]] = bitcast <4 x i32> [[VCLZQ_V1_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VCLZQ_V2_I]] to <4 x i32>
// CHECK-NEXT:    ret <4 x i32> [[TMP1]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vclz_u8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VCLZ_V_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VCLZ_V1_I:%.*]] = call <8 x i8> @llvm.ctlz.v8i8(<8 x i8> [[VCLZ_V_I]], i1 false)
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vclzq_u8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VCLZQ_V_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VCLZQ_V1_I:%.*]] = call <16 x i8> @llvm.ctlz.v16i8(<16 x i8> [[VCLZQ_V_I]], i1 false)
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vcnt_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VCNT_V_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VCNT_V1_I:%.*]] = call <8 x i8> @llvm.ctpop.v8i8(<8 x i8> [[VCNT_V_I]])
// CHECK-NEXT:    [[VCNT_V2_I:%.*]] = bitcast <8 x i8> [[VCNT_V1_I]] to <8 x b8>
// CHECK-NEXT:    ret <8 x b8> [[VCNT_V2_I]]
//
int8x8_t test_vcnt_s8(int8x8_t a) {
  return vcnt_s8(a);
}

// CHECK-LABEL: define dso_local <16 x b8> @test_vcntq_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VCNTQ_V_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VCNTQ_V1_I:%.*]] = call <16 x i8> @llvm.ctpop.v16i8(<16 x i8> [[VCNTQ_V_I]])
// CHECK-NEXT:    [[VCNTQ_V2_I:%.*]] = bitcast <16 x i8> [[VCNTQ_V1_I]] to <16 x b8>
// CHECK-NEXT:    ret <16 x b8> [[VCNTQ_V2_I]]
//
int8x16_t test_vcntq_s8(int8x16_t a) {
  return vcntq_s8(a);
}

// CHECK-LABEL: define dso_local <8 x b8> @test_vcnt_u8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VCNT_V_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VCNT_V1_I:%.*]] = call <8 x i8> @llvm.ctpop.v8i8(<8 x i8> [[VCNT_V_I]])
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vcntq_u8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VCNTQ_V_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VCNTQ_V1_I:%.*]] = call <16 x i8> @llvm.ctpop.v16i8(<16 x i8> [[VCNTQ_V_I]])
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vcnt_p8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VCNT_V_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VCNT_V1_I:%.*]] = call <8 x i8> @llvm.ctpop.v8i8(<8 x i8> [[VCNT_V_I]])
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vcntq_p8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VCNTQ_V_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VCNTQ_V1_I:%.*]] = call <16 x i8> @llvm.ctpop.v16i8(<16 x i8> [[VCNTQ_V_I]])
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vmvn_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[CONV_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[NOT_I:%.*]] = xor <8 x i8> [[CONV_I]], splat (i8 -1)
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i8> [[NOT_I]] to <8 x b8>
// CHECK-NEXT:    ret <8 x b8> [[TMP0]]
//
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vmvnq_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[CONV_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[NOT_I:%.*]] = xor <16 x i8> [[CONV_I]], splat (i8 -1)
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <16 x i8> [[NOT_I]] to <16 x b8>
// CHECK-NEXT:    ret <16 x b8> [[TMP0]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vmvn_u8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[CONV_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[NOT_I:%.*]] = xor <8 x i8> [[CONV_I]], splat (i8 -1)
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vmvnq_u8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[CONV_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[NOT_I:%.*]] = xor <16 x i8> [[CONV_I]], splat (i8 -1)
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vmvn_p8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[CONV_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[NOT_I:%.*]] = xor <8 x i8> [[CONV_I]], splat (i8 -1)
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vmvnq_p8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[CONV_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[NOT_I:%.*]] = xor <16 x i8> [[CONV_I]], splat (i8 -1)
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vrbit_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VRBIT_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VRBIT1_I:%.*]] = call <8 x i8> @llvm.bitreverse.v8i8(<8 x i8> [[VRBIT_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i8> [[VRBIT1_I]] to <8 x b8>
// CHECK-NEXT:    ret <8 x b8> [[TMP0]]
//
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vrbitq_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VRBIT_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VRBIT1_I:%.*]] = call <16 x i8> @llvm.bitreverse.v16i8(<16 x i8> [[VRBIT_I]])
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <16 x i8> [[VRBIT1_I]] to <16 x b8>
// CHECK-NEXT:    ret <16 x b8> [[TMP0]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vrbit_u8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VRBIT_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VRBIT1_I:%.*]] = call <8 x i8> @llvm.bitreverse.v8i8(<8 x i8> [[VRBIT_I]])
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vrbitq_u8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VRBIT_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VRBIT1_I:%.*]] = call <16 x i8> @llvm.bitreverse.v16i8(<16 x i8> [[VRBIT_I]])
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vrbit_p8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VRBIT_I:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VRBIT1_I:%.*]] = call <8 x i8> @llvm.bitreverse.v8i8(<8 x i8> [[VRBIT_I]])
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vrbitq_p8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[VRBIT_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VRBIT1_I:%.*]] = call <16 x i8> @llvm.bitreverse.v16i8(<16 x i8> [[VRBIT_I]])
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vmovn_s16(
// CHECK-SAME: <8 x i16> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[A]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[TMP1]] to <8 x i16>
// CHECK-NEXT:    [[VMOVN_I:%.*]] = trunc <8 x i16> [[TMP2]] to <8 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <8 x i8> [[VMOVN_I]] to <8 x b8>
...
// CHECK-NEXT:    [[VMOVN_I:%.*]] = trunc <4 x i32> [[TMP2]] to <4 x i16>
...
// CHECK-NEXT:    [[VMOVN_I:%.*]] = trunc <2 x i64> [[TMP2]] to <2 x i32>
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vmovn_u16(
// CHECK-SAME: <8 x i16> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[A]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vmovn_high_s16(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x i16> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[B]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[TMP1]] to <8 x i16>
// CHECK-NEXT:    [[VMOVN_I_I:%.*]] = trunc <8 x i16> [[TMP2]] to <8 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <8 x i8> [[VMOVN_I_I]] to <8 x b8>
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[TMP3]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[TMP1]] to <4 x i32>
// CHECK-NEXT:    [[VMOVN_I_I:%.*]] = trunc <4 x i32> [[TMP2]] to <4 x i16>
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[TMP1]] to <2 x i64>
// CHECK-NEXT:    [[VMOVN_I_I:%.*]] = trunc <2 x i64> [[TMP2]] to <2 x i32>
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vmovn_high_u16(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x i16> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[B]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vqmovun_s16(
// CHECK-SAME: <8 x i16> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VQMOVUN_V_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x i16>
// CHECK-NEXT:    [[VQMOVUN_V1_I:%.*]] = call <8 x i8> @llvm.aarch64.neon.sqxtun.v8i8(<8 x i16> [[VQMOVUN_V_I]])
// CHECK-NEXT:    [[VQMOVUN_V2_I:%.*]] = bitcast <8 x i8> [[VQMOVUN_V1_I]] to <8 x b8>
// CHECK-NEXT:    ret <8 x b8> [[VQMOVUN_V2_I]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i32> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VQMOVUN_V_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[VQMOVUN_V1_I:%.*]] = call <4 x i16> @llvm.aarch64.neon.sqxtun.v4i16(<4 x i32> [[VQMOVUN_V_I]])
// CHECK-NEXT:    [[VQMOVUN_V2_I:%.*]] = bitcast <4 x i16> [[VQMOVUN_V1_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VQMOVUN_V2_I]] to <4 x i16>
// CHECK-NEXT:    ret <4 x i16> [[TMP1]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x i64> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VQMOVUN_V_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <2 x i64>
// CHECK-NEXT:    [[VQMOVUN_V1_I:%.*]] = call <2 x i32> @llvm.aarch64.neon.sqxtun.v2i32(<2 x i64> [[VQMOVUN_V_I]])
// CHECK-NEXT:    [[VQMOVUN_V2_I:%.*]] = bitcast <2 x i32> [[VQMOVUN_V1_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VQMOVUN_V2_I]] to <2 x i32>
// CHECK-NEXT:    ret <2 x i32> [[TMP1]]
//
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vqmovun_high_s16(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x i16> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[B]] to <16 x b8>
// CHECK-NEXT:    [[VQMOVUN_V_I_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x i16>
// CHECK-NEXT:    [[VQMOVUN_V1_I_I:%.*]] = call <8 x i8> @llvm.aarch64.neon.sqxtun.v8i8(<8 x i16> [[VQMOVUN_V_I_I]])
// CHECK-NEXT:    [[VQMOVUN_V2_I_I:%.*]] = bitcast <8 x i8> [[VQMOVUN_V1_I_I]] to <8 x b8>
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[VQMOVUN_V2_I_I]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i32> [[B]] to <16 x b8>
// CHECK-NEXT:    [[VQMOVUN_V_I_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[VQMOVUN_V1_I_I:%.*]] = call <4 x i16> @llvm.aarch64.neon.sqxtun.v4i16(<4 x i32> [[VQMOVUN_V_I_I]])
// CHECK-NEXT:    [[VQMOVUN_V2_I_I:%.*]] = bitcast <4 x i16> [[VQMOVUN_V1_I_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VQMOVUN_V2_I_I]] to <4 x i16>
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x i64> [[B]] to <16 x b8>
// CHECK-NEXT:    [[VQMOVUN_V_I_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <2 x i64>
// CHECK-NEXT:    [[VQMOVUN_V1_I_I:%.*]] = call <2 x i32> @llvm.aarch64.neon.sqxtun.v2i32(<2 x i64> [[VQMOVUN_V_I_I]])
// CHECK-NEXT:    [[VQMOVUN_V2_I_I:%.*]] = bitcast <2 x i32> [[VQMOVUN_V1_I_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VQMOVUN_V2_I_I]] to <2 x i32>
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vqmovn_s16(
// CHECK-SAME: <8 x i16> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VQMOVN_V_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x i16>
// CHECK-NEXT:    [[VQMOVN_V1_I:%.*]] = call <8 x i8> @llvm.aarch64.neon.sqxtn.v8i8(<8 x i16> [[VQMOVN_V_I]])
// CHECK-NEXT:    [[VQMOVN_V2_I:%.*]] = bitcast <8 x i8> [[VQMOVN_V1_I]] to <8 x b8>
// CHECK-NEXT:    ret <8 x b8> [[VQMOVN_V2_I]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i32> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VQMOVN_V_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[VQMOVN_V1_I:%.*]] = call <4 x i16> @llvm.aarch64.neon.sqxtn.v4i16(<4 x i32> [[VQMOVN_V_I]])
// CHECK-NEXT:    [[VQMOVN_V2_I:%.*]] = bitcast <4 x i16> [[VQMOVN_V1_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VQMOVN_V2_I]] to <4 x i16>
// CHECK-NEXT:    ret <4 x i16> [[TMP1]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x i64> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VQMOVN_V_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <2 x i64>
// CHECK-NEXT:    [[VQMOVN_V1_I:%.*]] = call <2 x i32> @llvm.aarch64.neon.sqxtn.v2i32(<2 x i64> [[VQMOVN_V_I]])
// CHECK-NEXT:    [[VQMOVN_V2_I:%.*]] = bitcast <2 x i32> [[VQMOVN_V1_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VQMOVN_V2_I]] to <2 x i32>
// CHECK-NEXT:    ret <2 x i32> [[TMP1]]
//
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vqmovn_high_s16(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x i16> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[B]] to <16 x b8>
// CHECK-NEXT:    [[VQMOVN_V_I_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x i16>
// CHECK-NEXT:    [[VQMOVN_V1_I_I:%.*]] = call <8 x i8> @llvm.aarch64.neon.sqxtn.v8i8(<8 x i16> [[VQMOVN_V_I_I]])
// CHECK-NEXT:    [[VQMOVN_V2_I_I:%.*]] = bitcast <8 x i8> [[VQMOVN_V1_I_I]] to <8 x b8>
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[VQMOVN_V2_I_I]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i32> [[B]] to <16 x b8>
// CHECK-NEXT:    [[VQMOVN_V_I_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[VQMOVN_V1_I_I:%.*]] = call <4 x i16> @llvm.aarch64.neon.sqxtn.v4i16(<4 x i32> [[VQMOVN_V_I_I]])
// CHECK-NEXT:    [[VQMOVN_V2_I_I:%.*]] = bitcast <4 x i16> [[VQMOVN_V1_I_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VQMOVN_V2_I_I]] to <4 x i16>
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <4 x i16> [[A]], <4 x i16> [[TMP1]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
// CHECK-NEXT:    ret <8 x i16> [[SHUFFLE_I]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x i64> [[B]] to <16 x b8>
// CHECK-NEXT:    [[VQMOVN_V_I_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <2 x i64>
// CHECK-NEXT:    [[VQMOVN_V1_I_I:%.*]] = call <2 x i32> @llvm.aarch64.neon.sqxtn.v2i32(<2 x i64> [[VQMOVN_V_I_I]])
// CHECK-NEXT:    [[VQMOVN_V2_I_I:%.*]] = bitcast <2 x i32> [[VQMOVN_V1_I_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VQMOVN_V2_I_I]] to <2 x i32>
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <2 x i32> [[A]], <2 x i32> [[TMP1]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
// CHECK-NEXT:    ret <4 x i32> [[SHUFFLE_I]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vqmovn_u16(
// CHECK-SAME: <8 x i16> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VQMOVN_V_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x i16>
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vqmovn_high_u16(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x i16> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i16> [[B]] to <16 x b8>
// CHECK-NEXT:    [[VQMOVN_V_I_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <8 x i16>
...
// CHECK-NEXT:    [[VSHLL_N:%.*]] = shl <8 x i16> [[TMP1]], splat (i16 8)
...
// CHECK-NEXT:    [[VSHLL_N:%.*]] = shl <4 x i32> [[TMP3]], splat (i32 16)
...
// CHECK-NEXT:    [[VSHLL_N:%.*]] = shl <2 x i64> [[TMP3]], splat (i64 32)
...
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <8 x b8> [[SHUFFLE_I]] to <8 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = sext <8 x i8> [[TMP0]] to <8 x i16>
// CHECK-NEXT:    [[VSHLL_N:%.*]] = shl <8 x i16> [[TMP1]], splat (i16 8)
// CHECK-NEXT:    ret <8 x i16> [[VSHLL_N]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i16> [[SHUFFLE_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[TMP1]] to <4 x i16>
// CHECK-NEXT:    [[TMP3:%.*]] = sext <4 x i16> [[TMP2]] to <4 x i32>
// CHECK-NEXT:    [[VSHLL_N:%.*]] = shl <4 x i32> [[TMP3]], splat (i32 16)
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x i32> [[SHUFFLE_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[TMP1]] to <2 x i32>
// CHECK-NEXT:    [[TMP3:%.*]] = sext <2 x i32> [[TMP2]] to <2 x i64>
// CHECK-NEXT:    [[VSHLL_N:%.*]] = shl <2 x i64> [[TMP3]], splat (i64 32)
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVT_F16_F32_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
// CHECK-NEXT:    [[VCVT_F16_F321_I:%.*]] = call <4 x i16> @llvm.aarch64.neon.vcvtfp2hf(<4 x float> [[VCVT_F16_F32_I]])
// CHECK-NEXT:    [[VCVT_F16_F322_I:%.*]] = bitcast <4 x i16> [[VCVT_F16_F321_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[VCVT_F16_F322_I]] to <4 x i16>
...
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVT_F16_F32_I_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
// CHECK-NEXT:    [[VCVT_F16_F321_I_I:%.*]] = call <4 x i16> @llvm.aarch64.neon.vcvtfp2hf(<4 x float> [[VCVT_F16_F32_I_I]])
// CHECK-NEXT:    [[VCVT_F16_F322_I_I:%.*]] = bitcast <4 x i16> [[VCVT_F16_F321_I_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[VCVT_F16_F322_I_I]] to <4 x i16>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <4 x i16> [[TMP2]] to <4 x half>
...
// CHECK-NEXT:    [[VCVT_I:%.*]] = fptrunc <2 x double> [[TMP3]] to <2 x float>
...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <16 x i8> [[TMP2]] to <2 x double>
// CHECK-NEXT:    [[VCVT_I_I:%.*]] = fptrunc <2 x double> [[TMP3]] to <2 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x double> [[A]] to <2 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i64> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTX_F32_V_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x double>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x double> [[B]] to <2 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i64> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTX_F32_V_I_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x double>
...
// CHECK-NEXT:    [[VCVT_F32_F16_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <4 x i16>
// CHECK-NEXT:    [[VCVT_F32_F161_I:%.*]] = call <4 x float> @llvm.aarch64.neon.vcvthf2fp(<4 x i16> [[VCVT_F32_F16_I]])
// CHECK-NEXT:    [[VCVT_F32_F162_I:%.*]] = bitcast <4 x float> [[VCVT_F32_F161_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[VCVT_F32_F162_I]] to <4 x i32>
...
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i16> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VCVT_F32_F16_I_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <4 x i16>
// CHECK-NEXT:    [[VCVT_F32_F161_I_I:%.*]] = call <4 x float> @llvm.aarch64.neon.vcvthf2fp(<4 x i16> [[VCVT_F32_F16_I_I]])
// CHECK-NEXT:    [[VCVT_F32_F162_I_I:%.*]] = bitcast <4 x float> [[VCVT_F32_F161_I_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[VCVT_F32_F162_I_I]] to <4 x i32>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <4 x i32> [[TMP2]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP3]]
//
...
// CHECK-NEXT:    [[VCVT_I:%.*]] = fpext <2 x float> [[TMP3]] to <2 x double>
...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <8 x i8> [[TMP2]] to <2 x float>
// CHECK-NEXT:    [[VCVT_I_I:%.*]] = fpext <2 x float> [[TMP3]] to <2 x double>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x double> [[A]] to <2 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i64> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VRNDIQ_V_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x double>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VCVTZ_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTZ_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x double> [[A]] to <2 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i64> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTZ_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x double>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VCVTN_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTN_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x double> [[A]] to <2 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i64> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTN_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x double>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VCVTP_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTP_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x double> [[A]] to <2 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i64> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTP_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x double>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VCVTM_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTM_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x double> [[A]] to <2 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i64> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTM_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x double>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VCVTA_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTA_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x double> [[A]] to <2 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i64> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTA_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x double>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VRSQRTE_V_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VRSQRTEQ_V_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x double> [[A]] to <2 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i64> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VRSQRTEQ_V_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x double>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VRECPE_V_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VRECPEQ_V_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x double> [[A]] to <2 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i64> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VRECPEQ_V_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x double>
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x i32> [[A]] to <8 x b8>
// CHECK-NEXT:    [[VRECPE_V_I:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <2 x i32>
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i32> [[A]] to <16 x b8>
// CHECK-NEXT:    [[VRECPEQ_V_I:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <4 x i32>
...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <8 x i8> [[TMP2]] to <2 x float>
// CHECK-NEXT:    [[VSQRT_I:%.*]] = call <2 x float> @llvm.sqrt.v2f32(<2 x float> [[TMP3]])
...
// CHECK-NEXT:    [[VSQRT_I:%.*]] = call <4 x float> @llvm.sqrt.v4f32(<4 x float> [[TMP3]])
...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <16 x i8> [[TMP2]] to <2 x double>
// CHECK-NEXT:    [[VSQRT_I:%.*]] = call <2 x double> @llvm.sqrt.v2f64(<2 x double> [[TMP3]])
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[TMP1]] to <2 x i32>
// CHECK-NEXT:    [[VCVT_I:%.*]] = sitofp <2 x i32> [[TMP2]] to <2 x float>
// CHECK-NEXT:    ret <2 x float> [[VCVT_I]]
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[TMP1]] to <2 x i32>
// CHECK-NEXT:    [[VCVT_I:%.*]] = uitofp <2 x i32> [[TMP2]] to <2 x float>
// CHECK-NEXT:    ret <2 x float> [[VCVT_I]]
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[TMP1]] to <4 x i32>
// CHECK-NEXT:    [[VCVT_I:%.*]] = sitofp <4 x i32> [[TMP2]] to <4 x float>
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[TMP1]] to <4 x i32>
// CHECK-NEXT:    [[VCVT_I:%.*]] = uitofp <4 x i32> [[TMP2]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[VCVT_I]]
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[TMP1]] to <2 x i64>
// CHECK-NEXT:    [[VCVT_I:%.*]] = sitofp <2 x i64> [[TMP2]] to <2 x double>
// CHECK-NEXT:    ret <2 x double> [[VCVT_I]]
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[TMP1]] to <2 x i64>
// CHECK-NEXT:    [[VCVT_I:%.*]] = uitofp <2 x i64> [[TMP2]] to <2 x double>
// CHECK-NEXT:    ret <2 x double> [[VCVT_I]]
//
