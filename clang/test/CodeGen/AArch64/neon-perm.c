...
// CHECK-LABEL: define dso_local <8 x b8> @test_vuzp1_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[B]], <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14>
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vuzp1q_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[B]], <16 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14, i32 16, i32 18, i32 20, i32 22, i32 24, i32 26, i32 28, i32 30>
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vuzp1_u8(
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vuzp1q_u8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[B]], <16 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14, i32 16, i32 18, i32 20, i32 22, i32 24, i32 26, i32 28, i32 30>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vuzp1_p8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[B]], <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vuzp1q_p8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[B]], <16 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14, i32 16, i32 18, i32 20, i32 22, i32 24, i32 26, i32 28, i32 30>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vuzp2_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[B]], <8 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
//
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vuzp2q_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[B]], <16 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15, i32 17, i32 19, i32 21, i32 23, i32 25, i32 27, i32 29, i32 31>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vuzp2_u8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[B]], <8 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vuzp2q_u8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[B]], <16 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15, i32 17, i32 19, i32 21, i32 23, i32 25, i32 27, i32 29, i32 31>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vuzp2_p8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[B]], <8 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vuzp2q_p8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[B]], <16 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15, i32 17, i32 19, i32 21, i32 23, i32 25, i32 27, i32 29, i32 31>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vzip1_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[B]], <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
//
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vzip1q_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[B]], <16 x i32> <i32 0, i32 16, i32 1, i32 17, i32 2, i32 18, i32 3, i32 19, i32 4, i32 20, i32 5, i32 21, i32 6, i32 22, i32 7, i32 23>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vzip1_u8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[B]], <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vzip1q_u8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[B]], <16 x i32> <i32 0, i32 16, i32 1, i32 17, i32 2, i32 18, i32 3, i32 19, i32 4, i32 20, i32 5, i32 21, i32 6, i32 22, i32 7, i32 23>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vzip1_p8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[B]], <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vzip1q_p8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[B]], <16 x i32> <i32 0, i32 16, i32 1, i32 17, i32 2, i32 18, i32 3, i32 19, i32 4, i32 20, i32 5, i32 21, i32 6, i32 22, i32 7, i32 23>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vzip2_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[B]], <8 x i32> <i32 4, i32 12, i32 5, i32 13, i32 6, i32 14, i32 7, i32 15>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
//
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vzip2q_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[B]], <16 x i32> <i32 8, i32 24, i32 9, i32 25, i32 10, i32 26, i32 11, i32 27, i32 12, i32 28, i32 13, i32 29, i32 14, i32 30, i32 15, i32 31>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vzip2_u8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[B]], <8 x i32> <i32 4, i32 12, i32 5, i32 13, i32 6, i32 14, i32 7, i32 15>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vzip2q_u8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[B]], <16 x i32> <i32 8, i32 24, i32 9, i32 25, i32 10, i32 26, i32 11, i32 27, i32 12, i32 28, i32 13, i32 29, i32 14, i32 30, i32 15, i32 31>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vzip2_p8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[B]], <8 x i32> <i32 4, i32 12, i32 5, i32 13, i32 6, i32 14, i32 7, i32 15>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vzip2q_p8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[B]], <16 x i32> <i32 8, i32 24, i32 9, i32 25, i32 10, i32 26, i32 11, i32 27, i32 12, i32 28, i32 13, i32 29, i32 14, i32 30, i32 15, i32 31>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vtrn1_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[B]], <8 x i32> <i32 0, i32 8, i32 2, i32 10, i32 4, i32 12, i32 6, i32 14>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
//
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vtrn1q_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[B]], <16 x i32> <i32 0, i32 16, i32 2, i32 18, i32 4, i32 20, i32 6, i32 22, i32 8, i32 24, i32 10, i32 26, i32 12, i32 28, i32 14, i32 30>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vtrn1_u8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[B]], <8 x i32> <i32 0, i32 8, i32 2, i32 10, i32 4, i32 12, i32 6, i32 14>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vtrn1q_u8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[B]], <16 x i32> <i32 0, i32 16, i32 2, i32 18, i32 4, i32 20, i32 6, i32 22, i32 8, i32 24, i32 10, i32 26, i32 12, i32 28, i32 14, i32 30>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vtrn1_p8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[B]], <8 x i32> <i32 0, i32 8, i32 2, i32 10, i32 4, i32 12, i32 6, i32 14>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vtrn1q_p8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[B]], <16 x i32> <i32 0, i32 16, i32 2, i32 18, i32 4, i32 20, i32 6, i32 22, i32 8, i32 24, i32 10, i32 26, i32 12, i32 28, i32 14, i32 30>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vtrn2_s8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[B]], <8 x i32> <i32 1, i32 9, i32 3, i32 11, i32 5, i32 13, i32 7, i32 15>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
//
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vtrn2q_s8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[B]], <16 x i32> <i32 1, i32 17, i32 3, i32 19, i32 5, i32 21, i32 7, i32 23, i32 9, i32 25, i32 11, i32 27, i32 13, i32 29, i32 15, i32 31>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
//
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vtrn2_u8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[B]], <8 x i32> <i32 1, i32 9, i32 3, i32 11, i32 5, i32 13, i32 7, i32 15>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vtrn2q_u8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[B]], <16 x i32> <i32 1, i32 17, i32 3, i32 19, i32 5, i32 21, i32 7, i32 23, i32 9, i32 25, i32 11, i32 27, i32 13, i32 29, i32 15, i32 31>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <8 x b8> @test_vtrn2_p8(
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x b8> [[A]], <8 x b8> [[B]], <8 x i32> <i32 1, i32 9, i32 3, i32 11, i32 5, i32 13, i32 7, i32 15>
// CHECK-NEXT:    ret <8 x b8> [[SHUFFLE_I]]
...
// CHECK-LABEL: define dso_local <16 x b8> @test_vtrn2q_p8(
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <16 x b8> [[A]], <16 x b8> [[B]], <16 x i32> <i32 1, i32 17, i32 3, i32 19, i32 5, i32 21, i32 7, i32 23, i32 9, i32 25, i32 11, i32 27, i32 13, i32 29, i32 15, i32 31>
// CHECK-NEXT:    ret <16 x b8> [[SHUFFLE_I]]
...
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[RETVAL_I:%.*]] = alloca [[STRUCT_INT8X8X2_T:%.*]], align 8
...
// CHECK-NEXT:    [[VUZP_I:%.*]] = shufflevector <8 x i8> [[TMP0]], <8 x i8> [[TMP1]], <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14>
// CHECK-NEXT:    store <8 x i8> [[VUZP_I]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds <8 x i8>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VUZP1_I:%.*]] = shufflevector <8 x i8> [[TMP0]], <8 x i8> [[TMP1]], <8 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15>
// CHECK-NEXT:    store <8 x i8> [[VUZP1_I]], ptr [[TMP2]], align 8
// CHECK-NEXT:    [[TMP3:%.*]] = load [[STRUCT_INT8X8X2_T]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds nuw [[STRUCT_INT8X8X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP5:%.*]] = extractvalue [[STRUCT_INT8X8X2_T]] [[TMP3]], 0
// CHECK-NEXT:    store [2 x <8 x b8>] [[TMP5]], ptr [[TMP4]], align 8
// CHECK-NEXT:    [[TMP6:%.*]] = load [[STRUCT_INT8X8X2_T]], ptr [[RETVAL]], align 8
// CHECK-NEXT:    ret [[STRUCT_INT8X8X2_T]] [[TMP6]]
//
...
// CHECK-SAME: <4 x i16> noundef [[A:%.*]], <4 x i16> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[RETVAL_I:%.*]] = alloca [[STRUCT_INT16X4X2_T:%.*]], align 8
...
// CHECK-NEXT:    [[VUZP_I:%.*]] = shufflevector <4 x i16> [[TMP3]], <4 x i16> [[TMP5]], <4 x i32> <i32 0, i32 2, i32 4, i32 6>
// CHECK-NEXT:    store <4 x i16> [[VUZP_I]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds <4 x i16>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VUZP1_I:%.*]] = shufflevector <4 x i16> [[TMP3]], <4 x i16> [[TMP5]], <4 x i32> <i32 1, i32 3, i32 5, i32 7>
// CHECK-NEXT:    store <4 x i16> [[VUZP1_I]], ptr [[TMP6]], align 8
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_INT16X4X2_T]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_INT16X4X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_INT16X4X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <4 x i16>] [[TMP9]], ptr [[TMP8]], align 8
...
// CHECK-SAME: <2 x i32> noundef [[A:%.*]], <2 x i32> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[RETVAL_I:%.*]] = alloca [[STRUCT_INT32X2X2_T:%.*]], align 8
...
// CHECK-NEXT:    [[VUZP_I:%.*]] = shufflevector <2 x i32> [[TMP3]], <2 x i32> [[TMP5]], <2 x i32> <i32 0, i32 2>
// CHECK-NEXT:    store <2 x i32> [[VUZP_I]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds <2 x i32>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VUZP1_I:%.*]] = shufflevector <2 x i32> [[TMP3]], <2 x i32> [[TMP5]], <2 x i32> <i32 1, i32 3>
// CHECK-NEXT:    store <2 x i32> [[VUZP1_I]], ptr [[TMP6]], align 8
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_INT32X2X2_T]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_INT32X2X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_INT32X2X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <2 x i32>] [[TMP9]], ptr [[TMP8]], align 8
...
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[RETVAL_I:%.*]] = alloca [[STRUCT_UINT8X8X2_T:%.*]], align 8
...
// CHECK-NEXT:    [[VUZP1_I:%.*]] = shufflevector <8 x i8> [[TMP0]], <8 x i8> [[TMP1]], <8 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15>
// CHECK-NEXT:    store <8 x i8> [[VUZP1_I]], ptr [[TMP2]], align 8
// CHECK-NEXT:    [[TMP3:%.*]] = load [[STRUCT_UINT8X8X2_T]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds nuw [[STRUCT_UINT8X8X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP5:%.*]] = extractvalue [[STRUCT_UINT8X8X2_T]] [[TMP3]], 0
// CHECK-NEXT:    store [2 x <8 x b8>] [[TMP5]], ptr [[TMP4]], align 8
// CHECK-NEXT:    [[TMP6:%.*]] = load [[STRUCT_UINT8X8X2_T]], ptr [[RETVAL]], align 8
// CHECK-NEXT:    ret [[STRUCT_UINT8X8X2_T]] [[TMP6]]
//
...
// CHECK-SAME: <4 x i16> noundef [[A:%.*]], <4 x i16> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[RETVAL_I:%.*]] = alloca [[STRUCT_UINT16X4X2_T:%.*]], align 8
...
// CHECK-NEXT:    [[VUZP1_I:%.*]] = shufflevector <4 x i16> [[TMP3]], <4 x i16> [[TMP5]], <4 x i32> <i32 1, i32 3, i32 5, i32 7>
// CHECK-NEXT:    store <4 x i16> [[VUZP1_I]], ptr [[TMP6]], align 8
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_UINT16X4X2_T]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_UINT16X4X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_UINT16X4X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <4 x i16>] [[TMP9]], ptr [[TMP8]], align 8
...
// CHECK-SAME: <2 x i32> noundef [[A:%.*]], <2 x i32> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[RETVAL_I:%.*]] = alloca [[STRUCT_UINT32X2X2_T:%.*]], align 8
...
// CHECK-NEXT:    [[VUZP1_I:%.*]] = shufflevector <2 x i32> [[TMP3]], <2 x i32> [[TMP5]], <2 x i32> <i32 1, i32 3>
// CHECK-NEXT:    store <2 x i32> [[VUZP1_I]], ptr [[TMP6]], align 8
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_UINT32X2X2_T]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_UINT32X2X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_UINT32X2X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <2 x i32>] [[TMP9]], ptr [[TMP8]], align 8
...
// CHECK-SAME: <2 x float> noundef [[A:%.*]], <2 x float> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[RETVAL_I:%.*]] = alloca [[STRUCT_FLOAT32X2X2_T:%.*]], align 8
// CHECK-NEXT:    [[RETVAL:%.*]] = alloca [[STRUCT_FLOAT32X2X2_T]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x float> [[B]] to <8 x b8>
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <8 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <8 x i8> [[TMP2]] to <2 x float>
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <8 x i8> [[TMP4]] to <2 x float>
// CHECK-NEXT:    [[VUZP_I:%.*]] = shufflevector <2 x float> [[TMP3]], <2 x float> [[TMP5]], <2 x i32> <i32 0, i32 2>
// CHECK-NEXT:    store <2 x float> [[VUZP_I]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds <2 x float>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VUZP1_I:%.*]] = shufflevector <2 x float> [[TMP3]], <2 x float> [[TMP5]], <2 x i32> <i32 1, i32 3>
// CHECK-NEXT:    store <2 x float> [[VUZP1_I]], ptr [[TMP6]], align 8
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_FLOAT32X2X2_T]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_FLOAT32X2X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_FLOAT32X2X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <2 x float>] [[TMP9]], ptr [[TMP8]], align 8
...
// CHECK-SAME: <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[RETVAL_I:%.*]] = alloca [[STRUCT_POLY8X8X2_T:%.*]], align 8
...
// CHECK-NEXT:    [[VUZP1_I:%.*]] = shufflevector <8 x i8> [[TMP0]], <8 x i8> [[TMP1]], <8 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15>
// CHECK-NEXT:    store <8 x i8> [[VUZP1_I]], ptr [[TMP2]], align 8
// CHECK-NEXT:    [[TMP3:%.*]] = load [[STRUCT_POLY8X8X2_T]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY8X8X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP5:%.*]] = extractvalue [[STRUCT_POLY8X8X2_T]] [[TMP3]], 0
// CHECK-NEXT:    store [2 x <8 x b8>] [[TMP5]], ptr [[TMP4]], align 8
// CHECK-NEXT:    [[TMP6:%.*]] = load [[STRUCT_POLY8X8X2_T]], ptr [[RETVAL]], align 8
// CHECK-NEXT:    ret [[STRUCT_POLY8X8X2_T]] [[TMP6]]
//
...
// CHECK-SAME: <4 x i16> noundef [[A:%.*]], <4 x i16> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[RETVAL_I:%.*]] = alloca [[STRUCT_POLY16X4X2_T:%.*]], align 8
...
// CHECK-NEXT:    [[VUZP1_I:%.*]] = shufflevector <4 x i16> [[TMP3]], <4 x i16> [[TMP5]], <4 x i32> <i32 1, i32 3, i32 5, i32 7>
// CHECK-NEXT:    store <4 x i16> [[VUZP1_I]], ptr [[TMP6]], align 8
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_POLY16X4X2_T]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY16X4X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_POLY16X4X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <4 x i16>] [[TMP9]], ptr [[TMP8]], align 8
...
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[RETVAL_I:%.*]] = alloca [[STRUCT_INT8X16X2_T:%.*]], align 16
...
// CHECK-NEXT:    [[VUZP_I:%.*]] = shufflevector <16 x i8> [[TMP0]], <16 x i8> [[TMP1]], <16 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14, i32 16, i32 18, i32 20, i32 22, i32 24, i32 26, i32 28, i32 30>
// CHECK-NEXT:    store <16 x i8> [[VUZP_I]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds <16 x i8>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VUZP1_I:%.*]] = shufflevector <16 x i8> [[TMP0]], <16 x i8> [[TMP1]], <16 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15, i32 17, i32 19, i32 21, i32 23, i32 25, i32 27, i32 29, i32 31>
// CHECK-NEXT:    store <16 x i8> [[VUZP1_I]], ptr [[TMP2]], align 16
// CHECK-NEXT:    [[TMP3:%.*]] = load [[STRUCT_INT8X16X2_T]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds nuw [[STRUCT_INT8X16X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP5:%.*]] = extractvalue [[STRUCT_INT8X16X2_T]] [[TMP3]], 0
// CHECK-NEXT:    store [2 x <16 x b8>] [[TMP5]], ptr [[TMP4]], align 16
// CHECK-NEXT:    [[TMP6:%.*]] = load [[STRUCT_INT8X16X2_T]], ptr [[RETVAL]], align 16
// CHECK-NEXT:    ret [[STRUCT_INT8X16X2_T]] [[TMP6]]
//
...
// CHECK-SAME: <8 x i16> noundef [[A:%.*]], <8 x i16> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[RETVAL_I:%.*]] = alloca [[STRUCT_INT16X8X2_T:%.*]], align 16
...
// CHECK-NEXT:    [[VUZP_I:%.*]] = shufflevector <8 x i16> [[TMP3]], <8 x i16> [[TMP5]], <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14>
// CHECK-NEXT:    store <8 x i16> [[VUZP_I]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds <8 x i16>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VUZP1_I:%.*]] = shufflevector <8 x i16> [[TMP3]], <8 x i16> [[TMP5]], <8 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15>
// CHECK-NEXT:    store <8 x i16> [[VUZP1_I]], ptr [[TMP6]], align 16
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_INT16X8X2_T]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_INT16X8X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_INT16X8X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <8 x i16>] [[TMP9]], ptr [[TMP8]], align 16
...
// CHECK-SAME: <4 x i32> noundef [[A:%.*]], <4 x i32> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[RETVAL_I:%.*]] = alloca [[STRUCT_INT32X4X2_T:%.*]], align 16
...
// CHECK-NEXT:    [[VUZP_I:%.*]] = shufflevector <4 x i32> [[TMP3]], <4 x i32> [[TMP5]], <4 x i32> <i32 0, i32 2, i32 4, i32 6>
// CHECK-NEXT:    store <4 x i32> [[VUZP_I]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds <4 x i32>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VUZP1_I:%.*]] = shufflevector <4 x i32> [[TMP3]], <4 x i32> [[TMP5]], <4 x i32> <i32 1, i32 3, i32 5, i32 7>
// CHECK-NEXT:    store <4 x i32> [[VUZP1_I]], ptr [[TMP6]], align 16
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_INT32X4X2_T]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_INT32X4X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_INT32X4X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <4 x i32>] [[TMP9]], ptr [[TMP8]], align 16
...
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[RETVAL_I:%.*]] = alloca [[STRUCT_UINT8X16X2_T:%.*]], align 16
...
// CHECK-NEXT:    [[VUZP1_I:%.*]] = shufflevector <16 x i8> [[TMP0]], <16 x i8> [[TMP1]], <16 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15, i32 17, i32 19, i32 21, i32 23, i32 25, i32 27, i32 29, i32 31>
// CHECK-NEXT:    store <16 x i8> [[VUZP1_I]], ptr [[TMP2]], align 16
// CHECK-NEXT:    [[TMP3:%.*]] = load [[STRUCT_UINT8X16X2_T]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds nuw [[STRUCT_UINT8X16X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP5:%.*]] = extractvalue [[STRUCT_UINT8X16X2_T]] [[TMP3]], 0
// CHECK-NEXT:    store [2 x <16 x b8>] [[TMP5]], ptr [[TMP4]], align 16
// CHECK-NEXT:    [[TMP6:%.*]] = load [[STRUCT_UINT8X16X2_T]], ptr [[RETVAL]], align 16
// CHECK-NEXT:    ret [[STRUCT_UINT8X16X2_T]] [[TMP6]]
//
...
// CHECK-SAME: <8 x i16> noundef [[A:%.*]], <8 x i16> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[RETVAL_I:%.*]] = alloca [[STRUCT_UINT16X8X2_T:%.*]], align 16
...
// CHECK-NEXT:    [[VUZP1_I:%.*]] = shufflevector <8 x i16> [[TMP3]], <8 x i16> [[TMP5]], <8 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15>
// CHECK-NEXT:    store <8 x i16> [[VUZP1_I]], ptr [[TMP6]], align 16
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_UINT16X8X2_T]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_UINT16X8X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_UINT16X8X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <8 x i16>] [[TMP9]], ptr [[TMP8]], align 16
...
// CHECK-SAME: <4 x i32> noundef [[A:%.*]], <4 x i32> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[RETVAL_I:%.*]] = alloca [[STRUCT_UINT32X4X2_T:%.*]], align 16
...
// CHECK-NEXT:    [[VUZP1_I:%.*]] = shufflevector <4 x i32> [[TMP3]], <4 x i32> [[TMP5]], <4 x i32> <i32 1, i32 3, i32 5, i32 7>
// CHECK-NEXT:    store <4 x i32> [[VUZP1_I]], ptr [[TMP6]], align 16
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_UINT32X4X2_T]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_UINT32X4X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_UINT32X4X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <4 x i32>] [[TMP9]], ptr [[TMP8]], align 16
...
// CHECK-SAME: <4 x float> noundef [[A:%.*]], <4 x float> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[RETVAL_I:%.*]] = alloca [[STRUCT_FLOAT32X4X2_T:%.*]], align 16
// CHECK-NEXT:    [[RETVAL:%.*]] = alloca [[STRUCT_FLOAT32X4X2_T]], align 16
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x float> [[B]] to <16 x b8>
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[TMP0]] to <16 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <16 x i8> [[TMP2]] to <4 x float>
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <16 x i8> [[TMP4]] to <4 x float>
// CHECK-NEXT:    [[VUZP_I:%.*]] = shufflevector <4 x float> [[TMP3]], <4 x float> [[TMP5]], <4 x i32> <i32 0, i32 2, i32 4, i32 6>
// CHECK-NEXT:    store <4 x float> [[VUZP_I]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds <4 x float>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VUZP1_I:%.*]] = shufflevector <4 x float> [[TMP3]], <4 x float> [[TMP5]], <4 x i32> <i32 1, i32 3, i32 5, i32 7>
// CHECK-NEXT:    store <4 x float> [[VUZP1_I]], ptr [[TMP6]], align 16
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_FLOAT32X4X2_T]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_FLOAT32X4X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_FLOAT32X4X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <4 x float>] [[TMP9]], ptr [[TMP8]], align 16
...
// CHECK-SAME: <16 x b8> noundef [[A:%.*]], <16 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[RETVAL_I:%.*]] = alloca [[STRUCT_POLY8X16X2_T:%.*]], align 16
...
// CHECK-NEXT:    [[VUZP1_I:%.*]] = shufflevector <16 x i8> [[TMP0]], <16 x i8> [[TMP1]], <16 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15, i32 17, i32 19, i32 21, i32 23, i32 25, i32 27, i32 29, i32 31>
// CHECK-NEXT:    store <16 x i8> [[VUZP1_I]], ptr [[TMP2]], align 16
// CHECK-NEXT:    [[TMP3:%.*]] = load [[STRUCT_POLY8X16X2_T]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY8X16X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP5:%.*]] = extractvalue [[STRUCT_POLY8X16X2_T]] [[TMP3]], 0
// CHECK-NEXT:    store [2 x <16 x b8>] [[TMP5]], ptr [[TMP4]], align 16
// CHECK-NEXT:    [[TMP6:%.*]] = load [[STRUCT_POLY8X16X2_T]], ptr [[RETVAL]], align 16
// CHECK-NEXT:    ret [[STRUCT_POLY8X16X2_T]] [[TMP6]]
//
...
// CHECK-SAME: <8 x i16> noundef [[A:%.*]], <8 x i16> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[RETVAL_I:%.*]] = alloca [[STRUCT_POLY16X8X2_T:%.*]], align 16
...
// CHECK-NEXT:    [[VUZP1_I:%.*]] = shufflevector <8 x i16> [[TMP3]], <8 x i16> [[TMP5]], <8 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15>
// CHECK-NEXT:    store <8 x i16> [[VUZP1_I]], ptr [[TMP6]], align 16
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_POLY16X8X2_T]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY16X8X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_POLY16X8X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <8 x i16>] [[TMP9]], ptr [[TMP8]], align 16
...
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[B]] to <8 x i8>
// CHECK-NEXT:    [[VZIP_I:%.*]] = shufflevector <8 x i8> [[TMP0]], <8 x i8> [[TMP1]], <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11>
// CHECK-NEXT:    store <8 x i8> [[VZIP_I]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds <8 x i8>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VZIP1_I:%.*]] = shufflevector <8 x i8> [[TMP0]], <8 x i8> [[TMP1]], <8 x i32> <i32 4, i32 12, i32 5, i32 13, i32 6, i32 14, i32 7, i32 15>
// CHECK-NEXT:    store <8 x i8> [[VZIP1_I]], ptr [[TMP2]], align 8
// CHECK-NEXT:    [[TMP3:%.*]] = load [[STRUCT_INT8X8X2_T]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds nuw [[STRUCT_INT8X8X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP5:%.*]] = extractvalue [[STRUCT_INT8X8X2_T]] [[TMP3]], 0
// CHECK-NEXT:    store [2 x <8 x b8>] [[TMP5]], ptr [[TMP4]], align 8
...
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <8 x i8> [[TMP4]] to <4 x i16>
// CHECK-NEXT:    [[VZIP_I:%.*]] = shufflevector <4 x i16> [[TMP3]], <4 x i16> [[TMP5]], <4 x i32> <i32 0, i32 4, i32 1, i32 5>
// CHECK-NEXT:    store <4 x i16> [[VZIP_I]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds <4 x i16>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VZIP1_I:%.*]] = shufflevector <4 x i16> [[TMP3]], <4 x i16> [[TMP5]], <4 x i32> <i32 2, i32 6, i32 3, i32 7>
// CHECK-NEXT:    store <4 x i16> [[VZIP1_I]], ptr [[TMP6]], align 8
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_INT16X4X2_T]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_INT16X4X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_INT16X4X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <4 x i16>] [[TMP9]], ptr [[TMP8]], align 8
...
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <8 x i8> [[TMP4]] to <2 x i32>
// CHECK-NEXT:    [[VZIP_I:%.*]] = shufflevector <2 x i32> [[TMP3]], <2 x i32> [[TMP5]], <2 x i32> <i32 0, i32 2>
// CHECK-NEXT:    store <2 x i32> [[VZIP_I]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds <2 x i32>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VZIP1_I:%.*]] = shufflevector <2 x i32> [[TMP3]], <2 x i32> [[TMP5]], <2 x i32> <i32 1, i32 3>
// CHECK-NEXT:    store <2 x i32> [[VZIP1_I]], ptr [[TMP6]], align 8
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_INT32X2X2_T]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_INT32X2X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_INT32X2X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <2 x i32>] [[TMP9]], ptr [[TMP8]], align 8
...
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <8 x i8> [[TMP4]] to <2 x float>
// CHECK-NEXT:    [[VZIP_I:%.*]] = shufflevector <2 x float> [[TMP3]], <2 x float> [[TMP5]], <2 x i32> <i32 0, i32 2>
// CHECK-NEXT:    store <2 x float> [[VZIP_I]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds <2 x float>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VZIP1_I:%.*]] = shufflevector <2 x float> [[TMP3]], <2 x float> [[TMP5]], <2 x i32> <i32 1, i32 3>
// CHECK-NEXT:    store <2 x float> [[VZIP1_I]], ptr [[TMP6]], align 8
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_FLOAT32X2X2_T]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_FLOAT32X2X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_FLOAT32X2X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <2 x float>] [[TMP9]], ptr [[TMP8]], align 8
...
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[B]] to <16 x i8>
// CHECK-NEXT:    [[VZIP_I:%.*]] = shufflevector <16 x i8> [[TMP0]], <16 x i8> [[TMP1]], <16 x i32> <i32 0, i32 16, i32 1, i32 17, i32 2, i32 18, i32 3, i32 19, i32 4, i32 20, i32 5, i32 21, i32 6, i32 22, i32 7, i32 23>
// CHECK-NEXT:    store <16 x i8> [[VZIP_I]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds <16 x i8>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VZIP1_I:%.*]] = shufflevector <16 x i8> [[TMP0]], <16 x i8> [[TMP1]], <16 x i32> <i32 8, i32 24, i32 9, i32 25, i32 10, i32 26, i32 11, i32 27, i32 12, i32 28, i32 13, i32 29, i32 14, i32 30, i32 15, i32 31>
// CHECK-NEXT:    store <16 x i8> [[VZIP1_I]], ptr [[TMP2]], align 16
// CHECK-NEXT:    [[TMP3:%.*]] = load [[STRUCT_INT8X16X2_T]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds nuw [[STRUCT_INT8X16X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP5:%.*]] = extractvalue [[STRUCT_INT8X16X2_T]] [[TMP3]], 0
// CHECK-NEXT:    store [2 x <16 x b8>] [[TMP5]], ptr [[TMP4]], align 16
...
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <16 x i8> [[TMP4]] to <8 x i16>
// CHECK-NEXT:    [[VZIP_I:%.*]] = shufflevector <8 x i16> [[TMP3]], <8 x i16> [[TMP5]], <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11>
// CHECK-NEXT:    store <8 x i16> [[VZIP_I]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds <8 x i16>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VZIP1_I:%.*]] = shufflevector <8 x i16> [[TMP3]], <8 x i16> [[TMP5]], <8 x i32> <i32 4, i32 12, i32 5, i32 13, i32 6, i32 14, i32 7, i32 15>
// CHECK-NEXT:    store <8 x i16> [[VZIP1_I]], ptr [[TMP6]], align 16
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_INT16X8X2_T]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_INT16X8X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_INT16X8X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <8 x i16>] [[TMP9]], ptr [[TMP8]], align 16
...
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <16 x i8> [[TMP4]] to <4 x i32>
// CHECK-NEXT:    [[VZIP_I:%.*]] = shufflevector <4 x i32> [[TMP3]], <4 x i32> [[TMP5]], <4 x i32> <i32 0, i32 4, i32 1, i32 5>
// CHECK-NEXT:    store <4 x i32> [[VZIP_I]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds <4 x i32>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VZIP1_I:%.*]] = shufflevector <4 x i32> [[TMP3]], <4 x i32> [[TMP5]], <4 x i32> <i32 2, i32 6, i32 3, i32 7>
// CHECK-NEXT:    store <4 x i32> [[VZIP1_I]], ptr [[TMP6]], align 16
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_INT32X4X2_T]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_INT32X4X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_INT32X4X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <4 x i32>] [[TMP9]], ptr [[TMP8]], align 16
...
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <16 x i8> [[TMP4]] to <4 x float>
// CHECK-NEXT:    [[VZIP_I:%.*]] = shufflevector <4 x float> [[TMP3]], <4 x float> [[TMP5]], <4 x i32> <i32 0, i32 4, i32 1, i32 5>
// CHECK-NEXT:    store <4 x float> [[VZIP_I]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds <4 x float>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VZIP1_I:%.*]] = shufflevector <4 x float> [[TMP3]], <4 x float> [[TMP5]], <4 x i32> <i32 2, i32 6, i32 3, i32 7>
// CHECK-NEXT:    store <4 x float> [[VZIP1_I]], ptr [[TMP6]], align 16
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_FLOAT32X4X2_T]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_FLOAT32X4X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_FLOAT32X4X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <4 x float>] [[TMP9]], ptr [[TMP8]], align 16
...
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[B]] to <8 x i8>
// CHECK-NEXT:    [[VTRN_I:%.*]] = shufflevector <8 x i8> [[TMP0]], <8 x i8> [[TMP1]], <8 x i32> <i32 0, i32 8, i32 2, i32 10, i32 4, i32 12, i32 6, i32 14>
// CHECK-NEXT:    store <8 x i8> [[VTRN_I]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds <8 x i8>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VTRN1_I:%.*]] = shufflevector <8 x i8> [[TMP0]], <8 x i8> [[TMP1]], <8 x i32> <i32 1, i32 9, i32 3, i32 11, i32 5, i32 13, i32 7, i32 15>
// CHECK-NEXT:    store <8 x i8> [[VTRN1_I]], ptr [[TMP2]], align 8
// CHECK-NEXT:    [[TMP3:%.*]] = load [[STRUCT_INT8X8X2_T]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds nuw [[STRUCT_INT8X8X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP5:%.*]] = extractvalue [[STRUCT_INT8X8X2_T]] [[TMP3]], 0
// CHECK-NEXT:    store [2 x <8 x b8>] [[TMP5]], ptr [[TMP4]], align 8
...
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <8 x i8> [[TMP4]] to <4 x i16>
// CHECK-NEXT:    [[VTRN_I:%.*]] = shufflevector <4 x i16> [[TMP3]], <4 x i16> [[TMP5]], <4 x i32> <i32 0, i32 4, i32 2, i32 6>
// CHECK-NEXT:    store <4 x i16> [[VTRN_I]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds <4 x i16>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VTRN1_I:%.*]] = shufflevector <4 x i16> [[TMP3]], <4 x i16> [[TMP5]], <4 x i32> <i32 1, i32 5, i32 3, i32 7>
// CHECK-NEXT:    store <4 x i16> [[VTRN1_I]], ptr [[TMP6]], align 8
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_INT16X4X2_T]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_INT16X4X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_INT16X4X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <4 x i16>] [[TMP9]], ptr [[TMP8]], align 8
...
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <8 x i8> [[TMP4]] to <2 x i32>
// CHECK-NEXT:    [[VTRN_I:%.*]] = shufflevector <2 x i32> [[TMP3]], <2 x i32> [[TMP5]], <2 x i32> <i32 0, i32 2>
// CHECK-NEXT:    store <2 x i32> [[VTRN_I]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds <2 x i32>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VTRN1_I:%.*]] = shufflevector <2 x i32> [[TMP3]], <2 x i32> [[TMP5]], <2 x i32> <i32 1, i32 3>
// CHECK-NEXT:    store <2 x i32> [[VTRN1_I]], ptr [[TMP6]], align 8
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_INT32X2X2_T]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_INT32X2X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_INT32X2X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <2 x i32>] [[TMP9]], ptr [[TMP8]], align 8
...
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <8 x i8> [[TMP4]] to <2 x float>
// CHECK-NEXT:    [[VTRN_I:%.*]] = shufflevector <2 x float> [[TMP3]], <2 x float> [[TMP5]], <2 x i32> <i32 0, i32 2>
// CHECK-NEXT:    store <2 x float> [[VTRN_I]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds <2 x float>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VTRN1_I:%.*]] = shufflevector <2 x float> [[TMP3]], <2 x float> [[TMP5]], <2 x i32> <i32 1, i32 3>
// CHECK-NEXT:    store <2 x float> [[VTRN1_I]], ptr [[TMP6]], align 8
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_FLOAT32X2X2_T]], ptr [[RETVAL_I]], align 8
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_FLOAT32X2X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_FLOAT32X2X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <2 x float>] [[TMP9]], ptr [[TMP8]], align 8
...
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[B]] to <16 x i8>
// CHECK-NEXT:    [[VTRN_I:%.*]] = shufflevector <16 x i8> [[TMP0]], <16 x i8> [[TMP1]], <16 x i32> <i32 0, i32 16, i32 2, i32 18, i32 4, i32 20, i32 6, i32 22, i32 8, i32 24, i32 10, i32 26, i32 12, i32 28, i32 14, i32 30>
// CHECK-NEXT:    store <16 x i8> [[VTRN_I]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds <16 x i8>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VTRN1_I:%.*]] = shufflevector <16 x i8> [[TMP0]], <16 x i8> [[TMP1]], <16 x i32> <i32 1, i32 17, i32 3, i32 19, i32 5, i32 21, i32 7, i32 23, i32 9, i32 25, i32 11, i32 27, i32 13, i32 29, i32 15, i32 31>
// CHECK-NEXT:    store <16 x i8> [[VTRN1_I]], ptr [[TMP2]], align 16
// CHECK-NEXT:    [[TMP3:%.*]] = load [[STRUCT_INT8X16X2_T]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds nuw [[STRUCT_INT8X16X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP5:%.*]] = extractvalue [[STRUCT_INT8X16X2_T]] [[TMP3]], 0
// CHECK-NEXT:    store [2 x <16 x b8>] [[TMP5]], ptr [[TMP4]], align 16
...
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <16 x i8> [[TMP4]] to <8 x i16>
// CHECK-NEXT:    [[VTRN_I:%.*]] = shufflevector <8 x i16> [[TMP3]], <8 x i16> [[TMP5]], <8 x i32> <i32 0, i32 8, i32 2, i32 10, i32 4, i32 12, i32 6, i32 14>
// CHECK-NEXT:    store <8 x i16> [[VTRN_I]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds <8 x i16>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VTRN1_I:%.*]] = shufflevector <8 x i16> [[TMP3]], <8 x i16> [[TMP5]], <8 x i32> <i32 1, i32 9, i32 3, i32 11, i32 5, i32 13, i32 7, i32 15>
// CHECK-NEXT:    store <8 x i16> [[VTRN1_I]], ptr [[TMP6]], align 16
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_INT16X8X2_T]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_INT16X8X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_INT16X8X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <8 x i16>] [[TMP9]], ptr [[TMP8]], align 16
...
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <16 x i8> [[TMP4]] to <4 x i32>
// CHECK-NEXT:    [[VTRN_I:%.*]] = shufflevector <4 x i32> [[TMP3]], <4 x i32> [[TMP5]], <4 x i32> <i32 0, i32 4, i32 2, i32 6>
// CHECK-NEXT:    store <4 x i32> [[VTRN_I]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds <4 x i32>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VTRN1_I:%.*]] = shufflevector <4 x i32> [[TMP3]], <4 x i32> [[TMP5]], <4 x i32> <i32 1, i32 5, i32 3, i32 7>
// CHECK-NEXT:    store <4 x i32> [[VTRN1_I]], ptr [[TMP6]], align 16
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_INT32X4X2_T]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_INT32X4X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_INT32X4X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <4 x i32>] [[TMP9]], ptr [[TMP8]], align 16
...
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <16 x i8> [[TMP4]] to <4 x float>
// CHECK-NEXT:    [[VTRN_I:%.*]] = shufflevector <4 x float> [[TMP3]], <4 x float> [[TMP5]], <4 x i32> <i32 0, i32 4, i32 2, i32 6>
// CHECK-NEXT:    store <4 x float> [[VTRN_I]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds <4 x float>, ptr [[RETVAL_I]], i32 1
// CHECK-NEXT:    [[VTRN1_I:%.*]] = shufflevector <4 x float> [[TMP3]], <4 x float> [[TMP5]], <4 x i32> <i32 1, i32 5, i32 3, i32 7>
// CHECK-NEXT:    store <4 x float> [[VTRN1_I]], ptr [[TMP6]], align 16
// CHECK-NEXT:    [[TMP7:%.*]] = load [[STRUCT_FLOAT32X4X2_T]], ptr [[RETVAL_I]], align 16
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw [[STRUCT_FLOAT32X4X2_T]], ptr [[RETVAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = extractvalue [[STRUCT_FLOAT32X4X2_T]] [[TMP7]], 0
// CHECK-NEXT:    store [2 x <4 x float>] [[TMP9]], ptr [[TMP8]], align 16
