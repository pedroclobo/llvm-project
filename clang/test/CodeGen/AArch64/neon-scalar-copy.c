...
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i8 [[VGET_LANE]] to b8
...
// CHECK-SAME: <8 x b8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[__RET:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VGET_LANE:%.*]] = extractelement <8 x i8> [[TMP0]], i32 7
// CHECK-NEXT:    store i8 [[VGET_LANE]], ptr [[__RET]], align 1
// CHECK-NEXT:    [[TMP1:%.*]] = load b8, ptr [[__RET]], align 1
// CHECK-NEXT:    ret b8 [[TMP1]]
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i8 [[VGETQ_LANE]] to b8
// CHECK-NEXT:    ret b8 [[TMP1]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VGETQ_LANE:%.*]] = extractelement <16 x i8> [[TMP0]], i32 15
// CHECK-NEXT:    store i8 [[VGETQ_LANE]], ptr [[__RET]], align 1
// CHECK-NEXT:    [[TMP1:%.*]] = load b8, ptr [[__RET]], align 1
// CHECK-NEXT:    ret b8 [[TMP1]]
//
