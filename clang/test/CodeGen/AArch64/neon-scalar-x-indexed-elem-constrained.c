...
// UNCONSTRAINED-NEXT:    [[FMLA:%.*]] = bytecast exact <8 x b8> [[TMP4]] to <1 x double>
// UNCONSTRAINED-NEXT:    [[FMLA1:%.*]] = bytecast exact <8 x b8> [[TMP3]] to <1 x double>
...
// CONSTRAINED-NEXT:    [[FMLA:%.*]] = bytecast exact <8 x b8> [[TMP4]] to <1 x double>
// CONSTRAINED-NEXT:    [[FMLA1:%.*]] = bytecast exact <8 x b8> [[TMP3]] to <1 x double>
