...
// CHECK-NEXT:    [[LANE:%.*]] = shufflevector <1 x double> [[TMP4]], <1 x double> [[TMP4]], <1 x i32> zeroinitializer
// CHECK-NEXT:    [[FMLA:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <1 x double>
// CHECK-NEXT:    [[FMLA1:%.*]] = bytecast exact <8 x b8> [[TMP0]] to <1 x double>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <1 x double> [[A]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <1 x double> [[FNEG]] to <8 x b8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <1 x double> [[V]] to <8 x b8>
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <8 x b8> [[TMP2]] to <8 x i8>
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <8 x i8> [[TMP3]] to <1 x double>
// CHECK-NEXT:    [[LANE:%.*]] = shufflevector <1 x double> [[TMP4]], <1 x double> [[TMP4]], <1 x i32> zeroinitializer
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <8 x i8> [[TMP3]] to double
// CHECK-NEXT:    [[TMP5:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <8 x i8> [[TMP5]] to double
...
// CHECK-NEXT:    [[TMP9:%.*]] = call double @llvm.fma.f64(double [[TMP6]], double [[EXTRACT]], double [[TMP4]])
