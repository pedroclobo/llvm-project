...
// CHECK-NEXT:    [[VCMLA_F16_I:%.*]] = bytecast <8 x b8> [[TMP3]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_F161_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_F162_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <4 x half>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <8 x b8> [[VCMLA_F164_I]] to <4 x i16>
...
// CHECK-NEXT:    [[VCMLA_F32_I:%.*]] = bytecast <8 x b8> [[TMP3]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_F321_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_F322_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <2 x float>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <8 x b8> [[VCMLA_F324_I]] to <2 x i32>
...
// CHECK-NEXT:    [[VCMLAQ_F16_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_F161_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_F162_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <8 x half>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VCMLAQ_F164_I]] to <8 x i16>
...
// CHECK-NEXT:    [[VCMLAQ_F32_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_F321_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_F322_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <4 x float>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VCMLAQ_F324_I]] to <4 x i32>
...
// CHECK-NEXT:    [[VCMLAQ_F64_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <2 x double>
// CHECK-NEXT:    [[VCMLAQ_F641_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <2 x double>
// CHECK-NEXT:    [[VCMLAQ_F642_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <2 x double>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VCMLAQ_F644_I]] to <2 x i64>
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <4 x i16> [[TMP1]] to <8 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <4 x i16> [[TMP2]] to <8 x b8>
// CHECK-NEXT:    [[VCMLA_ROT90_F16_I:%.*]] = bytecast <8 x b8> [[TMP3]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_ROT90_F161_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_ROT90_F162_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <4 x half>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <8 x b8> [[VCMLA_ROT90_F164_I]] to <4 x i16>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <4 x i16> [[TMP6]] to <4 x half>
// CHECK-NEXT:    ret <4 x half> [[TMP7]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <2 x i32> [[TMP1]] to <8 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <2 x i32> [[TMP2]] to <8 x b8>
// CHECK-NEXT:    [[VCMLA_ROT90_F32_I:%.*]] = bytecast <8 x b8> [[TMP3]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_ROT90_F321_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_ROT90_F322_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <2 x float>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <8 x b8> [[VCMLA_ROT90_F324_I]] to <2 x i32>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <2 x i32> [[TMP6]] to <2 x float>
// CHECK-NEXT:    ret <2 x float> [[TMP7]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <8 x i16> [[TMP1]] to <16 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <8 x i16> [[TMP2]] to <16 x b8>
// CHECK-NEXT:    [[VCMLAQ_ROT90_F16_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_ROT90_F161_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_ROT90_F162_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <8 x half>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VCMLAQ_ROT90_F164_I]] to <8 x i16>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <8 x i16> [[TMP6]] to <8 x half>
// CHECK-NEXT:    ret <8 x half> [[TMP7]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <4 x i32> [[TMP1]] to <16 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <4 x i32> [[TMP2]] to <16 x b8>
// CHECK-NEXT:    [[VCMLAQ_ROT90_F32_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_ROT90_F321_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_ROT90_F322_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <4 x float>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VCMLAQ_ROT90_F324_I]] to <4 x i32>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <4 x i32> [[TMP6]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP7]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <2 x i64> [[TMP1]] to <16 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <2 x i64> [[TMP2]] to <16 x b8>
// CHECK-NEXT:    [[VCMLAQ_ROT90_F64_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <2 x double>
// CHECK-NEXT:    [[VCMLAQ_ROT90_F641_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <2 x double>
// CHECK-NEXT:    [[VCMLAQ_ROT90_F642_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <2 x double>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VCMLAQ_ROT90_F644_I]] to <2 x i64>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <2 x i64> [[TMP6]] to <2 x double>
// CHECK-NEXT:    ret <2 x double> [[TMP7]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <4 x i16> [[TMP1]] to <8 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <4 x i16> [[TMP2]] to <8 x b8>
// CHECK-NEXT:    [[VCMLA_ROT180_F16_I:%.*]] = bytecast <8 x b8> [[TMP3]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_ROT180_F161_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_ROT180_F162_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <4 x half>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <8 x b8> [[VCMLA_ROT180_F164_I]] to <4 x i16>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <4 x i16> [[TMP6]] to <4 x half>
// CHECK-NEXT:    ret <4 x half> [[TMP7]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <2 x i32> [[TMP1]] to <8 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <2 x i32> [[TMP2]] to <8 x b8>
// CHECK-NEXT:    [[VCMLA_ROT180_F32_I:%.*]] = bytecast <8 x b8> [[TMP3]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_ROT180_F321_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_ROT180_F322_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <2 x float>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <8 x b8> [[VCMLA_ROT180_F324_I]] to <2 x i32>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <2 x i32> [[TMP6]] to <2 x float>
// CHECK-NEXT:    ret <2 x float> [[TMP7]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <8 x i16> [[TMP1]] to <16 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <8 x i16> [[TMP2]] to <16 x b8>
// CHECK-NEXT:    [[VCMLAQ_ROT180_F16_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_ROT180_F161_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_ROT180_F162_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <8 x half>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VCMLAQ_ROT180_F164_I]] to <8 x i16>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <8 x i16> [[TMP6]] to <8 x half>
// CHECK-NEXT:    ret <8 x half> [[TMP7]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <4 x i32> [[TMP1]] to <16 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <4 x i32> [[TMP2]] to <16 x b8>
// CHECK-NEXT:    [[VCMLAQ_ROT180_F32_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_ROT180_F321_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_ROT180_F322_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <4 x float>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VCMLAQ_ROT180_F324_I]] to <4 x i32>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <4 x i32> [[TMP6]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP7]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <2 x i64> [[TMP1]] to <16 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <2 x i64> [[TMP2]] to <16 x b8>
// CHECK-NEXT:    [[VCMLAQ_ROT180_F64_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <2 x double>
// CHECK-NEXT:    [[VCMLAQ_ROT180_F641_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <2 x double>
// CHECK-NEXT:    [[VCMLAQ_ROT180_F642_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <2 x double>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VCMLAQ_ROT180_F644_I]] to <2 x i64>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <2 x i64> [[TMP6]] to <2 x double>
// CHECK-NEXT:    ret <2 x double> [[TMP7]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <4 x i16> [[TMP1]] to <8 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <4 x i16> [[TMP2]] to <8 x b8>
// CHECK-NEXT:    [[VCMLA_ROT270_F16_I:%.*]] = bytecast <8 x b8> [[TMP3]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_ROT270_F161_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_ROT270_F162_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <4 x half>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <8 x b8> [[VCMLA_ROT270_F164_I]] to <4 x i16>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <4 x i16> [[TMP6]] to <4 x half>
// CHECK-NEXT:    ret <4 x half> [[TMP7]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <2 x i32> [[TMP1]] to <8 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <2 x i32> [[TMP2]] to <8 x b8>
// CHECK-NEXT:    [[VCMLA_ROT270_F32_I:%.*]] = bytecast <8 x b8> [[TMP3]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_ROT270_F321_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_ROT270_F322_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <2 x float>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <8 x b8> [[VCMLA_ROT270_F324_I]] to <2 x i32>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <2 x i32> [[TMP6]] to <2 x float>
// CHECK-NEXT:    ret <2 x float> [[TMP7]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <8 x i16> [[TMP1]] to <16 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <8 x i16> [[TMP2]] to <16 x b8>
// CHECK-NEXT:    [[VCMLAQ_ROT270_F16_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_ROT270_F161_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_ROT270_F162_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <8 x half>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VCMLAQ_ROT270_F164_I]] to <8 x i16>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <8 x i16> [[TMP6]] to <8 x half>
// CHECK-NEXT:    ret <8 x half> [[TMP7]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <4 x i32> [[TMP1]] to <16 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <4 x i32> [[TMP2]] to <16 x b8>
// CHECK-NEXT:    [[VCMLAQ_ROT270_F32_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_ROT270_F321_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_ROT270_F322_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <4 x float>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VCMLAQ_ROT270_F324_I]] to <4 x i32>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <4 x i32> [[TMP6]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP7]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <2 x i64> [[TMP1]] to <16 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <2 x i64> [[TMP2]] to <16 x b8>
// CHECK-NEXT:    [[VCMLAQ_ROT270_F64_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <2 x double>
// CHECK-NEXT:    [[VCMLAQ_ROT270_F641_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <2 x double>
// CHECK-NEXT:    [[VCMLAQ_ROT270_F642_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <2 x double>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VCMLAQ_ROT270_F644_I]] to <2 x i64>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <2 x i64> [[TMP6]] to <2 x double>
// CHECK-NEXT:    ret <2 x double> [[TMP7]]
//
...
// CHECK-NEXT:    [[VCMLA_F16_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_F161_I:%.*]] = bytecast <8 x b8> [[TMP6]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_F162_I:%.*]] = bytecast <8 x b8> [[TMP7]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_F163_I:%.*]] = call <4 x half> @llvm.aarch64.neon.vcmla.rot0.v4f16(<4 x half> [[VCMLA_F16_I]], <4 x half> [[VCMLA_F161_I]], <4 x half> [[VCMLA_F162_I]])
// CHECK-NEXT:    [[VCMLA_F164_I:%.*]] = bitcast <4 x half> [[VCMLA_F163_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP8:%.*]] = bytecast <8 x b8> [[VCMLA_F164_I]] to <4 x i16>
...
// CHECK-NEXT:    [[VCMLAQ_F16_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_F161_I:%.*]] = bytecast <16 x b8> [[TMP6]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_F162_I:%.*]] = bytecast <16 x b8> [[TMP7]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_F163_I:%.*]] = call <8 x half> @llvm.aarch64.neon.vcmla.rot0.v8f16(<8 x half> [[VCMLAQ_F16_I]], <8 x half> [[VCMLAQ_F161_I]], <8 x half> [[VCMLAQ_F162_I]])
// CHECK-NEXT:    [[VCMLAQ_F164_I:%.*]] = bitcast <8 x half> [[VCMLAQ_F163_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP8:%.*]] = bytecast <16 x b8> [[VCMLAQ_F164_I]] to <8 x i16>
...
// CHECK-NEXT:    [[VCMLA_F32_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_F321_I:%.*]] = bytecast <8 x b8> [[TMP6]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_F322_I:%.*]] = bytecast <8 x b8> [[TMP7]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_F323_I:%.*]] = call <2 x float> @llvm.aarch64.neon.vcmla.rot0.v2f32(<2 x float> [[VCMLA_F32_I]], <2 x float> [[VCMLA_F321_I]], <2 x float> [[VCMLA_F322_I]])
// CHECK-NEXT:    [[VCMLA_F324_I:%.*]] = bitcast <2 x float> [[VCMLA_F323_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP8:%.*]] = bytecast <8 x b8> [[VCMLA_F324_I]] to <2 x i32>
...
// CHECK-NEXT:    [[VCMLAQ_F32_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_F321_I:%.*]] = bytecast <16 x b8> [[TMP6]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_F322_I:%.*]] = bytecast <16 x b8> [[TMP7]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_F323_I:%.*]] = call <4 x float> @llvm.aarch64.neon.vcmla.rot0.v4f32(<4 x float> [[VCMLAQ_F32_I]], <4 x float> [[VCMLAQ_F321_I]], <4 x float> [[VCMLAQ_F322_I]])
// CHECK-NEXT:    [[VCMLAQ_F324_I:%.*]] = bitcast <4 x float> [[VCMLAQ_F323_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP8:%.*]] = bytecast <16 x b8> [[VCMLAQ_F324_I]] to <4 x i32>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <4 x i16> [[TMP3]] to <8 x b8>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <4 x i16> [[TMP4]] to <8 x b8>
// CHECK-NEXT:    [[VCMLA_ROT90_F16_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_ROT90_F161_I:%.*]] = bytecast <8 x b8> [[TMP6]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_ROT90_F162_I:%.*]] = bytecast <8 x b8> [[TMP7]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_ROT90_F163_I:%.*]] = call <4 x half> @llvm.aarch64.neon.vcmla.rot90.v4f16(<4 x half> [[VCMLA_ROT90_F16_I]], <4 x half> [[VCMLA_ROT90_F161_I]], <4 x half> [[VCMLA_ROT90_F162_I]])
// CHECK-NEXT:    [[VCMLA_ROT90_F164_I:%.*]] = bitcast <4 x half> [[VCMLA_ROT90_F163_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP8:%.*]] = bytecast <8 x b8> [[VCMLA_ROT90_F164_I]] to <4 x i16>
// CHECK-NEXT:    [[TMP9:%.*]] = bitcast <4 x i16> [[TMP8]] to <4 x half>
// CHECK-NEXT:    ret <4 x half> [[TMP9]]
//
...
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <8 x i16> [[TMP3]] to <16 x b8>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <8 x i16> [[TMP4]] to <16 x b8>
// CHECK-NEXT:    [[VCMLAQ_ROT90_F16_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_ROT90_F161_I:%.*]] = bytecast <16 x b8> [[TMP6]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_ROT90_F162_I:%.*]] = bytecast <16 x b8> [[TMP7]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_ROT90_F163_I:%.*]] = call <8 x half> @llvm.aarch64.neon.vcmla.rot90.v8f16(<8 x half> [[VCMLAQ_ROT90_F16_I]], <8 x half> [[VCMLAQ_ROT90_F161_I]], <8 x half> [[VCMLAQ_ROT90_F162_I]])
// CHECK-NEXT:    [[VCMLAQ_ROT90_F164_I:%.*]] = bitcast <8 x half> [[VCMLAQ_ROT90_F163_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP8:%.*]] = bytecast <16 x b8> [[VCMLAQ_ROT90_F164_I]] to <8 x i16>
// CHECK-NEXT:    [[TMP9:%.*]] = bitcast <8 x i16> [[TMP8]] to <8 x half>
// CHECK-NEXT:    ret <8 x half> [[TMP9]]
//
...
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <2 x i32> [[TMP3]] to <8 x b8>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <2 x i32> [[TMP4]] to <8 x b8>
// CHECK-NEXT:    [[VCMLA_ROT90_F32_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_ROT90_F321_I:%.*]] = bytecast <8 x b8> [[TMP6]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_ROT90_F322_I:%.*]] = bytecast <8 x b8> [[TMP7]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_ROT90_F323_I:%.*]] = call <2 x float> @llvm.aarch64.neon.vcmla.rot90.v2f32(<2 x float> [[VCMLA_ROT90_F32_I]], <2 x float> [[VCMLA_ROT90_F321_I]], <2 x float> [[VCMLA_ROT90_F322_I]])
// CHECK-NEXT:    [[VCMLA_ROT90_F324_I:%.*]] = bitcast <2 x float> [[VCMLA_ROT90_F323_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP8:%.*]] = bytecast <8 x b8> [[VCMLA_ROT90_F324_I]] to <2 x i32>
// CHECK-NEXT:    [[TMP9:%.*]] = bitcast <2 x i32> [[TMP8]] to <2 x float>
// CHECK-NEXT:    ret <2 x float> [[TMP9]]
//
...
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <4 x i32> [[TMP3]] to <16 x b8>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <4 x i32> [[TMP4]] to <16 x b8>
// CHECK-NEXT:    [[VCMLAQ_ROT90_F32_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_ROT90_F321_I:%.*]] = bytecast <16 x b8> [[TMP6]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_ROT90_F322_I:%.*]] = bytecast <16 x b8> [[TMP7]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_ROT90_F323_I:%.*]] = call <4 x float> @llvm.aarch64.neon.vcmla.rot90.v4f32(<4 x float> [[VCMLAQ_ROT90_F32_I]], <4 x float> [[VCMLAQ_ROT90_F321_I]], <4 x float> [[VCMLAQ_ROT90_F322_I]])
// CHECK-NEXT:    [[VCMLAQ_ROT90_F324_I:%.*]] = bitcast <4 x float> [[VCMLAQ_ROT90_F323_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP8:%.*]] = bytecast <16 x b8> [[VCMLAQ_ROT90_F324_I]] to <4 x i32>
// CHECK-NEXT:    [[TMP9:%.*]] = bitcast <4 x i32> [[TMP8]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP9]]
//
...
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <4 x i16> [[TMP3]] to <8 x b8>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <4 x i16> [[TMP4]] to <8 x b8>
// CHECK-NEXT:    [[VCMLA_ROT180_F16_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_ROT180_F161_I:%.*]] = bytecast <8 x b8> [[TMP6]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_ROT180_F162_I:%.*]] = bytecast <8 x b8> [[TMP7]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_ROT180_F163_I:%.*]] = call <4 x half> @llvm.aarch64.neon.vcmla.rot180.v4f16(<4 x half> [[VCMLA_ROT180_F16_I]], <4 x half> [[VCMLA_ROT180_F161_I]], <4 x half> [[VCMLA_ROT180_F162_I]])
// CHECK-NEXT:    [[VCMLA_ROT180_F164_I:%.*]] = bitcast <4 x half> [[VCMLA_ROT180_F163_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP8:%.*]] = bytecast <8 x b8> [[VCMLA_ROT180_F164_I]] to <4 x i16>
// CHECK-NEXT:    [[TMP9:%.*]] = bitcast <4 x i16> [[TMP8]] to <4 x half>
// CHECK-NEXT:    ret <4 x half> [[TMP9]]
//
...
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <8 x i16> [[TMP3]] to <16 x b8>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <8 x i16> [[TMP4]] to <16 x b8>
// CHECK-NEXT:    [[VCMLAQ_ROT180_F16_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_ROT180_F161_I:%.*]] = bytecast <16 x b8> [[TMP6]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_ROT180_F162_I:%.*]] = bytecast <16 x b8> [[TMP7]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_ROT180_F163_I:%.*]] = call <8 x half> @llvm.aarch64.neon.vcmla.rot180.v8f16(<8 x half> [[VCMLAQ_ROT180_F16_I]], <8 x half> [[VCMLAQ_ROT180_F161_I]], <8 x half> [[VCMLAQ_ROT180_F162_I]])
// CHECK-NEXT:    [[VCMLAQ_ROT180_F164_I:%.*]] = bitcast <8 x half> [[VCMLAQ_ROT180_F163_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP8:%.*]] = bytecast <16 x b8> [[VCMLAQ_ROT180_F164_I]] to <8 x i16>
// CHECK-NEXT:    [[TMP9:%.*]] = bitcast <8 x i16> [[TMP8]] to <8 x half>
// CHECK-NEXT:    ret <8 x half> [[TMP9]]
//
...
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <2 x i32> [[TMP3]] to <8 x b8>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <2 x i32> [[TMP4]] to <8 x b8>
// CHECK-NEXT:    [[VCMLA_ROT180_F32_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_ROT180_F321_I:%.*]] = bytecast <8 x b8> [[TMP6]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_ROT180_F322_I:%.*]] = bytecast <8 x b8> [[TMP7]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_ROT180_F323_I:%.*]] = call <2 x float> @llvm.aarch64.neon.vcmla.rot180.v2f32(<2 x float> [[VCMLA_ROT180_F32_I]], <2 x float> [[VCMLA_ROT180_F321_I]], <2 x float> [[VCMLA_ROT180_F322_I]])
// CHECK-NEXT:    [[VCMLA_ROT180_F324_I:%.*]] = bitcast <2 x float> [[VCMLA_ROT180_F323_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP8:%.*]] = bytecast <8 x b8> [[VCMLA_ROT180_F324_I]] to <2 x i32>
// CHECK-NEXT:    [[TMP9:%.*]] = bitcast <2 x i32> [[TMP8]] to <2 x float>
// CHECK-NEXT:    ret <2 x float> [[TMP9]]
//
...
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <4 x i32> [[TMP3]] to <16 x b8>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <4 x i32> [[TMP4]] to <16 x b8>
// CHECK-NEXT:    [[VCMLAQ_ROT180_F32_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_ROT180_F321_I:%.*]] = bytecast <16 x b8> [[TMP6]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_ROT180_F322_I:%.*]] = bytecast <16 x b8> [[TMP7]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_ROT180_F323_I:%.*]] = call <4 x float> @llvm.aarch64.neon.vcmla.rot180.v4f32(<4 x float> [[VCMLAQ_ROT180_F32_I]], <4 x float> [[VCMLAQ_ROT180_F321_I]], <4 x float> [[VCMLAQ_ROT180_F322_I]])
// CHECK-NEXT:    [[VCMLAQ_ROT180_F324_I:%.*]] = bitcast <4 x float> [[VCMLAQ_ROT180_F323_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP8:%.*]] = bytecast <16 x b8> [[VCMLAQ_ROT180_F324_I]] to <4 x i32>
// CHECK-NEXT:    [[TMP9:%.*]] = bitcast <4 x i32> [[TMP8]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP9]]
//
...
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <4 x i16> [[TMP3]] to <8 x b8>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <4 x i16> [[TMP4]] to <8 x b8>
// CHECK-NEXT:    [[VCMLA_ROT270_F16_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_ROT270_F161_I:%.*]] = bytecast <8 x b8> [[TMP6]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_ROT270_F162_I:%.*]] = bytecast <8 x b8> [[TMP7]] to <4 x half>
// CHECK-NEXT:    [[VCMLA_ROT270_F163_I:%.*]] = call <4 x half> @llvm.aarch64.neon.vcmla.rot270.v4f16(<4 x half> [[VCMLA_ROT270_F16_I]], <4 x half> [[VCMLA_ROT270_F161_I]], <4 x half> [[VCMLA_ROT270_F162_I]])
// CHECK-NEXT:    [[VCMLA_ROT270_F164_I:%.*]] = bitcast <4 x half> [[VCMLA_ROT270_F163_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP8:%.*]] = bytecast <8 x b8> [[VCMLA_ROT270_F164_I]] to <4 x i16>
// CHECK-NEXT:    [[TMP9:%.*]] = bitcast <4 x i16> [[TMP8]] to <4 x half>
// CHECK-NEXT:    ret <4 x half> [[TMP9]]
//
...
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <8 x i16> [[TMP3]] to <16 x b8>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <8 x i16> [[TMP4]] to <16 x b8>
// CHECK-NEXT:    [[VCMLAQ_ROT270_F16_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_ROT270_F161_I:%.*]] = bytecast <16 x b8> [[TMP6]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_ROT270_F162_I:%.*]] = bytecast <16 x b8> [[TMP7]] to <8 x half>
// CHECK-NEXT:    [[VCMLAQ_ROT270_F163_I:%.*]] = call <8 x half> @llvm.aarch64.neon.vcmla.rot270.v8f16(<8 x half> [[VCMLAQ_ROT270_F16_I]], <8 x half> [[VCMLAQ_ROT270_F161_I]], <8 x half> [[VCMLAQ_ROT270_F162_I]])
// CHECK-NEXT:    [[VCMLAQ_ROT270_F164_I:%.*]] = bitcast <8 x half> [[VCMLAQ_ROT270_F163_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP8:%.*]] = bytecast <16 x b8> [[VCMLAQ_ROT270_F164_I]] to <8 x i16>
// CHECK-NEXT:    [[TMP9:%.*]] = bitcast <8 x i16> [[TMP8]] to <8 x half>
// CHECK-NEXT:    ret <8 x half> [[TMP9]]
//
...
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <2 x i32> [[TMP3]] to <8 x b8>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <2 x i32> [[TMP4]] to <8 x b8>
// CHECK-NEXT:    [[VCMLA_ROT270_F32_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_ROT270_F321_I:%.*]] = bytecast <8 x b8> [[TMP6]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_ROT270_F322_I:%.*]] = bytecast <8 x b8> [[TMP7]] to <2 x float>
// CHECK-NEXT:    [[VCMLA_ROT270_F323_I:%.*]] = call <2 x float> @llvm.aarch64.neon.vcmla.rot270.v2f32(<2 x float> [[VCMLA_ROT270_F32_I]], <2 x float> [[VCMLA_ROT270_F321_I]], <2 x float> [[VCMLA_ROT270_F322_I]])
// CHECK-NEXT:    [[VCMLA_ROT270_F324_I:%.*]] = bitcast <2 x float> [[VCMLA_ROT270_F323_I]] to <8 x b8>
// CHECK-NEXT:    [[TMP8:%.*]] = bytecast <8 x b8> [[VCMLA_ROT270_F324_I]] to <2 x i32>
// CHECK-NEXT:    [[TMP9:%.*]] = bitcast <2 x i32> [[TMP8]] to <2 x float>
// CHECK-NEXT:    ret <2 x float> [[TMP9]]
//
...
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <4 x i32> [[TMP3]] to <16 x b8>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <4 x i32> [[TMP4]] to <16 x b8>
// CHECK-NEXT:    [[VCMLAQ_ROT270_F32_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_ROT270_F321_I:%.*]] = bytecast <16 x b8> [[TMP6]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_ROT270_F322_I:%.*]] = bytecast <16 x b8> [[TMP7]] to <4 x float>
// CHECK-NEXT:    [[VCMLAQ_ROT270_F323_I:%.*]] = call <4 x float> @llvm.aarch64.neon.vcmla.rot270.v4f32(<4 x float> [[VCMLAQ_ROT270_F32_I]], <4 x float> [[VCMLAQ_ROT270_F321_I]], <4 x float> [[VCMLAQ_ROT270_F322_I]])
// CHECK-NEXT:    [[VCMLAQ_ROT270_F324_I:%.*]] = bitcast <4 x float> [[VCMLAQ_ROT270_F323_I]] to <16 x b8>
// CHECK-NEXT:    [[TMP8:%.*]] = bytecast <16 x b8> [[VCMLAQ_ROT270_F324_I]] to <4 x i32>
// CHECK-NEXT:    [[TMP9:%.*]] = bitcast <4 x i32> [[TMP8]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP9]]
//
