...
// CHECK-NEXT:    [[COERCE_DIVE:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X1X2_T]], ptr [[VAL]], i32 0, i32 0
// CHECK-NEXT:    store [2 x <1 x i64>] [[VAL_COERCE]], ptr [[COERCE_DIVE]], align 8
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[__S1]], ptr align 8 [[VAL]], i64 16, i1 false)
// CHECK-NEXT:    [[VAL1:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X1X2_T]], ptr [[__S1]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x <1 x i64>], ptr [[VAL1]], i64 0, i64 0
// CHECK-NEXT:    [[TMP0:%.*]] = load <1 x i64>, ptr [[ARRAYIDX]], align 8
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <1 x i64> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VAL2:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X1X2_T]], ptr [[__S1]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX3:%.*]] = getelementptr inbounds [2 x <1 x i64>], ptr [[VAL2]], i64 0, i64 1
// CHECK-NEXT:    [[TMP2:%.*]] = load <1 x i64>, ptr [[ARRAYIDX3]], align 8
...
// CHECK-NEXT:    call void @llvm.aarch64.neon.st2.v1i64.p0(<1 x i64> [[TMP4]], <1 x i64> [[TMP5]], ptr [[PTR]])
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[COERCE_DIVE:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X2X2_T]], ptr [[VAL]], i32 0, i32 0
// CHECK-NEXT:    store [2 x <2 x i64>] [[VAL_COERCE]], ptr [[COERCE_DIVE]], align 16
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 16 [[__S1]], ptr align 16 [[VAL]], i64 32, i1 false)
// CHECK-NEXT:    [[VAL1:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X2X2_T]], ptr [[__S1]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x <2 x i64>], ptr [[VAL1]], i64 0, i64 0
// CHECK-NEXT:    [[TMP0:%.*]] = load <2 x i64>, ptr [[ARRAYIDX]], align 16
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i64> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VAL2:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X2X2_T]], ptr [[__S1]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX3:%.*]] = getelementptr inbounds [2 x <2 x i64>], ptr [[VAL2]], i64 0, i64 1
// CHECK-NEXT:    [[TMP2:%.*]] = load <2 x i64>, ptr [[ARRAYIDX3]], align 16
...
// CHECK-NEXT:    call void @llvm.aarch64.neon.st2.v2i64.p0(<2 x i64> [[TMP4]], <2 x i64> [[TMP5]], ptr [[PTR]])
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[COERCE_DIVE:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X1X3_T]], ptr [[VAL]], i32 0, i32 0
// CHECK-NEXT:    store [3 x <1 x i64>] [[VAL_COERCE]], ptr [[COERCE_DIVE]], align 8
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[__S1]], ptr align 8 [[VAL]], i64 24, i1 false)
// CHECK-NEXT:    [[VAL1:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X1X3_T]], ptr [[__S1]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [3 x <1 x i64>], ptr [[VAL1]], i64 0, i64 0
// CHECK-NEXT:    [[TMP0:%.*]] = load <1 x i64>, ptr [[ARRAYIDX]], align 8
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <1 x i64> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VAL2:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X1X3_T]], ptr [[__S1]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX3:%.*]] = getelementptr inbounds [3 x <1 x i64>], ptr [[VAL2]], i64 0, i64 1
// CHECK-NEXT:    [[TMP2:%.*]] = load <1 x i64>, ptr [[ARRAYIDX3]], align 8
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <1 x i64> [[TMP2]] to <8 x b8>
// CHECK-NEXT:    [[VAL4:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X1X3_T]], ptr [[__S1]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX5:%.*]] = getelementptr inbounds [3 x <1 x i64>], ptr [[VAL4]], i64 0, i64 2
// CHECK-NEXT:    [[TMP4:%.*]] = load <1 x i64>, ptr [[ARRAYIDX5]], align 8
...
// CHECK-NEXT:    call void @llvm.aarch64.neon.st3.v1i64.p0(<1 x i64> [[TMP6]], <1 x i64> [[TMP7]], <1 x i64> [[TMP8]], ptr [[PTR]])
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[COERCE_DIVE:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X2X3_T]], ptr [[VAL]], i32 0, i32 0
// CHECK-NEXT:    store [3 x <2 x i64>] [[VAL_COERCE]], ptr [[COERCE_DIVE]], align 16
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 16 [[__S1]], ptr align 16 [[VAL]], i64 48, i1 false)
// CHECK-NEXT:    [[VAL1:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X2X3_T]], ptr [[__S1]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [3 x <2 x i64>], ptr [[VAL1]], i64 0, i64 0
// CHECK-NEXT:    [[TMP0:%.*]] = load <2 x i64>, ptr [[ARRAYIDX]], align 16
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i64> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VAL2:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X2X3_T]], ptr [[__S1]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX3:%.*]] = getelementptr inbounds [3 x <2 x i64>], ptr [[VAL2]], i64 0, i64 1
// CHECK-NEXT:    [[TMP2:%.*]] = load <2 x i64>, ptr [[ARRAYIDX3]], align 16
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <2 x i64> [[TMP2]] to <16 x b8>
// CHECK-NEXT:    [[VAL4:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X2X3_T]], ptr [[__S1]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX5:%.*]] = getelementptr inbounds [3 x <2 x i64>], ptr [[VAL4]], i64 0, i64 2
// CHECK-NEXT:    [[TMP4:%.*]] = load <2 x i64>, ptr [[ARRAYIDX5]], align 16
...
// CHECK-NEXT:    call void @llvm.aarch64.neon.st3.v2i64.p0(<2 x i64> [[TMP6]], <2 x i64> [[TMP7]], <2 x i64> [[TMP8]], ptr [[PTR]])
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[COERCE_DIVE:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X1X4_T]], ptr [[VAL]], i32 0, i32 0
// CHECK-NEXT:    store [4 x <1 x i64>] [[VAL_COERCE]], ptr [[COERCE_DIVE]], align 8
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[__S1]], ptr align 8 [[VAL]], i64 32, i1 false)
// CHECK-NEXT:    [[VAL1:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X1X4_T]], ptr [[__S1]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [4 x <1 x i64>], ptr [[VAL1]], i64 0, i64 0
// CHECK-NEXT:    [[TMP0:%.*]] = load <1 x i64>, ptr [[ARRAYIDX]], align 8
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <1 x i64> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VAL2:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X1X4_T]], ptr [[__S1]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX3:%.*]] = getelementptr inbounds [4 x <1 x i64>], ptr [[VAL2]], i64 0, i64 1
// CHECK-NEXT:    [[TMP2:%.*]] = load <1 x i64>, ptr [[ARRAYIDX3]], align 8
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <1 x i64> [[TMP2]] to <8 x b8>
// CHECK-NEXT:    [[VAL4:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X1X4_T]], ptr [[__S1]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX5:%.*]] = getelementptr inbounds [4 x <1 x i64>], ptr [[VAL4]], i64 0, i64 2
// CHECK-NEXT:    [[TMP4:%.*]] = load <1 x i64>, ptr [[ARRAYIDX5]], align 8
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <1 x i64> [[TMP4]] to <8 x b8>
// CHECK-NEXT:    [[VAL6:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X1X4_T]], ptr [[__S1]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX7:%.*]] = getelementptr inbounds [4 x <1 x i64>], ptr [[VAL6]], i64 0, i64 3
// CHECK-NEXT:    [[TMP6:%.*]] = load <1 x i64>, ptr [[ARRAYIDX7]], align 8
...
// CHECK-NEXT:    call void @llvm.aarch64.neon.st4.v1i64.p0(<1 x i64> [[TMP8]], <1 x i64> [[TMP9]], <1 x i64> [[TMP10]], <1 x i64> [[TMP11]], ptr [[PTR]])
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[COERCE_DIVE:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X2X4_T]], ptr [[VAL]], i32 0, i32 0
// CHECK-NEXT:    store [4 x <2 x i64>] [[VAL_COERCE]], ptr [[COERCE_DIVE]], align 16
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 16 [[__S1]], ptr align 16 [[VAL]], i64 64, i1 false)
// CHECK-NEXT:    [[VAL1:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X2X4_T]], ptr [[__S1]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [4 x <2 x i64>], ptr [[VAL1]], i64 0, i64 0
// CHECK-NEXT:    [[TMP0:%.*]] = load <2 x i64>, ptr [[ARRAYIDX]], align 16
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i64> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VAL2:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X2X4_T]], ptr [[__S1]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX3:%.*]] = getelementptr inbounds [4 x <2 x i64>], ptr [[VAL2]], i64 0, i64 1
// CHECK-NEXT:    [[TMP2:%.*]] = load <2 x i64>, ptr [[ARRAYIDX3]], align 16
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <2 x i64> [[TMP2]] to <16 x b8>
// CHECK-NEXT:    [[VAL4:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X2X4_T]], ptr [[__S1]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX5:%.*]] = getelementptr inbounds [4 x <2 x i64>], ptr [[VAL4]], i64 0, i64 2
// CHECK-NEXT:    [[TMP4:%.*]] = load <2 x i64>, ptr [[ARRAYIDX5]], align 16
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <2 x i64> [[TMP4]] to <16 x b8>
// CHECK-NEXT:    [[VAL6:%.*]] = getelementptr inbounds nuw [[STRUCT_POLY64X2X4_T]], ptr [[__S1]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX7:%.*]] = getelementptr inbounds [4 x <2 x i64>], ptr [[VAL6]], i64 0, i64 3
// CHECK-NEXT:    [[TMP6:%.*]] = load <2 x i64>, ptr [[ARRAYIDX7]], align 16
...
// CHECK-NEXT:    call void @llvm.aarch64.neon.st4.v2i64.p0(<2 x i64> [[TMP8]], <2 x i64> [[TMP9]], <2 x i64> [[TMP10]], <2 x i64> [[TMP11]], ptr [[PTR]])
// CHECK-NEXT:    ret void
//
