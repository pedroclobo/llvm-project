...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <1 x i64> [[A]] to <8 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <1 x i64> [[B]] to <8 x b8>
// CHECK-NEXT:    [[VSRI_N:%.*]] = bytecast <8 x b8> [[TMP0]] to <1 x i64>
// CHECK-NEXT:    [[VSRI_N1:%.*]] = bytecast <8 x b8> [[TMP1]] to <1 x i64>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x i64> [[A]] to <16 x b8>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i64> [[B]] to <16 x b8>
// CHECK-NEXT:    [[VSRI_N:%.*]] = bytecast <16 x b8> [[TMP0]] to <2 x i64>
// CHECK-NEXT:    [[VSRI_N1:%.*]] = bytecast <16 x b8> [[TMP1]] to <2 x i64>
