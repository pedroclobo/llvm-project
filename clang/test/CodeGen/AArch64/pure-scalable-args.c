...
// CHECK-AAPCS-NEXT: %1 = bytecast <vscale x 2 x b8> %cast.scalable to <vscale x 16 x i1>
...
// CHECK-AAPCS-NEXT: %12 = bytecast <vscale x 2 x b8> %cast.scalable5 to <vscale x 16 x i1>
...
// CHECK-AAPCS-NEXT:   %3 = bytecast <vscale x 2 x b8> %cast.scalable to <vscale x 16 x i1>
...
// CHECK-DARWIN-NEXT:   %1 = bytecast <vscale x 2 x b8> %cast.scalable to <vscale x 16 x i1>
