...
// CHECK: declare void @argpass_no_z_callee(<vscale x 16 x i8>, <16 x b8> noundef, <16 x i8>, double noundef, double noundef, i32 noundef, ptr noundef, i32 noundef, double noundef, <vscale x 16 x i1>)
