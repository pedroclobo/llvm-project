...
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast b8 [[BASE:%.*]] to i8
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast b8 [[STEP:%.*]] to i8
...
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = bytecast b8 [[BASE:%.*]] to i8
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = bytecast b8 [[STEP:%.*]] to i8
