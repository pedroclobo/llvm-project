...
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact b8 [[BASE:%.*]] to i8
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact b8 [[STEP:%.*]] to i8
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <vscale x 16 x i8> @llvm.aarch64.sve.index.nxv16i8(i8 [[TMP0]], i8 [[TMP1]])
...
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact b8 [[BASE:%.*]] to i8
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact b8 [[STEP:%.*]] to i8
// CPP-CHECK-NEXT:    [[TMP2:%.*]] = tail call <vscale x 16 x i8> @llvm.aarch64.sve.index.nxv16i8(i8 [[TMP0]], i8 [[TMP1]])
