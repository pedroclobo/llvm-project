...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact b8 [[OP2:%.*]] to i8
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <vscale x 16 x i8> @llvm.aarch64.sve.insr.nxv16i8(<vscale x 16 x i8> [[TMP0]], i8 [[TMP1]])
...
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact b8 [[OP2:%.*]] to i8
// CPP-CHECK-NEXT:    [[TMP2:%.*]] = tail call <vscale x 16 x i8> @llvm.aarch64.sve.insr.nxv16i8(<vscale x 16 x i8> [[TMP0]], i8 [[TMP1]])
