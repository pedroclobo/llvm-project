...
// CHECK-NEXT:    [[TMP1:%.*]] = tail call <vscale x 8 x b8> @llvm.masked.load.nxv8b8.p0(ptr align 1 [[BASE:%.*]], <vscale x 8 x i1> [[TMP0]], <vscale x 8 x b8> zeroinitializer)
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast <vscale x 8 x b8> [[TMP1]] to <vscale x 8 x i8>
...
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = tail call <vscale x 8 x b8> @llvm.masked.load.nxv8b8.p0(ptr align 1 [[BASE:%.*]], <vscale x 8 x i1> [[TMP0]], <vscale x 8 x b8> zeroinitializer)
// CPP-CHECK-NEXT:    [[TMP2:%.*]] = bytecast <vscale x 8 x b8> [[TMP1]] to <vscale x 8 x i8>
...
// CHECK-NEXT:    [[TMP1:%.*]] = tail call <vscale x 4 x b8> @llvm.masked.load.nxv4b8.p0(ptr align 1 [[BASE:%.*]], <vscale x 4 x i1> [[TMP0]], <vscale x 4 x b8> zeroinitializer)
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast <vscale x 4 x b8> [[TMP1]] to <vscale x 4 x i8>
...
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = tail call <vscale x 4 x b8> @llvm.masked.load.nxv4b8.p0(ptr align 1 [[BASE:%.*]], <vscale x 4 x i1> [[TMP0]], <vscale x 4 x b8> zeroinitializer)
// CPP-CHECK-NEXT:    [[TMP2:%.*]] = bytecast <vscale x 4 x b8> [[TMP1]] to <vscale x 4 x i8>
...
// CHECK-NEXT:    [[TMP1:%.*]] = tail call <vscale x 2 x b8> @llvm.masked.load.nxv2b8.p0(ptr align 1 [[BASE:%.*]], <vscale x 2 x i1> [[TMP0]], <vscale x 2 x b8> zeroinitializer)
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast <vscale x 2 x b8> [[TMP1]] to <vscale x 2 x i8>
...
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = tail call <vscale x 2 x b8> @llvm.masked.load.nxv2b8.p0(ptr align 1 [[BASE:%.*]], <vscale x 2 x i1> [[TMP0]], <vscale x 2 x b8> zeroinitializer)
// CPP-CHECK-NEXT:    [[TMP2:%.*]] = bytecast <vscale x 2 x b8> [[TMP1]] to <vscale x 2 x i8>
...
// CHECK-NEXT:    [[TMP4:%.*]] = tail call <vscale x 8 x b8> @llvm.masked.load.nxv8b8.p0(ptr align 1 [[TMP3]], <vscale x 8 x i1> [[TMP0]], <vscale x 8 x b8> zeroinitializer)
// CHECK-NEXT:    [[TMP5:%.*]] = bytecast <vscale x 8 x b8> [[TMP4]] to <vscale x 8 x i8>
...
// CPP-CHECK-NEXT:    [[TMP4:%.*]] = tail call <vscale x 8 x b8> @llvm.masked.load.nxv8b8.p0(ptr align 1 [[TMP3]], <vscale x 8 x i1> [[TMP0]], <vscale x 8 x b8> zeroinitializer)
// CPP-CHECK-NEXT:    [[TMP5:%.*]] = bytecast <vscale x 8 x b8> [[TMP4]] to <vscale x 8 x i8>
...
// CHECK-NEXT:    [[DOTIDX:%.*]] = mul i64 [[VNUM:%.*]], [[TMP2]]
// CHECK-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[BASE:%.*]], i64 [[DOTIDX]]
// CHECK-NEXT:    [[TMP4:%.*]] = tail call <vscale x 4 x b8> @llvm.masked.load.nxv4b8.p0(ptr align 1 [[TMP3]], <vscale x 4 x i1> [[TMP0]], <vscale x 4 x b8> zeroinitializer)
// CHECK-NEXT:    [[TMP5:%.*]] = bytecast <vscale x 4 x b8> [[TMP4]] to <vscale x 4 x i8>
...
// CPP-CHECK-NEXT:    [[DOTIDX:%.*]] = mul i64 [[VNUM:%.*]], [[TMP2]]
// CPP-CHECK-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[BASE:%.*]], i64 [[DOTIDX]]
// CPP-CHECK-NEXT:    [[TMP4:%.*]] = tail call <vscale x 4 x b8> @llvm.masked.load.nxv4b8.p0(ptr align 1 [[TMP3]], <vscale x 4 x i1> [[TMP0]], <vscale x 4 x b8> zeroinitializer)
// CPP-CHECK-NEXT:    [[TMP5:%.*]] = bytecast <vscale x 4 x b8> [[TMP4]] to <vscale x 4 x i8>
...
// CHECK-NEXT:    [[DOTIDX:%.*]] = mul i64 [[VNUM:%.*]], [[TMP2]]
// CHECK-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[BASE:%.*]], i64 [[DOTIDX]]
// CHECK-NEXT:    [[TMP4:%.*]] = tail call <vscale x 2 x b8> @llvm.masked.load.nxv2b8.p0(ptr align 1 [[TMP3]], <vscale x 2 x i1> [[TMP0]], <vscale x 2 x b8> zeroinitializer)
// CHECK-NEXT:    [[TMP5:%.*]] = bytecast <vscale x 2 x b8> [[TMP4]] to <vscale x 2 x i8>
...
// CPP-CHECK-NEXT:    [[DOTIDX:%.*]] = mul i64 [[VNUM:%.*]], [[TMP2]]
// CPP-CHECK-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[BASE:%.*]], i64 [[DOTIDX]]
// CPP-CHECK-NEXT:    [[TMP4:%.*]] = tail call <vscale x 2 x b8> @llvm.masked.load.nxv2b8.p0(ptr align 1 [[TMP3]], <vscale x 2 x i1> [[TMP0]], <vscale x 2 x b8> zeroinitializer)
// CPP-CHECK-NEXT:    [[TMP5:%.*]] = bytecast <vscale x 2 x b8> [[TMP4]] to <vscale x 2 x i8>
