...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = tail call <vscale x 16 x b8> @llvm.aarch64.sve.ldff1.nxv16b8(<vscale x 16 x i1> [[PG:%.*]], ptr [[BASE:%.*]])
// CHECK-NEXT:    ret <vscale x 16 x b8> [[TMP0]]
//
// CPP-CHECK-LABEL: @_Z15test_svldff1_s8u10__SVBool_tPKa(
// CPP-CHECK-NEXT:  entry:
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = tail call <vscale x 16 x b8> @llvm.aarch64.sve.ldff1.nxv16b8(<vscale x 16 x i1> [[PG:%.*]], ptr [[BASE:%.*]])
...
// CHECK-NEXT:    [[TMP1:%.*]] = tail call <vscale x 16 x b8> @llvm.aarch64.sve.ldff1.nxv16b8(<vscale x 16 x i1> [[PG:%.*]], ptr [[TMP0]])
...
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = tail call <vscale x 16 x b8> @llvm.aarch64.sve.ldff1.nxv16b8(<vscale x 16 x i1> [[PG:%.*]], ptr [[TMP0]])
