...
// CHECK-NEXT:    [[TMP1:%.*]] = tail call <vscale x 8 x b8> @llvm.aarch64.sve.ldnf1.nxv8b8(<vscale x 8 x i1> [[TMP0]], ptr [[BASE:%.*]])
...
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = tail call <vscale x 8 x b8> @llvm.aarch64.sve.ldnf1.nxv8b8(<vscale x 8 x i1> [[TMP0]], ptr [[BASE:%.*]])
...
// CHECK-NEXT:    [[TMP1:%.*]] = tail call <vscale x 4 x b8> @llvm.aarch64.sve.ldnf1.nxv4b8(<vscale x 4 x i1> [[TMP0]], ptr [[BASE:%.*]])
...
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = tail call <vscale x 4 x b8> @llvm.aarch64.sve.ldnf1.nxv4b8(<vscale x 4 x i1> [[TMP0]], ptr [[BASE:%.*]])
...
// CHECK-NEXT:    [[TMP1:%.*]] = tail call <vscale x 2 x b8> @llvm.aarch64.sve.ldnf1.nxv2b8(<vscale x 2 x i1> [[TMP0]], ptr [[BASE:%.*]])
...
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = tail call <vscale x 2 x b8> @llvm.aarch64.sve.ldnf1.nxv2b8(<vscale x 2 x i1> [[TMP0]], ptr [[BASE:%.*]])
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = tail call <vscale x 8 x i1> @llvm.aarch64.sve.convert.from.svbool.nxv8i1(<vscale x 16 x i1> [[PG:%.*]])
// CHECK-NEXT:    [[TMP1:%.*]] = getelementptr <vscale x 8 x b8>, ptr [[BASE:%.*]], i64 [[VNUM:%.*]]
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <vscale x 8 x b8> @llvm.aarch64.sve.ldnf1.nxv8b8(<vscale x 8 x i1> [[TMP0]], ptr [[TMP1]])
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <vscale x 8 x b8> [[TMP2]] to <vscale x 8 x i8>
...
// CPP-CHECK-NEXT:  entry:
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = tail call <vscale x 8 x i1> @llvm.aarch64.sve.convert.from.svbool.nxv8i1(<vscale x 16 x i1> [[PG:%.*]])
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = getelementptr <vscale x 8 x b8>, ptr [[BASE:%.*]], i64 [[VNUM:%.*]]
// CPP-CHECK-NEXT:    [[TMP2:%.*]] = tail call <vscale x 8 x b8> @llvm.aarch64.sve.ldnf1.nxv8b8(<vscale x 8 x i1> [[TMP0]], ptr [[TMP1]])
// CPP-CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <vscale x 8 x b8> [[TMP2]] to <vscale x 8 x i8>
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = tail call <vscale x 4 x i1> @llvm.aarch64.sve.convert.from.svbool.nxv4i1(<vscale x 16 x i1> [[PG:%.*]])
// CHECK-NEXT:    [[TMP1:%.*]] = getelementptr <vscale x 4 x b8>, ptr [[BASE:%.*]], i64 [[VNUM:%.*]]
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <vscale x 4 x b8> @llvm.aarch64.sve.ldnf1.nxv4b8(<vscale x 4 x i1> [[TMP0]], ptr [[TMP1]])
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <vscale x 4 x b8> [[TMP2]] to <vscale x 4 x i8>
...
// CPP-CHECK-NEXT:  entry:
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = tail call <vscale x 4 x i1> @llvm.aarch64.sve.convert.from.svbool.nxv4i1(<vscale x 16 x i1> [[PG:%.*]])
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = getelementptr <vscale x 4 x b8>, ptr [[BASE:%.*]], i64 [[VNUM:%.*]]
// CPP-CHECK-NEXT:    [[TMP2:%.*]] = tail call <vscale x 4 x b8> @llvm.aarch64.sve.ldnf1.nxv4b8(<vscale x 4 x i1> [[TMP0]], ptr [[TMP1]])
// CPP-CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <vscale x 4 x b8> [[TMP2]] to <vscale x 4 x i8>
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = tail call <vscale x 2 x i1> @llvm.aarch64.sve.convert.from.svbool.nxv2i1(<vscale x 16 x i1> [[PG:%.*]])
// CHECK-NEXT:    [[TMP1:%.*]] = getelementptr <vscale x 2 x b8>, ptr [[BASE:%.*]], i64 [[VNUM:%.*]]
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <vscale x 2 x b8> @llvm.aarch64.sve.ldnf1.nxv2b8(<vscale x 2 x i1> [[TMP0]], ptr [[TMP1]])
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <vscale x 2 x b8> [[TMP2]] to <vscale x 2 x i8>
...
// CPP-CHECK-NEXT:  entry:
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = tail call <vscale x 2 x i1> @llvm.aarch64.sve.convert.from.svbool.nxv2i1(<vscale x 16 x i1> [[PG:%.*]])
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = getelementptr <vscale x 2 x b8>, ptr [[BASE:%.*]], i64 [[VNUM:%.*]]
// CPP-CHECK-NEXT:    [[TMP2:%.*]] = tail call <vscale x 2 x b8> @llvm.aarch64.sve.ldnf1.nxv2b8(<vscale x 2 x i1> [[TMP0]], ptr [[TMP1]])
// CPP-CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <vscale x 2 x b8> [[TMP2]] to <vscale x 2 x i8>
