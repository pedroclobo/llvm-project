...
// CHECK-NEXT:    [[TMP1:%.*]] = tail call i8 @llvm.aarch64.sve.smaxv.nxv16i8(<vscale x 16 x i1> [[PG:%.*]], <vscale x 16 x i8> [[TMP0]])
...
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = tail call i8 @llvm.aarch64.sve.smaxv.nxv16i8(<vscale x 16 x i1> [[PG:%.*]], <vscale x 16 x i8> [[TMP0]])
...
// CHECK-NEXT:    [[RETVAL:%.*]] = alloca b8, align 1
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast <vscale x 16 x b8> [[OP:%.*]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = tail call i8 @llvm.aarch64.sve.umaxv.nxv16i8(<vscale x 16 x i1> [[PG:%.*]], <vscale x 16 x i8> [[TMP0]])
// CHECK-NEXT:    store i8 [[TMP1]], ptr [[RETVAL]], align 1
// CHECK-NEXT:    [[TMP2:%.*]] = load b8, ptr [[RETVAL]], align 1
// CHECK-NEXT:    ret b8 [[TMP2]]
//
...
// CPP-CHECK-NEXT:    [[RETVAL:%.*]] = alloca b8, align 1
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = bytecast <vscale x 16 x b8> [[OP:%.*]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = tail call i8 @llvm.aarch64.sve.umaxv.nxv16i8(<vscale x 16 x i1> [[PG:%.*]], <vscale x 16 x i8> [[TMP0]])
// CPP-CHECK-NEXT:    store i8 [[TMP1]], ptr [[RETVAL]], align 1
// CPP-CHECK-NEXT:    [[TMP2:%.*]] = load b8, ptr [[RETVAL]], align 1
// CPP-CHECK-NEXT:    ret b8 [[TMP2]]
//
