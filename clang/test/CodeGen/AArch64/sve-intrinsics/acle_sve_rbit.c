...
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <vscale x 16 x b8> zeroinitializer to <vscale x 16 x i8>
...
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <vscale x 16 x b8> zeroinitializer to <vscale x 16 x i8>
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[RETVAL:%.*]] = alloca <vscale x 16 x b8>, align 16
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <vscale x 16 x b8> undef to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <vscale x 16 x b8> [[OP:%.*]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <vscale x 16 x i8> @llvm.aarch64.sve.rbit.nxv16i8(<vscale x 16 x i8> [[TMP0]], <vscale x 16 x i1> [[PG:%.*]], <vscale x 16 x i8> [[TMP1]])
// CHECK-NEXT:    store <vscale x 16 x i8> [[TMP2]], ptr [[RETVAL]], align 16
// CHECK-NEXT:    [[TMP3:%.*]] = load <vscale x 16 x b8>, ptr [[RETVAL]], align 16
...
// CPP-CHECK-NEXT:  entry:
// CPP-CHECK-NEXT:    [[RETVAL:%.*]] = alloca <vscale x 16 x b8>, align 16
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <vscale x 16 x b8> undef to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <vscale x 16 x b8> [[OP:%.*]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    [[TMP2:%.*]] = tail call <vscale x 16 x i8> @llvm.aarch64.sve.rbit.nxv16i8(<vscale x 16 x i8> [[TMP0]], <vscale x 16 x i1> [[PG:%.*]], <vscale x 16 x i8> [[TMP1]])
// CPP-CHECK-NEXT:    store <vscale x 16 x i8> [[TMP2]], ptr [[RETVAL]], align 16
// CPP-CHECK-NEXT:    [[TMP3:%.*]] = load <vscale x 16 x b8>, ptr [[RETVAL]], align 16
