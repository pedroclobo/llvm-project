...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    tail call void @llvm.masked.store.nxv16b8.p0(<vscale x 16 x b8> [[DATA:%.*]], ptr align 1 [[BASE:%.*]], <vscale x 16 x i1> [[PG:%.*]])
// CHECK-NEXT:    ret void
//
// CPP-CHECK-LABEL: @_Z13test_svst1_s8u10__SVBool_tPau10__SVInt8_t(
// CPP-CHECK-NEXT:  entry:
// CPP-CHECK-NEXT:    tail call void @llvm.masked.store.nxv16b8.p0(<vscale x 16 x b8> [[DATA:%.*]], ptr align 1 [[BASE:%.*]], <vscale x 16 x i1> [[PG:%.*]])
...
// CHECK-NEXT:    tail call void @llvm.masked.store.nxv16b8.p0(<vscale x 16 x b8> [[DATA:%.*]], ptr align 1 [[TMP2]], <vscale x 16 x i1> [[PG:%.*]])
// CHECK-NEXT:    ret void
//
...
// CPP-CHECK-NEXT:    tail call void @llvm.masked.store.nxv16b8.p0(<vscale x 16 x b8> [[DATA:%.*]], ptr align 1 [[TMP2]], <vscale x 16 x i1> [[PG:%.*]])
// CPP-CHECK-NEXT:    ret void
//
