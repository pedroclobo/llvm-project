...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = insertvalue { <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8> } poison, <vscale x 16 x b8> [[DATA_COERCE0:%.*]], 0
// CHECK-NEXT:    [[TMP1:%.*]] = insertvalue { <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8> } [[TMP0]], <vscale x 16 x b8> [[DATA_COERCE1:%.*]], 1
// CHECK-NEXT:    [[TMP2:%.*]] = insertvalue { <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8> } [[TMP1]], <vscale x 16 x b8> [[DATA_COERCE2:%.*]], 2
// CHECK-NEXT:    [[TMP3:%.*]] = insertvalue { <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8> } [[TMP2]], <vscale x 16 x b8> [[DATA_COERCE3:%.*]], 3
// CHECK-NEXT:    [[TMP4:%.*]] = extractvalue { <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8> } [[TMP3]], 0
// CHECK-NEXT:    [[TMP5:%.*]] = extractvalue { <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8> } [[TMP3]], 1
// CHECK-NEXT:    [[TMP6:%.*]] = extractvalue { <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8> } [[TMP3]], 2
// CHECK-NEXT:    [[TMP7:%.*]] = extractvalue { <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8> } [[TMP3]], 3
// CHECK-NEXT:    [[TMP8:%.*]] = bytecast exact <vscale x 16 x b8> [[TMP4]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP9:%.*]] = bytecast exact <vscale x 16 x b8> [[TMP5]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP10:%.*]] = bytecast exact <vscale x 16 x b8> [[TMP6]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP11:%.*]] = bytecast exact <vscale x 16 x b8> [[TMP7]] to <vscale x 16 x i8>
// CHECK-NEXT:    tail call void @llvm.aarch64.sve.st4.nxv16i8(<vscale x 16 x i8> [[TMP8]], <vscale x 16 x i8> [[TMP9]], <vscale x 16 x i8> [[TMP10]], <vscale x 16 x i8> [[TMP11]], <vscale x 16 x i1> [[PG:%.*]], ptr [[BASE:%.*]])
// CHECK-NEXT:    ret void
//
// CPP-CHECK-LABEL: @_Z13test_svst4_s8u10__SVBool_tPa10svint8x4_t(
// CPP-CHECK-NEXT:  entry:
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = insertvalue { <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8> } poison, <vscale x 16 x b8> [[DATA_COERCE0:%.*]], 0
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = insertvalue { <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8> } [[TMP0]], <vscale x 16 x b8> [[DATA_COERCE1:%.*]], 1
// CPP-CHECK-NEXT:    [[TMP2:%.*]] = insertvalue { <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8> } [[TMP1]], <vscale x 16 x b8> [[DATA_COERCE2:%.*]], 2
// CPP-CHECK-NEXT:    [[TMP3:%.*]] = insertvalue { <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8> } [[TMP2]], <vscale x 16 x b8> [[DATA_COERCE3:%.*]], 3
// CPP-CHECK-NEXT:    [[TMP4:%.*]] = extractvalue { <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8> } [[TMP3]], 0
// CPP-CHECK-NEXT:    [[TMP5:%.*]] = extractvalue { <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8> } [[TMP3]], 1
// CPP-CHECK-NEXT:    [[TMP6:%.*]] = extractvalue { <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8> } [[TMP3]], 2
// CPP-CHECK-NEXT:    [[TMP7:%.*]] = extractvalue { <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8> } [[TMP3]], 3
// CPP-CHECK-NEXT:    [[TMP8:%.*]] = bytecast exact <vscale x 16 x b8> [[TMP4]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    [[TMP9:%.*]] = bytecast exact <vscale x 16 x b8> [[TMP5]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    [[TMP10:%.*]] = bytecast exact <vscale x 16 x b8> [[TMP6]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    [[TMP11:%.*]] = bytecast exact <vscale x 16 x b8> [[TMP7]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    tail call void @llvm.aarch64.sve.st4.nxv16i8(<vscale x 16 x i8> [[TMP8]], <vscale x 16 x i8> [[TMP9]], <vscale x 16 x i8> [[TMP10]], <vscale x 16 x i8> [[TMP11]], <vscale x 16 x i1> [[PG:%.*]], ptr [[BASE:%.*]])
...
// CHECK-NEXT:    [[TMP9:%.*]] = bytecast exact <vscale x 16 x b8> [[TMP4]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP10:%.*]] = bytecast exact <vscale x 16 x b8> [[TMP5]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP11:%.*]] = bytecast exact <vscale x 16 x b8> [[TMP6]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP12:%.*]] = bytecast exact <vscale x 16 x b8> [[TMP7]] to <vscale x 16 x i8>
// CHECK-NEXT:    tail call void @llvm.aarch64.sve.st4.nxv16i8(<vscale x 16 x i8> [[TMP9]], <vscale x 16 x i8> [[TMP10]], <vscale x 16 x i8> [[TMP11]], <vscale x 16 x i8> [[TMP12]], <vscale x 16 x i1> [[PG:%.*]], ptr [[TMP8]])
// CHECK-NEXT:    ret void
//
...
// CPP-CHECK-NEXT:    [[TMP9:%.*]] = bytecast exact <vscale x 16 x b8> [[TMP4]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    [[TMP10:%.*]] = bytecast exact <vscale x 16 x b8> [[TMP5]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    [[TMP11:%.*]] = bytecast exact <vscale x 16 x b8> [[TMP6]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    [[TMP12:%.*]] = bytecast exact <vscale x 16 x b8> [[TMP7]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    tail call void @llvm.aarch64.sve.st4.nxv16i8(<vscale x 16 x i8> [[TMP9]], <vscale x 16 x i8> [[TMP10]], <vscale x 16 x i8> [[TMP11]], <vscale x 16 x i8> [[TMP12]], <vscale x 16 x i1> [[PG:%.*]], ptr [[TMP8]])
// CPP-CHECK-NEXT:    ret void
//
