...
// CHECK-NEXT:    [[ADD:%.*]] = add <vscale x 16 x i8> [[TMP0]], [[TMP1]]
...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <vscale x 16 x b8> [[B:%.*]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[ADD:%.*]] = add <vscale x 16 x i8> [[TMP1]], [[TMP2]]
...
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <vscale x 16 x b8> [[A:%.*]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <vscale x 16 x b8> [[SPLAT_SPLAT]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[ADD:%.*]] = add <vscale x 16 x i8> [[TMP0]], [[TMP1]]
// CHECK-NEXT:    store <vscale x 16 x i8> [[ADD]], ptr [[RETVAL]], align 16
// CHECK-NEXT:    [[TMP2:%.*]] = load <vscale x 16 x b8>, ptr [[RETVAL]], align 16
// CHECK-NEXT:    ret <vscale x 16 x b8> [[TMP2]]
