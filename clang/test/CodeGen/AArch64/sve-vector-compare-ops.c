...
// CHECK-LABEL: @eq_i8(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[CMP:%.*]] = icmp eq <vscale x 16 x b8> [[A:%.*]], [[B:%.*]]
...
// CHECK-LABEL: @neq_i8(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[CMP:%.*]] = icmp ne <vscale x 16 x b8> [[A:%.*]], [[B:%.*]]
// CHECK-NEXT:    [[CONV:%.*]] = zext <vscale x 16 x i1> [[CMP]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[CONV1:%.*]] = bitcast <vscale x 16 x i8> [[CONV]] to <vscale x 16 x b8>
// CHECK-NEXT:    ret <vscale x 16 x b8> [[CONV1]]
//
...
// CHECK-LABEL: @leq_i8(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[CMP:%.*]] = icmp ule <vscale x 16 x b8> [[A:%.*]], [[B:%.*]]
// CHECK-NEXT:    [[CONV:%.*]] = zext <vscale x 16 x i1> [[CMP]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[CONV1:%.*]] = bitcast <vscale x 16 x i8> [[CONV]] to <vscale x 16 x b8>
// CHECK-NEXT:    ret <vscale x 16 x b8> [[CONV1]]
//
...
// CHECK-LABEL: @gt_i8(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[CMP:%.*]] = icmp ugt <vscale x 16 x b8> [[A:%.*]], [[B:%.*]]
// CHECK-NEXT:    [[CONV:%.*]] = zext <vscale x 16 x i1> [[CMP]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[CONV1:%.*]] = bitcast <vscale x 16 x i8> [[CONV]] to <vscale x 16 x b8>
// CHECK-NEXT:    ret <vscale x 16 x b8> [[CONV1]]
//
...
// CHECK-LABEL: @geq_i8(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[CMP:%.*]] = icmp uge <vscale x 16 x b8> [[A:%.*]], [[B:%.*]]
// CHECK-NEXT:    [[CONV:%.*]] = zext <vscale x 16 x i1> [[CMP]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[CONV1:%.*]] = bitcast <vscale x 16 x i8> [[CONV]] to <vscale x 16 x b8>
// CHECK-NEXT:    ret <vscale x 16 x b8> [[CONV1]]
//
