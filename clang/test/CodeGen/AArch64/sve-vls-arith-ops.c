...
// CHECK-NEXT:    [[EXT:%.*]] = bytecast <64 x b8> [[TMP1]] to <64 x i8>
// CHECK-NEXT:    [[EXT3:%.*]] = bytecast <64 x b8> [[TMP3]] to <64 x i8>
...
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <vscale x 16 x i8> [[B_COERCE:%.*]] to <vscale x 16 x b8>
// CHECK-NEXT:    [[TMP3:%.*]] = call <64 x b8> @llvm.vector.extract.v64b8.nxv16b8(<vscale x 16 x b8> [[TMP2]], i64 0)
// CHECK-NEXT:    [[EXT:%.*]] = bytecast <64 x b8> [[TMP3]] to <64 x i8>
// CHECK-NEXT:    [[CONV:%.*]] = bytecast <64 x b8> [[TMP1]] to <64 x i8>
