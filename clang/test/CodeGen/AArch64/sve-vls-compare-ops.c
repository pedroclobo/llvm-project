...
// CHECK-NEXT:    [[CMP:%.*]] = icmp eq <8 x b8> [[A]], [[B]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <8 x i1> [[CMP]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[SEXT]] to <8 x b8>
...
// CHECK-NEXT:    [[CMP:%.*]] = icmp eq <64 x b8> [[A1]], [[B2]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <64 x i1> [[CMP]] to <64 x i8>
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <64 x i8> [[SEXT]] to <64 x b8>
// CHECK-NEXT:    store <64 x b8> [[TMP0]], ptr [[RETVAL_COERCE]], align 16
// CHECK-NEXT:    [[TMP1:%.*]] = load <vscale x 16 x i8>, ptr [[RETVAL_COERCE]], align 16
...
// CHECK-NEXT:    [[B_COERCE:%.*]] = bitcast <vscale x 16 x i1> [[TMP1:%.*]] to <vscale x 2 x b8>
// CHECK-NEXT:    [[B:%.*]] = call <8 x b8> @llvm.vector.extract.v8b8.nxv2b8(<vscale x 2 x b8> [[B_COERCE]], i64 0)
// CHECK-NEXT:    [[CMP:%.*]] = icmp ne <8 x b8> [[A]], [[B]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <8 x i1> [[CMP]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[SEXT]] to <8 x b8>
// CHECK-NEXT:    [[CAST_SCALABLE:%.*]] = call <vscale x 2 x b8> @llvm.vector.insert.nxv2b8.v8b8(<vscale x 2 x b8> poison, <8 x b8> [[TMP2]], i64 0)
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <vscale x 2 x b8> [[CAST_SCALABLE]] to <vscale x 16 x i1>
...
// CHECK-NEXT:    store <vscale x 16 x i8> [[B_COERCE:%.*]], ptr [[B]], align 16
// CHECK-NEXT:    [[B2:%.*]] = load <64 x b8>, ptr [[B]], align 16
// CHECK-NEXT:    [[CMP:%.*]] = icmp ne <64 x b8> [[A1]], [[B2]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <64 x i1> [[CMP]] to <64 x i8>
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <64 x i8> [[SEXT]] to <64 x b8>
// CHECK-NEXT:    store <64 x b8> [[TMP0]], ptr [[RETVAL_COERCE]], align 16
// CHECK-NEXT:    [[TMP1:%.*]] = load <vscale x 16 x i8>, ptr [[RETVAL_COERCE]], align 16
...
// CHECK-NEXT:    [[B_COERCE:%.*]] = bitcast <vscale x 16 x i1> [[TMP1:%.*]] to <vscale x 2 x b8>
// CHECK-NEXT:    [[B:%.*]] = call <8 x b8> @llvm.vector.extract.v8b8.nxv2b8(<vscale x 2 x b8> [[B_COERCE]], i64 0)
// CHECK-NEXT:    [[CMP:%.*]] = icmp ult <8 x b8> [[A]], [[B]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <8 x i1> [[CMP]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[SEXT]] to <8 x b8>
// CHECK-NEXT:    [[CAST_SCALABLE:%.*]] = call <vscale x 2 x b8> @llvm.vector.insert.nxv2b8.v8b8(<vscale x 2 x b8> poison, <8 x b8> [[TMP2]], i64 0)
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <vscale x 2 x b8> [[CAST_SCALABLE]] to <vscale x 16 x i1>
...
// CHECK-NEXT:    store <vscale x 16 x i8> [[B_COERCE:%.*]], ptr [[B]], align 16
// CHECK-NEXT:    [[B2:%.*]] = load <64 x b8>, ptr [[B]], align 16
// CHECK-NEXT:    [[CMP:%.*]] = icmp slt <64 x b8> [[A1]], [[B2]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <64 x i1> [[CMP]] to <64 x i8>
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <64 x i8> [[SEXT]] to <64 x b8>
// CHECK-NEXT:    store <64 x b8> [[TMP0]], ptr [[RETVAL_COERCE]], align 16
// CHECK-NEXT:    [[TMP1:%.*]] = load <vscale x 16 x i8>, ptr [[RETVAL_COERCE]], align 16
...
// CHECK-NEXT:    store <vscale x 16 x i8> [[B_COERCE:%.*]], ptr [[B]], align 16
// CHECK-NEXT:    [[B2:%.*]] = load <64 x b8>, ptr [[B]], align 16
// CHECK-NEXT:    [[CMP:%.*]] = icmp ult <64 x b8> [[A1]], [[B2]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <64 x i1> [[CMP]] to <64 x i8>
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <64 x i8> [[SEXT]] to <64 x b8>
// CHECK-NEXT:    store <64 x b8> [[TMP0]], ptr [[RETVAL_COERCE]], align 16
// CHECK-NEXT:    [[TMP1:%.*]] = load <vscale x 16 x i8>, ptr [[RETVAL_COERCE]], align 16
...
// CHECK-NEXT:    [[B_COERCE:%.*]] = bitcast <vscale x 16 x i1> [[TMP1:%.*]] to <vscale x 2 x b8>
// CHECK-NEXT:    [[B:%.*]] = call <8 x b8> @llvm.vector.extract.v8b8.nxv2b8(<vscale x 2 x b8> [[B_COERCE]], i64 0)
// CHECK-NEXT:    [[CMP:%.*]] = icmp ule <8 x b8> [[A]], [[B]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <8 x i1> [[CMP]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[SEXT]] to <8 x b8>
// CHECK-NEXT:    [[CAST_SCALABLE:%.*]] = call <vscale x 2 x b8> @llvm.vector.insert.nxv2b8.v8b8(<vscale x 2 x b8> poison, <8 x b8> [[TMP2]], i64 0)
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <vscale x 2 x b8> [[CAST_SCALABLE]] to <vscale x 16 x i1>
...
// CHECK-NEXT:    store <vscale x 16 x i8> [[B_COERCE:%.*]], ptr [[B]], align 16
// CHECK-NEXT:    [[B2:%.*]] = load <64 x b8>, ptr [[B]], align 16
// CHECK-NEXT:    [[CMP:%.*]] = icmp sle <64 x b8> [[A1]], [[B2]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <64 x i1> [[CMP]] to <64 x i8>
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <64 x i8> [[SEXT]] to <64 x b8>
// CHECK-NEXT:    store <64 x b8> [[TMP0]], ptr [[RETVAL_COERCE]], align 16
// CHECK-NEXT:    [[TMP1:%.*]] = load <vscale x 16 x i8>, ptr [[RETVAL_COERCE]], align 16
...
// CHECK-NEXT:    store <vscale x 16 x i8> [[B_COERCE:%.*]], ptr [[B]], align 16
// CHECK-NEXT:    [[B2:%.*]] = load <64 x b8>, ptr [[B]], align 16
// CHECK-NEXT:    [[CMP:%.*]] = icmp ule <64 x b8> [[A1]], [[B2]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <64 x i1> [[CMP]] to <64 x i8>
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <64 x i8> [[SEXT]] to <64 x b8>
// CHECK-NEXT:    store <64 x b8> [[TMP0]], ptr [[RETVAL_COERCE]], align 16
// CHECK-NEXT:    [[TMP1:%.*]] = load <vscale x 16 x i8>, ptr [[RETVAL_COERCE]], align 16
...
// CHECK-NEXT:    [[B_COERCE:%.*]] = bitcast <vscale x 16 x i1> [[TMP1:%.*]] to <vscale x 2 x b8>
// CHECK-NEXT:    [[B:%.*]] = call <8 x b8> @llvm.vector.extract.v8b8.nxv2b8(<vscale x 2 x b8> [[B_COERCE]], i64 0)
// CHECK-NEXT:    [[CMP:%.*]] = icmp ugt <8 x b8> [[A]], [[B]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <8 x i1> [[CMP]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[SEXT]] to <8 x b8>
// CHECK-NEXT:    [[CAST_SCALABLE:%.*]] = call <vscale x 2 x b8> @llvm.vector.insert.nxv2b8.v8b8(<vscale x 2 x b8> poison, <8 x b8> [[TMP2]], i64 0)
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <vscale x 2 x b8> [[CAST_SCALABLE]] to <vscale x 16 x i1>
...
// CHECK-NEXT:    store <vscale x 16 x i8> [[B_COERCE:%.*]], ptr [[B]], align 16
// CHECK-NEXT:    [[B2:%.*]] = load <64 x b8>, ptr [[B]], align 16
// CHECK-NEXT:    [[CMP:%.*]] = icmp sgt <64 x b8> [[A1]], [[B2]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <64 x i1> [[CMP]] to <64 x i8>
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <64 x i8> [[SEXT]] to <64 x b8>
// CHECK-NEXT:    store <64 x b8> [[TMP0]], ptr [[RETVAL_COERCE]], align 16
// CHECK-NEXT:    [[TMP1:%.*]] = load <vscale x 16 x i8>, ptr [[RETVAL_COERCE]], align 16
...
// CHECK-NEXT:    store <vscale x 16 x i8> [[B_COERCE:%.*]], ptr [[B]], align 16
// CHECK-NEXT:    [[B2:%.*]] = load <64 x b8>, ptr [[B]], align 16
// CHECK-NEXT:    [[CMP:%.*]] = icmp ugt <64 x b8> [[A1]], [[B2]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <64 x i1> [[CMP]] to <64 x i8>
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <64 x i8> [[SEXT]] to <64 x b8>
// CHECK-NEXT:    store <64 x b8> [[TMP0]], ptr [[RETVAL_COERCE]], align 16
// CHECK-NEXT:    [[TMP1:%.*]] = load <vscale x 16 x i8>, ptr [[RETVAL_COERCE]], align 16
...
// CHECK-NEXT:    [[B_COERCE:%.*]] = bitcast <vscale x 16 x i1> [[TMP1:%.*]] to <vscale x 2 x b8>
// CHECK-NEXT:    [[B:%.*]] = call <8 x b8> @llvm.vector.extract.v8b8.nxv2b8(<vscale x 2 x b8> [[B_COERCE]], i64 0)
// CHECK-NEXT:    [[CMP:%.*]] = icmp uge <8 x b8> [[A]], [[B]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <8 x i1> [[CMP]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[SEXT]] to <8 x b8>
// CHECK-NEXT:    [[CAST_SCALABLE:%.*]] = call <vscale x 2 x b8> @llvm.vector.insert.nxv2b8.v8b8(<vscale x 2 x b8> poison, <8 x b8> [[TMP2]], i64 0)
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <vscale x 2 x b8> [[CAST_SCALABLE]] to <vscale x 16 x i1>
...
// CHECK-NEXT:    store <vscale x 16 x i8> [[B_COERCE:%.*]], ptr [[B]], align 16
// CHECK-NEXT:    [[B2:%.*]] = load <64 x b8>, ptr [[B]], align 16
// CHECK-NEXT:    [[CMP:%.*]] = icmp sge <64 x b8> [[A1]], [[B2]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <64 x i1> [[CMP]] to <64 x i8>
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <64 x i8> [[SEXT]] to <64 x b8>
// CHECK-NEXT:    store <64 x b8> [[TMP0]], ptr [[RETVAL_COERCE]], align 16
// CHECK-NEXT:    [[TMP1:%.*]] = load <vscale x 16 x i8>, ptr [[RETVAL_COERCE]], align 16
...
// CHECK-NEXT:    store <vscale x 16 x i8> [[B_COERCE:%.*]], ptr [[B]], align 16
// CHECK-NEXT:    [[B2:%.*]] = load <64 x b8>, ptr [[B]], align 16
// CHECK-NEXT:    [[CMP:%.*]] = icmp uge <64 x b8> [[A1]], [[B2]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <64 x i1> [[CMP]] to <64 x i8>
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <64 x i8> [[SEXT]] to <64 x b8>
// CHECK-NEXT:    store <64 x b8> [[TMP0]], ptr [[RETVAL_COERCE]], align 16
// CHECK-NEXT:    [[TMP1:%.*]] = load <vscale x 16 x i8>, ptr [[RETVAL_COERCE]], align 16
