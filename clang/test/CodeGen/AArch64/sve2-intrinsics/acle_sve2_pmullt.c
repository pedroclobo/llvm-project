...
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <vscale x 16 x i8> @llvm.aarch64.sve.pmullt.pair.nxv16i8(<vscale x 16 x i8> [[TMP0]], <vscale x 16 x i8> [[TMP1]])
...
// CPP-CHECK-NEXT:    [[TMP2:%.*]] = tail call <vscale x 16 x i8> @llvm.aarch64.sve.pmullt.pair.nxv16i8(<vscale x 16 x i8> [[TMP0]], <vscale x 16 x i8> [[TMP1]])
...
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <vscale x 16 x i8> @llvm.aarch64.sve.pmullt.pair.nxv16i8(<vscale x 16 x i8> [[TMP1]], <vscale x 16 x i8> [[DOTSPLAT]])
// CHECK-NEXT:    [[DOTCAST:%.*]] = bitcast <vscale x 16 x i8> [[TMP2]] to <vscale x 16 x b8>
// CHECK-NEXT:    ret <vscale x 16 x b8> [[DOTCAST]]
//
...
// CPP-CHECK-NEXT:    [[TMP2:%.*]] = tail call <vscale x 16 x i8> @llvm.aarch64.sve.pmullt.pair.nxv16i8(<vscale x 16 x i8> [[TMP1]], <vscale x 16 x i8> [[DOTSPLAT]])
// CPP-CHECK-NEXT:    [[DOTCAST:%.*]] = bitcast <vscale x 16 x i8> [[TMP2]] to <vscale x 16 x b8>
// CPP-CHECK-NEXT:    ret <vscale x 16 x b8> [[DOTCAST]]
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = tail call <vscale x 16 x b8> @llvm.aarch64.sve.pmullt.pair.nxv16b8(<vscale x 16 x b8> [[OP1:%.*]], <vscale x 16 x b8> [[OP2:%.*]])
...
// CPP-CHECK-NEXT:  entry:
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = tail call <vscale x 16 x b8> @llvm.aarch64.sve.pmullt.pair.nxv16b8(<vscale x 16 x b8> [[OP1:%.*]], <vscale x 16 x b8> [[OP2:%.*]])
...
// CHECK-NEXT:    [[TMP0:%.*]] = tail call <vscale x 16 x b8> @llvm.aarch64.sve.pmullt.pair.nxv16b8(<vscale x 16 x b8> [[OP1:%.*]], <vscale x 16 x b8> [[DOTSPLAT]])
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <vscale x 16 x b8> [[TMP0]] to <vscale x 8 x i16>
// CHECK-NEXT:    ret <vscale x 8 x i16> [[TMP1]]
//
...
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = tail call <vscale x 16 x b8> @llvm.aarch64.sve.pmullt.pair.nxv16b8(<vscale x 16 x b8> [[OP1:%.*]], <vscale x 16 x b8> [[DOTSPLAT]])
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <vscale x 16 x b8> [[TMP0]] to <vscale x 8 x i16>
// CPP-CHECK-NEXT:    ret <vscale x 8 x i16> [[TMP1]]
//
