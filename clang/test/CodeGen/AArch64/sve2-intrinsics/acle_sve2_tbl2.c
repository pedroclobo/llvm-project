...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast <vscale x 16 x b8> [[DATA_COERCE0:%.*]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast <vscale x 16 x b8> [[DATA_COERCE1:%.*]] to <vscale x 16 x i8>
...
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = bytecast <vscale x 16 x b8> [[DATA_COERCE0:%.*]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = bytecast <vscale x 16 x b8> [[DATA_COERCE1:%.*]] to <vscale x 16 x i8>
