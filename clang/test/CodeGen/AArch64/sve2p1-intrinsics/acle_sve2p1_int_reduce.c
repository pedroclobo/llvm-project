...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = tail call <16 x b8> @llvm.aarch64.sve.smaxqv.v16b8.nxv16b8(<vscale x 16 x i1> [[PG:%.*]], <vscale x 16 x b8> [[OP1:%.*]])
// CHECK-NEXT:    ret <16 x b8> [[TMP0]]
//
// CPP-CHECK-LABEL: @_Z15test_svmaxqv_s8u10__SVBool_tu10__SVInt8_t(
// CPP-CHECK-NEXT:  entry:
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = tail call <16 x b8> @llvm.aarch64.sve.smaxqv.v16b8.nxv16b8(<vscale x 16 x i1> [[PG:%.*]], <vscale x 16 x b8> [[OP1:%.*]])
// CPP-CHECK-NEXT:    ret <16 x b8> [[TMP0]]
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = tail call <16 x b8> @llvm.aarch64.sve.sminqv.v16b8.nxv16b8(<vscale x 16 x i1> [[PG:%.*]], <vscale x 16 x b8> [[OP1:%.*]])
// CHECK-NEXT:    ret <16 x b8> [[TMP0]]
//
// CPP-CHECK-LABEL: @_Z15test_svminqv_s8u10__SVBool_tu10__SVInt8_t(
// CPP-CHECK-NEXT:  entry:
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = tail call <16 x b8> @llvm.aarch64.sve.sminqv.v16b8.nxv16b8(<vscale x 16 x i1> [[PG:%.*]], <vscale x 16 x b8> [[OP1:%.*]])
// CPP-CHECK-NEXT:    ret <16 x b8> [[TMP0]]
//
