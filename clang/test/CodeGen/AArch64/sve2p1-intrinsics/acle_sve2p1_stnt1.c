...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE0:%.*]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE1:%.*]] to <vscale x 16 x i8>
...
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE0:%.*]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE1:%.*]] to <vscale x 16 x i8>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE0:%.*]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE1:%.*]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE2:%.*]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE3:%.*]] to <vscale x 16 x i8>
...
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE0:%.*]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE1:%.*]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    [[TMP2:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE2:%.*]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    [[TMP3:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE3:%.*]] to <vscale x 16 x i8>
...
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE0:%.*]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE1:%.*]] to <vscale x 16 x i8>
...
// CPP-CHECK-NEXT:    [[TMP3:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE0:%.*]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    [[TMP4:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE1:%.*]] to <vscale x 16 x i8>
...
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE0:%.*]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE1:%.*]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP5:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE2:%.*]] to <vscale x 16 x i8>
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE3:%.*]] to <vscale x 16 x i8>
...
// CPP-CHECK-NEXT:    [[TMP3:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE0:%.*]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    [[TMP4:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE1:%.*]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    [[TMP5:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE2:%.*]] to <vscale x 16 x i8>
// CPP-CHECK-NEXT:    [[TMP6:%.*]] = bytecast <vscale x 16 x b8> [[V_COERCE3:%.*]] to <vscale x 16 x i8>
