...
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <8 x b8> [[VQRDMLAH_S164_I]] to <4 x b16>
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <4 x b16> [[TMP3]] to <4 x i16>
...
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <8 x b8> [[VQRDMLAH_S324_I]] to <2 x b32>
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <2 x b32> [[TMP3]] to <2 x i32>
...
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <16 x b8> [[VQRDMLAHQ_S164_I]] to <8 x b16>
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b16> [[TMP3]] to <8 x i16>
...
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <16 x b8> [[VQRDMLAHQ_S324_I]] to <4 x b32>
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <4 x b32> [[TMP3]] to <4 x i32>
...
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <8 x b8> [[VQRDMLSH_S164_I]] to <4 x b16>
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <4 x b16> [[TMP3]] to <4 x i16>
// CHECK-NEXT:    ret <4 x i16> [[TMP4]]
//
...
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <8 x b8> [[VQRDMLSH_S324_I]] to <2 x b32>
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <2 x b32> [[TMP3]] to <2 x i32>
// CHECK-NEXT:    ret <2 x i32> [[TMP4]]
//
...
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <16 x b8> [[VQRDMLSHQ_S164_I]] to <8 x b16>
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b16> [[TMP3]] to <8 x i16>
// CHECK-NEXT:    ret <8 x i16> [[TMP4]]
//
...
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <16 x b8> [[VQRDMLSHQ_S324_I]] to <4 x b32>
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <4 x b32> [[TMP3]] to <4 x i32>
// CHECK-NEXT:    ret <4 x i32> [[TMP4]]
//
