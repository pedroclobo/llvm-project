...
// CHECK-NEXT:    [[VQRDMLAH_S16_I:%.*]] = bytecast <8 x b8> [[TMP3]] to <4 x i16>
// CHECK-NEXT:    [[VQRDMLAH_S161_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <4 x i16>
// CHECK-NEXT:    [[VQRDMLAH_S162_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <4 x i16>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <8 x b8> [[VQRDMLAH_S164_I]] to <4 x i16>
...
// CHECK-NEXT:    [[VQRDMLAH_S32_I:%.*]] = bytecast <8 x b8> [[TMP3]] to <2 x i32>
// CHECK-NEXT:    [[VQRDMLAH_S321_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <2 x i32>
// CHECK-NEXT:    [[VQRDMLAH_S322_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <2 x i32>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <8 x b8> [[VQRDMLAH_S324_I]] to <2 x i32>
...
// CHECK-NEXT:    [[VQRDMLAHQ_S16_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <8 x i16>
// CHECK-NEXT:    [[VQRDMLAHQ_S161_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <8 x i16>
// CHECK-NEXT:    [[VQRDMLAHQ_S162_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <8 x i16>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VQRDMLAHQ_S164_I]] to <8 x i16>
...
// CHECK-NEXT:    [[VQRDMLAHQ_S32_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <4 x i32>
// CHECK-NEXT:    [[VQRDMLAHQ_S321_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <4 x i32>
// CHECK-NEXT:    [[VQRDMLAHQ_S322_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <4 x i32>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VQRDMLAHQ_S324_I]] to <4 x i32>
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <4 x i16> [[B:%.*]] to <8 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <4 x i16> [[LANE]] to <8 x b8>
// CHECK-NEXT:    [[VQRDMLSH_S16_I:%.*]] = bytecast <8 x b8> [[TMP3]] to <4 x i16>
// CHECK-NEXT:    [[VQRDMLSH_S161_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <4 x i16>
// CHECK-NEXT:    [[VQRDMLSH_S162_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <4 x i16>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <8 x b8> [[VQRDMLSH_S164_I]] to <4 x i16>
// CHECK-NEXT:    ret <4 x i16> [[TMP6]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <2 x i32> [[B:%.*]] to <8 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <2 x i32> [[LANE]] to <8 x b8>
// CHECK-NEXT:    [[VQRDMLSH_S32_I:%.*]] = bytecast <8 x b8> [[TMP3]] to <2 x i32>
// CHECK-NEXT:    [[VQRDMLSH_S321_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <2 x i32>
// CHECK-NEXT:    [[VQRDMLSH_S322_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <2 x i32>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <8 x b8> [[VQRDMLSH_S324_I]] to <2 x i32>
// CHECK-NEXT:    ret <2 x i32> [[TMP6]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <8 x i16> [[B:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <8 x i16> [[LANE]] to <16 x b8>
// CHECK-NEXT:    [[VQRDMLSHQ_S16_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <8 x i16>
// CHECK-NEXT:    [[VQRDMLSHQ_S161_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <8 x i16>
// CHECK-NEXT:    [[VQRDMLSHQ_S162_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <8 x i16>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VQRDMLSHQ_S164_I]] to <8 x i16>
// CHECK-NEXT:    ret <8 x i16> [[TMP6]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <4 x i32> [[B:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <4 x i32> [[LANE]] to <16 x b8>
// CHECK-NEXT:    [[VQRDMLSHQ_S32_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <4 x i32>
// CHECK-NEXT:    [[VQRDMLSHQ_S321_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <4 x i32>
// CHECK-NEXT:    [[VQRDMLSHQ_S322_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <4 x i32>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VQRDMLSHQ_S324_I]] to <4 x i32>
// CHECK-NEXT:    ret <4 x i32> [[TMP6]]
//
