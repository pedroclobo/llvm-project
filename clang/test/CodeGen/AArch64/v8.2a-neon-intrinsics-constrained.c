...
// UNCONSTRAINED-NEXT:    [[FMLA:%.*]] = bytecast <8 x b8> [[TMP4]] to <4 x half>
// UNCONSTRAINED-NEXT:    [[FMLA1:%.*]] = bytecast <8 x b8> [[TMP3]] to <4 x half>
...
// CONSTRAINED-NEXT:    [[FMLA:%.*]] = bytecast <8 x b8> [[TMP4]] to <4 x half>
// CONSTRAINED-NEXT:    [[FMLA1:%.*]] = bytecast <8 x b8> [[TMP3]] to <4 x half>
...
// UNCONSTRAINED-NEXT:    [[FMLA:%.*]] = bytecast <16 x b8> [[TMP4]] to <8 x half>
// UNCONSTRAINED-NEXT:    [[FMLA1:%.*]] = bytecast <16 x b8> [[TMP3]] to <8 x half>
...
// CONSTRAINED-NEXT:    [[FMLA:%.*]] = bytecast <16 x b8> [[TMP4]] to <8 x half>
// CONSTRAINED-NEXT:    [[FMLA1:%.*]] = bytecast <16 x b8> [[TMP3]] to <8 x half>
