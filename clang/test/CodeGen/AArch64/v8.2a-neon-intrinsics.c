...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[VPADD_V3_I]] to <8 x i8>
...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[VPADDQ_V3_I]] to <16 x i8>
...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[VRECPS_V3_I]] to <8 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <8 x i8> [[TMP2]] to <4 x half>
// CHECK-NEXT:    ret <4 x half> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[VRECPSQ_V3_I]] to <16 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <16 x i8> [[TMP2]] to <8 x half>
// CHECK-NEXT:    ret <8 x half> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[VRSQRTS_V3_I]] to <8 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <8 x i8> [[TMP2]] to <4 x half>
// CHECK-NEXT:    ret <4 x half> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[VRSQRTSQ_V3_I]] to <16 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <16 x i8> [[TMP2]] to <8 x half>
// CHECK-NEXT:    ret <8 x half> [[TMP3]]
//
...
// CHECK-NEXT:    store <4 x half> [[B]], ptr [[__REINT_831]], align 8
...
// CHECK-NEXT:    [[CONV:%.*]] = fpext half [[A]] to float
// CHECK-NEXT:    store <8 x half> [[B]], ptr [[__REINT_834]], align 16
