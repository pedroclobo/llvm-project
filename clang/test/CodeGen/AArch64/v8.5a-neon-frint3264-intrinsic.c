...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VRND32X_F322_I]] to <8 x i8>
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VRND32XQ_F322_I]] to <16 x i8>
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VRND32Z_F322_I]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[TMP1]] to <2 x float>
// CHECK-NEXT:    ret <2 x float> [[TMP2]]
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VRND32ZQ_F322_I]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[TMP1]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP2]]
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VRND64X_F322_I]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[TMP1]] to <2 x float>
// CHECK-NEXT:    ret <2 x float> [[TMP2]]
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VRND64XQ_F322_I]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[TMP1]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP2]]
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VRND64Z_F322_I]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[TMP1]] to <2 x float>
// CHECK-NEXT:    ret <2 x float> [[TMP2]]
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VRND64ZQ_F322_I]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[TMP1]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP2]]
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VRND32X_F642_I]] to <8 x i8>
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VRND32XQ_F642_I]] to <16 x i8>
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VRND32Z_F642_I]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[TMP1]] to <1 x double>
// CHECK-NEXT:    ret <1 x double> [[TMP2]]
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VRND32ZQ_F642_I]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[TMP1]] to <2 x double>
// CHECK-NEXT:    ret <2 x double> [[TMP2]]
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VRND64X_F642_I]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[TMP1]] to <1 x double>
// CHECK-NEXT:    ret <1 x double> [[TMP2]]
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VRND64XQ_F642_I]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[TMP1]] to <2 x double>
// CHECK-NEXT:    ret <2 x double> [[TMP2]]
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b8> [[VRND64Z_F642_I]] to <8 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x i8> [[TMP1]] to <1 x double>
// CHECK-NEXT:    ret <1 x double> [[TMP2]]
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VRND64ZQ_F642_I]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x i8> [[TMP1]] to <2 x double>
// CHECK-NEXT:    ret <2 x double> [[TMP2]]
//
