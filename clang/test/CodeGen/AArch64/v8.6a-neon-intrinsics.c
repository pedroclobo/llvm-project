...
// CHECK-NEXT:    [[VMMLA3_I:%.*]] = call <4 x i32> @llvm.aarch64.neon.smmla.v4i32.v16i8(<4 x i32> [[R]], <16 x i8> [[VMMLA1_I]], <16 x i8> [[VMMLA2_I]])
...
// CHECK-NEXT:    [[VMMLA1_I:%.*]] = bytecast exact <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VMMLA2_I:%.*]] = bytecast exact <16 x b8> [[B]] to <16 x i8>
// CHECK-NEXT:    [[VMMLA3_I:%.*]] = call <4 x i32> @llvm.aarch64.neon.ummla.v4i32.v16i8(<4 x i32> [[R]], <16 x i8> [[VMMLA1_I]], <16 x i8> [[VMMLA2_I]])
// CHECK-NEXT:    ret <4 x i32> [[VMMLA3_I]]
//
...
// CHECK-NEXT:    [[VUSMMLA3_I:%.*]] = call <4 x i32> @llvm.aarch64.neon.usmmla.v4i32.v16i8(<4 x i32> [[R]], <16 x i8> [[VUSMMLA1_I]], <16 x i8> [[VUSMMLA2_I]])
...
// CHECK-NEXT:    [[VUSDOT3_I:%.*]] = call <2 x i32> @llvm.aarch64.neon.usdot.v2i32.v8i8(<2 x i32> [[R]], <8 x i8> [[VUSDOT1_I]], <8 x i8> [[VUSDOT2_I]])
...
// CHECK-NEXT:    [[VUSDOT3_I:%.*]] = call <4 x i32> @llvm.aarch64.neon.usdot.v4i32.v16i8(<4 x i32> [[R]], <16 x i8> [[VUSDOT1_I]], <16 x i8> [[VUSDOT2_I]])
