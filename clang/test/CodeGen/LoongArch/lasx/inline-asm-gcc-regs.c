...
// CHECK:    tail call void asm sideeffect "", "{$xr0}"(<32 x b8> undef) #[[ATTR1:[0-9]+]], !srcloc [[META2:![0-9]+]]
//
void test_xr0() {
...
// CHECK:    tail call void asm sideeffect "", "{$xr7}"(<32 x b8> undef) #[[ATTR1]], !srcloc [[META3:![0-9]+]]
//
void test_xr7() {
...
// CHECK:    tail call void asm sideeffect "", "{$xr15}"(<32 x b8> undef) #[[ATTR1]], !srcloc [[META4:![0-9]+]]
//
void test_xr15() {
...
// CHECK:    tail call void asm sideeffect "", "{$xr31}"(<32 x b8> undef) #[[ATTR1]], !srcloc [[META5:![0-9]+]]
//
void test_xr31() {
