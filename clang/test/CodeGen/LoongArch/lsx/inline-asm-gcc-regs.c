...
// CHECK:    tail call void asm sideeffect "", "{$vr0}"(<16 x b8> undef) #[[ATTR1:[0-9]+]], !srcloc [[META6:![0-9]+]]
//
void test_vr0() {
...
// CHECK:    tail call void asm sideeffect "", "{$vr7}"(<16 x b8> undef) #[[ATTR1]], !srcloc [[META7:![0-9]+]]
//
void test_vr7() {
...
// CHECK:    tail call void asm sideeffect "", "{$vr15}"(<16 x b8> undef) #[[ATTR1]], !srcloc [[META8:![0-9]+]]
//
void test_vr15() {
...
// CHECK:    tail call void asm sideeffect "", "{$vr31}"(<16 x b8> undef) #[[ATTR1]], !srcloc [[META9:![0-9]+]]
//
void test_vr31() {
