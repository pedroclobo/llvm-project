...
// CHECK-LE-NEXT:  entry:
// CHECK-LE-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[VC4:%.*]] to <16 x i8>
// CHECK-LE-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VC3:%.*]] to <16 x i8>
// CHECK-LE-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[VC2:%.*]] to <16 x i8>
// CHECK-LE-NEXT:    [[TMP3:%.*]] = bytecast exact <16 x b8> [[VC1:%.*]] to <16 x i8>
...
// CHECK-BE-NEXT:  entry:
// CHECK-BE-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[VC1:%.*]] to <16 x i8>
// CHECK-BE-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VC2:%.*]] to <16 x i8>
// CHECK-BE-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[VC3:%.*]] to <16 x i8>
// CHECK-BE-NEXT:    [[TMP3:%.*]] = bytecast exact <16 x b8> [[VC4:%.*]] to <16 x i8>
...
// CHECK-LE-NOOPT-NEXT:    [[TMP8:%.*]] = bytecast exact <16 x b8> [[TMP7]] to <16 x i8>
// CHECK-LE-NOOPT-NEXT:    [[TMP9:%.*]] = bytecast exact <16 x b8> [[TMP6]] to <16 x i8>
// CHECK-LE-NOOPT-NEXT:    [[TMP10:%.*]] = bytecast exact <16 x b8> [[TMP5]] to <16 x i8>
// CHECK-LE-NOOPT-NEXT:    [[TMP11:%.*]] = bytecast exact <16 x b8> [[TMP4]] to <16 x i8>
...
// CHECK-LE-NEXT:  entry:
// CHECK-LE-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[VC2:%.*]] to <16 x i8>
// CHECK-LE-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[VC1:%.*]] to <16 x i8>
...
// CHECK-LE-NOOPT-NEXT:    [[TMP4:%.*]] = load <16 x b8>, ptr [[VC1_ADDR]], align 16
// CHECK-LE-NOOPT-NEXT:    [[TMP5:%.*]] = load <16 x b8>, ptr [[VC2_ADDR]], align 16
// CHECK-LE-NOOPT-NEXT:    [[TMP6:%.*]] = bytecast exact <16 x b8> [[TMP5]] to <16 x i8>
// CHECK-LE-NOOPT-NEXT:    [[TMP7:%.*]] = bytecast exact <16 x b8> [[TMP4]] to <16 x i8>
