...
// BE-PWR9-NEXT:    [[TMP12:%.*]] = bytecast exact <4 x b32> [[TMP11]] to <4 x i32>
// BE-PWR9-NEXT:    [[TMP13:%.*]] = load <16 x b8>, ptr [[__RES_I]], align 16
// BE-PWR9-NEXT:    [[TMP14:%.*]] = bitcast <16 x b8> [[TMP13]] to <4 x b32>
// BE-PWR9-NEXT:    [[TMP15:%.*]] = bytecast exact <4 x b32> [[TMP14]] to <4 x i32>
// BE-PWR9-NEXT:    [[TMP16:%.*]] = load <16 x b8>, ptr [[__MASK_I]], align 16
// BE-PWR9-NEXT:    [[TMP17:%.*]] = bytecast exact <16 x b8> [[TMP16]] to <16 x i8>
...
// LE-PWR9-NEXT:    [[TMP12:%.*]] = bytecast exact <4 x b32> [[TMP11]] to <4 x i32>
// LE-PWR9-NEXT:    [[TMP13:%.*]] = load <16 x b8>, ptr [[__RES_I]], align 16
// LE-PWR9-NEXT:    [[TMP14:%.*]] = bitcast <16 x b8> [[TMP13]] to <4 x b32>
// LE-PWR9-NEXT:    [[TMP15:%.*]] = bytecast exact <4 x b32> [[TMP14]] to <4 x i32>
// LE-PWR9-NEXT:    [[TMP16:%.*]] = load <16 x b8>, ptr [[__MASK_I]], align 16
// LE-PWR9-NEXT:    [[TMP17:%.*]] = bytecast exact <16 x b8> [[TMP16]] to <16 x i8>
