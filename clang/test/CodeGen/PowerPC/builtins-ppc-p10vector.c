...
vector signed short test_vec_sldb_ss(void) {
  ...
  // CHECK-NEXT: bitcast <16 x i8> %{{.+}} to <16 x b8>
  // CHECK-NEXT: bytecast <16 x b8> %{{.+}} to <8 x i16>
  // CHECK-NEXT: ret <8 x i16>
...
vector signed int test_vec_sldb_si(void) {
  ...
  // CHECK-NEXT: bitcast <16 x i8> %{{.+}} to <16 x b8>
  // CHECK-NEXT: bytecast <16 x b8> %{{.+}} to <4 x i32>
  // CHECK-NEXT: ret <4 x i32>
...
vector signed long long test_vec_sldb_sll(void) {
  ...
  // CHECK-NEXT: bitcast <16 x i8> %{{.+}} to <16 x b8>
  // CHECK-NEXT: bytecast <16 x b8> %{{.+}} to <2 x i64>
  // CHECK-NEXT: ret <2 x i64>
...
// CHECK-BE-NEXT:    [[TMP3:%.*]] = bytecast <16 x b8> [[TMP1]] to <4 x i32>
...
// CHECK-BE-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[TMP5]] to <4 x i32>
...
// CHECK-LE-NEXT:    [[TMP3:%.*]] = bytecast <16 x b8> [[TMP1]] to <4 x i32>
...
// CHECK-LE-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[TMP5]] to <4 x i32>
...
// CHECK-BE-NEXT:    [[TMP5:%.*]] = bitcast <4 x i32> [[TMP4]] to <16 x b8>
// CHECK-BE-NEXT:    [[CONV2:%.*]] = bytecast <16 x b8> [[TMP5]] to <16 x i8>
...
// CHECK-LE-NEXT:    [[TMP5:%.*]] = bitcast <4 x i32> [[TMP4]] to <16 x b8>
// CHECK-LE-NEXT:    [[CONV2:%.*]] = bytecast <16 x b8> [[TMP5]] to <16 x i8>
...
// CHECK-BE-NEXT:    [[TMP3:%.*]] = bytecast <16 x b8> [[TMP1]] to <2 x i64>
...
// CHECK-BE-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[TMP5]] to <2 x i64>
...
// CHECK-LE-NEXT:    [[TMP3:%.*]] = bytecast <16 x b8> [[TMP1]] to <2 x i64>
...
// CHECK-LE-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[TMP5]] to <2 x i64>
...
// CHECK-BE-NEXT:    [[TMP5:%.*]] = bitcast <2 x i64> [[TMP4]] to <16 x b8>
// CHECK-BE-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[TMP5]] to <16 x i8>
...
// CHECK-LE-NEXT:    [[TMP5:%.*]] = bitcast <2 x i64> [[TMP4]] to <16 x b8>
// CHECK-LE-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[TMP5]] to <16 x i8>
