...
// CHECK: [[T1:%.+]] = bytecast <16 x b8> {{.+}} to <4 x i32>
// CHECK: [[T2:%.+]] = bytecast <16 x b8> {{.+}} to <4 x i32>
// CHECK: [[T3:%.+]] = call <4 x i32> @llvm.ppc.vsx.xxleqv(<4 x i32> [[T1]], <4 x i32> [[T2]])
// CHECK-LE: [[T1:%.+]] = bytecast <16 x b8> {{.+}} to <4 x i32>
// CHECK-LE: [[T2:%.+]] = bytecast <16 x b8> {{.+}} to <4 x i32>
// CHECK-LE: [[T3:%.+]] = call <4 x i32> @llvm.ppc.vsx.xxleqv(<4 x i32> [[T1]], <4 x i32> [[T2]])
