...
// CHECK-NEXT:    store <512 x i1> [[TMP1]], ptr [[RESP]], align 64, !tbaa [[__VECTOR_QUAD_TBAA6:![0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    store <256 x i1> [[TMP1]], ptr [[RESP]], align 32, !tbaa [[__VECTOR_PAIR_TBAA8:![0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    store <512 x i1> [[TMP4]], ptr [[RESP]], align 64, !tbaa [[__VECTOR_QUAD_TBAA6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast <16 x b8> [[VC]] to <16 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = tail call <256 x i1> @llvm.ppc.vsx.assemble.pair(<16 x i8> [[TMP0]], <16 x i8> [[TMP0]])
// CHECK-NEXT:    store <256 x i1> [[TMP1]], ptr [[RESP]], align 32, !tbaa [[__VECTOR_PAIR_TBAA8]]
// CHECK-NEXT:    ret void
//
