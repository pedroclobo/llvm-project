...
// CHECK:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[A:%.*]] to <1 x i128>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[B:%.*]] to <1 x i128>
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[C:%.*]] to <1 x i128>
// CHECK-NEXT:    [[TMP3:%.*]] = tail call <1 x i128> @llvm.ppc.altivec.vaddeuqm(<1 x i128> [[TMP0]], <1 x i128> [[TMP1]], <1 x i128> [[TMP2]])
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <1 x i128> [[TMP3]] to <16 x b8>
...
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <1 x i128> [[TMP2]] to <16 x b8>
