...
// CHECK-128-NEXT:    [[TMP0:%.*]] = load <1 x b8>, ptr [[Y]], align 1, !tbaa [[CHAR_TBAA10:![0-9]+]]
...
// CHECK-128-NEXT:    [[TMP1:%.*]] = bytecast <vscale x 1 x b8> [[CAST_SCALABLE]] to <vscale x 8 x i1>
...
// CHECK-128-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 1
// CHECK-128-NEXT:    store <1 x b8> [[CAST_FIXED]], ptr [[Y]], align 1, !tbaa [[CHAR_TBAA10]]
...
// CHECK-128-NEXT:  [[ENTRY:.*:]]
// CHECK-128-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 1
// CHECK-128-NEXT:    [[TMP0:%.*]] = load <1 x b8>, ptr [[Y]], align 1, !tbaa [[CHAR_TBAA10]]
// CHECK-128-NEXT:    [[CAST_SCALABLE:%.*]] = tail call <vscale x 1 x b8> @llvm.vector.insert.nxv1b8.v1b8(<vscale x 1 x b8> poison, <1 x b8> [[TMP0]], i64 0)
// CHECK-128-NEXT:    [[TMP1:%.*]] = bytecast <vscale x 1 x b8> [[CAST_SCALABLE]] to <vscale x 8 x i1>
