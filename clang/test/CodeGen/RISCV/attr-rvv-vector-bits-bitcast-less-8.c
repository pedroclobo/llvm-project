...
// CHECK-128-NEXT:    [[TMP0:%.*]] = load <1 x b8>, ptr [[SAVED_VALUE]], align 1, !tbaa [[TBAA6]]
// CHECK-128-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S:%.*]], i64 1
// CHECK-128-NEXT:    store <1 x b8> [[TMP0]], ptr [[Y]], align 1, !tbaa [[TBAA6]]
