...
// CHECK-64-NEXT:  [[ENTRY:.*:]]
// CHECK-64-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 8
// CHECK-64-NEXT:    [[TMP0:%.*]] = load <8 x b8>, ptr [[Y]], align 8, !tbaa [[CHAR_TBAA10]]
...
// CHECK-128-NEXT:  [[ENTRY:.*:]]
// CHECK-128-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 16
// CHECK-128-NEXT:    [[TMP0:%.*]] = load <16 x b8>, ptr [[Y]], align 8, !tbaa [[CHAR_TBAA10]]
// CHECK-128-NEXT:    [[CAST_SCALABLE:%.*]] = tail call <vscale x 8 x b8> @llvm.vector.insert.nxv8b8.v16b8(<vscale x 8 x b8> poison, <16 x b8> [[TMP0]], i64 0)
...
// CHECK-256-NEXT:  [[ENTRY:.*:]]
// CHECK-256-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 32
// CHECK-256-NEXT:    [[TMP0:%.*]] = load <32 x b8>, ptr [[Y]], align 8, !tbaa [[CHAR_TBAA10]]
...
// CHECK-64-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 8
// CHECK-64-NEXT:    store <8 x b8> [[CAST_FIXED]], ptr [[Y]], align 8, !tbaa [[CHAR_TBAA10]]
// CHECK-64-NEXT:    ret void
//
...
// CHECK-128-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 16
// CHECK-128-NEXT:    store <16 x b8> [[CAST_FIXED]], ptr [[Y]], align 8, !tbaa [[CHAR_TBAA10]]
// CHECK-128-NEXT:    ret void
//
...
// CHECK-256-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 32
// CHECK-256-NEXT:    store <32 x b8> [[CAST_FIXED]], ptr [[Y]], align 8, !tbaa [[CHAR_TBAA10]]
// CHECK-256-NEXT:    ret void
//
