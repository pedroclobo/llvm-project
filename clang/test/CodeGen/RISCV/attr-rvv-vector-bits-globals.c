...
// CHECK-256-NEXT:    [[TMP0:%.*]] = load <1 x b8>, ptr [[SAVED_VALUE]], align 1, !tbaa [[TBAA6]]
// CHECK-256-NEXT:    store <1 x b8> [[TMP0]], ptr @global_bool32, align 1, !tbaa [[TBAA6]]
// CHECK-256-NEXT:    ret void
//
...
// CHECK-256-NEXT:    store <1 x b8> [[TMP0]], ptr [[SAVED_VALUE]], align 1, !tbaa [[TBAA6]]
