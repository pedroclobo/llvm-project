...
// CHECK-64-NEXT:    store <8 x b8> [[CAST_FIXED]], ptr @global_bool1, align 8, !tbaa [[TBAA4]]
// CHECK-64-NEXT:    ret void
//
...
// CHECK-256-NEXT:    store <32 x b8> [[CAST_FIXED]], ptr @global_bool1, align 8, !tbaa [[TBAA4]]
// CHECK-256-NEXT:    ret void
//
...
// CHECK-64-NEXT:    store <2 x b8> [[CAST_FIXED]], ptr @global_bool4, align 2, !tbaa [[TBAA4]]
// CHECK-64-NEXT:    ret void
//
...
// CHECK-256-NEXT:    store <8 x b8> [[CAST_FIXED]], ptr @global_bool4, align 8, !tbaa [[TBAA4]]
// CHECK-256-NEXT:    ret void
//
...
// CHECK-256-NEXT:    [[TMP0:%.*]] = load <1 x b8>, ptr [[SAVED_VALUE]], align 1, !tbaa [[TBAA4]]
// CHECK-256-NEXT:    store <1 x b8> [[TMP0]], ptr @global_bool32, align 1, !tbaa [[TBAA4]]
// CHECK-256-NEXT:    ret void
//
...
// CHECK-64-NEXT:  entry:
// CHECK-64-NEXT:    [[TMP0:%.*]] = load <8 x b8>, ptr @global_bool1, align 8, !tbaa [[TBAA4]]
// CHECK-64-NEXT:    [[CAST_SCALABLE:%.*]] = tail call <vscale x 8 x b8> @llvm.vector.insert.nxv8b8.v8b8(<vscale x 8 x b8> undef, <8 x b8> [[TMP0]], i64 0)
// CHECK-64-NEXT:    [[TMP1:%.*]] = bytecast <vscale x 8 x b8> [[CAST_SCALABLE]] to <vscale x 64 x i1>
// CHECK-64-NEXT:    ret <vscale x 64 x i1> [[TMP1]]
//
// CHECK-256-LABEL: @read_global_bool1(
// CHECK-256-NEXT:  entry:
// CHECK-256-NEXT:    [[TMP0:%.*]] = load <32 x b8>, ptr @global_bool1, align 8, !tbaa [[TBAA4]]
// CHECK-256-NEXT:    [[CAST_SCALABLE:%.*]] = tail call <vscale x 8 x b8> @llvm.vector.insert.nxv8b8.v32b8(<vscale x 8 x b8> undef, <32 x b8> [[TMP0]], i64 0)
// CHECK-256-NEXT:    [[TMP1:%.*]] = bytecast <vscale x 8 x b8> [[CAST_SCALABLE]] to <vscale x 64 x i1>
...
// CHECK-64-NEXT:  entry:
// CHECK-64-NEXT:    [[TMP0:%.*]] = load <2 x b8>, ptr @global_bool4, align 2, !tbaa [[TBAA4]]
// CHECK-64-NEXT:    [[CAST_SCALABLE:%.*]] = tail call <vscale x 2 x b8> @llvm.vector.insert.nxv2b8.v2b8(<vscale x 2 x b8> undef, <2 x b8> [[TMP0]], i64 0)
// CHECK-64-NEXT:    [[TMP1:%.*]] = bytecast <vscale x 2 x b8> [[CAST_SCALABLE]] to <vscale x 16 x i1>
// CHECK-64-NEXT:    ret <vscale x 16 x i1> [[TMP1]]
//
// CHECK-256-LABEL: @read_global_bool4(
// CHECK-256-NEXT:  entry:
// CHECK-256-NEXT:    [[TMP0:%.*]] = load <8 x b8>, ptr @global_bool4, align 8, !tbaa [[TBAA4]]
// CHECK-256-NEXT:    [[CAST_SCALABLE:%.*]] = tail call <vscale x 2 x b8> @llvm.vector.insert.nxv2b8.v8b8(<vscale x 2 x b8> undef, <8 x b8> [[TMP0]], i64 0)
// CHECK-256-NEXT:    [[TMP1:%.*]] = bytecast <vscale x 2 x b8> [[CAST_SCALABLE]] to <vscale x 16 x i1>
...
// CHECK-256-NEXT:  entry:
// CHECK-256-NEXT:    [[SAVED_VALUE:%.*]] = alloca <1 x b8>, align 1
// CHECK-256-NEXT:    [[TMP0:%.*]] = load <1 x b8>, ptr @global_bool32, align 1, !tbaa [[TBAA4]]
// CHECK-256-NEXT:    store <1 x b8> [[TMP0]], ptr [[SAVED_VALUE]], align 1, !tbaa [[TBAA4]]
