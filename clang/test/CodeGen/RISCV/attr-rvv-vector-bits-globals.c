...
// CHECK-64-NEXT:    store <8 x b8> [[CAST_FIXED]], ptr @global_bool1, align 8, !tbaa [[CHAR_TBAA10]]
// CHECK-64-NEXT:    ret void
//
...
// CHECK-256-NEXT:    store <32 x b8> [[CAST_FIXED]], ptr @global_bool1, align 8, !tbaa [[CHAR_TBAA10]]
// CHECK-256-NEXT:    ret void
//
...
// CHECK-64-NEXT:    store <2 x b8> [[CAST_FIXED]], ptr @global_bool4, align 2, !tbaa [[CHAR_TBAA10]]
// CHECK-64-NEXT:    ret void
//
...
// CHECK-256-NEXT:    store <8 x b8> [[CAST_FIXED]], ptr @global_bool4, align 8, !tbaa [[CHAR_TBAA10]]
// CHECK-256-NEXT:    ret void
//
...
// CHECK-256-NEXT:    store <1 x b8> [[CAST_FIXED]], ptr @global_bool32, align 1, !tbaa [[CHAR_TBAA10]]
// CHECK-256-NEXT:    ret void
//
...
// CHECK-64-NEXT:  [[ENTRY:.*:]]
// CHECK-64-NEXT:    [[TMP0:%.*]] = load <8 x b8>, ptr @global_bool1, align 8, !tbaa [[CHAR_TBAA10]]
...
// CHECK-256-NEXT:  [[ENTRY:.*:]]
// CHECK-256-NEXT:    [[TMP0:%.*]] = load <32 x b8>, ptr @global_bool1, align 8, !tbaa [[CHAR_TBAA10]]
...
// CHECK-64-SAME: ) local_unnamed_addr #[[ATTR2]] {
// CHECK-64-NEXT:  [[ENTRY:.*:]]
// CHECK-64-NEXT:    [[TMP0:%.*]] = load <2 x b8>, ptr @global_bool4, align 2, !tbaa [[CHAR_TBAA10]]
...
// CHECK-256-SAME: ) local_unnamed_addr #[[ATTR2]] {
// CHECK-256-NEXT:  [[ENTRY:.*:]]
// CHECK-256-NEXT:    [[TMP0:%.*]] = load <8 x b8>, ptr @global_bool4, align 8, !tbaa [[CHAR_TBAA10]]
...
// CHECK-256-SAME: ) local_unnamed_addr #[[ATTR2]] {
// CHECK-256-NEXT:  [[ENTRY:.*:]]
// CHECK-256-NEXT:    [[TMP0:%.*]] = load <1 x b8>, ptr @global_bool32, align 1, !tbaa [[CHAR_TBAA10]]
...
// CHECK-256-NEXT:    [[TMP1:%.*]] = bytecast <vscale x 1 x b8> [[CAST_SCALABLE]] to <vscale x 8 x i1>
