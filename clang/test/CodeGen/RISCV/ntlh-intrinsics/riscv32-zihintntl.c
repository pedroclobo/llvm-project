...
void ntl_all_sizes() {                                       // CHECK-LABEL: ntl_all_sizes
  uc = __riscv_ntl_load(&sc, __RISCV_NTLH_INNERMOST_PRIVATE);   // CHECK: load b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !7
  sc = __riscv_ntl_load(&uc, __RISCV_NTLH_INNERMOST_PRIVATE);   // CHECK: load b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !7
  ...
  v16sc1 = __riscv_ntl_load(&v16sc2, __RISCV_NTLH_INNERMOST_PRIVATE);   // CHECK: load <16 x b8>{{.*}}align 16, !nontemporal !6, !riscv-nontemporal-domain !7
  ...
  *scvc1 = __riscv_ntl_load(scvc2, __RISCV_NTLH_INNERMOST_PRIVATE);   // CHECK: load <vscale x 8 x b8>{{.*}}align 8, !nontemporal !6, !riscv-nontemporal-domain !7

  uc = __riscv_ntl_load(&sc, __RISCV_NTLH_ALL_PRIVATE);   // CHECK: load b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !8
  sc = __riscv_ntl_load(&uc, __RISCV_NTLH_ALL_PRIVATE);   // CHECK: load b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !8
  ...
  v16sc1 = __riscv_ntl_load(&v16sc2, __RISCV_NTLH_ALL_PRIVATE);   // CHECK: load <16 x b8>{{.*}}align 16, !nontemporal !6, !riscv-nontemporal-domain !8
  ...
  *scvc1 = __riscv_ntl_load(scvc2, __RISCV_NTLH_ALL_PRIVATE);   // CHECK: load <vscale x 8 x b8>{{.*}}align 8, !nontemporal !6, !riscv-nontemporal-domain !8

  uc = __riscv_ntl_load(&sc, __RISCV_NTLH_INNERMOST_SHARED);   // CHECK: load b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !9
  sc = __riscv_ntl_load(&uc, __RISCV_NTLH_INNERMOST_SHARED);   // CHECK: load b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !9
  ...
  v16sc1 = __riscv_ntl_load(&v16sc2, __RISCV_NTLH_INNERMOST_SHARED);   // CHECK: load <16 x b8>{{.*}}align 16, !nontemporal !6, !riscv-nontemporal-domain !9
  ...
  *scvc1 = __riscv_ntl_load(scvc2, __RISCV_NTLH_INNERMOST_SHARED);   // CHECK: load <vscale x 8 x b8>{{.*}}align 8, !nontemporal !6, !riscv-nontemporal-domain !9

  uc = __riscv_ntl_load(&sc, __RISCV_NTLH_ALL);   // CHECK: load b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !10
  sc = __riscv_ntl_load(&uc, __RISCV_NTLH_ALL);   // CHECK: load b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !10
  ...
  v16sc1 = __riscv_ntl_load(&v16sc2, __RISCV_NTLH_ALL);   // CHECK: load <16 x b8>{{.*}}align 16, !nontemporal !6, !riscv-nontemporal-domain !10
  ...
  *scvc1 = __riscv_ntl_load(scvc2, __RISCV_NTLH_ALL);   // CHECK: load <vscale x 8 x b8>{{.*}}align 8, !nontemporal !6, !riscv-nontemporal-domain !10

  uc = __riscv_ntl_load(&sc);   // CHECK: load b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !10
  sc = __riscv_ntl_load(&uc);   // CHECK: load b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !10
  ...
  v16sc1 = __riscv_ntl_load(&v16sc2);   // CHECK: load <16 x b8>{{.*}}align 16, !nontemporal !6, !riscv-nontemporal-domain !10
  ...
  *scvc1 = __riscv_ntl_load(scvc2);   // CHECK: load <vscale x 8 x b8>{{.*}}align 8, !nontemporal !6, !riscv-nontemporal-domain !10

  __riscv_ntl_store(&uc, 1, __RISCV_NTLH_INNERMOST_PRIVATE);    // CHECK: store b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !7
  __riscv_ntl_store(&sc, 1, __RISCV_NTLH_INNERMOST_PRIVATE);    // CHECK: store b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !7
  ...
  __riscv_ntl_store(&v16sc1, v16sc2, __RISCV_NTLH_INNERMOST_PRIVATE);  // CHECK: store <16 x b8>{{.*}}align 16, !nontemporal !6, !riscv-nontemporal-domain !7
  ...
  __riscv_ntl_store(scvc2, *scvc1, __RISCV_NTLH_INNERMOST_PRIVATE);  // CHECK: store <vscale x 8 x b8>{{.*}}align 8, !nontemporal !6, !riscv-nontemporal-domain !7

  __riscv_ntl_store(&uc, 1, __RISCV_NTLH_ALL_PRIVATE);    // CHECK: store b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !8
  __riscv_ntl_store(&sc, 1, __RISCV_NTLH_ALL_PRIVATE);    // CHECK: store b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !8
  ...
  __riscv_ntl_store(&v16sc1, v16sc2, __RISCV_NTLH_ALL_PRIVATE);  // CHECK: store <16 x b8>{{.*}}align 16, !nontemporal !6, !riscv-nontemporal-domain !8
  ...
  __riscv_ntl_store(scvc2, *scvc1, __RISCV_NTLH_ALL_PRIVATE);  // CHECK: store <vscale x 8 x b8>{{.*}}align 8, !nontemporal !6, !riscv-nontemporal-domain !8

  __riscv_ntl_store(&uc, 1, __RISCV_NTLH_INNERMOST_SHARED);    // CHECK: store b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !9
  __riscv_ntl_store(&sc, 1, __RISCV_NTLH_INNERMOST_SHARED);    // CHECK: store b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !9
  ...
  __riscv_ntl_store(&v16sc1, v16sc2, __RISCV_NTLH_INNERMOST_SHARED);  // CHECK: store <16 x b8>{{.*}}align 16, !nontemporal !6, !riscv-nontemporal-domain !9
  ...
  __riscv_ntl_store(scvc2, *scvc1, __RISCV_NTLH_INNERMOST_SHARED);  // CHECK: store <vscale x 8 x b8>{{.*}}align 8, !nontemporal !6, !riscv-nontemporal-domain !9

  __riscv_ntl_store(&uc, 1, __RISCV_NTLH_ALL);    // CHECK: store b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !10
  __riscv_ntl_store(&sc, 1, __RISCV_NTLH_ALL);    // CHECK: store b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !10
  ...
  __riscv_ntl_store(&v16sc1, v16sc2, __RISCV_NTLH_ALL);  // CHECK: store <16 x b8>{{.*}}align 16, !nontemporal !6, !riscv-nontemporal-domain !10
  ...
  __riscv_ntl_store(scvc2, *scvc1, __RISCV_NTLH_ALL);  // CHECK: store <vscale x 8 x b8>{{.*}}align 8, !nontemporal !6, !riscv-nontemporal-domain !10

  __riscv_ntl_store(&uc, 1);    // CHECK: store b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !10
  __riscv_ntl_store(&sc, 1);    // CHECK: store b8{{.*}}align 1, !nontemporal !6, !riscv-nontemporal-domain !10
  ...
  __riscv_ntl_store(&v16sc1, v16sc2);  // CHECK: store <16 x b8>{{.*}}align 16, !nontemporal !6, !riscv-nontemporal-domain !10
  ...
  __riscv_ntl_store(scvc2, *scvc1);  // CHECK: store <vscale x 8 x b8>{{.*}}align 8, !nontemporal !6, !riscv-nontemporal-domain !10
}
// clang-format on
