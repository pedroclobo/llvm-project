...
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact b8 6 to i8
...
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact b8 7 to i8
// CHECK-NEXT:    store i8 [[TMP1]], ptr [[B]], align 1
// CHECK-NEXT:    [[C:%.*]] = getelementptr inbounds nuw [[STRUCT_TINY]], ptr [[DOTCOMPOUNDLITERAL]], i32 0, i32 2
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact b8 8 to i8
// CHECK-NEXT:    store i8 [[TMP2]], ptr [[C]], align 1
// CHECK-NEXT:    [[D:%.*]] = getelementptr inbounds nuw [[STRUCT_TINY]], ptr [[DOTCOMPOUNDLITERAL]], i32 0, i32 3
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact b8 9 to i8
// CHECK-NEXT:    store i8 [[TMP3]], ptr [[D]], align 1
...
// CHECK-NEXT:    [[TMP4:%.*]] = load i32, ptr [[DOTCOMPOUNDLITERAL]], align 1
// CHECK-NEXT:    [[TMP5:%.*]] = load [2 x i32], ptr [[DOTCOMPOUNDLITERAL1]], align 4
// CHECK-NEXT:    [[COERCE_DIVE:%.*]] = getelementptr inbounds nuw [[STRUCT_SMALL_ALIGNED]], ptr [[DOTCOMPOUNDLITERAL4]], i32 0, i32 0
// CHECK-NEXT:    [[TMP6:%.*]] = load i64, ptr [[COERCE_DIVE]], align 8
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[BYVAL_TEMP]], ptr align 4 [[DOTCOMPOUNDLITERAL6]], i32 16, i1 false)
// CHECK-NEXT:    [[CALL:%.*]] = call i32 (i32, ...) @f_va_callee(i32 noundef 1, i32 noundef 2, i64 noundef 3, double noundef 4.000000e+00, double noundef 5.000000e+00, i32 [[TMP4]], [2 x i32] [[TMP5]], i64 [[TMP6]], ptr noundef [[BYVAL_TEMP]])
// CHECK-NEXT:    ret void
//
...
// CHECK-ILP32F-NEXT:    [[CONV10:%.*]] = bytecast exact b8 [[TMP7]] to i8
...
// CHECK-ILP32F-NEXT:    [[CONV13:%.*]] = bytecast exact b8 [[TMP8]] to i8
...
// CHECK-ILP32F-NEXT:    [[CONV16:%.*]] = bytecast exact b8 [[TMP9]] to i8
...
// CHECK-ILP32F-NEXT:    [[CONV19:%.*]] = bytecast exact b8 [[TMP10]] to i8
...
// CHECK-ILP32D-NEXT:    [[CONV10:%.*]] = bytecast exact b8 [[TMP7]] to i8
...
// CHECK-ILP32D-NEXT:    [[CONV13:%.*]] = bytecast exact b8 [[TMP8]] to i8
...
// CHECK-ILP32D-NEXT:    [[CONV16:%.*]] = bytecast exact b8 [[TMP9]] to i8
...
// CHECK-ILP32D-NEXT:    [[CONV19:%.*]] = bytecast exact b8 [[TMP10]] to i8
...
// CHECK-ILP32E-NEXT:    [[CONV10:%.*]] = bytecast exact b8 [[TMP7]] to i8
...
// CHECK-ILP32E-NEXT:    [[CONV13:%.*]] = bytecast exact b8 [[TMP8]] to i8
...
// CHECK-ILP32E-NEXT:    [[CONV16:%.*]] = bytecast exact b8 [[TMP9]] to i8
...
// CHECK-ILP32E-NEXT:    [[CONV19:%.*]] = bytecast exact b8 [[TMP10]] to i8
