...
// CHECK-RV64-LABEL: define dso_local <vscale x 1 x b8> @test_viota_m_u8mf8
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[OP1:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x b8> @llvm.riscv.viota.nxv1b8.i64(<vscale x 1 x b8> poison, <vscale x 1 x i1> [[OP1]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local <vscale x 2 x b8> @test_viota_m_u8mf4
// CHECK-RV64-SAME: (<vscale x 2 x i1> [[OP1:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x b8> @llvm.riscv.viota.nxv2b8.i64(<vscale x 2 x b8> poison, <vscale x 2 x i1> [[OP1]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local <vscale x 4 x b8> @test_viota_m_u8mf2
// CHECK-RV64-SAME: (<vscale x 4 x i1> [[OP1:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x b8> @llvm.riscv.viota.nxv4b8.i64(<vscale x 4 x b8> poison, <vscale x 4 x i1> [[OP1]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local <vscale x 8 x b8> @test_viota_m_u8m1
// CHECK-RV64-SAME: (<vscale x 8 x i1> [[OP1:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x b8> @llvm.riscv.viota.nxv8b8.i64(<vscale x 8 x b8> poison, <vscale x 8 x i1> [[OP1]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local <vscale x 16 x b8> @test_viota_m_u8m2
// CHECK-RV64-SAME: (<vscale x 16 x i1> [[OP1:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 16 x b8> @llvm.riscv.viota.nxv16b8.i64(<vscale x 16 x b8> poison, <vscale x 16 x i1> [[OP1]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local <vscale x 32 x b8> @test_viota_m_u8m4
// CHECK-RV64-SAME: (<vscale x 32 x i1> [[OP1:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 32 x b8> @llvm.riscv.viota.nxv32b8.i64(<vscale x 32 x b8> poison, <vscale x 32 x i1> [[OP1]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local <vscale x 64 x b8> @test_viota_m_u8m8
// CHECK-RV64-SAME: (<vscale x 64 x i1> [[OP1:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 64 x b8> @llvm.riscv.viota.nxv64b8.i64(<vscale x 64 x b8> poison, <vscale x 64 x i1> [[OP1]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local <vscale x 1 x b8> @test_viota_m_u8mf8_m
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], <vscale x 1 x i1> [[OP1:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x b8> @llvm.riscv.viota.mask.nxv1b8.i64(<vscale x 1 x b8> poison, <vscale x 1 x i1> [[OP1]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 3)
// CHECK-RV64-NEXT:    ret <vscale x 1 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 2 x b8> @test_viota_m_u8mf4_m
// CHECK-RV64-SAME: (<vscale x 2 x i1> [[MASK:%.*]], <vscale x 2 x i1> [[OP1:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x b8> @llvm.riscv.viota.mask.nxv2b8.i64(<vscale x 2 x b8> poison, <vscale x 2 x i1> [[OP1]], <vscale x 2 x i1> [[MASK]], i64 [[VL]], i64 3)
// CHECK-RV64-NEXT:    ret <vscale x 2 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 4 x b8> @test_viota_m_u8mf2_m
// CHECK-RV64-SAME: (<vscale x 4 x i1> [[MASK:%.*]], <vscale x 4 x i1> [[OP1:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x b8> @llvm.riscv.viota.mask.nxv4b8.i64(<vscale x 4 x b8> poison, <vscale x 4 x i1> [[OP1]], <vscale x 4 x i1> [[MASK]], i64 [[VL]], i64 3)
// CHECK-RV64-NEXT:    ret <vscale x 4 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 8 x b8> @test_viota_m_u8m1_m
// CHECK-RV64-SAME: (<vscale x 8 x i1> [[MASK:%.*]], <vscale x 8 x i1> [[OP1:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x b8> @llvm.riscv.viota.mask.nxv8b8.i64(<vscale x 8 x b8> poison, <vscale x 8 x i1> [[OP1]], <vscale x 8 x i1> [[MASK]], i64 [[VL]], i64 3)
// CHECK-RV64-NEXT:    ret <vscale x 8 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 16 x b8> @test_viota_m_u8m2_m
// CHECK-RV64-SAME: (<vscale x 16 x i1> [[MASK:%.*]], <vscale x 16 x i1> [[OP1:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 16 x b8> @llvm.riscv.viota.mask.nxv16b8.i64(<vscale x 16 x b8> poison, <vscale x 16 x i1> [[OP1]], <vscale x 16 x i1> [[MASK]], i64 [[VL]], i64 3)
// CHECK-RV64-NEXT:    ret <vscale x 16 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 32 x b8> @test_viota_m_u8m4_m
// CHECK-RV64-SAME: (<vscale x 32 x i1> [[MASK:%.*]], <vscale x 32 x i1> [[OP1:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 32 x b8> @llvm.riscv.viota.mask.nxv32b8.i64(<vscale x 32 x b8> poison, <vscale x 32 x i1> [[OP1]], <vscale x 32 x i1> [[MASK]], i64 [[VL]], i64 3)
// CHECK-RV64-NEXT:    ret <vscale x 32 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 64 x b8> @test_viota_m_u8m8_m
// CHECK-RV64-SAME: (<vscale x 64 x i1> [[MASK:%.*]], <vscale x 64 x i1> [[OP1:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 64 x b8> @llvm.riscv.viota.mask.nxv64b8.i64(<vscale x 64 x b8> poison, <vscale x 64 x i1> [[OP1]], <vscale x 64 x i1> [[MASK]], i64 [[VL]], i64 3)
// CHECK-RV64-NEXT:    ret <vscale x 64 x b8> [[TMP0]]
//
