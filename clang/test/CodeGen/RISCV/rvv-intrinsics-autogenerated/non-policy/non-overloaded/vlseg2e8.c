...
// CHECK-RV64-LABEL: define dso_local { <vscale x 1 x b8>, <vscale x 1 x b8> } @test_vlseg2e8_v_u8mf8x2
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { <vscale x 1 x b8>, <vscale x 1 x b8> } @llvm.riscv.vlseg2.nxv1b8.i64(<vscale x 1 x b8> poison, <vscale x 1 x b8> poison, ptr [[BASE]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local { <vscale x 2 x b8>, <vscale x 2 x b8> } @test_vlseg2e8_v_u8mf4x2
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { <vscale x 2 x b8>, <vscale x 2 x b8> } @llvm.riscv.vlseg2.nxv2b8.i64(<vscale x 2 x b8> poison, <vscale x 2 x b8> poison, ptr [[BASE]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local { <vscale x 4 x b8>, <vscale x 4 x b8> } @test_vlseg2e8_v_u8mf2x2
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { <vscale x 4 x b8>, <vscale x 4 x b8> } @llvm.riscv.vlseg2.nxv4b8.i64(<vscale x 4 x b8> poison, <vscale x 4 x b8> poison, ptr [[BASE]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local { <vscale x 8 x b8>, <vscale x 8 x b8> } @test_vlseg2e8_v_u8m1x2
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { <vscale x 8 x b8>, <vscale x 8 x b8> } @llvm.riscv.vlseg2.nxv8b8.i64(<vscale x 8 x b8> poison, <vscale x 8 x b8> poison, ptr [[BASE]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local { <vscale x 16 x b8>, <vscale x 16 x b8> } @test_vlseg2e8_v_u8m2x2
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { <vscale x 16 x b8>, <vscale x 16 x b8> } @llvm.riscv.vlseg2.nxv16b8.i64(<vscale x 16 x b8> poison, <vscale x 16 x b8> poison, ptr [[BASE]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local { <vscale x 32 x b8>, <vscale x 32 x b8> } @test_vlseg2e8_v_u8m4x2
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { <vscale x 32 x b8>, <vscale x 32 x b8> } @llvm.riscv.vlseg2.nxv32b8.i64(<vscale x 32 x b8> poison, <vscale x 32 x b8> poison, ptr [[BASE]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local { <vscale x 1 x b8>, <vscale x 1 x b8> } @test_vlseg2e8_v_u8mf8x2_m
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { <vscale x 1 x b8>, <vscale x 1 x b8> } @llvm.riscv.vlseg2.mask.nxv1b8.i64(<vscale x 1 x b8> poison, <vscale x 1 x b8> poison, ptr [[BASE]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 3)
// CHECK-RV64-NEXT:    ret { <vscale x 1 x b8>, <vscale x 1 x b8> } [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local { <vscale x 2 x b8>, <vscale x 2 x b8> } @test_vlseg2e8_v_u8mf4x2_m
// CHECK-RV64-SAME: (<vscale x 2 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { <vscale x 2 x b8>, <vscale x 2 x b8> } @llvm.riscv.vlseg2.mask.nxv2b8.i64(<vscale x 2 x b8> poison, <vscale x 2 x b8> poison, ptr [[BASE]], <vscale x 2 x i1> [[MASK]], i64 [[VL]], i64 3)
// CHECK-RV64-NEXT:    ret { <vscale x 2 x b8>, <vscale x 2 x b8> } [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local { <vscale x 4 x b8>, <vscale x 4 x b8> } @test_vlseg2e8_v_u8mf2x2_m
// CHECK-RV64-SAME: (<vscale x 4 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { <vscale x 4 x b8>, <vscale x 4 x b8> } @llvm.riscv.vlseg2.mask.nxv4b8.i64(<vscale x 4 x b8> poison, <vscale x 4 x b8> poison, ptr [[BASE]], <vscale x 4 x i1> [[MASK]], i64 [[VL]], i64 3)
// CHECK-RV64-NEXT:    ret { <vscale x 4 x b8>, <vscale x 4 x b8> } [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local { <vscale x 8 x b8>, <vscale x 8 x b8> } @test_vlseg2e8_v_u8m1x2_m
// CHECK-RV64-SAME: (<vscale x 8 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { <vscale x 8 x b8>, <vscale x 8 x b8> } @llvm.riscv.vlseg2.mask.nxv8b8.i64(<vscale x 8 x b8> poison, <vscale x 8 x b8> poison, ptr [[BASE]], <vscale x 8 x i1> [[MASK]], i64 [[VL]], i64 3)
// CHECK-RV64-NEXT:    ret { <vscale x 8 x b8>, <vscale x 8 x b8> } [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local { <vscale x 16 x b8>, <vscale x 16 x b8> } @test_vlseg2e8_v_u8m2x2_m
// CHECK-RV64-SAME: (<vscale x 16 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { <vscale x 16 x b8>, <vscale x 16 x b8> } @llvm.riscv.vlseg2.mask.nxv16b8.i64(<vscale x 16 x b8> poison, <vscale x 16 x b8> poison, ptr [[BASE]], <vscale x 16 x i1> [[MASK]], i64 [[VL]], i64 3)
// CHECK-RV64-NEXT:    ret { <vscale x 16 x b8>, <vscale x 16 x b8> } [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local { <vscale x 32 x b8>, <vscale x 32 x b8> } @test_vlseg2e8_v_u8m4x2_m
// CHECK-RV64-SAME: (<vscale x 32 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { <vscale x 32 x b8>, <vscale x 32 x b8> } @llvm.riscv.vlseg2.mask.nxv32b8.i64(<vscale x 32 x b8> poison, <vscale x 32 x b8> poison, ptr [[BASE]], <vscale x 32 x i1> [[MASK]], i64 [[VL]], i64 3)
// CHECK-RV64-NEXT:    ret { <vscale x 32 x b8>, <vscale x 32 x b8> } [[TMP0]]
//
