...
// CHECK-RV64-LABEL: define dso_local <vscale x 1 x b8> @test_vrev8_v_u8mf8_tu
// CHECK-RV64-SAME: (<vscale x 1 x b8> [[MASKEDOFF:%.*]], <vscale x 1 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x b8> @llvm.riscv.vrev8.nxv1b8.i64(<vscale x 1 x b8> [[MASKEDOFF]], <vscale x 1 x b8> [[VS2]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local <vscale x 2 x b8> @test_vrev8_v_u8mf4_tu
// CHECK-RV64-SAME: (<vscale x 2 x b8> [[MASKEDOFF:%.*]], <vscale x 2 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x b8> @llvm.riscv.vrev8.nxv2b8.i64(<vscale x 2 x b8> [[MASKEDOFF]], <vscale x 2 x b8> [[VS2]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local <vscale x 4 x b8> @test_vrev8_v_u8mf2_tu
// CHECK-RV64-SAME: (<vscale x 4 x b8> [[MASKEDOFF:%.*]], <vscale x 4 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x b8> @llvm.riscv.vrev8.nxv4b8.i64(<vscale x 4 x b8> [[MASKEDOFF]], <vscale x 4 x b8> [[VS2]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local <vscale x 8 x b8> @test_vrev8_v_u8m1_tu
// CHECK-RV64-SAME: (<vscale x 8 x b8> [[MASKEDOFF:%.*]], <vscale x 8 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x b8> @llvm.riscv.vrev8.nxv8b8.i64(<vscale x 8 x b8> [[MASKEDOFF]], <vscale x 8 x b8> [[VS2]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local <vscale x 16 x b8> @test_vrev8_v_u8m2_tu
// CHECK-RV64-SAME: (<vscale x 16 x b8> [[MASKEDOFF:%.*]], <vscale x 16 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 16 x b8> @llvm.riscv.vrev8.nxv16b8.i64(<vscale x 16 x b8> [[MASKEDOFF]], <vscale x 16 x b8> [[VS2]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local <vscale x 32 x b8> @test_vrev8_v_u8m4_tu
// CHECK-RV64-SAME: (<vscale x 32 x b8> [[MASKEDOFF:%.*]], <vscale x 32 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 32 x b8> @llvm.riscv.vrev8.nxv32b8.i64(<vscale x 32 x b8> [[MASKEDOFF]], <vscale x 32 x b8> [[VS2]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local <vscale x 64 x b8> @test_vrev8_v_u8m8_tu
// CHECK-RV64-SAME: (<vscale x 64 x b8> [[MASKEDOFF:%.*]], <vscale x 64 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 64 x b8> @llvm.riscv.vrev8.nxv64b8.i64(<vscale x 64 x b8> [[MASKEDOFF]], <vscale x 64 x b8> [[VS2]], i64 [[VL]])
...
// CHECK-RV64-LABEL: define dso_local <vscale x 1 x b8> @test_vrev8_v_u8mf8_tum
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], <vscale x 1 x b8> [[MASKEDOFF:%.*]], <vscale x 1 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x b8> @llvm.riscv.vrev8.mask.nxv1b8.i64(<vscale x 1 x b8> [[MASKEDOFF]], <vscale x 1 x b8> [[VS2]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 2)
// CHECK-RV64-NEXT:    ret <vscale x 1 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 2 x b8> @test_vrev8_v_u8mf4_tum
// CHECK-RV64-SAME: (<vscale x 2 x i1> [[MASK:%.*]], <vscale x 2 x b8> [[MASKEDOFF:%.*]], <vscale x 2 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x b8> @llvm.riscv.vrev8.mask.nxv2b8.i64(<vscale x 2 x b8> [[MASKEDOFF]], <vscale x 2 x b8> [[VS2]], <vscale x 2 x i1> [[MASK]], i64 [[VL]], i64 2)
// CHECK-RV64-NEXT:    ret <vscale x 2 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 4 x b8> @test_vrev8_v_u8mf2_tum
// CHECK-RV64-SAME: (<vscale x 4 x i1> [[MASK:%.*]], <vscale x 4 x b8> [[MASKEDOFF:%.*]], <vscale x 4 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x b8> @llvm.riscv.vrev8.mask.nxv4b8.i64(<vscale x 4 x b8> [[MASKEDOFF]], <vscale x 4 x b8> [[VS2]], <vscale x 4 x i1> [[MASK]], i64 [[VL]], i64 2)
// CHECK-RV64-NEXT:    ret <vscale x 4 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 8 x b8> @test_vrev8_v_u8m1_tum
// CHECK-RV64-SAME: (<vscale x 8 x i1> [[MASK:%.*]], <vscale x 8 x b8> [[MASKEDOFF:%.*]], <vscale x 8 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x b8> @llvm.riscv.vrev8.mask.nxv8b8.i64(<vscale x 8 x b8> [[MASKEDOFF]], <vscale x 8 x b8> [[VS2]], <vscale x 8 x i1> [[MASK]], i64 [[VL]], i64 2)
// CHECK-RV64-NEXT:    ret <vscale x 8 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 16 x b8> @test_vrev8_v_u8m2_tum
// CHECK-RV64-SAME: (<vscale x 16 x i1> [[MASK:%.*]], <vscale x 16 x b8> [[MASKEDOFF:%.*]], <vscale x 16 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 16 x b8> @llvm.riscv.vrev8.mask.nxv16b8.i64(<vscale x 16 x b8> [[MASKEDOFF]], <vscale x 16 x b8> [[VS2]], <vscale x 16 x i1> [[MASK]], i64 [[VL]], i64 2)
// CHECK-RV64-NEXT:    ret <vscale x 16 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 32 x b8> @test_vrev8_v_u8m4_tum
// CHECK-RV64-SAME: (<vscale x 32 x i1> [[MASK:%.*]], <vscale x 32 x b8> [[MASKEDOFF:%.*]], <vscale x 32 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 32 x b8> @llvm.riscv.vrev8.mask.nxv32b8.i64(<vscale x 32 x b8> [[MASKEDOFF]], <vscale x 32 x b8> [[VS2]], <vscale x 32 x i1> [[MASK]], i64 [[VL]], i64 2)
// CHECK-RV64-NEXT:    ret <vscale x 32 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 64 x b8> @test_vrev8_v_u8m8_tum
// CHECK-RV64-SAME: (<vscale x 64 x i1> [[MASK:%.*]], <vscale x 64 x b8> [[MASKEDOFF:%.*]], <vscale x 64 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 64 x b8> @llvm.riscv.vrev8.mask.nxv64b8.i64(<vscale x 64 x b8> [[MASKEDOFF]], <vscale x 64 x b8> [[VS2]], <vscale x 64 x i1> [[MASK]], i64 [[VL]], i64 2)
// CHECK-RV64-NEXT:    ret <vscale x 64 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 1 x b8> @test_vrev8_v_u8mf8_tumu
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], <vscale x 1 x b8> [[MASKEDOFF:%.*]], <vscale x 1 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x b8> @llvm.riscv.vrev8.mask.nxv1b8.i64(<vscale x 1 x b8> [[MASKEDOFF]], <vscale x 1 x b8> [[VS2]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 0)
// CHECK-RV64-NEXT:    ret <vscale x 1 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 2 x b8> @test_vrev8_v_u8mf4_tumu
// CHECK-RV64-SAME: (<vscale x 2 x i1> [[MASK:%.*]], <vscale x 2 x b8> [[MASKEDOFF:%.*]], <vscale x 2 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x b8> @llvm.riscv.vrev8.mask.nxv2b8.i64(<vscale x 2 x b8> [[MASKEDOFF]], <vscale x 2 x b8> [[VS2]], <vscale x 2 x i1> [[MASK]], i64 [[VL]], i64 0)
// CHECK-RV64-NEXT:    ret <vscale x 2 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 4 x b8> @test_vrev8_v_u8mf2_tumu
// CHECK-RV64-SAME: (<vscale x 4 x i1> [[MASK:%.*]], <vscale x 4 x b8> [[MASKEDOFF:%.*]], <vscale x 4 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x b8> @llvm.riscv.vrev8.mask.nxv4b8.i64(<vscale x 4 x b8> [[MASKEDOFF]], <vscale x 4 x b8> [[VS2]], <vscale x 4 x i1> [[MASK]], i64 [[VL]], i64 0)
// CHECK-RV64-NEXT:    ret <vscale x 4 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 8 x b8> @test_vrev8_v_u8m1_tumu
// CHECK-RV64-SAME: (<vscale x 8 x i1> [[MASK:%.*]], <vscale x 8 x b8> [[MASKEDOFF:%.*]], <vscale x 8 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x b8> @llvm.riscv.vrev8.mask.nxv8b8.i64(<vscale x 8 x b8> [[MASKEDOFF]], <vscale x 8 x b8> [[VS2]], <vscale x 8 x i1> [[MASK]], i64 [[VL]], i64 0)
// CHECK-RV64-NEXT:    ret <vscale x 8 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 16 x b8> @test_vrev8_v_u8m2_tumu
// CHECK-RV64-SAME: (<vscale x 16 x i1> [[MASK:%.*]], <vscale x 16 x b8> [[MASKEDOFF:%.*]], <vscale x 16 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 16 x b8> @llvm.riscv.vrev8.mask.nxv16b8.i64(<vscale x 16 x b8> [[MASKEDOFF]], <vscale x 16 x b8> [[VS2]], <vscale x 16 x i1> [[MASK]], i64 [[VL]], i64 0)
// CHECK-RV64-NEXT:    ret <vscale x 16 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 32 x b8> @test_vrev8_v_u8m4_tumu
// CHECK-RV64-SAME: (<vscale x 32 x i1> [[MASK:%.*]], <vscale x 32 x b8> [[MASKEDOFF:%.*]], <vscale x 32 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 32 x b8> @llvm.riscv.vrev8.mask.nxv32b8.i64(<vscale x 32 x b8> [[MASKEDOFF]], <vscale x 32 x b8> [[VS2]], <vscale x 32 x i1> [[MASK]], i64 [[VL]], i64 0)
// CHECK-RV64-NEXT:    ret <vscale x 32 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 64 x b8> @test_vrev8_v_u8m8_tumu
// CHECK-RV64-SAME: (<vscale x 64 x i1> [[MASK:%.*]], <vscale x 64 x b8> [[MASKEDOFF:%.*]], <vscale x 64 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 64 x b8> @llvm.riscv.vrev8.mask.nxv64b8.i64(<vscale x 64 x b8> [[MASKEDOFF]], <vscale x 64 x b8> [[VS2]], <vscale x 64 x i1> [[MASK]], i64 [[VL]], i64 0)
// CHECK-RV64-NEXT:    ret <vscale x 64 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 1 x b8> @test_vrev8_v_u8mf8_mu
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], <vscale x 1 x b8> [[MASKEDOFF:%.*]], <vscale x 1 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x b8> @llvm.riscv.vrev8.mask.nxv1b8.i64(<vscale x 1 x b8> [[MASKEDOFF]], <vscale x 1 x b8> [[VS2]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 1 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 2 x b8> @test_vrev8_v_u8mf4_mu
// CHECK-RV64-SAME: (<vscale x 2 x i1> [[MASK:%.*]], <vscale x 2 x b8> [[MASKEDOFF:%.*]], <vscale x 2 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x b8> @llvm.riscv.vrev8.mask.nxv2b8.i64(<vscale x 2 x b8> [[MASKEDOFF]], <vscale x 2 x b8> [[VS2]], <vscale x 2 x i1> [[MASK]], i64 [[VL]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 2 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 4 x b8> @test_vrev8_v_u8mf2_mu
// CHECK-RV64-SAME: (<vscale x 4 x i1> [[MASK:%.*]], <vscale x 4 x b8> [[MASKEDOFF:%.*]], <vscale x 4 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x b8> @llvm.riscv.vrev8.mask.nxv4b8.i64(<vscale x 4 x b8> [[MASKEDOFF]], <vscale x 4 x b8> [[VS2]], <vscale x 4 x i1> [[MASK]], i64 [[VL]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 4 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 8 x b8> @test_vrev8_v_u8m1_mu
// CHECK-RV64-SAME: (<vscale x 8 x i1> [[MASK:%.*]], <vscale x 8 x b8> [[MASKEDOFF:%.*]], <vscale x 8 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x b8> @llvm.riscv.vrev8.mask.nxv8b8.i64(<vscale x 8 x b8> [[MASKEDOFF]], <vscale x 8 x b8> [[VS2]], <vscale x 8 x i1> [[MASK]], i64 [[VL]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 8 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 16 x b8> @test_vrev8_v_u8m2_mu
// CHECK-RV64-SAME: (<vscale x 16 x i1> [[MASK:%.*]], <vscale x 16 x b8> [[MASKEDOFF:%.*]], <vscale x 16 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 16 x b8> @llvm.riscv.vrev8.mask.nxv16b8.i64(<vscale x 16 x b8> [[MASKEDOFF]], <vscale x 16 x b8> [[VS2]], <vscale x 16 x i1> [[MASK]], i64 [[VL]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 16 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 32 x b8> @test_vrev8_v_u8m4_mu
// CHECK-RV64-SAME: (<vscale x 32 x i1> [[MASK:%.*]], <vscale x 32 x b8> [[MASKEDOFF:%.*]], <vscale x 32 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 32 x b8> @llvm.riscv.vrev8.mask.nxv32b8.i64(<vscale x 32 x b8> [[MASKEDOFF]], <vscale x 32 x b8> [[VS2]], <vscale x 32 x i1> [[MASK]], i64 [[VL]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 32 x b8> [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local <vscale x 64 x b8> @test_vrev8_v_u8m8_mu
// CHECK-RV64-SAME: (<vscale x 64 x i1> [[MASK:%.*]], <vscale x 64 x b8> [[MASKEDOFF:%.*]], <vscale x 64 x b8> [[VS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 64 x b8> @llvm.riscv.vrev8.mask.nxv64b8.i64(<vscale x 64 x b8> [[MASKEDOFF]], <vscale x 64 x b8> [[VS2]], <vscale x 64 x i1> [[MASK]], i64 [[VL]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 64 x b8> [[TMP0]]
//
