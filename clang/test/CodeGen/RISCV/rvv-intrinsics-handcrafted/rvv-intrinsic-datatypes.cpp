...
// CHECK-NEXT:    [[U8MF8:%.*]] = alloca <vscale x 1 x b8>, align 1
// CHECK-NEXT:    [[U8MF4:%.*]] = alloca <vscale x 2 x b8>, align 1
// CHECK-NEXT:    [[U8MF2:%.*]] = alloca <vscale x 4 x b8>, align 1
// CHECK-NEXT:    [[U8M1:%.*]] = alloca <vscale x 8 x b8>, align 1
// CHECK-NEXT:    [[U8M2:%.*]] = alloca <vscale x 16 x b8>, align 1
// CHECK-NEXT:    [[U8M4:%.*]] = alloca <vscale x 32 x b8>, align 1
// CHECK-NEXT:    [[U8M8:%.*]] = alloca <vscale x 64 x b8>, align 1
...
// CHECK-NEXT:    [[U8MF8X2:%.*]] = alloca { <vscale x 1 x b8>, <vscale x 1 x b8> }, align 1
// CHECK-NEXT:    [[U8MF8X3:%.*]] = alloca { <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8> }, align 1
// CHECK-NEXT:    [[U8MF8X4:%.*]] = alloca { <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8> }, align 1
// CHECK-NEXT:    [[U8MF8X5:%.*]] = alloca { <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8> }, align 1
// CHECK-NEXT:    [[U8MF8X6:%.*]] = alloca { <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8> }, align 1
// CHECK-NEXT:    [[U8MF8X7:%.*]] = alloca { <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8> }, align 1
// CHECK-NEXT:    [[U8MF8X8:%.*]] = alloca { <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8>, <vscale x 1 x b8> }, align 1
// CHECK-NEXT:    [[U8MF4X2:%.*]] = alloca { <vscale x 2 x b8>, <vscale x 2 x b8> }, align 1
// CHECK-NEXT:    [[U8MF4X3:%.*]] = alloca { <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8> }, align 1
// CHECK-NEXT:    [[U8MF4X4:%.*]] = alloca { <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8> }, align 1
// CHECK-NEXT:    [[U8MF4X5:%.*]] = alloca { <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8> }, align 1
// CHECK-NEXT:    [[U8MF4X6:%.*]] = alloca { <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8> }, align 1
// CHECK-NEXT:    [[U8MF4X7:%.*]] = alloca { <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8> }, align 1
// CHECK-NEXT:    [[U8MF4X8:%.*]] = alloca { <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8>, <vscale x 2 x b8> }, align 1
// CHECK-NEXT:    [[U8MF2X2:%.*]] = alloca { <vscale x 4 x b8>, <vscale x 4 x b8> }, align 1
// CHECK-NEXT:    [[U8MF2X3:%.*]] = alloca { <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8> }, align 1
// CHECK-NEXT:    [[U8MF2X4:%.*]] = alloca { <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8> }, align 1
// CHECK-NEXT:    [[U8MF2X5:%.*]] = alloca { <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8> }, align 1
// CHECK-NEXT:    [[U8MF2X6:%.*]] = alloca { <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8> }, align 1
// CHECK-NEXT:    [[U8MF2X7:%.*]] = alloca { <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8> }, align 1
// CHECK-NEXT:    [[U8MF2X8:%.*]] = alloca { <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8>, <vscale x 4 x b8> }, align 1
// CHECK-NEXT:    [[U8M1X2:%.*]] = alloca { <vscale x 8 x b8>, <vscale x 8 x b8> }, align 1
// CHECK-NEXT:    [[U8M1X3:%.*]] = alloca { <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8> }, align 1
// CHECK-NEXT:    [[U8M1X4:%.*]] = alloca { <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8> }, align 1
// CHECK-NEXT:    [[U8M1X5:%.*]] = alloca { <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8> }, align 1
// CHECK-NEXT:    [[U8M1X6:%.*]] = alloca { <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8> }, align 1
// CHECK-NEXT:    [[U8M1X7:%.*]] = alloca { <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8> }, align 1
// CHECK-NEXT:    [[U8M1X8:%.*]] = alloca { <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8>, <vscale x 8 x b8> }, align 1
// CHECK-NEXT:    [[U8M2X2:%.*]] = alloca { <vscale x 16 x b8>, <vscale x 16 x b8> }, align 1
// CHECK-NEXT:    [[U8M2X3:%.*]] = alloca { <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8> }, align 1
// CHECK-NEXT:    [[U8M2X4:%.*]] = alloca { <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8>, <vscale x 16 x b8> }, align 1
// CHECK-NEXT:    [[U8M4X2:%.*]] = alloca { <vscale x 32 x b8>, <vscale x 32 x b8> }, align 1
