...
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x b8> @llvm.vector.extract.nxv8b8.nxv16b8(<vscale x 16 x b8> [[SRC:%.*]], i64 8)
...
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 16 x b8> @llvm.vector.insert.nxv16b8.nxv8b8(<vscale x 16 x b8> [[DEST:%.*]], <vscale x 8 x b8> [[VAL:%.*]], i64 8)
