...
// CHECK-I386:   [[CONV:%.*]] = bytecast b8 [[VALUE]] to i8
// CHECK-I386:   ret i8 [[CONV]]
...
// CHECK-X64:   [[CONV:%.*]] = bytecast b8 [[VALUE]] to i8
// CHECK-X64:   ret i8 [[CONV]]
...
// CHECK-X64-LABEL: define dso_local noundef i64 @test__shiftleft128(i64 noundef %l, i64 noundef %h, b8 noundef %d)
...
// CHECK-X64-LABEL: define dso_local noundef i64 @test__shiftright128(i64 noundef %l, i64 noundef %h, b8 noundef %d)
// CHECK-X64: = zext i8 %{{.*}} to i64
