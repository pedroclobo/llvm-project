...
// CHECK:   [[EXT_A:%.*]] = bytecast <8 x b8> %a to <8 x i8>
// CHECK:   [[EXT_B:%.*]] = bytecast <8 x b8> %b to <8 x i8>
// CHECK:   [[NEG_I:%.*]] = xor <8 x i8> [[EXT_B]], <i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1>
...
// CHECK:   [[EXT_A:%.*]] = bytecast <16 x b8> %a to <16 x i8>
// CHECK:   [[EXT_B:%.*]] = bytecast <16 x b8> %b to <16 x i8>
// CHECK:   [[NEG_I:%.*]] = xor <16 x i8> [[EXT_B]], <i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1>
