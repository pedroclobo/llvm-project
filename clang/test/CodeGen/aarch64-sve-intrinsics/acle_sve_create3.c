...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = tail call <vscale x 48 x b8> @llvm.vector.insert.nxv48b8.nxv16b8(<vscale x 48 x b8> poison, <vscale x 16 x b8> [[X0:%.*]], i64 0)
// CHECK-NEXT:    [[TMP1:%.*]] = tail call <vscale x 48 x b8> @llvm.vector.insert.nxv48b8.nxv16b8(<vscale x 48 x b8> [[TMP0]], <vscale x 16 x b8> [[X1:%.*]], i64 16)
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <vscale x 48 x b8> @llvm.vector.insert.nxv48b8.nxv16b8(<vscale x 48 x b8> [[TMP1]], <vscale x 16 x b8> [[X2:%.*]], i64 32)
// CHECK-NEXT:    ret <vscale x 48 x b8> [[TMP2]]
//
// CPP-CHECK-LABEL: @_Z17test_svcreate3_u8u11__SVUint8_tS_S_(
// CPP-CHECK-NEXT:  entry:
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = tail call <vscale x 48 x b8> @llvm.vector.insert.nxv48b8.nxv16b8(<vscale x 48 x b8> poison, <vscale x 16 x b8> [[X0:%.*]], i64 0)
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = tail call <vscale x 48 x b8> @llvm.vector.insert.nxv48b8.nxv16b8(<vscale x 48 x b8> [[TMP0]], <vscale x 16 x b8> [[X1:%.*]], i64 16)
// CPP-CHECK-NEXT:    [[TMP2:%.*]] = tail call <vscale x 48 x b8> @llvm.vector.insert.nxv48b8.nxv16b8(<vscale x 48 x b8> [[TMP1]], <vscale x 16 x b8> [[X2:%.*]], i64 32)
// CPP-CHECK-NEXT:    ret <vscale x 48 x b8> [[TMP2]]
//
