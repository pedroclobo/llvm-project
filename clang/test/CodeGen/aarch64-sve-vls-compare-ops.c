...
// CHECK-NEXT:    [[CONV3:%.*]] = bytecast <8 x b8> [[B2]] to <8 x i8>
// CHECK-NEXT:    [[CMP:%.*]] = icmp eq <8 x i8> [[CONV]], [[CONV3]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <8 x i1> [[CMP]] to <8 x i8>
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i8> [[SEXT]] to <8 x b8>
// CHECK-NEXT:    store <8 x b8> [[TMP0]], ptr [[RETVAL_COERCE]], align 2
// CHECK-NEXT:    [[TMP1:%.*]] = load <vscale x 16 x i1>, ptr [[RETVAL_COERCE]], align 2
...
// CHECK-NEXT:    [[CAST_SCALABLE:%.*]] = call <vscale x 16 x i8> @llvm.vector.insert.nxv16i8.v64i8(<vscale x 16 x i8> undef, <64 x i8> [[SEXT]], i64 0)
...
// CHECK-NEXT:    [[CAST_SCALABLE:%.*]] = call <vscale x 8 x i16> @llvm.vector.insert.nxv8i16.v32i16(<vscale x 8 x i16> undef, <32 x i16> [[SEXT]], i64 0)
...
// CHECK-NEXT:    [[CAST_SCALABLE:%.*]] = call <vscale x 4 x i32> @llvm.vector.insert.nxv4i32.v16i32(<vscale x 4 x i32> undef, <16 x i32> [[SEXT]], i64 0)
...
// CHECK-NEXT:    [[CAST_SCALABLE:%.*]] = call <vscale x 2 x i64> @llvm.vector.insert.nxv2i64.v8i64(<vscale x 2 x i64> undef, <8 x i64> [[SEXT]], i64 0)
...
// CHECK-NEXT:    [[CONV3:%.*]] = bytecast <64 x b8> [[B2]] to <64 x i8>
// CHECK-NEXT:    [[CMP:%.*]] = icmp eq <64 x i8> [[CONV]], [[CONV3]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <64 x i1> [[CMP]] to <64 x i8>
// CHECK-NEXT:    [[CAST_SCALABLE:%.*]] = call <vscale x 16 x i8> @llvm.vector.insert.nxv16i8.v64i8(<vscale x 16 x i8> undef, <64 x i8> [[SEXT]], i64 0)
// CHECK-NEXT:    ret <vscale x 16 x i8> [[CAST_SCALABLE]]
//
...
// CHECK-NEXT:    [[CAST_SCALABLE:%.*]] = call <vscale x 8 x i16> @llvm.vector.insert.nxv8i16.v32i16(<vscale x 8 x i16> undef, <32 x i16> [[CONV3]], i64 0)
// CHECK-NEXT:    ret <vscale x 8 x i16> [[CAST_SCALABLE]]
//
...
// CHECK-NEXT:    [[CONV:%.*]] = bytecast <8 x b8> [[A1]] to <8 x i8>
// CHECK-NEXT:    [[CONV3:%.*]] = bytecast <8 x b8> [[B2]] to <8 x i8>
// CHECK-NEXT:    [[CMP:%.*]] = icmp ne <8 x i8> [[CONV]], [[CONV3]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <8 x i1> [[CMP]] to <8 x i8>
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i8> [[SEXT]] to <8 x b8>
// CHECK-NEXT:    store <8 x b8> [[TMP0]], ptr [[RETVAL_COERCE]], align 2
// CHECK-NEXT:    [[TMP1:%.*]] = load <vscale x 16 x i1>, ptr [[RETVAL_COERCE]], align 2
...
// CHECK-NEXT:    [[CONV:%.*]] = bytecast <64 x b8> [[A1]] to <64 x i8>
// CHECK-NEXT:    [[CONV3:%.*]] = bytecast <64 x b8> [[B2]] to <64 x i8>
// CHECK-NEXT:    [[CMP:%.*]] = icmp ne <64 x i8> [[CONV]], [[CONV3]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <64 x i1> [[CMP]] to <64 x i8>
// CHECK-NEXT:    [[CAST_SCALABLE:%.*]] = call <vscale x 16 x i8> @llvm.vector.insert.nxv16i8.v64i8(<vscale x 16 x i8> undef, <64 x i8> [[SEXT]], i64 0)
// CHECK-NEXT:    ret <vscale x 16 x i8> [[CAST_SCALABLE]]
//
...
// CHECK-NEXT:    [[CONV:%.*]] = bytecast <8 x b8> [[A1]] to <8 x i8>
// CHECK-NEXT:    [[CONV3:%.*]] = bytecast <8 x b8> [[B2]] to <8 x i8>
// CHECK-NEXT:    [[CMP:%.*]] = icmp ult <8 x i8> [[CONV]], [[CONV3]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <8 x i1> [[CMP]] to <8 x i8>
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i8> [[SEXT]] to <8 x b8>
// CHECK-NEXT:    store <8 x b8> [[TMP0]], ptr [[RETVAL_COERCE]], align 2
// CHECK-NEXT:    [[TMP1:%.*]] = load <vscale x 16 x i1>, ptr [[RETVAL_COERCE]], align 2
...
// CHECK-NEXT:    [[CONV:%.*]] = bytecast <64 x b8> [[A1]] to <64 x i8>
// CHECK-NEXT:    [[CONV3:%.*]] = bytecast <64 x b8> [[B2]] to <64 x i8>
// CHECK-NEXT:    [[CMP:%.*]] = icmp ult <64 x i8> [[CONV]], [[CONV3]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <64 x i1> [[CMP]] to <64 x i8>
// CHECK-NEXT:    [[CAST_SCALABLE:%.*]] = call <vscale x 16 x i8> @llvm.vector.insert.nxv16i8.v64i8(<vscale x 16 x i8> undef, <64 x i8> [[SEXT]], i64 0)
// CHECK-NEXT:    ret <vscale x 16 x i8> [[CAST_SCALABLE]]
//
...
// CHECK-NEXT:    [[CONV:%.*]] = bytecast <8 x b8> [[A1]] to <8 x i8>
// CHECK-NEXT:    [[CONV3:%.*]] = bytecast <8 x b8> [[B2]] to <8 x i8>
// CHECK-NEXT:    [[CMP:%.*]] = icmp ule <8 x i8> [[CONV]], [[CONV3]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <8 x i1> [[CMP]] to <8 x i8>
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i8> [[SEXT]] to <8 x b8>
// CHECK-NEXT:    store <8 x b8> [[TMP0]], ptr [[RETVAL_COERCE]], align 2
// CHECK-NEXT:    [[TMP1:%.*]] = load <vscale x 16 x i1>, ptr [[RETVAL_COERCE]], align 2
...
// CHECK-NEXT:    [[CONV:%.*]] = bytecast <64 x b8> [[A1]] to <64 x i8>
// CHECK-NEXT:    [[CONV3:%.*]] = bytecast <64 x b8> [[B2]] to <64 x i8>
// CHECK-NEXT:    [[CMP:%.*]] = icmp ule <64 x i8> [[CONV]], [[CONV3]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <64 x i1> [[CMP]] to <64 x i8>
// CHECK-NEXT:    [[CAST_SCALABLE:%.*]] = call <vscale x 16 x i8> @llvm.vector.insert.nxv16i8.v64i8(<vscale x 16 x i8> undef, <64 x i8> [[SEXT]], i64 0)
// CHECK-NEXT:    ret <vscale x 16 x i8> [[CAST_SCALABLE]]
//
...
// CHECK-NEXT:    [[CONV:%.*]] = bytecast <8 x b8> [[A1]] to <8 x i8>
// CHECK-NEXT:    [[CONV3:%.*]] = bytecast <8 x b8> [[B2]] to <8 x i8>
// CHECK-NEXT:    [[CMP:%.*]] = icmp ugt <8 x i8> [[CONV]], [[CONV3]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <8 x i1> [[CMP]] to <8 x i8>
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i8> [[SEXT]] to <8 x b8>
// CHECK-NEXT:    store <8 x b8> [[TMP0]], ptr [[RETVAL_COERCE]], align 2
// CHECK-NEXT:    [[TMP1:%.*]] = load <vscale x 16 x i1>, ptr [[RETVAL_COERCE]], align 2
...
// CHECK-NEXT:    [[CONV:%.*]] = bytecast <64 x b8> [[A1]] to <64 x i8>
// CHECK-NEXT:    [[CONV3:%.*]] = bytecast <64 x b8> [[B2]] to <64 x i8>
// CHECK-NEXT:    [[CMP:%.*]] = icmp ugt <64 x i8> [[CONV]], [[CONV3]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <64 x i1> [[CMP]] to <64 x i8>
// CHECK-NEXT:    [[CAST_SCALABLE:%.*]] = call <vscale x 16 x i8> @llvm.vector.insert.nxv16i8.v64i8(<vscale x 16 x i8> undef, <64 x i8> [[SEXT]], i64 0)
// CHECK-NEXT:    ret <vscale x 16 x i8> [[CAST_SCALABLE]]
//
...
// CHECK-NEXT:    [[CONV:%.*]] = bytecast <8 x b8> [[A1]] to <8 x i8>
// CHECK-NEXT:    [[CONV3:%.*]] = bytecast <8 x b8> [[B2]] to <8 x i8>
// CHECK-NEXT:    [[CMP:%.*]] = icmp uge <8 x i8> [[CONV]], [[CONV3]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <8 x i1> [[CMP]] to <8 x i8>
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i8> [[SEXT]] to <8 x b8>
// CHECK-NEXT:    store <8 x b8> [[TMP0]], ptr [[RETVAL_COERCE]], align 2
// CHECK-NEXT:    [[TMP1:%.*]] = load <vscale x 16 x i1>, ptr [[RETVAL_COERCE]], align 2
...
// CHECK-NEXT:    [[CONV:%.*]] = bytecast <64 x b8> [[A1]] to <64 x i8>
// CHECK-NEXT:    [[CONV3:%.*]] = bytecast <64 x b8> [[B2]] to <64 x i8>
// CHECK-NEXT:    [[CMP:%.*]] = icmp uge <64 x i8> [[CONV]], [[CONV3]]
// CHECK-NEXT:    [[SEXT:%.*]] = sext <64 x i1> [[CMP]] to <64 x i8>
// CHECK-NEXT:    [[CAST_SCALABLE:%.*]] = call <vscale x 16 x i8> @llvm.vector.insert.nxv16i8.v64i8(<vscale x 16 x i8> undef, <64 x i8> [[SEXT]], i64 0)
// CHECK-NEXT:    ret <vscale x 16 x i8> [[CAST_SCALABLE]]
//
