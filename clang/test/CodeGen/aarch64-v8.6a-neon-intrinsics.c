...
// CHECK: [[TMP1:%.*]] = bytecast <16 x b8> %a to <16 x i8>
// CHECK: [[TMP2:%.*]] = bytecast <16 x b8> %b to <16 x i8>
// CHECK: [[VAL:%.*]] = call <4 x i32> @llvm.aarch64.neon.ummla.v4i32.v16i8(<4 x i32> %r, <16 x i8> [[TMP1]], <16 x i8> [[TMP2]])
// CHECK: ret <4 x i32> [[VAL]]
...
// CHECK: [[TMP1:%.*]] = bytecast <16 x b8> %a to <16 x i8>
// CHECK: [[VAL:%.*]] = call <4 x i32> @llvm.aarch64.neon.usmmla.v4i32.v16i8(<4 x i32> %r, <16 x i8> [[TMP1]], <16 x i8> %b)
// CHECK: ret <4 x i32> [[VAL]]
...
// CHECK: [[TMP1:%.*]] = bytecast <8 x b8> %a to <8 x i8>
// CHECK: [[VAL:%.*]] = call <2 x i32> @llvm.aarch64.neon.usdot.v2i32.v8i8(<2 x i32> %r, <8 x i8> [[TMP1]], <8 x i8> %b)
...
// CHECK: [[TMP6:%.*]] = bytecast <8 x b8> %a to <8 x i8>
// CHECK: [[OP:%.*]] = call <2 x i32> @llvm.aarch64.neon.usdot.v2i32.v8i8(<2 x i32> %r, <8 x i8> [[TMP6]], <8 x i8> [[TMP4]])
...
// CHECK: [[TMP0:%.*]] = bytecast <8 x b8> %b to <2 x i32>
// CHECK: [[TMP1:%.*]] = bitcast <2 x i32> %0 to <8 x i8>
// CHECK: [[TMP2:%.*]] = bitcast <8 x i8> %1 to <2 x i32>
// CHECK: [[LANE:%.*]] = shufflevector <2 x i32> [[TMP2]], <2 x i32> [[TMP2]], <2 x i32> zeroinitializer
// CHECK: [[TMP4:%.*]] = bitcast <2 x i32> [[LANE]] to <8 x b8>
// CHECK: [[TMP5:%.*]] = bitcast <2 x i32> %r to <8 x i8>
// CHECK: [[TMP6:%.*]] = bytecast <8 x b8> [[TMP4]] to <8 x i8>
// CHECK: [[OP:%.*]] = call <2 x i32> @llvm.aarch64.neon.usdot.v2i32.v8i8(<2 x i32> %r, <8 x i8> [[TMP6]], <8 x i8> %a)
// CHECK: ret <2 x i32> [[OP]]
...
// CHECK: [[TMP0:%.*]] = bytecast <16 x b8> %b to <4 x i32>
// CHECK: [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x i8>
// CHECK: [[TMP2:%.*]] = bitcast <16 x i8> [[TMP1]] to <4 x i32>
// CHECK: [[LANE:%.*]] = shufflevector <4 x i32> [[TMP2]], <4 x i32> [[TMP2]], <2 x i32> zeroinitializer
// CHECK: [[TMP4:%.*]] = bitcast <2 x i32> [[LANE]] to <8 x b8>
...
// CHECK: [[TMP0:%.*]] = bitcast <4 x i32> %r to <16 x i8>
// CHECK: [[TMP1:%.*]] = bytecast <16 x b8> %a to <16 x i8>
// CHECK: [[VAL:%.*]] = call <4 x i32> @llvm.aarch64.neon.usdot.v4i32.v16i8(<4 x i32> %r, <16 x i8> [[TMP1]], <16 x i8> %b)
// CHECK: ret <4 x i32> [[VAL]]
...
// CHECK: [[TMP6:%.*]] = bytecast <16 x b8> %a to <16 x i8>
// CHECK: [[OP:%.*]] = call <4 x i32> @llvm.aarch64.neon.usdot.v4i32.v16i8(<4 x i32> %r, <16 x i8> [[TMP6]], <16 x i8> [[TMP4]])
...
// CHECK: [[TMP2:%.*]] = bitcast <8 x i8> [[TMP1]] to <2 x i32>
// CHECK: [[LANE:%.*]] = shufflevector <2 x i32> [[TMP2]], <2 x i32> [[TMP2]], <4 x i32> zeroinitializer
// CHECK: [[TMP4:%.*]] = bitcast <4 x i32> [[LANE]] to <16 x b8>
// CHECK: [[TMP5:%.*]] = bitcast <4 x i32> %r to <16 x i8>
// CHECK: [[TMP6:%.*]] = bytecast <16 x b8> [[TMP4]] to <16 x i8>
// CHECK: [[OP:%.*]] = call <4 x i32> @llvm.aarch64.neon.usdot.v4i32.v16i8(<4 x i32> %r, <16 x i8> [[TMP6]], <16 x i8> %a)
// CHECK: ret <4 x i32> [[OP]]
