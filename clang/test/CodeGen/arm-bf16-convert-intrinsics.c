...
// CHECK-A64-NEXT:    [[TMP2:%.*]] = bytecast <8 x b8> [[TMP1]] to <8 x i8>
...
// CHECK-A32-HARDFP-NEXT:    [[TMP2:%.*]] = bytecast <8 x b8> [[TMP1]] to <8 x i8>
...
// CHECK-A32-SOFTFP-NEXT:    [[TMP5:%.*]] = bytecast <8 x b8> [[TMP4]] to <8 x i8>
...
// CHECK-A32-SOFTFP-NEXT:    [[TMP11:%.*]] = bytecast <8 x b8> [[TMP10]] to <8 x i8>
...
// CHECK-A64-NEXT:    [[TMP2:%.*]] = bytecast <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-A32-HARDFP-NEXT:    [[VCVTFP2BF_I:%.*]] = bytecast <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-A32-SOFTFP-NEXT:    [[VCVTFP2BF_I:%.*]] = bytecast <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-A32-HARDFP-NEXT:    [[VCVTFP2BF_I:%.*]] = bytecast <16 x b8> [[TMP2]] to <4 x float>
// CHECK-A32-HARDFP-NEXT:    [[VCVTFP2BF1_I:%.*]] = call <4 x bfloat> @llvm.arm.neon.vcvtfp2bf.v4bf16(<4 x float> [[VCVTFP2BF_I]])
...
// CHECK-A32-SOFTFP-NEXT:    [[VCVTFP2BF_I:%.*]] = bytecast <16 x b8> [[TMP2]] to <4 x float>
// CHECK-A32-SOFTFP-NEXT:    [[VCVTFP2BF1_I:%.*]] = call <4 x i16> @llvm.arm.neon.vcvtfp2bf.v4i16(<4 x float> [[VCVTFP2BF_I]])
...
// CHECK-A64-NEXT:    [[TMP4:%.*]] = bytecast <16 x b8> [[TMP2]] to <8 x bfloat>
...
// CHECK-A32-SOFTFP-NEXT:    [[VCVTFP2BF_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <4 x float>
// CHECK-A32-SOFTFP-NEXT:    [[VCVTFP2BF1_I:%.*]] = call <4 x i16> @llvm.arm.neon.vcvtfp2bf.v4i16(<4 x float> [[VCVTFP2BF_I]])
