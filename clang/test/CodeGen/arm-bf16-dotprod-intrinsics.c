...
// CHECK-NEXT:    [[VBFDOT3_I:%.*]] = call <2 x float> @llvm.arm.neon.bfdot.v2f32.v4bf16(<2 x float> [[R]], <4 x bfloat> [[A]], <4 x bfloat> [[TMP4]])
// CHECK-NEXT:    ret <2 x float> [[VBFDOT3_I]]
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__REINT_796:%.*]] = alloca <8 x bfloat>, align 8
// CHECK-NEXT:    [[__REINT1_796:%.*]] = alloca <4 x float>, align 8
// CHECK-NEXT:    store <8 x bfloat> [[B:%.*]], ptr [[__REINT_796]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load <4 x float>, ptr [[__REINT_796]], align 8
...
// CHECK-NEXT:    store <4 x float> [[LANE]], ptr [[__REINT1_796]], align 8
// CHECK-NEXT:    [[TMP4:%.*]] = load <8 x bfloat>, ptr [[__REINT1_796]], align 8
...
// CHECK-NEXT:    [[VBFDOT3_I:%.*]] = call <4 x float> @llvm.arm.neon.bfdot.v4f32.v8bf16(<4 x float> [[R]], <8 x bfloat> [[A]], <8 x bfloat> [[TMP4]])
// CHECK-NEXT:    ret <4 x float> [[VBFDOT3_I]]
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__REINT_798:%.*]] = alloca <8 x bfloat>, align 8
// CHECK-NEXT:    [[__REINT1_798:%.*]] = alloca <2 x float>, align 8
// CHECK-NEXT:    store <8 x bfloat> [[B:%.*]], ptr [[__REINT_798]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load <4 x float>, ptr [[__REINT_798]], align 8
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x float> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <16 x i8> [[TMP2]] to <4 x float>
...
// CHECK-NEXT:    [[__REINT1_792:%.*]] = alloca <4 x float>, align 8
...
// CHECK-NEXT:    store <4 x float> [[LANE]], ptr [[__REINT1_792]], align 8
// CHECK-NEXT:    [[TMP4:%.*]] = load <8 x bfloat>, ptr [[__REINT1_792]], align 8
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <4 x float> [[R:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <8 x bfloat> [[A:%.*]] to <16 x b8>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <8 x bfloat> [[TMP4]] to <16 x b8>
// CHECK-NEXT:    [[VBFDOT3_I:%.*]] = call <4 x float> @llvm.arm.neon.bfdot.v4f32.v8bf16(<4 x float> [[R]], <8 x bfloat> [[A]], <8 x bfloat> [[TMP4]])
