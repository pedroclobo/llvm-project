...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__S2_794:%.*]] = alloca <4 x bfloat>, align 8
// CHECK-NEXT:    [[REF_TMP:%.*]] = alloca <2 x float>, align 8
// CHECK-NEXT:    store <4 x bfloat> [[B:%.*]], ptr [[__S2_794]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load <2 x float>, ptr [[__S2_794]], align 8
...
// CHECK-NEXT:    store <2 x float> [[LANE]], ptr [[REF_TMP]], align 8
// CHECK-NEXT:    [[TMP4:%.*]] = load <4 x bfloat>, ptr [[REF_TMP]], align 8
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__S2_796:%.*]] = alloca <8 x bfloat>, align 8
// CHECK-NEXT:    [[REF_TMP:%.*]] = alloca <4 x float>, align 8
// CHECK-NEXT:    store <8 x bfloat> [[B:%.*]], ptr [[__S2_796]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load <4 x float>, ptr [[__S2_796]], align 8
...
// CHECK-NEXT:    store <4 x float> [[LANE]], ptr [[REF_TMP]], align 8
// CHECK-NEXT:    [[TMP4:%.*]] = load <8 x bfloat>, ptr [[REF_TMP]], align 8
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__S2_798:%.*]] = alloca <8 x bfloat>, align 8
// CHECK-NEXT:    [[REF_TMP:%.*]] = alloca <2 x float>, align 8
// CHECK-NEXT:    store <8 x bfloat> [[B:%.*]], ptr [[__S2_798]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load <4 x float>, ptr [[__S2_798]], align 8
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x float> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <16 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <16 x i8> [[TMP2]] to <4 x float>
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__S2_792:%.*]] = alloca <4 x bfloat>, align 8
// CHECK-NEXT:    [[REF_TMP:%.*]] = alloca <4 x float>, align 8
// CHECK-NEXT:    store <4 x bfloat> [[B:%.*]], ptr [[__S2_792]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load <2 x float>, ptr [[__S2_792]], align 8
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x float> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <8 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <8 x i8> [[TMP2]] to <2 x float>
...
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <16 x b8> [[VBFMMLAQ_F324_I]] to <4 x b32>
...
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <16 x b8> [[VBFMLALBQ_F324_I]] to <4 x b32>
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <4 x b32> [[TMP3]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP4]]
//
...
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <16 x b8> [[VBFMLALTQ_F324_I]] to <4 x b32>
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <4 x b32> [[TMP3]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP4]]
//
