...
// CHECK-NEXT:    [[VBFDOT_I:%.*]] = bytecast <8 x b8> [[TMP3]] to <2 x float>
// CHECK-NEXT:    [[VBFDOT1_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <4 x bfloat>
// CHECK-NEXT:    [[VBFDOT2_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <4 x bfloat>
...
// CHECK-NEXT:    [[VBFDOT_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <4 x float>
// CHECK-NEXT:    [[VBFDOT1_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <8 x bfloat>
// CHECK-NEXT:    [[VBFDOT2_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <8 x bfloat>
...
// CHECK-NEXT:    [[VBFDOT_I:%.*]] = bytecast <8 x b8> [[TMP11]] to <2 x float>
// CHECK-NEXT:    [[VBFDOT1_I:%.*]] = bytecast <8 x b8> [[TMP12]] to <4 x bfloat>
// CHECK-NEXT:    [[VBFDOT2_I:%.*]] = bytecast <8 x b8> [[TMP13]] to <4 x bfloat>
// CHECK-NEXT:    [[VBFDOT3_I:%.*]] = call <2 x float> @llvm.arm.neon.bfdot.v2f32.v4bf16(<2 x float> [[VBFDOT_I]], <4 x bfloat> [[VBFDOT1_I]], <4 x bfloat> [[VBFDOT2_I]])
// CHECK-NEXT:    ret <2 x float> [[VBFDOT3_I]]
//
...
// CHECK-NEXT:    [[VBFDOT_I:%.*]] = bytecast <16 x b8> [[TMP11]] to <4 x float>
// CHECK-NEXT:    [[VBFDOT1_I:%.*]] = bytecast <16 x b8> [[TMP12]] to <8 x bfloat>
// CHECK-NEXT:    [[VBFDOT2_I:%.*]] = bytecast <16 x b8> [[TMP13]] to <8 x bfloat>
// CHECK-NEXT:    [[VBFDOT3_I:%.*]] = call <4 x float> @llvm.arm.neon.bfdot.v4f32.v8bf16(<4 x float> [[VBFDOT_I]], <8 x bfloat> [[VBFDOT1_I]], <8 x bfloat> [[VBFDOT2_I]])
// CHECK-NEXT:    ret <4 x float> [[VBFDOT3_I]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <8 x i16> [[TMP1]] to <16 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <8 x i16> [[TMP2]] to <16 x b8>
// CHECK-NEXT:    [[VBFMMLAQ_F32_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <4 x float>
// CHECK-NEXT:    [[VBFMMLAQ_F321_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <8 x bfloat>
// CHECK-NEXT:    [[VBFMMLAQ_F322_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <8 x bfloat>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VBFMMLAQ_F324_I]] to <4 x i32>
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <8 x i16> [[TMP1]] to <16 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <8 x i16> [[TMP2]] to <16 x b8>
// CHECK-NEXT:    [[VBFMLALBQ_F32_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <4 x float>
// CHECK-NEXT:    [[VBFMLALBQ_F321_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <8 x bfloat>
// CHECK-NEXT:    [[VBFMLALBQ_F322_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <8 x bfloat>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VBFMLALBQ_F324_I]] to <4 x i32>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <4 x i32> [[TMP6]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP7]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <8 x i16> [[TMP1]] to <16 x b8>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <8 x i16> [[TMP2]] to <16 x b8>
// CHECK-NEXT:    [[VBFMLALTQ_F32_I:%.*]] = bytecast <16 x b8> [[TMP3]] to <4 x float>
// CHECK-NEXT:    [[VBFMLALTQ_F321_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <8 x bfloat>
// CHECK-NEXT:    [[VBFMLALTQ_F322_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <8 x bfloat>
...
// CHECK-NEXT:    [[TMP6:%.*]] = bytecast <16 x b8> [[VBFMLALTQ_F324_I]] to <4 x i32>
// CHECK-NEXT:    [[TMP7:%.*]] = bitcast <4 x i32> [[TMP6]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP7]]
//
