...
// CHECK-LABEL: @test_s8(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[X:%.*]] to <16 x i8>
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[X:%.*]] to <16 x i8>
// CHECK-LE-NEXT: [[TMP1:%.*]] = bitcast <16 x i8> [[TMP0]] to <8 x i16>
// CHECK-BE-NEXT: [[TMP1:%.*]] = call <8 x i16> @llvm.arm.mve.vreinterpretq.v8i16.v16i8(<16 x i8> [[TMP0]])
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[X:%.*]] to <16 x i8>
// CHECK-LE-NEXT: [[TMP1:%.*]] = bitcast <16 x i8> [[TMP0]] to <4 x i32>
// CHECK-BE-NEXT: [[TMP1:%.*]] = call <4 x i32> @llvm.arm.mve.vreinterpretq.v4i32.v16i8(<16 x i8> [[TMP0]])
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[X:%.*]] to <16 x i8>
// CHECK-LE-NEXT: [[TMP1:%.*]] = bitcast <16 x i8> [[TMP0]] to <2 x i64>
// CHECK-BE-NEXT: [[TMP1:%.*]] = call <2 x i64> @llvm.arm.mve.vreinterpretq.v2i64.v16i8(<16 x i8> [[TMP0]])
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[X:%.*]] to <16 x i8>
// CHECK-LE-NEXT: [[TMP1:%.*]] = bitcast <16 x i8> [[TMP0]] to <8 x half>
// CHECK-BE-NEXT: [[TMP1:%.*]] = call <8 x half> @llvm.arm.mve.vreinterpretq.v8f16.v16i8(<16 x i8> [[TMP0]])
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[X:%.*]] to <16 x i8>
// CHECK-LE-NEXT: [[TMP1:%.*]] = bitcast <16 x i8> [[TMP0]] to <4 x float>
// CHECK-BE-NEXT: [[TMP1:%.*]] = call <4 x float> @llvm.arm.mve.vreinterpretq.v4f32.v16i8(<16 x i8> [[TMP0]])
