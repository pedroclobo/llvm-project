...
// CHECK-C-NEXT:    [[VECINS:%.*]] = insertelement <16 x i8> [[TMP2]], i8 [[TMP0]], i32 [[TMP1]]
// CHECK-C-NEXT:    store <16 x i8> [[VECINS]], ptr [[X_ADDR]], align 16
// CHECK-C-NEXT:    [[TMP3:%.*]] = load <16 x i8>, ptr [[X_ADDR]], align 16
// CHECK-C-NEXT:    ret <16 x i8> [[TMP3]]
//
...
// CHECK-CXX-NEXT:    [[VECINS:%.*]] = insertelement <16 x i8> [[TMP2]], i8 [[TMP0]], i32 [[TMP1]]
// CHECK-CXX-NEXT:    store <16 x i8> [[VECINS]], ptr [[X_ADDR]], align 16
// CHECK-CXX-NEXT:    [[TMP3:%.*]] = load <16 x i8>, ptr [[X_ADDR]], align 16
// CHECK-CXX-NEXT:    ret <16 x i8> [[TMP3]]
//
