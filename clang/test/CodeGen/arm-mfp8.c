...
// CHECK-C-NEXT:    [[I_ADDR:%.*]] = alloca i32, align 4
// CHECK-C-NEXT:    [[V_ADDR:%.*]] = alloca <1 x i8>, align 1
// CHECK-C-NEXT:    store <16 x i8> [[X]], ptr [[X_ADDR]], align 16
// CHECK-C-NEXT:    store i32 [[I]], ptr [[I_ADDR]], align 4
// CHECK-C-NEXT:    store <1 x i8> [[V]], ptr [[V_ADDR]], align 1
// CHECK-C-NEXT:    [[TMP0:%.*]] = load <1 x i8>, ptr [[V_ADDR]], align 1
// CHECK-C-NEXT:    [[TMP1:%.*]] = load i32, ptr [[I_ADDR]], align 4
// CHECK-C-NEXT:    [[TMP2:%.*]] = load <16 x i8>, ptr [[X_ADDR]], align 16
// CHECK-C-NEXT:    [[TMP3:%.*]] = bitcast <1 x i8> [[TMP0]] to i8
// CHECK-C-NEXT:    [[VECINS:%.*]] = insertelement <16 x i8> [[TMP2]], i8 [[TMP3]], i32 [[TMP1]]
// CHECK-C-NEXT:    store <16 x i8> [[VECINS]], ptr [[X_ADDR]], align 16
// CHECK-C-NEXT:    [[TMP4:%.*]] = load <16 x i8>, ptr [[X_ADDR]], align 16
...
// CHECK-CXX-NEXT:  [[ENTRY:.*:]]
// CHECK-CXX-NEXT:    [[X_ADDR:%.*]] = alloca <16 x i8>, align 16
// CHECK-CXX-NEXT:    [[I_ADDR:%.*]] = alloca i32, align 4
// CHECK-CXX-NEXT:    [[V_ADDR:%.*]] = alloca <1 x i8>, align 1
// CHECK-CXX-NEXT:    store <16 x i8> [[X]], ptr [[X_ADDR]], align 16
// CHECK-CXX-NEXT:    store i32 [[I]], ptr [[I_ADDR]], align 4
// CHECK-CXX-NEXT:    store <1 x i8> [[V]], ptr [[V_ADDR]], align 1
// CHECK-CXX-NEXT:    [[TMP0:%.*]] = load <1 x i8>, ptr [[V_ADDR]], align 1
// CHECK-CXX-NEXT:    [[TMP1:%.*]] = load i32, ptr [[I_ADDR]], align 4
// CHECK-CXX-NEXT:    [[TMP2:%.*]] = load <16 x i8>, ptr [[X_ADDR]], align 16
// CHECK-CXX-NEXT:    [[TMP3:%.*]] = bitcast <1 x i8> [[TMP0]] to i8
// CHECK-CXX-NEXT:    [[VECINS:%.*]] = insertelement <16 x i8> [[TMP2]], i8 [[TMP3]], i32 [[TMP1]]
// CHECK-CXX-NEXT:    store <16 x i8> [[VECINS]], ptr [[X_ADDR]], align 16
// CHECK-CXX-NEXT:    [[TMP4:%.*]] = load <16 x i8>, ptr [[X_ADDR]], align 16
// CHECK-CXX-NEXT:    ret <16 x i8> [[TMP4]]
//
