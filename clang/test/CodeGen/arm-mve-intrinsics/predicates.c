...
// CHECK-NEXT:    [[TMP0:%.*]] = zext i16 [[P:%.*]] to i32
// CHECK-NEXT:    [[TMP1:%.*]] = call <16 x i1> @llvm.arm.mve.pred.i2v.v16i1(i32 [[TMP0]])
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[A:%.*]] to <16 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <16 x b8> [[B:%.*]] to <16 x i8>
// CHECK-NEXT:    [[TMP4:%.*]] = select <16 x i1> [[TMP1]], <16 x i8> [[TMP2]], <16 x i8> [[TMP3]]
