...
// CHECK-NEXT:    [[TMP2:%.*]] = and <16 x i8> [[TMP0]], [[TMP1]]
...
// CHECK-NEXT:    [[TMP5:%.*]] = call <16 x i8> @llvm.arm.mve.and.predicated.v16i8.v16i1(<16 x i8> [[TMP0]], <16 x i8> [[TMP1]], <16 x i1> [[TMP3]], <16 x i8> [[TMP4]])
...
// CHECK-NEXT:    [[TMP2:%.*]] = zext i16 [[P:%.*]] to i32
// CHECK-NEXT:    [[TMP3:%.*]] = call <16 x i1> @llvm.arm.mve.pred.i2v.v16i1(i32 [[TMP2]])
// CHECK-NEXT:    [[TMP4:%.*]] = call <16 x i8> @llvm.arm.mve.and.predicated.v16i8.v16i1(<16 x i8> [[TMP0]], <16 x i8> [[TMP1]], <16 x i1> [[TMP3]], <16 x i8> undef)
