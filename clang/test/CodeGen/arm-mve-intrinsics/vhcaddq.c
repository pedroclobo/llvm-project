...
// CHECK-NEXT:    [[TMP2:%.*]] = call <16 x i8> @llvm.arm.mve.vcaddq.v16i8(i32 0, i32 0, <16 x i8> [[TMP0]], <16 x i8> [[TMP1]])
...
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact <16 x b8> [[A:%.*]] to <16 x i8>
// CHECK-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[B:%.*]] to <16 x i8>
// CHECK-NEXT:    [[TMP2:%.*]] = call <16 x i8> @llvm.arm.mve.vcaddq.v16i8(i32 0, i32 1, <16 x i8> [[TMP0]], <16 x i8> [[TMP1]])
// CHECK-NEXT:    store <16 x i8> [[TMP2]], ptr [[RETVAL]], align 8
// CHECK-NEXT:    [[TMP3:%.*]] = load <16 x b8>, ptr [[RETVAL]], align 8
// CHECK-NEXT:    ret <16 x b8> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = call <16 x i8> @llvm.arm.mve.vcaddq.predicated.v16i8.v16i1(i32 0, i32 0, <16 x i8> undef, <16 x i8> [[TMP0]], <16 x i8> [[TMP1]], <16 x i1> [[TMP3]])
...
// CHECK-NEXT:    [[TMP2:%.*]] = zext i16 [[P:%.*]] to i32
// CHECK-NEXT:    [[TMP3:%.*]] = call <16 x i1> @llvm.arm.mve.pred.i2v.v16i1(i32 [[TMP2]])
// CHECK-NEXT:    [[TMP4:%.*]] = call <16 x i8> @llvm.arm.mve.vcaddq.predicated.v16i8.v16i1(i32 0, i32 1, <16 x i8> undef, <16 x i8> [[TMP0]], <16 x i8> [[TMP1]], <16 x i1> [[TMP3]])
// CHECK-NEXT:    store <16 x i8> [[TMP4]], ptr [[RETVAL]], align 8
// CHECK-NEXT:    [[TMP5:%.*]] = load <16 x b8>, ptr [[RETVAL]], align 8
// CHECK-NEXT:    ret <16 x b8> [[TMP5]]
//
...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[B:%.*]] to <16 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = zext i16 [[P:%.*]] to i32
// CHECK-NEXT:    [[TMP4:%.*]] = call <16 x i1> @llvm.arm.mve.pred.i2v.v16i1(i32 [[TMP3]])
// CHECK-NEXT:    [[TMP5:%.*]] = call <16 x i8> @llvm.arm.mve.vcaddq.predicated.v16i8.v16i1(i32 0, i32 0, <16 x i8> [[TMP0]], <16 x i8> [[TMP1]], <16 x i8> [[TMP2]], <16 x i1> [[TMP4]])
...
// CHECK-NEXT:    [[TMP3:%.*]] = zext i16 [[P:%.*]] to i32
// CHECK-NEXT:    [[TMP4:%.*]] = call <16 x i1> @llvm.arm.mve.pred.i2v.v16i1(i32 [[TMP3]])
// CHECK-NEXT:    [[TMP5:%.*]] = call <16 x i8> @llvm.arm.mve.vcaddq.predicated.v16i8.v16i1(i32 0, i32 1, <16 x i8> [[TMP0]], <16 x i8> [[TMP1]], <16 x i8> [[TMP2]], <16 x i1> [[TMP4]])
// CHECK-NEXT:    store <16 x i8> [[TMP5]], ptr [[RETVAL]], align 8
// CHECK-NEXT:    [[TMP6:%.*]] = load <16 x b8>, ptr [[RETVAL]], align 8
// CHECK-NEXT:    ret <16 x b8> [[TMP6]]
//
