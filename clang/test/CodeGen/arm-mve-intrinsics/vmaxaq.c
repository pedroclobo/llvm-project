...
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast <16 x b8> [[A:%.*]] to <16 x i8>
// CHECK-NEXT:    [[TMP4:%.*]] = icmp uge <16 x i8> [[TMP3]], [[TMP2]]
// CHECK-NEXT:    [[TMP5:%.*]] = select <16 x i1> [[TMP4]], <16 x i8> [[TMP3]], <16 x i8> [[TMP2]]
...
// CHECK-NEXT:    [[TMP3:%.*]] = call <16 x i8> @llvm.arm.mve.vmaxa.predicated.v16i8.v16i1(<16 x i8> [[TMP0]], <16 x i8> [[B:%.*]], <16 x i1> [[TMP2]])
