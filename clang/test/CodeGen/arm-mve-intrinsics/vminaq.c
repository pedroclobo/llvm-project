...
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <16 x b8> [[A:%.*]] to <16 x i8>
// CHECK-NEXT:    [[TMP5:%.*]] = icmp ule <16 x i8> [[TMP4]], [[TMP3]]
...
// CHECK-NEXT:    [[TMP4:%.*]] = call <16 x i8> @llvm.arm.mve.vmina.predicated.v16i8.v16i1(<16 x i8> [[TMP0]], <16 x i8> [[TMP1]], <16 x i1> [[TMP3]])
