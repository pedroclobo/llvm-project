...
// CHECK-NEXT:    [[TMP2:%.*]] = call <8 x i16> @llvm.arm.mve.vmull.v8i16.v16i8(<16 x i8> [[TMP0]], <16 x i8> [[TMP1]], i32 1, i32 0)
...
// CHECK-NEXT:    [[TMP4:%.*]] = call <8 x i16> @llvm.arm.mve.mull.int.predicated.v8i16.v16i8.v8i1(<16 x i8> [[TMP0]], <16 x i8> [[TMP1]], i32 0, i32 0, <8 x i1> [[TMP3]], <8 x i16> [[INACTIVE:%.*]])
...
// CHECK-NEXT:    [[TMP2:%.*]] = zext i16 [[P:%.*]] to i32
// CHECK-NEXT:    [[TMP3:%.*]] = call <8 x i1> @llvm.arm.mve.pred.i2v.v8i1(i32 [[TMP2]])
// CHECK-NEXT:    [[TMP4:%.*]] = call <8 x i16> @llvm.arm.mve.mull.poly.predicated.v8i16.v16i8.v8i1(<16 x i8> [[TMP0]], <16 x i8> [[TMP1]], i32 0, <8 x i1> [[TMP3]], <8 x i16> [[INACTIVE:%.*]])
// CHECK-NEXT:    ret <8 x i16> [[TMP4]]
//
...
// CHECK-NEXT:    [[TMP2:%.*]] = zext i16 [[P:%.*]] to i32
// CHECK-NEXT:    [[TMP3:%.*]] = call <8 x i1> @llvm.arm.mve.pred.i2v.v8i1(i32 [[TMP2]])
// CHECK-NEXT:    [[TMP4:%.*]] = call <8 x i16> @llvm.arm.mve.mull.int.predicated.v8i16.v16i8.v8i1(<16 x i8> [[TMP0]], <16 x i8> [[TMP1]], i32 1, i32 0, <8 x i1> [[TMP3]], <8 x i16> undef)
// CHECK-NEXT:    ret <8 x i16> [[TMP4]]
//
