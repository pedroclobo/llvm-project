...
// CHECK-A32-NEXT:    [[VRNDA_V_I:%.*]] = bytecast <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-A32-NEXT:    [[TMP2:%.*]] = bytecast <8 x b8> [[VRNDA_V2_I]] to <2 x i32>
...
// CHECK-A64-NEXT:    [[VRNDA_I:%.*]] = bytecast <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-A32-NEXT:    [[VRNDAQ_V_I:%.*]] = bytecast <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-A32-NEXT:    [[TMP2:%.*]] = bytecast <16 x b8> [[VRNDAQ_V2_I]] to <4 x i32>
...
// CHECK-A64-NEXT:    [[VRNDA_I:%.*]] = bytecast <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-A32-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-A32-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-A32-NEXT:    [[VRNDM_V_I:%.*]] = bytecast <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-A32-NEXT:    [[TMP2:%.*]] = bytecast <8 x b8> [[VRNDM_V2_I]] to <2 x i32>
// CHECK-A32-NEXT:    [[TMP3:%.*]] = bitcast <2 x i32> [[TMP2]] to <2 x float>
// CHECK-A32-NEXT:    ret <2 x float> [[TMP3]]
//
...
// CHECK-A64-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-A64-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-A64-NEXT:    [[VRNDM_I:%.*]] = bytecast <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-A32-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-A32-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-A32-NEXT:    [[VRNDMQ_V_I:%.*]] = bytecast <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-A32-NEXT:    [[TMP2:%.*]] = bytecast <16 x b8> [[VRNDMQ_V2_I]] to <4 x i32>
// CHECK-A32-NEXT:    [[TMP3:%.*]] = bitcast <4 x i32> [[TMP2]] to <4 x float>
// CHECK-A32-NEXT:    ret <4 x float> [[TMP3]]
//
...
// CHECK-A64-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-A64-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-A64-NEXT:    [[VRNDM_I:%.*]] = bytecast <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-A32-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-A32-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-A32-NEXT:    [[VRNDN_V_I:%.*]] = bytecast <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-A32-NEXT:    [[TMP2:%.*]] = bytecast <8 x b8> [[VRNDN_V2_I]] to <2 x i32>
// CHECK-A32-NEXT:    [[TMP3:%.*]] = bitcast <2 x i32> [[TMP2]] to <2 x float>
// CHECK-A32-NEXT:    ret <2 x float> [[TMP3]]
//
...
// CHECK-A64-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-A64-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-A64-NEXT:    [[VRNDN_I:%.*]] = bytecast <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-A32-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-A32-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-A32-NEXT:    [[VRNDNQ_V_I:%.*]] = bytecast <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-A32-NEXT:    [[TMP2:%.*]] = bytecast <16 x b8> [[VRNDNQ_V2_I]] to <4 x i32>
// CHECK-A32-NEXT:    [[TMP3:%.*]] = bitcast <4 x i32> [[TMP2]] to <4 x float>
// CHECK-A32-NEXT:    ret <4 x float> [[TMP3]]
//
...
// CHECK-A64-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-A64-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-A64-NEXT:    [[VRNDN_I:%.*]] = bytecast <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-A32-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-A32-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-A32-NEXT:    [[VRNDP_V_I:%.*]] = bytecast <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-A32-NEXT:    [[TMP2:%.*]] = bytecast <8 x b8> [[VRNDP_V2_I]] to <2 x i32>
// CHECK-A32-NEXT:    [[TMP3:%.*]] = bitcast <2 x i32> [[TMP2]] to <2 x float>
// CHECK-A32-NEXT:    ret <2 x float> [[TMP3]]
//
...
// CHECK-A64-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-A64-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-A64-NEXT:    [[VRNDP_I:%.*]] = bytecast <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-A32-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-A32-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-A32-NEXT:    [[VRNDPQ_V_I:%.*]] = bytecast <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-A32-NEXT:    [[TMP2:%.*]] = bytecast <16 x b8> [[VRNDPQ_V2_I]] to <4 x i32>
// CHECK-A32-NEXT:    [[TMP3:%.*]] = bitcast <4 x i32> [[TMP2]] to <4 x float>
// CHECK-A32-NEXT:    ret <4 x float> [[TMP3]]
//
...
// CHECK-A64-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-A64-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-A64-NEXT:    [[VRNDP_I:%.*]] = bytecast <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-A32-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-A32-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-A32-NEXT:    [[VRNDX_V_I:%.*]] = bytecast <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-A32-NEXT:    [[TMP2:%.*]] = bytecast <8 x b8> [[VRNDX_V2_I]] to <2 x i32>
// CHECK-A32-NEXT:    [[TMP3:%.*]] = bitcast <2 x i32> [[TMP2]] to <2 x float>
// CHECK-A32-NEXT:    ret <2 x float> [[TMP3]]
//
...
// CHECK-A64-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-A64-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-A64-NEXT:    [[VRNDX_I:%.*]] = bytecast <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-A32-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-A32-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-A32-NEXT:    [[VRNDXQ_V_I:%.*]] = bytecast <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-A32-NEXT:    [[TMP2:%.*]] = bytecast <16 x b8> [[VRNDXQ_V2_I]] to <4 x i32>
// CHECK-A32-NEXT:    [[TMP3:%.*]] = bitcast <4 x i32> [[TMP2]] to <4 x float>
// CHECK-A32-NEXT:    ret <4 x float> [[TMP3]]
//
...
// CHECK-A64-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-A64-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-A64-NEXT:    [[VRNDX_I:%.*]] = bytecast <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-A32-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-A32-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-A32-NEXT:    [[VRND_V_I:%.*]] = bytecast <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-A32-NEXT:    [[TMP2:%.*]] = bytecast <8 x b8> [[VRND_V2_I]] to <2 x i32>
// CHECK-A32-NEXT:    [[TMP3:%.*]] = bitcast <2 x i32> [[TMP2]] to <2 x float>
// CHECK-A32-NEXT:    ret <2 x float> [[TMP3]]
//
...
// CHECK-A64-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-A64-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-A64-NEXT:    [[VRNDZ_I:%.*]] = bytecast <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-A32-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-A32-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-A32-NEXT:    [[VRNDQ_V_I:%.*]] = bytecast <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-A32-NEXT:    [[TMP2:%.*]] = bytecast <16 x b8> [[VRNDQ_V2_I]] to <4 x i32>
// CHECK-A32-NEXT:    [[TMP3:%.*]] = bitcast <4 x i32> [[TMP2]] to <4 x float>
// CHECK-A32-NEXT:    ret <4 x float> [[TMP3]]
//
...
// CHECK-A64-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-A64-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-A64-NEXT:    [[VRNDZ_I:%.*]] = bytecast <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-NEXT:    [[VRNDI_V_I:%.*]] = bytecast <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-NEXT:    [[VRNDIQ_V_I:%.*]] = bytecast <16 x b8> [[TMP1]] to <4 x float>
