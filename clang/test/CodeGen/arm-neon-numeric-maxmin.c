...
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x b8> [[VMAXNM_V3_I]] to <2 x b32>
...
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x b8> [[VMAXNMQ_V3_I]] to <4 x b32>
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <4 x b32> [[TMP2]] to <4 x float>
...
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <8 x b8> [[VMINNM_V3_I]] to <2 x b32>
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <2 x b32> [[TMP2]] to <2 x float>
// CHECK-NEXT:    ret <2 x float> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <16 x b8> [[VMINNMQ_V3_I]] to <4 x b32>
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <4 x b32> [[TMP2]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP3]]
//
