...
// CHECK-NEXT:    [[VMAXNM_V_I:%.*]] = bytecast exact <8 x b8> [[TMP2]] to <2 x float>
// CHECK-NEXT:    [[VMAXNM_V1_I:%.*]] = bytecast exact <8 x b8> [[TMP3]] to <2 x float>
...
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b8> [[VMAXNM_V3_I]] to <2 x i32>
...
// CHECK-NEXT:    [[VMAXNMQ_V_I:%.*]] = bytecast exact <16 x b8> [[TMP2]] to <4 x float>
// CHECK-NEXT:    [[VMAXNMQ_V1_I:%.*]] = bytecast exact <16 x b8> [[TMP3]] to <4 x float>
...
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <16 x b8> [[VMAXNMQ_V3_I]] to <4 x i32>
...
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <2 x i32> [[TMP1]] to <8 x b8>
// CHECK-NEXT:    [[VMINNM_V_I:%.*]] = bytecast exact <8 x b8> [[TMP2]] to <2 x float>
// CHECK-NEXT:    [[VMINNM_V1_I:%.*]] = bytecast exact <8 x b8> [[TMP3]] to <2 x float>
...
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b8> [[VMINNM_V3_I]] to <2 x i32>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <2 x i32> [[TMP4]] to <2 x float>
// CHECK-NEXT:    ret <2 x float> [[TMP5]]
//
...
// CHECK-NEXT:    [[TMP2:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <4 x i32> [[TMP1]] to <16 x b8>
// CHECK-NEXT:    [[VMINNMQ_V_I:%.*]] = bytecast exact <16 x b8> [[TMP2]] to <4 x float>
// CHECK-NEXT:    [[VMINNMQ_V1_I:%.*]] = bytecast exact <16 x b8> [[TMP3]] to <4 x float>
...
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <16 x b8> [[VMINNMQ_V3_I]] to <4 x i32>
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <4 x i32> [[TMP4]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP5]]
//
