...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[VMAXNM_V3_I]] to <8 x i8>
...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[VMAXNMQ_V3_I]] to <16 x i8>
...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <8 x b8> [[VMINNM_V3_I]] to <8 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <8 x i8> [[TMP2]] to <2 x float>
// CHECK-NEXT:    ret <2 x float> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <16 x b8> [[VMINNMQ_V3_I]] to <16 x i8>
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <16 x i8> [[TMP2]] to <4 x float>
// CHECK-NEXT:    ret <4 x float> [[TMP3]]
//
