...
// CHECK-NEXT:    [[VCVTA_S32_V_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VCVTA_U32_V_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-NEXT:    [[VCVTAQ_S32_V_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTAQ_U32_V_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VCVTN_S32_V_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VCVTN_U32_V_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTNQ_S32_V_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTNQ_U32_V_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VCVTP_S32_V_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VCVTP_U32_V_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTPQ_S32_V_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTPQ_U32_V_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VCVTM_S32_V_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <2 x float> [[A]] to <2 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[TMP0]] to <8 x b8>
// CHECK-NEXT:    [[VCVTM_U32_V_I:%.*]] = bytecast exact <8 x b8> [[TMP1]] to <2 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTMQ_S32_V_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x float> [[A]] to <4 x i32>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <4 x i32> [[TMP0]] to <16 x b8>
// CHECK-NEXT:    [[VCVTMQ_U32_V_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <4 x float>
