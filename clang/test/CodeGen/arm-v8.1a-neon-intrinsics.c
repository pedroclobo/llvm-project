...
// CHECK-ARM-NEXT:    [[TMP0:%.*]] = bitcast <8 x b8> [[VQRDMLAH_S164_I]] to <4 x b16>
// CHECK-ARM-NEXT:    [[TMP1:%.*]] = bytecast exact <4 x b16> [[TMP0]] to <4 x i16>
// CHECK-ARM-NEXT:    ret <4 x i16> [[TMP1]]
//
...
// CHECK-AARCH64-NEXT:    [[TMP0:%.*]] = bitcast <8 x b8> [[VQRDMLAH_S164_I]] to <4 x b16>
// CHECK-AARCH64-NEXT:    [[TMP1:%.*]] = bytecast exact <4 x b16> [[TMP0]] to <4 x i16>
// CHECK-AARCH64-NEXT:    ret <4 x i16> [[TMP1]]
//
...
// CHECK-ARM-NEXT:    [[TMP0:%.*]] = bitcast <8 x b8> [[VQRDMLAH_S324_I]] to <2 x b32>
// CHECK-ARM-NEXT:    [[TMP1:%.*]] = bytecast exact <2 x b32> [[TMP0]] to <2 x i32>
// CHECK-ARM-NEXT:    ret <2 x i32> [[TMP1]]
//
...
// CHECK-AARCH64-NEXT:    [[TMP0:%.*]] = bitcast <8 x b8> [[VQRDMLAH_S324_I]] to <2 x b32>
// CHECK-AARCH64-NEXT:    [[TMP1:%.*]] = bytecast exact <2 x b32> [[TMP0]] to <2 x i32>
// CHECK-AARCH64-NEXT:    ret <2 x i32> [[TMP1]]
//
...
// CHECK-ARM-NEXT:    [[TMP0:%.*]] = bitcast <16 x b8> [[VQRDMLAHQ_S164_I]] to <8 x b16>
// CHECK-ARM-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b16> [[TMP0]] to <8 x i16>
// CHECK-ARM-NEXT:    ret <8 x i16> [[TMP1]]
//
...
// CHECK-AARCH64-NEXT:    [[TMP0:%.*]] = bitcast <16 x b8> [[VQRDMLAHQ_S164_I]] to <8 x b16>
// CHECK-AARCH64-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b16> [[TMP0]] to <8 x i16>
// CHECK-AARCH64-NEXT:    ret <8 x i16> [[TMP1]]
//
...
// CHECK-ARM-NEXT:    [[TMP0:%.*]] = bitcast <16 x b8> [[VQRDMLAHQ_S324_I]] to <4 x b32>
// CHECK-ARM-NEXT:    [[TMP1:%.*]] = bytecast exact <4 x b32> [[TMP0]] to <4 x i32>
// CHECK-ARM-NEXT:    ret <4 x i32> [[TMP1]]
//
...
// CHECK-AARCH64-NEXT:    [[TMP0:%.*]] = bitcast <16 x b8> [[VQRDMLAHQ_S324_I]] to <4 x b32>
// CHECK-AARCH64-NEXT:    [[TMP1:%.*]] = bytecast exact <4 x b32> [[TMP0]] to <4 x i32>
// CHECK-AARCH64-NEXT:    ret <4 x i32> [[TMP1]]
//
...
// CHECK-ARM-NEXT:    [[VQRDMLAH_S164_I:%.*]] = bitcast <4 x i16> [[VQRDMLAH_S163_I]] to <8 x b8>
// CHECK-ARM-NEXT:    [[TMP3:%.*]] = bitcast <8 x b8> [[VQRDMLAH_S164_I]] to <4 x b16>
// CHECK-ARM-NEXT:    [[TMP4:%.*]] = bytecast exact <4 x b16> [[TMP3]] to <4 x i16>
// CHECK-ARM-NEXT:    ret <4 x i16> [[TMP4]]
//
...
// CHECK-AARCH64-NEXT:    [[VQRDMLAH_S164_I:%.*]] = bitcast <4 x i16> [[VQRDMLAH_S163_I]] to <8 x b8>
// CHECK-AARCH64-NEXT:    [[TMP3:%.*]] = bitcast <8 x b8> [[VQRDMLAH_S164_I]] to <4 x b16>
// CHECK-AARCH64-NEXT:    [[TMP4:%.*]] = bytecast exact <4 x b16> [[TMP3]] to <4 x i16>
// CHECK-AARCH64-NEXT:    ret <4 x i16> [[TMP4]]
//
...
// CHECK-ARM-NEXT:    [[VQRDMLAH_S324_I:%.*]] = bitcast <2 x i32> [[VQRDMLAH_S323_I]] to <8 x b8>
// CHECK-ARM-NEXT:    [[TMP3:%.*]] = bitcast <8 x b8> [[VQRDMLAH_S324_I]] to <2 x b32>
// CHECK-ARM-NEXT:    [[TMP4:%.*]] = bytecast exact <2 x b32> [[TMP3]] to <2 x i32>
// CHECK-ARM-NEXT:    ret <2 x i32> [[TMP4]]
//
...
// CHECK-AARCH64-NEXT:    [[VQRDMLAH_S324_I:%.*]] = bitcast <2 x i32> [[VQRDMLAH_S323_I]] to <8 x b8>
// CHECK-AARCH64-NEXT:    [[TMP3:%.*]] = bitcast <8 x b8> [[VQRDMLAH_S324_I]] to <2 x b32>
// CHECK-AARCH64-NEXT:    [[TMP4:%.*]] = bytecast exact <2 x b32> [[TMP3]] to <2 x i32>
// CHECK-AARCH64-NEXT:    ret <2 x i32> [[TMP4]]
//
...
// CHECK-ARM-NEXT:    [[VQRDMLAHQ_S164_I:%.*]] = bitcast <8 x i16> [[VQRDMLAHQ_S163_I]] to <16 x b8>
// CHECK-ARM-NEXT:    [[TMP3:%.*]] = bitcast <16 x b8> [[VQRDMLAHQ_S164_I]] to <8 x b16>
// CHECK-ARM-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b16> [[TMP3]] to <8 x i16>
// CHECK-ARM-NEXT:    ret <8 x i16> [[TMP4]]
//
...
// CHECK-AARCH64-NEXT:    [[VQRDMLAHQ_S164_I:%.*]] = bitcast <8 x i16> [[VQRDMLAHQ_S163_I]] to <16 x b8>
// CHECK-AARCH64-NEXT:    [[TMP3:%.*]] = bitcast <16 x b8> [[VQRDMLAHQ_S164_I]] to <8 x b16>
// CHECK-AARCH64-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b16> [[TMP3]] to <8 x i16>
// CHECK-AARCH64-NEXT:    ret <8 x i16> [[TMP4]]
//
...
// CHECK-ARM-NEXT:    [[VQRDMLAHQ_S324_I:%.*]] = bitcast <4 x i32> [[VQRDMLAHQ_S323_I]] to <16 x b8>
// CHECK-ARM-NEXT:    [[TMP3:%.*]] = bitcast <16 x b8> [[VQRDMLAHQ_S324_I]] to <4 x b32>
// CHECK-ARM-NEXT:    [[TMP4:%.*]] = bytecast exact <4 x b32> [[TMP3]] to <4 x i32>
// CHECK-ARM-NEXT:    ret <4 x i32> [[TMP4]]
//
...
// CHECK-AARCH64-NEXT:    [[VQRDMLAHQ_S324_I:%.*]] = bitcast <4 x i32> [[VQRDMLAHQ_S323_I]] to <16 x b8>
// CHECK-AARCH64-NEXT:    [[TMP3:%.*]] = bitcast <16 x b8> [[VQRDMLAHQ_S324_I]] to <4 x b32>
// CHECK-AARCH64-NEXT:    [[TMP4:%.*]] = bytecast exact <4 x b32> [[TMP3]] to <4 x i32>
// CHECK-AARCH64-NEXT:    ret <4 x i32> [[TMP4]]
//
...
// CHECK-ARM-NEXT:    [[TMP0:%.*]] = bitcast <8 x b8> [[VQRDMLSH_S164_I]] to <4 x b16>
// CHECK-ARM-NEXT:    [[TMP1:%.*]] = bytecast exact <4 x b16> [[TMP0]] to <4 x i16>
// CHECK-ARM-NEXT:    ret <4 x i16> [[TMP1]]
//
...
// CHECK-AARCH64-NEXT:    [[TMP0:%.*]] = bitcast <8 x b8> [[VQRDMLSH_S164_I]] to <4 x b16>
// CHECK-AARCH64-NEXT:    [[TMP1:%.*]] = bytecast exact <4 x b16> [[TMP0]] to <4 x i16>
// CHECK-AARCH64-NEXT:    ret <4 x i16> [[TMP1]]
//
...
// CHECK-ARM-NEXT:    [[TMP0:%.*]] = bitcast <8 x b8> [[VQRDMLSH_S324_I]] to <2 x b32>
// CHECK-ARM-NEXT:    [[TMP1:%.*]] = bytecast exact <2 x b32> [[TMP0]] to <2 x i32>
// CHECK-ARM-NEXT:    ret <2 x i32> [[TMP1]]
//
...
// CHECK-AARCH64-NEXT:    [[TMP0:%.*]] = bitcast <8 x b8> [[VQRDMLSH_S324_I]] to <2 x b32>
// CHECK-AARCH64-NEXT:    [[TMP1:%.*]] = bytecast exact <2 x b32> [[TMP0]] to <2 x i32>
// CHECK-AARCH64-NEXT:    ret <2 x i32> [[TMP1]]
//
...
// CHECK-ARM-NEXT:    [[TMP0:%.*]] = bitcast <16 x b8> [[VQRDMLSHQ_S164_I]] to <8 x b16>
// CHECK-ARM-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b16> [[TMP0]] to <8 x i16>
// CHECK-ARM-NEXT:    ret <8 x i16> [[TMP1]]
//
...
// CHECK-AARCH64-NEXT:    [[TMP0:%.*]] = bitcast <16 x b8> [[VQRDMLSHQ_S164_I]] to <8 x b16>
// CHECK-AARCH64-NEXT:    [[TMP1:%.*]] = bytecast exact <8 x b16> [[TMP0]] to <8 x i16>
// CHECK-AARCH64-NEXT:    ret <8 x i16> [[TMP1]]
//
...
// CHECK-ARM-NEXT:    [[TMP0:%.*]] = bitcast <16 x b8> [[VQRDMLSHQ_S324_I]] to <4 x b32>
// CHECK-ARM-NEXT:    [[TMP1:%.*]] = bytecast exact <4 x b32> [[TMP0]] to <4 x i32>
// CHECK-ARM-NEXT:    ret <4 x i32> [[TMP1]]
//
...
// CHECK-AARCH64-NEXT:    [[TMP0:%.*]] = bitcast <16 x b8> [[VQRDMLSHQ_S324_I]] to <4 x b32>
// CHECK-AARCH64-NEXT:    [[TMP1:%.*]] = bytecast exact <4 x b32> [[TMP0]] to <4 x i32>
// CHECK-AARCH64-NEXT:    ret <4 x i32> [[TMP1]]
//
...
// CHECK-ARM-NEXT:    [[VQRDMLSH_S164_I:%.*]] = bitcast <4 x i16> [[VQRDMLSH_S163_I]] to <8 x b8>
// CHECK-ARM-NEXT:    [[TMP3:%.*]] = bitcast <8 x b8> [[VQRDMLSH_S164_I]] to <4 x b16>
// CHECK-ARM-NEXT:    [[TMP4:%.*]] = bytecast exact <4 x b16> [[TMP3]] to <4 x i16>
// CHECK-ARM-NEXT:    ret <4 x i16> [[TMP4]]
//
...
// CHECK-AARCH64-NEXT:    [[VQRDMLSH_S164_I:%.*]] = bitcast <4 x i16> [[VQRDMLSH_S163_I]] to <8 x b8>
// CHECK-AARCH64-NEXT:    [[TMP3:%.*]] = bitcast <8 x b8> [[VQRDMLSH_S164_I]] to <4 x b16>
// CHECK-AARCH64-NEXT:    [[TMP4:%.*]] = bytecast exact <4 x b16> [[TMP3]] to <4 x i16>
// CHECK-AARCH64-NEXT:    ret <4 x i16> [[TMP4]]
//
...
// CHECK-ARM-NEXT:    [[VQRDMLSH_S324_I:%.*]] = bitcast <2 x i32> [[VQRDMLSH_S323_I]] to <8 x b8>
// CHECK-ARM-NEXT:    [[TMP3:%.*]] = bitcast <8 x b8> [[VQRDMLSH_S324_I]] to <2 x b32>
// CHECK-ARM-NEXT:    [[TMP4:%.*]] = bytecast exact <2 x b32> [[TMP3]] to <2 x i32>
// CHECK-ARM-NEXT:    ret <2 x i32> [[TMP4]]
//
...
// CHECK-AARCH64-NEXT:    [[VQRDMLSH_S324_I:%.*]] = bitcast <2 x i32> [[VQRDMLSH_S323_I]] to <8 x b8>
// CHECK-AARCH64-NEXT:    [[TMP3:%.*]] = bitcast <8 x b8> [[VQRDMLSH_S324_I]] to <2 x b32>
// CHECK-AARCH64-NEXT:    [[TMP4:%.*]] = bytecast exact <2 x b32> [[TMP3]] to <2 x i32>
// CHECK-AARCH64-NEXT:    ret <2 x i32> [[TMP4]]
//
...
// CHECK-ARM-NEXT:    [[VQRDMLSHQ_S164_I:%.*]] = bitcast <8 x i16> [[VQRDMLSHQ_S163_I]] to <16 x b8>
// CHECK-ARM-NEXT:    [[TMP3:%.*]] = bitcast <16 x b8> [[VQRDMLSHQ_S164_I]] to <8 x b16>
// CHECK-ARM-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b16> [[TMP3]] to <8 x i16>
// CHECK-ARM-NEXT:    ret <8 x i16> [[TMP4]]
//
...
// CHECK-AARCH64-NEXT:    [[VQRDMLSHQ_S164_I:%.*]] = bitcast <8 x i16> [[VQRDMLSHQ_S163_I]] to <16 x b8>
// CHECK-AARCH64-NEXT:    [[TMP3:%.*]] = bitcast <16 x b8> [[VQRDMLSHQ_S164_I]] to <8 x b16>
// CHECK-AARCH64-NEXT:    [[TMP4:%.*]] = bytecast exact <8 x b16> [[TMP3]] to <8 x i16>
// CHECK-AARCH64-NEXT:    ret <8 x i16> [[TMP4]]
//
...
// CHECK-ARM-NEXT:    [[VQRDMLSHQ_S324_I:%.*]] = bitcast <4 x i32> [[VQRDMLSHQ_S323_I]] to <16 x b8>
// CHECK-ARM-NEXT:    [[TMP3:%.*]] = bitcast <16 x b8> [[VQRDMLSHQ_S324_I]] to <4 x b32>
// CHECK-ARM-NEXT:    [[TMP4:%.*]] = bytecast exact <4 x b32> [[TMP3]] to <4 x i32>
// CHECK-ARM-NEXT:    ret <4 x i32> [[TMP4]]
//
...
// CHECK-AARCH64-NEXT:    [[VQRDMLSHQ_S324_I:%.*]] = bitcast <4 x i32> [[VQRDMLSHQ_S323_I]] to <16 x b8>
// CHECK-AARCH64-NEXT:    [[TMP3:%.*]] = bitcast <16 x b8> [[VQRDMLSHQ_S324_I]] to <4 x b32>
// CHECK-AARCH64-NEXT:    [[TMP4:%.*]] = bytecast exact <4 x b32> [[TMP3]] to <4 x i32>
// CHECK-AARCH64-NEXT:    ret <4 x i32> [[TMP4]]
//
