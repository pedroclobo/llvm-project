...
// CHECK-NEXT:    [[VMMLA_I:%.*]] = bytecast <16 x b8> [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[VMMLA1_I:%.*]] = bytecast <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VMMLA2_I:%.*]] = bytecast <16 x b8> [[B]] to <16 x i8>
// CHECK-NEXT:    [[VMMLA3_I:%.*]] = call <4 x i32> @llvm.arm.neon.smmla.v4i32.v16i8(<4 x i32> [[VMMLA_I]], <16 x i8> [[VMMLA1_I]], <16 x i8> [[VMMLA2_I]])
...
// CHECK-NEXT:    [[VMMLA1_I:%.*]] = bytecast <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VMMLA2_I:%.*]] = bytecast <16 x b8> [[B]] to <16 x i8>
// CHECK-NEXT:    [[VMMLA3_I:%.*]] = call <4 x i32> @llvm.arm.neon.ummla.v4i32.v16i8(<4 x i32> [[VMMLA_I]], <16 x i8> [[VMMLA1_I]], <16 x i8> [[VMMLA2_I]])
// CHECK-NEXT:    ret <4 x i32> [[VMMLA3_I]]
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i32> [[R]] to <16 x b8>
// CHECK-NEXT:    [[VUSMMLA_I:%.*]] = bytecast <16 x b8> [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[VUSMMLA1_I:%.*]] = bytecast <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VUSMMLA2_I:%.*]] = bytecast <16 x b8> [[B]] to <16 x i8>
// CHECK-NEXT:    [[VUSMMLA3_I:%.*]] = call <4 x i32> @llvm.arm.neon.usmmla.v4i32.v16i8(<4 x i32> [[VUSMMLA_I]], <16 x i8> [[VUSMMLA1_I]], <16 x i8> [[VUSMMLA2_I]])
...
// CHECK-NEXT:    [[VUSDOT_I:%.*]] = bytecast <8 x b8> [[TMP0]] to <2 x i32>
// CHECK-NEXT:    [[VUSDOT1_I:%.*]] = bytecast <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VUSDOT2_I:%.*]] = bytecast <8 x b8> [[B]] to <8 x i8>
// CHECK-NEXT:    [[VUSDOT3_I:%.*]] = call <2 x i32> @llvm.arm.neon.usdot.v2i32.v8i8(<2 x i32> [[VUSDOT_I]], <8 x i8> [[VUSDOT1_I]], <8 x i8> [[VUSDOT2_I]])
...
// CHECK-SAME: <2 x i32> noundef [[R:%.*]], <8 x b8> noundef [[A:%.*]], <8 x b8> noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = bytecast <8 x b8> [[B]] to <2 x i32>
...
// CHECK-NEXT:    [[VUSDOT_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <2 x i32>
// CHECK-NEXT:    [[VUSDOT1_I:%.*]] = bytecast <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VUSDOT2_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <8 x i8>
// CHECK-NEXT:    [[VUSDOT3_I:%.*]] = call <2 x i32> @llvm.arm.neon.usdot.v2i32.v8i8(<2 x i32> [[VUSDOT_I]], <8 x i8> [[VUSDOT1_I]], <8 x i8> [[VUSDOT2_I]])
// CHECK-NEXT:    ret <2 x i32> [[VUSDOT3_I]]
//
...
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <2 x i32> [[R]] to <8 x b8>
// CHECK-NEXT:    [[VUSDOT_I:%.*]] = bytecast <8 x b8> [[TMP5]] to <2 x i32>
// CHECK-NEXT:    [[VUSDOT1_I:%.*]] = bytecast <8 x b8> [[TMP4]] to <8 x i8>
// CHECK-NEXT:    [[VUSDOT2_I:%.*]] = bytecast <8 x b8> [[A]] to <8 x i8>
// CHECK-NEXT:    [[VUSDOT3_I:%.*]] = call <2 x i32> @llvm.arm.neon.usdot.v2i32.v8i8(<2 x i32> [[VUSDOT_I]], <8 x i8> [[VUSDOT1_I]], <8 x i8> [[VUSDOT2_I]])
// CHECK-NEXT:    ret <2 x i32> [[VUSDOT3_I]]
//
...
// CHECK-NEXT:    [[VUSDOT_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <4 x i32>
// CHECK-NEXT:    [[VUSDOT1_I:%.*]] = bytecast <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VUSDOT2_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <16 x i8>
// CHECK-NEXT:    [[VUSDOT3_I:%.*]] = call <4 x i32> @llvm.arm.neon.usdot.v4i32.v16i8(<4 x i32> [[VUSDOT_I]], <16 x i8> [[VUSDOT1_I]], <16 x i8> [[VUSDOT2_I]])
...
// CHECK-NEXT:    [[TMP5:%.*]] = bitcast <4 x i32> [[R]] to <16 x b8>
// CHECK-NEXT:    [[VUSDOT_I:%.*]] = bytecast <16 x b8> [[TMP5]] to <4 x i32>
// CHECK-NEXT:    [[VUSDOT1_I:%.*]] = bytecast <16 x b8> [[TMP4]] to <16 x i8>
// CHECK-NEXT:    [[VUSDOT2_I:%.*]] = bytecast <16 x b8> [[A]] to <16 x i8>
// CHECK-NEXT:    [[VUSDOT3_I:%.*]] = call <4 x i32> @llvm.arm.neon.usdot.v4i32.v16i8(<4 x i32> [[VUSDOT_I]], <16 x i8> [[VUSDOT1_I]], <16 x i8> [[VUSDOT2_I]])
// CHECK-NEXT:    ret <4 x i32> [[VUSDOT3_I]]
//
