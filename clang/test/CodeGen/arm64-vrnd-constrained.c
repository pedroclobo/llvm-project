...
// UNCONSTRAINED-NEXT:    [[VRNDZ_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x double>
...
// CONSTRAINED-NEXT:    [[VRNDZ_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x double>
...
// UNCONSTRAINED-NEXT:    store <2 x double> [[TMP0]], ptr [[__P0_ADDR_I]], align 16
// UNCONSTRAINED-NEXT:    [[TMP1:%.*]] = load <16 x b8>, ptr [[__P0_ADDR_I]], align 16
// UNCONSTRAINED-NEXT:    [[VRNDM_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x double>
...
// CONSTRAINED-NEXT:    store <2 x double> [[TMP0]], ptr [[__P0_ADDR_I]], align 16
// CONSTRAINED-NEXT:    [[TMP1:%.*]] = load <16 x b8>, ptr [[__P0_ADDR_I]], align 16
// CONSTRAINED-NEXT:    [[VRNDM_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x double>
...
// UNCONSTRAINED-NEXT:    store <2 x double> [[TMP0]], ptr [[__P0_ADDR_I]], align 16
// UNCONSTRAINED-NEXT:    [[TMP1:%.*]] = load <16 x b8>, ptr [[__P0_ADDR_I]], align 16
// UNCONSTRAINED-NEXT:    [[VRNDX_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x double>
...
// CONSTRAINED-NEXT:    store <2 x double> [[TMP0]], ptr [[__P0_ADDR_I]], align 16
// CONSTRAINED-NEXT:    [[TMP1:%.*]] = load <16 x b8>, ptr [[__P0_ADDR_I]], align 16
// CONSTRAINED-NEXT:    [[VRNDX_I:%.*]] = bytecast exact <16 x b8> [[TMP1]] to <2 x double>
