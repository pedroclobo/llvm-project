...
// AArch32-NEXT:  entry:
// AArch32-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[A:%.*]] to i8
// AArch32-NEXT:    [[CONV1:%.*]] = zext i8 [[CONV]] to i32
// AArch32-NEXT:    [[CONV2:%.*]] = bytecast exact b8 [[B:%.*]] to i8
// AArch32-NEXT:    [[CONV3:%.*]] = zext i8 [[CONV2]] to i32
// AArch32-NEXT:    [[CONV4:%.*]] = bytecast exact b8 [[C:%.*]] to i8
...
// AArch32-NEXT:  entry:
// AArch32-NEXT:    [[TMP0:%.*]] = bytecast exact b8 [[B:%.*]] to i8
...
// AArch64-NEXT:  entry:
// AArch64-NEXT:    [[TMP0:%.*]] = bytecast exact b8 [[B:%.*]] to i8
