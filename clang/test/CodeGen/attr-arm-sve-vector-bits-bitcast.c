...
// CHECK-128-NEXT:    [[TMP0:%.*]] = load <2 x b8>, ptr [[Y]], align 2, !tbaa [[CHAR_TBAA6]]
...
// CHECK-256-NEXT:    [[TMP0:%.*]] = load <4 x b8>, ptr [[Y]], align 2, !tbaa [[CHAR_TBAA6]]
...
// CHECK-512-NEXT:    [[TMP0:%.*]] = load <8 x b8>, ptr [[Y]], align 2, !tbaa [[CHAR_TBAA6]]
...
// CHECK-128-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 2
// CHECK-128-NEXT:    store <2 x b8> [[CAST_FIXED]], ptr [[Y]], align 2, !tbaa [[CHAR_TBAA6]]
// CHECK-128-NEXT:    ret void
//
...
// CHECK-256-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 4
// CHECK-256-NEXT:    store <4 x b8> [[CAST_FIXED]], ptr [[Y]], align 2, !tbaa [[CHAR_TBAA6]]
// CHECK-256-NEXT:    ret void
//
...
// CHECK-512-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw i8, ptr [[S]], i64 8
// CHECK-512-NEXT:    store <8 x b8> [[CAST_FIXED]], ptr [[Y]], align 2, !tbaa [[CHAR_TBAA6]]
// CHECK-512-NEXT:    ret void
//
