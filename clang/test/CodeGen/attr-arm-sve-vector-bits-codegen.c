...
// CHECK-NEXT:    [[CAST_SCALABLE1:%.*]] = call <vscale x 2 x b8> @llvm.vector.insert.nxv2b8.v8b8(<vscale x 2 x b8> undef, <8 x b8> [[TMP3]], i64 0)
// CHECK-NEXT:    [[TMP4:%.*]] = bytecast <vscale x 2 x b8> [[CAST_SCALABLE1]] to <vscale x 16 x i1>
...
// CHECK-NEXT:    [[CAST_SCALABLE2:%.*]] = call <vscale x 4 x i32> @llvm.vector.insert.nxv4i32.v16i32(<vscale x 4 x i32> undef, <16 x i32> [[TMP7]], i64 0)
...
// CHECK-NEXT:    [[CAST_SCALABLE3:%.*]] = call <vscale x 4 x i32> @llvm.vector.insert.nxv4i32.v16i32(<vscale x 4 x i32> undef, <16 x i32> [[TMP11]], i64 0)
...
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 2 [[RETVAL_COERCE]], ptr align 2 [[RETVAL]], i64 8, i1 false)
// CHECK-NEXT:    [[TMP2:%.*]] = load <vscale x 16 x i1>, ptr [[RETVAL_COERCE]], align 2
...
// CHECK-NEXT:    [[EXT:%.*]] = bytecast <8 x b8> [[TMP3]] to <8 x i8>
// CHECK-NEXT:    [[TMP4:%.*]] = load <8 x b8>, ptr [[YY]], align 8
// CHECK-NEXT:    [[EXT1:%.*]] = bytecast <8 x b8> [[TMP4]] to <8 x i8>
// CHECK-NEXT:    [[ADD:%.*]] = add <8 x i8> [[EXT]], [[EXT1]]
// CHECK-NEXT:    [[UNPROMOTION:%.*]] = bitcast <8 x i8> [[ADD]] to <8 x b8>
// CHECK-NEXT:    [[CAST_SCALABLE2:%.*]] = call <vscale x 2 x b8> @llvm.vector.insert.nxv2b8.v8b8(<vscale x 2 x b8> undef, <8 x b8> [[UNPROMOTION]], i64 0)
// CHECK-NEXT:    [[TMP5:%.*]] = bytecast <vscale x 2 x b8> [[CAST_SCALABLE2]] to <vscale x 16 x i1>
...
// CHECK-NEXT:    [[CAST_SCALABLE3:%.*]] = call <vscale x 4 x i32> @llvm.vector.insert.nxv4i32.v16i32(<vscale x 4 x i32> undef, <16 x i32> [[TMP8]], i64 0)
...
// CHECK-NEXT:    [[CAST_SCALABLE4:%.*]] = call <vscale x 4 x i32> @llvm.vector.insert.nxv4i32.v16i32(<vscale x 4 x i32> undef, <16 x i32> [[TMP12]], i64 0)
