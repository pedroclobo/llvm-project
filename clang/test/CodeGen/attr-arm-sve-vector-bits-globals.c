...
// CHECK-128-NEXT:    store <2 x b8> [[CAST_FIXED]], ptr @global_bool, align 2, !tbaa [[TBAA6]]
// CHECK-128-NEXT:    ret void
//
...
// CHECK-512-NEXT:    store <8 x b8> [[CAST_FIXED]], ptr @global_bool, align 2, !tbaa [[TBAA6]]
// CHECK-512-NEXT:    ret void
//
...
// CHECK-128-NEXT:  entry:
// CHECK-128-NEXT:    [[TMP0:%.*]] = load <2 x b8>, ptr @global_bool, align 2, !tbaa [[TBAA6]]
// CHECK-128-NEXT:    [[CAST_SCALABLE:%.*]] = tail call <vscale x 2 x b8> @llvm.vector.insert.nxv2b8.v2b8(<vscale x 2 x b8> undef, <2 x b8> [[TMP0]], i64 0)
...
// CHECK-512-NEXT:  entry:
// CHECK-512-NEXT:    [[TMP0:%.*]] = load <8 x b8>, ptr @global_bool, align 2, !tbaa [[TBAA6]]
// CHECK-512-NEXT:    [[CAST_SCALABLE:%.*]] = tail call <vscale x 2 x b8> @llvm.vector.insert.nxv2b8.v8b8(<vscale x 2 x b8> undef, <8 x b8> [[TMP0]], i64 0)
