...
// CHECK-128-NEXT:    store <2 x i64> [[CAST_FIXED]], ptr @global_i64, align 16, !tbaa [[TBAA2:![0-9]+]]
...
// CHECK-512-NEXT:    store <8 x i64> [[CAST_FIXED]], ptr @global_i64, align 16, !tbaa [[TBAA2:![0-9]+]]
...
// CHECK-128-NEXT:    store <8 x bfloat> [[CAST_FIXED]], ptr @global_bf16, align 16, !tbaa [[TBAA2]]
// CHECK-128-NEXT:    ret void
//
...
// CHECK-512-NEXT:    store <32 x bfloat> [[CAST_FIXED]], ptr @global_bf16, align 16, !tbaa [[TBAA2]]
// CHECK-512-NEXT:    ret void
//
...
// CHECK-128-NEXT:  entry:
// CHECK-128-NEXT:    [[TMP0:%.*]] = bitcast <vscale x 16 x i1> [[V:%.*]] to <vscale x 2 x b8>
// CHECK-128-NEXT:    [[CAST_FIXED:%.*]] = tail call <2 x b8> @llvm.vector.extract.v2b8.nxv2b8(<vscale x 2 x b8> [[TMP0]], i64 0)
// CHECK-128-NEXT:    store <2 x b8> [[CAST_FIXED]], ptr @global_bool, align 2, !tbaa [[TBAA2]]
// CHECK-128-NEXT:    ret void
//
// CHECK-512-LABEL: @write_global_bool(
// CHECK-512-NEXT:  entry:
// CHECK-512-NEXT:    [[TMP0:%.*]] = bitcast <vscale x 16 x i1> [[V:%.*]] to <vscale x 2 x b8>
// CHECK-512-NEXT:    [[CAST_FIXED:%.*]] = tail call <8 x b8> @llvm.vector.extract.v8b8.nxv2b8(<vscale x 2 x b8> [[TMP0]], i64 0)
// CHECK-512-NEXT:    store <8 x b8> [[CAST_FIXED]], ptr @global_bool, align 2, !tbaa [[TBAA2]]
// CHECK-512-NEXT:    ret void
//
...
// CHECK-128-NEXT:  entry:
// CHECK-128-NEXT:    [[TMP0:%.*]] = load <2 x i64>, ptr @global_i64, align 16, !tbaa [[TBAA2]]
...
// CHECK-512-NEXT:  entry:
// CHECK-512-NEXT:    [[TMP0:%.*]] = load <8 x i64>, ptr @global_i64, align 16, !tbaa [[TBAA2]]
...
// CHECK-128-NEXT:  entry:
// CHECK-128-NEXT:    [[TMP0:%.*]] = load <8 x bfloat>, ptr @global_bf16, align 16, !tbaa [[TBAA2]]
...
// CHECK-512-NEXT:  entry:
// CHECK-512-NEXT:    [[TMP0:%.*]] = load <32 x bfloat>, ptr @global_bf16, align 16, !tbaa [[TBAA2]]
...
// CHECK-128-NEXT:  entry:
// CHECK-128-NEXT:    [[TMP0:%.*]] = load <2 x b8>, ptr @global_bool, align 2, !tbaa [[TBAA2]]
...
// CHECK-128-NEXT:    [[TMP1:%.*]] = bytecast <vscale x 2 x b8> [[CAST_SCALABLE]] to <vscale x 16 x i1>
// CHECK-128-NEXT:    ret <vscale x 16 x i1> [[TMP1]]
//
// CHECK-512-LABEL: @read_global_bool(
// CHECK-512-NEXT:  entry:
// CHECK-512-NEXT:    [[TMP0:%.*]] = load <8 x b8>, ptr @global_bool, align 2, !tbaa [[TBAA2]]
...
// CHECK-512-NEXT:    [[TMP1:%.*]] = bytecast <vscale x 2 x b8> [[CAST_SCALABLE]] to <vscale x 16 x i1>
