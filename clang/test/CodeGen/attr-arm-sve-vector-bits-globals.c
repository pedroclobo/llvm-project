...
// CHECK-128-NEXT:    store <2 x b8> [[CAST_FIXED]], ptr @global_bool, align 2, !tbaa [[CHAR_TBAA6]]
// CHECK-128-NEXT:    ret void
//
...
// CHECK-512-NEXT:    store <8 x b8> [[CAST_FIXED]], ptr @global_bool, align 2, !tbaa [[CHAR_TBAA6]]
// CHECK-512-NEXT:    ret void
//
...
// CHECK-128-SAME: ) local_unnamed_addr #[[ATTR2]] {
// CHECK-128-NEXT:  [[ENTRY:.*:]]
// CHECK-128-NEXT:    [[TMP0:%.*]] = load <2 x b8>, ptr @global_bool, align 2, !tbaa [[CHAR_TBAA6]]
...
// CHECK-512-SAME: ) local_unnamed_addr #[[ATTR2]] {
// CHECK-512-NEXT:  [[ENTRY:.*:]]
// CHECK-512-NEXT:    [[TMP0:%.*]] = load <8 x b8>, ptr @global_bool, align 2, !tbaa [[CHAR_TBAA6]]
