...
void test_builtin_elementwise_abs(float f1, float f2, double d1, double d2,
  ...
  // CHECK-NEXT: [[CAST:%.+]] = bytecast b8 [[BFCAST2]] to i8
...
void test_builtin_elementwise_add_sat(float f1, float f2, double d1, double d2,
  ...
  // CHECK-NEXT: [[CAST1:%.+]] = bytecast b8 [[C1]] to i8
  // CHECK-NEXT: [[CAST2:%.+]] = bytecast b8 [[C2]] to i8
  ...
  // CHECK-NEXT: [[CAST1:%.+]] = bytecast b8 [[UC1]] to i8
  // CHECK-NEXT: [[CAST2:%.+]] = bytecast b8 [[UC2]] to i8
...
void test_builtin_elementwise_bitreverse(si8 vi1, si8 vi2,
  ...
  // CHECK:      [[CAST:%.+]] = bytecast b8 [[CI]] to i8
