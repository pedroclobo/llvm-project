...
void test_builtin_popcountg(unsigned char uc, unsigned short us,
  ...
  // CHECK-NEXT: %cast = bytecast exact b8 %1 to i8
  // CHECK-NEXT: %2 = call i8 @llvm.ctpop.i8(i8 %cast)
  // CHECK-NEXT: %cast1 = zext i8 %2 to i32
...
void test_builtin_clzg(unsigned char uc, unsigned short us, unsigned int ui,
  ...
  // CHECK: %1 = load b8, ptr %uc.addr, align 1
  // CHECK-NEXT: %cast = bytecast exact b8 %1 to i8
  // CHECK-NEXT: %2 = call i8 @llvm.ctlz.i8(i8 %cast, i1 true)
  // CHECK-NEXT: %cast1 = zext i8 %2 to i32
  ...
  // CHECK-NEXT: %cast7 = bytecast exact b8 %15 to i8
  // CHECK-NEXT: %16 = call i8 @llvm.ctlz.i8(i8 %cast7, i1 true)
  // CHECK-NEXT: %cast8 = zext i8 %16 to i32
  // CHECK-NEXT: %iszero = icmp eq i8 %cast7, 0
  // CHECK-NEXT: %17 = load b8, ptr %sc.addr, align 1
  // CHECK-NEXT: %conv = bytecast exact b8 %17 to i8
  // CHECK-NEXT: %conv9 = sext i8 %conv to i32
  // CHECK-NEXT: %clzg = select i1 %iszero, i32 %conv9, i32 %cast8
  ...
  // CHECK-NEXT: %conv12 = bytecast exact b8 %20 to i8
...
void test_builtin_ctzg(unsigned char uc, unsigned short us, unsigned int ui,
  ...
  // CHECK: %1 = load b8, ptr %uc.addr, align 1
  // CHECK-NEXT: %cast = bytecast exact b8 %1 to i8
  // CHECK-NEXT: %2 = call i8 @llvm.cttz.i8(i8 %cast, i1 true)
  // CHECK-NEXT: %cast1 = zext i8 %2 to i32
  ...
  // CHECK-NEXT: %15 = load b8, ptr %uc.addr, align 1
  // CHECK-NEXT: %cast7 = bytecast exact b8 %15 to i8
  // CHECK-NEXT: %16 = call i8 @llvm.cttz.i8(i8 %cast7, i1 true)
  // CHECK-NEXT: %cast8 = zext i8 %16 to i32
  // CHECK-NEXT: %iszero = icmp eq i8 %cast7, 0
  // CHECK-NEXT: %17 = load b8, ptr %sc.addr, align 1
  // CHECK-NEXT: %conv = bytecast exact b8 %17 to i8
  // CHECK-NEXT: %conv9 = sext i8 %conv to i32
  // CHECK-NEXT: %ctzg = select i1 %iszero, i32 %conv9, i32 %cast8
