...
void foo(signed char sc, unsigned char uc, signed long long sll,
  ...
  // CHECK: alloca b[[CHSIZE]], align [[CHALIGN:[0-9]+]]
  // CHECK: alloca i[[LLSIZE]], align [[LLALIGN:[0-9]+]]

  // CHECK: store i64 %ull,

  sc1 = csc;
  // CHECK-NEXT: %[[VAR1:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]]  }, ptr %[[CSC:[A-Za-z0-9.]+]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR2:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR1]]
  // CHECK-NEXT: store b[[CHSIZE]] %[[VAR2]], ptr %[[SC1:[A-Za-z0-9.]+]], align [[CHALIGN]]

  sc1 = cuc;
  // CHECK-NEXT: %[[VAR3:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]]  }, ptr %[[CUC:[A-Za-z0-9.]+]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR4:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR3]]
  // CHECK-NEXT: store b[[CHSIZE]] %[[VAR4]], ptr %[[SC1]], align [[CHALIGN]]
  ...
  // CHECK-NEXT: %[[CONV1:[A-Za-z0-9.]+]] = bitcast i[[CHSIZE]] %[[VAR7]] to b[[CHSIZE]]
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV1]], ptr %[[SC1]], align [[CHALIGN]]
  ...
  // CHECK-NEXT: %[[CONV2:[A-Za-z0-9.]+]] = bitcast i[[CHSIZE]] %[[VAR10]] to b[[CHSIZE]]
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV2]], ptr %[[SC1]], align [[CHALIGN]]

  uc1 = csc;
  // CHECK-NEXT: %[[VAR11:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]]  }, ptr %[[CSC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR12:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR11]]
  // CHECK-NEXT: store b[[CHSIZE]] %[[VAR12]], ptr %[[UC1:[A-Za-z0-9.]+]], align [[CHALIGN]]

  uc1 = cuc;
  // CHECK-NEXT: %[[VAR13:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]]  }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR14:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR13]]
  // CHECK-NEXT: store b[[CHSIZE]] %[[VAR14]], ptr %[[UC1]], align [[CHALIGN]]
  ...
  // CHECK-NEXT: %[[CONV3:[A-Za-z0-9.]+]] = bitcast i[[CHSIZE]] %[[VAR17]] to b[[CHSIZE]]
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV3]], ptr %[[UC1]], align [[CHALIGN]]
  ...
  // CHECK-NEXT: %[[CONV4:[A-Za-z0-9.]+]] = bitcast i[[CHSIZE]] %[[VAR20]] to b[[CHSIZE]]
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV4]], ptr %[[UC1]], align [[CHALIGN]]

  sll1 = csc;
  // CHECK-NEXT: %[[VAR21:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]]  }, ptr %[[CSC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR22:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR21]]
  // CHECK-NEXT: %[[CONV4:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR22]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR23:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV4]] to i[[LLSIZE]]
  // CHECK-NEXT: store i[[LLSIZE]] %[[VAR23]], ptr %[[SLL1:[A-Za-z0-9]+]], align [[LLALIGN]]

  sll1 = cuc;
  // CHECK-NEXT: %[[VAR24:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]]  }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR25:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR24]]
  // CHECK-NEXT: %[[CONV4:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR25]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR26:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV4]] to i[[LLSIZE]]
  ...
  ull1 = csc;
  // CHECK-NEXT: %[[VAR31:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR32:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR31]]
  // CHECK-NEXT: %[[CONV:[A-Za-z0-9.]+]]  = bytecast exact b[[CHSIZE]] %[[VAR32]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR33:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV]] to i[[LLSIZE]]
  // CHECK-NEXT: store i[[LLSIZE]] %[[VAR33]], ptr %[[ULL1:[A-Za-z0-9]+]], align [[LLALIGN]]

  ull1 = cuc;
  // CHECK-NEXT: %[[VAR34:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR35:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR34]]
  // CHECK-NEXT: %[[CONV5:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR35]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR36:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV5]] to i[[LLSIZE]]
  ...
  csc1 = sc;
  // CHECK-NEXT: %[[VAR41:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[SCADDR:[A-Za-z0-9.]+]], align [[CHALIGN]]
  // CHECK-NEXT: %[[VAR42:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC1:[A-Za-z0-9.]+]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR43:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: store b[[CHSIZE]] %[[VAR41]], ptr %[[VAR42]]
  // CHECK-NEXT: store b[[CHSIZE]] 0, ptr %[[VAR43]]

  csc1 = uc;
  // CHECK-NEXT: %[[VAR44:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[UCADDR:[A-Za-z0-9.]+]], align [[CHALIGN]]
  // CHECK-NEXT: %[[VAR45:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR46:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: store b[[CHSIZE]] %[[VAR44]], ptr %[[VAR45]]
  // CHECK-NEXT: store b[[CHSIZE]] 0, ptr %[[VAR46]]
  ...
  // CHECK-NEXT: %[[CONV:[A-Za-z0-9.]+]]  = bitcast i[[CHSIZE]] %[[VAR48]] to b[[CHSIZE]]
  // CHECK-NEXT: %[[VAR49:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR50:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV]], ptr %[[VAR49]]
  // CHECK-NEXT: store b[[CHSIZE]] 0, ptr %[[VAR50]]
  ...
  // CHECK-NEXT: %[[CONV:[A-Za-z0-9.]+]]  = bitcast i[[CHSIZE]] %[[VAR52]] to b[[CHSIZE]]
  // CHECK-NEXT: %[[VAR53:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR54:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV]], ptr %[[VAR53]]
  // CHECK-NEXT: store b[[CHSIZE]] 0, ptr %[[VAR54]]

  cuc1 = sc;
  // CHECK-NEXT: %[[VAR55:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[SCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[VAR56:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC1:[A-Za-z0-9.]+]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR57:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: store b[[CHSIZE]] %[[VAR55]], ptr %[[VAR56]]
  // CHECK-NEXT: store b[[CHSIZE]] 0, ptr %[[VAR57]]

  cuc1 = uc;
  // CHECK-NEXT: %[[VAR58:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[UCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[VAR59:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR60:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: store b[[CHSIZE]] %[[VAR58]], ptr %[[VAR59]]
  // CHECK-NEXT: store b[[CHSIZE]] 0, ptr %[[VAR60]]
  ...
  // CHECK-NEXT: %[[CONV8:[A-Za-z0-9.]+]] = bitcast i[[CHSIZE]] %[[VAR62]] to b[[CHSIZE]]
  // CHECK-NEXT: %[[VAR63:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR64:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV8]], ptr %[[VAR63]]
  // CHECK-NEXT: store b[[CHSIZE]] 0, ptr %[[VAR64]]
  ...
  // CHECK-NEXT: %[[CONV9:[A-Za-z0-9.]+]] = bitcast i[[CHSIZE]] %[[VAR66]] to b[[CHSIZE]]
  // CHECK-NEXT: %[[VAR67:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR68:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV9]], ptr %[[VAR67]]
  // CHECK-NEXT: store b[[CHSIZE]] 0, ptr %[[VAR68]]

  csll1 = sc;
  // CHECK-NEXT: %[[VAR69:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[SCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[CONV:[A-Za-z0-9.]+]]  = bytecast exact b8 %[[VAR69]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR70:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV]] to i[[LLSIZE]]
  ...
  csll1 = uc;
  // CHECK-NEXT: %[[VAR73:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[UCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[CONV10:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR73]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR74:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV10]] to i[[LLSIZE]]
  ...
  cull1 = sc;
  // CHECK-NEXT: %[[VAR80:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[SCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[CONV:[A-Za-z0-9.]+]]  = bytecast exact b[[CHSIZE]] %[[VAR80]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR81:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV]] to i[[LLSIZE]]
  ...
  cull1 = uc;
  // CHECK-NEXT: %[[VAR84:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[UCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[CONV11:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR84]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR85:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV11]] to i[[LLSIZE]]
  ...
  csc1 = sc + csc;
  // CHECK-NEXT: %[[VAR94:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[SCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[CONV:[A-Za-z0-9.]+]]  = bytecast exact b[[CHSIZE]] %[[VAR94]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR95:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV]] to i[[ARSIZE:[0-9]+]]
  // CHECK-NEXT: %[[VAR96:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR97:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR96]]
  // CHECK-NEXT: %[[VAR98:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: %[[VAR99:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR98]]
  // CHECK-NEXT: %[[CONV:[A-Za-z0-9.]+]]  = bytecast exact b[[CHSIZE]] %[[VAR97]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR100:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV]] to i[[ARSIZE]]
  // CHECK-NEXT: %[[CONV:[A-Za-z0-9.]+]]  = bytecast exact b[[CHSIZE]] %[[VAR99]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR101:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV]] to i[[ARSIZE]]
  ...
  // CHECK-NEXT: %[[CONV1:[A-Za-z0-9.]+]]  = bitcast i[[CHSIZE]] %[[VAR104]] to b[[CHSIZE]]
  // CHECK-NEXT: %[[VAR105:[A-Za-z0-9.]+]] = trunc i[[ARSIZE]] %[[VAR103]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[CONV2:[A-Za-z0-9.]+]]  = bitcast i[[CHSIZE]] %[[VAR105]] to b[[CHSIZE]]
  // CHECK-NEXT: %[[VAR106:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR107:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV1]], ptr %[[VAR106]]
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV2]], ptr %[[VAR107]]

  cuc1 = sc + cuc;
  // CHECK-NEXT: %[[VAR108:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[SCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[CONV:[A-Za-z0-9.]+]]   = bytecast exact b[[CHSIZE]] %[[VAR108]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR109:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV]] to i[[ARSIZE]]
  // CHECK-NEXT: %[[VAR110:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR111:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR110]]
  // CHECK-NEXT: %[[VAR112:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: %[[VAR113:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR112]]
  // CHECK-NEXT: %[[CONV12:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR111]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR114:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV12]] to i[[ARSIZE]]
  // CHECK-NEXT: %[[CONV13:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR113]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR115:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV13]] to i[[ARSIZE]]
  ...
  // CHECK-NEXT: %[[CONV14:[A-Za-z0-9.]+]] = bitcast i[[CHSIZE]] %[[VAR118]] to b[[CHSIZE]]
  // CHECK-NEXT: %[[VAR119:[A-Za-z0-9.]+]] = trunc i[[ARSIZE]] %[[VAR117]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[CONV15:[A-Za-z0-9.]+]] = bitcast i[[CHSIZE]] %[[VAR119]] to b[[CHSIZE]]
  // CHECK-NEXT: %[[VAR120:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR121:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV14]], ptr %[[VAR120]]
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV15]], ptr %[[VAR121]]

  csll1 = sc + csll;
  // CHECK-NEXT: %[[VAR122:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[SCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[CONV:[A-Za-z0-9.]+]]   = bytecast exact b[[CHSIZE]] %[[VAR122]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR123:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV]] to i[[LLSIZE]]
  ...
  cull1 = sc + cull;
  // CHECK-NEXT: %[[VAR132:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[SCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[CONV:[A-Za-z0-9.]+]]   = bytecast exact b[[CHSIZE]] %[[VAR132]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR133:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV]] to i[[LLSIZE]]
  ...
  csc1 = uc + csc;
  // CHECK-NEXT: %[[VAR142:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[UCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[CONV16:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR142]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR143:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV16]] to i[[ARSIZE]]
  // CHECK-NEXT: %[[VAR144:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR145:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR144]]
  // CHECK-NEXT: %[[VAR146:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: %[[VAR147:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR146]]
  // CHECK-NEXT: %[[CONV1:[A-Za-z0-9.]+]]  = bytecast exact b[[CHSIZE]] %[[VAR145]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR148:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV1]] to i[[ARSIZE]]
  // CHECK-NEXT: %[[CONV2:[A-Za-z0-9.]+]]  = bytecast exact b[[CHSIZE]] %[[VAR147]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR149:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV2]] to i[[ARSIZE]]
  ...
  // CHECK-NEXT: %[[CONV3:[A-Za-z0-9.]+]]  = bitcast i[[CHSIZE]] %[[VAR152]] to b[[CHSIZE]]
  // CHECK-NEXT: %[[VAR153:[A-Za-z0-9.]+]] = trunc i[[ARSIZE]] %[[VAR151]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[CONV4:[A-Za-z0-9.]+]]  = bitcast i[[CHSIZE]] %[[VAR153]] to b[[CHSIZE]]
  // CHECK-NEXT: %[[VAR154:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR155:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV3]], ptr %[[VAR154]]
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV4]], ptr %[[VAR155]]

  cuc1 = uc + cuc;
  // CHECK-NEXT: %[[VAR156:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[UCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[CONV16:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR156]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR157:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV16]] to i[[ARSIZE]]
  // CHECK-NEXT: %[[VAR158:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR159:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR158]]
  // CHECK-NEXT: %[[VAR160:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: %[[VAR161:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR160]]
  // CHECK-NEXT: %[[CONV17:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR159]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR162:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV17]] to i[[ARSIZE]]
  // CHECK-NEXT: %[[CONV18:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR161]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR163:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV18]] to i[[ARSIZE]]
  ...
  // CHECK-NEXT: %[[CONV19:[A-Za-z0-9.]+]] = bitcast i[[CHSIZE]] %[[VAR166]] to b[[CHSIZE]]
  // CHECK-NEXT: %[[VAR167:[A-Za-z0-9.]+]] = trunc i[[ARSIZE]] %[[VAR165]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[CONV20:[A-Za-z0-9.]+]] = bitcast i[[CHSIZE]] %[[VAR167]] to b[[CHSIZE]]
  // CHECK-NEXT: %[[VAR168:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR169:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV19]], ptr %[[VAR168]]
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV20]], ptr %[[VAR169]]

  csll1 = uc + csll;
  // CHECK-NEXT: %[[VAR170:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[UCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[CONV21:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR170]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR171:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV21]] to i[[LLSIZE]]
  ...
  cull1 = uc + cull;
  // CHECK-NEXT: %[[VAR180:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[UCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[CONV21:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR180]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR181:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV21]] to i[[LLSIZE]]
  ...
  // CHECK-NEXT: %[[VAR191:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR192:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR191]]
  // CHECK-NEXT: %[[VAR193:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: %[[VAR194:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR193]]
  // CHECK-NEXT: %[[CONV1:[A-Za-z0-9.]+]]  = bytecast exact b[[CHSIZE]] %[[VAR192]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR195:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV1]] to i[[LLSIZE]]
  // CHECK-NEXT: %[[CONV2:[A-Za-z0-9.]+]]  = bytecast exact b[[CHSIZE]] %[[VAR194]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR196:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV2]] to i[[LLSIZE]]
  ...
  // CHECK-NEXT: %[[VAR202:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR203:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR202]]
  // CHECK-NEXT: %[[VAR204:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: %[[VAR205:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR204]]
  // CHECK-NEXT: %[[CONV22:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR203]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR206:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV22]] to i[[LLSIZE]]
  // CHECK-NEXT: %[[CONV23:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR205]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR207:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV23]] to i[[LLSIZE]]
  ...
  // CHECK-NEXT: %[[VAR231:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR232:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR231]]
  // CHECK-NEXT: %[[VAR233:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: %[[VAR234:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR233]]
  // CHECK-NEXT: %[[CONV1:[A-Za-z0-9.]+]]  = bytecast exact b[[CHSIZE]] %[[VAR232]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR235:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV1]] to i[[LLSIZE]]
  // CHECK-NEXT: %[[CONV2:[A-Za-z0-9.]+]]  = bytecast exact b[[CHSIZE]] %[[VAR234]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR236:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV2]] to i[[LLSIZE]]
  ...
  // CHECK-NEXT: %[[VAR242:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR243:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR242]]
  // CHECK-NEXT: %[[VAR244:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: %[[VAR245:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR244]]
  // CHECK-NEXT: %[[CONV24:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR243]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR246:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV24]] to i[[LLSIZE]]
  // CHECK-NEXT: %[[CONV25:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR245]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR247:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV25]] to i[[LLSIZE]]
  ...
  csc1 = csc + sc;
  // CHECK-NEXT: %[[VAR270:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR271:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR270]]
  // CHECK-NEXT: %[[VAR272:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: %[[VAR273:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR272]]
  // CHECK-NEXT: %[[CONV1:[A-Za-z0-9.]+]]  = bytecast exact b[[CHSIZE]] %[[VAR271]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR274:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV1]] to i[[ARSIZE]]
  // CHECK-NEXT: %[[CONV2:[A-Za-z0-9.]+]]  = bytecast exact b[[CHSIZE]] %[[VAR273]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR275:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV2]] to i[[ARSIZE]]
  // CHECK-NEXT: %[[VAR276:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[SCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[CONV3:[A-Za-z0-9.]+]]  = bytecast exact b[[CHSIZE]] %[[VAR276]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR277:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV3]] to i[[ARSIZE]]
  ...
  // CHECK-NEXT: %[[CONV4:[A-Za-z0-9.]+]]  = bitcast i[[CHSIZE]] %[[VAR280]] to b[[CHSIZE]]
  // CHECK-NEXT: %[[VAR281:[A-Za-z0-9.]+]] = trunc i[[ARSIZE]] %[[VAR279]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[CONV5:[A-Za-z0-9.]+]]  = bitcast i[[CHSIZE]] %[[VAR281]] to b[[CHSIZE]]
  // CHECK-NEXT: %[[VAR282:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR283:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV4]], ptr %[[VAR282]]
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV5]], ptr %[[VAR283]]

  csc1 = csc + uc;
  // CHECK-NEXT: %[[VAR284:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR285:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR284]]
  // CHECK-NEXT: %[[VAR286:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: %[[VAR287:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR286]]
  // CHECK-NEXT: %[[CONV1:[A-Za-z0-9.]+]]  = bytecast exact b[[CHSIZE]] %[[VAR285]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR288:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV1]] to i[[ARSIZE]]
  // CHECK-NEXT: %[[CONV2:[A-Za-z0-9.]+]]  = bytecast exact b[[CHSIZE]] %[[VAR287]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR289:[A-Za-z0-9.]+]] = sext i[[CHSIZE]] %[[CONV2]] to i[[ARSIZE]]
  // CHECK-NEXT: %[[VAR290:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[UCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[CONV26:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR290]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR291:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV26]] to i[[ARSIZE]]
  ...
  // CHECK-NEXT: %[[CONV3:[A-Za-z0-9.]+]]  = bitcast i[[CHSIZE]] %[[VAR294]] to b[[CHSIZE]]
  // CHECK-NEXT: %[[VAR295:[A-Za-z0-9.]+]] = trunc i[[ARSIZE]] %[[VAR293]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[CONV4:[A-Za-z0-9.]+]]  = bitcast i[[CHSIZE]] %[[VAR295]] to b[[CHSIZE]]
  // CHECK-NEXT: %[[VAR296:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR297:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CSC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV3]], ptr %[[VAR296]]
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV4]], ptr %[[VAR297]]
  ...
  csc1 = cuc + sc;
  // CHECK-NEXT: %[[VAR320:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR321:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR320]]
  // CHECK-NEXT: %[[VAR322:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: %[[VAR323:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR322]]
  // CHECK-NEXT: %[[CONV27:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR321]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR324:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV27]] to i[[ARSIZE]]
  // CHECK-NEXT: %[[CONV28:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR323]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR325:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV28]] to i[[ARSIZE]]
  ...
  cuc1 = cuc + uc;
  // CHECK-NEXT: %[[VAR334:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR335:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR334]]
  // CHECK-NEXT: %[[VAR336:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: %[[VAR337:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR336]]
  // CHECK-NEXT: %[[CONV29:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR335]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR338:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV29]] to i[[ARSIZE]]
  // CHECK-NEXT: %[[CONV30:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR337]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR339:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV30]] to i[[ARSIZE]]
  // CHECK-NEXT: %[[VAR340:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[UCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[CONV30:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR340]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR341:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV30]] to i[[ARSIZE]]
  ...
  // CHECK-NEXT: %[[CONV31:[A-Za-z0-9.]+]] = bitcast i[[CHSIZE]] %[[VAR344]] to b[[CHSIZE]]
  // CHECK-NEXT: %[[VAR345:[A-Za-z0-9.]+]] = trunc i[[ARSIZE]] %[[VAR343]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[CONV32:[A-Za-z0-9.]+]] = bitcast i[[CHSIZE]] %[[VAR345]] to b[[CHSIZE]]
  // CHECK-NEXT: %[[VAR346:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR347:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC1]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV31]], ptr %[[VAR346]]
  // CHECK-NEXT: store b[[CHSIZE]] %[[CONV32]], ptr %[[VAR347]]

  csll1 = cuc + sll;
  // CHECK-NEXT: %[[VAR348:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR349:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR348]]
  // CHECK-NEXT: %[[VAR350:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: %[[VAR351:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR350]]
  // CHECK-NEXT: %[[CONV33:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR349]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR352:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV33]] to i[[LLSIZE]]
  // CHECK-NEXT: %[[CONV34:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR351]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR353:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV34]] to i[[LLSIZE]]
  ...
  cull1 = cuc + ull;
  // CHECK-NEXT: %[[VAR357:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 0
  // CHECK-NEXT: %[[VAR358:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR357]]
  // CHECK-NEXT: %[[VAR359:[A-Za-z0-9.]+]] = getelementptr inbounds nuw { b[[CHSIZE]], b[[CHSIZE]] }, ptr %[[CUC]], i{{[0-9]+}} 0, i{{[0-9]+}} 1
  // CHECK-NEXT: %[[VAR360:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[VAR359]]
  // CHECK-NEXT: %[[CONV35:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR358]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR361:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV35]] to i[[LLSIZE]]
  // CHECK-NEXT: %[[CONV36:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR360]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR362:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV36]] to i[[LLSIZE]]
  ...
  // CHECK-NEXT: %[[VAR382:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[UCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[CONV36:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR382]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR383:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV36]] to i[[LLSIZE]]
  ...
  // CHECK-NEXT: %[[VAR420:[A-Za-z0-9.]+]] = load b[[CHSIZE]], ptr %[[UCADDR]], align [[CHALIGN]]
  // CHECK-NEXT: %[[CONV37:[A-Za-z0-9.]+]] = bytecast exact b[[CHSIZE]] %[[VAR420]] to i[[CHSIZE]]
  // CHECK-NEXT: %[[VAR421:[A-Za-z0-9.]+]] = zext i[[CHSIZE]] %[[CONV37]] to i[[LLSIZE]]
