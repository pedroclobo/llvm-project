...
// CHECK: %struct.layout3 = type <{ b8, [3 x i8], %struct.size8_pack4, i8, [3 x i8] }>
// CHECK: %struct.layout0 = type { b8, %struct.size8, i8 }
// CHECK: %struct.layout1 = type <{ b8, %struct.size8_anon, i8, [2 x i8] }>
// CHECK: %struct.layout2 = type <{ b8, %struct.size8_pack1, i8 }>
