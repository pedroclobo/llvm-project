...
// CHECK-NEXT: call void @"?fin$0@0@__leave_with___finally_simple@@"(b8 noundef 0, ptr noundef %[[fp]])
...
// CHECK: [[tryleave]]
// CHECK-NEXT: %[[fp:[^ ]*]] = call ptr @llvm.localaddress()
// CHECK-NEXT: call void @"?fin$0@0@__leave_with___finally_noreturn@@"(b8 noundef 0, ptr noundef %[[fp]])
...
// CHECK: [[tryleave]]
// CHECK-NEXT: %[[fp:[^ ]*]] = call ptr @llvm.localaddress()
// CHECK-NEXT: call void @"?fin$0@0@__leave_with___finally@@"(b8 noundef 0, ptr noundef %[[fp]])
...
// CHECK: [[g1_cont1]]
// CHECK-NEXT: %[[fp:[^ ]*]] = call ptr @llvm.localaddress()
// CHECK-NEXT: invoke void @"?fin$0@0@nested___except___finally@@"(b8 noundef 0, ptr noundef %[[fp]])
...
// CHECK-NEXT: %[[fp:[^ ]*]] = call ptr @llvm.localaddress()
// CHECK-NEXT: invoke void @"?fin$0@0@nested___except___finally@@"(b8 noundef 1, ptr noundef %[[fp]])
...
// CHECK-LABEL: define internal void @"?fin$0@0@nested___except___finally@@"(b8 noundef %abnormal_termination, ptr noundef %frame_pointer)
// CHECK: call void @g()
// CHECK: unreachable
...
// CHECK-NEXT: call void @"?fin$0@0@nested___finally___except@@"(b8 noundef 0, ptr noundef %[[fp]])
// CHECK-NEXT: ret i32 1

// CHECK: [[g2_lpad]]
// CHECK: cleanuppad
// CHECK: %[[fp:[^ ]*]] = call ptr @llvm.localaddress()
// CHECK-NEXT: call void @"?fin$0@0@nested___finally___except@@"(b8 noundef 1, ptr noundef %[[fp]])
// CHECK: cleanupret {{.*}} unwind to caller

// CHECK-LABEL: define internal void @"?fin$0@0@nested___finally___except@@"(b8 noundef %abnormal_termination, ptr noundef %frame_pointer)
// CHECK: ret void
...
// CHECK: store i32 16, ptr %[[myres:[^ ]*]],
// CHECK: %[[fp:[^ ]*]] = call ptr @llvm.localaddress()
// CHECK-NEXT: invoke void @"?fin$1@0@nested___finally___finally@@"(b8 noundef 0, ptr noundef %[[fp]])
// CHECK-NEXT:       to label %[[finally_cont:.*]] unwind label %[[g2_lpad:.*]]

// CHECK: [[finally_cont]]
// CHECK: store i32 51, ptr %[[myres]]
// CHECK: %[[fp:[^ ]*]] = call ptr @llvm.localaddress()
// CHECK-NEXT: call void @"?fin$0@0@nested___finally___finally@@"(b8 noundef 0, ptr noundef %[[fp]])
// CHECK-NEXT: ret i32 1

// CHECK: [[g1_lpad]]
// CHECK-NEXT: %[[padtoken:[^ ]*]] = cleanuppad within none []
// CHECK-NEXT: %[[fp:[^ ]*]] = call ptr @llvm.localaddress()
// CHECK-NEXT: invoke void @"?fin$1@0@nested___finally___finally@@"(b8 noundef 1, ptr noundef %[[fp]])
...
// CHECK-NEXT: %[[padtoken:[^ ]*]] = cleanuppad within none []
// CHECK-NEXT: %[[fp:[^ ]*]] = call ptr @llvm.localaddress()
// CHECK-NEXT: call void @"?fin$0@0@nested___finally___finally@@"(b8 noundef 1, ptr noundef %[[fp]])
// CHECK: cleanupret from %[[padtoken]] unwind to caller

// CHECK-LABEL: define internal void @"?fin$0@0@nested___finally___finally@@"(b8 noundef %abnormal_termination, ptr noundef %frame_pointer)
// CHECK: ret void

// CHECK-LABEL: define internal void @"?fin$1@0@nested___finally___finally@@"(b8 noundef %abnormal_termination, ptr noundef %frame_pointer)
// CHECK: call void @g()
// CHECK: unreachable
