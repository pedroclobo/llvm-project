...
// CHECK-LABEL: define internal void @"?fin$0@0@main@@"({{b8 noundef( zeroext)?}} %abnormal_termination, ptr noundef %frame_pointer)
// CHECK: call void @"?fin$1@0@main@@"({{b8 noundef( zeroext)?}} 0, ptr noundef %frame_pointer)
int
main(void) {
  int Check = 0;
  __try {
