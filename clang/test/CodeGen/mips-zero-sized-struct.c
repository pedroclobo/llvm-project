...
// O32: define{{.*}} void @fn28(ptr dead_on_unwind noalias writable sret(%struct.T2) align 1 %agg.result, b8 noundef signext %arg0)
// N32: define{{.*}} void @fn28(b8 noundef signext %arg0)
// N64: define{{.*}} void @fn28(b8 noundef signext %arg0)
