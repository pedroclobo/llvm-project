...
// CHECK: define{{.*}}b8 @test_InterlockedExchange8(ptr{{[a-z_ ]*}}%value, b8{{[a-z_ ]*}}%mask){{.*}}{
// CHECK:   [[CAST:%[0-9]+]] = bytecast exact b8 %mask to i8
...
// CHECK: define{{.*}}b8 @test_InterlockedExchangeAdd8(ptr{{[a-z_ ]*}}%value, b8{{[a-z_ ]*}}%mask){{.*}}{
// CHECK:   [[CAST:%[0-9]+]] = bytecast exact b8 %mask to i8
...
// CHECK: define{{.*}}b8 @test_InterlockedExchangeSub8(ptr{{[a-z_ ]*}}%value, b8{{[a-z_ ]*}}%mask){{.*}}{
// CHECK:   [[CAST:%[0-9]+]] = bytecast exact b8 %mask to i8
...
// CHECK: define{{.*}}b8 @test_InterlockedOr8(ptr{{[a-z_ ]*}}%value, b8{{[a-z_ ]*}}%mask){{.*}}{
// CHECK:   [[CAST:%[0-9]+]] = bytecast exact b8 %mask to i8
...
// CHECK: define{{.*}}b8 @test_InterlockedXor8(ptr{{[a-z_ ]*}}%value, b8{{[a-z_ ]*}}%mask){{.*}}{
...
// CHECK: define{{.*}}b8 @test_InterlockedAnd8(ptr{{[a-z_ ]*}}%value, b8{{[a-z_ ]*}}%mask){{.*}}{
