...
uint8x16_t test_vaeseq_u8(uint8x16_t data, uint8x16_t key) {
  ...
  // CHECK: %0 = bytecast <16 x b8> %data to <16 x i8>
  // CHECK: %1 = bytecast <16 x b8> %key to <16 x i8>
  // CHECK: call <16 x i8> @llvm.{{arm.neon|aarch64.crypto}}.aese(<16 x i8> %0, <16 x i8> %1)
}
...
uint8x16_t test_vaesdq_u8(uint8x16_t data, uint8x16_t key) {
  ...
  // CHECK: %0 = bytecast <16 x b8> %data to <16 x i8>
  // CHECK: %1 = bytecast <16 x b8> %key to <16 x i8>
  // CHECK: call <16 x i8> @llvm.{{arm.neon|aarch64.crypto}}.aesd(<16 x i8> %0, <16 x i8> %1)
}
...
uint8x16_t test_vaesmcq_u8(uint8x16_t data) {
  ...
  // CHECK: %0 = bytecast <16 x b8> %data to <16 x i8>
  // CHECK: call <16 x i8> @llvm.{{arm.neon|aarch64.crypto}}.aesmc(<16 x i8> %0)
}
...
uint8x16_t test_vaesimcq_u8(uint8x16_t data) {
  ...
  // CHECK: %0 = bytecast <16 x b8> %data to <16 x i8>
  // CHECK: call <16 x i8> @llvm.{{arm.neon|aarch64.crypto}}.aesimc(<16 x i8> %0)
}
