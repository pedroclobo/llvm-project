...
void test1(void) {
  // CHECK:     = call ptr @__strcpy_chk(ptr getelementptr inbounds ([63 x b8], ptr @gbuf, i64 0, i64 4), ptr @.str, i64 59)
...
void test3(void) {
  // CHECK:     = call ptr @__strcpy_chk(ptr getelementptr inbounds ([63 x b8], ptr @gbuf, i64 0, i64 100), ptr @.str, i64 0)
  strcpy(&gbuf[100], "Hi there");
}

// CHECK-LABEL: define{{.*}} void @test4
void test4(void) {
  // CHECK:     = call ptr @__strcpy_chk(ptr getelementptr inbounds ([63 x b8], ptr @gbuf, i64 0, i64 -1), ptr @.str, i64 0)
