...
// CHECK: store b8 bitcast (i8 5 to b8), ptr %{{.*}}, align 1, !tbaa [[TAG_i8:!.*]]
// CHECK: store b8 bitcast (i8 0 to b8), ptr %{{.*}}, align 1, !tbaa [[TAG_i8]]
// CHECK: load b8, ptr %{{.*}}, align 1, !tbaa [[TAG_i8]]
// PATH-LABEL: define{{.*}} b8 @g3(
// PATH: store b8 bitcast (i8 5 to b8), ptr %{{.*}}, align 1, !tbaa [[TAG_i8:!.*]]
// PATH: store b8 bitcast (i8 0 to b8), ptr %{{.*}}, align 1, !tbaa [[TAG_i8]]
