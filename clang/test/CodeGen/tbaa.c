...
// CHECK: store b8 5, ptr %{{.*}}, align 1, !tbaa [[TAG_i8:!.*]]
// CHECK: store b8 0, ptr %{{.*}}, align 1, !tbaa [[TAG_i8]]
// CHECK: load b8, ptr %{{.*}}, align 1, !tbaa [[TAG_i8]]
// PATH-LABEL: define{{.*}} b8 @g3(
// PATH: store b8 5, ptr %{{.*}}, align 1, !tbaa [[TAG_i8:!.*]]
// PATH: store b8 0, ptr %{{.*}}, align 1, !tbaa [[TAG_i8]]
