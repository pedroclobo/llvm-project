...
// CHECK: [[c0:%.+]] = bytecast <8 x b8> [[t0]] to <8 x i8>
...
// CHECK: [[ext8:%.+]] = bytecast <8 x b8> [[splat_splat]] to <8 x i8>
// CHECK: [[t7:%.+]] = load <8 x b8>, ptr {{@.+}},
// CHECK: [[ext9:%.+]] = bytecast <8 x b8> [[t7]] to <8 x i8>
...
// CHECK: [[ext32:%.+]] = bytecast <8 x b8> [[t17]] to <8 x i8>
// CHECK: [[t18:%.+]] = load <8 x b8>, ptr {{@.+}},
// CHECK: [[ext33:%.+]] = bytecast <8 x b8> [[t18]] to <8 x i8>
