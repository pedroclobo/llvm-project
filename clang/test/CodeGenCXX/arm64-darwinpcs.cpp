...
// CHECK: define{{.*}} void @_Z15test_extensionsbcs(i1 noundef %a, b8 noundef %b, i16 noundef %c)
// CHECK-DARWIN: define{{.*}} void @_Z15test_extensionsbcs(i1 noundef zeroext %a, b8 noundef signext %b, i16 noundef signext %c)
