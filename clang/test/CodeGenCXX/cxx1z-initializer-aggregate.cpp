...
namespace Constant {
  ...
  C c1 = {};
  C c2 = {1};
  // CHECK: @_ZN8Constant2c1E ={{.*}} global { b8 } zeroinitializer, align 1
  // CHECK: @_ZN8Constant2c2E ={{.*}} global { b8 } { b8 1 }, align 1

  // Test packing bases into tail padding.
  D d1 = {};
  D d2 = {1, 2, 3};
  D d3 = {1};
  // CHECK: @_ZN8Constant2d1E ={{.*}} global { i32, b8, b8 } zeroinitializer, align 4
  // CHECK: @_ZN8Constant2d2E ={{.*}} global { i32, b8, b8 } { i32 1, b8 2, b8 3 }, align 4
  // CHECK: @_ZN8Constant2d3E ={{.*}} global { i32, b8, b8 } { i32 1, b8 0, b8 0 }, align 4
