...
// ITANIUM-SAME: = linkonce_odr constant { <{ [11 x b8], [21 x b8] }> } { <{ [11 x b8], [21 x b8] }> <{ [11 x b8] c"hello world", [21 x b8] zeroinitializer }> }, comdat
// MSABI-SAME: = linkonce_odr dso_local constant { <{ [11 x b8], [21 x b8] }> } { <{ [11 x b8], [21 x b8] }> <{ [11 x b8] c"hello world", [21 x b8] zeroinitializer }> }, comdat
...
// CHECK: internal constant { <{ [10 x b8], [22 x b8] }> } { <{ [10 x b8], [22 x b8] }> <{ [10 x b8] c"hello anon", [22 x b8] zeroinitializer }> }
// CHECK-NOT: comdat
// ITANIUM: @r
// MSABI: @"?r@@3PEBDEB"
