...
// CHECK: store volatile <4 x i8> <i8 0, i8 0, i8 0, i8 poison>, ptr addrspace(3) @local_memory_alignment_global.lds_v3i8, align 4
...
// CHECK: store volatile <4 x i16> <i16 0, i16 0, i16 0, i16 poison>, ptr addrspace(3) @local_memory_alignment_global.lds_v3i16, align 8
...
// CHECK: store volatile <4 x i64> <i64 0, i64 0, i64 0, i64 poison>, ptr addrspace(3) @local_memory_alignment_global.lds_v3i64, align 32
...
// CHECK: store volatile <4 x half> <half 0xH0000, half 0xH0000, half 0xH0000, half poison>, ptr addrspace(3) @local_memory_alignment_global.lds_v3f16, align 8
...
// CHECK: store volatile <4 x double> <double 0.000000e+00, double 0.000000e+00, double 0.000000e+00, double poison>, ptr addrspace(3) @local_memory_alignment_global.lds_v3f64, align 32
...
// CHECK: store volatile <4 x i8> <i8 0, i8 0, i8 0, i8 poison>, ptr addrspace(5) %arraydecay{{[0-9]+}}, align 4
...
// CHECK: store volatile <4 x i16> <i16 0, i16 0, i16 0, i16 poison>, ptr addrspace(5) %arraydecay{{[0-9]+}}, align 8
...
// CHECK: store volatile <4 x i64> <i64 0, i64 0, i64 0, i64 poison>, ptr addrspace(5) %arraydecay{{[0-9]+}}, align 32
...
// CHECK: store volatile <4 x half> <half 0xH0000, half 0xH0000, half 0xH0000, half poison>, ptr addrspace(5) %arraydecay{{[0-9]+}}, align 8
...
// CHECK: store volatile <4 x double> <double 0.000000e+00, double 0.000000e+00, double 0.000000e+00, double poison>, ptr addrspace(5) %arraydecay{{[0-9]+}}, align 32
