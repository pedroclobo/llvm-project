...
// CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact b8 41 to i8
// CHECK-NEXT:    store i8 [[TMP3]], ptr addrspace(4) [[TMP2]], align 1
...
// CHECK-NEXT:    [[TMP4:%.*]] = load ptr addrspace(4), ptr addrspace(4) [[CPP_ASCAST]], align 8
// CHECK-NEXT:    [[TMP5:%.*]] = bytecast exact b8 43 to i8
// CHECK-NEXT:    store i8 [[TMP5]], ptr addrspace(4) [[TMP4]], align 1
...
// CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds b8, ptr addrspace(4) [[TMP8]], i64 0
// CHECK-NEXT:    [[TMP9:%.*]] = load b8, ptr addrspace(4) [[ARRAYIDX]], align 1
// CHECK-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP9]] to i8
...
// CHECK-NEXT:    [[CMP7:%.*]] = icmp sgt i32 [[TMP12]], 2
// CHECK-NEXT:    [[TMP13:%.*]] = zext i1 [[CMP7]] to i64
