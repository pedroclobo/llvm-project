...
// CHECK1-NEXT:    [[ARRAYIDX1:%.*]] = getelementptr inbounds b8, ptr [[TMP13]], i64 0
// CHECK1-NEXT:    store b8 [[TMP11]], ptr [[ARRAYIDX1]], align 1
// CHECK1-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP15:%.*]] = load i32, ptr [[TMP14]], align 4
// CHECK1-NEXT:    [[TMP16:%.*]] = call i32 @__kmpc_cancel_barrier(ptr @[[GLOB3:[0-9]+]], i32 [[TMP15]])
// CHECK1-NEXT:    [[TMP17:%.*]] = icmp ne i32 [[TMP16]], 0
// CHECK1-NEXT:    br i1 [[TMP17]], label [[DOTCANCEL_EXIT2:%.*]], label [[DOTCANCEL_CONTINUE3:%.*]]
// CHECK1:       .cancel.exit2:
// CHECK1-NEXT:    br label [[RETURN]]
// CHECK1:       .cancel.continue3:
// CHECK1-NEXT:    [[TMP18:%.*]] = load i32, ptr [[TMP1]], align 4
// CHECK1-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[TMP0]], align 8
// CHECK1-NEXT:    [[ARRAYIDX4:%.*]] = getelementptr inbounds ptr, ptr [[TMP19]], i64 0
// CHECK1-NEXT:    [[TMP20:%.*]] = load ptr, ptr [[ARRAYIDX4]], align 8
// CHECK1-NEXT:    [[ARRAYIDX5:%.*]] = getelementptr inbounds b8, ptr [[TMP20]], i64 0
// CHECK1-NEXT:    [[TMP21:%.*]] = load b8, ptr [[ARRAYIDX5]], align 1
// CHECK1-NEXT:    [[CONV6:%.*]] = bytecast b8 [[TMP21]] to i8
// CHECK1-NEXT:    [[CONV7:%.*]] = sext i8 [[CONV6]] to i32
// CHECK1-NEXT:    [[ADD:%.*]] = add nsw i32 [[CONV7]], [[TMP18]]
// CHECK1-NEXT:    [[CONV8:%.*]] = trunc i32 [[ADD]] to i8
// CHECK1-NEXT:    [[TMP22:%.*]] = bitcast i8 [[CONV8]] to b8
// CHECK1-NEXT:    store b8 [[TMP22]], ptr [[ARRAYIDX5]], align 1
// CHECK1-NEXT:    br label [[RETURN]]
// CHECK1:       return:
...
// CHECK3-NEXT:    [[P_LASTITER34:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[P_LOWERBOUND35:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[P_UPPERBOUND36:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[P_STRIDE37:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[DOTOMP_IV:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[TMP:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[DOTCAPTURE_EXPR_40:%.*]] = alloca i32, align 4
...
// CHECK3-NEXT:    call void @__kmpc_for_static_init_4u(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM15]], i32 34, ptr [[P_LASTITER]], ptr [[P_LOWERBOUND]], ptr [[P_UPPERBOUND]], ptr [[P_STRIDE]], i32 1, i32 0)
...
// CHECK3-NEXT:    [[TMP7:%.*]] = call i32 @__kmpc_cancel(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM13]], i32 3)
...
// CHECK3-NEXT:    call void @__kmpc_for_static_fini(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM15]])
// CHECK3-NEXT:    [[OMP_GLOBAL_THREAD_NUM16:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB1]])
// CHECK3-NEXT:    call void @__kmpc_barrier(ptr @[[GLOB3:[0-9]+]], i32 [[OMP_GLOBAL_THREAD_NUM16]])
// CHECK3-NEXT:    br label [[OMP_SECTION_LOOP_AFTER:%.*]]
// CHECK3:       omp_section_loop.after:
// CHECK3-NEXT:    br label [[OMP_SECTION_LOOP_PREHEADER17:%.*]]
// CHECK3:       omp_section_loop.preheader17:
// CHECK3-NEXT:    store i32 0, ptr [[P_LOWERBOUND35]], align 4
// CHECK3-NEXT:    store i32 1, ptr [[P_UPPERBOUND36]], align 4
// CHECK3-NEXT:    store i32 1, ptr [[P_STRIDE37]], align 4
// CHECK3-NEXT:    [[OMP_GLOBAL_THREAD_NUM38:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB1]])
// CHECK3-NEXT:    call void @__kmpc_for_static_init_4u(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM38]], i32 34, ptr [[P_LASTITER34]], ptr [[P_LOWERBOUND35]], ptr [[P_UPPERBOUND36]], ptr [[P_STRIDE37]], i32 1, i32 0)
// CHECK3-NEXT:    [[TMP9:%.*]] = load i32, ptr [[P_LOWERBOUND35]], align 4
// CHECK3-NEXT:    [[TMP10:%.*]] = load i32, ptr [[P_UPPERBOUND36]], align 4
// CHECK3-NEXT:    [[TMP11:%.*]] = sub i32 [[TMP10]], [[TMP9]]
// CHECK3-NEXT:    [[TMP12:%.*]] = add i32 [[TMP11]], 1
// CHECK3-NEXT:    br label [[OMP_SECTION_LOOP_HEADER18:%.*]]
// CHECK3:       omp_section_loop.header18:
// CHECK3-NEXT:    [[OMP_SECTION_LOOP_IV24:%.*]] = phi i32 [ 0, [[OMP_SECTION_LOOP_PREHEADER17]] ], [ [[OMP_SECTION_LOOP_NEXT26:%.*]], [[OMP_SECTION_LOOP_INC21:%.*]] ]
// CHECK3-NEXT:    br label [[OMP_SECTION_LOOP_COND19:%.*]]
// CHECK3:       omp_section_loop.cond19:
// CHECK3-NEXT:    [[OMP_SECTION_LOOP_CMP25:%.*]] = icmp ult i32 [[OMP_SECTION_LOOP_IV24]], [[TMP12]]
// CHECK3-NEXT:    br i1 [[OMP_SECTION_LOOP_CMP25]], label [[OMP_SECTION_LOOP_BODY20:%.*]], label [[OMP_SECTION_LOOP_EXIT22:%.*]]
// CHECK3:       omp_section_loop.body20:
// CHECK3-NEXT:    [[TMP13:%.*]] = add i32 [[OMP_SECTION_LOOP_IV24]], [[TMP9]]
// CHECK3-NEXT:    [[TMP14:%.*]] = mul i32 [[TMP13]], 1
// CHECK3-NEXT:    [[TMP15:%.*]] = add i32 [[TMP14]], 0
// CHECK3-NEXT:    switch i32 [[TMP15]], label [[OMP_SECTION_LOOP_BODY20_SECTIONS_AFTER:%.*]] [
// CHECK3-NEXT:      i32 0, label [[OMP_SECTION_LOOP_BODY_CASE27:%.*]]
// CHECK3-NEXT:      i32 1, label [[OMP_SECTION_LOOP_BODY_CASE30:%.*]]
// CHECK3-NEXT:    ]
// CHECK3:       omp_section_loop.body.case27:
// CHECK3-NEXT:    [[OMP_GLOBAL_THREAD_NUM28:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB1]])
// CHECK3-NEXT:    [[TMP16:%.*]] = call i32 @__kmpc_cancel(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM28]], i32 3)
// CHECK3-NEXT:    [[TMP17:%.*]] = icmp eq i32 [[TMP16]], 0
// CHECK3-NEXT:    br i1 [[TMP17]], label [[OMP_SECTION_LOOP_BODY_CASE27_SPLIT:%.*]], label [[OMP_SECTION_LOOP_BODY_CASE27_CNCL:%.*]]
// CHECK3:       omp_section_loop.body.case27.split:
// CHECK3-NEXT:    br label [[OMP_SECTION_LOOP_BODY_CASE27_SECTION_AFTER:%.*]]
// CHECK3:       omp_section_loop.body.case27.section.after:
// CHECK3-NEXT:    br label [[OMP_SECTION_LOOP_BODY20_SECTIONS_AFTER]]
// CHECK3:       omp_section_loop.body.case30:
// CHECK3-NEXT:    [[OMP_GLOBAL_THREAD_NUM32:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB1]])
// CHECK3-NEXT:    [[TMP18:%.*]] = call i32 @__kmpc_cancel(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM32]], i32 3)
// CHECK3-NEXT:    [[TMP19:%.*]] = icmp eq i32 [[TMP18]], 0
// CHECK3-NEXT:    br i1 [[TMP19]], label [[OMP_SECTION_LOOP_BODY_CASE30_SPLIT:%.*]], label [[OMP_SECTION_LOOP_BODY_CASE30_CNCL:%.*]]
// CHECK3:       omp_section_loop.body.case30.split:
// CHECK3-NEXT:    br label [[OMP_SECTION_LOOP_BODY_CASE30_SECTION_AFTER31:%.*]]
// CHECK3:       omp_section_loop.body.case30.section.after31:
// CHECK3-NEXT:    br label [[OMP_REGION_FINALIZE:%.*]]
// CHECK3:       omp_region.finalize:
// CHECK3-NEXT:    br label [[OMP_SECTION_LOOP_BODY_CASE30_SECTION_AFTER:%.*]]
// CHECK3:       omp_section_loop.body.case30.section.after:
// CHECK3-NEXT:    br label [[OMP_SECTION_LOOP_BODY20_SECTIONS_AFTER]]
// CHECK3:       omp_section_loop.body20.sections.after:
// CHECK3-NEXT:    br label [[OMP_SECTION_LOOP_INC21]]
// CHECK3:       omp_section_loop.inc21:
// CHECK3-NEXT:    [[OMP_SECTION_LOOP_NEXT26]] = add nuw i32 [[OMP_SECTION_LOOP_IV24]], 1
// CHECK3-NEXT:    br label [[OMP_SECTION_LOOP_HEADER18]]
// CHECK3:       omp_section_loop.exit22:
// CHECK3-NEXT:    call void @__kmpc_for_static_fini(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM38]])
// CHECK3-NEXT:    [[OMP_GLOBAL_THREAD_NUM39:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB1]])
// CHECK3-NEXT:    call void @__kmpc_barrier(ptr @[[GLOB3]], i32 [[OMP_GLOBAL_THREAD_NUM39]])
// CHECK3-NEXT:    br label [[OMP_SECTION_LOOP_AFTER23:%.*]]
// CHECK3:       omp_section_loop.after23:
...
// CHECK3-NEXT:    [[SUB41:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK3-NEXT:    store i32 [[SUB41]], ptr [[DOTCAPTURE_EXPR_40]], align 4
...
// CHECK3-NEXT:    [[TMP23:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_40]], align 4
// CHECK3-NEXT:    store i32 [[TMP23]], ptr [[DOTOMP_UB]], align 4
// CHECK3-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4
// CHECK3-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK3-NEXT:    [[OMP_GLOBAL_THREAD_NUM43:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB6:[0-9]+]])
// CHECK3-NEXT:    call void @__kmpc_for_static_init_4(ptr @[[GLOB4:[0-9]+]], i32 [[OMP_GLOBAL_THREAD_NUM43]], i32 34, ptr [[DOTOMP_IS_LAST]], ptr [[DOTOMP_LB]], ptr [[DOTOMP_UB]], ptr [[DOTOMP_STRIDE]], i32 1, i32 1)
// CHECK3-NEXT:    [[TMP24:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK3-NEXT:    [[TMP25:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_40]], align 4
// CHECK3-NEXT:    [[CMP44:%.*]] = icmp sgt i32 [[TMP24]], [[TMP25]]
// CHECK3-NEXT:    br i1 [[CMP44]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK3:       cond.true:
// CHECK3-NEXT:    [[TMP26:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_40]], align 4
...
// CHECK3-NEXT:    [[CMP45:%.*]] = icmp sle i32 [[TMP29]], [[TMP30]]
// CHECK3-NEXT:    br i1 [[CMP45]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK3:       omp.inner.for.body:
// CHECK3-NEXT:    [[TMP31:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK3-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP31]], 1
// CHECK3-NEXT:    [[ADD46:%.*]] = add nsw i32 0, [[MUL]]
// CHECK3-NEXT:    store i32 [[ADD46]], ptr [[I42]], align 4
// CHECK3-NEXT:    [[TMP32:%.*]] = load float, ptr @flag, align 4
// CHECK3-NEXT:    [[TOBOOL47:%.*]] = fcmp une float [[TMP32]], 0.000000e+00
// CHECK3-NEXT:    br i1 [[TOBOOL47]], label [[OMP_IF_THEN:%.*]], label [[OMP_IF_ELSE:%.*]]
// CHECK3:       omp_if.then:
// CHECK3-NEXT:    [[OMP_GLOBAL_THREAD_NUM48:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB8:[0-9]+]])
// CHECK3-NEXT:    [[TMP33:%.*]] = call i32 @__kmpc_cancel(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM48]], i32 2)
...
// CHECK3:       omp_section_loop.body.case27.cncl:
// CHECK3-NEXT:    br label [[OMP_SECTION_LOOP_EXIT22]]
// CHECK3:       omp_section_loop.body.case30.cncl:
// CHECK3-NEXT:    br label [[OMP_REGION_FINALIZE]]
...
// CHECK3-NEXT:    [[ADD49:%.*]] = add nsw i32 [[TMP35]], 1
// CHECK3-NEXT:    store i32 [[ADD49]], ptr [[DOTOMP_IV]], align 4
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK3:       omp.inner.for.end:
// CHECK3-NEXT:    br label [[OMP_LOOP_EXIT:%.*]]
// CHECK3:       omp.loop.exit:
// CHECK3-NEXT:    [[OMP_GLOBAL_THREAD_NUM51:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB10:[0-9]+]])
// CHECK3-NEXT:    call void @__kmpc_for_static_fini(ptr @[[GLOB4]], i32 [[OMP_GLOBAL_THREAD_NUM51]])
// CHECK3-NEXT:    br label [[OMP_PRECOND_END]]
// CHECK3:       cancel.exit:
// CHECK3-NEXT:    [[OMP_GLOBAL_THREAD_NUM50:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB10]])
// CHECK3-NEXT:    call void @__kmpc_for_static_fini(ptr @[[GLOB4]], i32 [[OMP_GLOBAL_THREAD_NUM50]])
// CHECK3-NEXT:    br label [[CANCEL_CONT:%.*]]
// CHECK3:       omp.precond.end:
// CHECK3-NEXT:    br label [[CANCEL_CONT]]
// CHECK3:       cancel.cont:
// CHECK3-NEXT:    [[OMP_GLOBAL_THREAD_NUM52:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB1]])
// CHECK3-NEXT:    call void @__kmpc_barrier(ptr @[[GLOB3]], i32 [[OMP_GLOBAL_THREAD_NUM52]])
// CHECK3-NEXT:    [[OMP_GLOBAL_THREAD_NUM53:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB14:[0-9]+]])
// CHECK3-NEXT:    [[TMP36:%.*]] = call ptr @__kmpc_omp_task_alloc(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM53]], i32 1, i64 40, i64 1, ptr @.omp_task_entry.)
// CHECK3-NEXT:    [[TMP37:%.*]] = getelementptr inbounds nuw [[STRUCT_KMP_TASK_T_WITH_PRIVATES:%.*]], ptr [[TMP36]], i32 0, i32 0
// CHECK3-NEXT:    [[OMP_GLOBAL_THREAD_NUM54:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB14]])
// CHECK3-NEXT:    [[TMP38:%.*]] = call i32 @__kmpc_omp_task(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM54]], ptr [[TMP36]])
...
// CHECK3-NEXT:    br i1 [[TOBOOL]], label [[TMP18:%.*]], label [[TMP3:%.*]]
// CHECK3:       3:
...
// CHECK3-NEXT:    [[TMP8:%.*]] = bitcast i8 [[CONV]] to b8
// CHECK3-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[LOADGEP_ARGV_ADDR]], align 8
// CHECK3-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds ptr, ptr [[TMP9]], i64 0
// CHECK3-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[ARRAYIDX]], align 8
// CHECK3-NEXT:    [[ARRAYIDX5:%.*]] = getelementptr inbounds b8, ptr [[TMP10]], i64 0
// CHECK3-NEXT:    store b8 [[TMP8]], ptr [[ARRAYIDX5]], align 1
// CHECK3-NEXT:    [[OMP_GLOBAL_THREAD_NUM6:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB1]])
// CHECK3-NEXT:    [[TMP11:%.*]] = call i32 @__kmpc_cancel_barrier(ptr @[[GLOB2:[0-9]+]], i32 [[OMP_GLOBAL_THREAD_NUM6]])
// CHECK3-NEXT:    [[TMP12:%.*]] = icmp eq i32 [[TMP11]], 0
// CHECK3-NEXT:    br i1 [[TMP12]], label [[DOTCONT:%.*]], label [[DOTCNCL7:%.*]]
// CHECK3:       .cncl7:
// CHECK3-NEXT:    br label [[DOTFINI]]
// CHECK3:       .cont:
// CHECK3-NEXT:    [[TMP13:%.*]] = load i32, ptr [[LOADGEP_ARGC_ADDR]], align 4
// CHECK3-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[LOADGEP_ARGV_ADDR]], align 8
// CHECK3-NEXT:    [[ARRAYIDX8:%.*]] = getelementptr inbounds ptr, ptr [[TMP14]], i64 0
// CHECK3-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[ARRAYIDX8]], align 8
// CHECK3-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds b8, ptr [[TMP15]], i64 0
// CHECK3-NEXT:    [[TMP16:%.*]] = load b8, ptr [[ARRAYIDX9]], align 1
// CHECK3-NEXT:    [[CONV10:%.*]] = bytecast b8 [[TMP16]] to i8
// CHECK3-NEXT:    [[CONV11:%.*]] = sext i8 [[CONV10]] to i32
// CHECK3-NEXT:    [[ADD:%.*]] = add nsw i32 [[CONV11]], [[TMP13]]
// CHECK3-NEXT:    [[CONV12:%.*]] = trunc i32 [[ADD]] to i8
// CHECK3-NEXT:    [[TMP17:%.*]] = bitcast i8 [[CONV12]] to b8
// CHECK3-NEXT:    store b8 [[TMP17]], ptr [[ARRAYIDX9]], align 1
...
// CHECK3-NEXT:    [[TMP19:%.*]] = call i32 @__kmpc_cancel(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM2]], i32 1)
// CHECK3-NEXT:    [[TMP20:%.*]] = icmp eq i32 [[TMP19]], 0
// CHECK3-NEXT:    br i1 [[TMP20]], label [[DOTSPLIT3:%.*]], label [[DOTCNCL4:%.*]]
// CHECK3:       .cncl4:
// CHECK3-NEXT:    br label [[DOTFINI]]
// CHECK3:       .split3:
// CHECK3-NEXT:    br label [[TMP6]]
