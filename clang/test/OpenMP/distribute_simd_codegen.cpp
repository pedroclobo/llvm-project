...
// CHECK1-NEXT:    [[I:%.*]] = alloca b8, align 1
...
// CHECK1-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK1-NEXT:    [[DOTCAPTURE_EXPR_1:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[KERNEL_ARGS:%.*]] = alloca [[STRUCT___TGT_KERNEL_ARGUMENTS:%.*]], align 8
// CHECK1-NEXT:    [[TMP0:%.*]] = bytecast exact b8 0 to i8
// CHECK1-NEXT:    store i8 [[TMP0]], ptr [[A]], align 1
// CHECK1-NEXT:    [[TMP1:%.*]] = load b8, ptr [[I]], align 1
// CHECK1-NEXT:    store b8 [[TMP1]], ptr [[I_CASTED]], align 1
// CHECK1-NEXT:    [[TMP2:%.*]] = load i64, ptr [[I_CASTED]], align 8
// CHECK1-NEXT:    [[TMP3:%.*]] = load b8, ptr [[A]], align 1
// CHECK1-NEXT:    store b8 [[TMP3]], ptr [[A_CASTED]], align 1
...
// CHECK1-NEXT:    store i64 [[TMP4]], ptr [[TMP8]], align 8
...
// CHECK1-NEXT:    [[TMP13:%.*]] = load b8, ptr [[A]], align 1
// CHECK1-NEXT:    store b8 [[TMP13]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-NEXT:    [[TMP14:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP14]] to i8
...
// CHECK1-NEXT:    [[TMP16:%.*]] = zext i32 [[ADD5]] to i64
...
// CHECK1-NEXT:    store ptr @.offload_sizes.5, ptr [[TMP21]], align 8
// CHECK1-NEXT:    [[TMP22:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 5
// CHECK1-NEXT:    store ptr @.offload_maptypes.6, ptr [[TMP22]], align 8
...
// CHECK1-NEXT:    store i64 [[TMP16]], ptr [[TMP25]], align 8
...
// CHECK1-NEXT:    [[TMP30:%.*]] = call i32 @__tgt_target_kernel(ptr @[[GLOB2]], i64 -1, i32 0, i32 1, ptr @.{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z12test_precondv_l115.region_id, ptr [[KERNEL_ARGS]])
// CHECK1-NEXT:    [[TMP31:%.*]] = icmp ne i32 [[TMP30]], 0
// CHECK1-NEXT:    br i1 [[TMP31]], label [[OMP_OFFLOAD_FAILED:%.*]], label [[OMP_OFFLOAD_CONT:%.*]]
// CHECK1:       omp_offload.failed:
// CHECK1-NEXT:    call void @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z12test_precondv_l115(i64 [[TMP2]], i64 [[TMP4]]) #[[ATTR3]]
// CHECK1-NEXT:    br label [[OMP_OFFLOAD_CONT]]
// CHECK1:       omp_offload.cont:
// CHECK1-NEXT:    ret void
//
...
// CHECK1-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK1-NEXT:    [[DOTCAPTURE_EXPR_1:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[I5:%.*]] = alloca b8, align 1
// CHECK1-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[I8:%.*]] = alloca b8, align 1
// CHECK1-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 8
...
// CHECK1-NEXT:    [[TMP2:%.*]] = load b8, ptr [[TMP1]], align 1
// CHECK1-NEXT:    store b8 [[TMP2]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-NEXT:    [[TMP3:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP3]] to i8
// CHECK1-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
// CHECK1-NEXT:    [[SUB:%.*]] = sub i32 10, [[CONV2]]
// CHECK1-NEXT:    [[SUB3:%.*]] = sub i32 [[SUB]], 1
// CHECK1-NEXT:    [[ADD:%.*]] = add i32 [[SUB3]], 1
...
// CHECK1-NEXT:    [[SUB4:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK1-NEXT:    store i32 [[SUB4]], ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK1-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-NEXT:    store b8 [[TMP4]], ptr [[I5]], align 1
// CHECK1-NEXT:    [[TMP5:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-NEXT:    [[CONV6:%.*]] = bytecast exact b8 [[TMP5]] to i8
...
// CHECK1-NEXT:    [[CMP9:%.*]] = icmp sgt i32 [[TMP9]], [[TMP10]]
...
// CHECK1:       omp.inner.for.body:
// CHECK1-NEXT:    [[TMP16:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !llvm.access.group [[ACC_GRP25]]
// CHECK1-NEXT:    [[CONV11:%.*]] = bytecast exact b8 [[TMP16]] to i8
// CHECK1-NEXT:    [[CONV12:%.*]] = sext i8 [[CONV11]] to i32
// CHECK1-NEXT:    [[TMP17:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP25]]
// CHECK1-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP17]], 1
// CHECK1-NEXT:    [[ADD13:%.*]] = add nsw i32 [[CONV12]], [[MUL]]
// CHECK1-NEXT:    [[CONV14:%.*]] = trunc i32 [[ADD13]] to i8
// CHECK1-NEXT:    [[TMP18:%.*]] = bitcast i8 [[CONV14]] to b8
// CHECK1-NEXT:    store b8 [[TMP18]], ptr [[I8]], align 1, !llvm.access.group [[ACC_GRP25]]
// CHECK1-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1:       omp.body.continue:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
// CHECK1-NEXT:    [[TMP19:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP25]]
// CHECK1-NEXT:    [[ADD15:%.*]] = add nsw i32 [[TMP19]], 1
// CHECK1-NEXT:    store i32 [[ADD15]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP25]]
...
// CHECK1:       .omp.final.then:
// CHECK1-NEXT:    [[TMP24:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-NEXT:    [[CONV16:%.*]] = bytecast exact b8 [[TMP24]] to i8
// CHECK1-NEXT:    [[CONV17:%.*]] = sext i8 [[CONV16]] to i32
// CHECK1-NEXT:    [[TMP25:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-NEXT:    [[CONV18:%.*]] = bytecast exact b8 [[TMP25]] to i8
// CHECK1-NEXT:    [[CONV19:%.*]] = sext i8 [[CONV18]] to i32
// CHECK1-NEXT:    [[SUB20:%.*]] = sub i32 10, [[CONV19]]
// CHECK1-NEXT:    [[SUB21:%.*]] = sub i32 [[SUB20]], 1
// CHECK1-NEXT:    [[ADD22:%.*]] = add i32 [[SUB21]], 1
// CHECK1-NEXT:    [[DIV23:%.*]] = udiv i32 [[ADD22]], 1
// CHECK1-NEXT:    [[MUL24:%.*]] = mul nsw i32 [[DIV23]], 1
// CHECK1-NEXT:    [[ADD25:%.*]] = add nsw i32 [[CONV17]], [[MUL24]]
// CHECK1-NEXT:    [[CONV26:%.*]] = trunc i32 [[ADD25]] to i8
// CHECK1-NEXT:    [[TMP26:%.*]] = bitcast i8 [[CONV26]] to b8
// CHECK1-NEXT:    store b8 [[TMP26]], ptr [[TMP0]], align 1
// CHECK1-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK1:       .omp.final.done:
...
// CHECK3-SAME: () #[[ATTR0]] {
// CHECK3-NEXT:  entry:
// CHECK3-NEXT:    [[A:%.*]] = alloca b8, align 1
// CHECK3-NEXT:    [[I:%.*]] = alloca b8, align 1
...
// CHECK3-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK3-NEXT:    [[DOTCAPTURE_EXPR_1:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[KERNEL_ARGS:%.*]] = alloca [[STRUCT___TGT_KERNEL_ARGUMENTS:%.*]], align 8
// CHECK3-NEXT:    [[TMP0:%.*]] = bytecast exact b8 0 to i8
// CHECK3-NEXT:    store i8 [[TMP0]], ptr [[A]], align 1
// CHECK3-NEXT:    [[TMP1:%.*]] = load b8, ptr [[I]], align 1
// CHECK3-NEXT:    store b8 [[TMP1]], ptr [[I_CASTED]], align 1
// CHECK3-NEXT:    [[TMP2:%.*]] = load i32, ptr [[I_CASTED]], align 4
// CHECK3-NEXT:    [[TMP3:%.*]] = load b8, ptr [[A]], align 1
// CHECK3-NEXT:    store b8 [[TMP3]], ptr [[A_CASTED]], align 1
...
// CHECK3-NEXT:    store i32 [[TMP4]], ptr [[TMP8]], align 4
...
// CHECK3-NEXT:    [[TMP13:%.*]] = load b8, ptr [[A]], align 1
// CHECK3-NEXT:    store b8 [[TMP13]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK3-NEXT:    [[TMP14:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK3-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP14]] to i8
...
// CHECK3-NEXT:    [[TMP16:%.*]] = zext i32 [[ADD5]] to i64
...
// CHECK3-NEXT:    store ptr @.offload_sizes.5, ptr [[TMP21]], align 4
// CHECK3-NEXT:    [[TMP22:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 5
// CHECK3-NEXT:    store ptr @.offload_maptypes.6, ptr [[TMP22]], align 4
...
// CHECK3-NEXT:    store i64 [[TMP16]], ptr [[TMP25]], align 8
...
// CHECK3-NEXT:    [[TMP30:%.*]] = call i32 @__tgt_target_kernel(ptr @[[GLOB2]], i64 -1, i32 0, i32 1, ptr @.{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z12test_precondv_l115.region_id, ptr [[KERNEL_ARGS]])
// CHECK3-NEXT:    [[TMP31:%.*]] = icmp ne i32 [[TMP30]], 0
// CHECK3-NEXT:    br i1 [[TMP31]], label [[OMP_OFFLOAD_FAILED:%.*]], label [[OMP_OFFLOAD_CONT:%.*]]
// CHECK3:       omp_offload.failed:
// CHECK3-NEXT:    call void @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z12test_precondv_l115(i32 [[TMP2]], i32 [[TMP4]]) #[[ATTR3]]
// CHECK3-NEXT:    br label [[OMP_OFFLOAD_CONT]]
// CHECK3:       omp_offload.cont:
// CHECK3-NEXT:    ret void
//
...
// CHECK3-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK3-NEXT:    [[DOTCAPTURE_EXPR_1:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[I5:%.*]] = alloca b8, align 1
// CHECK3-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[I8:%.*]] = alloca b8, align 1
// CHECK3-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK3-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 4
...
// CHECK3-NEXT:    [[TMP2:%.*]] = load b8, ptr [[TMP1]], align 1
// CHECK3-NEXT:    store b8 [[TMP2]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK3-NEXT:    [[TMP3:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK3-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP3]] to i8
// CHECK3-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
// CHECK3-NEXT:    [[SUB:%.*]] = sub i32 10, [[CONV2]]
// CHECK3-NEXT:    [[SUB3:%.*]] = sub i32 [[SUB]], 1
// CHECK3-NEXT:    [[ADD:%.*]] = add i32 [[SUB3]], 1
...
// CHECK3-NEXT:    [[SUB4:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK3-NEXT:    store i32 [[SUB4]], ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK3-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK3-NEXT:    store b8 [[TMP4]], ptr [[I5]], align 1
// CHECK3-NEXT:    [[TMP5:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK3-NEXT:    [[CONV6:%.*]] = bytecast exact b8 [[TMP5]] to i8
...
// CHECK3-NEXT:    [[CMP9:%.*]] = icmp sgt i32 [[TMP9]], [[TMP10]]
// CHECK3-NEXT:    br i1 [[CMP9]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK3:       cond.true:
...
// CHECK3:       omp.inner.for.body:
// CHECK3-NEXT:    [[TMP16:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !llvm.access.group [[ACC_GRP26]]
// CHECK3-NEXT:    [[CONV11:%.*]] = bytecast exact b8 [[TMP16]] to i8
// CHECK3-NEXT:    [[CONV12:%.*]] = sext i8 [[CONV11]] to i32
// CHECK3-NEXT:    [[TMP17:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP26]]
// CHECK3-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP17]], 1
// CHECK3-NEXT:    [[ADD13:%.*]] = add nsw i32 [[CONV12]], [[MUL]]
// CHECK3-NEXT:    [[CONV14:%.*]] = trunc i32 [[ADD13]] to i8
// CHECK3-NEXT:    [[TMP18:%.*]] = bitcast i8 [[CONV14]] to b8
// CHECK3-NEXT:    store b8 [[TMP18]], ptr [[I8]], align 1, !llvm.access.group [[ACC_GRP26]]
// CHECK3-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK3:       omp.body.continue:
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
// CHECK3-NEXT:    [[TMP19:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP26]]
// CHECK3-NEXT:    [[ADD15:%.*]] = add nsw i32 [[TMP19]], 1
// CHECK3-NEXT:    store i32 [[ADD15]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP26]]
...
// CHECK3:       .omp.final.then:
// CHECK3-NEXT:    [[TMP24:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK3-NEXT:    [[CONV16:%.*]] = bytecast exact b8 [[TMP24]] to i8
// CHECK3-NEXT:    [[CONV17:%.*]] = sext i8 [[CONV16]] to i32
// CHECK3-NEXT:    [[TMP25:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK3-NEXT:    [[CONV18:%.*]] = bytecast exact b8 [[TMP25]] to i8
// CHECK3-NEXT:    [[CONV19:%.*]] = sext i8 [[CONV18]] to i32
// CHECK3-NEXT:    [[SUB20:%.*]] = sub i32 10, [[CONV19]]
...
// CHECK3-NEXT:    [[ADD25:%.*]] = add nsw i32 [[CONV17]], [[MUL24]]
// CHECK3-NEXT:    [[CONV26:%.*]] = trunc i32 [[ADD25]] to i8
// CHECK3-NEXT:    [[TMP26:%.*]] = bitcast i8 [[CONV26]] to b8
// CHECK3-NEXT:    store b8 [[TMP26]], ptr [[TMP0]], align 1
// CHECK3-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK3:       .omp.final.done:
...
// CHECK5-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[TMP1]], align 8, !nontemporal [[META20:![0-9]+]]
...
// CHECK5-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[TMP0]], align 8, !nontemporal [[META20]]
...
// CHECK5-NEXT:    [[I:%.*]] = alloca b8, align 1
...
// CHECK5-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK5-NEXT:    [[DOTCAPTURE_EXPR_1:%.*]] = alloca i32, align 4
// CHECK5-NEXT:    [[KERNEL_ARGS:%.*]] = alloca [[STRUCT___TGT_KERNEL_ARGUMENTS:%.*]], align 8
// CHECK5-NEXT:    [[TMP0:%.*]] = bytecast exact b8 0 to i8
// CHECK5-NEXT:    store i8 [[TMP0]], ptr [[A]], align 1
// CHECK5-NEXT:    [[TMP1:%.*]] = load b8, ptr [[I]], align 1
// CHECK5-NEXT:    store b8 [[TMP1]], ptr [[I_CASTED]], align 1
// CHECK5-NEXT:    [[TMP2:%.*]] = load i64, ptr [[I_CASTED]], align 8
// CHECK5-NEXT:    [[TMP3:%.*]] = load b8, ptr [[A]], align 1
// CHECK5-NEXT:    store b8 [[TMP3]], ptr [[A_CASTED]], align 1
// CHECK5-NEXT:    [[TMP4:%.*]] = load i64, ptr [[A_CASTED]], align 8
// CHECK5-NEXT:    [[TMP5:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 0
// CHECK5-NEXT:    store i64 [[TMP2]], ptr [[TMP5]], align 8
// CHECK5-NEXT:    [[TMP6:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 0
// CHECK5-NEXT:    store i64 [[TMP2]], ptr [[TMP6]], align 8
// CHECK5-NEXT:    [[TMP7:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOFFLOAD_MAPPERS]], i64 0, i64 0
// CHECK5-NEXT:    store ptr null, ptr [[TMP7]], align 8
// CHECK5-NEXT:    [[TMP8:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 1
// CHECK5-NEXT:    store i64 [[TMP4]], ptr [[TMP8]], align 8
// CHECK5-NEXT:    [[TMP9:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 1
// CHECK5-NEXT:    store i64 [[TMP4]], ptr [[TMP9]], align 8
// CHECK5-NEXT:    [[TMP10:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOFFLOAD_MAPPERS]], i64 0, i64 1
// CHECK5-NEXT:    store ptr null, ptr [[TMP10]], align 8
// CHECK5-NEXT:    [[TMP11:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 0
// CHECK5-NEXT:    [[TMP12:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 0
// CHECK5-NEXT:    [[TMP13:%.*]] = load b8, ptr [[A]], align 1
// CHECK5-NEXT:    store b8 [[TMP13]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK5-NEXT:    [[TMP14:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK5-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP14]] to i8
// CHECK5-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
...
// CHECK5-NEXT:    store i32 [[SUB4]], ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK5-NEXT:    [[TMP15:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK5-NEXT:    [[ADD5:%.*]] = add nsw i32 [[TMP15]], 1
// CHECK5-NEXT:    [[TMP16:%.*]] = zext i32 [[ADD5]] to i64
// CHECK5-NEXT:    [[TMP17:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 0
// CHECK5-NEXT:    store i32 3, ptr [[TMP17]], align 4
// CHECK5-NEXT:    [[TMP18:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 1
// CHECK5-NEXT:    store i32 2, ptr [[TMP18]], align 4
// CHECK5-NEXT:    [[TMP19:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 2
// CHECK5-NEXT:    store ptr [[TMP11]], ptr [[TMP19]], align 8
// CHECK5-NEXT:    [[TMP20:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 3
// CHECK5-NEXT:    store ptr [[TMP12]], ptr [[TMP20]], align 8
// CHECK5-NEXT:    [[TMP21:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 4
// CHECK5-NEXT:    store ptr @.offload_sizes.5, ptr [[TMP21]], align 8
// CHECK5-NEXT:    [[TMP22:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 5
// CHECK5-NEXT:    store ptr @.offload_maptypes.6, ptr [[TMP22]], align 8
// CHECK5-NEXT:    [[TMP23:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 6
// CHECK5-NEXT:    store ptr null, ptr [[TMP23]], align 8
// CHECK5-NEXT:    [[TMP24:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 7
// CHECK5-NEXT:    store ptr null, ptr [[TMP24]], align 8
// CHECK5-NEXT:    [[TMP25:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 8
// CHECK5-NEXT:    store i64 [[TMP16]], ptr [[TMP25]], align 8
// CHECK5-NEXT:    [[TMP26:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 9
// CHECK5-NEXT:    store i64 0, ptr [[TMP26]], align 8
// CHECK5-NEXT:    [[TMP27:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 10
// CHECK5-NEXT:    store [3 x i32] zeroinitializer, ptr [[TMP27]], align 4
// CHECK5-NEXT:    [[TMP28:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 11
// CHECK5-NEXT:    store [3 x i32] [i32 1, i32 0, i32 0], ptr [[TMP28]], align 4
// CHECK5-NEXT:    [[TMP29:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 12
// CHECK5-NEXT:    store i32 0, ptr [[TMP29]], align 4
// CHECK5-NEXT:    [[TMP30:%.*]] = call i32 @__tgt_target_kernel(ptr @[[GLOB2]], i64 -1, i32 0, i32 1, ptr @.{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z12test_precondv_l115.region_id, ptr [[KERNEL_ARGS]])
// CHECK5-NEXT:    [[TMP31:%.*]] = icmp ne i32 [[TMP30]], 0
// CHECK5-NEXT:    br i1 [[TMP31]], label [[OMP_OFFLOAD_FAILED:%.*]], label [[OMP_OFFLOAD_CONT:%.*]]
// CHECK5:       omp_offload.failed:
// CHECK5-NEXT:    call void @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z12test_precondv_l115(i64 [[TMP2]], i64 [[TMP4]]) #[[ATTR3]]
// CHECK5-NEXT:    br label [[OMP_OFFLOAD_CONT]]
// CHECK5:       omp_offload.cont:
// CHECK5-NEXT:    ret void
//
...
// CHECK5-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK5-NEXT:    [[DOTCAPTURE_EXPR_1:%.*]] = alloca i32, align 4
// CHECK5-NEXT:    [[I5:%.*]] = alloca b8, align 1
// CHECK5-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK5-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK5-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i32, align 4
// CHECK5-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK5-NEXT:    [[I8:%.*]] = alloca b8, align 1
// CHECK5-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK5-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 8
...
// CHECK5-NEXT:    [[TMP2:%.*]] = load b8, ptr [[TMP1]], align 1
// CHECK5-NEXT:    store b8 [[TMP2]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK5-NEXT:    [[TMP3:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK5-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP3]] to i8
// CHECK5-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
// CHECK5-NEXT:    [[SUB:%.*]] = sub i32 10, [[CONV2]]
// CHECK5-NEXT:    [[SUB3:%.*]] = sub i32 [[SUB]], 1
// CHECK5-NEXT:    [[ADD:%.*]] = add i32 [[SUB3]], 1
...
// CHECK5-NEXT:    [[SUB4:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK5-NEXT:    store i32 [[SUB4]], ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK5-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK5-NEXT:    store b8 [[TMP4]], ptr [[I5]], align 1
// CHECK5-NEXT:    [[TMP5:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK5-NEXT:    [[CONV6:%.*]] = bytecast exact b8 [[TMP5]] to i8
// CHECK5-NEXT:    [[CONV7:%.*]] = sext i8 [[CONV6]] to i32
// CHECK5-NEXT:    [[CMP:%.*]] = icmp slt i32 [[CONV7]], 10
...
// CHECK5-NEXT:    [[CMP9:%.*]] = icmp sgt i32 [[TMP9]], [[TMP10]]
...
// CHECK5-NEXT:    [[TMP14:%.*]] = load b8, ptr [[TMP1]], align 1
// CHECK5-NEXT:    [[TOBOOL:%.*]] = icmp ne b8 [[TMP14]], 0
...
// CHECK5-NEXT:    [[CMP10:%.*]] = icmp sle i32 [[TMP15]], [[TMP16]]
// CHECK5-NEXT:    br i1 [[CMP10]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK5:       omp.inner.for.body:
// CHECK5-NEXT:    [[TMP17:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !llvm.access.group [[ACC_GRP26]]
// CHECK5-NEXT:    [[CONV11:%.*]] = bytecast exact b8 [[TMP17]] to i8
// CHECK5-NEXT:    [[CONV12:%.*]] = sext i8 [[CONV11]] to i32
// CHECK5-NEXT:    [[TMP18:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP26]]
// CHECK5-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP18]], 1
// CHECK5-NEXT:    [[ADD13:%.*]] = add nsw i32 [[CONV12]], [[MUL]]
// CHECK5-NEXT:    [[CONV14:%.*]] = trunc i32 [[ADD13]] to i8
// CHECK5-NEXT:    [[TMP19:%.*]] = bitcast i8 [[CONV14]] to b8
// CHECK5-NEXT:    store b8 [[TMP19]], ptr [[I8]], align 1, !nontemporal [[META20]], !llvm.access.group [[ACC_GRP26]]
// CHECK5-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK5:       omp.body.continue:
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK5:       omp.inner.for.inc:
// CHECK5-NEXT:    [[TMP20:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP26]]
// CHECK5-NEXT:    [[ADD15:%.*]] = add nsw i32 [[TMP20]], 1
// CHECK5-NEXT:    store i32 [[ADD15]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP26]]
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_COND]], !llvm.loop [[LOOP27:![0-9]+]]
// CHECK5:       omp.inner.for.end:
// CHECK5-NEXT:    br label [[OMP_IF_END:%.*]]
// CHECK5:       omp_if.else:
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_COND16:%.*]]
// CHECK5:       omp.inner.for.cond16:
// CHECK5-NEXT:    [[TMP21:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK5-NEXT:    [[TMP22:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK5-NEXT:    [[CMP17:%.*]] = icmp sle i32 [[TMP21]], [[TMP22]]
// CHECK5-NEXT:    br i1 [[CMP17]], label [[OMP_INNER_FOR_BODY18:%.*]], label [[OMP_INNER_FOR_END27:%.*]]
// CHECK5:       omp.inner.for.body18:
// CHECK5-NEXT:    [[TMP23:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK5-NEXT:    [[CONV19:%.*]] = bytecast exact b8 [[TMP23]] to i8
// CHECK5-NEXT:    [[CONV20:%.*]] = sext i8 [[CONV19]] to i32
// CHECK5-NEXT:    [[TMP24:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK5-NEXT:    [[MUL21:%.*]] = mul nsw i32 [[TMP24]], 1
// CHECK5-NEXT:    [[ADD22:%.*]] = add nsw i32 [[CONV20]], [[MUL21]]
// CHECK5-NEXT:    [[CONV23:%.*]] = trunc i32 [[ADD22]] to i8
// CHECK5-NEXT:    [[TMP25:%.*]] = bitcast i8 [[CONV23]] to b8
// CHECK5-NEXT:    store b8 [[TMP25]], ptr [[I8]], align 1
...
// CHECK5-NEXT:    [[TMP26:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK5-NEXT:    [[ADD26:%.*]] = add nsw i32 [[TMP26]], 1
// CHECK5-NEXT:    store i32 [[ADD26]], ptr [[DOTOMP_IV]], align 4
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_COND16]], !llvm.loop [[LOOP29:![0-9]+]]
...
// CHECK5-NEXT:    call void @__kmpc_for_static_fini(ptr @[[GLOB1]], i32 [[TMP28]])
// CHECK5-NEXT:    [[TMP29:%.*]] = load i32, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK5-NEXT:    [[TMP30:%.*]] = icmp ne i32 [[TMP29]], 0
// CHECK5-NEXT:    br i1 [[TMP30]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK5:       .omp.final.then:
// CHECK5-NEXT:    [[TMP31:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK5-NEXT:    [[CONV28:%.*]] = bytecast exact b8 [[TMP31]] to i8
// CHECK5-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK5-NEXT:    [[TMP32:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK5-NEXT:    [[CONV30:%.*]] = bytecast exact b8 [[TMP32]] to i8
// CHECK5-NEXT:    [[CONV31:%.*]] = sext i8 [[CONV30]] to i32
// CHECK5-NEXT:    [[SUB32:%.*]] = sub i32 10, [[CONV31]]
// CHECK5-NEXT:    [[SUB33:%.*]] = sub i32 [[SUB32]], 1
// CHECK5-NEXT:    [[ADD34:%.*]] = add i32 [[SUB33]], 1
// CHECK5-NEXT:    [[DIV35:%.*]] = udiv i32 [[ADD34]], 1
// CHECK5-NEXT:    [[MUL36:%.*]] = mul nsw i32 [[DIV35]], 1
// CHECK5-NEXT:    [[ADD37:%.*]] = add nsw i32 [[CONV29]], [[MUL36]]
// CHECK5-NEXT:    [[CONV38:%.*]] = trunc i32 [[ADD37]] to i8
// CHECK5-NEXT:    [[TMP33:%.*]] = bitcast i8 [[CONV38]] to b8
// CHECK5-NEXT:    store b8 [[TMP33]], ptr [[TMP0]], align 1
// CHECK5-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK5:       .omp.final.done:
...
// CHECK7-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[TMP1]], align 4, !nontemporal [[META21:![0-9]+]]
...
// CHECK7-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[TMP0]], align 4, !nontemporal [[META21]]
...
// CHECK7-SAME: () #[[ATTR0]] {
// CHECK7-NEXT:  entry:
// CHECK7-NEXT:    [[A:%.*]] = alloca b8, align 1
// CHECK7-NEXT:    [[I:%.*]] = alloca b8, align 1
...
// CHECK7-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK7-NEXT:    [[DOTCAPTURE_EXPR_1:%.*]] = alloca i32, align 4
// CHECK7-NEXT:    [[KERNEL_ARGS:%.*]] = alloca [[STRUCT___TGT_KERNEL_ARGUMENTS:%.*]], align 8
// CHECK7-NEXT:    [[TMP0:%.*]] = bytecast exact b8 0 to i8
// CHECK7-NEXT:    store i8 [[TMP0]], ptr [[A]], align 1
// CHECK7-NEXT:    [[TMP1:%.*]] = load b8, ptr [[I]], align 1
// CHECK7-NEXT:    store b8 [[TMP1]], ptr [[I_CASTED]], align 1
// CHECK7-NEXT:    [[TMP2:%.*]] = load i32, ptr [[I_CASTED]], align 4
// CHECK7-NEXT:    [[TMP3:%.*]] = load b8, ptr [[A]], align 1
// CHECK7-NEXT:    store b8 [[TMP3]], ptr [[A_CASTED]], align 1
// CHECK7-NEXT:    [[TMP4:%.*]] = load i32, ptr [[A_CASTED]], align 4
// CHECK7-NEXT:    [[TMP5:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 0
// CHECK7-NEXT:    store i32 [[TMP2]], ptr [[TMP5]], align 4
// CHECK7-NEXT:    [[TMP6:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 0
// CHECK7-NEXT:    store i32 [[TMP2]], ptr [[TMP6]], align 4
// CHECK7-NEXT:    [[TMP7:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOFFLOAD_MAPPERS]], i32 0, i32 0
// CHECK7-NEXT:    store ptr null, ptr [[TMP7]], align 4
// CHECK7-NEXT:    [[TMP8:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 1
// CHECK7-NEXT:    store i32 [[TMP4]], ptr [[TMP8]], align 4
// CHECK7-NEXT:    [[TMP9:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 1
// CHECK7-NEXT:    store i32 [[TMP4]], ptr [[TMP9]], align 4
// CHECK7-NEXT:    [[TMP10:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOFFLOAD_MAPPERS]], i32 0, i32 1
// CHECK7-NEXT:    store ptr null, ptr [[TMP10]], align 4
// CHECK7-NEXT:    [[TMP11:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 0
// CHECK7-NEXT:    [[TMP12:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 0
// CHECK7-NEXT:    [[TMP13:%.*]] = load b8, ptr [[A]], align 1
// CHECK7-NEXT:    store b8 [[TMP13]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK7-NEXT:    [[TMP14:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK7-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP14]] to i8
// CHECK7-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
...
// CHECK7-NEXT:    store i32 [[SUB4]], ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK7-NEXT:    [[TMP15:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK7-NEXT:    [[ADD5:%.*]] = add nsw i32 [[TMP15]], 1
// CHECK7-NEXT:    [[TMP16:%.*]] = zext i32 [[ADD5]] to i64
// CHECK7-NEXT:    [[TMP17:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 0
// CHECK7-NEXT:    store i32 3, ptr [[TMP17]], align 4
// CHECK7-NEXT:    [[TMP18:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 1
// CHECK7-NEXT:    store i32 2, ptr [[TMP18]], align 4
// CHECK7-NEXT:    [[TMP19:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 2
// CHECK7-NEXT:    store ptr [[TMP11]], ptr [[TMP19]], align 4
// CHECK7-NEXT:    [[TMP20:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 3
// CHECK7-NEXT:    store ptr [[TMP12]], ptr [[TMP20]], align 4
// CHECK7-NEXT:    [[TMP21:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 4
// CHECK7-NEXT:    store ptr @.offload_sizes.5, ptr [[TMP21]], align 4
// CHECK7-NEXT:    [[TMP22:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 5
// CHECK7-NEXT:    store ptr @.offload_maptypes.6, ptr [[TMP22]], align 4
// CHECK7-NEXT:    [[TMP23:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 6
// CHECK7-NEXT:    store ptr null, ptr [[TMP23]], align 4
// CHECK7-NEXT:    [[TMP24:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 7
// CHECK7-NEXT:    store ptr null, ptr [[TMP24]], align 4
// CHECK7-NEXT:    [[TMP25:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 8
// CHECK7-NEXT:    store i64 [[TMP16]], ptr [[TMP25]], align 8
// CHECK7-NEXT:    [[TMP26:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 9
// CHECK7-NEXT:    store i64 0, ptr [[TMP26]], align 8
// CHECK7-NEXT:    [[TMP27:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 10
// CHECK7-NEXT:    store [3 x i32] zeroinitializer, ptr [[TMP27]], align 4
// CHECK7-NEXT:    [[TMP28:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 11
// CHECK7-NEXT:    store [3 x i32] [i32 1, i32 0, i32 0], ptr [[TMP28]], align 4
// CHECK7-NEXT:    [[TMP29:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 12
// CHECK7-NEXT:    store i32 0, ptr [[TMP29]], align 4
// CHECK7-NEXT:    [[TMP30:%.*]] = call i32 @__tgt_target_kernel(ptr @[[GLOB2]], i64 -1, i32 0, i32 1, ptr @.{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z12test_precondv_l115.region_id, ptr [[KERNEL_ARGS]])
// CHECK7-NEXT:    [[TMP31:%.*]] = icmp ne i32 [[TMP30]], 0
// CHECK7-NEXT:    br i1 [[TMP31]], label [[OMP_OFFLOAD_FAILED:%.*]], label [[OMP_OFFLOAD_CONT:%.*]]
// CHECK7:       omp_offload.failed:
// CHECK7-NEXT:    call void @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z12test_precondv_l115(i32 [[TMP2]], i32 [[TMP4]]) #[[ATTR3]]
// CHECK7-NEXT:    br label [[OMP_OFFLOAD_CONT]]
// CHECK7:       omp_offload.cont:
// CHECK7-NEXT:    ret void
//
...
// CHECK7-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK7-NEXT:    [[DOTCAPTURE_EXPR_1:%.*]] = alloca i32, align 4
// CHECK7-NEXT:    [[I5:%.*]] = alloca b8, align 1
// CHECK7-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK7-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK7-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i32, align 4
// CHECK7-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK7-NEXT:    [[I8:%.*]] = alloca b8, align 1
// CHECK7-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK7-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 4
...
// CHECK7-NEXT:    [[TMP2:%.*]] = load b8, ptr [[TMP1]], align 1
// CHECK7-NEXT:    store b8 [[TMP2]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK7-NEXT:    [[TMP3:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK7-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP3]] to i8
// CHECK7-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
// CHECK7-NEXT:    [[SUB:%.*]] = sub i32 10, [[CONV2]]
// CHECK7-NEXT:    [[SUB3:%.*]] = sub i32 [[SUB]], 1
// CHECK7-NEXT:    [[ADD:%.*]] = add i32 [[SUB3]], 1
...
// CHECK7-NEXT:    [[SUB4:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK7-NEXT:    store i32 [[SUB4]], ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK7-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK7-NEXT:    store b8 [[TMP4]], ptr [[I5]], align 1
// CHECK7-NEXT:    [[TMP5:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK7-NEXT:    [[CONV6:%.*]] = bytecast exact b8 [[TMP5]] to i8
// CHECK7-NEXT:    [[CONV7:%.*]] = sext i8 [[CONV6]] to i32
// CHECK7-NEXT:    [[CMP:%.*]] = icmp slt i32 [[CONV7]], 10
...
// CHECK7-NEXT:    [[CMP9:%.*]] = icmp sgt i32 [[TMP9]], [[TMP10]]
// CHECK7-NEXT:    br i1 [[CMP9]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK7:       cond.true:
...
// CHECK7-NEXT:    [[TMP14:%.*]] = load b8, ptr [[TMP1]], align 1
// CHECK7-NEXT:    [[TOBOOL:%.*]] = icmp ne b8 [[TMP14]], 0
...
// CHECK7:       omp.inner.for.body:
// CHECK7-NEXT:    [[TMP17:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !llvm.access.group [[ACC_GRP27]]
// CHECK7-NEXT:    [[CONV11:%.*]] = bytecast exact b8 [[TMP17]] to i8
// CHECK7-NEXT:    [[CONV12:%.*]] = sext i8 [[CONV11]] to i32
// CHECK7-NEXT:    [[TMP18:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP27]]
// CHECK7-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP18]], 1
// CHECK7-NEXT:    [[ADD13:%.*]] = add nsw i32 [[CONV12]], [[MUL]]
// CHECK7-NEXT:    [[CONV14:%.*]] = trunc i32 [[ADD13]] to i8
// CHECK7-NEXT:    [[TMP19:%.*]] = bitcast i8 [[CONV14]] to b8
// CHECK7-NEXT:    store b8 [[TMP19]], ptr [[I8]], align 1, !nontemporal [[META21]], !llvm.access.group [[ACC_GRP27]]
// CHECK7-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK7:       omp.body.continue:
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK7:       omp.inner.for.inc:
// CHECK7-NEXT:    [[TMP20:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP27]]
// CHECK7-NEXT:    [[ADD15:%.*]] = add nsw i32 [[TMP20]], 1
// CHECK7-NEXT:    store i32 [[ADD15]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP27]]
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_COND]], !llvm.loop [[LOOP28:![0-9]+]]
// CHECK7:       omp.inner.for.end:
// CHECK7-NEXT:    br label [[OMP_IF_END:%.*]]
// CHECK7:       omp_if.else:
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_COND16:%.*]]
// CHECK7:       omp.inner.for.cond16:
// CHECK7-NEXT:    [[TMP21:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK7-NEXT:    [[TMP22:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK7-NEXT:    [[CMP17:%.*]] = icmp sle i32 [[TMP21]], [[TMP22]]
// CHECK7-NEXT:    br i1 [[CMP17]], label [[OMP_INNER_FOR_BODY18:%.*]], label [[OMP_INNER_FOR_END27:%.*]]
// CHECK7:       omp.inner.for.body18:
// CHECK7-NEXT:    [[TMP23:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK7-NEXT:    [[CONV19:%.*]] = bytecast exact b8 [[TMP23]] to i8
// CHECK7-NEXT:    [[CONV20:%.*]] = sext i8 [[CONV19]] to i32
// CHECK7-NEXT:    [[TMP24:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK7-NEXT:    [[MUL21:%.*]] = mul nsw i32 [[TMP24]], 1
// CHECK7-NEXT:    [[ADD22:%.*]] = add nsw i32 [[CONV20]], [[MUL21]]
// CHECK7-NEXT:    [[CONV23:%.*]] = trunc i32 [[ADD22]] to i8
// CHECK7-NEXT:    [[TMP25:%.*]] = bitcast i8 [[CONV23]] to b8
// CHECK7-NEXT:    store b8 [[TMP25]], ptr [[I8]], align 1
// CHECK7-NEXT:    br label [[OMP_BODY_CONTINUE24:%.*]]
// CHECK7:       omp.body.continue24:
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_INC25:%.*]]
// CHECK7:       omp.inner.for.inc25:
// CHECK7-NEXT:    [[TMP26:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK7-NEXT:    [[ADD26:%.*]] = add nsw i32 [[TMP26]], 1
// CHECK7-NEXT:    store i32 [[ADD26]], ptr [[DOTOMP_IV]], align 4
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_COND16]], !llvm.loop [[LOOP30:![0-9]+]]
// CHECK7:       omp.inner.for.end27:
// CHECK7-NEXT:    br label [[OMP_IF_END]]
// CHECK7:       omp_if.end:
// CHECK7-NEXT:    br label [[OMP_LOOP_EXIT:%.*]]
// CHECK7:       omp.loop.exit:
// CHECK7-NEXT:    [[TMP27:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK7-NEXT:    [[TMP28:%.*]] = load i32, ptr [[TMP27]], align 4
// CHECK7-NEXT:    call void @__kmpc_for_static_fini(ptr @[[GLOB1]], i32 [[TMP28]])
// CHECK7-NEXT:    [[TMP29:%.*]] = load i32, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK7-NEXT:    [[TMP30:%.*]] = icmp ne i32 [[TMP29]], 0
// CHECK7-NEXT:    br i1 [[TMP30]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK7:       .omp.final.then:
// CHECK7-NEXT:    [[TMP31:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK7-NEXT:    [[CONV28:%.*]] = bytecast exact b8 [[TMP31]] to i8
// CHECK7-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK7-NEXT:    [[TMP32:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK7-NEXT:    [[CONV30:%.*]] = bytecast exact b8 [[TMP32]] to i8
// CHECK7-NEXT:    [[CONV31:%.*]] = sext i8 [[CONV30]] to i32
// CHECK7-NEXT:    [[SUB32:%.*]] = sub i32 10, [[CONV31]]
// CHECK7-NEXT:    [[SUB33:%.*]] = sub i32 [[SUB32]], 1
// CHECK7-NEXT:    [[ADD34:%.*]] = add i32 [[SUB33]], 1
// CHECK7-NEXT:    [[DIV35:%.*]] = udiv i32 [[ADD34]], 1
// CHECK7-NEXT:    [[MUL36:%.*]] = mul nsw i32 [[DIV35]], 1
// CHECK7-NEXT:    [[ADD37:%.*]] = add nsw i32 [[CONV29]], [[MUL36]]
// CHECK7-NEXT:    [[CONV38:%.*]] = trunc i32 [[ADD37]] to i8
// CHECK7-NEXT:    [[TMP33:%.*]] = bitcast i8 [[CONV38]] to b8
// CHECK7-NEXT:    store b8 [[TMP33]], ptr [[TMP0]], align 1
// CHECK7-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK7:       .omp.final.done:
...
// CHECK9-SAME: () #[[ATTR0]] {
// CHECK9-NEXT:  entry:
// CHECK9-NEXT:    [[A:%.*]] = alloca b8, align 1
// CHECK9-NEXT:    [[I:%.*]] = alloca b8, align 1
// CHECK9-NEXT:    [[TMP:%.*]] = alloca b8, align 1
// CHECK9-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK9-NEXT:    [[DOTCAPTURE_EXPR_1:%.*]] = alloca i32, align 4
// CHECK9-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK9-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK9-NEXT:    [[I5:%.*]] = alloca b8, align 1
// CHECK9-NEXT:    [[DOTOMP_IV:%.*]] = alloca i32, align 4
// CHECK9-NEXT:    [[DOTLINEAR_START:%.*]] = alloca b8, align 1
// CHECK9-NEXT:    [[I8:%.*]] = alloca b8, align 1
// CHECK9-NEXT:    [[I9:%.*]] = alloca b8, align 1
// CHECK9-NEXT:    [[TMP0:%.*]] = bytecast exact b8 0 to i8
// CHECK9-NEXT:    store i8 [[TMP0]], ptr [[A]], align 1
// CHECK9-NEXT:    [[TMP1:%.*]] = load b8, ptr [[A]], align 1
// CHECK9-NEXT:    store b8 [[TMP1]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK9-NEXT:    [[TMP2:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK9-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP2]] to i8
// CHECK9-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
// CHECK9-NEXT:    [[SUB:%.*]] = sub i32 10, [[CONV2]]
...
// CHECK9-NEXT:    store i32 [[SUB4]], ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK9-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK9-NEXT:    [[TMP3:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK9-NEXT:    store i32 [[TMP3]], ptr [[DOTOMP_UB]], align 4
// CHECK9-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK9-NEXT:    store b8 [[TMP4]], ptr [[I5]], align 1
// CHECK9-NEXT:    [[TMP5:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK9-NEXT:    [[CONV6:%.*]] = bytecast exact b8 [[TMP5]] to i8
// CHECK9-NEXT:    [[CONV7:%.*]] = sext i8 [[CONV6]] to i32
// CHECK9-NEXT:    [[CMP:%.*]] = icmp slt i32 [[CONV7]], 10
...
// CHECK9-NEXT:    [[TMP7:%.*]] = load b8, ptr [[I]], align 1
// CHECK9-NEXT:    store b8 [[TMP7]], ptr [[DOTLINEAR_START]], align 1
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK9:       omp.inner.for.cond:
// CHECK9-NEXT:    [[TMP8:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP12:![0-9]+]]
// CHECK9-NEXT:    [[TMP9:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4, !llvm.access.group [[ACC_GRP12]]
// CHECK9-NEXT:    [[CMP10:%.*]] = icmp sle i32 [[TMP8]], [[TMP9]]
// CHECK9-NEXT:    br i1 [[CMP10]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK9:       omp.inner.for.body:
// CHECK9-NEXT:    [[TMP10:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !llvm.access.group [[ACC_GRP12]]
// CHECK9-NEXT:    [[CONV11:%.*]] = bytecast exact b8 [[TMP10]] to i8
// CHECK9-NEXT:    [[CONV12:%.*]] = sext i8 [[CONV11]] to i32
// CHECK9-NEXT:    [[TMP11:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP12]]
// CHECK9-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP11]], 1
// CHECK9-NEXT:    [[ADD13:%.*]] = add nsw i32 [[CONV12]], [[MUL]]
// CHECK9-NEXT:    [[CONV14:%.*]] = trunc i32 [[ADD13]] to i8
// CHECK9-NEXT:    [[TMP12:%.*]] = bitcast i8 [[CONV14]] to b8
// CHECK9-NEXT:    store b8 [[TMP12]], ptr [[I8]], align 1, !llvm.access.group [[ACC_GRP12]]
// CHECK9-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK9:       omp.body.continue:
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK9:       omp.inner.for.inc:
...
// CHECK9:       omp.inner.for.end:
// CHECK9-NEXT:    [[TMP14:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK9-NEXT:    [[CONV16:%.*]] = bytecast exact b8 [[TMP14]] to i8
// CHECK9-NEXT:    [[CONV17:%.*]] = sext i8 [[CONV16]] to i32
// CHECK9-NEXT:    [[TMP15:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK9-NEXT:    [[CONV18:%.*]] = bytecast exact b8 [[TMP15]] to i8
// CHECK9-NEXT:    [[CONV19:%.*]] = sext i8 [[CONV18]] to i32
// CHECK9-NEXT:    [[SUB20:%.*]] = sub i32 10, [[CONV19]]
// CHECK9-NEXT:    [[SUB21:%.*]] = sub i32 [[SUB20]], 1
// CHECK9-NEXT:    [[ADD22:%.*]] = add i32 [[SUB21]], 1
// CHECK9-NEXT:    [[DIV23:%.*]] = udiv i32 [[ADD22]], 1
// CHECK9-NEXT:    [[MUL24:%.*]] = mul nsw i32 [[DIV23]], 1
// CHECK9-NEXT:    [[ADD25:%.*]] = add nsw i32 [[CONV17]], [[MUL24]]
// CHECK9-NEXT:    [[CONV26:%.*]] = trunc i32 [[ADD25]] to i8
// CHECK9-NEXT:    [[TMP16:%.*]] = bitcast i8 [[CONV26]] to b8
// CHECK9-NEXT:    store b8 [[TMP16]], ptr [[I]], align 1
...
// CHECK11-SAME: () #[[ATTR0]] {
// CHECK11-NEXT:  entry:
// CHECK11-NEXT:    [[A:%.*]] = alloca b8, align 1
// CHECK11-NEXT:    [[I:%.*]] = alloca b8, align 1
// CHECK11-NEXT:    [[TMP:%.*]] = alloca b8, align 1
// CHECK11-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK11-NEXT:    [[DOTCAPTURE_EXPR_1:%.*]] = alloca i32, align 4
// CHECK11-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK11-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK11-NEXT:    [[I5:%.*]] = alloca b8, align 1
// CHECK11-NEXT:    [[DOTOMP_IV:%.*]] = alloca i32, align 4
// CHECK11-NEXT:    [[DOTLINEAR_START:%.*]] = alloca b8, align 1
// CHECK11-NEXT:    [[I8:%.*]] = alloca b8, align 1
// CHECK11-NEXT:    [[I9:%.*]] = alloca b8, align 1
// CHECK11-NEXT:    [[TMP0:%.*]] = bytecast exact b8 0 to i8
// CHECK11-NEXT:    store i8 [[TMP0]], ptr [[A]], align 1
// CHECK11-NEXT:    [[TMP1:%.*]] = load b8, ptr [[A]], align 1
// CHECK11-NEXT:    store b8 [[TMP1]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK11-NEXT:    [[TMP2:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK11-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP2]] to i8
// CHECK11-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
// CHECK11-NEXT:    [[SUB:%.*]] = sub i32 10, [[CONV2]]
...
// CHECK11-NEXT:    store i32 [[SUB4]], ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK11-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK11-NEXT:    [[TMP3:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK11-NEXT:    store i32 [[TMP3]], ptr [[DOTOMP_UB]], align 4
// CHECK11-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK11-NEXT:    store b8 [[TMP4]], ptr [[I5]], align 1
// CHECK11-NEXT:    [[TMP5:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK11-NEXT:    [[CONV6:%.*]] = bytecast exact b8 [[TMP5]] to i8
// CHECK11-NEXT:    [[CONV7:%.*]] = sext i8 [[CONV6]] to i32
// CHECK11-NEXT:    [[CMP:%.*]] = icmp slt i32 [[CONV7]], 10
...
// CHECK11-NEXT:    [[TMP7:%.*]] = load b8, ptr [[I]], align 1
// CHECK11-NEXT:    store b8 [[TMP7]], ptr [[DOTLINEAR_START]], align 1
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK11:       omp.inner.for.cond:
// CHECK11-NEXT:    [[TMP8:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP13:![0-9]+]]
// CHECK11-NEXT:    [[TMP9:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4, !llvm.access.group [[ACC_GRP13]]
// CHECK11-NEXT:    [[CMP10:%.*]] = icmp sle i32 [[TMP8]], [[TMP9]]
// CHECK11-NEXT:    br i1 [[CMP10]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK11:       omp.inner.for.body:
// CHECK11-NEXT:    [[TMP10:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !llvm.access.group [[ACC_GRP13]]
// CHECK11-NEXT:    [[CONV11:%.*]] = bytecast exact b8 [[TMP10]] to i8
// CHECK11-NEXT:    [[CONV12:%.*]] = sext i8 [[CONV11]] to i32
// CHECK11-NEXT:    [[TMP11:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP13]]
// CHECK11-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP11]], 1
// CHECK11-NEXT:    [[ADD13:%.*]] = add nsw i32 [[CONV12]], [[MUL]]
// CHECK11-NEXT:    [[CONV14:%.*]] = trunc i32 [[ADD13]] to i8
// CHECK11-NEXT:    [[TMP12:%.*]] = bitcast i8 [[CONV14]] to b8
// CHECK11-NEXT:    store b8 [[TMP12]], ptr [[I8]], align 1, !llvm.access.group [[ACC_GRP13]]
// CHECK11-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK11:       omp.body.continue:
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK11:       omp.inner.for.inc:
// CHECK11-NEXT:    [[TMP13:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP13]]
// CHECK11-NEXT:    [[ADD15:%.*]] = add nsw i32 [[TMP13]], 1
...
// CHECK11:       omp.inner.for.end:
// CHECK11-NEXT:    [[TMP14:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK11-NEXT:    [[CONV16:%.*]] = bytecast exact b8 [[TMP14]] to i8
// CHECK11-NEXT:    [[CONV17:%.*]] = sext i8 [[CONV16]] to i32
// CHECK11-NEXT:    [[TMP15:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK11-NEXT:    [[CONV18:%.*]] = bytecast exact b8 [[TMP15]] to i8
// CHECK11-NEXT:    [[CONV19:%.*]] = sext i8 [[CONV18]] to i32
// CHECK11-NEXT:    [[SUB20:%.*]] = sub i32 10, [[CONV19]]
// CHECK11-NEXT:    [[SUB21:%.*]] = sub i32 [[SUB20]], 1
// CHECK11-NEXT:    [[ADD22:%.*]] = add i32 [[SUB21]], 1
// CHECK11-NEXT:    [[DIV23:%.*]] = udiv i32 [[ADD22]], 1
// CHECK11-NEXT:    [[MUL24:%.*]] = mul nsw i32 [[DIV23]], 1
// CHECK11-NEXT:    [[ADD25:%.*]] = add nsw i32 [[CONV17]], [[MUL24]]
// CHECK11-NEXT:    [[CONV26:%.*]] = trunc i32 [[ADD25]] to i8
// CHECK11-NEXT:    [[TMP16:%.*]] = bitcast i8 [[CONV26]] to b8
// CHECK11-NEXT:    store b8 [[TMP16]], ptr [[I]], align 1
...
// CHECK13-SAME: () #[[ATTR0]] {
// CHECK13-NEXT:  entry:
// CHECK13-NEXT:    [[A:%.*]] = alloca b8, align 1
// CHECK13-NEXT:    [[I:%.*]] = alloca b8, align 1
// CHECK13-NEXT:    [[TMP:%.*]] = alloca b8, align 1
// CHECK13-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK13-NEXT:    [[DOTCAPTURE_EXPR_1:%.*]] = alloca i32, align 4
// CHECK13-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK13-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK13-NEXT:    [[I5:%.*]] = alloca b8, align 1
// CHECK13-NEXT:    [[DOTOMP_IV:%.*]] = alloca i32, align 4
// CHECK13-NEXT:    [[DOTLINEAR_START:%.*]] = alloca b8, align 1
// CHECK13-NEXT:    [[I8:%.*]] = alloca b8, align 1
// CHECK13-NEXT:    [[I9:%.*]] = alloca b8, align 1
// CHECK13-NEXT:    [[TMP0:%.*]] = bytecast exact b8 0 to i8
// CHECK13-NEXT:    store i8 [[TMP0]], ptr [[A]], align 1
// CHECK13-NEXT:    [[TMP1:%.*]] = load b8, ptr [[A]], align 1
// CHECK13-NEXT:    store b8 [[TMP1]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK13-NEXT:    [[TMP2:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK13-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP2]] to i8
// CHECK13-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
// CHECK13-NEXT:    [[SUB:%.*]] = sub i32 10, [[CONV2]]
...
// CHECK13-NEXT:    store i32 [[SUB4]], ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK13-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK13-NEXT:    [[TMP3:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK13-NEXT:    store i32 [[TMP3]], ptr [[DOTOMP_UB]], align 4
// CHECK13-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK13-NEXT:    store b8 [[TMP4]], ptr [[I5]], align 1
// CHECK13-NEXT:    [[TMP5:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK13-NEXT:    [[CONV6:%.*]] = bytecast exact b8 [[TMP5]] to i8
// CHECK13-NEXT:    [[CONV7:%.*]] = sext i8 [[CONV6]] to i32
// CHECK13-NEXT:    [[CMP:%.*]] = icmp slt i32 [[CONV7]], 10
...
// CHECK13-NEXT:    [[TMP7:%.*]] = load b8, ptr [[I]], align 1
// CHECK13-NEXT:    store b8 [[TMP7]], ptr [[DOTLINEAR_START]], align 1
// CHECK13-NEXT:    [[TMP8:%.*]] = load b8, ptr [[A]], align 1
// CHECK13-NEXT:    [[TOBOOL:%.*]] = icmp ne b8 [[TMP8]], 0
// CHECK13-NEXT:    br i1 [[TOBOOL]], label [[OMP_IF_THEN:%.*]], label [[OMP_IF_ELSE:%.*]]
// CHECK13:       omp_if.then:
// CHECK13-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK13:       omp.inner.for.cond:
// CHECK13-NEXT:    [[TMP9:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP13:![0-9]+]]
// CHECK13-NEXT:    [[TMP10:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4, !llvm.access.group [[ACC_GRP13]]
// CHECK13-NEXT:    [[CMP10:%.*]] = icmp sle i32 [[TMP9]], [[TMP10]]
// CHECK13-NEXT:    br i1 [[CMP10]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK13:       omp.inner.for.body:
// CHECK13-NEXT:    [[TMP11:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !llvm.access.group [[ACC_GRP13]]
// CHECK13-NEXT:    [[CONV11:%.*]] = bytecast exact b8 [[TMP11]] to i8
// CHECK13-NEXT:    [[CONV12:%.*]] = sext i8 [[CONV11]] to i32
// CHECK13-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP13]]
// CHECK13-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP12]], 1
// CHECK13-NEXT:    [[ADD13:%.*]] = add nsw i32 [[CONV12]], [[MUL]]
// CHECK13-NEXT:    [[CONV14:%.*]] = trunc i32 [[ADD13]] to i8
// CHECK13-NEXT:    [[TMP13:%.*]] = bitcast i8 [[CONV14]] to b8
// CHECK13-NEXT:    store b8 [[TMP13]], ptr [[I8]], align 1, !nontemporal [[META7]], !llvm.access.group [[ACC_GRP13]]
// CHECK13-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK13:       omp.body.continue:
// CHECK13-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK13:       omp.inner.for.inc:
// CHECK13-NEXT:    [[TMP14:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP13]]
// CHECK13-NEXT:    [[ADD15:%.*]] = add nsw i32 [[TMP14]], 1
// CHECK13-NEXT:    store i32 [[ADD15]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP13]]
// CHECK13-NEXT:    br label [[OMP_INNER_FOR_COND]], !llvm.loop [[LOOP14:![0-9]+]]
// CHECK13:       omp.inner.for.end:
// CHECK13-NEXT:    br label [[OMP_IF_END:%.*]]
// CHECK13:       omp_if.else:
// CHECK13-NEXT:    br label [[OMP_INNER_FOR_COND16:%.*]]
// CHECK13:       omp.inner.for.cond16:
// CHECK13-NEXT:    [[TMP15:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK13-NEXT:    [[TMP16:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK13-NEXT:    [[CMP17:%.*]] = icmp sle i32 [[TMP15]], [[TMP16]]
// CHECK13-NEXT:    br i1 [[CMP17]], label [[OMP_INNER_FOR_BODY18:%.*]], label [[OMP_INNER_FOR_END27:%.*]]
// CHECK13:       omp.inner.for.body18:
// CHECK13-NEXT:    [[TMP17:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK13-NEXT:    [[CONV19:%.*]] = bytecast exact b8 [[TMP17]] to i8
// CHECK13-NEXT:    [[CONV20:%.*]] = sext i8 [[CONV19]] to i32
// CHECK13-NEXT:    [[TMP18:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK13-NEXT:    [[MUL21:%.*]] = mul nsw i32 [[TMP18]], 1
// CHECK13-NEXT:    [[ADD22:%.*]] = add nsw i32 [[CONV20]], [[MUL21]]
// CHECK13-NEXT:    [[CONV23:%.*]] = trunc i32 [[ADD22]] to i8
// CHECK13-NEXT:    [[TMP19:%.*]] = bitcast i8 [[CONV23]] to b8
// CHECK13-NEXT:    store b8 [[TMP19]], ptr [[I8]], align 1
// CHECK13-NEXT:    br label [[OMP_BODY_CONTINUE24:%.*]]
// CHECK13:       omp.body.continue24:
// CHECK13-NEXT:    br label [[OMP_INNER_FOR_INC25:%.*]]
// CHECK13:       omp.inner.for.inc25:
// CHECK13-NEXT:    [[TMP20:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK13-NEXT:    [[ADD26:%.*]] = add nsw i32 [[TMP20]], 1
// CHECK13-NEXT:    store i32 [[ADD26]], ptr [[DOTOMP_IV]], align 4
// CHECK13-NEXT:    br label [[OMP_INNER_FOR_COND16]], !llvm.loop [[LOOP16:![0-9]+]]
// CHECK13:       omp.inner.for.end27:
// CHECK13-NEXT:    br label [[OMP_IF_END]]
// CHECK13:       omp_if.end:
// CHECK13-NEXT:    [[TMP21:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK13-NEXT:    [[CONV28:%.*]] = bytecast exact b8 [[TMP21]] to i8
// CHECK13-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK13-NEXT:    [[TMP22:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK13-NEXT:    [[CONV30:%.*]] = bytecast exact b8 [[TMP22]] to i8
// CHECK13-NEXT:    [[CONV31:%.*]] = sext i8 [[CONV30]] to i32
// CHECK13-NEXT:    [[SUB32:%.*]] = sub i32 10, [[CONV31]]
// CHECK13-NEXT:    [[SUB33:%.*]] = sub i32 [[SUB32]], 1
// CHECK13-NEXT:    [[ADD34:%.*]] = add i32 [[SUB33]], 1
// CHECK13-NEXT:    [[DIV35:%.*]] = udiv i32 [[ADD34]], 1
// CHECK13-NEXT:    [[MUL36:%.*]] = mul nsw i32 [[DIV35]], 1
// CHECK13-NEXT:    [[ADD37:%.*]] = add nsw i32 [[CONV29]], [[MUL36]]
// CHECK13-NEXT:    [[CONV38:%.*]] = trunc i32 [[ADD37]] to i8
// CHECK13-NEXT:    [[TMP23:%.*]] = bitcast i8 [[CONV38]] to b8
// CHECK13-NEXT:    store b8 [[TMP23]], ptr [[I]], align 1
...
// CHECK15-SAME: () #[[ATTR0]] {
// CHECK15-NEXT:  entry:
// CHECK15-NEXT:    [[A:%.*]] = alloca b8, align 1
// CHECK15-NEXT:    [[I:%.*]] = alloca b8, align 1
// CHECK15-NEXT:    [[TMP:%.*]] = alloca b8, align 1
// CHECK15-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK15-NEXT:    [[DOTCAPTURE_EXPR_1:%.*]] = alloca i32, align 4
// CHECK15-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK15-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK15-NEXT:    [[I5:%.*]] = alloca b8, align 1
// CHECK15-NEXT:    [[DOTOMP_IV:%.*]] = alloca i32, align 4
// CHECK15-NEXT:    [[DOTLINEAR_START:%.*]] = alloca b8, align 1
// CHECK15-NEXT:    [[I8:%.*]] = alloca b8, align 1
// CHECK15-NEXT:    [[I9:%.*]] = alloca b8, align 1
// CHECK15-NEXT:    [[TMP0:%.*]] = bytecast exact b8 0 to i8
// CHECK15-NEXT:    store i8 [[TMP0]], ptr [[A]], align 1
// CHECK15-NEXT:    [[TMP1:%.*]] = load b8, ptr [[A]], align 1
// CHECK15-NEXT:    store b8 [[TMP1]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK15-NEXT:    [[TMP2:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK15-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP2]] to i8
// CHECK15-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
// CHECK15-NEXT:    [[SUB:%.*]] = sub i32 10, [[CONV2]]
...
// CHECK15-NEXT:    store i32 [[SUB4]], ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK15-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK15-NEXT:    [[TMP3:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK15-NEXT:    store i32 [[TMP3]], ptr [[DOTOMP_UB]], align 4
// CHECK15-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK15-NEXT:    store b8 [[TMP4]], ptr [[I5]], align 1
// CHECK15-NEXT:    [[TMP5:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK15-NEXT:    [[CONV6:%.*]] = bytecast exact b8 [[TMP5]] to i8
// CHECK15-NEXT:    [[CONV7:%.*]] = sext i8 [[CONV6]] to i32
// CHECK15-NEXT:    [[CMP:%.*]] = icmp slt i32 [[CONV7]], 10
...
// CHECK15-NEXT:    [[TMP7:%.*]] = load b8, ptr [[I]], align 1
// CHECK15-NEXT:    store b8 [[TMP7]], ptr [[DOTLINEAR_START]], align 1
// CHECK15-NEXT:    [[TMP8:%.*]] = load b8, ptr [[A]], align 1
// CHECK15-NEXT:    [[TOBOOL:%.*]] = icmp ne b8 [[TMP8]], 0
// CHECK15-NEXT:    br i1 [[TOBOOL]], label [[OMP_IF_THEN:%.*]], label [[OMP_IF_ELSE:%.*]]
// CHECK15:       omp_if.then:
// CHECK15-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK15:       omp.inner.for.cond:
// CHECK15-NEXT:    [[TMP9:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP14:![0-9]+]]
// CHECK15-NEXT:    [[TMP10:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK15-NEXT:    [[CMP10:%.*]] = icmp sle i32 [[TMP9]], [[TMP10]]
// CHECK15-NEXT:    br i1 [[CMP10]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK15:       omp.inner.for.body:
// CHECK15-NEXT:    [[TMP11:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !llvm.access.group [[ACC_GRP14]]
// CHECK15-NEXT:    [[CONV11:%.*]] = bytecast exact b8 [[TMP11]] to i8
// CHECK15-NEXT:    [[CONV12:%.*]] = sext i8 [[CONV11]] to i32
// CHECK15-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK15-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP12]], 1
// CHECK15-NEXT:    [[ADD13:%.*]] = add nsw i32 [[CONV12]], [[MUL]]
// CHECK15-NEXT:    [[CONV14:%.*]] = trunc i32 [[ADD13]] to i8
// CHECK15-NEXT:    [[TMP13:%.*]] = bitcast i8 [[CONV14]] to b8
// CHECK15-NEXT:    store b8 [[TMP13]], ptr [[I8]], align 1, !nontemporal [[META8]], !llvm.access.group [[ACC_GRP14]]
// CHECK15-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK15:       omp.body.continue:
// CHECK15-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK15:       omp.inner.for.inc:
// CHECK15-NEXT:    [[TMP14:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK15-NEXT:    [[ADD15:%.*]] = add nsw i32 [[TMP14]], 1
// CHECK15-NEXT:    store i32 [[ADD15]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK15-NEXT:    br label [[OMP_INNER_FOR_COND]], !llvm.loop [[LOOP15:![0-9]+]]
// CHECK15:       omp.inner.for.end:
// CHECK15-NEXT:    br label [[OMP_IF_END:%.*]]
// CHECK15:       omp_if.else:
// CHECK15-NEXT:    br label [[OMP_INNER_FOR_COND16:%.*]]
// CHECK15:       omp.inner.for.cond16:
// CHECK15-NEXT:    [[TMP15:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK15-NEXT:    [[TMP16:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK15-NEXT:    [[CMP17:%.*]] = icmp sle i32 [[TMP15]], [[TMP16]]
// CHECK15-NEXT:    br i1 [[CMP17]], label [[OMP_INNER_FOR_BODY18:%.*]], label [[OMP_INNER_FOR_END27:%.*]]
// CHECK15:       omp.inner.for.body18:
// CHECK15-NEXT:    [[TMP17:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK15-NEXT:    [[CONV19:%.*]] = bytecast exact b8 [[TMP17]] to i8
// CHECK15-NEXT:    [[CONV20:%.*]] = sext i8 [[CONV19]] to i32
// CHECK15-NEXT:    [[TMP18:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK15-NEXT:    [[MUL21:%.*]] = mul nsw i32 [[TMP18]], 1
// CHECK15-NEXT:    [[ADD22:%.*]] = add nsw i32 [[CONV20]], [[MUL21]]
// CHECK15-NEXT:    [[CONV23:%.*]] = trunc i32 [[ADD22]] to i8
// CHECK15-NEXT:    [[TMP19:%.*]] = bitcast i8 [[CONV23]] to b8
// CHECK15-NEXT:    store b8 [[TMP19]], ptr [[I8]], align 1
// CHECK15-NEXT:    br label [[OMP_BODY_CONTINUE24:%.*]]
// CHECK15:       omp.body.continue24:
// CHECK15-NEXT:    br label [[OMP_INNER_FOR_INC25:%.*]]
// CHECK15:       omp.inner.for.inc25:
// CHECK15-NEXT:    [[TMP20:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK15-NEXT:    [[ADD26:%.*]] = add nsw i32 [[TMP20]], 1
// CHECK15-NEXT:    store i32 [[ADD26]], ptr [[DOTOMP_IV]], align 4
// CHECK15-NEXT:    br label [[OMP_INNER_FOR_COND16]], !llvm.loop [[LOOP17:![0-9]+]]
// CHECK15:       omp.inner.for.end27:
// CHECK15-NEXT:    br label [[OMP_IF_END]]
// CHECK15:       omp_if.end:
// CHECK15-NEXT:    [[TMP21:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK15-NEXT:    [[CONV28:%.*]] = bytecast exact b8 [[TMP21]] to i8
// CHECK15-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK15-NEXT:    [[TMP22:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK15-NEXT:    [[CONV30:%.*]] = bytecast exact b8 [[TMP22]] to i8
// CHECK15-NEXT:    [[CONV31:%.*]] = sext i8 [[CONV30]] to i32
// CHECK15-NEXT:    [[SUB32:%.*]] = sub i32 10, [[CONV31]]
// CHECK15-NEXT:    [[SUB33:%.*]] = sub i32 [[SUB32]], 1
// CHECK15-NEXT:    [[ADD34:%.*]] = add i32 [[SUB33]], 1
// CHECK15-NEXT:    [[DIV35:%.*]] = udiv i32 [[ADD34]], 1
// CHECK15-NEXT:    [[MUL36:%.*]] = mul nsw i32 [[DIV35]], 1
// CHECK15-NEXT:    [[ADD37:%.*]] = add nsw i32 [[CONV29]], [[MUL36]]
// CHECK15-NEXT:    [[CONV38:%.*]] = trunc i32 [[ADD37]] to i8
// CHECK15-NEXT:    [[TMP23:%.*]] = bitcast i8 [[CONV38]] to b8
// CHECK15-NEXT:    store b8 [[TMP23]], ptr [[I]], align 1
...
// CHECK17-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK17-NEXT:    [[DOTCAPTURE_EXPR_1:%.*]] = alloca i32, align 4
// CHECK17-NEXT:    [[I5:%.*]] = alloca b8, align 1
// CHECK17-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK17-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK17-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i32, align 4
// CHECK17-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK17-NEXT:    [[I8:%.*]] = alloca b8, align 1
// CHECK17-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK17-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 8
...
// CHECK17-NEXT:    [[TMP2:%.*]] = load b8, ptr [[TMP1]], align 1
// CHECK17-NEXT:    store b8 [[TMP2]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK17-NEXT:    [[TMP3:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK17-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP3]] to i8
// CHECK17-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
// CHECK17-NEXT:    [[SUB:%.*]] = sub i32 10, [[CONV2]]
...
// CHECK17-NEXT:    store i32 [[SUB4]], ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK17-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK17-NEXT:    store b8 [[TMP4]], ptr [[I5]], align 1
// CHECK17-NEXT:    [[TMP5:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK17-NEXT:    [[CONV6:%.*]] = bytecast exact b8 [[TMP5]] to i8
...
// CHECK17-NEXT:    [[CMP9:%.*]] = icmp sgt i32 [[TMP9]], [[TMP10]]
...
// CHECK17-NEXT:    br i1 [[CMP10]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK17:       omp.inner.for.body:
// CHECK17-NEXT:    [[TMP16:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !llvm.access.group [[ACC_GRP26]]
// CHECK17-NEXT:    [[CONV11:%.*]] = bytecast exact b8 [[TMP16]] to i8
// CHECK17-NEXT:    [[CONV12:%.*]] = sext i8 [[CONV11]] to i32
// CHECK17-NEXT:    [[TMP17:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP26]]
// CHECK17-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP17]], 1
// CHECK17-NEXT:    [[ADD13:%.*]] = add nsw i32 [[CONV12]], [[MUL]]
// CHECK17-NEXT:    [[CONV14:%.*]] = trunc i32 [[ADD13]] to i8
// CHECK17-NEXT:    [[TMP18:%.*]] = bitcast i8 [[CONV14]] to b8
// CHECK17-NEXT:    store b8 [[TMP18]], ptr [[I8]], align 1, !llvm.access.group [[ACC_GRP26]]
// CHECK17-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK17:       omp.body.continue:
// CHECK17-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK17:       omp.inner.for.inc:
// CHECK17-NEXT:    [[TMP19:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP26]]
// CHECK17-NEXT:    [[ADD15:%.*]] = add nsw i32 [[TMP19]], 1
// CHECK17-NEXT:    store i32 [[ADD15]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP26]]
...
// CHECK17:       .omp.final.then:
// CHECK17-NEXT:    [[TMP24:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK17-NEXT:    [[CONV16:%.*]] = bytecast exact b8 [[TMP24]] to i8
// CHECK17-NEXT:    [[CONV17:%.*]] = sext i8 [[CONV16]] to i32
// CHECK17-NEXT:    [[TMP25:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK17-NEXT:    [[CONV18:%.*]] = bytecast exact b8 [[TMP25]] to i8
// CHECK17-NEXT:    [[CONV19:%.*]] = sext i8 [[CONV18]] to i32
// CHECK17-NEXT:    [[SUB20:%.*]] = sub i32 10, [[CONV19]]
// CHECK17-NEXT:    [[SUB21:%.*]] = sub i32 [[SUB20]], 1
// CHECK17-NEXT:    [[ADD22:%.*]] = add i32 [[SUB21]], 1
// CHECK17-NEXT:    [[DIV23:%.*]] = udiv i32 [[ADD22]], 1
// CHECK17-NEXT:    [[MUL24:%.*]] = mul nsw i32 [[DIV23]], 1
// CHECK17-NEXT:    [[ADD25:%.*]] = add nsw i32 [[CONV17]], [[MUL24]]
// CHECK17-NEXT:    [[CONV26:%.*]] = trunc i32 [[ADD25]] to i8
// CHECK17-NEXT:    [[TMP26:%.*]] = bitcast i8 [[CONV26]] to b8
// CHECK17-NEXT:    store b8 [[TMP26]], ptr [[TMP0]], align 1
// CHECK17-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK17:       .omp.final.done:
...
// CHECK19-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK19-NEXT:    [[DOTCAPTURE_EXPR_1:%.*]] = alloca i32, align 4
// CHECK19-NEXT:    [[I5:%.*]] = alloca b8, align 1
// CHECK19-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK19-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK19-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i32, align 4
// CHECK19-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK19-NEXT:    [[I8:%.*]] = alloca b8, align 1
// CHECK19-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK19-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 4
...
// CHECK19-NEXT:    [[TMP2:%.*]] = load b8, ptr [[TMP1]], align 1
// CHECK19-NEXT:    store b8 [[TMP2]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK19-NEXT:    [[TMP3:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK19-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP3]] to i8
// CHECK19-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
// CHECK19-NEXT:    [[SUB:%.*]] = sub i32 10, [[CONV2]]
// CHECK19-NEXT:    [[SUB3:%.*]] = sub i32 [[SUB]], 1
// CHECK19-NEXT:    [[ADD:%.*]] = add i32 [[SUB3]], 1
// CHECK19-NEXT:    [[DIV:%.*]] = udiv i32 [[ADD]], 1
// CHECK19-NEXT:    [[SUB4:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK19-NEXT:    store i32 [[SUB4]], ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK19-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK19-NEXT:    store b8 [[TMP4]], ptr [[I5]], align 1
// CHECK19-NEXT:    [[TMP5:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK19-NEXT:    [[CONV6:%.*]] = bytecast exact b8 [[TMP5]] to i8
...
// CHECK19-NEXT:    [[CMP9:%.*]] = icmp sgt i32 [[TMP9]], [[TMP10]]
// CHECK19-NEXT:    br i1 [[CMP9]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK19:       cond.true:
...
// CHECK19:       omp.inner.for.body:
// CHECK19-NEXT:    [[TMP16:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !llvm.access.group [[ACC_GRP27]]
// CHECK19-NEXT:    [[CONV11:%.*]] = bytecast exact b8 [[TMP16]] to i8
// CHECK19-NEXT:    [[CONV12:%.*]] = sext i8 [[CONV11]] to i32
// CHECK19-NEXT:    [[TMP17:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP27]]
// CHECK19-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP17]], 1
// CHECK19-NEXT:    [[ADD13:%.*]] = add nsw i32 [[CONV12]], [[MUL]]
// CHECK19-NEXT:    [[CONV14:%.*]] = trunc i32 [[ADD13]] to i8
// CHECK19-NEXT:    [[TMP18:%.*]] = bitcast i8 [[CONV14]] to b8
// CHECK19-NEXT:    store b8 [[TMP18]], ptr [[I8]], align 1, !llvm.access.group [[ACC_GRP27]]
// CHECK19-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK19:       omp.body.continue:
// CHECK19-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK19:       omp.inner.for.inc:
// CHECK19-NEXT:    [[TMP19:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP27]]
// CHECK19-NEXT:    [[ADD15:%.*]] = add nsw i32 [[TMP19]], 1
// CHECK19-NEXT:    store i32 [[ADD15]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP27]]
...
// CHECK19:       .omp.final.then:
// CHECK19-NEXT:    [[TMP24:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK19-NEXT:    [[CONV16:%.*]] = bytecast exact b8 [[TMP24]] to i8
// CHECK19-NEXT:    [[CONV17:%.*]] = sext i8 [[CONV16]] to i32
// CHECK19-NEXT:    [[TMP25:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK19-NEXT:    [[CONV18:%.*]] = bytecast exact b8 [[TMP25]] to i8
// CHECK19-NEXT:    [[CONV19:%.*]] = sext i8 [[CONV18]] to i32
// CHECK19-NEXT:    [[SUB20:%.*]] = sub i32 10, [[CONV19]]
// CHECK19-NEXT:    [[SUB21:%.*]] = sub i32 [[SUB20]], 1
// CHECK19-NEXT:    [[ADD22:%.*]] = add i32 [[SUB21]], 1
// CHECK19-NEXT:    [[DIV23:%.*]] = udiv i32 [[ADD22]], 1
// CHECK19-NEXT:    [[MUL24:%.*]] = mul nsw i32 [[DIV23]], 1
// CHECK19-NEXT:    [[ADD25:%.*]] = add nsw i32 [[CONV17]], [[MUL24]]
// CHECK19-NEXT:    [[CONV26:%.*]] = trunc i32 [[ADD25]] to i8
// CHECK19-NEXT:    [[TMP26:%.*]] = bitcast i8 [[CONV26]] to b8
// CHECK19-NEXT:    store b8 [[TMP26]], ptr [[TMP0]], align 1
// CHECK19-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK19:       .omp.final.done:
...
// CHECK21-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[TMP1]], align 8, !nontemporal [[META21:![0-9]+]]
...
// CHECK21-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[TMP0]], align 8, !nontemporal [[META21]]
...
// CHECK21-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK21-NEXT:    [[DOTCAPTURE_EXPR_1:%.*]] = alloca i32, align 4
// CHECK21-NEXT:    [[I5:%.*]] = alloca b8, align 1
// CHECK21-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK21-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK21-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i32, align 4
// CHECK21-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK21-NEXT:    [[I8:%.*]] = alloca b8, align 1
// CHECK21-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK21-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 8
...
// CHECK21-NEXT:    [[TMP2:%.*]] = load b8, ptr [[TMP1]], align 1
// CHECK21-NEXT:    store b8 [[TMP2]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK21-NEXT:    [[TMP3:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK21-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP3]] to i8
// CHECK21-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
// CHECK21-NEXT:    [[SUB:%.*]] = sub i32 10, [[CONV2]]
// CHECK21-NEXT:    [[SUB3:%.*]] = sub i32 [[SUB]], 1
// CHECK21-NEXT:    [[ADD:%.*]] = add i32 [[SUB3]], 1
// CHECK21-NEXT:    [[DIV:%.*]] = udiv i32 [[ADD]], 1
// CHECK21-NEXT:    [[SUB4:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK21-NEXT:    store i32 [[SUB4]], ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK21-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK21-NEXT:    store b8 [[TMP4]], ptr [[I5]], align 1
// CHECK21-NEXT:    [[TMP5:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK21-NEXT:    [[CONV6:%.*]] = bytecast exact b8 [[TMP5]] to i8
// CHECK21-NEXT:    [[CONV7:%.*]] = sext i8 [[CONV6]] to i32
// CHECK21-NEXT:    [[CMP:%.*]] = icmp slt i32 [[CONV7]], 10
...
// CHECK21-NEXT:    [[CMP9:%.*]] = icmp sgt i32 [[TMP9]], [[TMP10]]
...
// CHECK21-NEXT:    [[TMP14:%.*]] = load b8, ptr [[TMP1]], align 1
// CHECK21-NEXT:    [[TOBOOL:%.*]] = icmp ne b8 [[TMP14]], 0
...
// CHECK21-NEXT:    [[CMP10:%.*]] = icmp sle i32 [[TMP15]], [[TMP16]]
// CHECK21-NEXT:    br i1 [[CMP10]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK21:       omp.inner.for.body:
// CHECK21-NEXT:    [[TMP17:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !llvm.access.group [[ACC_GRP27]]
// CHECK21-NEXT:    [[CONV11:%.*]] = bytecast exact b8 [[TMP17]] to i8
// CHECK21-NEXT:    [[CONV12:%.*]] = sext i8 [[CONV11]] to i32
// CHECK21-NEXT:    [[TMP18:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP27]]
// CHECK21-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP18]], 1
// CHECK21-NEXT:    [[ADD13:%.*]] = add nsw i32 [[CONV12]], [[MUL]]
// CHECK21-NEXT:    [[CONV14:%.*]] = trunc i32 [[ADD13]] to i8
// CHECK21-NEXT:    [[TMP19:%.*]] = bitcast i8 [[CONV14]] to b8
// CHECK21-NEXT:    store b8 [[TMP19]], ptr [[I8]], align 1, !nontemporal [[META21]], !llvm.access.group [[ACC_GRP27]]
// CHECK21-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK21:       omp.body.continue:
// CHECK21-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK21:       omp.inner.for.inc:
// CHECK21-NEXT:    [[TMP20:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP27]]
// CHECK21-NEXT:    [[ADD15:%.*]] = add nsw i32 [[TMP20]], 1
// CHECK21-NEXT:    store i32 [[ADD15]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP27]]
// CHECK21-NEXT:    br label [[OMP_INNER_FOR_COND]], !llvm.loop [[LOOP28:![0-9]+]]
// CHECK21:       omp.inner.for.end:
// CHECK21-NEXT:    br label [[OMP_IF_END:%.*]]
// CHECK21:       omp_if.else:
// CHECK21-NEXT:    br label [[OMP_INNER_FOR_COND16:%.*]]
// CHECK21:       omp.inner.for.cond16:
// CHECK21-NEXT:    [[TMP21:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK21-NEXT:    [[TMP22:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK21-NEXT:    [[CMP17:%.*]] = icmp sle i32 [[TMP21]], [[TMP22]]
// CHECK21-NEXT:    br i1 [[CMP17]], label [[OMP_INNER_FOR_BODY18:%.*]], label [[OMP_INNER_FOR_END27:%.*]]
// CHECK21:       omp.inner.for.body18:
// CHECK21-NEXT:    [[TMP23:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK21-NEXT:    [[CONV19:%.*]] = bytecast exact b8 [[TMP23]] to i8
// CHECK21-NEXT:    [[CONV20:%.*]] = sext i8 [[CONV19]] to i32
// CHECK21-NEXT:    [[TMP24:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK21-NEXT:    [[MUL21:%.*]] = mul nsw i32 [[TMP24]], 1
// CHECK21-NEXT:    [[ADD22:%.*]] = add nsw i32 [[CONV20]], [[MUL21]]
// CHECK21-NEXT:    [[CONV23:%.*]] = trunc i32 [[ADD22]] to i8
// CHECK21-NEXT:    [[TMP25:%.*]] = bitcast i8 [[CONV23]] to b8
// CHECK21-NEXT:    store b8 [[TMP25]], ptr [[I8]], align 1
...
// CHECK21-NEXT:    [[TMP26:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK21-NEXT:    [[ADD26:%.*]] = add nsw i32 [[TMP26]], 1
// CHECK21-NEXT:    store i32 [[ADD26]], ptr [[DOTOMP_IV]], align 4
// CHECK21-NEXT:    br label [[OMP_INNER_FOR_COND16]], !llvm.loop [[LOOP30:![0-9]+]]
// CHECK21:       omp.inner.for.end27:
// CHECK21-NEXT:    br label [[OMP_IF_END]]
// CHECK21:       omp_if.end:
// CHECK21-NEXT:    br label [[OMP_LOOP_EXIT:%.*]]
// CHECK21:       omp.loop.exit:
// CHECK21-NEXT:    [[TMP27:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK21-NEXT:    [[TMP28:%.*]] = load i32, ptr [[TMP27]], align 4
// CHECK21-NEXT:    call void @__kmpc_for_static_fini(ptr @[[GLOB1]], i32 [[TMP28]])
// CHECK21-NEXT:    [[TMP29:%.*]] = load i32, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK21-NEXT:    [[TMP30:%.*]] = icmp ne i32 [[TMP29]], 0
// CHECK21-NEXT:    br i1 [[TMP30]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK21:       .omp.final.then:
// CHECK21-NEXT:    [[TMP31:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK21-NEXT:    [[CONV28:%.*]] = bytecast exact b8 [[TMP31]] to i8
// CHECK21-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK21-NEXT:    [[TMP32:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK21-NEXT:    [[CONV30:%.*]] = bytecast exact b8 [[TMP32]] to i8
// CHECK21-NEXT:    [[CONV31:%.*]] = sext i8 [[CONV30]] to i32
// CHECK21-NEXT:    [[SUB32:%.*]] = sub i32 10, [[CONV31]]
// CHECK21-NEXT:    [[SUB33:%.*]] = sub i32 [[SUB32]], 1
// CHECK21-NEXT:    [[ADD34:%.*]] = add i32 [[SUB33]], 1
// CHECK21-NEXT:    [[DIV35:%.*]] = udiv i32 [[ADD34]], 1
// CHECK21-NEXT:    [[MUL36:%.*]] = mul nsw i32 [[DIV35]], 1
// CHECK21-NEXT:    [[ADD37:%.*]] = add nsw i32 [[CONV29]], [[MUL36]]
// CHECK21-NEXT:    [[CONV38:%.*]] = trunc i32 [[ADD37]] to i8
// CHECK21-NEXT:    [[TMP33:%.*]] = bitcast i8 [[CONV38]] to b8
// CHECK21-NEXT:    store b8 [[TMP33]], ptr [[TMP0]], align 1
// CHECK21-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK21:       .omp.final.done:
...
// CHECK23-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[TMP1]], align 4, !nontemporal [[META22:![0-9]+]]
...
// CHECK23-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[TMP0]], align 4, !nontemporal [[META22]]
...
// CHECK23-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK23-NEXT:    [[DOTCAPTURE_EXPR_1:%.*]] = alloca i32, align 4
// CHECK23-NEXT:    [[I5:%.*]] = alloca b8, align 1
// CHECK23-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK23-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK23-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i32, align 4
// CHECK23-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK23-NEXT:    [[I8:%.*]] = alloca b8, align 1
// CHECK23-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK23-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 4
...
// CHECK23-NEXT:    [[TMP2:%.*]] = load b8, ptr [[TMP1]], align 1
// CHECK23-NEXT:    store b8 [[TMP2]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK23-NEXT:    [[TMP3:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK23-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP3]] to i8
// CHECK23-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
// CHECK23-NEXT:    [[SUB:%.*]] = sub i32 10, [[CONV2]]
// CHECK23-NEXT:    [[SUB3:%.*]] = sub i32 [[SUB]], 1
// CHECK23-NEXT:    [[ADD:%.*]] = add i32 [[SUB3]], 1
// CHECK23-NEXT:    [[DIV:%.*]] = udiv i32 [[ADD]], 1
// CHECK23-NEXT:    [[SUB4:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK23-NEXT:    store i32 [[SUB4]], ptr [[DOTCAPTURE_EXPR_1]], align 4
// CHECK23-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK23-NEXT:    store b8 [[TMP4]], ptr [[I5]], align 1
// CHECK23-NEXT:    [[TMP5:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK23-NEXT:    [[CONV6:%.*]] = bytecast exact b8 [[TMP5]] to i8
// CHECK23-NEXT:    [[CONV7:%.*]] = sext i8 [[CONV6]] to i32
// CHECK23-NEXT:    [[CMP:%.*]] = icmp slt i32 [[CONV7]], 10
...
// CHECK23-NEXT:    [[CMP9:%.*]] = icmp sgt i32 [[TMP9]], [[TMP10]]
// CHECK23-NEXT:    br i1 [[CMP9]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK23:       cond.true:
...
// CHECK23-NEXT:    [[TMP14:%.*]] = load b8, ptr [[TMP1]], align 1
// CHECK23-NEXT:    [[TOBOOL:%.*]] = icmp ne b8 [[TMP14]], 0
...
// CHECK23-NEXT:    [[CMP10:%.*]] = icmp sle i32 [[TMP15]], [[TMP16]]
// CHECK23-NEXT:    br i1 [[CMP10]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK23:       omp.inner.for.body:
// CHECK23-NEXT:    [[TMP17:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !llvm.access.group [[ACC_GRP28]]
// CHECK23-NEXT:    [[CONV11:%.*]] = bytecast exact b8 [[TMP17]] to i8
// CHECK23-NEXT:    [[CONV12:%.*]] = sext i8 [[CONV11]] to i32
// CHECK23-NEXT:    [[TMP18:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP28]]
// CHECK23-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP18]], 1
// CHECK23-NEXT:    [[ADD13:%.*]] = add nsw i32 [[CONV12]], [[MUL]]
// CHECK23-NEXT:    [[CONV14:%.*]] = trunc i32 [[ADD13]] to i8
// CHECK23-NEXT:    [[TMP19:%.*]] = bitcast i8 [[CONV14]] to b8
// CHECK23-NEXT:    store b8 [[TMP19]], ptr [[I8]], align 1, !nontemporal [[META22]], !llvm.access.group [[ACC_GRP28]]
// CHECK23-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK23:       omp.body.continue:
// CHECK23-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK23:       omp.inner.for.inc:
// CHECK23-NEXT:    [[TMP20:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP28]]
// CHECK23-NEXT:    [[ADD15:%.*]] = add nsw i32 [[TMP20]], 1
// CHECK23-NEXT:    store i32 [[ADD15]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP28]]
// CHECK23-NEXT:    br label [[OMP_INNER_FOR_COND]], !llvm.loop [[LOOP29:![0-9]+]]
// CHECK23:       omp.inner.for.end:
// CHECK23-NEXT:    br label [[OMP_IF_END:%.*]]
// CHECK23:       omp_if.else:
// CHECK23-NEXT:    br label [[OMP_INNER_FOR_COND16:%.*]]
// CHECK23:       omp.inner.for.cond16:
// CHECK23-NEXT:    [[TMP21:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK23-NEXT:    [[TMP22:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK23-NEXT:    [[CMP17:%.*]] = icmp sle i32 [[TMP21]], [[TMP22]]
// CHECK23-NEXT:    br i1 [[CMP17]], label [[OMP_INNER_FOR_BODY18:%.*]], label [[OMP_INNER_FOR_END27:%.*]]
// CHECK23:       omp.inner.for.body18:
// CHECK23-NEXT:    [[TMP23:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK23-NEXT:    [[CONV19:%.*]] = bytecast exact b8 [[TMP23]] to i8
// CHECK23-NEXT:    [[CONV20:%.*]] = sext i8 [[CONV19]] to i32
// CHECK23-NEXT:    [[TMP24:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK23-NEXT:    [[MUL21:%.*]] = mul nsw i32 [[TMP24]], 1
// CHECK23-NEXT:    [[ADD22:%.*]] = add nsw i32 [[CONV20]], [[MUL21]]
// CHECK23-NEXT:    [[CONV23:%.*]] = trunc i32 [[ADD22]] to i8
// CHECK23-NEXT:    [[TMP25:%.*]] = bitcast i8 [[CONV23]] to b8
// CHECK23-NEXT:    store b8 [[TMP25]], ptr [[I8]], align 1
// CHECK23-NEXT:    br label [[OMP_BODY_CONTINUE24:%.*]]
// CHECK23:       omp.body.continue24:
// CHECK23-NEXT:    br label [[OMP_INNER_FOR_INC25:%.*]]
// CHECK23:       omp.inner.for.inc25:
// CHECK23-NEXT:    [[TMP26:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK23-NEXT:    [[ADD26:%.*]] = add nsw i32 [[TMP26]], 1
// CHECK23-NEXT:    store i32 [[ADD26]], ptr [[DOTOMP_IV]], align 4
// CHECK23-NEXT:    br label [[OMP_INNER_FOR_COND16]], !llvm.loop [[LOOP31:![0-9]+]]
// CHECK23:       omp.inner.for.end27:
// CHECK23-NEXT:    br label [[OMP_IF_END]]
// CHECK23:       omp_if.end:
// CHECK23-NEXT:    br label [[OMP_LOOP_EXIT:%.*]]
// CHECK23:       omp.loop.exit:
// CHECK23-NEXT:    [[TMP27:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK23-NEXT:    [[TMP28:%.*]] = load i32, ptr [[TMP27]], align 4
// CHECK23-NEXT:    call void @__kmpc_for_static_fini(ptr @[[GLOB1]], i32 [[TMP28]])
// CHECK23-NEXT:    [[TMP29:%.*]] = load i32, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK23-NEXT:    [[TMP30:%.*]] = icmp ne i32 [[TMP29]], 0
// CHECK23-NEXT:    br i1 [[TMP30]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK23:       .omp.final.then:
// CHECK23-NEXT:    [[TMP31:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK23-NEXT:    [[CONV28:%.*]] = bytecast exact b8 [[TMP31]] to i8
// CHECK23-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK23-NEXT:    [[TMP32:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK23-NEXT:    [[CONV30:%.*]] = bytecast exact b8 [[TMP32]] to i8
// CHECK23-NEXT:    [[CONV31:%.*]] = sext i8 [[CONV30]] to i32
// CHECK23-NEXT:    [[SUB32:%.*]] = sub i32 10, [[CONV31]]
// CHECK23-NEXT:    [[SUB33:%.*]] = sub i32 [[SUB32]], 1
// CHECK23-NEXT:    [[ADD34:%.*]] = add i32 [[SUB33]], 1
// CHECK23-NEXT:    [[DIV35:%.*]] = udiv i32 [[ADD34]], 1
// CHECK23-NEXT:    [[MUL36:%.*]] = mul nsw i32 [[DIV35]], 1
// CHECK23-NEXT:    [[ADD37:%.*]] = add nsw i32 [[CONV29]], [[MUL36]]
// CHECK23-NEXT:    [[CONV38:%.*]] = trunc i32 [[ADD37]] to i8
// CHECK23-NEXT:    [[TMP33:%.*]] = bitcast i8 [[CONV38]] to b8
// CHECK23-NEXT:    store b8 [[TMP33]], ptr [[TMP0]], align 1
// CHECK23-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK23:       .omp.final.done:
