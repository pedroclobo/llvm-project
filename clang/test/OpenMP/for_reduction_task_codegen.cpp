...
// CHECK1-NEXT:    [[TMP90:%.*]] = getelementptr b8, ptr [[ARRAYIDX2]], i64 [[TMP12]]
...
// CHECK1-NEXT:    [[TMP96:%.*]] = getelementptr b8, ptr [[ARRAYIDX2]], i64 [[TMP12]]
...
// CHECK1-NEXT:    [[TMP108:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP109:%.*]] = load i32, ptr [[TMP108]], align 4
// CHECK1-NEXT:    call void @__kmpc_barrier(ptr @[[GLOB4:[0-9]+]], i32 [[TMP109]])
