...
// CHECK-64-NEXT:    [[CONV:%.*]] = bytecast b8 [[TMP2]] to i8
...
// CHECK-64-NEXT:    [[CONV5:%.*]] = bytecast b8 [[TMP9]] to i8
// CHECK-64-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK-64-NEXT:    [[TMP10:%.*]] = load b8, ptr [[C1]], align 1
// CHECK-64-NEXT:    [[CONV7:%.*]] = bytecast b8 [[TMP10]] to i8
...
// CHECK-32-NEXT:    [[CONV:%.*]] = bytecast b8 [[TMP2]] to i8
...
// CHECK-32-NEXT:    [[CONV5:%.*]] = bytecast b8 [[TMP9]] to i8
// CHECK-32-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK-32-NEXT:    [[TMP10:%.*]] = load b8, ptr [[C1]], align 1
// CHECK-32-NEXT:    [[CONV7:%.*]] = bytecast b8 [[TMP10]] to i8
...
// CHECK-32-EX-NEXT:    [[CONV:%.*]] = bytecast b8 [[TMP2]] to i8
...
// CHECK-32-EX-NEXT:    [[CONV5:%.*]] = bytecast b8 [[TMP9]] to i8
// CHECK-32-EX-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK-32-EX-NEXT:    [[TMP10:%.*]] = load b8, ptr [[C1]], align 1
// CHECK-32-EX-NEXT:    [[CONV7:%.*]] = bytecast b8 [[TMP10]] to i8
