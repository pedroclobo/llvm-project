...
// CHECK-64-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[C_ADDR]], align 8
// CHECK-64-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[D_ADDR]], align 8
// CHECK-64-NEXT:    [[TMP2:%.*]] = bytecast exact b8 0 to i8
// CHECK-64-NEXT:    store i8 [[TMP2]], ptr [[C1]], align 1
// CHECK-64-NEXT:    store float 1.000000e+00, ptr [[D2]], align 4
// CHECK-64-NEXT:    [[TMP3:%.*]] = load b8, ptr [[C1]], align 1
// CHECK-64-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP3]] to i8
// CHECK-64-NEXT:    [[CONV3:%.*]] = sext i8 [[CONV]] to i32
// CHECK-64-NEXT:    [[XOR:%.*]] = xor i32 [[CONV3]], 2
// CHECK-64-NEXT:    [[CONV4:%.*]] = trunc i32 [[XOR]] to i8
// CHECK-64-NEXT:    [[TMP4:%.*]] = bitcast i8 [[CONV4]] to b8
// CHECK-64-NEXT:    store b8 [[TMP4]], ptr [[C1]], align 1
// CHECK-64-NEXT:    [[TMP5:%.*]] = load float, ptr [[D2]], align 4
// CHECK-64-NEXT:    [[MUL:%.*]] = fmul float [[TMP5]], 3.300000e+01
...
// CHECK-64-NEXT:    [[TMP8:%.*]] = call i32 @__kmpc_nvptx_parallel_reduce_nowait_v2(ptr @[[GLOB1]], i64 8, ptr [[DOTOMP_REDUCTION_RED_LIST]], ptr @_omp_reduction_shuffle_and_reduce_func1, ptr @_omp_reduction_inter_warp_copy_func2)
// CHECK-64-NEXT:    [[TMP9:%.*]] = icmp eq i32 [[TMP8]], 1
// CHECK-64-NEXT:    br i1 [[TMP9]], label [[DOTOMP_REDUCTION_THEN:%.*]], label [[DOTOMP_REDUCTION_DONE:%.*]]
// CHECK-64:       .omp.reduction.then:
// CHECK-64-NEXT:    [[TMP10:%.*]] = load b8, ptr [[TMP0]], align 1
// CHECK-64-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP10]] to i8
// CHECK-64-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK-64-NEXT:    [[TMP11:%.*]] = load b8, ptr [[C1]], align 1
// CHECK-64-NEXT:    [[CONV7:%.*]] = bytecast exact b8 [[TMP11]] to i8
// CHECK-64-NEXT:    [[CONV8:%.*]] = sext i8 [[CONV7]] to i32
// CHECK-64-NEXT:    [[XOR9:%.*]] = xor i32 [[CONV6]], [[CONV8]]
// CHECK-64-NEXT:    [[CONV10:%.*]] = trunc i32 [[XOR9]] to i8
// CHECK-64-NEXT:    [[TMP12:%.*]] = bitcast i8 [[CONV10]] to b8
// CHECK-64-NEXT:    store b8 [[TMP12]], ptr [[TMP0]], align 1
// CHECK-64-NEXT:    [[TMP13:%.*]] = load float, ptr [[TMP1]], align 4
// CHECK-64-NEXT:    [[TMP14:%.*]] = load float, ptr [[D2]], align 4
// CHECK-64-NEXT:    [[MUL11:%.*]] = fmul float [[TMP13]], [[TMP14]]
...
// CHECK-32-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[C_ADDR]], align 4
// CHECK-32-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[D_ADDR]], align 4
// CHECK-32-NEXT:    [[TMP2:%.*]] = bytecast exact b8 0 to i8
// CHECK-32-NEXT:    store i8 [[TMP2]], ptr [[C1]], align 1
// CHECK-32-NEXT:    store float 1.000000e+00, ptr [[D2]], align 4
// CHECK-32-NEXT:    [[TMP3:%.*]] = load b8, ptr [[C1]], align 1
// CHECK-32-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP3]] to i8
// CHECK-32-NEXT:    [[CONV3:%.*]] = sext i8 [[CONV]] to i32
// CHECK-32-NEXT:    [[XOR:%.*]] = xor i32 [[CONV3]], 2
// CHECK-32-NEXT:    [[CONV4:%.*]] = trunc i32 [[XOR]] to i8
// CHECK-32-NEXT:    [[TMP4:%.*]] = bitcast i8 [[CONV4]] to b8
// CHECK-32-NEXT:    store b8 [[TMP4]], ptr [[C1]], align 1
// CHECK-32-NEXT:    [[TMP5:%.*]] = load float, ptr [[D2]], align 4
// CHECK-32-NEXT:    [[MUL:%.*]] = fmul float [[TMP5]], 3.300000e+01
...
// CHECK-32-NEXT:    [[TMP8:%.*]] = call i32 @__kmpc_nvptx_parallel_reduce_nowait_v2(ptr @[[GLOB1]], i64 8, ptr [[DOTOMP_REDUCTION_RED_LIST]], ptr @_omp_reduction_shuffle_and_reduce_func1, ptr @_omp_reduction_inter_warp_copy_func2)
// CHECK-32-NEXT:    [[TMP9:%.*]] = icmp eq i32 [[TMP8]], 1
// CHECK-32-NEXT:    br i1 [[TMP9]], label [[DOTOMP_REDUCTION_THEN:%.*]], label [[DOTOMP_REDUCTION_DONE:%.*]]
// CHECK-32:       .omp.reduction.then:
// CHECK-32-NEXT:    [[TMP10:%.*]] = load b8, ptr [[TMP0]], align 1
// CHECK-32-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP10]] to i8
// CHECK-32-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK-32-NEXT:    [[TMP11:%.*]] = load b8, ptr [[C1]], align 1
// CHECK-32-NEXT:    [[CONV7:%.*]] = bytecast exact b8 [[TMP11]] to i8
// CHECK-32-NEXT:    [[CONV8:%.*]] = sext i8 [[CONV7]] to i32
// CHECK-32-NEXT:    [[XOR9:%.*]] = xor i32 [[CONV6]], [[CONV8]]
// CHECK-32-NEXT:    [[CONV10:%.*]] = trunc i32 [[XOR9]] to i8
// CHECK-32-NEXT:    [[TMP12:%.*]] = bitcast i8 [[CONV10]] to b8
// CHECK-32-NEXT:    store b8 [[TMP12]], ptr [[TMP0]], align 1
// CHECK-32-NEXT:    [[TMP13:%.*]] = load float, ptr [[TMP1]], align 4
// CHECK-32-NEXT:    [[TMP14:%.*]] = load float, ptr [[D2]], align 4
// CHECK-32-NEXT:    [[MUL11:%.*]] = fmul float [[TMP13]], [[TMP14]]
...
// CHECK-32-EX-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[C_ADDR]], align 4
// CHECK-32-EX-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[D_ADDR]], align 4
// CHECK-32-EX-NEXT:    [[TMP2:%.*]] = bytecast exact b8 0 to i8
// CHECK-32-EX-NEXT:    store i8 [[TMP2]], ptr [[C1]], align 1
// CHECK-32-EX-NEXT:    store float 1.000000e+00, ptr [[D2]], align 4
// CHECK-32-EX-NEXT:    [[TMP3:%.*]] = load b8, ptr [[C1]], align 1
// CHECK-32-EX-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP3]] to i8
// CHECK-32-EX-NEXT:    [[CONV3:%.*]] = sext i8 [[CONV]] to i32
// CHECK-32-EX-NEXT:    [[XOR:%.*]] = xor i32 [[CONV3]], 2
// CHECK-32-EX-NEXT:    [[CONV4:%.*]] = trunc i32 [[XOR]] to i8
// CHECK-32-EX-NEXT:    [[TMP4:%.*]] = bitcast i8 [[CONV4]] to b8
// CHECK-32-EX-NEXT:    store b8 [[TMP4]], ptr [[C1]], align 1
// CHECK-32-EX-NEXT:    [[TMP5:%.*]] = load float, ptr [[D2]], align 4
// CHECK-32-EX-NEXT:    [[MUL:%.*]] = fmul float [[TMP5]], 3.300000e+01
...
// CHECK-32-EX-NEXT:    [[TMP8:%.*]] = call i32 @__kmpc_nvptx_parallel_reduce_nowait_v2(ptr @[[GLOB1]], i64 8, ptr [[DOTOMP_REDUCTION_RED_LIST]], ptr @_omp_reduction_shuffle_and_reduce_func1, ptr @_omp_reduction_inter_warp_copy_func2)
...
// CHECK-32-EX:       .omp.reduction.then:
// CHECK-32-EX-NEXT:    [[TMP10:%.*]] = load b8, ptr [[TMP0]], align 1
// CHECK-32-EX-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP10]] to i8
// CHECK-32-EX-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK-32-EX-NEXT:    [[TMP11:%.*]] = load b8, ptr [[C1]], align 1
// CHECK-32-EX-NEXT:    [[CONV7:%.*]] = bytecast exact b8 [[TMP11]] to i8
...
// CHECK-32-EX-NEXT:    [[TMP12:%.*]] = bitcast i8 [[CONV10]] to b8
// CHECK-32-EX-NEXT:    store b8 [[TMP12]], ptr [[TMP0]], align 1
// CHECK-32-EX-NEXT:    [[TMP13:%.*]] = load float, ptr [[TMP1]], align 4
// CHECK-32-EX-NEXT:    [[TMP14:%.*]] = load float, ptr [[D2]], align 4
// CHECK-32-EX-NEXT:    [[MUL11:%.*]] = fmul float [[TMP13]], [[TMP14]]
