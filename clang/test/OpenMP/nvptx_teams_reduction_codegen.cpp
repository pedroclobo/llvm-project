...
// CHECK1-NEXT:    [[CONV5:%.*]] = bytecast b8 [[TMP9]] to i8
// CHECK1-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK1-NEXT:    [[TMP10:%.*]] = load b8, ptr [[C1]], align 1
// CHECK1-NEXT:    [[CONV7:%.*]] = bytecast b8 [[TMP10]] to i8
...
// CHECK2-NEXT:    [[CONV5:%.*]] = bytecast b8 [[TMP9]] to i8
// CHECK2-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK2-NEXT:    [[TMP10:%.*]] = load b8, ptr [[C1]], align 1
// CHECK2-NEXT:    [[CONV7:%.*]] = bytecast b8 [[TMP10]] to i8
...
// CHECK3-NEXT:    [[CONV5:%.*]] = bytecast b8 [[TMP9]] to i8
// CHECK3-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK3-NEXT:    [[TMP10:%.*]] = load b8, ptr [[C1]], align 1
// CHECK3-NEXT:    [[CONV7:%.*]] = bytecast b8 [[TMP10]] to i8
