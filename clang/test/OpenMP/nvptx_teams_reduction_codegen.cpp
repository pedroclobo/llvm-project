...
// CHECK1-NEXT:    br i1 [[EXEC_USER_CODE]], label [[USER_CODE_ENTRY:%.*]], label [[WORKER_EXIT:%.*]]
// CHECK1:       user_code.entry:
// CHECK1-NEXT:    [[TMP1:%.*]] = load b8, ptr [[C_ADDR]], align 1
// CHECK1-NEXT:    [[C1:%.*]] = call align 8 ptr @__kmpc_alloc_shared(i64 1)
// CHECK1-NEXT:    store b8 [[TMP1]], ptr [[C1]], align 1
...
// CHECK1-NEXT:    [[TMP2:%.*]] = load b8, ptr [[C1]], align 1
// CHECK1-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP2]] to i8
// CHECK1-NEXT:    [[CONV3:%.*]] = sext i8 [[CONV]] to i32
// CHECK1-NEXT:    [[XOR:%.*]] = xor i32 [[CONV3]], 2
// CHECK1-NEXT:    [[CONV4:%.*]] = trunc i32 [[XOR]] to i8
// CHECK1-NEXT:    [[TMP3:%.*]] = bitcast i8 [[CONV4]] to b8
// CHECK1-NEXT:    store b8 [[TMP3]], ptr [[C1]], align 1
// CHECK1-NEXT:    [[TMP4:%.*]] = load float, ptr [[D2]], align 4
// CHECK1-NEXT:    [[MUL:%.*]] = fmul float [[TMP4]], 3.300000e+01
...
// CHECK1-NEXT:    [[DOTOMP_REDUCTION_ELEMENT:%.*]] = alloca b8, align 1
...
// CHECK1-NEXT:    [[TMP11:%.*]] = getelementptr b8, ptr [[TMP9]], i64 1
...
// CHECK1-NEXT:    store i32 [[TMP16]], ptr [[DOTOMP_REDUCTION_ELEMENT]], align 4
// CHECK1-NEXT:    [[TMP17:%.*]] = getelementptr i8, ptr [[TMP9]], i64 1
// CHECK1-NEXT:    [[TMP18:%.*]] = getelementptr i8, ptr [[DOTOMP_REDUCTION_ELEMENT]], i64 1
// CHECK1-NEXT:    store ptr [[DOTOMP_REDUCTION_ELEMENT]], ptr [[TMP10]], align 8
// CHECK1-NEXT:    [[TMP19:%.*]] = getelementptr inbounds [2 x ptr], ptr [[TMP4]], i64 0, i64 1
// CHECK1-NEXT:    [[TMP20:%.*]] = load ptr, ptr [[TMP19]], align 8
// CHECK1-NEXT:    [[TMP21:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOMP_REDUCTION_REMOTE_REDUCE_LIST]], i64 0, i64 1
// CHECK1-NEXT:    [[TMP22:%.*]] = getelementptr float, ptr [[TMP20]], i64 1
...
// CHECK1-NEXT:    store i32 [[TMP26]], ptr [[DOTOMP_REDUCTION_ELEMENT4]], align 4
// CHECK1-NEXT:    [[TMP27:%.*]] = getelementptr i32, ptr [[TMP20]], i64 1
// CHECK1-NEXT:    [[TMP28:%.*]] = getelementptr i32, ptr [[DOTOMP_REDUCTION_ELEMENT4]], i64 1
// CHECK1-NEXT:    store ptr [[DOTOMP_REDUCTION_ELEMENT4]], ptr [[TMP21]], align 8
// CHECK1-NEXT:    [[TMP29:%.*]] = icmp eq i16 [[TMP7]], 0
// CHECK1-NEXT:    [[TMP30:%.*]] = icmp eq i16 [[TMP7]], 1
// CHECK1-NEXT:    [[TMP31:%.*]] = icmp ult i16 [[TMP5]], [[TMP6]]
// CHECK1-NEXT:    [[TMP32:%.*]] = and i1 [[TMP30]], [[TMP31]]
// CHECK1-NEXT:    [[TMP33:%.*]] = icmp eq i16 [[TMP7]], 2
// CHECK1-NEXT:    [[TMP34:%.*]] = and i16 [[TMP5]], 1
// CHECK1-NEXT:    [[TMP35:%.*]] = icmp eq i16 [[TMP34]], 0
// CHECK1-NEXT:    [[TMP36:%.*]] = and i1 [[TMP33]], [[TMP35]]
// CHECK1-NEXT:    [[TMP37:%.*]] = icmp sgt i16 [[TMP6]], 0
// CHECK1-NEXT:    [[TMP38:%.*]] = and i1 [[TMP36]], [[TMP37]]
// CHECK1-NEXT:    [[TMP39:%.*]] = or i1 [[TMP29]], [[TMP32]]
// CHECK1-NEXT:    [[TMP40:%.*]] = or i1 [[TMP39]], [[TMP38]]
// CHECK1-NEXT:    br i1 [[TMP40]], label [[THEN:%.*]], label [[ELSE:%.*]]
// CHECK1:       then:
...
// CHECK1-NEXT:    br label [[IFCONT]]
// CHECK1:       ifcont:
// CHECK1-NEXT:    [[TMP41:%.*]] = icmp eq i16 [[TMP7]], 1
// CHECK1-NEXT:    [[TMP42:%.*]] = icmp uge i16 [[TMP5]], [[TMP6]]
// CHECK1-NEXT:    [[TMP43:%.*]] = and i1 [[TMP41]], [[TMP42]]
// CHECK1-NEXT:    br i1 [[TMP43]], label [[THEN5:%.*]], label [[ELSE6:%.*]]
// CHECK1:       then5:
// CHECK1-NEXT:    [[TMP44:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOMP_REDUCTION_REMOTE_REDUCE_LIST]], i64 0, i64 0
// CHECK1-NEXT:    [[TMP45:%.*]] = load ptr, ptr [[TMP44]], align 8
// CHECK1-NEXT:    [[TMP46:%.*]] = getelementptr inbounds [2 x ptr], ptr [[TMP4]], i64 0, i64 0
// CHECK1-NEXT:    [[TMP47:%.*]] = load ptr, ptr [[TMP46]], align 8
// CHECK1-NEXT:    [[TMP48:%.*]] = load b8, ptr [[TMP45]], align 1
// CHECK1-NEXT:    store b8 [[TMP48]], ptr [[TMP47]], align 1
// CHECK1-NEXT:    [[TMP49:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOMP_REDUCTION_REMOTE_REDUCE_LIST]], i64 0, i64 1
// CHECK1-NEXT:    [[TMP50:%.*]] = load ptr, ptr [[TMP49]], align 8
// CHECK1-NEXT:    [[TMP51:%.*]] = getelementptr inbounds [2 x ptr], ptr [[TMP4]], i64 0, i64 1
// CHECK1-NEXT:    [[TMP52:%.*]] = load ptr, ptr [[TMP51]], align 8
// CHECK1-NEXT:    [[TMP53:%.*]] = load float, ptr [[TMP50]], align 4
// CHECK1-NEXT:    store float [[TMP53]], ptr [[TMP52]], align 4
...
// CHECK1-NEXT:    [[TMP10:%.*]] = load b8, ptr [[TMP7]], align 1
// CHECK1-NEXT:    store b8 [[TMP10]], ptr [[TMP9]], align 1
...
// CHECK1-NEXT:    [[TMP8:%.*]] = getelementptr inbounds [[STRUCT__GLOBALIZED_LOCALS_TY_1:%.*]], ptr [[TMP4]], i32 [[TMP5]]
// CHECK1-NEXT:    [[TMP9:%.*]] = getelementptr inbounds [[STRUCT__GLOBALIZED_LOCALS_TY_1]], ptr [[TMP8]], i32 0, i32 0
// CHECK1-NEXT:    [[TMP10:%.*]] = load b8, ptr [[TMP9]], align 1
// CHECK1-NEXT:    store b8 [[TMP10]], ptr [[TMP7]], align 1
// CHECK1-NEXT:    [[TMP11:%.*]] = getelementptr inbounds [2 x ptr], ptr [[TMP3]], i64 0, i64 1
// CHECK1-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[TMP11]], align 8
// CHECK1-NEXT:    [[TMP13:%.*]] = getelementptr inbounds [[STRUCT__GLOBALIZED_LOCALS_TY_1]], ptr [[TMP4]], i32 [[TMP5]]
// CHECK1-NEXT:    [[TMP14:%.*]] = getelementptr inbounds [[STRUCT__GLOBALIZED_LOCALS_TY_1]], ptr [[TMP13]], i32 0, i32 1
...
// CHECK2-NEXT:    br i1 [[EXEC_USER_CODE]], label [[USER_CODE_ENTRY:%.*]], label [[WORKER_EXIT:%.*]]
// CHECK2:       user_code.entry:
// CHECK2-NEXT:    [[TMP1:%.*]] = load b8, ptr [[C_ADDR]], align 1
// CHECK2-NEXT:    [[C1:%.*]] = call align 8 ptr @__kmpc_alloc_shared(i32 1)
// CHECK2-NEXT:    store b8 [[TMP1]], ptr [[C1]], align 1
...
// CHECK2-NEXT:    [[TMP2:%.*]] = load b8, ptr [[C1]], align 1
// CHECK2-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP2]] to i8
// CHECK2-NEXT:    [[CONV3:%.*]] = sext i8 [[CONV]] to i32
// CHECK2-NEXT:    [[XOR:%.*]] = xor i32 [[CONV3]], 2
// CHECK2-NEXT:    [[CONV4:%.*]] = trunc i32 [[XOR]] to i8
// CHECK2-NEXT:    [[TMP3:%.*]] = bitcast i8 [[CONV4]] to b8
// CHECK2-NEXT:    store b8 [[TMP3]], ptr [[C1]], align 1
// CHECK2-NEXT:    [[TMP4:%.*]] = load float, ptr [[D2]], align 4
// CHECK2-NEXT:    [[MUL:%.*]] = fmul float [[TMP4]], 3.300000e+01
...
// CHECK2-NEXT:    store ptr [[C1]], ptr [[TMP5]], align 4
// CHECK2-NEXT:    [[TMP6:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOMP_REDUCTION_RED_LIST]], i32 0, i32 1
// CHECK2-NEXT:    store ptr [[D2]], ptr [[TMP6]], align 4
// CHECK2-NEXT:    %"_openmp_teams_reductions_buffer_$_$ptr" = call ptr @__kmpc_reduction_get_fixed_buffer()
// CHECK2-NEXT:    [[TMP7:%.*]] = call i32 @__kmpc_nvptx_teams_reduce_nowait_v2(ptr @[[GLOB1]], ptr %"_openmp_teams_reductions_buffer_$_$ptr", i32 1024, i64 8, ptr [[DOTOMP_REDUCTION_RED_LIST]], ptr @_omp_reduction_shuffle_and_reduce_func1, ptr @_omp_reduction_inter_warp_copy_func2, ptr @_omp_reduction_list_to_global_copy_func3, ptr @_omp_reduction_list_to_global_reduce_func4, ptr @_omp_reduction_global_to_list_copy_func5, ptr @_omp_reduction_global_to_list_reduce_func6)
// CHECK2-NEXT:    [[TMP8:%.*]] = icmp eq i32 [[TMP7]], 1
// CHECK2-NEXT:    br i1 [[TMP8]], label [[DOTOMP_REDUCTION_THEN:%.*]], label [[DOTOMP_REDUCTION_DONE:%.*]]
// CHECK2:       .omp.reduction.then:
// CHECK2-NEXT:    [[TMP9:%.*]] = load b8, ptr [[TMP0]], align 1
// CHECK2-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP9]] to i8
// CHECK2-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK2-NEXT:    [[TMP10:%.*]] = load b8, ptr [[C1]], align 1
// CHECK2-NEXT:    [[CONV7:%.*]] = bytecast exact b8 [[TMP10]] to i8
// CHECK2-NEXT:    [[CONV8:%.*]] = sext i8 [[CONV7]] to i32
// CHECK2-NEXT:    [[XOR9:%.*]] = xor i32 [[CONV6]], [[CONV8]]
// CHECK2-NEXT:    [[CONV10:%.*]] = trunc i32 [[XOR9]] to i8
// CHECK2-NEXT:    [[TMP11:%.*]] = bitcast i8 [[CONV10]] to b8
// CHECK2-NEXT:    store b8 [[TMP11]], ptr [[TMP0]], align 1
// CHECK2-NEXT:    [[TMP12:%.*]] = load float, ptr [[TMP1]], align 4
// CHECK2-NEXT:    [[TMP13:%.*]] = load float, ptr [[D2]], align 4
// CHECK2-NEXT:    [[MUL11:%.*]] = fmul float [[TMP12]], [[TMP13]]
// CHECK2-NEXT:    store float [[MUL11]], ptr [[TMP1]], align 4
// CHECK2-NEXT:    br label [[DOTOMP_REDUCTION_DONE]]
// CHECK2:       .omp.reduction.done:
// CHECK2-NEXT:    call void @__kmpc_free_shared(ptr [[D2]], i32 4)
// CHECK2-NEXT:    call void @__kmpc_free_shared(ptr [[C1]], i32 1)
...
// CHECK2-NEXT:    [[DOTOMP_REDUCTION_ELEMENT:%.*]] = alloca b8, align 1
...
// CHECK2-NEXT:    [[TMP11:%.*]] = getelementptr b8, ptr [[TMP9]], i32 1
...
// CHECK2-NEXT:    store i32 [[TMP16]], ptr [[DOTOMP_REDUCTION_ELEMENT]], align 4
// CHECK2-NEXT:    [[TMP17:%.*]] = getelementptr i8, ptr [[TMP9]], i32 1
// CHECK2-NEXT:    [[TMP18:%.*]] = getelementptr i8, ptr [[DOTOMP_REDUCTION_ELEMENT]], i32 1
// CHECK2-NEXT:    store ptr [[DOTOMP_REDUCTION_ELEMENT]], ptr [[TMP10]], align 4
// CHECK2-NEXT:    [[TMP19:%.*]] = getelementptr inbounds [2 x ptr], ptr [[TMP4]], i32 0, i32 1
// CHECK2-NEXT:    [[TMP20:%.*]] = load ptr, ptr [[TMP19]], align 4
// CHECK2-NEXT:    [[TMP21:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOMP_REDUCTION_REMOTE_REDUCE_LIST]], i32 0, i32 1
// CHECK2-NEXT:    [[TMP22:%.*]] = getelementptr float, ptr [[TMP20]], i32 1
...
// CHECK2-NEXT:    store i32 [[TMP26]], ptr [[DOTOMP_REDUCTION_ELEMENT4]], align 4
// CHECK2-NEXT:    [[TMP27:%.*]] = getelementptr i32, ptr [[TMP20]], i32 1
// CHECK2-NEXT:    [[TMP28:%.*]] = getelementptr i32, ptr [[DOTOMP_REDUCTION_ELEMENT4]], i32 1
// CHECK2-NEXT:    store ptr [[DOTOMP_REDUCTION_ELEMENT4]], ptr [[TMP21]], align 4
// CHECK2-NEXT:    [[TMP29:%.*]] = icmp eq i16 [[TMP7]], 0
// CHECK2-NEXT:    [[TMP30:%.*]] = icmp eq i16 [[TMP7]], 1
// CHECK2-NEXT:    [[TMP31:%.*]] = icmp ult i16 [[TMP5]], [[TMP6]]
// CHECK2-NEXT:    [[TMP32:%.*]] = and i1 [[TMP30]], [[TMP31]]
// CHECK2-NEXT:    [[TMP33:%.*]] = icmp eq i16 [[TMP7]], 2
// CHECK2-NEXT:    [[TMP34:%.*]] = and i16 [[TMP5]], 1
// CHECK2-NEXT:    [[TMP35:%.*]] = icmp eq i16 [[TMP34]], 0
// CHECK2-NEXT:    [[TMP36:%.*]] = and i1 [[TMP33]], [[TMP35]]
// CHECK2-NEXT:    [[TMP37:%.*]] = icmp sgt i16 [[TMP6]], 0
// CHECK2-NEXT:    [[TMP38:%.*]] = and i1 [[TMP36]], [[TMP37]]
// CHECK2-NEXT:    [[TMP39:%.*]] = or i1 [[TMP29]], [[TMP32]]
// CHECK2-NEXT:    [[TMP40:%.*]] = or i1 [[TMP39]], [[TMP38]]
// CHECK2-NEXT:    br i1 [[TMP40]], label [[THEN:%.*]], label [[ELSE:%.*]]
// CHECK2:       then:
...
// CHECK2-NEXT:    br label [[IFCONT]]
// CHECK2:       ifcont:
// CHECK2-NEXT:    [[TMP41:%.*]] = icmp eq i16 [[TMP7]], 1
// CHECK2-NEXT:    [[TMP42:%.*]] = icmp uge i16 [[TMP5]], [[TMP6]]
// CHECK2-NEXT:    [[TMP43:%.*]] = and i1 [[TMP41]], [[TMP42]]
// CHECK2-NEXT:    br i1 [[TMP43]], label [[THEN5:%.*]], label [[ELSE6:%.*]]
// CHECK2:       then5:
// CHECK2-NEXT:    [[TMP44:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOMP_REDUCTION_REMOTE_REDUCE_LIST]], i32 0, i32 0
// CHECK2-NEXT:    [[TMP45:%.*]] = load ptr, ptr [[TMP44]], align 4
// CHECK2-NEXT:    [[TMP46:%.*]] = getelementptr inbounds [2 x ptr], ptr [[TMP4]], i32 0, i32 0
// CHECK2-NEXT:    [[TMP47:%.*]] = load ptr, ptr [[TMP46]], align 4
// CHECK2-NEXT:    [[TMP48:%.*]] = load b8, ptr [[TMP45]], align 1
// CHECK2-NEXT:    store b8 [[TMP48]], ptr [[TMP47]], align 1
// CHECK2-NEXT:    [[TMP49:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOMP_REDUCTION_REMOTE_REDUCE_LIST]], i32 0, i32 1
// CHECK2-NEXT:    [[TMP50:%.*]] = load ptr, ptr [[TMP49]], align 4
// CHECK2-NEXT:    [[TMP51:%.*]] = getelementptr inbounds [2 x ptr], ptr [[TMP4]], i32 0, i32 1
// CHECK2-NEXT:    [[TMP52:%.*]] = load ptr, ptr [[TMP51]], align 4
// CHECK2-NEXT:    [[TMP53:%.*]] = load float, ptr [[TMP50]], align 4
// CHECK2-NEXT:    store float [[TMP53]], ptr [[TMP52]], align 4
...
// CHECK2-NEXT:    [[TMP10:%.*]] = load b8, ptr [[TMP7]], align 1
// CHECK2-NEXT:    store b8 [[TMP10]], ptr [[TMP9]], align 1
...
// CHECK2-NEXT:    [[TMP8:%.*]] = getelementptr inbounds [[STRUCT__GLOBALIZED_LOCALS_TY_1:%.*]], ptr [[TMP4]], i32 [[TMP5]]
// CHECK2-NEXT:    [[TMP9:%.*]] = getelementptr inbounds [[STRUCT__GLOBALIZED_LOCALS_TY_1]], ptr [[TMP8]], i32 0, i32 0
// CHECK2-NEXT:    [[TMP10:%.*]] = load b8, ptr [[TMP9]], align 1
// CHECK2-NEXT:    store b8 [[TMP10]], ptr [[TMP7]], align 1
// CHECK2-NEXT:    [[TMP11:%.*]] = getelementptr inbounds [2 x ptr], ptr [[TMP3]], i32 0, i32 1
// CHECK2-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[TMP11]], align 4
// CHECK2-NEXT:    [[TMP13:%.*]] = getelementptr inbounds [[STRUCT__GLOBALIZED_LOCALS_TY_1]], ptr [[TMP4]], i32 [[TMP5]]
// CHECK2-NEXT:    [[TMP14:%.*]] = getelementptr inbounds [[STRUCT__GLOBALIZED_LOCALS_TY_1]], ptr [[TMP13]], i32 0, i32 1
...
// CHECK3-NEXT:    br i1 [[EXEC_USER_CODE]], label [[USER_CODE_ENTRY:%.*]], label [[WORKER_EXIT:%.*]]
// CHECK3:       user_code.entry:
// CHECK3-NEXT:    [[TMP1:%.*]] = load b8, ptr [[C_ADDR]], align 1
// CHECK3-NEXT:    [[C1:%.*]] = call align 8 ptr @__kmpc_alloc_shared(i32 1)
// CHECK3-NEXT:    store b8 [[TMP1]], ptr [[C1]], align 1
...
// CHECK3-NEXT:    [[TMP2:%.*]] = load b8, ptr [[C1]], align 1
// CHECK3-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP2]] to i8
// CHECK3-NEXT:    [[CONV3:%.*]] = sext i8 [[CONV]] to i32
// CHECK3-NEXT:    [[XOR:%.*]] = xor i32 [[CONV3]], 2
// CHECK3-NEXT:    [[CONV4:%.*]] = trunc i32 [[XOR]] to i8
// CHECK3-NEXT:    [[TMP3:%.*]] = bitcast i8 [[CONV4]] to b8
// CHECK3-NEXT:    store b8 [[TMP3]], ptr [[C1]], align 1
// CHECK3-NEXT:    [[TMP4:%.*]] = load float, ptr [[D2]], align 4
// CHECK3-NEXT:    [[MUL:%.*]] = fmul float [[TMP4]], 3.300000e+01
...
// CHECK3-NEXT:    store ptr [[C1]], ptr [[TMP5]], align 4
// CHECK3-NEXT:    [[TMP6:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOMP_REDUCTION_RED_LIST]], i32 0, i32 1
// CHECK3-NEXT:    store ptr [[D2]], ptr [[TMP6]], align 4
// CHECK3-NEXT:    %"_openmp_teams_reductions_buffer_$_$ptr" = call ptr @__kmpc_reduction_get_fixed_buffer()
// CHECK3-NEXT:    [[TMP7:%.*]] = call i32 @__kmpc_nvptx_teams_reduce_nowait_v2(ptr @[[GLOB1]], ptr %"_openmp_teams_reductions_buffer_$_$ptr", i32 2048, i64 8, ptr [[DOTOMP_REDUCTION_RED_LIST]], ptr @_omp_reduction_shuffle_and_reduce_func1, ptr @_omp_reduction_inter_warp_copy_func2, ptr @_omp_reduction_list_to_global_copy_func3, ptr @_omp_reduction_list_to_global_reduce_func4, ptr @_omp_reduction_global_to_list_copy_func5, ptr @_omp_reduction_global_to_list_reduce_func6)
// CHECK3-NEXT:    [[TMP8:%.*]] = icmp eq i32 [[TMP7]], 1
// CHECK3-NEXT:    br i1 [[TMP8]], label [[DOTOMP_REDUCTION_THEN:%.*]], label [[DOTOMP_REDUCTION_DONE:%.*]]
// CHECK3:       .omp.reduction.then:
// CHECK3-NEXT:    [[TMP9:%.*]] = load b8, ptr [[TMP0]], align 1
// CHECK3-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP9]] to i8
// CHECK3-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK3-NEXT:    [[TMP10:%.*]] = load b8, ptr [[C1]], align 1
// CHECK3-NEXT:    [[CONV7:%.*]] = bytecast exact b8 [[TMP10]] to i8
// CHECK3-NEXT:    [[CONV8:%.*]] = sext i8 [[CONV7]] to i32
// CHECK3-NEXT:    [[XOR9:%.*]] = xor i32 [[CONV6]], [[CONV8]]
// CHECK3-NEXT:    [[CONV10:%.*]] = trunc i32 [[XOR9]] to i8
// CHECK3-NEXT:    [[TMP11:%.*]] = bitcast i8 [[CONV10]] to b8
// CHECK3-NEXT:    store b8 [[TMP11]], ptr [[TMP0]], align 1
// CHECK3-NEXT:    [[TMP12:%.*]] = load float, ptr [[TMP1]], align 4
// CHECK3-NEXT:    [[TMP13:%.*]] = load float, ptr [[D2]], align 4
// CHECK3-NEXT:    [[MUL11:%.*]] = fmul float [[TMP12]], [[TMP13]]
// CHECK3-NEXT:    store float [[MUL11]], ptr [[TMP1]], align 4
// CHECK3-NEXT:    br label [[DOTOMP_REDUCTION_DONE]]
// CHECK3:       .omp.reduction.done:
// CHECK3-NEXT:    call void @__kmpc_free_shared(ptr [[D2]], i32 4)
// CHECK3-NEXT:    call void @__kmpc_free_shared(ptr [[C1]], i32 1)
...
// CHECK3-NEXT:    [[DOTOMP_REDUCTION_ELEMENT:%.*]] = alloca b8, align 1
...
// CHECK3-NEXT:    [[TMP11:%.*]] = getelementptr b8, ptr [[TMP9]], i32 1
...
// CHECK3-NEXT:    store i32 [[TMP16]], ptr [[DOTOMP_REDUCTION_ELEMENT]], align 4
// CHECK3-NEXT:    [[TMP17:%.*]] = getelementptr i8, ptr [[TMP9]], i32 1
// CHECK3-NEXT:    [[TMP18:%.*]] = getelementptr i8, ptr [[DOTOMP_REDUCTION_ELEMENT]], i32 1
// CHECK3-NEXT:    store ptr [[DOTOMP_REDUCTION_ELEMENT]], ptr [[TMP10]], align 4
// CHECK3-NEXT:    [[TMP19:%.*]] = getelementptr inbounds [2 x ptr], ptr [[TMP4]], i32 0, i32 1
// CHECK3-NEXT:    [[TMP20:%.*]] = load ptr, ptr [[TMP19]], align 4
// CHECK3-NEXT:    [[TMP21:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOMP_REDUCTION_REMOTE_REDUCE_LIST]], i32 0, i32 1
// CHECK3-NEXT:    [[TMP22:%.*]] = getelementptr float, ptr [[TMP20]], i32 1
...
// CHECK3-NEXT:    store i32 [[TMP26]], ptr [[DOTOMP_REDUCTION_ELEMENT4]], align 4
// CHECK3-NEXT:    [[TMP27:%.*]] = getelementptr i32, ptr [[TMP20]], i32 1
// CHECK3-NEXT:    [[TMP28:%.*]] = getelementptr i32, ptr [[DOTOMP_REDUCTION_ELEMENT4]], i32 1
// CHECK3-NEXT:    store ptr [[DOTOMP_REDUCTION_ELEMENT4]], ptr [[TMP21]], align 4
// CHECK3-NEXT:    [[TMP29:%.*]] = icmp eq i16 [[TMP7]], 0
// CHECK3-NEXT:    [[TMP30:%.*]] = icmp eq i16 [[TMP7]], 1
// CHECK3-NEXT:    [[TMP31:%.*]] = icmp ult i16 [[TMP5]], [[TMP6]]
// CHECK3-NEXT:    [[TMP32:%.*]] = and i1 [[TMP30]], [[TMP31]]
// CHECK3-NEXT:    [[TMP33:%.*]] = icmp eq i16 [[TMP7]], 2
// CHECK3-NEXT:    [[TMP34:%.*]] = and i16 [[TMP5]], 1
// CHECK3-NEXT:    [[TMP35:%.*]] = icmp eq i16 [[TMP34]], 0
// CHECK3-NEXT:    [[TMP36:%.*]] = and i1 [[TMP33]], [[TMP35]]
// CHECK3-NEXT:    [[TMP37:%.*]] = icmp sgt i16 [[TMP6]], 0
// CHECK3-NEXT:    [[TMP38:%.*]] = and i1 [[TMP36]], [[TMP37]]
// CHECK3-NEXT:    [[TMP39:%.*]] = or i1 [[TMP29]], [[TMP32]]
// CHECK3-NEXT:    [[TMP40:%.*]] = or i1 [[TMP39]], [[TMP38]]
// CHECK3-NEXT:    br i1 [[TMP40]], label [[THEN:%.*]], label [[ELSE:%.*]]
// CHECK3:       then:
...
// CHECK3-NEXT:    br label [[IFCONT]]
// CHECK3:       ifcont:
// CHECK3-NEXT:    [[TMP41:%.*]] = icmp eq i16 [[TMP7]], 1
// CHECK3-NEXT:    [[TMP42:%.*]] = icmp uge i16 [[TMP5]], [[TMP6]]
// CHECK3-NEXT:    [[TMP43:%.*]] = and i1 [[TMP41]], [[TMP42]]
// CHECK3-NEXT:    br i1 [[TMP43]], label [[THEN5:%.*]], label [[ELSE6:%.*]]
// CHECK3:       then5:
// CHECK3-NEXT:    [[TMP44:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOMP_REDUCTION_REMOTE_REDUCE_LIST]], i32 0, i32 0
// CHECK3-NEXT:    [[TMP45:%.*]] = load ptr, ptr [[TMP44]], align 4
// CHECK3-NEXT:    [[TMP46:%.*]] = getelementptr inbounds [2 x ptr], ptr [[TMP4]], i32 0, i32 0
// CHECK3-NEXT:    [[TMP47:%.*]] = load ptr, ptr [[TMP46]], align 4
// CHECK3-NEXT:    [[TMP48:%.*]] = load b8, ptr [[TMP45]], align 1
// CHECK3-NEXT:    store b8 [[TMP48]], ptr [[TMP47]], align 1
// CHECK3-NEXT:    [[TMP49:%.*]] = getelementptr inbounds [2 x ptr], ptr [[DOTOMP_REDUCTION_REMOTE_REDUCE_LIST]], i32 0, i32 1
// CHECK3-NEXT:    [[TMP50:%.*]] = load ptr, ptr [[TMP49]], align 4
// CHECK3-NEXT:    [[TMP51:%.*]] = getelementptr inbounds [2 x ptr], ptr [[TMP4]], i32 0, i32 1
// CHECK3-NEXT:    [[TMP52:%.*]] = load ptr, ptr [[TMP51]], align 4
// CHECK3-NEXT:    [[TMP53:%.*]] = load float, ptr [[TMP50]], align 4
// CHECK3-NEXT:    store float [[TMP53]], ptr [[TMP52]], align 4
...
// CHECK3-NEXT:    [[TMP10:%.*]] = load b8, ptr [[TMP7]], align 1
// CHECK3-NEXT:    store b8 [[TMP10]], ptr [[TMP9]], align 1
...
// CHECK3-NEXT:    [[TMP8:%.*]] = getelementptr inbounds [[STRUCT__GLOBALIZED_LOCALS_TY_1:%.*]], ptr [[TMP4]], i32 [[TMP5]]
// CHECK3-NEXT:    [[TMP9:%.*]] = getelementptr inbounds [[STRUCT__GLOBALIZED_LOCALS_TY_1]], ptr [[TMP8]], i32 0, i32 0
// CHECK3-NEXT:    [[TMP10:%.*]] = load b8, ptr [[TMP9]], align 1
// CHECK3-NEXT:    store b8 [[TMP10]], ptr [[TMP7]], align 1
// CHECK3-NEXT:    [[TMP11:%.*]] = getelementptr inbounds [2 x ptr], ptr [[TMP3]], i32 0, i32 1
// CHECK3-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[TMP11]], align 4
// CHECK3-NEXT:    [[TMP13:%.*]] = getelementptr inbounds [[STRUCT__GLOBALIZED_LOCALS_TY_1]], ptr [[TMP4]], i32 [[TMP5]]
// CHECK3-NEXT:    [[TMP14:%.*]] = getelementptr inbounds [[STRUCT__GLOBALIZED_LOCALS_TY_1]], ptr [[TMP13]], i32 0, i32 1
