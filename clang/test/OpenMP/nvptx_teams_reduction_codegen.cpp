...
// CHECK1-NEXT:    [[C1:%.*]] = call align 8 ptr @__kmpc_alloc_shared(i64 1)
// CHECK1-NEXT:    [[D2:%.*]] = call align 8 ptr @__kmpc_alloc_shared(i64 4)
// CHECK1-NEXT:    [[TMP2:%.*]] = bytecast exact b8 0 to i8
// CHECK1-NEXT:    store i8 [[TMP2]], ptr [[C1]], align 1
// CHECK1-NEXT:    store float 1.000000e+00, ptr [[D2]], align 4
// CHECK1-NEXT:    [[TMP3:%.*]] = load b8, ptr [[C1]], align 1
...
// CHECK1-NEXT:    [[TMP4:%.*]] = bitcast i8 [[CONV4]] to b8
// CHECK1-NEXT:    store b8 [[TMP4]], ptr [[C1]], align 1
// CHECK1-NEXT:    [[TMP5:%.*]] = load float, ptr [[D2]], align 4
// CHECK1-NEXT:    [[MUL:%.*]] = fmul float [[TMP5]], 3.300000e+01
...
// CHECK1:       .omp.reduction.then:
// CHECK1-NEXT:    [[TMP10:%.*]] = load b8, ptr [[TMP0]], align 1
// CHECK1-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP10]] to i8
// CHECK1-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK1-NEXT:    [[TMP11:%.*]] = load b8, ptr [[C1]], align 1
// CHECK1-NEXT:    [[CONV7:%.*]] = bytecast exact b8 [[TMP11]] to i8
// CHECK1-NEXT:    [[CONV8:%.*]] = sext i8 [[CONV7]] to i32
// CHECK1-NEXT:    [[XOR9:%.*]] = xor i32 [[CONV6]], [[CONV8]]
// CHECK1-NEXT:    [[CONV10:%.*]] = trunc i32 [[XOR9]] to i8
// CHECK1-NEXT:    [[TMP12:%.*]] = bitcast i8 [[CONV10]] to b8
// CHECK1-NEXT:    store b8 [[TMP12]], ptr [[TMP0]], align 1
// CHECK1-NEXT:    [[TMP13:%.*]] = load float, ptr [[TMP1]], align 4
// CHECK1-NEXT:    [[TMP14:%.*]] = load float, ptr [[D2]], align 4
// CHECK1-NEXT:    [[MUL11:%.*]] = fmul float [[TMP13]], [[TMP14]]
...
// CHECK2-NEXT:    [[C1:%.*]] = call align 8 ptr @__kmpc_alloc_shared(i32 1)
// CHECK2-NEXT:    [[D2:%.*]] = call align 8 ptr @__kmpc_alloc_shared(i32 4)
// CHECK2-NEXT:    [[TMP2:%.*]] = bytecast exact b8 0 to i8
// CHECK2-NEXT:    store i8 [[TMP2]], ptr [[C1]], align 1
// CHECK2-NEXT:    store float 1.000000e+00, ptr [[D2]], align 4
// CHECK2-NEXT:    [[TMP3:%.*]] = load b8, ptr [[C1]], align 1
// CHECK2-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP3]] to i8
// CHECK2-NEXT:    [[CONV3:%.*]] = sext i8 [[CONV]] to i32
// CHECK2-NEXT:    [[XOR:%.*]] = xor i32 [[CONV3]], 2
// CHECK2-NEXT:    [[CONV4:%.*]] = trunc i32 [[XOR]] to i8
// CHECK2-NEXT:    [[TMP4:%.*]] = bitcast i8 [[CONV4]] to b8
// CHECK2-NEXT:    store b8 [[TMP4]], ptr [[C1]], align 1
// CHECK2-NEXT:    [[TMP5:%.*]] = load float, ptr [[D2]], align 4
...
// CHECK2:       .omp.reduction.then:
// CHECK2-NEXT:    [[TMP10:%.*]] = load b8, ptr [[TMP0]], align 1
// CHECK2-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP10]] to i8
// CHECK2-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK2-NEXT:    [[TMP11:%.*]] = load b8, ptr [[C1]], align 1
// CHECK2-NEXT:    [[CONV7:%.*]] = bytecast exact b8 [[TMP11]] to i8
// CHECK2-NEXT:    [[CONV8:%.*]] = sext i8 [[CONV7]] to i32
// CHECK2-NEXT:    [[XOR9:%.*]] = xor i32 [[CONV6]], [[CONV8]]
// CHECK2-NEXT:    [[CONV10:%.*]] = trunc i32 [[XOR9]] to i8
// CHECK2-NEXT:    [[TMP12:%.*]] = bitcast i8 [[CONV10]] to b8
// CHECK2-NEXT:    store b8 [[TMP12]], ptr [[TMP0]], align 1
// CHECK2-NEXT:    [[TMP13:%.*]] = load float, ptr [[TMP1]], align 4
// CHECK2-NEXT:    [[TMP14:%.*]] = load float, ptr [[D2]], align 4
// CHECK2-NEXT:    [[MUL11:%.*]] = fmul float [[TMP13]], [[TMP14]]
...
// CHECK3-NEXT:    [[C1:%.*]] = call align 8 ptr @__kmpc_alloc_shared(i32 1)
// CHECK3-NEXT:    [[D2:%.*]] = call align 8 ptr @__kmpc_alloc_shared(i32 4)
// CHECK3-NEXT:    [[TMP2:%.*]] = bytecast exact b8 0 to i8
// CHECK3-NEXT:    store i8 [[TMP2]], ptr [[C1]], align 1
// CHECK3-NEXT:    store float 1.000000e+00, ptr [[D2]], align 4
// CHECK3-NEXT:    [[TMP3:%.*]] = load b8, ptr [[C1]], align 1
...
// CHECK3-NEXT:    [[TMP4:%.*]] = bitcast i8 [[CONV4]] to b8
// CHECK3-NEXT:    store b8 [[TMP4]], ptr [[C1]], align 1
// CHECK3-NEXT:    [[TMP5:%.*]] = load float, ptr [[D2]], align 4
// CHECK3-NEXT:    [[MUL:%.*]] = fmul float [[TMP5]], 3.300000e+01
...
// CHECK3:       .omp.reduction.then:
// CHECK3-NEXT:    [[TMP10:%.*]] = load b8, ptr [[TMP0]], align 1
// CHECK3-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP10]] to i8
// CHECK3-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK3-NEXT:    [[TMP11:%.*]] = load b8, ptr [[C1]], align 1
// CHECK3-NEXT:    [[CONV7:%.*]] = bytecast exact b8 [[TMP11]] to i8
// CHECK3-NEXT:    [[CONV8:%.*]] = sext i8 [[CONV7]] to i32
// CHECK3-NEXT:    [[XOR9:%.*]] = xor i32 [[CONV6]], [[CONV8]]
// CHECK3-NEXT:    [[CONV10:%.*]] = trunc i32 [[XOR9]] to i8
// CHECK3-NEXT:    [[TMP12:%.*]] = bitcast i8 [[CONV10]] to b8
// CHECK3-NEXT:    store b8 [[TMP12]], ptr [[TMP0]], align 1
// CHECK3-NEXT:    [[TMP13:%.*]] = load float, ptr [[TMP1]], align 4
// CHECK3-NEXT:    [[TMP14:%.*]] = load float, ptr [[D2]], align 4
// CHECK3-NEXT:    [[MUL11:%.*]] = fmul float [[TMP13]], [[TMP14]]
