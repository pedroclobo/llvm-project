...
// CHECK1-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i64, align 8
// CHECK1-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[I14:%.*]] = alloca b8, align 1
// CHECK1-NEXT:    [[X15:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[TMP0:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB1]])
// CHECK1-NEXT:    store ptr [[A]], ptr [[A_ADDR]], align 8
// CHECK1-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 8
// CHECK1-NEXT:    store ptr [[C]], ptr [[C_ADDR]], align 8
...
// CHECK1-NEXT:    [[TMP2:%.*]] = bitcast i8 [[CONV]] to b8
...
// CHECK1-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP3]] to i8
...
// CHECK1-NEXT:    store b8 [[TMP4]], ptr [[I]], align 1
// CHECK1-NEXT:    store i32 11, ptr [[X9]], align 4
// CHECK1-NEXT:    [[TMP5:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-NEXT:    [[CONV10:%.*]] = bytecast exact b8 [[TMP5]] to i8
// CHECK1-NEXT:    [[CONV11:%.*]] = sext i8 [[CONV10]] to i32
// CHECK1-NEXT:    [[CONV12:%.*]] = bytecast exact b8 57 to i8
// CHECK1-NEXT:    [[CONV13:%.*]] = sext i8 [[CONV12]] to i32
// CHECK1-NEXT:    [[CMP:%.*]] = icmp sle i32 [[CONV11]], [[CONV13]]
// CHECK1-NEXT:    br i1 [[CMP]], label [[OMP_PRECOND_THEN:%.*]], label [[OMP_PRECOND_END:%.*]]
// CHECK1:       omp.precond.then:
// CHECK1-NEXT:    store i64 0, ptr [[DOTOMP_LB]], align 8
// CHECK1-NEXT:    [[TMP6:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_2]], align 8
// CHECK1-NEXT:    store i64 [[TMP6]], ptr [[DOTOMP_UB]], align 8
// CHECK1-NEXT:    store i64 1, ptr [[DOTOMP_STRIDE]], align 8
// CHECK1-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK1-NEXT:    [[TMP7:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_2]], align 8
// CHECK1-NEXT:    call void @__kmpc_dispatch_init_8(ptr @[[GLOB1]], i32 [[TMP0]], i32 1073741894, i64 0, i64 [[TMP7]], i64 1, i64 1)
// CHECK1-NEXT:    br label [[OMP_DISPATCH_COND:%.*]]
// CHECK1:       omp.dispatch.cond:
// CHECK1-NEXT:    [[TMP8:%.*]] = call i32 @__kmpc_dispatch_next_8(ptr @[[GLOB1]], i32 [[TMP0]], ptr [[DOTOMP_IS_LAST]], ptr [[DOTOMP_LB]], ptr [[DOTOMP_UB]], ptr [[DOTOMP_STRIDE]])
// CHECK1-NEXT:    [[TOBOOL:%.*]] = icmp ne i32 [[TMP8]], 0
// CHECK1-NEXT:    br i1 [[TOBOOL]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]]
// CHECK1:       omp.dispatch.body:
// CHECK1-NEXT:    [[TMP9:%.*]] = load i64, ptr [[DOTOMP_LB]], align 8
// CHECK1-NEXT:    store i64 [[TMP9]], ptr [[DOTOMP_IV]], align 8
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK1:       omp.inner.for.cond:
// CHECK1-NEXT:    [[TMP10:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK1-NEXT:    [[TMP11:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8
// CHECK1-NEXT:    [[CMP16:%.*]] = icmp sle i64 [[TMP10]], [[TMP11]]
// CHECK1-NEXT:    br i1 [[CMP16]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK1:       omp.inner.for.body:
// CHECK1-NEXT:    [[TMP12:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-NEXT:    [[CONV17:%.*]] = bytecast exact b8 [[TMP12]] to i8
// CHECK1-NEXT:    [[CONV18:%.*]] = sext i8 [[CONV17]] to i64
// CHECK1-NEXT:    [[TMP13:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK1-NEXT:    [[DIV19:%.*]] = sdiv i64 [[TMP13]], 11
// CHECK1-NEXT:    [[MUL20:%.*]] = mul nsw i64 [[DIV19]], 1
// CHECK1-NEXT:    [[ADD21:%.*]] = add nsw i64 [[CONV18]], [[MUL20]]
// CHECK1-NEXT:    [[CONV22:%.*]] = trunc i64 [[ADD21]] to i8
// CHECK1-NEXT:    [[TMP14:%.*]] = bitcast i8 [[CONV22]] to b8
// CHECK1-NEXT:    store b8 [[TMP14]], ptr [[I14]], align 1
// CHECK1-NEXT:    [[TMP15:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK1-NEXT:    [[TMP16:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK1-NEXT:    [[DIV23:%.*]] = sdiv i64 [[TMP16]], 11
// CHECK1-NEXT:    [[MUL24:%.*]] = mul nsw i64 [[DIV23]], 11
// CHECK1-NEXT:    [[SUB25:%.*]] = sub nsw i64 [[TMP15]], [[MUL24]]
// CHECK1-NEXT:    [[MUL26:%.*]] = mul nsw i64 [[SUB25]], 1
// CHECK1-NEXT:    [[SUB27:%.*]] = sub nsw i64 11, [[MUL26]]
// CHECK1-NEXT:    [[CONV28:%.*]] = trunc i64 [[SUB27]] to i32
// CHECK1-NEXT:    store i32 [[CONV28]], ptr [[X15]], align 4
// CHECK1-NEXT:    call void @__kmpc_ordered(ptr @[[GLOB1]], i32 [[TMP0]])
// CHECK1-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[B_ADDR]], align 8
// CHECK1-NEXT:    [[TMP18:%.*]] = load b8, ptr [[I14]], align 1
// CHECK1-NEXT:    [[IDXPROM:%.*]] = bytecast exact b8 [[TMP18]] to i8
// CHECK1-NEXT:    [[IDXPROM29:%.*]] = sext i8 [[IDXPROM]] to i64
// CHECK1-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds float, ptr [[TMP17]], i64 [[IDXPROM29]]
// CHECK1-NEXT:    [[TMP19:%.*]] = load float, ptr [[ARRAYIDX]], align 4
// CHECK1-NEXT:    [[TMP20:%.*]] = load ptr, ptr [[C_ADDR]], align 8
// CHECK1-NEXT:    [[TMP21:%.*]] = load b8, ptr [[I14]], align 1
// CHECK1-NEXT:    [[IDXPROM30:%.*]] = bytecast exact b8 [[TMP21]] to i8
// CHECK1-NEXT:    [[IDXPROM31:%.*]] = sext i8 [[IDXPROM30]] to i64
// CHECK1-NEXT:    [[ARRAYIDX32:%.*]] = getelementptr inbounds float, ptr [[TMP20]], i64 [[IDXPROM31]]
// CHECK1-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX32]], align 4
// CHECK1-NEXT:    [[MUL33:%.*]] = fmul float [[TMP19]], [[TMP22]]
// CHECK1-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[D_ADDR]], align 8
// CHECK1-NEXT:    [[TMP24:%.*]] = load b8, ptr [[I14]], align 1
// CHECK1-NEXT:    [[IDXPROM34:%.*]] = bytecast exact b8 [[TMP24]] to i8
// CHECK1-NEXT:    [[IDXPROM35:%.*]] = sext i8 [[IDXPROM34]] to i64
// CHECK1-NEXT:    [[ARRAYIDX36:%.*]] = getelementptr inbounds float, ptr [[TMP23]], i64 [[IDXPROM35]]
// CHECK1-NEXT:    [[TMP25:%.*]] = load float, ptr [[ARRAYIDX36]], align 4
// CHECK1-NEXT:    [[MUL37:%.*]] = fmul float [[MUL33]], [[TMP25]]
// CHECK1-NEXT:    [[TMP26:%.*]] = load ptr, ptr [[A_ADDR]], align 8
// CHECK1-NEXT:    [[TMP27:%.*]] = load b8, ptr [[I14]], align 1
// CHECK1-NEXT:    [[IDXPROM38:%.*]] = bytecast exact b8 [[TMP27]] to i8
// CHECK1-NEXT:    [[IDXPROM39:%.*]] = sext i8 [[IDXPROM38]] to i64
// CHECK1-NEXT:    [[ARRAYIDX40:%.*]] = getelementptr inbounds float, ptr [[TMP26]], i64 [[IDXPROM39]]
// CHECK1-NEXT:    store float [[MUL37]], ptr [[ARRAYIDX40]], align 4
// CHECK1-NEXT:    call void @__kmpc_end_ordered(ptr @[[GLOB1]], i32 [[TMP0]])
// CHECK1-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1:       omp.body.continue:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
...
// CHECK1-NEXT:    [[ADD41:%.*]] = add nsw i64 [[TMP28]], 1
// CHECK1-NEXT:    store i64 [[ADD41]], ptr [[DOTOMP_IV]], align 8
...
// CHECK1-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[I:%.*]] = alloca b8, align 1
// CHECK1-NEXT:    [[X7:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[TMP0:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB1]])
// CHECK1-NEXT:    store ptr [[A]], ptr [[A_ADDR]], align 8
// CHECK1-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 8
// CHECK1-NEXT:    store ptr [[C]], ptr [[C_ADDR]], align 8
...
// CHECK1-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4
// CHECK1-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK1-NEXT:    [[CONV8:%.*]] = bytecast exact b8 57 to i8
// CHECK1-NEXT:    [[CONV9:%.*]] = sext i8 [[CONV8]] to i32
// CHECK1-NEXT:    [[CONV10:%.*]] = bytecast exact b8 48 to i8
// CHECK1-NEXT:    [[CONV11:%.*]] = sext i8 [[CONV10]] to i32
// CHECK1-NEXT:    [[SUB12:%.*]] = sub nsw i32 [[CONV11]], 1
// CHECK1-NEXT:    [[SUB13:%.*]] = sub nsw i32 [[CONV9]], [[SUB12]]
// CHECK1-NEXT:    [[DIV14:%.*]] = sdiv i32 [[SUB13]], 1
// CHECK1-NEXT:    [[MUL15:%.*]] = mul nsw i32 [[DIV14]], 20
// CHECK1-NEXT:    [[SUB16:%.*]] = sub nsw i32 [[MUL15]], 1
// CHECK1-NEXT:    call void @__kmpc_dispatch_init_4(ptr @[[GLOB1]], i32 [[TMP0]], i32 1073741893, i32 0, i32 [[SUB16]], i32 1, i32 1)
// CHECK1-NEXT:    br label [[OMP_DISPATCH_COND:%.*]]
// CHECK1:       omp.dispatch.cond:
// CHECK1-NEXT:    [[TMP1:%.*]] = call i32 @__kmpc_dispatch_next_4(ptr @[[GLOB1]], i32 [[TMP0]], ptr [[DOTOMP_IS_LAST]], ptr [[DOTOMP_LB]], ptr [[DOTOMP_UB]], ptr [[DOTOMP_STRIDE]])
// CHECK1-NEXT:    [[TOBOOL:%.*]] = icmp ne i32 [[TMP1]], 0
...
// CHECK1-NEXT:    br i1 [[CMP]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK1:       omp.inner.for.body:
// CHECK1-NEXT:    [[CONV17:%.*]] = bytecast exact b8 48 to i8
// CHECK1-NEXT:    [[CONV18:%.*]] = sext i8 [[CONV17]] to i32
// CHECK1-NEXT:    [[TMP5:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK1-NEXT:    [[DIV19:%.*]] = sdiv i32 [[TMP5]], 20
// CHECK1-NEXT:    [[MUL20:%.*]] = mul nsw i32 [[DIV19]], 1
// CHECK1-NEXT:    [[ADD:%.*]] = add nsw i32 [[CONV18]], [[MUL20]]
// CHECK1-NEXT:    [[CONV21:%.*]] = trunc i32 [[ADD]] to i8
// CHECK1-NEXT:    [[TMP6:%.*]] = bitcast i8 [[CONV21]] to b8
// CHECK1-NEXT:    store b8 [[TMP6]], ptr [[I]], align 1
// CHECK1-NEXT:    [[TMP7:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK1-NEXT:    [[TMP8:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK1-NEXT:    [[DIV22:%.*]] = sdiv i32 [[TMP8]], 20
// CHECK1-NEXT:    [[MUL23:%.*]] = mul nsw i32 [[DIV22]], 20
// CHECK1-NEXT:    [[SUB24:%.*]] = sub nsw i32 [[TMP7]], [[MUL23]]
// CHECK1-NEXT:    [[MUL25:%.*]] = mul nsw i32 [[SUB24]], 1
// CHECK1-NEXT:    [[ADD26:%.*]] = add nsw i32 -10, [[MUL25]]
// CHECK1-NEXT:    store i32 [[ADD26]], ptr [[X7]], align 4
// CHECK1-NEXT:    call void @__kmpc_ordered(ptr @[[GLOB1]], i32 [[TMP0]])
// CHECK1-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[B_ADDR]], align 8
// CHECK1-NEXT:    [[TMP10:%.*]] = load b8, ptr [[I]], align 1
// CHECK1-NEXT:    [[IDXPROM:%.*]] = bytecast exact b8 [[TMP10]] to i8
// CHECK1-NEXT:    [[IDXPROM27:%.*]] = zext i8 [[IDXPROM]] to i64
// CHECK1-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw float, ptr [[TMP9]], i64 [[IDXPROM27]]
// CHECK1-NEXT:    [[TMP11:%.*]] = load float, ptr [[ARRAYIDX]], align 4
// CHECK1-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[C_ADDR]], align 8
// CHECK1-NEXT:    [[TMP13:%.*]] = load b8, ptr [[I]], align 1
// CHECK1-NEXT:    [[IDXPROM28:%.*]] = bytecast exact b8 [[TMP13]] to i8
// CHECK1-NEXT:    [[IDXPROM29:%.*]] = zext i8 [[IDXPROM28]] to i64
// CHECK1-NEXT:    [[ARRAYIDX30:%.*]] = getelementptr inbounds nuw float, ptr [[TMP12]], i64 [[IDXPROM29]]
// CHECK1-NEXT:    [[TMP14:%.*]] = load float, ptr [[ARRAYIDX30]], align 4
// CHECK1-NEXT:    [[MUL31:%.*]] = fmul float [[TMP11]], [[TMP14]]
// CHECK1-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[D_ADDR]], align 8
// CHECK1-NEXT:    [[TMP16:%.*]] = load b8, ptr [[I]], align 1
// CHECK1-NEXT:    [[IDXPROM32:%.*]] = bytecast exact b8 [[TMP16]] to i8
// CHECK1-NEXT:    [[IDXPROM33:%.*]] = zext i8 [[IDXPROM32]] to i64
// CHECK1-NEXT:    [[ARRAYIDX34:%.*]] = getelementptr inbounds nuw float, ptr [[TMP15]], i64 [[IDXPROM33]]
// CHECK1-NEXT:    [[TMP17:%.*]] = load float, ptr [[ARRAYIDX34]], align 4
// CHECK1-NEXT:    [[MUL35:%.*]] = fmul float [[MUL31]], [[TMP17]]
// CHECK1-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[A_ADDR]], align 8
// CHECK1-NEXT:    [[TMP19:%.*]] = load b8, ptr [[I]], align 1
// CHECK1-NEXT:    [[IDXPROM36:%.*]] = bytecast exact b8 [[TMP19]] to i8
// CHECK1-NEXT:    [[IDXPROM37:%.*]] = zext i8 [[IDXPROM36]] to i64
// CHECK1-NEXT:    [[ARRAYIDX38:%.*]] = getelementptr inbounds nuw float, ptr [[TMP18]], i64 [[IDXPROM37]]
// CHECK1-NEXT:    store float [[MUL35]], ptr [[ARRAYIDX38]], align 4
// CHECK1-NEXT:    call void @__kmpc_end_ordered(ptr @[[GLOB1]], i32 [[TMP0]])
// CHECK1-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1:       omp.body.continue:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
...
// CHECK1-NEXT:    [[ADD39:%.*]] = add nsw i32 [[TMP20]], 1
// CHECK1-NEXT:    store i32 [[ADD39]], ptr [[DOTOMP_IV]], align 4
// CHECK1-NEXT:    call void @__kmpc_dispatch_fini_4(ptr @[[GLOB1]], i32 [[TMP0]])
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK1:       omp.inner.for.end:
// CHECK1-NEXT:    br label [[OMP_DISPATCH_INC:%.*]]
...
// CHECK1-IRBUILDER-NEXT:    [[DOTOMP_IV:%.*]] = alloca i64, align 8
// CHECK1-IRBUILDER-NEXT:    [[TMP:%.*]] = alloca b8, align 1
// CHECK1-IRBUILDER-NEXT:    [[_TMP1:%.*]] = alloca i32, align 4
// CHECK1-IRBUILDER-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK1-IRBUILDER-NEXT:    [[DOTCAPTURE_EXPR_2:%.*]] = alloca i64, align 8
// CHECK1-IRBUILDER-NEXT:    [[I:%.*]] = alloca b8, align 1
// CHECK1-IRBUILDER-NEXT:    [[X9:%.*]] = alloca i32, align 4
// CHECK1-IRBUILDER-NEXT:    [[DOTOMP_LB:%.*]] = alloca i64, align 8
// CHECK1-IRBUILDER-NEXT:    [[DOTOMP_UB:%.*]] = alloca i64, align 8
// CHECK1-IRBUILDER-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i64, align 8
// CHECK1-IRBUILDER-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK1-IRBUILDER-NEXT:    [[I14:%.*]] = alloca b8, align 1
// CHECK1-IRBUILDER-NEXT:    [[X15:%.*]] = alloca i32, align 4
// CHECK1-IRBUILDER-NEXT:    store ptr [[A]], ptr [[A_ADDR]], align 8
// CHECK1-IRBUILDER-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 8
// CHECK1-IRBUILDER-NEXT:    store ptr [[C]], ptr [[C_ADDR]], align 8
// CHECK1-IRBUILDER-NEXT:    store ptr [[D]], ptr [[D_ADDR]], align 8
...
// CHECK1-IRBUILDER-NEXT:    [[TMP1:%.*]] = bitcast i8 [[CONV]] to b8
// CHECK1-IRBUILDER-NEXT:    store b8 [[TMP1]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-IRBUILDER-NEXT:    [[CONV3:%.*]] = bytecast exact b8 57 to i8
// CHECK1-IRBUILDER-NEXT:    [[CONV4:%.*]] = sext i8 [[CONV3]] to i32
// CHECK1-IRBUILDER-NEXT:    [[TMP2:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-IRBUILDER-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP2]] to i8
// CHECK1-IRBUILDER-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK1-IRBUILDER-NEXT:    [[SUB:%.*]] = sub i32 [[CONV4]], [[CONV6]]
// CHECK1-IRBUILDER-NEXT:    [[ADD:%.*]] = add i32 [[SUB]], 1
// CHECK1-IRBUILDER-NEXT:    [[DIV:%.*]] = udiv i32 [[ADD]], 1
// CHECK1-IRBUILDER-NEXT:    [[CONV7:%.*]] = zext i32 [[DIV]] to i64
// CHECK1-IRBUILDER-NEXT:    [[MUL:%.*]] = mul nsw i64 [[CONV7]], 11
// CHECK1-IRBUILDER-NEXT:    [[SUB8:%.*]] = sub nsw i64 [[MUL]], 1
// CHECK1-IRBUILDER-NEXT:    store i64 [[SUB8]], ptr [[DOTCAPTURE_EXPR_2]], align 8
// CHECK1-IRBUILDER-NEXT:    [[TMP3:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-IRBUILDER-NEXT:    store b8 [[TMP3]], ptr [[I]], align 1
// CHECK1-IRBUILDER-NEXT:    store i32 11, ptr [[X9]], align 4
// CHECK1-IRBUILDER-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-IRBUILDER-NEXT:    [[CONV10:%.*]] = bytecast exact b8 [[TMP4]] to i8
// CHECK1-IRBUILDER-NEXT:    [[CONV11:%.*]] = sext i8 [[CONV10]] to i32
// CHECK1-IRBUILDER-NEXT:    [[CONV12:%.*]] = bytecast exact b8 57 to i8
// CHECK1-IRBUILDER-NEXT:    [[CONV13:%.*]] = sext i8 [[CONV12]] to i32
// CHECK1-IRBUILDER-NEXT:    [[CMP:%.*]] = icmp sle i32 [[CONV11]], [[CONV13]]
...
// CHECK1-IRBUILDER-NEXT:    store i64 [[TMP5]], ptr [[DOTOMP_UB]], align 8
// CHECK1-IRBUILDER-NEXT:    store i64 1, ptr [[DOTOMP_STRIDE]], align 8
// CHECK1-IRBUILDER-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK1-IRBUILDER-NEXT:    [[TMP6:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_2]], align 8
// CHECK1-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB8:[0-9]+]])
// CHECK1-IRBUILDER-NEXT:    call void @__kmpc_dispatch_init_8(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM]], i32 1073741894, i64 0, i64 [[TMP6]], i64 1, i64 1)
// CHECK1-IRBUILDER-NEXT:    br label [[OMP_DISPATCH_COND:%.*]]
// CHECK1-IRBUILDER:       omp.dispatch.cond:
// CHECK1-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM16:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB8]])
// CHECK1-IRBUILDER-NEXT:    [[TMP7:%.*]] = call i32 @__kmpc_dispatch_next_8(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM16]], ptr [[DOTOMP_IS_LAST]], ptr [[DOTOMP_LB]], ptr [[DOTOMP_UB]], ptr [[DOTOMP_STRIDE]])
// CHECK1-IRBUILDER-NEXT:    [[TOBOOL:%.*]] = icmp ne i32 [[TMP7]], 0
// CHECK1-IRBUILDER-NEXT:    br i1 [[TOBOOL]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]]
// CHECK1-IRBUILDER:       omp.dispatch.body:
// CHECK1-IRBUILDER-NEXT:    [[TMP8:%.*]] = load i64, ptr [[DOTOMP_LB]], align 8
// CHECK1-IRBUILDER-NEXT:    store i64 [[TMP8]], ptr [[DOTOMP_IV]], align 8
// CHECK1-IRBUILDER-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK1-IRBUILDER:       omp.inner.for.cond:
// CHECK1-IRBUILDER-NEXT:    [[TMP9:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK1-IRBUILDER-NEXT:    [[TMP10:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8
// CHECK1-IRBUILDER-NEXT:    [[CMP17:%.*]] = icmp sle i64 [[TMP9]], [[TMP10]]
// CHECK1-IRBUILDER-NEXT:    br i1 [[CMP17]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK1-IRBUILDER:       omp.inner.for.body:
// CHECK1-IRBUILDER-NEXT:    [[TMP11:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-IRBUILDER-NEXT:    [[CONV18:%.*]] = bytecast exact b8 [[TMP11]] to i8
// CHECK1-IRBUILDER-NEXT:    [[CONV19:%.*]] = sext i8 [[CONV18]] to i64
// CHECK1-IRBUILDER-NEXT:    [[TMP12:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK1-IRBUILDER-NEXT:    [[DIV20:%.*]] = sdiv i64 [[TMP12]], 11
// CHECK1-IRBUILDER-NEXT:    [[MUL21:%.*]] = mul nsw i64 [[DIV20]], 1
// CHECK1-IRBUILDER-NEXT:    [[ADD22:%.*]] = add nsw i64 [[CONV19]], [[MUL21]]
// CHECK1-IRBUILDER-NEXT:    [[CONV23:%.*]] = trunc i64 [[ADD22]] to i8
// CHECK1-IRBUILDER-NEXT:    [[TMP13:%.*]] = bitcast i8 [[CONV23]] to b8
// CHECK1-IRBUILDER-NEXT:    store b8 [[TMP13]], ptr [[I14]], align 1
// CHECK1-IRBUILDER-NEXT:    [[TMP14:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK1-IRBUILDER-NEXT:    [[TMP15:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK1-IRBUILDER-NEXT:    [[DIV24:%.*]] = sdiv i64 [[TMP15]], 11
// CHECK1-IRBUILDER-NEXT:    [[MUL25:%.*]] = mul nsw i64 [[DIV24]], 11
// CHECK1-IRBUILDER-NEXT:    [[SUB26:%.*]] = sub nsw i64 [[TMP14]], [[MUL25]]
// CHECK1-IRBUILDER-NEXT:    [[MUL27:%.*]] = mul nsw i64 [[SUB26]], 1
// CHECK1-IRBUILDER-NEXT:    [[SUB28:%.*]] = sub nsw i64 11, [[MUL27]]
// CHECK1-IRBUILDER-NEXT:    [[CONV29:%.*]] = trunc i64 [[SUB28]] to i32
// CHECK1-IRBUILDER-NEXT:    store i32 [[CONV29]], ptr [[X15]], align 4
// CHECK1-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM30:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB1]])
// CHECK1-IRBUILDER-NEXT:    call void @__kmpc_ordered(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM30]])
// CHECK1-IRBUILDER-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[B_ADDR]], align 8
// CHECK1-IRBUILDER-NEXT:    [[TMP17:%.*]] = load b8, ptr [[I14]], align 1
// CHECK1-IRBUILDER-NEXT:    [[IDXPROM:%.*]] = bytecast exact b8 [[TMP17]] to i8
// CHECK1-IRBUILDER-NEXT:    [[IDXPROM31:%.*]] = sext i8 [[IDXPROM]] to i64
// CHECK1-IRBUILDER-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds float, ptr [[TMP16]], i64 [[IDXPROM31]]
// CHECK1-IRBUILDER-NEXT:    [[TMP18:%.*]] = load float, ptr [[ARRAYIDX]], align 4
// CHECK1-IRBUILDER-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[C_ADDR]], align 8
// CHECK1-IRBUILDER-NEXT:    [[TMP20:%.*]] = load b8, ptr [[I14]], align 1
// CHECK1-IRBUILDER-NEXT:    [[IDXPROM32:%.*]] = bytecast exact b8 [[TMP20]] to i8
// CHECK1-IRBUILDER-NEXT:    [[IDXPROM33:%.*]] = sext i8 [[IDXPROM32]] to i64
// CHECK1-IRBUILDER-NEXT:    [[ARRAYIDX34:%.*]] = getelementptr inbounds float, ptr [[TMP19]], i64 [[IDXPROM33]]
// CHECK1-IRBUILDER-NEXT:    [[TMP21:%.*]] = load float, ptr [[ARRAYIDX34]], align 4
// CHECK1-IRBUILDER-NEXT:    [[MUL35:%.*]] = fmul float [[TMP18]], [[TMP21]]
// CHECK1-IRBUILDER-NEXT:    [[TMP22:%.*]] = load ptr, ptr [[D_ADDR]], align 8
// CHECK1-IRBUILDER-NEXT:    [[TMP23:%.*]] = load b8, ptr [[I14]], align 1
// CHECK1-IRBUILDER-NEXT:    [[IDXPROM36:%.*]] = bytecast exact b8 [[TMP23]] to i8
// CHECK1-IRBUILDER-NEXT:    [[IDXPROM37:%.*]] = sext i8 [[IDXPROM36]] to i64
// CHECK1-IRBUILDER-NEXT:    [[ARRAYIDX38:%.*]] = getelementptr inbounds float, ptr [[TMP22]], i64 [[IDXPROM37]]
// CHECK1-IRBUILDER-NEXT:    [[TMP24:%.*]] = load float, ptr [[ARRAYIDX38]], align 4
// CHECK1-IRBUILDER-NEXT:    [[MUL39:%.*]] = fmul float [[MUL35]], [[TMP24]]
// CHECK1-IRBUILDER-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[A_ADDR]], align 8
// CHECK1-IRBUILDER-NEXT:    [[TMP26:%.*]] = load b8, ptr [[I14]], align 1
// CHECK1-IRBUILDER-NEXT:    [[IDXPROM40:%.*]] = bytecast exact b8 [[TMP26]] to i8
// CHECK1-IRBUILDER-NEXT:    [[IDXPROM41:%.*]] = sext i8 [[IDXPROM40]] to i64
// CHECK1-IRBUILDER-NEXT:    [[ARRAYIDX42:%.*]] = getelementptr inbounds float, ptr [[TMP25]], i64 [[IDXPROM41]]
// CHECK1-IRBUILDER-NEXT:    store float [[MUL39]], ptr [[ARRAYIDX42]], align 4
// CHECK1-IRBUILDER-NEXT:    br label [[OMP_INNER_FOR_BODY_ORDERED_AFTER:%.*]]
// CHECK1-IRBUILDER:       omp.inner.for.body.ordered.after:
// CHECK1-IRBUILDER-NEXT:    call void @__kmpc_end_ordered(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM30]])
// CHECK1-IRBUILDER-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1-IRBUILDER:       omp.body.continue:
// CHECK1-IRBUILDER-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1-IRBUILDER:       omp.inner.for.inc:
// CHECK1-IRBUILDER-NEXT:    [[TMP27:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK1-IRBUILDER-NEXT:    [[ADD43:%.*]] = add nsw i64 [[TMP27]], 1
// CHECK1-IRBUILDER-NEXT:    store i64 [[ADD43]], ptr [[DOTOMP_IV]], align 8
// CHECK1-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM44:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB8]])
// CHECK1-IRBUILDER-NEXT:    call void @__kmpc_dispatch_fini_8(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM44]])
// CHECK1-IRBUILDER-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK1-IRBUILDER:       omp.inner.for.end:
// CHECK1-IRBUILDER-NEXT:    br label [[OMP_DISPATCH_INC:%.*]]
// CHECK1-IRBUILDER:       omp.dispatch.inc:
...
// CHECK1-IRBUILDER-NEXT:    call void @__kmpc_dispatch_deinit(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM45]])
...
// CHECK1-IRBUILDER-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK1-IRBUILDER-NEXT:    [[I:%.*]] = alloca b8, align 1
// CHECK1-IRBUILDER-NEXT:    [[X7:%.*]] = alloca i32, align 4
// CHECK1-IRBUILDER-NEXT:    store ptr [[A]], ptr [[A_ADDR]], align 8
// CHECK1-IRBUILDER-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 8
// CHECK1-IRBUILDER-NEXT:    store ptr [[C]], ptr [[C_ADDR]], align 8
// CHECK1-IRBUILDER-NEXT:    store ptr [[D]], ptr [[D_ADDR]], align 8
// CHECK1-IRBUILDER-NEXT:    store i32 0, ptr [[X]], align 4
// CHECK1-IRBUILDER-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK1-IRBUILDER-NEXT:    [[CONV:%.*]] = bytecast exact b8 57 to i8
// CHECK1-IRBUILDER-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
// CHECK1-IRBUILDER-NEXT:    [[CONV3:%.*]] = bytecast exact b8 48 to i8
// CHECK1-IRBUILDER-NEXT:    [[CONV4:%.*]] = sext i8 [[CONV3]] to i32
// CHECK1-IRBUILDER-NEXT:    [[SUB:%.*]] = sub nsw i32 [[CONV4]], 1
// CHECK1-IRBUILDER-NEXT:    [[SUB5:%.*]] = sub nsw i32 [[CONV2]], [[SUB]]
// CHECK1-IRBUILDER-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB5]], 1
// CHECK1-IRBUILDER-NEXT:    [[MUL:%.*]] = mul nsw i32 [[DIV]], 20
// CHECK1-IRBUILDER-NEXT:    [[SUB6:%.*]] = sub nsw i32 [[MUL]], 1
// CHECK1-IRBUILDER-NEXT:    store i32 [[SUB6]], ptr [[DOTOMP_UB]], align 4
// CHECK1-IRBUILDER-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4
// CHECK1-IRBUILDER-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK1-IRBUILDER-NEXT:    [[CONV8:%.*]] = bytecast exact b8 57 to i8
// CHECK1-IRBUILDER-NEXT:    [[CONV9:%.*]] = sext i8 [[CONV8]] to i32
// CHECK1-IRBUILDER-NEXT:    [[CONV10:%.*]] = bytecast exact b8 48 to i8
// CHECK1-IRBUILDER-NEXT:    [[CONV11:%.*]] = sext i8 [[CONV10]] to i32
// CHECK1-IRBUILDER-NEXT:    [[SUB12:%.*]] = sub nsw i32 [[CONV11]], 1
// CHECK1-IRBUILDER-NEXT:    [[SUB13:%.*]] = sub nsw i32 [[CONV9]], [[SUB12]]
// CHECK1-IRBUILDER-NEXT:    [[DIV14:%.*]] = sdiv i32 [[SUB13]], 1
// CHECK1-IRBUILDER-NEXT:    [[MUL15:%.*]] = mul nsw i32 [[DIV14]], 20
// CHECK1-IRBUILDER-NEXT:    [[SUB16:%.*]] = sub nsw i32 [[MUL15]], 1
// CHECK1-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB10:[0-9]+]])
// CHECK1-IRBUILDER-NEXT:    call void @__kmpc_dispatch_init_4(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM]], i32 1073741893, i32 0, i32 [[SUB16]], i32 1, i32 1)
// CHECK1-IRBUILDER-NEXT:    br label [[OMP_DISPATCH_COND:%.*]]
// CHECK1-IRBUILDER:       omp.dispatch.cond:
// CHECK1-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM17:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB10]])
// CHECK1-IRBUILDER-NEXT:    [[TMP0:%.*]] = call i32 @__kmpc_dispatch_next_4(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM17]], ptr [[DOTOMP_IS_LAST]], ptr [[DOTOMP_LB]], ptr [[DOTOMP_UB]], ptr [[DOTOMP_STRIDE]])
// CHECK1-IRBUILDER-NEXT:    [[TOBOOL:%.*]] = icmp ne i32 [[TMP0]], 0
// CHECK1-IRBUILDER-NEXT:    br i1 [[TOBOOL]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]]
// CHECK1-IRBUILDER:       omp.dispatch.body:
// CHECK1-IRBUILDER-NEXT:    [[TMP1:%.*]] = load i32, ptr [[DOTOMP_LB]], align 4
...
// CHECK1-IRBUILDER-NEXT:    br i1 [[CMP]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK1-IRBUILDER:       omp.inner.for.body:
// CHECK1-IRBUILDER-NEXT:    [[CONV18:%.*]] = bytecast exact b8 48 to i8
// CHECK1-IRBUILDER-NEXT:    [[CONV19:%.*]] = sext i8 [[CONV18]] to i32
// CHECK1-IRBUILDER-NEXT:    [[TMP4:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK1-IRBUILDER-NEXT:    [[DIV20:%.*]] = sdiv i32 [[TMP4]], 20
// CHECK1-IRBUILDER-NEXT:    [[MUL21:%.*]] = mul nsw i32 [[DIV20]], 1
// CHECK1-IRBUILDER-NEXT:    [[ADD:%.*]] = add nsw i32 [[CONV19]], [[MUL21]]
// CHECK1-IRBUILDER-NEXT:    [[CONV22:%.*]] = trunc i32 [[ADD]] to i8
// CHECK1-IRBUILDER-NEXT:    [[TMP5:%.*]] = bitcast i8 [[CONV22]] to b8
// CHECK1-IRBUILDER-NEXT:    store b8 [[TMP5]], ptr [[I]], align 1
// CHECK1-IRBUILDER-NEXT:    [[TMP6:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK1-IRBUILDER-NEXT:    [[TMP7:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK1-IRBUILDER-NEXT:    [[DIV23:%.*]] = sdiv i32 [[TMP7]], 20
// CHECK1-IRBUILDER-NEXT:    [[MUL24:%.*]] = mul nsw i32 [[DIV23]], 20
// CHECK1-IRBUILDER-NEXT:    [[SUB25:%.*]] = sub nsw i32 [[TMP6]], [[MUL24]]
// CHECK1-IRBUILDER-NEXT:    [[MUL26:%.*]] = mul nsw i32 [[SUB25]], 1
// CHECK1-IRBUILDER-NEXT:    [[ADD27:%.*]] = add nsw i32 -10, [[MUL26]]
// CHECK1-IRBUILDER-NEXT:    store i32 [[ADD27]], ptr [[X7]], align 4
// CHECK1-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM28:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB1]])
// CHECK1-IRBUILDER-NEXT:    call void @__kmpc_ordered(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM28]])
// CHECK1-IRBUILDER-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[B_ADDR]], align 8
// CHECK1-IRBUILDER-NEXT:    [[TMP9:%.*]] = load b8, ptr [[I]], align 1
// CHECK1-IRBUILDER-NEXT:    [[IDXPROM:%.*]] = bytecast exact b8 [[TMP9]] to i8
// CHECK1-IRBUILDER-NEXT:    [[IDXPROM29:%.*]] = zext i8 [[IDXPROM]] to i64
// CHECK1-IRBUILDER-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw float, ptr [[TMP8]], i64 [[IDXPROM29]]
// CHECK1-IRBUILDER-NEXT:    [[TMP10:%.*]] = load float, ptr [[ARRAYIDX]], align 4
// CHECK1-IRBUILDER-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[C_ADDR]], align 8
// CHECK1-IRBUILDER-NEXT:    [[TMP12:%.*]] = load b8, ptr [[I]], align 1
// CHECK1-IRBUILDER-NEXT:    [[IDXPROM30:%.*]] = bytecast exact b8 [[TMP12]] to i8
// CHECK1-IRBUILDER-NEXT:    [[IDXPROM31:%.*]] = zext i8 [[IDXPROM30]] to i64
// CHECK1-IRBUILDER-NEXT:    [[ARRAYIDX32:%.*]] = getelementptr inbounds nuw float, ptr [[TMP11]], i64 [[IDXPROM31]]
// CHECK1-IRBUILDER-NEXT:    [[TMP13:%.*]] = load float, ptr [[ARRAYIDX32]], align 4
// CHECK1-IRBUILDER-NEXT:    [[MUL33:%.*]] = fmul float [[TMP10]], [[TMP13]]
// CHECK1-IRBUILDER-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[D_ADDR]], align 8
// CHECK1-IRBUILDER-NEXT:    [[TMP15:%.*]] = load b8, ptr [[I]], align 1
// CHECK1-IRBUILDER-NEXT:    [[IDXPROM34:%.*]] = bytecast exact b8 [[TMP15]] to i8
// CHECK1-IRBUILDER-NEXT:    [[IDXPROM35:%.*]] = zext i8 [[IDXPROM34]] to i64
// CHECK1-IRBUILDER-NEXT:    [[ARRAYIDX36:%.*]] = getelementptr inbounds nuw float, ptr [[TMP14]], i64 [[IDXPROM35]]
// CHECK1-IRBUILDER-NEXT:    [[TMP16:%.*]] = load float, ptr [[ARRAYIDX36]], align 4
// CHECK1-IRBUILDER-NEXT:    [[MUL37:%.*]] = fmul float [[MUL33]], [[TMP16]]
// CHECK1-IRBUILDER-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[A_ADDR]], align 8
// CHECK1-IRBUILDER-NEXT:    [[TMP18:%.*]] = load b8, ptr [[I]], align 1
// CHECK1-IRBUILDER-NEXT:    [[IDXPROM38:%.*]] = bytecast exact b8 [[TMP18]] to i8
// CHECK1-IRBUILDER-NEXT:    [[IDXPROM39:%.*]] = zext i8 [[IDXPROM38]] to i64
// CHECK1-IRBUILDER-NEXT:    [[ARRAYIDX40:%.*]] = getelementptr inbounds nuw float, ptr [[TMP17]], i64 [[IDXPROM39]]
// CHECK1-IRBUILDER-NEXT:    store float [[MUL37]], ptr [[ARRAYIDX40]], align 4
// CHECK1-IRBUILDER-NEXT:    br label [[OMP_INNER_FOR_BODY_ORDERED_AFTER:%.*]]
// CHECK1-IRBUILDER:       omp.inner.for.body.ordered.after:
// CHECK1-IRBUILDER-NEXT:    call void @__kmpc_end_ordered(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM28]])
// CHECK1-IRBUILDER-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1-IRBUILDER:       omp.body.continue:
// CHECK1-IRBUILDER-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1-IRBUILDER:       omp.inner.for.inc:
// CHECK1-IRBUILDER-NEXT:    [[TMP19:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK1-IRBUILDER-NEXT:    [[ADD41:%.*]] = add nsw i32 [[TMP19]], 1
// CHECK1-IRBUILDER-NEXT:    store i32 [[ADD41]], ptr [[DOTOMP_IV]], align 4
// CHECK1-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM42:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB10]])
// CHECK1-IRBUILDER-NEXT:    call void @__kmpc_dispatch_fini_4(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM42]])
// CHECK1-IRBUILDER-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK1-IRBUILDER:       omp.inner.for.end:
// CHECK1-IRBUILDER-NEXT:    br label [[OMP_DISPATCH_INC:%.*]]
// CHECK1-IRBUILDER:       omp.dispatch.inc:
// CHECK1-IRBUILDER-NEXT:    br label [[OMP_DISPATCH_COND]]
// CHECK1-IRBUILDER:       omp.dispatch.end:
// CHECK1-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM43:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB10]])
// CHECK1-IRBUILDER-NEXT:    call void @__kmpc_dispatch_deinit(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM43]])
// CHECK1-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM44:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB1]])
// CHECK1-IRBUILDER-NEXT:    call void @__kmpc_barrier(ptr @[[GLOB4]], i32 [[OMP_GLOBAL_THREAD_NUM44]])
// CHECK1-IRBUILDER-NEXT:    ret void
//
//
...
// CHECK3-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i64, align 8
// CHECK3-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[I14:%.*]] = alloca b8, align 1
// CHECK3-NEXT:    [[X15:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[TMP0:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB1]])
// CHECK3-NEXT:    store ptr [[A]], ptr [[A_ADDR]], align 8
// CHECK3-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 8
// CHECK3-NEXT:    store ptr [[C]], ptr [[C_ADDR]], align 8
...
// CHECK3-NEXT:    [[TMP2:%.*]] = bitcast i8 [[CONV]] to b8
// CHECK3-NEXT:    store b8 [[TMP2]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK3-NEXT:    [[CONV3:%.*]] = bytecast exact b8 57 to i8
// CHECK3-NEXT:    [[CONV4:%.*]] = sext i8 [[CONV3]] to i32
// CHECK3-NEXT:    [[TMP3:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK3-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP3]] to i8
// CHECK3-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK3-NEXT:    [[SUB:%.*]] = sub i32 [[CONV4]], [[CONV6]]
// CHECK3-NEXT:    [[ADD:%.*]] = add i32 [[SUB]], 1
// CHECK3-NEXT:    [[DIV:%.*]] = udiv i32 [[ADD]], 1
// CHECK3-NEXT:    [[CONV7:%.*]] = zext i32 [[DIV]] to i64
// CHECK3-NEXT:    [[MUL:%.*]] = mul nsw i64 [[CONV7]], 11
// CHECK3-NEXT:    [[SUB8:%.*]] = sub nsw i64 [[MUL]], 1
// CHECK3-NEXT:    store i64 [[SUB8]], ptr [[DOTCAPTURE_EXPR_2]], align 8
// CHECK3-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK3-NEXT:    store b8 [[TMP4]], ptr [[I]], align 1
// CHECK3-NEXT:    store i32 11, ptr [[X9]], align 4
// CHECK3-NEXT:    [[TMP5:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK3-NEXT:    [[CONV10:%.*]] = bytecast exact b8 [[TMP5]] to i8
// CHECK3-NEXT:    [[CONV11:%.*]] = sext i8 [[CONV10]] to i32
// CHECK3-NEXT:    [[CONV12:%.*]] = bytecast exact b8 57 to i8
// CHECK3-NEXT:    [[CONV13:%.*]] = sext i8 [[CONV12]] to i32
// CHECK3-NEXT:    [[CMP:%.*]] = icmp sle i32 [[CONV11]], [[CONV13]]
// CHECK3-NEXT:    br i1 [[CMP]], label [[OMP_PRECOND_THEN:%.*]], label [[OMP_PRECOND_END:%.*]]
// CHECK3:       omp.precond.then:
// CHECK3-NEXT:    store i64 0, ptr [[DOTOMP_LB]], align 8
// CHECK3-NEXT:    [[TMP6:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_2]], align 8
// CHECK3-NEXT:    store i64 [[TMP6]], ptr [[DOTOMP_UB]], align 8
// CHECK3-NEXT:    store i64 1, ptr [[DOTOMP_STRIDE]], align 8
// CHECK3-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK3-NEXT:    [[TMP7:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_2]], align 8
// CHECK3-NEXT:    call void @__kmpc_dispatch_init_8(ptr @[[GLOB1]], i32 [[TMP0]], i32 70, i64 0, i64 [[TMP7]], i64 1, i64 1)
// CHECK3-NEXT:    br label [[OMP_DISPATCH_COND:%.*]]
// CHECK3:       omp.dispatch.cond:
// CHECK3-NEXT:    [[TMP8:%.*]] = call i32 @__kmpc_dispatch_next_8(ptr @[[GLOB1]], i32 [[TMP0]], ptr [[DOTOMP_IS_LAST]], ptr [[DOTOMP_LB]], ptr [[DOTOMP_UB]], ptr [[DOTOMP_STRIDE]])
// CHECK3-NEXT:    [[TOBOOL:%.*]] = icmp ne i32 [[TMP8]], 0
// CHECK3-NEXT:    br i1 [[TOBOOL]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]]
// CHECK3:       omp.dispatch.body:
// CHECK3-NEXT:    [[TMP9:%.*]] = load i64, ptr [[DOTOMP_LB]], align 8
// CHECK3-NEXT:    store i64 [[TMP9]], ptr [[DOTOMP_IV]], align 8
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK3:       omp.inner.for.cond:
// CHECK3-NEXT:    [[TMP10:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK3-NEXT:    [[TMP11:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8
// CHECK3-NEXT:    [[CMP16:%.*]] = icmp sle i64 [[TMP10]], [[TMP11]]
// CHECK3-NEXT:    br i1 [[CMP16]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK3:       omp.inner.for.body:
// CHECK3-NEXT:    [[TMP12:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK3-NEXT:    [[CONV17:%.*]] = bytecast exact b8 [[TMP12]] to i8
// CHECK3-NEXT:    [[CONV18:%.*]] = sext i8 [[CONV17]] to i64
// CHECK3-NEXT:    [[TMP13:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK3-NEXT:    [[DIV19:%.*]] = sdiv i64 [[TMP13]], 11
// CHECK3-NEXT:    [[MUL20:%.*]] = mul nsw i64 [[DIV19]], 1
// CHECK3-NEXT:    [[ADD21:%.*]] = add nsw i64 [[CONV18]], [[MUL20]]
// CHECK3-NEXT:    [[CONV22:%.*]] = trunc i64 [[ADD21]] to i8
// CHECK3-NEXT:    [[TMP14:%.*]] = bitcast i8 [[CONV22]] to b8
// CHECK3-NEXT:    store b8 [[TMP14]], ptr [[I14]], align 1
// CHECK3-NEXT:    [[TMP15:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK3-NEXT:    [[TMP16:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK3-NEXT:    [[DIV23:%.*]] = sdiv i64 [[TMP16]], 11
// CHECK3-NEXT:    [[MUL24:%.*]] = mul nsw i64 [[DIV23]], 11
// CHECK3-NEXT:    [[SUB25:%.*]] = sub nsw i64 [[TMP15]], [[MUL24]]
// CHECK3-NEXT:    [[MUL26:%.*]] = mul nsw i64 [[SUB25]], 1
// CHECK3-NEXT:    [[SUB27:%.*]] = sub nsw i64 11, [[MUL26]]
// CHECK3-NEXT:    [[CONV28:%.*]] = trunc i64 [[SUB27]] to i32
// CHECK3-NEXT:    store i32 [[CONV28]], ptr [[X15]], align 4
// CHECK3-NEXT:    call void @__kmpc_ordered(ptr @[[GLOB1]], i32 [[TMP0]])
// CHECK3-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[B_ADDR]], align 8
// CHECK3-NEXT:    [[TMP18:%.*]] = load b8, ptr [[I14]], align 1
// CHECK3-NEXT:    [[IDXPROM:%.*]] = bytecast exact b8 [[TMP18]] to i8
// CHECK3-NEXT:    [[IDXPROM29:%.*]] = sext i8 [[IDXPROM]] to i64
// CHECK3-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds float, ptr [[TMP17]], i64 [[IDXPROM29]]
// CHECK3-NEXT:    [[TMP19:%.*]] = load float, ptr [[ARRAYIDX]], align 4
// CHECK3-NEXT:    [[TMP20:%.*]] = load ptr, ptr [[C_ADDR]], align 8
// CHECK3-NEXT:    [[TMP21:%.*]] = load b8, ptr [[I14]], align 1
// CHECK3-NEXT:    [[IDXPROM30:%.*]] = bytecast exact b8 [[TMP21]] to i8
// CHECK3-NEXT:    [[IDXPROM31:%.*]] = sext i8 [[IDXPROM30]] to i64
// CHECK3-NEXT:    [[ARRAYIDX32:%.*]] = getelementptr inbounds float, ptr [[TMP20]], i64 [[IDXPROM31]]
// CHECK3-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX32]], align 4
// CHECK3-NEXT:    [[MUL33:%.*]] = fmul float [[TMP19]], [[TMP22]]
// CHECK3-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[D_ADDR]], align 8
// CHECK3-NEXT:    [[TMP24:%.*]] = load b8, ptr [[I14]], align 1
// CHECK3-NEXT:    [[IDXPROM34:%.*]] = bytecast exact b8 [[TMP24]] to i8
// CHECK3-NEXT:    [[IDXPROM35:%.*]] = sext i8 [[IDXPROM34]] to i64
// CHECK3-NEXT:    [[ARRAYIDX36:%.*]] = getelementptr inbounds float, ptr [[TMP23]], i64 [[IDXPROM35]]
// CHECK3-NEXT:    [[TMP25:%.*]] = load float, ptr [[ARRAYIDX36]], align 4
// CHECK3-NEXT:    [[MUL37:%.*]] = fmul float [[MUL33]], [[TMP25]]
// CHECK3-NEXT:    [[TMP26:%.*]] = load ptr, ptr [[A_ADDR]], align 8
// CHECK3-NEXT:    [[TMP27:%.*]] = load b8, ptr [[I14]], align 1
// CHECK3-NEXT:    [[IDXPROM38:%.*]] = bytecast exact b8 [[TMP27]] to i8
// CHECK3-NEXT:    [[IDXPROM39:%.*]] = sext i8 [[IDXPROM38]] to i64
// CHECK3-NEXT:    [[ARRAYIDX40:%.*]] = getelementptr inbounds float, ptr [[TMP26]], i64 [[IDXPROM39]]
// CHECK3-NEXT:    store float [[MUL37]], ptr [[ARRAYIDX40]], align 4
// CHECK3-NEXT:    call void @__kmpc_end_ordered(ptr @[[GLOB1]], i32 [[TMP0]])
// CHECK3-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK3:       omp.body.continue:
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
// CHECK3-NEXT:    [[TMP28:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK3-NEXT:    [[ADD41:%.*]] = add nsw i64 [[TMP28]], 1
// CHECK3-NEXT:    store i64 [[ADD41]], ptr [[DOTOMP_IV]], align 8
...
// CHECK3-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[I:%.*]] = alloca b8, align 1
// CHECK3-NEXT:    [[X7:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[TMP0:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB1]])
// CHECK3-NEXT:    store ptr [[A]], ptr [[A_ADDR]], align 8
// CHECK3-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 8
// CHECK3-NEXT:    store ptr [[C]], ptr [[C_ADDR]], align 8
...
// CHECK3-NEXT:    store i32 0, ptr [[X]], align 4
// CHECK3-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK3-NEXT:    [[CONV:%.*]] = bytecast exact b8 57 to i8
// CHECK3-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
// CHECK3-NEXT:    [[CONV3:%.*]] = bytecast exact b8 48 to i8
// CHECK3-NEXT:    [[CONV4:%.*]] = sext i8 [[CONV3]] to i32
// CHECK3-NEXT:    [[SUB:%.*]] = sub nsw i32 [[CONV4]], 1
// CHECK3-NEXT:    [[SUB5:%.*]] = sub nsw i32 [[CONV2]], [[SUB]]
// CHECK3-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB5]], 1
// CHECK3-NEXT:    [[MUL:%.*]] = mul nsw i32 [[DIV]], 20
// CHECK3-NEXT:    [[SUB6:%.*]] = sub nsw i32 [[MUL]], 1
// CHECK3-NEXT:    store i32 [[SUB6]], ptr [[DOTOMP_UB]], align 4
// CHECK3-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4
// CHECK3-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK3-NEXT:    [[CONV8:%.*]] = bytecast exact b8 57 to i8
// CHECK3-NEXT:    [[CONV9:%.*]] = sext i8 [[CONV8]] to i32
// CHECK3-NEXT:    [[CONV10:%.*]] = bytecast exact b8 48 to i8
// CHECK3-NEXT:    [[CONV11:%.*]] = sext i8 [[CONV10]] to i32
// CHECK3-NEXT:    [[SUB12:%.*]] = sub nsw i32 [[CONV11]], 1
// CHECK3-NEXT:    [[SUB13:%.*]] = sub nsw i32 [[CONV9]], [[SUB12]]
// CHECK3-NEXT:    [[DIV14:%.*]] = sdiv i32 [[SUB13]], 1
// CHECK3-NEXT:    [[MUL15:%.*]] = mul nsw i32 [[DIV14]], 20
// CHECK3-NEXT:    [[SUB16:%.*]] = sub nsw i32 [[MUL15]], 1
// CHECK3-NEXT:    call void @__kmpc_dispatch_init_4(ptr @[[GLOB1]], i32 [[TMP0]], i32 69, i32 0, i32 [[SUB16]], i32 1, i32 1)
// CHECK3-NEXT:    br label [[OMP_DISPATCH_COND:%.*]]
// CHECK3:       omp.dispatch.cond:
// CHECK3-NEXT:    [[TMP1:%.*]] = call i32 @__kmpc_dispatch_next_4(ptr @[[GLOB1]], i32 [[TMP0]], ptr [[DOTOMP_IS_LAST]], ptr [[DOTOMP_LB]], ptr [[DOTOMP_UB]], ptr [[DOTOMP_STRIDE]])
// CHECK3-NEXT:    [[TOBOOL:%.*]] = icmp ne i32 [[TMP1]], 0
...
// CHECK3-NEXT:    br i1 [[CMP]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK3:       omp.inner.for.body:
// CHECK3-NEXT:    [[CONV17:%.*]] = bytecast exact b8 48 to i8
// CHECK3-NEXT:    [[CONV18:%.*]] = sext i8 [[CONV17]] to i32
// CHECK3-NEXT:    [[TMP5:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK3-NEXT:    [[DIV19:%.*]] = sdiv i32 [[TMP5]], 20
// CHECK3-NEXT:    [[MUL20:%.*]] = mul nsw i32 [[DIV19]], 1
// CHECK3-NEXT:    [[ADD:%.*]] = add nsw i32 [[CONV18]], [[MUL20]]
// CHECK3-NEXT:    [[CONV21:%.*]] = trunc i32 [[ADD]] to i8
// CHECK3-NEXT:    [[TMP6:%.*]] = bitcast i8 [[CONV21]] to b8
// CHECK3-NEXT:    store b8 [[TMP6]], ptr [[I]], align 1
// CHECK3-NEXT:    [[TMP7:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK3-NEXT:    [[TMP8:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK3-NEXT:    [[DIV22:%.*]] = sdiv i32 [[TMP8]], 20
// CHECK3-NEXT:    [[MUL23:%.*]] = mul nsw i32 [[DIV22]], 20
// CHECK3-NEXT:    [[SUB24:%.*]] = sub nsw i32 [[TMP7]], [[MUL23]]
// CHECK3-NEXT:    [[MUL25:%.*]] = mul nsw i32 [[SUB24]], 1
// CHECK3-NEXT:    [[ADD26:%.*]] = add nsw i32 -10, [[MUL25]]
// CHECK3-NEXT:    store i32 [[ADD26]], ptr [[X7]], align 4
// CHECK3-NEXT:    call void @__kmpc_ordered(ptr @[[GLOB1]], i32 [[TMP0]])
// CHECK3-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[B_ADDR]], align 8
// CHECK3-NEXT:    [[TMP10:%.*]] = load b8, ptr [[I]], align 1
// CHECK3-NEXT:    [[IDXPROM:%.*]] = bytecast exact b8 [[TMP10]] to i8
// CHECK3-NEXT:    [[IDXPROM27:%.*]] = zext i8 [[IDXPROM]] to i64
// CHECK3-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw float, ptr [[TMP9]], i64 [[IDXPROM27]]
// CHECK3-NEXT:    [[TMP11:%.*]] = load float, ptr [[ARRAYIDX]], align 4
// CHECK3-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[C_ADDR]], align 8
// CHECK3-NEXT:    [[TMP13:%.*]] = load b8, ptr [[I]], align 1
// CHECK3-NEXT:    [[IDXPROM28:%.*]] = bytecast exact b8 [[TMP13]] to i8
// CHECK3-NEXT:    [[IDXPROM29:%.*]] = zext i8 [[IDXPROM28]] to i64
// CHECK3-NEXT:    [[ARRAYIDX30:%.*]] = getelementptr inbounds nuw float, ptr [[TMP12]], i64 [[IDXPROM29]]
// CHECK3-NEXT:    [[TMP14:%.*]] = load float, ptr [[ARRAYIDX30]], align 4
// CHECK3-NEXT:    [[MUL31:%.*]] = fmul float [[TMP11]], [[TMP14]]
// CHECK3-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[D_ADDR]], align 8
// CHECK3-NEXT:    [[TMP16:%.*]] = load b8, ptr [[I]], align 1
// CHECK3-NEXT:    [[IDXPROM32:%.*]] = bytecast exact b8 [[TMP16]] to i8
// CHECK3-NEXT:    [[IDXPROM33:%.*]] = zext i8 [[IDXPROM32]] to i64
// CHECK3-NEXT:    [[ARRAYIDX34:%.*]] = getelementptr inbounds nuw float, ptr [[TMP15]], i64 [[IDXPROM33]]
// CHECK3-NEXT:    [[TMP17:%.*]] = load float, ptr [[ARRAYIDX34]], align 4
// CHECK3-NEXT:    [[MUL35:%.*]] = fmul float [[MUL31]], [[TMP17]]
// CHECK3-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[A_ADDR]], align 8
// CHECK3-NEXT:    [[TMP19:%.*]] = load b8, ptr [[I]], align 1
// CHECK3-NEXT:    [[IDXPROM36:%.*]] = bytecast exact b8 [[TMP19]] to i8
// CHECK3-NEXT:    [[IDXPROM37:%.*]] = zext i8 [[IDXPROM36]] to i64
// CHECK3-NEXT:    [[ARRAYIDX38:%.*]] = getelementptr inbounds nuw float, ptr [[TMP18]], i64 [[IDXPROM37]]
// CHECK3-NEXT:    store float [[MUL35]], ptr [[ARRAYIDX38]], align 4
// CHECK3-NEXT:    call void @__kmpc_end_ordered(ptr @[[GLOB1]], i32 [[TMP0]])
// CHECK3-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK3:       omp.body.continue:
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
...
// CHECK3-NEXT:    [[ADD39:%.*]] = add nsw i32 [[TMP20]], 1
// CHECK3-NEXT:    store i32 [[ADD39]], ptr [[DOTOMP_IV]], align 4
// CHECK3-NEXT:    call void @__kmpc_dispatch_fini_4(ptr @[[GLOB1]], i32 [[TMP0]])
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK3:       omp.inner.for.end:
// CHECK3-NEXT:    br label [[OMP_DISPATCH_INC:%.*]]
...
// CHECK3-IRBUILDER-NEXT:    [[DOTOMP_IV:%.*]] = alloca i64, align 8
// CHECK3-IRBUILDER-NEXT:    [[TMP:%.*]] = alloca b8, align 1
// CHECK3-IRBUILDER-NEXT:    [[_TMP1:%.*]] = alloca i32, align 4
// CHECK3-IRBUILDER-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK3-IRBUILDER-NEXT:    [[DOTCAPTURE_EXPR_2:%.*]] = alloca i64, align 8
// CHECK3-IRBUILDER-NEXT:    [[I:%.*]] = alloca b8, align 1
// CHECK3-IRBUILDER-NEXT:    [[X9:%.*]] = alloca i32, align 4
// CHECK3-IRBUILDER-NEXT:    [[DOTOMP_LB:%.*]] = alloca i64, align 8
// CHECK3-IRBUILDER-NEXT:    [[DOTOMP_UB:%.*]] = alloca i64, align 8
// CHECK3-IRBUILDER-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i64, align 8
// CHECK3-IRBUILDER-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK3-IRBUILDER-NEXT:    [[I14:%.*]] = alloca b8, align 1
// CHECK3-IRBUILDER-NEXT:    [[X15:%.*]] = alloca i32, align 4
// CHECK3-IRBUILDER-NEXT:    store ptr [[A]], ptr [[A_ADDR]], align 8
// CHECK3-IRBUILDER-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 8
// CHECK3-IRBUILDER-NEXT:    store ptr [[C]], ptr [[C_ADDR]], align 8
// CHECK3-IRBUILDER-NEXT:    store ptr [[D]], ptr [[D_ADDR]], align 8
...
// CHECK3-IRBUILDER-NEXT:    [[TMP1:%.*]] = bitcast i8 [[CONV]] to b8
// CHECK3-IRBUILDER-NEXT:    store b8 [[TMP1]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK3-IRBUILDER-NEXT:    [[CONV3:%.*]] = bytecast exact b8 57 to i8
// CHECK3-IRBUILDER-NEXT:    [[CONV4:%.*]] = sext i8 [[CONV3]] to i32
// CHECK3-IRBUILDER-NEXT:    [[TMP2:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK3-IRBUILDER-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP2]] to i8
// CHECK3-IRBUILDER-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK3-IRBUILDER-NEXT:    [[SUB:%.*]] = sub i32 [[CONV4]], [[CONV6]]
// CHECK3-IRBUILDER-NEXT:    [[ADD:%.*]] = add i32 [[SUB]], 1
// CHECK3-IRBUILDER-NEXT:    [[DIV:%.*]] = udiv i32 [[ADD]], 1
// CHECK3-IRBUILDER-NEXT:    [[CONV7:%.*]] = zext i32 [[DIV]] to i64
// CHECK3-IRBUILDER-NEXT:    [[MUL:%.*]] = mul nsw i64 [[CONV7]], 11
// CHECK3-IRBUILDER-NEXT:    [[SUB8:%.*]] = sub nsw i64 [[MUL]], 1
// CHECK3-IRBUILDER-NEXT:    store i64 [[SUB8]], ptr [[DOTCAPTURE_EXPR_2]], align 8
// CHECK3-IRBUILDER-NEXT:    [[TMP3:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK3-IRBUILDER-NEXT:    store b8 [[TMP3]], ptr [[I]], align 1
// CHECK3-IRBUILDER-NEXT:    store i32 11, ptr [[X9]], align 4
// CHECK3-IRBUILDER-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK3-IRBUILDER-NEXT:    [[CONV10:%.*]] = bytecast exact b8 [[TMP4]] to i8
// CHECK3-IRBUILDER-NEXT:    [[CONV11:%.*]] = sext i8 [[CONV10]] to i32
// CHECK3-IRBUILDER-NEXT:    [[CONV12:%.*]] = bytecast exact b8 57 to i8
// CHECK3-IRBUILDER-NEXT:    [[CONV13:%.*]] = sext i8 [[CONV12]] to i32
// CHECK3-IRBUILDER-NEXT:    [[CMP:%.*]] = icmp sle i32 [[CONV11]], [[CONV13]]
...
// CHECK3-IRBUILDER-NEXT:    store i64 [[TMP5]], ptr [[DOTOMP_UB]], align 8
// CHECK3-IRBUILDER-NEXT:    store i64 1, ptr [[DOTOMP_STRIDE]], align 8
// CHECK3-IRBUILDER-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK3-IRBUILDER-NEXT:    [[TMP6:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_2]], align 8
// CHECK3-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB8:[0-9]+]])
// CHECK3-IRBUILDER-NEXT:    call void @__kmpc_dispatch_init_8(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM]], i32 70, i64 0, i64 [[TMP6]], i64 1, i64 1)
// CHECK3-IRBUILDER-NEXT:    br label [[OMP_DISPATCH_COND:%.*]]
// CHECK3-IRBUILDER:       omp.dispatch.cond:
// CHECK3-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM16:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB8]])
// CHECK3-IRBUILDER-NEXT:    [[TMP7:%.*]] = call i32 @__kmpc_dispatch_next_8(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM16]], ptr [[DOTOMP_IS_LAST]], ptr [[DOTOMP_LB]], ptr [[DOTOMP_UB]], ptr [[DOTOMP_STRIDE]])
// CHECK3-IRBUILDER-NEXT:    [[TOBOOL:%.*]] = icmp ne i32 [[TMP7]], 0
// CHECK3-IRBUILDER-NEXT:    br i1 [[TOBOOL]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]]
// CHECK3-IRBUILDER:       omp.dispatch.body:
// CHECK3-IRBUILDER-NEXT:    [[TMP8:%.*]] = load i64, ptr [[DOTOMP_LB]], align 8
// CHECK3-IRBUILDER-NEXT:    store i64 [[TMP8]], ptr [[DOTOMP_IV]], align 8
// CHECK3-IRBUILDER-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK3-IRBUILDER:       omp.inner.for.cond:
// CHECK3-IRBUILDER-NEXT:    [[TMP9:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK3-IRBUILDER-NEXT:    [[TMP10:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8
// CHECK3-IRBUILDER-NEXT:    [[CMP17:%.*]] = icmp sle i64 [[TMP9]], [[TMP10]]
// CHECK3-IRBUILDER-NEXT:    br i1 [[CMP17]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK3-IRBUILDER:       omp.inner.for.body:
// CHECK3-IRBUILDER-NEXT:    [[TMP11:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK3-IRBUILDER-NEXT:    [[CONV18:%.*]] = bytecast exact b8 [[TMP11]] to i8
// CHECK3-IRBUILDER-NEXT:    [[CONV19:%.*]] = sext i8 [[CONV18]] to i64
// CHECK3-IRBUILDER-NEXT:    [[TMP12:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK3-IRBUILDER-NEXT:    [[DIV20:%.*]] = sdiv i64 [[TMP12]], 11
// CHECK3-IRBUILDER-NEXT:    [[MUL21:%.*]] = mul nsw i64 [[DIV20]], 1
// CHECK3-IRBUILDER-NEXT:    [[ADD22:%.*]] = add nsw i64 [[CONV19]], [[MUL21]]
// CHECK3-IRBUILDER-NEXT:    [[CONV23:%.*]] = trunc i64 [[ADD22]] to i8
// CHECK3-IRBUILDER-NEXT:    [[TMP13:%.*]] = bitcast i8 [[CONV23]] to b8
// CHECK3-IRBUILDER-NEXT:    store b8 [[TMP13]], ptr [[I14]], align 1
// CHECK3-IRBUILDER-NEXT:    [[TMP14:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK3-IRBUILDER-NEXT:    [[TMP15:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK3-IRBUILDER-NEXT:    [[DIV24:%.*]] = sdiv i64 [[TMP15]], 11
// CHECK3-IRBUILDER-NEXT:    [[MUL25:%.*]] = mul nsw i64 [[DIV24]], 11
// CHECK3-IRBUILDER-NEXT:    [[SUB26:%.*]] = sub nsw i64 [[TMP14]], [[MUL25]]
// CHECK3-IRBUILDER-NEXT:    [[MUL27:%.*]] = mul nsw i64 [[SUB26]], 1
// CHECK3-IRBUILDER-NEXT:    [[SUB28:%.*]] = sub nsw i64 11, [[MUL27]]
// CHECK3-IRBUILDER-NEXT:    [[CONV29:%.*]] = trunc i64 [[SUB28]] to i32
// CHECK3-IRBUILDER-NEXT:    store i32 [[CONV29]], ptr [[X15]], align 4
// CHECK3-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM30:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB1]])
// CHECK3-IRBUILDER-NEXT:    call void @__kmpc_ordered(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM30]])
// CHECK3-IRBUILDER-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[B_ADDR]], align 8
// CHECK3-IRBUILDER-NEXT:    [[TMP17:%.*]] = load b8, ptr [[I14]], align 1
// CHECK3-IRBUILDER-NEXT:    [[IDXPROM:%.*]] = bytecast exact b8 [[TMP17]] to i8
// CHECK3-IRBUILDER-NEXT:    [[IDXPROM31:%.*]] = sext i8 [[IDXPROM]] to i64
// CHECK3-IRBUILDER-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds float, ptr [[TMP16]], i64 [[IDXPROM31]]
// CHECK3-IRBUILDER-NEXT:    [[TMP18:%.*]] = load float, ptr [[ARRAYIDX]], align 4
// CHECK3-IRBUILDER-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[C_ADDR]], align 8
// CHECK3-IRBUILDER-NEXT:    [[TMP20:%.*]] = load b8, ptr [[I14]], align 1
// CHECK3-IRBUILDER-NEXT:    [[IDXPROM32:%.*]] = bytecast exact b8 [[TMP20]] to i8
// CHECK3-IRBUILDER-NEXT:    [[IDXPROM33:%.*]] = sext i8 [[IDXPROM32]] to i64
// CHECK3-IRBUILDER-NEXT:    [[ARRAYIDX34:%.*]] = getelementptr inbounds float, ptr [[TMP19]], i64 [[IDXPROM33]]
// CHECK3-IRBUILDER-NEXT:    [[TMP21:%.*]] = load float, ptr [[ARRAYIDX34]], align 4
// CHECK3-IRBUILDER-NEXT:    [[MUL35:%.*]] = fmul float [[TMP18]], [[TMP21]]
// CHECK3-IRBUILDER-NEXT:    [[TMP22:%.*]] = load ptr, ptr [[D_ADDR]], align 8
// CHECK3-IRBUILDER-NEXT:    [[TMP23:%.*]] = load b8, ptr [[I14]], align 1
// CHECK3-IRBUILDER-NEXT:    [[IDXPROM36:%.*]] = bytecast exact b8 [[TMP23]] to i8
// CHECK3-IRBUILDER-NEXT:    [[IDXPROM37:%.*]] = sext i8 [[IDXPROM36]] to i64
// CHECK3-IRBUILDER-NEXT:    [[ARRAYIDX38:%.*]] = getelementptr inbounds float, ptr [[TMP22]], i64 [[IDXPROM37]]
// CHECK3-IRBUILDER-NEXT:    [[TMP24:%.*]] = load float, ptr [[ARRAYIDX38]], align 4
// CHECK3-IRBUILDER-NEXT:    [[MUL39:%.*]] = fmul float [[MUL35]], [[TMP24]]
// CHECK3-IRBUILDER-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[A_ADDR]], align 8
// CHECK3-IRBUILDER-NEXT:    [[TMP26:%.*]] = load b8, ptr [[I14]], align 1
// CHECK3-IRBUILDER-NEXT:    [[IDXPROM40:%.*]] = bytecast exact b8 [[TMP26]] to i8
// CHECK3-IRBUILDER-NEXT:    [[IDXPROM41:%.*]] = sext i8 [[IDXPROM40]] to i64
// CHECK3-IRBUILDER-NEXT:    [[ARRAYIDX42:%.*]] = getelementptr inbounds float, ptr [[TMP25]], i64 [[IDXPROM41]]
// CHECK3-IRBUILDER-NEXT:    store float [[MUL39]], ptr [[ARRAYIDX42]], align 4
// CHECK3-IRBUILDER-NEXT:    br label [[OMP_INNER_FOR_BODY_ORDERED_AFTER:%.*]]
// CHECK3-IRBUILDER:       omp.inner.for.body.ordered.after:
// CHECK3-IRBUILDER-NEXT:    call void @__kmpc_end_ordered(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM30]])
// CHECK3-IRBUILDER-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK3-IRBUILDER:       omp.body.continue:
// CHECK3-IRBUILDER-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3-IRBUILDER:       omp.inner.for.inc:
// CHECK3-IRBUILDER-NEXT:    [[TMP27:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8
// CHECK3-IRBUILDER-NEXT:    [[ADD43:%.*]] = add nsw i64 [[TMP27]], 1
// CHECK3-IRBUILDER-NEXT:    store i64 [[ADD43]], ptr [[DOTOMP_IV]], align 8
// CHECK3-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM44:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB8]])
// CHECK3-IRBUILDER-NEXT:    call void @__kmpc_dispatch_fini_8(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM44]])
// CHECK3-IRBUILDER-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK3-IRBUILDER:       omp.inner.for.end:
// CHECK3-IRBUILDER-NEXT:    br label [[OMP_DISPATCH_INC:%.*]]
// CHECK3-IRBUILDER:       omp.dispatch.inc:
...
// CHECK3-IRBUILDER-NEXT:    call void @__kmpc_dispatch_deinit(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM45]])
...
// CHECK3-IRBUILDER-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK3-IRBUILDER-NEXT:    [[I:%.*]] = alloca b8, align 1
// CHECK3-IRBUILDER-NEXT:    [[X7:%.*]] = alloca i32, align 4
// CHECK3-IRBUILDER-NEXT:    store ptr [[A]], ptr [[A_ADDR]], align 8
// CHECK3-IRBUILDER-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 8
// CHECK3-IRBUILDER-NEXT:    store ptr [[C]], ptr [[C_ADDR]], align 8
// CHECK3-IRBUILDER-NEXT:    store ptr [[D]], ptr [[D_ADDR]], align 8
// CHECK3-IRBUILDER-NEXT:    store i32 0, ptr [[X]], align 4
// CHECK3-IRBUILDER-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK3-IRBUILDER-NEXT:    [[CONV:%.*]] = bytecast exact b8 57 to i8
// CHECK3-IRBUILDER-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
// CHECK3-IRBUILDER-NEXT:    [[CONV3:%.*]] = bytecast exact b8 48 to i8
// CHECK3-IRBUILDER-NEXT:    [[CONV4:%.*]] = sext i8 [[CONV3]] to i32
// CHECK3-IRBUILDER-NEXT:    [[SUB:%.*]] = sub nsw i32 [[CONV4]], 1
// CHECK3-IRBUILDER-NEXT:    [[SUB5:%.*]] = sub nsw i32 [[CONV2]], [[SUB]]
// CHECK3-IRBUILDER-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB5]], 1
// CHECK3-IRBUILDER-NEXT:    [[MUL:%.*]] = mul nsw i32 [[DIV]], 20
// CHECK3-IRBUILDER-NEXT:    [[SUB6:%.*]] = sub nsw i32 [[MUL]], 1
// CHECK3-IRBUILDER-NEXT:    store i32 [[SUB6]], ptr [[DOTOMP_UB]], align 4
// CHECK3-IRBUILDER-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4
// CHECK3-IRBUILDER-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK3-IRBUILDER-NEXT:    [[CONV8:%.*]] = bytecast exact b8 57 to i8
// CHECK3-IRBUILDER-NEXT:    [[CONV9:%.*]] = sext i8 [[CONV8]] to i32
// CHECK3-IRBUILDER-NEXT:    [[CONV10:%.*]] = bytecast exact b8 48 to i8
// CHECK3-IRBUILDER-NEXT:    [[CONV11:%.*]] = sext i8 [[CONV10]] to i32
// CHECK3-IRBUILDER-NEXT:    [[SUB12:%.*]] = sub nsw i32 [[CONV11]], 1
// CHECK3-IRBUILDER-NEXT:    [[SUB13:%.*]] = sub nsw i32 [[CONV9]], [[SUB12]]
// CHECK3-IRBUILDER-NEXT:    [[DIV14:%.*]] = sdiv i32 [[SUB13]], 1
// CHECK3-IRBUILDER-NEXT:    [[MUL15:%.*]] = mul nsw i32 [[DIV14]], 20
// CHECK3-IRBUILDER-NEXT:    [[SUB16:%.*]] = sub nsw i32 [[MUL15]], 1
// CHECK3-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB10:[0-9]+]])
// CHECK3-IRBUILDER-NEXT:    call void @__kmpc_dispatch_init_4(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM]], i32 69, i32 0, i32 [[SUB16]], i32 1, i32 1)
// CHECK3-IRBUILDER-NEXT:    br label [[OMP_DISPATCH_COND:%.*]]
// CHECK3-IRBUILDER:       omp.dispatch.cond:
// CHECK3-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM17:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB10]])
// CHECK3-IRBUILDER-NEXT:    [[TMP0:%.*]] = call i32 @__kmpc_dispatch_next_4(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM17]], ptr [[DOTOMP_IS_LAST]], ptr [[DOTOMP_LB]], ptr [[DOTOMP_UB]], ptr [[DOTOMP_STRIDE]])
// CHECK3-IRBUILDER-NEXT:    [[TOBOOL:%.*]] = icmp ne i32 [[TMP0]], 0
// CHECK3-IRBUILDER-NEXT:    br i1 [[TOBOOL]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]]
// CHECK3-IRBUILDER:       omp.dispatch.body:
// CHECK3-IRBUILDER-NEXT:    [[TMP1:%.*]] = load i32, ptr [[DOTOMP_LB]], align 4
...
// CHECK3-IRBUILDER-NEXT:    br i1 [[CMP]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK3-IRBUILDER:       omp.inner.for.body:
// CHECK3-IRBUILDER-NEXT:    [[CONV18:%.*]] = bytecast exact b8 48 to i8
// CHECK3-IRBUILDER-NEXT:    [[CONV19:%.*]] = sext i8 [[CONV18]] to i32
// CHECK3-IRBUILDER-NEXT:    [[TMP4:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK3-IRBUILDER-NEXT:    [[DIV20:%.*]] = sdiv i32 [[TMP4]], 20
// CHECK3-IRBUILDER-NEXT:    [[MUL21:%.*]] = mul nsw i32 [[DIV20]], 1
// CHECK3-IRBUILDER-NEXT:    [[ADD:%.*]] = add nsw i32 [[CONV19]], [[MUL21]]
// CHECK3-IRBUILDER-NEXT:    [[CONV22:%.*]] = trunc i32 [[ADD]] to i8
// CHECK3-IRBUILDER-NEXT:    [[TMP5:%.*]] = bitcast i8 [[CONV22]] to b8
// CHECK3-IRBUILDER-NEXT:    store b8 [[TMP5]], ptr [[I]], align 1
// CHECK3-IRBUILDER-NEXT:    [[TMP6:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK3-IRBUILDER-NEXT:    [[TMP7:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK3-IRBUILDER-NEXT:    [[DIV23:%.*]] = sdiv i32 [[TMP7]], 20
// CHECK3-IRBUILDER-NEXT:    [[MUL24:%.*]] = mul nsw i32 [[DIV23]], 20
// CHECK3-IRBUILDER-NEXT:    [[SUB25:%.*]] = sub nsw i32 [[TMP6]], [[MUL24]]
// CHECK3-IRBUILDER-NEXT:    [[MUL26:%.*]] = mul nsw i32 [[SUB25]], 1
// CHECK3-IRBUILDER-NEXT:    [[ADD27:%.*]] = add nsw i32 -10, [[MUL26]]
// CHECK3-IRBUILDER-NEXT:    store i32 [[ADD27]], ptr [[X7]], align 4
// CHECK3-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM28:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB1]])
// CHECK3-IRBUILDER-NEXT:    call void @__kmpc_ordered(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM28]])
// CHECK3-IRBUILDER-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[B_ADDR]], align 8
// CHECK3-IRBUILDER-NEXT:    [[TMP9:%.*]] = load b8, ptr [[I]], align 1
// CHECK3-IRBUILDER-NEXT:    [[IDXPROM:%.*]] = bytecast exact b8 [[TMP9]] to i8
// CHECK3-IRBUILDER-NEXT:    [[IDXPROM29:%.*]] = zext i8 [[IDXPROM]] to i64
// CHECK3-IRBUILDER-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw float, ptr [[TMP8]], i64 [[IDXPROM29]]
// CHECK3-IRBUILDER-NEXT:    [[TMP10:%.*]] = load float, ptr [[ARRAYIDX]], align 4
// CHECK3-IRBUILDER-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[C_ADDR]], align 8
// CHECK3-IRBUILDER-NEXT:    [[TMP12:%.*]] = load b8, ptr [[I]], align 1
// CHECK3-IRBUILDER-NEXT:    [[IDXPROM30:%.*]] = bytecast exact b8 [[TMP12]] to i8
// CHECK3-IRBUILDER-NEXT:    [[IDXPROM31:%.*]] = zext i8 [[IDXPROM30]] to i64
// CHECK3-IRBUILDER-NEXT:    [[ARRAYIDX32:%.*]] = getelementptr inbounds nuw float, ptr [[TMP11]], i64 [[IDXPROM31]]
// CHECK3-IRBUILDER-NEXT:    [[TMP13:%.*]] = load float, ptr [[ARRAYIDX32]], align 4
// CHECK3-IRBUILDER-NEXT:    [[MUL33:%.*]] = fmul float [[TMP10]], [[TMP13]]
// CHECK3-IRBUILDER-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[D_ADDR]], align 8
// CHECK3-IRBUILDER-NEXT:    [[TMP15:%.*]] = load b8, ptr [[I]], align 1
// CHECK3-IRBUILDER-NEXT:    [[IDXPROM34:%.*]] = bytecast exact b8 [[TMP15]] to i8
// CHECK3-IRBUILDER-NEXT:    [[IDXPROM35:%.*]] = zext i8 [[IDXPROM34]] to i64
// CHECK3-IRBUILDER-NEXT:    [[ARRAYIDX36:%.*]] = getelementptr inbounds nuw float, ptr [[TMP14]], i64 [[IDXPROM35]]
// CHECK3-IRBUILDER-NEXT:    [[TMP16:%.*]] = load float, ptr [[ARRAYIDX36]], align 4
// CHECK3-IRBUILDER-NEXT:    [[MUL37:%.*]] = fmul float [[MUL33]], [[TMP16]]
// CHECK3-IRBUILDER-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[A_ADDR]], align 8
// CHECK3-IRBUILDER-NEXT:    [[TMP18:%.*]] = load b8, ptr [[I]], align 1
// CHECK3-IRBUILDER-NEXT:    [[IDXPROM38:%.*]] = bytecast exact b8 [[TMP18]] to i8
// CHECK3-IRBUILDER-NEXT:    [[IDXPROM39:%.*]] = zext i8 [[IDXPROM38]] to i64
// CHECK3-IRBUILDER-NEXT:    [[ARRAYIDX40:%.*]] = getelementptr inbounds nuw float, ptr [[TMP17]], i64 [[IDXPROM39]]
// CHECK3-IRBUILDER-NEXT:    store float [[MUL37]], ptr [[ARRAYIDX40]], align 4
// CHECK3-IRBUILDER-NEXT:    br label [[OMP_INNER_FOR_BODY_ORDERED_AFTER:%.*]]
// CHECK3-IRBUILDER:       omp.inner.for.body.ordered.after:
// CHECK3-IRBUILDER-NEXT:    call void @__kmpc_end_ordered(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM28]])
// CHECK3-IRBUILDER-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK3-IRBUILDER:       omp.body.continue:
// CHECK3-IRBUILDER-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3-IRBUILDER:       omp.inner.for.inc:
// CHECK3-IRBUILDER-NEXT:    [[TMP19:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
// CHECK3-IRBUILDER-NEXT:    [[ADD41:%.*]] = add nsw i32 [[TMP19]], 1
// CHECK3-IRBUILDER-NEXT:    store i32 [[ADD41]], ptr [[DOTOMP_IV]], align 4
// CHECK3-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM42:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB10]])
// CHECK3-IRBUILDER-NEXT:    call void @__kmpc_dispatch_fini_4(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM42]])
// CHECK3-IRBUILDER-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK3-IRBUILDER:       omp.inner.for.end:
// CHECK3-IRBUILDER-NEXT:    br label [[OMP_DISPATCH_INC:%.*]]
// CHECK3-IRBUILDER:       omp.dispatch.inc:
// CHECK3-IRBUILDER-NEXT:    br label [[OMP_DISPATCH_COND]]
// CHECK3-IRBUILDER:       omp.dispatch.end:
// CHECK3-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM43:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB10]])
// CHECK3-IRBUILDER-NEXT:    call void @__kmpc_dispatch_deinit(ptr @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM43]])
// CHECK3-IRBUILDER-NEXT:    [[OMP_GLOBAL_THREAD_NUM44:%.*]] = call i32 @__kmpc_global_thread_num(ptr @[[GLOB1]])
// CHECK3-IRBUILDER-NEXT:    call void @__kmpc_barrier(ptr @[[GLOB4]], i32 [[OMP_GLOBAL_THREAD_NUM44]])
// CHECK3-IRBUILDER-NEXT:    ret void
//
//
...
// CHECK5-NEXT:    [[TMP1:%.*]] = bitcast i8 [[CONV]] to b8
// CHECK5-NEXT:    store b8 [[TMP1]], ptr [[I]], align 1
// CHECK5-NEXT:    br label [[FOR_COND:%.*]]
// CHECK5:       for.cond:
// CHECK5-NEXT:    [[TMP2:%.*]] = load b8, ptr [[I]], align 1
// CHECK5-NEXT:    [[CONV1:%.*]] = bytecast exact b8 [[TMP2]] to i8
// CHECK5-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV1]] to i32
// CHECK5-NEXT:    [[CONV3:%.*]] = bytecast exact b8 57 to i8
// CHECK5-NEXT:    [[CONV4:%.*]] = sext i8 [[CONV3]] to i32
// CHECK5-NEXT:    [[CMP:%.*]] = icmp sle i32 [[CONV2]], [[CONV4]]
// CHECK5-NEXT:    br i1 [[CMP]], label [[FOR_BODY:%.*]], label [[FOR_END22:%.*]]
// CHECK5:       for.body:
// CHECK5-NEXT:    store i32 11, ptr [[X]], align 4
// CHECK5-NEXT:    br label [[FOR_COND5:%.*]]
// CHECK5:       for.cond5:
// CHECK5-NEXT:    [[TMP3:%.*]] = load i32, ptr [[X]], align 4
// CHECK5-NEXT:    [[CMP6:%.*]] = icmp ugt i32 [[TMP3]], 0
// CHECK5-NEXT:    br i1 [[CMP6]], label [[FOR_BODY7:%.*]], label [[FOR_END:%.*]]
// CHECK5:       for.body7:
// CHECK5-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[B_ADDR]], align 8
// CHECK5-NEXT:    [[TMP5:%.*]] = load b8, ptr [[I]], align 1
// CHECK5-NEXT:    [[IDXPROM:%.*]] = bytecast exact b8 [[TMP5]] to i8
// CHECK5-NEXT:    [[IDXPROM8:%.*]] = sext i8 [[IDXPROM]] to i64
// CHECK5-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds float, ptr [[TMP4]], i64 [[IDXPROM8]]
// CHECK5-NEXT:    [[TMP6:%.*]] = load float, ptr [[ARRAYIDX]], align 4
// CHECK5-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[C_ADDR]], align 8
// CHECK5-NEXT:    [[TMP8:%.*]] = load b8, ptr [[I]], align 1
// CHECK5-NEXT:    [[IDXPROM9:%.*]] = bytecast exact b8 [[TMP8]] to i8
// CHECK5-NEXT:    [[IDXPROM10:%.*]] = sext i8 [[IDXPROM9]] to i64
// CHECK5-NEXT:    [[ARRAYIDX11:%.*]] = getelementptr inbounds float, ptr [[TMP7]], i64 [[IDXPROM10]]
// CHECK5-NEXT:    [[TMP9:%.*]] = load float, ptr [[ARRAYIDX11]], align 4
// CHECK5-NEXT:    [[MUL:%.*]] = fmul float [[TMP6]], [[TMP9]]
// CHECK5-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[D_ADDR]], align 8
// CHECK5-NEXT:    [[TMP11:%.*]] = load b8, ptr [[I]], align 1
// CHECK5-NEXT:    [[IDXPROM12:%.*]] = bytecast exact b8 [[TMP11]] to i8
// CHECK5-NEXT:    [[IDXPROM13:%.*]] = sext i8 [[IDXPROM12]] to i64
// CHECK5-NEXT:    [[ARRAYIDX14:%.*]] = getelementptr inbounds float, ptr [[TMP10]], i64 [[IDXPROM13]]
// CHECK5-NEXT:    [[TMP12:%.*]] = load float, ptr [[ARRAYIDX14]], align 4
// CHECK5-NEXT:    [[MUL15:%.*]] = fmul float [[MUL]], [[TMP12]]
// CHECK5-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[A_ADDR]], align 8
// CHECK5-NEXT:    [[TMP14:%.*]] = load b8, ptr [[I]], align 1
// CHECK5-NEXT:    [[IDXPROM16:%.*]] = bytecast exact b8 [[TMP14]] to i8
// CHECK5-NEXT:    [[IDXPROM17:%.*]] = sext i8 [[IDXPROM16]] to i64
// CHECK5-NEXT:    [[ARRAYIDX18:%.*]] = getelementptr inbounds float, ptr [[TMP13]], i64 [[IDXPROM17]]
// CHECK5-NEXT:    store float [[MUL15]], ptr [[ARRAYIDX18]], align 4
// CHECK5-NEXT:    br label [[FOR_INC:%.*]]
// CHECK5:       for.inc:
// CHECK5-NEXT:    [[TMP15:%.*]] = load i32, ptr [[X]], align 4
// CHECK5-NEXT:    [[DEC:%.*]] = add i32 [[TMP15]], -1
// CHECK5-NEXT:    store i32 [[DEC]], ptr [[X]], align 4
// CHECK5-NEXT:    br label [[FOR_COND5]], !llvm.loop [[LOOP5:![0-9]+]]
// CHECK5:       for.end:
// CHECK5-NEXT:    br label [[FOR_INC19:%.*]]
// CHECK5:       for.inc19:
// CHECK5-NEXT:    [[TMP16:%.*]] = load b8, ptr [[I]], align 1
// CHECK5-NEXT:    [[CONV20:%.*]] = bytecast exact b8 [[TMP16]] to i8
// CHECK5-NEXT:    [[INC:%.*]] = add i8 [[CONV20]], 1
// CHECK5-NEXT:    [[CONV21:%.*]] = bitcast i8 [[INC]] to b8
// CHECK5-NEXT:    store b8 [[CONV21]], ptr [[I]], align 1
...
// CHECK5-NEXT:    store ptr [[D]], ptr [[D_ADDR]], align 8
// CHECK5-NEXT:    store i32 0, ptr [[X]], align 4
// CHECK5-NEXT:    [[TMP0:%.*]] = bytecast exact b8 48 to i8
// CHECK5-NEXT:    store i8 [[TMP0]], ptr [[I]], align 1
// CHECK5-NEXT:    br label [[FOR_COND:%.*]]
// CHECK5:       for.cond:
// CHECK5-NEXT:    [[TMP1:%.*]] = load b8, ptr [[I]], align 1
// CHECK5-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP1]] to i8
// CHECK5-NEXT:    [[CONV1:%.*]] = zext i8 [[CONV]] to i32
// CHECK5-NEXT:    [[CONV2:%.*]] = bytecast exact b8 57 to i8
// CHECK5-NEXT:    [[CONV3:%.*]] = sext i8 [[CONV2]] to i32
// CHECK5-NEXT:    [[CMP:%.*]] = icmp sle i32 [[CONV1]], [[CONV3]]
// CHECK5-NEXT:    br i1 [[CMP]], label [[FOR_BODY:%.*]], label [[FOR_END22:%.*]]
// CHECK5:       for.body:
...
// CHECK5-NEXT:    [[CMP5:%.*]] = icmp slt i32 [[TMP2]], 10
// CHECK5-NEXT:    br i1 [[CMP5]], label [[FOR_BODY6:%.*]], label [[FOR_END:%.*]]
// CHECK5:       for.body6:
// CHECK5-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[B_ADDR]], align 8
// CHECK5-NEXT:    [[TMP4:%.*]] = load b8, ptr [[I]], align 1
// CHECK5-NEXT:    [[IDXPROM:%.*]] = bytecast exact b8 [[TMP4]] to i8
// CHECK5-NEXT:    [[IDXPROM7:%.*]] = zext i8 [[IDXPROM]] to i64
// CHECK5-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw float, ptr [[TMP3]], i64 [[IDXPROM7]]
// CHECK5-NEXT:    [[TMP5:%.*]] = load float, ptr [[ARRAYIDX]], align 4
// CHECK5-NEXT:    [[TMP6:%.*]] = load ptr, ptr [[C_ADDR]], align 8
// CHECK5-NEXT:    [[TMP7:%.*]] = load b8, ptr [[I]], align 1
// CHECK5-NEXT:    [[IDXPROM8:%.*]] = bytecast exact b8 [[TMP7]] to i8
// CHECK5-NEXT:    [[IDXPROM9:%.*]] = zext i8 [[IDXPROM8]] to i64
// CHECK5-NEXT:    [[ARRAYIDX10:%.*]] = getelementptr inbounds nuw float, ptr [[TMP6]], i64 [[IDXPROM9]]
// CHECK5-NEXT:    [[TMP8:%.*]] = load float, ptr [[ARRAYIDX10]], align 4
// CHECK5-NEXT:    [[MUL:%.*]] = fmul float [[TMP5]], [[TMP8]]
// CHECK5-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[D_ADDR]], align 8
// CHECK5-NEXT:    [[TMP10:%.*]] = load b8, ptr [[I]], align 1
// CHECK5-NEXT:    [[IDXPROM11:%.*]] = bytecast exact b8 [[TMP10]] to i8
// CHECK5-NEXT:    [[IDXPROM12:%.*]] = zext i8 [[IDXPROM11]] to i64
// CHECK5-NEXT:    [[ARRAYIDX13:%.*]] = getelementptr inbounds nuw float, ptr [[TMP9]], i64 [[IDXPROM12]]
// CHECK5-NEXT:    [[TMP11:%.*]] = load float, ptr [[ARRAYIDX13]], align 4
// CHECK5-NEXT:    [[MUL14:%.*]] = fmul float [[MUL]], [[TMP11]]
// CHECK5-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[A_ADDR]], align 8
// CHECK5-NEXT:    [[TMP13:%.*]] = load b8, ptr [[I]], align 1
// CHECK5-NEXT:    [[IDXPROM15:%.*]] = bytecast exact b8 [[TMP13]] to i8
// CHECK5-NEXT:    [[IDXPROM16:%.*]] = zext i8 [[IDXPROM15]] to i64
// CHECK5-NEXT:    [[ARRAYIDX17:%.*]] = getelementptr inbounds nuw float, ptr [[TMP12]], i64 [[IDXPROM16]]
// CHECK5-NEXT:    store float [[MUL14]], ptr [[ARRAYIDX17]], align 4
// CHECK5-NEXT:    br label [[FOR_INC:%.*]]
// CHECK5:       for.inc:
// CHECK5-NEXT:    [[TMP14:%.*]] = load i32, ptr [[X]], align 4
// CHECK5-NEXT:    [[INC:%.*]] = add nsw i32 [[TMP14]], 1
// CHECK5-NEXT:    store i32 [[INC]], ptr [[X]], align 4
// CHECK5-NEXT:    br label [[FOR_COND4]], !llvm.loop [[LOOP7:![0-9]+]]
// CHECK5:       for.end:
// CHECK5-NEXT:    br label [[FOR_INC18:%.*]]
// CHECK5:       for.inc18:
// CHECK5-NEXT:    [[TMP15:%.*]] = load b8, ptr [[I]], align 1
// CHECK5-NEXT:    [[CONV19:%.*]] = bytecast exact b8 [[TMP15]] to i8
// CHECK5-NEXT:    [[INC20:%.*]] = add i8 [[CONV19]], 1
// CHECK5-NEXT:    [[CONV21:%.*]] = bitcast i8 [[INC20]] to b8
// CHECK5-NEXT:    store b8 [[CONV21]], ptr [[I]], align 1
