...
// CHECK1-NEXT:    [[CONV:%.*]] = fptoui double [[TMP0]] to i8
// CHECK1-NEXT:    [[CONV1:%.*]] = bitcast i8 [[CONV]] to b8
// CHECK1-NEXT:    store b8 [[CONV1]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-NEXT:    [[TMP1:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-NEXT:    store b8 [[TMP1]], ptr [[DOTCAPTURE_EXPR__CASTED]], align 1
...
// CHECK1-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR__ADDR]], align 1
// CHECK1-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP4]] to i8
// CHECK1-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i64
// CHECK1-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP6:%.*]] = load i32, ptr [[TMP5]], align 4
// CHECK1-NEXT:    call void @__kmpc_for_static_init_8u(ptr @[[GLOB1:[0-9]+]], i32 [[TMP6]], i32 33, ptr [[DOTOMP_IS_LAST]], ptr [[DOTOMP_LB]], ptr [[DOTOMP_UB]], ptr [[DOTOMP_STRIDE]], i64 1, i64 [[CONV6]])
...
// CHECK1-NEXT:    store i64 [[ADD12]], ptr [[I4]], align 8
...
// CHECK1-NEXT:    store i64 [[ADD13]], ptr [[DOTOMP_IV]], align 8
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND]]
...
// CHECK1-NEXT:    store i64 [[ADD14]], ptr [[DOTOMP_LB]], align 8
...
// CHECK1-NEXT:    store i64 [[ADD15]], ptr [[DOTOMP_UB]], align 8
// CHECK1-NEXT:    br label [[OMP_DISPATCH_COND]]
...
// CHECK1-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i64, align 8
// CHECK1-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[I13:%.*]] = alloca b8, align 1
// CHECK1-NEXT:    [[X14:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 8
...
// CHECK1-NEXT:    [[TMP6:%.*]] = bitcast i8 [[CONV]] to b8
// CHECK1-NEXT:    store b8 [[TMP6]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-NEXT:    [[CONV3:%.*]] = bytecast exact b8 57 to i8
// CHECK1-NEXT:    [[CONV4:%.*]] = sext i8 [[CONV3]] to i32
// CHECK1-NEXT:    [[TMP7:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP7]] to i8
// CHECK1-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK1-NEXT:    [[SUB:%.*]] = sub i32 [[CONV4]], [[CONV6]]
// CHECK1-NEXT:    [[ADD:%.*]] = add i32 [[SUB]], 1
// CHECK1-NEXT:    [[DIV:%.*]] = udiv i32 [[ADD]], 1
// CHECK1-NEXT:    [[CONV7:%.*]] = zext i32 [[DIV]] to i64
// CHECK1-NEXT:    [[MUL:%.*]] = mul nsw i64 [[CONV7]], 11
// CHECK1-NEXT:    [[SUB8:%.*]] = sub nsw i64 [[MUL]], 1
// CHECK1-NEXT:    store i64 [[SUB8]], ptr [[DOTCAPTURE_EXPR_2]], align 8
// CHECK1-NEXT:    [[TMP8:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-NEXT:    store b8 [[TMP8]], ptr [[I]], align 1
// CHECK1-NEXT:    store i32 11, ptr [[X]], align 4
// CHECK1-NEXT:    [[TMP9:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK1-NEXT:    [[CONV9:%.*]] = bytecast exact b8 [[TMP9]] to i8
// CHECK1-NEXT:    [[CONV10:%.*]] = sext i8 [[CONV9]] to i32
// CHECK1-NEXT:    [[CONV11:%.*]] = bytecast exact b8 57 to i8
// CHECK1-NEXT:    [[CONV12:%.*]] = sext i8 [[CONV11]] to i32
// CHECK1-NEXT:    [[CMP:%.*]] = icmp sle i32 [[CONV10]], [[CONV12]]
// CHECK1-NEXT:    br i1 [[CMP]], label [[OMP_PRECOND_THEN:%.*]], label [[OMP_PRECOND_END:%.*]]
// CHECK1:       omp.precond.then:
// CHECK1-NEXT:    store i64 0, ptr [[DOTOMP_LB]], align 8
...
// CHECK1-NEXT:    store i64 1, ptr [[DOTOMP_STRIDE]], align 8
// CHECK1-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK1-NEXT:    [[TMP11:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_2]], align 8
// CHECK1-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP13:%.*]] = load i32, ptr [[TMP12]], align 4
// CHECK1-NEXT:    call void @__kmpc_dispatch_init_8(ptr @[[GLOB2]], i32 [[TMP13]], i32 1073741862, i64 0, i64 [[TMP11]], i64 1, i64 1)
// CHECK1-NEXT:    br label [[OMP_DISPATCH_COND:%.*]]
// CHECK1:       omp.dispatch.cond:
// CHECK1-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP15:%.*]] = load i32, ptr [[TMP14]], align 4
// CHECK1-NEXT:    [[TMP16:%.*]] = call i32 @__kmpc_dispatch_next_8(ptr @[[GLOB2]], i32 [[TMP15]], ptr [[DOTOMP_IS_LAST]], ptr [[DOTOMP_LB]], ptr [[DOTOMP_UB]], ptr [[DOTOMP_STRIDE]])
// CHECK1-NEXT:    [[TOBOOL:%.*]] = icmp ne i32 [[TMP16]], 0
// CHECK1-NEXT:    br i1 [[TOBOOL]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]]
// CHECK1:       omp.dispatch.body:
// CHECK1-NEXT:    [[TMP17:%.*]] = load i64, ptr [[DOTOMP_LB]], align 8
// CHECK1-NEXT:    store i64 [[TMP17]], ptr [[DOTOMP_IV]], align 8
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK1:       omp.inner.for.cond:
// CHECK1-NEXT:    [[TMP18:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP11:![0-9]+]]
// CHECK1-NEXT:    [[TMP19:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[CMP15:%.*]] = icmp sle i64 [[TMP18]], [[TMP19]]
// CHECK1-NEXT:    br i1 [[CMP15]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK1:       omp.inner.for.body:
// CHECK1-NEXT:    [[TMP20:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[CONV16:%.*]] = bytecast exact b8 [[TMP20]] to i8
// CHECK1-NEXT:    [[CONV17:%.*]] = sext i8 [[CONV16]] to i64
// CHECK1-NEXT:    [[TMP21:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[DIV18:%.*]] = sdiv i64 [[TMP21]], 11
// CHECK1-NEXT:    [[MUL19:%.*]] = mul nsw i64 [[DIV18]], 1
// CHECK1-NEXT:    [[ADD20:%.*]] = add nsw i64 [[CONV17]], [[MUL19]]
// CHECK1-NEXT:    [[CONV21:%.*]] = trunc i64 [[ADD20]] to i8
// CHECK1-NEXT:    [[TMP22:%.*]] = bitcast i8 [[CONV21]] to b8
// CHECK1-NEXT:    store b8 [[TMP22]], ptr [[I13]], align 1, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[TMP23:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[TMP24:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[DIV22:%.*]] = sdiv i64 [[TMP24]], 11
// CHECK1-NEXT:    [[MUL23:%.*]] = mul nsw i64 [[DIV22]], 11
// CHECK1-NEXT:    [[SUB24:%.*]] = sub nsw i64 [[TMP23]], [[MUL23]]
// CHECK1-NEXT:    [[MUL25:%.*]] = mul nsw i64 [[SUB24]], 1
// CHECK1-NEXT:    [[SUB26:%.*]] = sub nsw i64 11, [[MUL25]]
// CHECK1-NEXT:    [[CONV27:%.*]] = trunc i64 [[SUB26]] to i32
// CHECK1-NEXT:    store i32 [[CONV27]], ptr [[X14]], align 4, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[TMP2]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[TMP26:%.*]] = load b8, ptr [[I13]], align 1, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[IDXPROM:%.*]] = bytecast exact b8 [[TMP26]] to i8
// CHECK1-NEXT:    [[IDXPROM28:%.*]] = sext i8 [[IDXPROM]] to i64
// CHECK1-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds float, ptr [[TMP25]], i64 [[IDXPROM28]]
// CHECK1-NEXT:    [[TMP27:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[TMP28:%.*]] = load ptr, ptr [[TMP3]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[TMP29:%.*]] = load b8, ptr [[I13]], align 1, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[IDXPROM29:%.*]] = bytecast exact b8 [[TMP29]] to i8
// CHECK1-NEXT:    [[IDXPROM30:%.*]] = sext i8 [[IDXPROM29]] to i64
// CHECK1-NEXT:    [[ARRAYIDX31:%.*]] = getelementptr inbounds float, ptr [[TMP28]], i64 [[IDXPROM30]]
// CHECK1-NEXT:    [[TMP30:%.*]] = load float, ptr [[ARRAYIDX31]], align 4, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[MUL32:%.*]] = fmul float [[TMP27]], [[TMP30]]
// CHECK1-NEXT:    [[TMP31:%.*]] = load ptr, ptr [[TMP4]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[TMP32:%.*]] = load b8, ptr [[I13]], align 1, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[IDXPROM33:%.*]] = bytecast exact b8 [[TMP32]] to i8
// CHECK1-NEXT:    [[IDXPROM34:%.*]] = sext i8 [[IDXPROM33]] to i64
// CHECK1-NEXT:    [[ARRAYIDX35:%.*]] = getelementptr inbounds float, ptr [[TMP31]], i64 [[IDXPROM34]]
// CHECK1-NEXT:    [[TMP33:%.*]] = load float, ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[MUL36:%.*]] = fmul float [[MUL32]], [[TMP33]]
// CHECK1-NEXT:    [[TMP34:%.*]] = load ptr, ptr [[TMP1]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[TMP35:%.*]] = load b8, ptr [[I13]], align 1, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[IDXPROM37:%.*]] = bytecast exact b8 [[TMP35]] to i8
// CHECK1-NEXT:    [[IDXPROM38:%.*]] = sext i8 [[IDXPROM37]] to i64
// CHECK1-NEXT:    [[ARRAYIDX39:%.*]] = getelementptr inbounds float, ptr [[TMP34]], i64 [[IDXPROM38]]
// CHECK1-NEXT:    store float [[MUL36]], ptr [[ARRAYIDX39]], align 4, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1:       omp.body.continue:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
// CHECK1-NEXT:    [[TMP36:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK1-NEXT:    [[ADD40:%.*]] = add nsw i64 [[TMP36]], 1
// CHECK1-NEXT:    store i64 [[ADD40]], ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP11]]
...
// CHECK1-NEXT:    call void @__kmpc_dispatch_deinit(ptr @[[GLOB2]], i32 [[TMP38]])
// CHECK1-NEXT:    br label [[OMP_PRECOND_END]]
// CHECK1:       omp.precond.end:
// CHECK1-NEXT:    ret void
//
...
// CHECK1-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[D_ADDR]], align 8
// CHECK1-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK1-NEXT:    [[CONV:%.*]] = bytecast exact b8 57 to i8
// CHECK1-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
// CHECK1-NEXT:    [[CONV3:%.*]] = bytecast exact b8 48 to i8
// CHECK1-NEXT:    [[CONV4:%.*]] = sext i8 [[CONV3]] to i32
// CHECK1-NEXT:    [[SUB:%.*]] = sub nsw i32 [[CONV4]], 1
// CHECK1-NEXT:    [[SUB5:%.*]] = sub nsw i32 [[CONV2]], [[SUB]]
// CHECK1-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB5]], 1
// CHECK1-NEXT:    [[MUL:%.*]] = mul nsw i32 [[DIV]], 20
// CHECK1-NEXT:    [[SUB6:%.*]] = sub nsw i32 [[MUL]], 1
// CHECK1-NEXT:    store i32 [[SUB6]], ptr [[DOTOMP_UB]], align 4
// CHECK1-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4
// CHECK1-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK1-NEXT:    [[CONV7:%.*]] = bytecast exact b8 57 to i8
// CHECK1-NEXT:    [[CONV8:%.*]] = sext i8 [[CONV7]] to i32
// CHECK1-NEXT:    [[CONV9:%.*]] = bytecast exact b8 48 to i8
// CHECK1-NEXT:    [[CONV10:%.*]] = sext i8 [[CONV9]] to i32
// CHECK1-NEXT:    [[SUB11:%.*]] = sub nsw i32 [[CONV10]], 1
// CHECK1-NEXT:    [[SUB12:%.*]] = sub nsw i32 [[CONV8]], [[SUB11]]
// CHECK1-NEXT:    [[DIV13:%.*]] = sdiv i32 [[SUB12]], 1
// CHECK1-NEXT:    [[MUL14:%.*]] = mul nsw i32 [[DIV13]], 20
// CHECK1-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[MUL14]], 1
// CHECK1-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP5:%.*]] = load i32, ptr [[TMP4]], align 4
// CHECK1-NEXT:    call void @__kmpc_dispatch_init_4(ptr @[[GLOB2]], i32 [[TMP5]], i32 1073741861, i32 0, i32 [[SUB15]], i32 1, i32 1)
// CHECK1-NEXT:    br label [[OMP_DISPATCH_COND:%.*]]
// CHECK1:       omp.dispatch.cond:
...
// CHECK1-NEXT:    br i1 [[CMP]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK1:       omp.inner.for.body:
// CHECK1-NEXT:    [[CONV16:%.*]] = bytecast exact b8 48 to i8
// CHECK1-NEXT:    [[CONV17:%.*]] = sext i8 [[CONV16]] to i32
// CHECK1-NEXT:    [[TMP10:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK1-NEXT:    [[DIV18:%.*]] = sdiv i32 [[TMP10]], 20
// CHECK1-NEXT:    [[MUL19:%.*]] = mul nsw i32 [[DIV18]], 1
// CHECK1-NEXT:    [[ADD:%.*]] = add nsw i32 [[CONV17]], [[MUL19]]
// CHECK1-NEXT:    [[CONV20:%.*]] = trunc i32 [[ADD]] to i8
// CHECK1-NEXT:    [[TMP11:%.*]] = bitcast i8 [[CONV20]] to b8
// CHECK1-NEXT:    store b8 [[TMP11]], ptr [[I]], align 1, !llvm.access.group [[ACC_GRP14]]
...
// CHECK1-NEXT:    [[DIV21:%.*]] = sdiv i32 [[TMP13]], 20
// CHECK1-NEXT:    [[MUL22:%.*]] = mul nsw i32 [[DIV21]], 20
// CHECK1-NEXT:    [[SUB23:%.*]] = sub nsw i32 [[TMP12]], [[MUL22]]
// CHECK1-NEXT:    [[MUL24:%.*]] = mul nsw i32 [[SUB23]], 1
// CHECK1-NEXT:    [[ADD25:%.*]] = add nsw i32 -10, [[MUL24]]
// CHECK1-NEXT:    store i32 [[ADD25]], ptr [[X]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK1-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[TMP1]], align 8, !llvm.access.group [[ACC_GRP14]]
// CHECK1-NEXT:    [[TMP15:%.*]] = load b8, ptr [[I]], align 1, !llvm.access.group [[ACC_GRP14]]
// CHECK1-NEXT:    [[IDXPROM:%.*]] = bytecast exact b8 [[TMP15]] to i8
// CHECK1-NEXT:    [[IDXPROM26:%.*]] = zext i8 [[IDXPROM]] to i64
// CHECK1-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw float, ptr [[TMP14]], i64 [[IDXPROM26]]
// CHECK1-NEXT:    [[TMP16:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK1-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[TMP2]], align 8, !llvm.access.group [[ACC_GRP14]]
// CHECK1-NEXT:    [[TMP18:%.*]] = load b8, ptr [[I]], align 1, !llvm.access.group [[ACC_GRP14]]
// CHECK1-NEXT:    [[IDXPROM27:%.*]] = bytecast exact b8 [[TMP18]] to i8
// CHECK1-NEXT:    [[IDXPROM28:%.*]] = zext i8 [[IDXPROM27]] to i64
// CHECK1-NEXT:    [[ARRAYIDX29:%.*]] = getelementptr inbounds nuw float, ptr [[TMP17]], i64 [[IDXPROM28]]
// CHECK1-NEXT:    [[TMP19:%.*]] = load float, ptr [[ARRAYIDX29]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK1-NEXT:    [[MUL30:%.*]] = fmul float [[TMP16]], [[TMP19]]
// CHECK1-NEXT:    [[TMP20:%.*]] = load ptr, ptr [[TMP3]], align 8, !llvm.access.group [[ACC_GRP14]]
// CHECK1-NEXT:    [[TMP21:%.*]] = load b8, ptr [[I]], align 1, !llvm.access.group [[ACC_GRP14]]
// CHECK1-NEXT:    [[IDXPROM31:%.*]] = bytecast exact b8 [[TMP21]] to i8
// CHECK1-NEXT:    [[IDXPROM32:%.*]] = zext i8 [[IDXPROM31]] to i64
// CHECK1-NEXT:    [[ARRAYIDX33:%.*]] = getelementptr inbounds nuw float, ptr [[TMP20]], i64 [[IDXPROM32]]
// CHECK1-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX33]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK1-NEXT:    [[MUL34:%.*]] = fmul float [[MUL30]], [[TMP22]]
// CHECK1-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[TMP0]], align 8, !llvm.access.group [[ACC_GRP14]]
// CHECK1-NEXT:    [[TMP24:%.*]] = load b8, ptr [[I]], align 1, !llvm.access.group [[ACC_GRP14]]
// CHECK1-NEXT:    [[IDXPROM35:%.*]] = bytecast exact b8 [[TMP24]] to i8
// CHECK1-NEXT:    [[IDXPROM36:%.*]] = zext i8 [[IDXPROM35]] to i64
// CHECK1-NEXT:    [[ARRAYIDX37:%.*]] = getelementptr inbounds nuw float, ptr [[TMP23]], i64 [[IDXPROM36]]
// CHECK1-NEXT:    store float [[MUL34]], ptr [[ARRAYIDX37]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK1-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1:       omp.body.continue:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
// CHECK1-NEXT:    [[TMP25:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK1-NEXT:    [[ADD38:%.*]] = add nsw i32 [[TMP25]], 1
// CHECK1-NEXT:    store i32 [[ADD38]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP14]]
...
// CHECK2-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
...
// CHECK2-NEXT:    [[CONV:%.*]] = fptoui double [[TMP0]] to i8
// CHECK2-NEXT:    [[CONV1:%.*]] = bitcast i8 [[CONV]] to b8
// CHECK2-NEXT:    store b8 [[CONV1]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK2-NEXT:    [[TMP1:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK2-NEXT:    store b8 [[TMP1]], ptr [[DOTCAPTURE_EXPR__CASTED]], align 1
...
// CHECK2-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR__ADDR]], align 1
// CHECK2-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP4]] to i8
// CHECK2-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i64
// CHECK2-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    [[TMP6:%.*]] = load i32, ptr [[TMP5]], align 4
// CHECK2-NEXT:    call void @__kmpc_for_static_init_8u(ptr @[[GLOB1:[0-9]+]], i32 [[TMP6]], i32 33, ptr [[DOTOMP_IS_LAST]], ptr [[DOTOMP_LB]], ptr [[DOTOMP_UB]], ptr [[DOTOMP_STRIDE]], i64 1, i64 [[CONV6]])
...
// CHECK2-NEXT:    store i64 [[ADD12]], ptr [[I4]], align 8
...
// CHECK2-NEXT:    store i64 [[ADD13]], ptr [[DOTOMP_IV]], align 8
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_COND]]
...
// CHECK2-NEXT:    store i64 [[ADD14]], ptr [[DOTOMP_LB]], align 8
...
// CHECK2-NEXT:    store i64 [[ADD15]], ptr [[DOTOMP_UB]], align 8
// CHECK2-NEXT:    br label [[OMP_DISPATCH_COND]]
...
// CHECK2-NEXT:    [[D_ADDR:%.*]] = alloca ptr, align 8
// CHECK2-NEXT:    [[DOTOMP_IV:%.*]] = alloca i64, align 8
// CHECK2-NEXT:    [[TMP:%.*]] = alloca b8, align 1
// CHECK2-NEXT:    [[_TMP1:%.*]] = alloca i32, align 4
// CHECK2-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK2-NEXT:    [[DOTCAPTURE_EXPR_2:%.*]] = alloca i64, align 8
// CHECK2-NEXT:    [[I:%.*]] = alloca b8, align 1
// CHECK2-NEXT:    [[X:%.*]] = alloca i32, align 4
// CHECK2-NEXT:    [[DOTOMP_LB:%.*]] = alloca i64, align 8
// CHECK2-NEXT:    [[DOTOMP_UB:%.*]] = alloca i64, align 8
// CHECK2-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i64, align 8
// CHECK2-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK2-NEXT:    [[I13:%.*]] = alloca b8, align 1
// CHECK2-NEXT:    [[X14:%.*]] = alloca i32, align 4
// CHECK2-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 8
...
// CHECK2-NEXT:    [[TMP6:%.*]] = bitcast i8 [[CONV]] to b8
// CHECK2-NEXT:    store b8 [[TMP6]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK2-NEXT:    [[CONV3:%.*]] = bytecast exact b8 57 to i8
// CHECK2-NEXT:    [[CONV4:%.*]] = sext i8 [[CONV3]] to i32
// CHECK2-NEXT:    [[TMP7:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK2-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP7]] to i8
// CHECK2-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK2-NEXT:    [[SUB:%.*]] = sub i32 [[CONV4]], [[CONV6]]
// CHECK2-NEXT:    [[ADD:%.*]] = add i32 [[SUB]], 1
// CHECK2-NEXT:    [[DIV:%.*]] = udiv i32 [[ADD]], 1
// CHECK2-NEXT:    [[CONV7:%.*]] = zext i32 [[DIV]] to i64
// CHECK2-NEXT:    [[MUL:%.*]] = mul nsw i64 [[CONV7]], 11
// CHECK2-NEXT:    [[SUB8:%.*]] = sub nsw i64 [[MUL]], 1
// CHECK2-NEXT:    store i64 [[SUB8]], ptr [[DOTCAPTURE_EXPR_2]], align 8
// CHECK2-NEXT:    [[TMP8:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK2-NEXT:    store b8 [[TMP8]], ptr [[I]], align 1
// CHECK2-NEXT:    store i32 11, ptr [[X]], align 4
// CHECK2-NEXT:    [[TMP9:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK2-NEXT:    [[CONV9:%.*]] = bytecast exact b8 [[TMP9]] to i8
// CHECK2-NEXT:    [[CONV10:%.*]] = sext i8 [[CONV9]] to i32
// CHECK2-NEXT:    [[CONV11:%.*]] = bytecast exact b8 57 to i8
// CHECK2-NEXT:    [[CONV12:%.*]] = sext i8 [[CONV11]] to i32
// CHECK2-NEXT:    [[CMP:%.*]] = icmp sle i32 [[CONV10]], [[CONV12]]
// CHECK2-NEXT:    br i1 [[CMP]], label [[OMP_PRECOND_THEN:%.*]], label [[OMP_PRECOND_END:%.*]]
// CHECK2:       omp.precond.then:
// CHECK2-NEXT:    store i64 0, ptr [[DOTOMP_LB]], align 8
...
// CHECK2-NEXT:    store i64 1, ptr [[DOTOMP_STRIDE]], align 8
// CHECK2-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK2-NEXT:    [[TMP11:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_2]], align 8
// CHECK2-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    [[TMP13:%.*]] = load i32, ptr [[TMP12]], align 4
// CHECK2-NEXT:    call void @__kmpc_dispatch_init_8(ptr @[[GLOB2]], i32 [[TMP13]], i32 38, i64 0, i64 [[TMP11]], i64 1, i64 1)
// CHECK2-NEXT:    br label [[OMP_DISPATCH_COND:%.*]]
// CHECK2:       omp.dispatch.cond:
// CHECK2-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    [[TMP15:%.*]] = load i32, ptr [[TMP14]], align 4
// CHECK2-NEXT:    [[TMP16:%.*]] = call i32 @__kmpc_dispatch_next_8(ptr @[[GLOB2]], i32 [[TMP15]], ptr [[DOTOMP_IS_LAST]], ptr [[DOTOMP_LB]], ptr [[DOTOMP_UB]], ptr [[DOTOMP_STRIDE]])
// CHECK2-NEXT:    [[TOBOOL:%.*]] = icmp ne i32 [[TMP16]], 0
// CHECK2-NEXT:    br i1 [[TOBOOL]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]]
// CHECK2:       omp.dispatch.body:
// CHECK2-NEXT:    [[TMP17:%.*]] = load i64, ptr [[DOTOMP_LB]], align 8
// CHECK2-NEXT:    store i64 [[TMP17]], ptr [[DOTOMP_IV]], align 8
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK2:       omp.inner.for.cond:
// CHECK2-NEXT:    [[TMP18:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP11:![0-9]+]]
// CHECK2-NEXT:    [[TMP19:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[CMP15:%.*]] = icmp sle i64 [[TMP18]], [[TMP19]]
// CHECK2-NEXT:    br i1 [[CMP15]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK2:       omp.inner.for.body:
// CHECK2-NEXT:    [[TMP20:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[CONV16:%.*]] = bytecast exact b8 [[TMP20]] to i8
// CHECK2-NEXT:    [[CONV17:%.*]] = sext i8 [[CONV16]] to i64
// CHECK2-NEXT:    [[TMP21:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[DIV18:%.*]] = sdiv i64 [[TMP21]], 11
// CHECK2-NEXT:    [[MUL19:%.*]] = mul nsw i64 [[DIV18]], 1
// CHECK2-NEXT:    [[ADD20:%.*]] = add nsw i64 [[CONV17]], [[MUL19]]
// CHECK2-NEXT:    [[CONV21:%.*]] = trunc i64 [[ADD20]] to i8
// CHECK2-NEXT:    [[TMP22:%.*]] = bitcast i8 [[CONV21]] to b8
// CHECK2-NEXT:    store b8 [[TMP22]], ptr [[I13]], align 1, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[TMP23:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[TMP24:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[DIV22:%.*]] = sdiv i64 [[TMP24]], 11
// CHECK2-NEXT:    [[MUL23:%.*]] = mul nsw i64 [[DIV22]], 11
// CHECK2-NEXT:    [[SUB24:%.*]] = sub nsw i64 [[TMP23]], [[MUL23]]
// CHECK2-NEXT:    [[MUL25:%.*]] = mul nsw i64 [[SUB24]], 1
// CHECK2-NEXT:    [[SUB26:%.*]] = sub nsw i64 11, [[MUL25]]
// CHECK2-NEXT:    [[CONV27:%.*]] = trunc i64 [[SUB26]] to i32
// CHECK2-NEXT:    store i32 [[CONV27]], ptr [[X14]], align 4, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[TMP2]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[TMP26:%.*]] = load b8, ptr [[I13]], align 1, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[IDXPROM:%.*]] = bytecast exact b8 [[TMP26]] to i8
// CHECK2-NEXT:    [[IDXPROM28:%.*]] = sext i8 [[IDXPROM]] to i64
// CHECK2-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds float, ptr [[TMP25]], i64 [[IDXPROM28]]
// CHECK2-NEXT:    [[TMP27:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[TMP28:%.*]] = load ptr, ptr [[TMP3]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[TMP29:%.*]] = load b8, ptr [[I13]], align 1, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[IDXPROM29:%.*]] = bytecast exact b8 [[TMP29]] to i8
// CHECK2-NEXT:    [[IDXPROM30:%.*]] = sext i8 [[IDXPROM29]] to i64
// CHECK2-NEXT:    [[ARRAYIDX31:%.*]] = getelementptr inbounds float, ptr [[TMP28]], i64 [[IDXPROM30]]
// CHECK2-NEXT:    [[TMP30:%.*]] = load float, ptr [[ARRAYIDX31]], align 4, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[MUL32:%.*]] = fmul float [[TMP27]], [[TMP30]]
// CHECK2-NEXT:    [[TMP31:%.*]] = load ptr, ptr [[TMP4]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[TMP32:%.*]] = load b8, ptr [[I13]], align 1, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[IDXPROM33:%.*]] = bytecast exact b8 [[TMP32]] to i8
// CHECK2-NEXT:    [[IDXPROM34:%.*]] = sext i8 [[IDXPROM33]] to i64
// CHECK2-NEXT:    [[ARRAYIDX35:%.*]] = getelementptr inbounds float, ptr [[TMP31]], i64 [[IDXPROM34]]
// CHECK2-NEXT:    [[TMP33:%.*]] = load float, ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[MUL36:%.*]] = fmul float [[MUL32]], [[TMP33]]
// CHECK2-NEXT:    [[TMP34:%.*]] = load ptr, ptr [[TMP1]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[TMP35:%.*]] = load b8, ptr [[I13]], align 1, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[IDXPROM37:%.*]] = bytecast exact b8 [[TMP35]] to i8
// CHECK2-NEXT:    [[IDXPROM38:%.*]] = sext i8 [[IDXPROM37]] to i64
// CHECK2-NEXT:    [[ARRAYIDX39:%.*]] = getelementptr inbounds float, ptr [[TMP34]], i64 [[IDXPROM38]]
// CHECK2-NEXT:    store float [[MUL36]], ptr [[ARRAYIDX39]], align 4, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK2:       omp.body.continue:
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK2:       omp.inner.for.inc:
// CHECK2-NEXT:    [[TMP36:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK2-NEXT:    [[ADD40:%.*]] = add nsw i64 [[TMP36]], 1
// CHECK2-NEXT:    store i64 [[ADD40]], ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP11]]
...
// CHECK2-NEXT:    br label [[OMP_DISPATCH_COND]]
// CHECK2:       omp.dispatch.end:
// CHECK2-NEXT:    [[TMP37:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    [[TMP38:%.*]] = load i32, ptr [[TMP37]], align 4
// CHECK2-NEXT:    call void @__kmpc_dispatch_deinit(ptr @[[GLOB2]], i32 [[TMP38]])
// CHECK2-NEXT:    br label [[OMP_PRECOND_END]]
// CHECK2:       omp.precond.end:
// CHECK2-NEXT:    ret void
//
...
// CHECK2-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[D_ADDR]], align 8
// CHECK2-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK2-NEXT:    [[CONV:%.*]] = bytecast exact b8 57 to i8
// CHECK2-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
// CHECK2-NEXT:    [[CONV3:%.*]] = bytecast exact b8 48 to i8
// CHECK2-NEXT:    [[CONV4:%.*]] = sext i8 [[CONV3]] to i32
// CHECK2-NEXT:    [[SUB:%.*]] = sub nsw i32 [[CONV4]], 1
// CHECK2-NEXT:    [[SUB5:%.*]] = sub nsw i32 [[CONV2]], [[SUB]]
// CHECK2-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB5]], 1
// CHECK2-NEXT:    [[MUL:%.*]] = mul nsw i32 [[DIV]], 20
// CHECK2-NEXT:    [[SUB6:%.*]] = sub nsw i32 [[MUL]], 1
// CHECK2-NEXT:    store i32 [[SUB6]], ptr [[DOTOMP_UB]], align 4
// CHECK2-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4
// CHECK2-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK2-NEXT:    [[CONV7:%.*]] = bytecast exact b8 57 to i8
// CHECK2-NEXT:    [[CONV8:%.*]] = sext i8 [[CONV7]] to i32
// CHECK2-NEXT:    [[CONV9:%.*]] = bytecast exact b8 48 to i8
// CHECK2-NEXT:    [[CONV10:%.*]] = sext i8 [[CONV9]] to i32
// CHECK2-NEXT:    [[SUB11:%.*]] = sub nsw i32 [[CONV10]], 1
// CHECK2-NEXT:    [[SUB12:%.*]] = sub nsw i32 [[CONV8]], [[SUB11]]
// CHECK2-NEXT:    [[DIV13:%.*]] = sdiv i32 [[SUB12]], 1
// CHECK2-NEXT:    [[MUL14:%.*]] = mul nsw i32 [[DIV13]], 20
// CHECK2-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[MUL14]], 1
// CHECK2-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    [[TMP5:%.*]] = load i32, ptr [[TMP4]], align 4
// CHECK2-NEXT:    call void @__kmpc_dispatch_init_4(ptr @[[GLOB2]], i32 [[TMP5]], i32 37, i32 0, i32 [[SUB15]], i32 1, i32 1)
// CHECK2-NEXT:    br label [[OMP_DISPATCH_COND:%.*]]
// CHECK2:       omp.dispatch.cond:
...
// CHECK2-NEXT:    br i1 [[CMP]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK2:       omp.inner.for.body:
// CHECK2-NEXT:    [[CONV16:%.*]] = bytecast exact b8 48 to i8
// CHECK2-NEXT:    [[CONV17:%.*]] = sext i8 [[CONV16]] to i32
// CHECK2-NEXT:    [[TMP10:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK2-NEXT:    [[DIV18:%.*]] = sdiv i32 [[TMP10]], 20
// CHECK2-NEXT:    [[MUL19:%.*]] = mul nsw i32 [[DIV18]], 1
// CHECK2-NEXT:    [[ADD:%.*]] = add nsw i32 [[CONV17]], [[MUL19]]
// CHECK2-NEXT:    [[CONV20:%.*]] = trunc i32 [[ADD]] to i8
// CHECK2-NEXT:    [[TMP11:%.*]] = bitcast i8 [[CONV20]] to b8
// CHECK2-NEXT:    store b8 [[TMP11]], ptr [[I]], align 1, !llvm.access.group [[ACC_GRP14]]
// CHECK2-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK2-NEXT:    [[TMP13:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK2-NEXT:    [[DIV21:%.*]] = sdiv i32 [[TMP13]], 20
// CHECK2-NEXT:    [[MUL22:%.*]] = mul nsw i32 [[DIV21]], 20
// CHECK2-NEXT:    [[SUB23:%.*]] = sub nsw i32 [[TMP12]], [[MUL22]]
// CHECK2-NEXT:    [[MUL24:%.*]] = mul nsw i32 [[SUB23]], 1
// CHECK2-NEXT:    [[ADD25:%.*]] = add nsw i32 -10, [[MUL24]]
// CHECK2-NEXT:    store i32 [[ADD25]], ptr [[X]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK2-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[TMP1]], align 8, !llvm.access.group [[ACC_GRP14]]
// CHECK2-NEXT:    [[TMP15:%.*]] = load b8, ptr [[I]], align 1, !llvm.access.group [[ACC_GRP14]]
// CHECK2-NEXT:    [[IDXPROM:%.*]] = bytecast exact b8 [[TMP15]] to i8
// CHECK2-NEXT:    [[IDXPROM26:%.*]] = zext i8 [[IDXPROM]] to i64
// CHECK2-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw float, ptr [[TMP14]], i64 [[IDXPROM26]]
// CHECK2-NEXT:    [[TMP16:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK2-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[TMP2]], align 8, !llvm.access.group [[ACC_GRP14]]
// CHECK2-NEXT:    [[TMP18:%.*]] = load b8, ptr [[I]], align 1, !llvm.access.group [[ACC_GRP14]]
// CHECK2-NEXT:    [[IDXPROM27:%.*]] = bytecast exact b8 [[TMP18]] to i8
// CHECK2-NEXT:    [[IDXPROM28:%.*]] = zext i8 [[IDXPROM27]] to i64
// CHECK2-NEXT:    [[ARRAYIDX29:%.*]] = getelementptr inbounds nuw float, ptr [[TMP17]], i64 [[IDXPROM28]]
// CHECK2-NEXT:    [[TMP19:%.*]] = load float, ptr [[ARRAYIDX29]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK2-NEXT:    [[MUL30:%.*]] = fmul float [[TMP16]], [[TMP19]]
// CHECK2-NEXT:    [[TMP20:%.*]] = load ptr, ptr [[TMP3]], align 8, !llvm.access.group [[ACC_GRP14]]
// CHECK2-NEXT:    [[TMP21:%.*]] = load b8, ptr [[I]], align 1, !llvm.access.group [[ACC_GRP14]]
// CHECK2-NEXT:    [[IDXPROM31:%.*]] = bytecast exact b8 [[TMP21]] to i8
// CHECK2-NEXT:    [[IDXPROM32:%.*]] = zext i8 [[IDXPROM31]] to i64
// CHECK2-NEXT:    [[ARRAYIDX33:%.*]] = getelementptr inbounds nuw float, ptr [[TMP20]], i64 [[IDXPROM32]]
// CHECK2-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX33]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK2-NEXT:    [[MUL34:%.*]] = fmul float [[MUL30]], [[TMP22]]
// CHECK2-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[TMP0]], align 8, !llvm.access.group [[ACC_GRP14]]
// CHECK2-NEXT:    [[TMP24:%.*]] = load b8, ptr [[I]], align 1, !llvm.access.group [[ACC_GRP14]]
// CHECK2-NEXT:    [[IDXPROM35:%.*]] = bytecast exact b8 [[TMP24]] to i8
// CHECK2-NEXT:    [[IDXPROM36:%.*]] = zext i8 [[IDXPROM35]] to i64
// CHECK2-NEXT:    [[ARRAYIDX37:%.*]] = getelementptr inbounds nuw float, ptr [[TMP23]], i64 [[IDXPROM36]]
// CHECK2-NEXT:    store float [[MUL34]], ptr [[ARRAYIDX37]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK2-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK2:       omp.body.continue:
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK2:       omp.inner.for.inc:
// CHECK2-NEXT:    [[TMP25:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK2-NEXT:    [[ADD38:%.*]] = add nsw i32 [[TMP25]], 1
// CHECK2-NEXT:    store i32 [[ADD38]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP14]]
...
// CHECK5-NEXT:    [[CONV:%.*]] = fptoui double [[TMP0]] to i8, !dbg [[DBG11]]
// CHECK5-NEXT:    [[CONV1:%.*]] = bitcast i8 [[CONV]] to b8, !dbg [[DBG11]]
// CHECK5-NEXT:    store b8 [[CONV1]], ptr [[DOTCAPTURE_EXPR_]], align 1, !dbg [[DBG11]]
// CHECK5-NEXT:    [[TMP1:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !dbg [[DBG11]]
// CHECK5-NEXT:    store b8 [[TMP1]], ptr [[DOTCAPTURE_EXPR__CASTED]], align 1, !dbg [[DBG11]]
...
// CHECK5-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR__ADDR]], align 1, !dbg [[DBG15]]
// CHECK5-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP4]] to i8, !dbg [[DBG15]]
// CHECK5-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i64, !dbg [[DBG15]]
// CHECK5-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !dbg [[DBG15]]
// CHECK5-NEXT:    [[TMP6:%.*]] = load i32, ptr [[TMP5]], align 4, !dbg [[DBG15]]
// CHECK5-NEXT:    call void @__kmpc_for_static_init_8u(ptr @[[GLOB1:[0-9]+]], i32 [[TMP6]], i32 33, ptr [[DOTOMP_IS_LAST]], ptr [[DOTOMP_LB]], ptr [[DOTOMP_UB]], ptr [[DOTOMP_STRIDE]], i64 1, i64 [[CONV6]]), !dbg [[DBG15]]
...
// CHECK5-NEXT:    br i1 [[CMP9]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]], !dbg [[DBG15]]
...
// CHECK5-NEXT:    br i1 [[CMP11]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]], !dbg [[DBG15]]
...
// CHECK5-NEXT:    store i64 [[ADD12]], ptr [[I4]], align 8, !dbg [[DBG14]]
...
// CHECK5-NEXT:    store i64 [[ADD13]], ptr [[DOTOMP_IV]], align 8, !dbg [[DBG14]]
...
// CHECK5-NEXT:    store i64 [[ADD14]], ptr [[DOTOMP_LB]], align 8, !dbg [[DBG14]]
...
// CHECK5-NEXT:    store i64 [[ADD15]], ptr [[DOTOMP_UB]], align 8, !dbg [[DBG14]]
...
// CHECK5-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i64, align 8
// CHECK5-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK5-NEXT:    [[I13:%.*]] = alloca b8, align 1
// CHECK5-NEXT:    [[X14:%.*]] = alloca i32, align 4
// CHECK5-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK5-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 8
...
// CHECK5-NEXT:    [[TMP6:%.*]] = bitcast i8 [[CONV]] to b8, !dbg [[DBG80]]
// CHECK5-NEXT:    store b8 [[TMP6]], ptr [[DOTCAPTURE_EXPR_]], align 1, !dbg [[DBG80]]
// CHECK5-NEXT:    [[CONV3:%.*]] = bytecast exact b8 57 to i8, !dbg [[DBG80]]
// CHECK5-NEXT:    [[CONV4:%.*]] = sext i8 [[CONV3]] to i32, !dbg [[DBG80]]
// CHECK5-NEXT:    [[TMP7:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !dbg [[DBG80]]
// CHECK5-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP7]] to i8, !dbg [[DBG80]]
// CHECK5-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32, !dbg [[DBG80]]
// CHECK5-NEXT:    [[SUB:%.*]] = sub i32 [[CONV4]], [[CONV6]], !dbg [[DBG80]]
// CHECK5-NEXT:    [[ADD:%.*]] = add i32 [[SUB]], 1, !dbg [[DBG80]]
// CHECK5-NEXT:    [[DIV:%.*]] = udiv i32 [[ADD]], 1, !dbg [[DBG80]]
// CHECK5-NEXT:    [[CONV7:%.*]] = zext i32 [[DIV]] to i64, !dbg [[DBG80]]
// CHECK5-NEXT:    [[MUL:%.*]] = mul nsw i64 [[CONV7]], 11, !dbg [[DBG81:![0-9]+]]
// CHECK5-NEXT:    [[SUB8:%.*]] = sub nsw i64 [[MUL]], 1, !dbg [[DBG81]]
// CHECK5-NEXT:    store i64 [[SUB8]], ptr [[DOTCAPTURE_EXPR_2]], align 8, !dbg [[DBG80]]
// CHECK5-NEXT:    [[TMP8:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !dbg [[DBG80]]
// CHECK5-NEXT:    store b8 [[TMP8]], ptr [[I]], align 1, !dbg [[DBG80]]
// CHECK5-NEXT:    store i32 11, ptr [[X]], align 4, !dbg [[DBG81]]
// CHECK5-NEXT:    [[TMP9:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !dbg [[DBG80]]
// CHECK5-NEXT:    [[CONV9:%.*]] = bytecast exact b8 [[TMP9]] to i8, !dbg [[DBG80]]
// CHECK5-NEXT:    [[CONV10:%.*]] = sext i8 [[CONV9]] to i32, !dbg [[DBG80]]
// CHECK5-NEXT:    [[CONV11:%.*]] = bytecast exact b8 57 to i8, !dbg [[DBG80]]
// CHECK5-NEXT:    [[CONV12:%.*]] = sext i8 [[CONV11]] to i32, !dbg [[DBG80]]
// CHECK5-NEXT:    [[CMP:%.*]] = icmp sle i32 [[CONV10]], [[CONV12]], !dbg [[DBG80]]
...
// CHECK5-NEXT:    store i64 [[TMP10]], ptr [[DOTOMP_UB]], align 8, !dbg [[DBG80]]
// CHECK5-NEXT:    store i64 1, ptr [[DOTOMP_STRIDE]], align 8, !dbg [[DBG80]]
// CHECK5-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4, !dbg [[DBG80]]
// CHECK5-NEXT:    [[TMP11:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_2]], align 8, !dbg [[DBG81]]
// CHECK5-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !dbg [[DBG79]]
// CHECK5-NEXT:    [[TMP13:%.*]] = load i32, ptr [[TMP12]], align 4, !dbg [[DBG79]]
// CHECK5-NEXT:    call void @__kmpc_dispatch_init_8(ptr @[[GLOB25]], i32 [[TMP13]], i32 1073741862, i64 0, i64 [[TMP11]], i64 1, i64 1), !dbg [[DBG79]]
// CHECK5-NEXT:    br label [[OMP_DISPATCH_COND:%.*]], !dbg [[DBG79]]
// CHECK5:       omp.dispatch.cond:
// CHECK5-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !dbg [[DBG79]]
// CHECK5-NEXT:    [[TMP15:%.*]] = load i32, ptr [[TMP14]], align 4, !dbg [[DBG79]]
// CHECK5-NEXT:    [[TMP16:%.*]] = call i32 @__kmpc_dispatch_next_8(ptr @[[GLOB25]], i32 [[TMP15]], ptr [[DOTOMP_IS_LAST]], ptr [[DOTOMP_LB]], ptr [[DOTOMP_UB]], ptr [[DOTOMP_STRIDE]]), !dbg [[DBG79]]
// CHECK5-NEXT:    [[TOBOOL:%.*]] = icmp ne i32 [[TMP16]], 0, !dbg [[DBG79]]
// CHECK5-NEXT:    br i1 [[TOBOOL]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]], !dbg [[DBG79]]
// CHECK5:       omp.dispatch.body:
// CHECK5-NEXT:    [[TMP17:%.*]] = load i64, ptr [[DOTOMP_LB]], align 8, !dbg [[DBG80]]
// CHECK5-NEXT:    store i64 [[TMP17]], ptr [[DOTOMP_IV]], align 8, !dbg [[DBG80]]
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]], !dbg [[DBG79]]
// CHECK5:       omp.inner.for.cond:
// CHECK5-NEXT:    [[TMP18:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !dbg [[DBG80]], !llvm.access.group [[ACC_GRP82:![0-9]+]]
// CHECK5-NEXT:    [[TMP19:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !dbg [[DBG80]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[CMP15:%.*]] = icmp sle i64 [[TMP18]], [[TMP19]], !dbg [[DBG80]]
// CHECK5-NEXT:    br i1 [[CMP15]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]], !dbg [[DBG79]]
// CHECK5:       omp.inner.for.body:
// CHECK5-NEXT:    [[TMP20:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !dbg [[DBG80]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[CONV16:%.*]] = bytecast exact b8 [[TMP20]] to i8, !dbg [[DBG80]]
// CHECK5-NEXT:    [[CONV17:%.*]] = sext i8 [[CONV16]] to i64, !dbg [[DBG80]]
// CHECK5-NEXT:    [[TMP21:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !dbg [[DBG80]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[DIV18:%.*]] = sdiv i64 [[TMP21]], 11, !dbg [[DBG80]]
// CHECK5-NEXT:    [[MUL19:%.*]] = mul nsw i64 [[DIV18]], 1, !dbg [[DBG80]]
// CHECK5-NEXT:    [[ADD20:%.*]] = add nsw i64 [[CONV17]], [[MUL19]], !dbg [[DBG80]]
// CHECK5-NEXT:    [[CONV21:%.*]] = trunc i64 [[ADD20]] to i8, !dbg [[DBG80]]
// CHECK5-NEXT:    [[TMP22:%.*]] = bitcast i8 [[CONV21]] to b8, !dbg [[DBG80]]
// CHECK5-NEXT:    store b8 [[TMP22]], ptr [[I13]], align 1, !dbg [[DBG80]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[TMP23:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !dbg [[DBG80]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[TMP24:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !dbg [[DBG80]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[DIV22:%.*]] = sdiv i64 [[TMP24]], 11, !dbg [[DBG80]]
// CHECK5-NEXT:    [[MUL23:%.*]] = mul nsw i64 [[DIV22]], 11, !dbg [[DBG80]]
// CHECK5-NEXT:    [[SUB24:%.*]] = sub nsw i64 [[TMP23]], [[MUL23]], !dbg [[DBG80]]
// CHECK5-NEXT:    [[MUL25:%.*]] = mul nsw i64 [[SUB24]], 1, !dbg [[DBG81]]
// CHECK5-NEXT:    [[SUB26:%.*]] = sub nsw i64 11, [[MUL25]], !dbg [[DBG81]]
// CHECK5-NEXT:    [[CONV27:%.*]] = trunc i64 [[SUB26]] to i32, !dbg [[DBG81]]
// CHECK5-NEXT:    store i32 [[CONV27]], ptr [[X14]], align 4, !dbg [[DBG81]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[TMP2]], align 8, !dbg [[DBG83:![0-9]+]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[TMP26:%.*]] = load b8, ptr [[I13]], align 1, !dbg [[DBG83]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[IDXPROM:%.*]] = bytecast exact b8 [[TMP26]] to i8, !dbg [[DBG83]]
// CHECK5-NEXT:    [[IDXPROM28:%.*]] = sext i8 [[IDXPROM]] to i64, !dbg [[DBG83]]
// CHECK5-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds float, ptr [[TMP25]], i64 [[IDXPROM28]], !dbg [[DBG83]]
// CHECK5-NEXT:    [[TMP27:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !dbg [[DBG83]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[TMP28:%.*]] = load ptr, ptr [[TMP3]], align 8, !dbg [[DBG83]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[TMP29:%.*]] = load b8, ptr [[I13]], align 1, !dbg [[DBG83]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[IDXPROM29:%.*]] = bytecast exact b8 [[TMP29]] to i8, !dbg [[DBG83]]
// CHECK5-NEXT:    [[IDXPROM30:%.*]] = sext i8 [[IDXPROM29]] to i64, !dbg [[DBG83]]
// CHECK5-NEXT:    [[ARRAYIDX31:%.*]] = getelementptr inbounds float, ptr [[TMP28]], i64 [[IDXPROM30]], !dbg [[DBG83]]
// CHECK5-NEXT:    [[TMP30:%.*]] = load float, ptr [[ARRAYIDX31]], align 4, !dbg [[DBG83]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[MUL32:%.*]] = fmul float [[TMP27]], [[TMP30]], !dbg [[DBG83]]
// CHECK5-NEXT:    [[TMP31:%.*]] = load ptr, ptr [[TMP4]], align 8, !dbg [[DBG83]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[TMP32:%.*]] = load b8, ptr [[I13]], align 1, !dbg [[DBG83]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[IDXPROM33:%.*]] = bytecast exact b8 [[TMP32]] to i8, !dbg [[DBG83]]
// CHECK5-NEXT:    [[IDXPROM34:%.*]] = sext i8 [[IDXPROM33]] to i64, !dbg [[DBG83]]
// CHECK5-NEXT:    [[ARRAYIDX35:%.*]] = getelementptr inbounds float, ptr [[TMP31]], i64 [[IDXPROM34]], !dbg [[DBG83]]
// CHECK5-NEXT:    [[TMP33:%.*]] = load float, ptr [[ARRAYIDX35]], align 4, !dbg [[DBG83]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[MUL36:%.*]] = fmul float [[MUL32]], [[TMP33]], !dbg [[DBG83]]
// CHECK5-NEXT:    [[TMP34:%.*]] = load ptr, ptr [[TMP1]], align 8, !dbg [[DBG83]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[TMP35:%.*]] = load b8, ptr [[I13]], align 1, !dbg [[DBG83]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[IDXPROM37:%.*]] = bytecast exact b8 [[TMP35]] to i8, !dbg [[DBG83]]
// CHECK5-NEXT:    [[IDXPROM38:%.*]] = sext i8 [[IDXPROM37]] to i64, !dbg [[DBG83]]
// CHECK5-NEXT:    [[ARRAYIDX39:%.*]] = getelementptr inbounds float, ptr [[TMP34]], i64 [[IDXPROM38]], !dbg [[DBG83]]
// CHECK5-NEXT:    store float [[MUL36]], ptr [[ARRAYIDX39]], align 4, !dbg [[DBG83]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]], !dbg [[DBG84:![0-9]+]]
// CHECK5:       omp.body.continue:
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]], !dbg [[DBG79]]
// CHECK5:       omp.inner.for.inc:
// CHECK5-NEXT:    [[TMP36:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !dbg [[DBG80]], !llvm.access.group [[ACC_GRP82]]
// CHECK5-NEXT:    [[ADD40:%.*]] = add nsw i64 [[TMP36]], 1, !dbg [[DBG80]]
// CHECK5-NEXT:    store i64 [[ADD40]], ptr [[DOTOMP_IV]], align 8, !dbg [[DBG80]], !llvm.access.group [[ACC_GRP82]]
...
// CHECK5:       omp.dispatch.end:
// CHECK5-NEXT:    [[TMP37:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !dbg [[DBG79]]
// CHECK5-NEXT:    [[TMP38:%.*]] = load i32, ptr [[TMP37]], align 4, !dbg [[DBG79]]
// CHECK5-NEXT:    call void @__kmpc_dispatch_deinit(ptr @[[GLOB25]], i32 [[TMP38]]), !dbg [[DBG79]]
...
// CHECK5-NEXT:    [[CONV:%.*]] = bytecast exact b8 57 to i8, !dbg [[DBG94]]
// CHECK5-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32, !dbg [[DBG94]]
// CHECK5-NEXT:    [[CONV3:%.*]] = bytecast exact b8 48 to i8, !dbg [[DBG94]]
// CHECK5-NEXT:    [[CONV4:%.*]] = sext i8 [[CONV3]] to i32, !dbg [[DBG94]]
// CHECK5-NEXT:    [[SUB:%.*]] = sub nsw i32 [[CONV4]], 1, !dbg [[DBG94]]
// CHECK5-NEXT:    [[SUB5:%.*]] = sub nsw i32 [[CONV2]], [[SUB]], !dbg [[DBG94]]
// CHECK5-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB5]], 1, !dbg [[DBG94]]
// CHECK5-NEXT:    [[MUL:%.*]] = mul nsw i32 [[DIV]], 20, !dbg [[DBG95:![0-9]+]]
// CHECK5-NEXT:    [[SUB6:%.*]] = sub nsw i32 [[MUL]], 1, !dbg [[DBG95]]
// CHECK5-NEXT:    store i32 [[SUB6]], ptr [[DOTOMP_UB]], align 4, !dbg [[DBG94]]
// CHECK5-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4, !dbg [[DBG94]]
// CHECK5-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4, !dbg [[DBG94]]
// CHECK5-NEXT:    [[CONV7:%.*]] = bytecast exact b8 57 to i8, !dbg [[DBG94]]
// CHECK5-NEXT:    [[CONV8:%.*]] = sext i8 [[CONV7]] to i32, !dbg [[DBG94]]
// CHECK5-NEXT:    [[CONV9:%.*]] = bytecast exact b8 48 to i8, !dbg [[DBG94]]
// CHECK5-NEXT:    [[CONV10:%.*]] = sext i8 [[CONV9]] to i32, !dbg [[DBG94]]
// CHECK5-NEXT:    [[SUB11:%.*]] = sub nsw i32 [[CONV10]], 1, !dbg [[DBG94]]
// CHECK5-NEXT:    [[SUB12:%.*]] = sub nsw i32 [[CONV8]], [[SUB11]], !dbg [[DBG94]]
// CHECK5-NEXT:    [[DIV13:%.*]] = sdiv i32 [[SUB12]], 1, !dbg [[DBG94]]
// CHECK5-NEXT:    [[MUL14:%.*]] = mul nsw i32 [[DIV13]], 20, !dbg [[DBG95]]
// CHECK5-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[MUL14]], 1, !dbg [[DBG95]]
// CHECK5-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !dbg [[DBG93]]
// CHECK5-NEXT:    [[TMP5:%.*]] = load i32, ptr [[TMP4]], align 4, !dbg [[DBG93]]
// CHECK5-NEXT:    call void @__kmpc_dispatch_init_4(ptr @[[GLOB27]], i32 [[TMP5]], i32 1073741861, i32 0, i32 [[SUB15]], i32 1, i32 1), !dbg [[DBG93]]
...
// CHECK5:       omp.inner.for.cond:
// CHECK5-NEXT:    [[TMP8:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !dbg [[DBG94]], !llvm.access.group [[ACC_GRP96:![0-9]+]]
// CHECK5-NEXT:    [[TMP9:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4, !dbg [[DBG94]], !llvm.access.group [[ACC_GRP96]]
...
// CHECK5:       omp.inner.for.body:
// CHECK5-NEXT:    [[CONV16:%.*]] = bytecast exact b8 48 to i8, !dbg [[DBG94]]
// CHECK5-NEXT:    [[CONV17:%.*]] = sext i8 [[CONV16]] to i32, !dbg [[DBG94]]
// CHECK5-NEXT:    [[TMP10:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !dbg [[DBG94]], !llvm.access.group [[ACC_GRP96]]
// CHECK5-NEXT:    [[DIV18:%.*]] = sdiv i32 [[TMP10]], 20, !dbg [[DBG94]]
// CHECK5-NEXT:    [[MUL19:%.*]] = mul nsw i32 [[DIV18]], 1, !dbg [[DBG94]]
// CHECK5-NEXT:    [[ADD:%.*]] = add nsw i32 [[CONV17]], [[MUL19]], !dbg [[DBG94]]
// CHECK5-NEXT:    [[CONV20:%.*]] = trunc i32 [[ADD]] to i8, !dbg [[DBG94]]
// CHECK5-NEXT:    [[TMP11:%.*]] = bitcast i8 [[CONV20]] to b8, !dbg [[DBG94]]
// CHECK5-NEXT:    store b8 [[TMP11]], ptr [[I]], align 1, !dbg [[DBG94]], !llvm.access.group [[ACC_GRP96]]
// CHECK5-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !dbg [[DBG94]], !llvm.access.group [[ACC_GRP96]]
// CHECK5-NEXT:    [[TMP13:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !dbg [[DBG94]], !llvm.access.group [[ACC_GRP96]]
// CHECK5-NEXT:    [[DIV21:%.*]] = sdiv i32 [[TMP13]], 20, !dbg [[DBG94]]
// CHECK5-NEXT:    [[MUL22:%.*]] = mul nsw i32 [[DIV21]], 20, !dbg [[DBG94]]
// CHECK5-NEXT:    [[SUB23:%.*]] = sub nsw i32 [[TMP12]], [[MUL22]], !dbg [[DBG94]]
// CHECK5-NEXT:    [[MUL24:%.*]] = mul nsw i32 [[SUB23]], 1, !dbg [[DBG95]]
// CHECK5-NEXT:    [[ADD25:%.*]] = add nsw i32 -10, [[MUL24]], !dbg [[DBG95]]
// CHECK5-NEXT:    store i32 [[ADD25]], ptr [[X]], align 4, !dbg [[DBG95]], !llvm.access.group [[ACC_GRP96]]
// CHECK5-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[TMP1]], align 8, !dbg [[DBG97:![0-9]+]], !llvm.access.group [[ACC_GRP96]]
// CHECK5-NEXT:    [[TMP15:%.*]] = load b8, ptr [[I]], align 1, !dbg [[DBG97]], !llvm.access.group [[ACC_GRP96]]
// CHECK5-NEXT:    [[IDXPROM:%.*]] = bytecast exact b8 [[TMP15]] to i8, !dbg [[DBG97]]
// CHECK5-NEXT:    [[IDXPROM26:%.*]] = zext i8 [[IDXPROM]] to i64, !dbg [[DBG97]]
// CHECK5-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw float, ptr [[TMP14]], i64 [[IDXPROM26]], !dbg [[DBG97]]
// CHECK5-NEXT:    [[TMP16:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !dbg [[DBG97]], !llvm.access.group [[ACC_GRP96]]
// CHECK5-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[TMP2]], align 8, !dbg [[DBG97]], !llvm.access.group [[ACC_GRP96]]
// CHECK5-NEXT:    [[TMP18:%.*]] = load b8, ptr [[I]], align 1, !dbg [[DBG97]], !llvm.access.group [[ACC_GRP96]]
// CHECK5-NEXT:    [[IDXPROM27:%.*]] = bytecast exact b8 [[TMP18]] to i8, !dbg [[DBG97]]
// CHECK5-NEXT:    [[IDXPROM28:%.*]] = zext i8 [[IDXPROM27]] to i64, !dbg [[DBG97]]
// CHECK5-NEXT:    [[ARRAYIDX29:%.*]] = getelementptr inbounds nuw float, ptr [[TMP17]], i64 [[IDXPROM28]], !dbg [[DBG97]]
// CHECK5-NEXT:    [[TMP19:%.*]] = load float, ptr [[ARRAYIDX29]], align 4, !dbg [[DBG97]], !llvm.access.group [[ACC_GRP96]]
// CHECK5-NEXT:    [[MUL30:%.*]] = fmul float [[TMP16]], [[TMP19]], !dbg [[DBG97]]
// CHECK5-NEXT:    [[TMP20:%.*]] = load ptr, ptr [[TMP3]], align 8, !dbg [[DBG97]], !llvm.access.group [[ACC_GRP96]]
// CHECK5-NEXT:    [[TMP21:%.*]] = load b8, ptr [[I]], align 1, !dbg [[DBG97]], !llvm.access.group [[ACC_GRP96]]
// CHECK5-NEXT:    [[IDXPROM31:%.*]] = bytecast exact b8 [[TMP21]] to i8, !dbg [[DBG97]]
// CHECK5-NEXT:    [[IDXPROM32:%.*]] = zext i8 [[IDXPROM31]] to i64, !dbg [[DBG97]]
// CHECK5-NEXT:    [[ARRAYIDX33:%.*]] = getelementptr inbounds nuw float, ptr [[TMP20]], i64 [[IDXPROM32]], !dbg [[DBG97]]
// CHECK5-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX33]], align 4, !dbg [[DBG97]], !llvm.access.group [[ACC_GRP96]]
// CHECK5-NEXT:    [[MUL34:%.*]] = fmul float [[MUL30]], [[TMP22]], !dbg [[DBG97]]
// CHECK5-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[TMP0]], align 8, !dbg [[DBG97]], !llvm.access.group [[ACC_GRP96]]
// CHECK5-NEXT:    [[TMP24:%.*]] = load b8, ptr [[I]], align 1, !dbg [[DBG97]], !llvm.access.group [[ACC_GRP96]]
// CHECK5-NEXT:    [[IDXPROM35:%.*]] = bytecast exact b8 [[TMP24]] to i8, !dbg [[DBG97]]
// CHECK5-NEXT:    [[IDXPROM36:%.*]] = zext i8 [[IDXPROM35]] to i64, !dbg [[DBG97]]
// CHECK5-NEXT:    [[ARRAYIDX37:%.*]] = getelementptr inbounds nuw float, ptr [[TMP23]], i64 [[IDXPROM36]], !dbg [[DBG97]]
// CHECK5-NEXT:    store float [[MUL34]], ptr [[ARRAYIDX37]], align 4, !dbg [[DBG97]], !llvm.access.group [[ACC_GRP96]]
// CHECK5-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]], !dbg [[DBG98:![0-9]+]]
// CHECK5:       omp.body.continue:
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]], !dbg [[DBG93]]
// CHECK5:       omp.inner.for.inc:
// CHECK5-NEXT:    [[TMP25:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !dbg [[DBG94]], !llvm.access.group [[ACC_GRP96]]
// CHECK5-NEXT:    [[ADD38:%.*]] = add nsw i32 [[TMP25]], 1, !dbg [[DBG94]]
// CHECK5-NEXT:    store i32 [[ADD38]], ptr [[DOTOMP_IV]], align 4, !dbg [[DBG94]], !llvm.access.group [[ACC_GRP96]]
...
// CHECK6-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
...
// CHECK6-NEXT:    [[CONV:%.*]] = fptoui double [[TMP0]] to i8
// CHECK6-NEXT:    [[CONV1:%.*]] = bitcast i8 [[CONV]] to b8
// CHECK6-NEXT:    store b8 [[CONV1]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK6-NEXT:    [[TMP1:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK6-NEXT:    store b8 [[TMP1]], ptr [[DOTCAPTURE_EXPR__CASTED]], align 1
...
// CHECK6-NEXT:    [[TMP4:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR__ADDR]], align 1
// CHECK6-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP4]] to i8
// CHECK6-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i64
// CHECK6-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK6-NEXT:    [[TMP6:%.*]] = load i32, ptr [[TMP5]], align 4
// CHECK6-NEXT:    call void @__kmpc_for_static_init_8u(ptr @[[GLOB1:[0-9]+]], i32 [[TMP6]], i32 33, ptr [[DOTOMP_IS_LAST]], ptr [[DOTOMP_LB]], ptr [[DOTOMP_UB]], ptr [[DOTOMP_STRIDE]], i64 1, i64 [[CONV6]])
...
// CHECK6-NEXT:    store i64 [[ADD12]], ptr [[I4]], align 8
...
// CHECK6-NEXT:    store i64 [[ADD13]], ptr [[DOTOMP_IV]], align 8
// CHECK6-NEXT:    br label [[OMP_INNER_FOR_COND]]
...
// CHECK6-NEXT:    store i64 [[ADD14]], ptr [[DOTOMP_LB]], align 8
...
// CHECK6-NEXT:    store i64 [[ADD15]], ptr [[DOTOMP_UB]], align 8
// CHECK6-NEXT:    br label [[OMP_DISPATCH_COND]]
...
// CHECK6-NEXT:    [[D_ADDR:%.*]] = alloca ptr, align 8
// CHECK6-NEXT:    [[DOTOMP_IV:%.*]] = alloca i64, align 8
// CHECK6-NEXT:    [[TMP:%.*]] = alloca b8, align 1
// CHECK6-NEXT:    [[_TMP1:%.*]] = alloca i32, align 4
// CHECK6-NEXT:    [[DOTCAPTURE_EXPR_:%.*]] = alloca b8, align 1
// CHECK6-NEXT:    [[DOTCAPTURE_EXPR_2:%.*]] = alloca i64, align 8
// CHECK6-NEXT:    [[I:%.*]] = alloca b8, align 1
// CHECK6-NEXT:    [[X:%.*]] = alloca i32, align 4
// CHECK6-NEXT:    [[DOTOMP_LB:%.*]] = alloca i64, align 8
// CHECK6-NEXT:    [[DOTOMP_UB:%.*]] = alloca i64, align 8
// CHECK6-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i64, align 8
// CHECK6-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK6-NEXT:    [[I13:%.*]] = alloca b8, align 1
// CHECK6-NEXT:    [[X14:%.*]] = alloca i32, align 4
// CHECK6-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK6-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 8
...
// CHECK6-NEXT:    [[TMP6:%.*]] = bitcast i8 [[CONV]] to b8
// CHECK6-NEXT:    store b8 [[TMP6]], ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK6-NEXT:    [[CONV3:%.*]] = bytecast exact b8 57 to i8
// CHECK6-NEXT:    [[CONV4:%.*]] = sext i8 [[CONV3]] to i32
// CHECK6-NEXT:    [[TMP7:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK6-NEXT:    [[CONV5:%.*]] = bytecast exact b8 [[TMP7]] to i8
// CHECK6-NEXT:    [[CONV6:%.*]] = sext i8 [[CONV5]] to i32
// CHECK6-NEXT:    [[SUB:%.*]] = sub i32 [[CONV4]], [[CONV6]]
// CHECK6-NEXT:    [[ADD:%.*]] = add i32 [[SUB]], 1
// CHECK6-NEXT:    [[DIV:%.*]] = udiv i32 [[ADD]], 1
// CHECK6-NEXT:    [[CONV7:%.*]] = zext i32 [[DIV]] to i64
// CHECK6-NEXT:    [[MUL:%.*]] = mul nsw i64 [[CONV7]], 11
// CHECK6-NEXT:    [[SUB8:%.*]] = sub nsw i64 [[MUL]], 1
// CHECK6-NEXT:    store i64 [[SUB8]], ptr [[DOTCAPTURE_EXPR_2]], align 8
// CHECK6-NEXT:    [[TMP8:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK6-NEXT:    store b8 [[TMP8]], ptr [[I]], align 1
// CHECK6-NEXT:    store i32 11, ptr [[X]], align 4
// CHECK6-NEXT:    [[TMP9:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1
// CHECK6-NEXT:    [[CONV9:%.*]] = bytecast exact b8 [[TMP9]] to i8
// CHECK6-NEXT:    [[CONV10:%.*]] = sext i8 [[CONV9]] to i32
// CHECK6-NEXT:    [[CONV11:%.*]] = bytecast exact b8 57 to i8
// CHECK6-NEXT:    [[CONV12:%.*]] = sext i8 [[CONV11]] to i32
// CHECK6-NEXT:    [[CMP:%.*]] = icmp sle i32 [[CONV10]], [[CONV12]]
// CHECK6-NEXT:    br i1 [[CMP]], label [[OMP_PRECOND_THEN:%.*]], label [[OMP_PRECOND_END:%.*]]
// CHECK6:       omp.precond.then:
// CHECK6-NEXT:    store i64 0, ptr [[DOTOMP_LB]], align 8
// CHECK6-NEXT:    [[TMP10:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_2]], align 8
// CHECK6-NEXT:    store i64 [[TMP10]], ptr [[DOTOMP_UB]], align 8
// CHECK6-NEXT:    store i64 1, ptr [[DOTOMP_STRIDE]], align 8
// CHECK6-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK6-NEXT:    [[TMP11:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_2]], align 8
// CHECK6-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK6-NEXT:    [[TMP13:%.*]] = load i32, ptr [[TMP12]], align 4
// CHECK6-NEXT:    call void @__kmpc_dispatch_init_8(ptr @[[GLOB2]], i32 [[TMP13]], i32 1073741862, i64 0, i64 [[TMP11]], i64 1, i64 1)
// CHECK6-NEXT:    br label [[OMP_DISPATCH_COND:%.*]]
// CHECK6:       omp.dispatch.cond:
// CHECK6-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK6-NEXT:    [[TMP15:%.*]] = load i32, ptr [[TMP14]], align 4
// CHECK6-NEXT:    [[TMP16:%.*]] = call i32 @__kmpc_dispatch_next_8(ptr @[[GLOB2]], i32 [[TMP15]], ptr [[DOTOMP_IS_LAST]], ptr [[DOTOMP_LB]], ptr [[DOTOMP_UB]], ptr [[DOTOMP_STRIDE]])
// CHECK6-NEXT:    [[TOBOOL:%.*]] = icmp ne i32 [[TMP16]], 0
// CHECK6-NEXT:    br i1 [[TOBOOL]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]]
// CHECK6:       omp.dispatch.body:
// CHECK6-NEXT:    [[TMP17:%.*]] = load i64, ptr [[DOTOMP_LB]], align 8
// CHECK6-NEXT:    store i64 [[TMP17]], ptr [[DOTOMP_IV]], align 8
// CHECK6-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK6:       omp.inner.for.cond:
// CHECK6-NEXT:    [[TMP18:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP11:![0-9]+]]
// CHECK6-NEXT:    [[TMP19:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[CMP15:%.*]] = icmp sle i64 [[TMP18]], [[TMP19]]
// CHECK6-NEXT:    br i1 [[CMP15]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK6:       omp.inner.for.body:
// CHECK6-NEXT:    [[TMP20:%.*]] = load b8, ptr [[DOTCAPTURE_EXPR_]], align 1, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[CONV16:%.*]] = bytecast exact b8 [[TMP20]] to i8
// CHECK6-NEXT:    [[CONV17:%.*]] = sext i8 [[CONV16]] to i64
// CHECK6-NEXT:    [[TMP21:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[DIV18:%.*]] = sdiv i64 [[TMP21]], 11
// CHECK6-NEXT:    [[MUL19:%.*]] = mul nsw i64 [[DIV18]], 1
// CHECK6-NEXT:    [[ADD20:%.*]] = add nsw i64 [[CONV17]], [[MUL19]]
// CHECK6-NEXT:    [[CONV21:%.*]] = trunc i64 [[ADD20]] to i8
// CHECK6-NEXT:    [[TMP22:%.*]] = bitcast i8 [[CONV21]] to b8
// CHECK6-NEXT:    store b8 [[TMP22]], ptr [[I13]], align 1, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[TMP23:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[TMP24:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[DIV22:%.*]] = sdiv i64 [[TMP24]], 11
// CHECK6-NEXT:    [[MUL23:%.*]] = mul nsw i64 [[DIV22]], 11
// CHECK6-NEXT:    [[SUB24:%.*]] = sub nsw i64 [[TMP23]], [[MUL23]]
// CHECK6-NEXT:    [[MUL25:%.*]] = mul nsw i64 [[SUB24]], 1
// CHECK6-NEXT:    [[SUB26:%.*]] = sub nsw i64 11, [[MUL25]]
// CHECK6-NEXT:    [[CONV27:%.*]] = trunc i64 [[SUB26]] to i32
// CHECK6-NEXT:    store i32 [[CONV27]], ptr [[X14]], align 4, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[TMP2]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[TMP26:%.*]] = load b8, ptr [[I13]], align 1, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[IDXPROM:%.*]] = bytecast exact b8 [[TMP26]] to i8
// CHECK6-NEXT:    [[IDXPROM28:%.*]] = sext i8 [[IDXPROM]] to i64
// CHECK6-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds float, ptr [[TMP25]], i64 [[IDXPROM28]]
// CHECK6-NEXT:    [[TMP27:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[TMP28:%.*]] = load ptr, ptr [[TMP3]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[TMP29:%.*]] = load b8, ptr [[I13]], align 1, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[IDXPROM29:%.*]] = bytecast exact b8 [[TMP29]] to i8
// CHECK6-NEXT:    [[IDXPROM30:%.*]] = sext i8 [[IDXPROM29]] to i64
// CHECK6-NEXT:    [[ARRAYIDX31:%.*]] = getelementptr inbounds float, ptr [[TMP28]], i64 [[IDXPROM30]]
// CHECK6-NEXT:    [[TMP30:%.*]] = load float, ptr [[ARRAYIDX31]], align 4, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[MUL32:%.*]] = fmul float [[TMP27]], [[TMP30]]
// CHECK6-NEXT:    [[TMP31:%.*]] = load ptr, ptr [[TMP4]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[TMP32:%.*]] = load b8, ptr [[I13]], align 1, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[IDXPROM33:%.*]] = bytecast exact b8 [[TMP32]] to i8
// CHECK6-NEXT:    [[IDXPROM34:%.*]] = sext i8 [[IDXPROM33]] to i64
// CHECK6-NEXT:    [[ARRAYIDX35:%.*]] = getelementptr inbounds float, ptr [[TMP31]], i64 [[IDXPROM34]]
// CHECK6-NEXT:    [[TMP33:%.*]] = load float, ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[MUL36:%.*]] = fmul float [[MUL32]], [[TMP33]]
// CHECK6-NEXT:    [[TMP34:%.*]] = load ptr, ptr [[TMP1]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[TMP35:%.*]] = load b8, ptr [[I13]], align 1, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[IDXPROM37:%.*]] = bytecast exact b8 [[TMP35]] to i8
// CHECK6-NEXT:    [[IDXPROM38:%.*]] = sext i8 [[IDXPROM37]] to i64
// CHECK6-NEXT:    [[ARRAYIDX39:%.*]] = getelementptr inbounds float, ptr [[TMP34]], i64 [[IDXPROM38]]
// CHECK6-NEXT:    store float [[MUL36]], ptr [[ARRAYIDX39]], align 4, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK6:       omp.body.continue:
// CHECK6-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK6:       omp.inner.for.inc:
// CHECK6-NEXT:    [[TMP36:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP11]]
// CHECK6-NEXT:    [[ADD40:%.*]] = add nsw i64 [[TMP36]], 1
// CHECK6-NEXT:    store i64 [[ADD40]], ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP11]]
...
// CHECK6-NEXT:    br label [[OMP_DISPATCH_COND]]
// CHECK6:       omp.dispatch.end:
// CHECK6-NEXT:    [[TMP37:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK6-NEXT:    [[TMP38:%.*]] = load i32, ptr [[TMP37]], align 4
// CHECK6-NEXT:    call void @__kmpc_dispatch_deinit(ptr @[[GLOB2]], i32 [[TMP38]])
// CHECK6-NEXT:    br label [[OMP_PRECOND_END]]
// CHECK6:       omp.precond.end:
// CHECK6-NEXT:    ret void
//
...
// CHECK6-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[D_ADDR]], align 8
// CHECK6-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK6-NEXT:    [[CONV:%.*]] = bytecast exact b8 57 to i8
// CHECK6-NEXT:    [[CONV2:%.*]] = sext i8 [[CONV]] to i32
// CHECK6-NEXT:    [[CONV3:%.*]] = bytecast exact b8 48 to i8
// CHECK6-NEXT:    [[CONV4:%.*]] = sext i8 [[CONV3]] to i32
// CHECK6-NEXT:    [[SUB:%.*]] = sub nsw i32 [[CONV4]], 1
// CHECK6-NEXT:    [[SUB5:%.*]] = sub nsw i32 [[CONV2]], [[SUB]]
// CHECK6-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB5]], 1
// CHECK6-NEXT:    [[MUL:%.*]] = mul nsw i32 [[DIV]], 20
// CHECK6-NEXT:    [[SUB6:%.*]] = sub nsw i32 [[MUL]], 1
// CHECK6-NEXT:    store i32 [[SUB6]], ptr [[DOTOMP_UB]], align 4
// CHECK6-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4
// CHECK6-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK6-NEXT:    [[CONV7:%.*]] = bytecast exact b8 57 to i8
// CHECK6-NEXT:    [[CONV8:%.*]] = sext i8 [[CONV7]] to i32
// CHECK6-NEXT:    [[CONV9:%.*]] = bytecast exact b8 48 to i8
// CHECK6-NEXT:    [[CONV10:%.*]] = sext i8 [[CONV9]] to i32
// CHECK6-NEXT:    [[SUB11:%.*]] = sub nsw i32 [[CONV10]], 1
// CHECK6-NEXT:    [[SUB12:%.*]] = sub nsw i32 [[CONV8]], [[SUB11]]
// CHECK6-NEXT:    [[DIV13:%.*]] = sdiv i32 [[SUB12]], 1
// CHECK6-NEXT:    [[MUL14:%.*]] = mul nsw i32 [[DIV13]], 20
// CHECK6-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[MUL14]], 1
// CHECK6-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK6-NEXT:    [[TMP5:%.*]] = load i32, ptr [[TMP4]], align 4
// CHECK6-NEXT:    call void @__kmpc_dispatch_init_4(ptr @[[GLOB2]], i32 [[TMP5]], i32 1073741861, i32 0, i32 [[SUB15]], i32 1, i32 1)
// CHECK6-NEXT:    br label [[OMP_DISPATCH_COND:%.*]]
// CHECK6:       omp.dispatch.cond:
...
// CHECK6-NEXT:    br i1 [[CMP]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK6:       omp.inner.for.body:
// CHECK6-NEXT:    [[CONV16:%.*]] = bytecast exact b8 48 to i8
// CHECK6-NEXT:    [[CONV17:%.*]] = sext i8 [[CONV16]] to i32
// CHECK6-NEXT:    [[TMP10:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK6-NEXT:    [[DIV18:%.*]] = sdiv i32 [[TMP10]], 20
// CHECK6-NEXT:    [[MUL19:%.*]] = mul nsw i32 [[DIV18]], 1
// CHECK6-NEXT:    [[ADD:%.*]] = add nsw i32 [[CONV17]], [[MUL19]]
// CHECK6-NEXT:    [[CONV20:%.*]] = trunc i32 [[ADD]] to i8
// CHECK6-NEXT:    [[TMP11:%.*]] = bitcast i8 [[CONV20]] to b8
// CHECK6-NEXT:    store b8 [[TMP11]], ptr [[I]], align 1, !llvm.access.group [[ACC_GRP14]]
// CHECK6-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK6-NEXT:    [[TMP13:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK6-NEXT:    [[DIV21:%.*]] = sdiv i32 [[TMP13]], 20
// CHECK6-NEXT:    [[MUL22:%.*]] = mul nsw i32 [[DIV21]], 20
// CHECK6-NEXT:    [[SUB23:%.*]] = sub nsw i32 [[TMP12]], [[MUL22]]
// CHECK6-NEXT:    [[MUL24:%.*]] = mul nsw i32 [[SUB23]], 1
// CHECK6-NEXT:    [[ADD25:%.*]] = add nsw i32 -10, [[MUL24]]
// CHECK6-NEXT:    store i32 [[ADD25]], ptr [[X]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK6-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[TMP1]], align 8, !llvm.access.group [[ACC_GRP14]]
// CHECK6-NEXT:    [[TMP15:%.*]] = load b8, ptr [[I]], align 1, !llvm.access.group [[ACC_GRP14]]
// CHECK6-NEXT:    [[IDXPROM:%.*]] = bytecast exact b8 [[TMP15]] to i8
// CHECK6-NEXT:    [[IDXPROM26:%.*]] = zext i8 [[IDXPROM]] to i64
// CHECK6-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw float, ptr [[TMP14]], i64 [[IDXPROM26]]
// CHECK6-NEXT:    [[TMP16:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK6-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[TMP2]], align 8, !llvm.access.group [[ACC_GRP14]]
// CHECK6-NEXT:    [[TMP18:%.*]] = load b8, ptr [[I]], align 1, !llvm.access.group [[ACC_GRP14]]
// CHECK6-NEXT:    [[IDXPROM27:%.*]] = bytecast exact b8 [[TMP18]] to i8
// CHECK6-NEXT:    [[IDXPROM28:%.*]] = zext i8 [[IDXPROM27]] to i64
// CHECK6-NEXT:    [[ARRAYIDX29:%.*]] = getelementptr inbounds nuw float, ptr [[TMP17]], i64 [[IDXPROM28]]
// CHECK6-NEXT:    [[TMP19:%.*]] = load float, ptr [[ARRAYIDX29]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK6-NEXT:    [[MUL30:%.*]] = fmul float [[TMP16]], [[TMP19]]
// CHECK6-NEXT:    [[TMP20:%.*]] = load ptr, ptr [[TMP3]], align 8, !llvm.access.group [[ACC_GRP14]]
// CHECK6-NEXT:    [[TMP21:%.*]] = load b8, ptr [[I]], align 1, !llvm.access.group [[ACC_GRP14]]
// CHECK6-NEXT:    [[IDXPROM31:%.*]] = bytecast exact b8 [[TMP21]] to i8
// CHECK6-NEXT:    [[IDXPROM32:%.*]] = zext i8 [[IDXPROM31]] to i64
// CHECK6-NEXT:    [[ARRAYIDX33:%.*]] = getelementptr inbounds nuw float, ptr [[TMP20]], i64 [[IDXPROM32]]
// CHECK6-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX33]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK6-NEXT:    [[MUL34:%.*]] = fmul float [[MUL30]], [[TMP22]]
// CHECK6-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[TMP0]], align 8, !llvm.access.group [[ACC_GRP14]]
// CHECK6-NEXT:    [[TMP24:%.*]] = load b8, ptr [[I]], align 1, !llvm.access.group [[ACC_GRP14]]
// CHECK6-NEXT:    [[IDXPROM35:%.*]] = bytecast exact b8 [[TMP24]] to i8
// CHECK6-NEXT:    [[IDXPROM36:%.*]] = zext i8 [[IDXPROM35]] to i64
// CHECK6-NEXT:    [[ARRAYIDX37:%.*]] = getelementptr inbounds nuw float, ptr [[TMP23]], i64 [[IDXPROM36]]
// CHECK6-NEXT:    store float [[MUL34]], ptr [[ARRAYIDX37]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK6-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK6:       omp.body.continue:
// CHECK6-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK6:       omp.inner.for.inc:
// CHECK6-NEXT:    [[TMP25:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK6-NEXT:    [[ADD38:%.*]] = add nsw i32 [[TMP25]], 1
// CHECK6-NEXT:    store i32 [[ADD38]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP14]]
