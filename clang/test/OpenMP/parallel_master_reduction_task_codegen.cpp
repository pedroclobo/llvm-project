...
// CHECK1-NEXT:    [[TMP51:%.*]] = call ptr @__kmpc_taskred_modifier_init(ptr @[[GLOB1]], i32 [[TMP50]], i32 0, i32 2, ptr [[DOTRD_INPUT_]])
...
// CHECK1-NEXT:    [[TMP54:%.*]] = call i32 @__kmpc_master(ptr @[[GLOB1]], i32 [[TMP53]])
// CHECK1-NEXT:    [[TMP55:%.*]] = icmp ne i32 [[TMP54]], 0
// CHECK1-NEXT:    br i1 [[TMP55]], label [[OMP_IF_THEN:%.*]], label [[OMP_IF_END:%.*]]
// CHECK1:       omp_if.then:
...
// CHECK1-NEXT:    [[TMP59:%.*]] = load ptr, ptr [[TMP]], align 8
...
// CHECK1-NEXT:    call void @__kmpc_end_master(ptr @[[GLOB1]], i32 [[TMP53]])
// CHECK1-NEXT:    br label [[OMP_IF_END]]
// CHECK1:       omp_if.end:
// CHECK1-NEXT:    [[TMP72:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP73:%.*]] = load i32, ptr [[TMP72]], align 4
// CHECK1-NEXT:    call void @__kmpc_task_reduction_modifier_fini(ptr @[[GLOB1]], i32 [[TMP73]], i32 0)
// CHECK1-NEXT:    [[TMP74:%.*]] = getelementptr inbounds [3 x ptr], ptr [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 0
// CHECK1-NEXT:    store ptr [[ARGC1]], ptr [[TMP74]], align 8
// CHECK1-NEXT:    [[TMP75:%.*]] = getelementptr inbounds [3 x ptr], ptr [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 1
// CHECK1-NEXT:    store ptr [[VLA]], ptr [[TMP75]], align 8
// CHECK1-NEXT:    [[TMP76:%.*]] = getelementptr inbounds [3 x ptr], ptr [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 2
// CHECK1-NEXT:    [[TMP77:%.*]] = inttoptr i64 [[TMP11]] to ptr
...
// CHECK1-NEXT:    [[TMP80:%.*]] = call i32 @__kmpc_reduce_nowait(ptr @[[GLOB2:[0-9]+]], i32 [[TMP79]], i32 2, i64 24, ptr [[DOTOMP_REDUCTION_RED_LIST]], ptr @main.omp_outlined.omp.reduction.reduction_func, ptr @.gomp_critical_user_.reduction.var)
// CHECK1-NEXT:    switch i32 [[TMP80]], label [[DOTOMP_REDUCTION_DEFAULT:%.*]] [
// CHECK1-NEXT:      i32 1, label [[DOTOMP_REDUCTION_CASE1:%.*]]
// CHECK1-NEXT:      i32 2, label [[DOTOMP_REDUCTION_CASE2:%.*]]
// CHECK1-NEXT:    ]
// CHECK1:       .omp.reduction.case1:
// CHECK1-NEXT:    [[TMP81:%.*]] = load i32, ptr [[TMP0]], align 4
// CHECK1-NEXT:    [[TMP82:%.*]] = load i32, ptr [[ARGC1]], align 4
// CHECK1-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP81]], [[TMP82]]
// CHECK1-NEXT:    store i32 [[ADD]], ptr [[TMP0]], align 4
// CHECK1-NEXT:    [[TMP83:%.*]] = getelementptr b8, ptr [[ARRAYIDX2]], i64 [[TMP11]]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq ptr [[ARRAYIDX2]], [[TMP83]]
...
// CHECK1-NEXT:    [[TMP84:%.*]] = load b8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST12]], align 1
// CHECK1-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP84]] to i8
// CHECK1-NEXT:    [[CONV13:%.*]] = sext i8 [[CONV]] to i32
// CHECK1-NEXT:    [[TMP85:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1
// CHECK1-NEXT:    [[CONV14:%.*]] = bytecast exact b8 [[TMP85]] to i8
...
// CHECK1-NEXT:    [[TMP86:%.*]] = bitcast i8 [[CONV17]] to b8
// CHECK1-NEXT:    store b8 [[TMP86]], ptr [[OMP_ARRAYCPY_DESTELEMENTPAST12]], align 1
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE19:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT18]], [[TMP83]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYCPY_DONE19]], label [[OMP_ARRAYCPY_DONE20]], label [[OMP_ARRAYCPY_BODY]]
// CHECK1:       omp.arraycpy.done20:
// CHECK1-NEXT:    call void @__kmpc_end_reduce_nowait(ptr @[[GLOB2]], i32 [[TMP79]], ptr @.gomp_critical_user_.reduction.var)
...
// CHECK1-NEXT:    [[TMP89:%.*]] = getelementptr b8, ptr [[ARRAYIDX2]], i64 [[TMP11]]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY21:%.*]] = icmp eq ptr [[ARRAYIDX2]], [[TMP89]]
...
// CHECK1-NEXT:    [[TMP90:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
// CHECK1-NEXT:    [[CONV25:%.*]] = bytecast exact b8 [[TMP90]] to i8
...
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP91:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY22]] ], [ [[TMP98:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    [[TMP92:%.*]] = bitcast i8 [[TMP91]] to b8
// CHECK1-NEXT:    store b8 [[TMP92]], ptr [[_TMP27]], align 1
// CHECK1-NEXT:    [[TMP93:%.*]] = load b8, ptr [[_TMP27]], align 1
// CHECK1-NEXT:    [[CONV28:%.*]] = bytecast exact b8 [[TMP93]] to i8
// CHECK1-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK1-NEXT:    [[TMP94:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
// CHECK1-NEXT:    [[CONV30:%.*]] = bytecast exact b8 [[TMP94]] to i8
...
// CHECK1-NEXT:    [[TMP95:%.*]] = bitcast i8 [[CONV33]] to b8
// CHECK1-NEXT:    store b8 [[TMP95]], ptr [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP96:%.*]] = load i8, ptr [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP97:%.*]] = cmpxchg ptr [[OMP_ARRAYCPY_DESTELEMENTPAST24]], i8 [[TMP91]], i8 [[TMP96]] monotonic monotonic, align 1
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE36:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT34]], [[TMP89]]
