...
// CHECK1-NEXT:    [[TMP83:%.*]] = load b8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST12]], align 1
// CHECK1-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP83]] to i8
// CHECK1-NEXT:    [[CONV13:%.*]] = sext i8 [[CONV]] to i32
// CHECK1-NEXT:    [[TMP84:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1
// CHECK1-NEXT:    [[CONV14:%.*]] = bytecast exact b8 [[TMP84]] to i8
...
// CHECK1-NEXT:    [[TMP85:%.*]] = bitcast i8 [[CONV17]] to b8
// CHECK1-NEXT:    store b8 [[TMP85]], ptr [[OMP_ARRAYCPY_DESTELEMENTPAST12]], align 1
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE19:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT18]], [[TMP82]]
...
// CHECK1-NEXT:    [[TMP87:%.*]] = atomicrmw add ptr [[TMP0]], i32 [[TMP86]] monotonic, align 4
// CHECK1-NEXT:    [[TMP88:%.*]] = getelementptr b8, ptr [[ARRAYIDX2]], i64 [[TMP11]]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY21:%.*]] = icmp eq ptr [[ARRAYIDX2]], [[TMP88]]
...
// CHECK1-NEXT:    [[CONV25:%.*]] = bytecast exact b8 [[TMP89]] to i8
...
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP90:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY22]] ], [ [[TMP97:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    [[TMP91:%.*]] = bitcast i8 [[TMP90]] to b8
// CHECK1-NEXT:    store b8 [[TMP91]], ptr [[_TMP27]], align 1
// CHECK1-NEXT:    [[TMP92:%.*]] = load b8, ptr [[_TMP27]], align 1
// CHECK1-NEXT:    [[CONV28:%.*]] = bytecast exact b8 [[TMP92]] to i8
// CHECK1-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK1-NEXT:    [[TMP93:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
// CHECK1-NEXT:    [[CONV30:%.*]] = bytecast exact b8 [[TMP93]] to i8
...
// CHECK1-NEXT:    [[TMP94:%.*]] = bitcast i8 [[CONV33]] to b8
// CHECK1-NEXT:    store b8 [[TMP94]], ptr [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP95:%.*]] = load i8, ptr [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP96:%.*]] = cmpxchg ptr [[OMP_ARRAYCPY_DESTELEMENTPAST24]], i8 [[TMP90]], i8 [[TMP95]] monotonic monotonic, align 1
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE36:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT34]], [[TMP88]]
