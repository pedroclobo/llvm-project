...
// CHECK1-NEXT:    [[ARRAYIDX8:%.*]] = getelementptr inbounds b8, ptr [[TMP15]], i64 [[IDXPROM7]]
// CHECK1-NEXT:    [[TMP17:%.*]] = load b8, ptr [[ARRAYIDX8]], align 1
// CHECK1-NEXT:    [[CONV:%.*]] = bytecast b8 [[TMP17]] to i8
// CHECK1-NEXT:    [[CONV9:%.*]] = sext i8 [[CONV]] to i32
// CHECK1-NEXT:    store i32 [[CONV9]], ptr [[DOTCAPTURE_EXPR_6]], align 4
// CHECK1-NEXT:    [[TMP18:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_4]], align 4
// CHECK1-NEXT:    [[SUB:%.*]] = sub nsw i32 [[TMP18]], 0
// CHECK1-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB]], 1
// CHECK1-NEXT:    [[CONV11:%.*]] = sext i32 [[DIV]] to i64
// CHECK1-NEXT:    [[TMP19:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_6]], align 4
// CHECK1-NEXT:    [[TMP20:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_5]], align 4
// CHECK1-NEXT:    [[SUB12:%.*]] = sub i32 [[TMP19]], [[TMP20]]
// CHECK1-NEXT:    [[SUB13:%.*]] = sub i32 [[SUB12]], 1
// CHECK1-NEXT:    [[ADD:%.*]] = add i32 [[SUB13]], 1
// CHECK1-NEXT:    [[DIV14:%.*]] = udiv i32 [[ADD]], 1
// CHECK1-NEXT:    [[CONV15:%.*]] = zext i32 [[DIV14]] to i64
// CHECK1-NEXT:    [[MUL:%.*]] = mul nsw i64 [[CONV11]], [[CONV15]]
// CHECK1-NEXT:    [[SUB16:%.*]] = sub nsw i64 [[MUL]], 1
// CHECK1-NEXT:    store i64 [[SUB16]], ptr [[DOTCAPTURE_EXPR_10]], align 8
...
// CHECK1-NEXT:    [[TMP30:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_10]], align 8
...
// CHECK1-NEXT:    [[DOTCAPTURE_EXPR_7_I:%.*]] = alloca i64, align 8
// CHECK1-NEXT:    [[I_I:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[J_I:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[I15_I:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[J16_I:%.*]] = alloca i32, align 4
...
// CHECK1-NEXT:    [[ARRAYIDX5_I:%.*]] = getelementptr inbounds b8, ptr [[TMP36]], i64 [[IDXPROM4_I]]
// CHECK1-NEXT:    [[TMP40:%.*]] = load b8, ptr [[ARRAYIDX5_I]], align 1
// CHECK1-NEXT:    [[CONV_I:%.*]] = bytecast b8 [[TMP40]] to i8
// CHECK1-NEXT:    [[CONV6_I:%.*]] = sext i8 [[CONV_I]] to i32
// CHECK1-NEXT:    store i32 [[CONV6_I]], ptr [[DOTCAPTURE_EXPR_3_I]], align 4, !noalias [[META50]]
// CHECK1-NEXT:    [[TMP41:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR__I]], align 4, !noalias [[META50]]
// CHECK1-NEXT:    [[CONV8_I:%.*]] = sext i32 [[TMP41]] to i64
...
// CHECK1-NEXT:    [[SUB9_I:%.*]] = sub i32 [[TMP42]], [[TMP43]]
// CHECK1-NEXT:    [[SUB10_I:%.*]] = sub i32 [[SUB9_I]], 1
// CHECK1-NEXT:    [[CONV12_I:%.*]] = zext i32 [[SUB9_I]] to i64
// CHECK1-NEXT:    [[MUL_I:%.*]] = mul nsw i64 [[CONV8_I]], [[CONV12_I]]
// CHECK1-NEXT:    [[SUB13_I:%.*]] = sub nsw i64 [[MUL_I]], 1
// CHECK1-NEXT:    store i64 [[SUB13_I]], ptr [[DOTCAPTURE_EXPR_7_I]], align 8, !noalias [[META50]]
...
// CHECK1-NEXT:    [[CMP14_I:%.*]] = icmp slt i32 [[TMP46]], [[TMP47]]
// CHECK1-NEXT:    br i1 [[CMP14_I]], label [[TASKLOOP_IF_THEN_I:%.*]], label [[TASKLOOP_IF_END_I]]
...
// CHECK1-NEXT:    [[CMP17_I:%.*]] = icmp ule i64 [[TMP53]], [[TMP54]]
// CHECK1-NEXT:    br i1 [[CMP17_I]], label [[OMP_INNER_FOR_BODY_I:%.*]], label [[OMP_INNER_FOR_END_I:%.*]]
// CHECK1:       omp.inner.for.body.i:
...
// CHECK1-NEXT:    [[SUB18_I:%.*]] = sub i32 [[TMP56]], [[TMP57]]
// CHECK1-NEXT:    [[SUB19_I:%.*]] = sub i32 [[SUB18_I]], 1
// CHECK1-NEXT:    [[CONV23_I:%.*]] = zext i32 [[SUB18_I]] to i64
// CHECK1-NEXT:    [[DIV24_I:%.*]] = sdiv i64 [[TMP55]], [[CONV23_I]]
// CHECK1-NEXT:    [[CONV27_I:%.*]] = trunc i64 [[DIV24_I]] to i32
// CHECK1-NEXT:    store i32 [[CONV27_I]], ptr [[I15_I]], align 4, !noalias [[META50]], !llvm.access.group [[ACC_GRP51]]
// CHECK1-NEXT:    [[TMP58:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_2_I]], align 4, !noalias [[META50]], !llvm.access.group [[ACC_GRP51]]
// CHECK1-NEXT:    [[CONV28_I:%.*]] = sext i32 [[TMP58]] to i64
...
// CHECK1-NEXT:    [[SUB29_I:%.*]] = sub i32 [[TMP61]], [[TMP62]]
// CHECK1-NEXT:    [[SUB30_I:%.*]] = sub i32 [[SUB29_I]], 1
// CHECK1-NEXT:    [[CONV34_I:%.*]] = zext i32 [[SUB29_I]] to i64
// CHECK1-NEXT:    [[DIV35_I:%.*]] = sdiv i64 [[TMP60]], [[CONV34_I]]
...
// CHECK1-NEXT:    [[SUB36_I:%.*]] = sub i32 [[TMP63]], [[TMP64]]
// CHECK1-NEXT:    [[SUB37_I:%.*]] = sub i32 [[SUB36_I]], 1
// CHECK1-NEXT:    [[CONV41_I:%.*]] = zext i32 [[SUB36_I]] to i64
// CHECK1-NEXT:    [[MUL42_I:%.*]] = mul nsw i64 [[DIV35_I]], [[CONV41_I]]
// CHECK1-NEXT:    [[SUB43_I:%.*]] = sub nsw i64 [[TMP59]], [[MUL42_I]]
// CHECK1-NEXT:    [[ADD45_I:%.*]] = add nsw i64 [[CONV28_I]], [[SUB43_I]]
// CHECK1-NEXT:    [[CONV46_I:%.*]] = trunc i64 [[ADD45_I]] to i32
// CHECK1-NEXT:    store i32 [[CONV46_I]], ptr [[J16_I]], align 4, !noalias [[META50]], !llvm.access.group [[ACC_GRP51]]
// CHECK1-NEXT:    [[TMP65:%.*]] = load i64, ptr [[DOTOMP_IV_I]], align 8, !noalias [[META50]], !llvm.access.group [[ACC_GRP51]]
// CHECK1-NEXT:    [[ADD47_I:%.*]] = add nsw i64 [[TMP65]], 1
// CHECK1-NEXT:    store i64 [[ADD47_I]], ptr [[DOTOMP_IV_I]], align 8, !noalias [[META50]], !llvm.access.group [[ACC_GRP51]]
...
// CHECK2-NEXT:    [[ARRAYIDX8:%.*]] = getelementptr inbounds b8, ptr [[TMP15]], i64 [[IDXPROM7]]
// CHECK2-NEXT:    [[TMP17:%.*]] = load b8, ptr [[ARRAYIDX8]], align 1
// CHECK2-NEXT:    [[CONV:%.*]] = bytecast b8 [[TMP17]] to i8
// CHECK2-NEXT:    [[CONV9:%.*]] = sext i8 [[CONV]] to i32
// CHECK2-NEXT:    store i32 [[CONV9]], ptr [[DOTCAPTURE_EXPR_6]], align 4
// CHECK2-NEXT:    [[TMP18:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_4]], align 4
// CHECK2-NEXT:    [[SUB:%.*]] = sub nsw i32 [[TMP18]], 0
// CHECK2-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB]], 1
// CHECK2-NEXT:    [[CONV11:%.*]] = sext i32 [[DIV]] to i64
// CHECK2-NEXT:    [[TMP19:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_6]], align 4
// CHECK2-NEXT:    [[TMP20:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_5]], align 4
// CHECK2-NEXT:    [[SUB12:%.*]] = sub i32 [[TMP19]], [[TMP20]]
// CHECK2-NEXT:    [[SUB13:%.*]] = sub i32 [[SUB12]], 1
// CHECK2-NEXT:    [[ADD:%.*]] = add i32 [[SUB13]], 1
// CHECK2-NEXT:    [[DIV14:%.*]] = udiv i32 [[ADD]], 1
// CHECK2-NEXT:    [[CONV15:%.*]] = zext i32 [[DIV14]] to i64
// CHECK2-NEXT:    [[MUL:%.*]] = mul nsw i64 [[CONV11]], [[CONV15]]
// CHECK2-NEXT:    [[SUB16:%.*]] = sub nsw i64 [[MUL]], 1
// CHECK2-NEXT:    store i64 [[SUB16]], ptr [[DOTCAPTURE_EXPR_10]], align 8
...
// CHECK2-NEXT:    [[TMP30:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_10]], align 8
...
// CHECK2-NEXT:    [[DOTCAPTURE_EXPR_7_I:%.*]] = alloca i64, align 8
// CHECK2-NEXT:    [[I_I:%.*]] = alloca i32, align 4
// CHECK2-NEXT:    [[J_I:%.*]] = alloca i32, align 4
// CHECK2-NEXT:    [[I15_I:%.*]] = alloca i32, align 4
// CHECK2-NEXT:    [[J16_I:%.*]] = alloca i32, align 4
...
// CHECK2-NEXT:    [[ARRAYIDX5_I:%.*]] = getelementptr inbounds b8, ptr [[TMP36]], i64 [[IDXPROM4_I]]
// CHECK2-NEXT:    [[TMP40:%.*]] = load b8, ptr [[ARRAYIDX5_I]], align 1
// CHECK2-NEXT:    [[CONV_I:%.*]] = bytecast b8 [[TMP40]] to i8
// CHECK2-NEXT:    [[CONV6_I:%.*]] = sext i8 [[CONV_I]] to i32
// CHECK2-NEXT:    store i32 [[CONV6_I]], ptr [[DOTCAPTURE_EXPR_3_I]], align 4, !noalias [[META50]]
// CHECK2-NEXT:    [[TMP41:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR__I]], align 4, !noalias [[META50]]
// CHECK2-NEXT:    [[CONV8_I:%.*]] = sext i32 [[TMP41]] to i64
...
// CHECK2-NEXT:    [[SUB9_I:%.*]] = sub i32 [[TMP42]], [[TMP43]]
// CHECK2-NEXT:    [[SUB10_I:%.*]] = sub i32 [[SUB9_I]], 1
// CHECK2-NEXT:    [[CONV12_I:%.*]] = zext i32 [[SUB9_I]] to i64
// CHECK2-NEXT:    [[MUL_I:%.*]] = mul nsw i64 [[CONV8_I]], [[CONV12_I]]
// CHECK2-NEXT:    [[SUB13_I:%.*]] = sub nsw i64 [[MUL_I]], 1
// CHECK2-NEXT:    store i64 [[SUB13_I]], ptr [[DOTCAPTURE_EXPR_7_I]], align 8, !noalias [[META50]]
...
// CHECK2-NEXT:    [[CMP14_I:%.*]] = icmp slt i32 [[TMP46]], [[TMP47]]
// CHECK2-NEXT:    br i1 [[CMP14_I]], label [[TASKLOOP_IF_THEN_I:%.*]], label [[TASKLOOP_IF_END_I]]
...
// CHECK2-NEXT:    [[CMP17_I:%.*]] = icmp ule i64 [[TMP53]], [[TMP54]]
// CHECK2-NEXT:    br i1 [[CMP17_I]], label [[OMP_INNER_FOR_BODY_I:%.*]], label [[OMP_INNER_FOR_END_I:%.*]]
// CHECK2:       omp.inner.for.body.i:
...
// CHECK2-NEXT:    [[SUB18_I:%.*]] = sub i32 [[TMP56]], [[TMP57]]
// CHECK2-NEXT:    [[SUB19_I:%.*]] = sub i32 [[SUB18_I]], 1
// CHECK2-NEXT:    [[CONV23_I:%.*]] = zext i32 [[SUB18_I]] to i64
// CHECK2-NEXT:    [[DIV24_I:%.*]] = sdiv i64 [[TMP55]], [[CONV23_I]]
// CHECK2-NEXT:    [[CONV27_I:%.*]] = trunc i64 [[DIV24_I]] to i32
// CHECK2-NEXT:    store i32 [[CONV27_I]], ptr [[I15_I]], align 4, !noalias [[META50]], !llvm.access.group [[ACC_GRP51]]
// CHECK2-NEXT:    [[TMP58:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_2_I]], align 4, !noalias [[META50]], !llvm.access.group [[ACC_GRP51]]
// CHECK2-NEXT:    [[CONV28_I:%.*]] = sext i32 [[TMP58]] to i64
...
// CHECK2-NEXT:    [[SUB29_I:%.*]] = sub i32 [[TMP61]], [[TMP62]]
// CHECK2-NEXT:    [[SUB30_I:%.*]] = sub i32 [[SUB29_I]], 1
// CHECK2-NEXT:    [[CONV34_I:%.*]] = zext i32 [[SUB29_I]] to i64
// CHECK2-NEXT:    [[DIV35_I:%.*]] = sdiv i64 [[TMP60]], [[CONV34_I]]
...
// CHECK2-NEXT:    [[SUB36_I:%.*]] = sub i32 [[TMP63]], [[TMP64]]
// CHECK2-NEXT:    [[SUB37_I:%.*]] = sub i32 [[SUB36_I]], 1
// CHECK2-NEXT:    [[CONV41_I:%.*]] = zext i32 [[SUB36_I]] to i64
// CHECK2-NEXT:    [[MUL42_I:%.*]] = mul nsw i64 [[DIV35_I]], [[CONV41_I]]
// CHECK2-NEXT:    [[SUB43_I:%.*]] = sub nsw i64 [[TMP59]], [[MUL42_I]]
// CHECK2-NEXT:    [[ADD45_I:%.*]] = add nsw i64 [[CONV28_I]], [[SUB43_I]]
// CHECK2-NEXT:    [[CONV46_I:%.*]] = trunc i64 [[ADD45_I]] to i32
// CHECK2-NEXT:    store i32 [[CONV46_I]], ptr [[J16_I]], align 4, !noalias [[META50]], !llvm.access.group [[ACC_GRP51]]
// CHECK2-NEXT:    [[TMP65:%.*]] = load i64, ptr [[DOTOMP_IV_I]], align 8, !noalias [[META50]], !llvm.access.group [[ACC_GRP51]]
// CHECK2-NEXT:    [[ADD47_I:%.*]] = add nsw i64 [[TMP65]], 1
// CHECK2-NEXT:    store i64 [[ADD47_I]], ptr [[DOTOMP_IV_I]], align 8, !noalias [[META50]], !llvm.access.group [[ACC_GRP51]]
...
// CHECK3-NEXT:    [[ARRAYIDX8:%.*]] = getelementptr inbounds b8, ptr [[TMP17]], i64 [[IDXPROM7]]
// CHECK3-NEXT:    [[TMP19:%.*]] = load b8, ptr [[ARRAYIDX8]], align 1
// CHECK3-NEXT:    [[CONV:%.*]] = bytecast b8 [[TMP19]] to i8
// CHECK3-NEXT:    [[CONV9:%.*]] = sext i8 [[CONV]] to i32
// CHECK3-NEXT:    store i32 [[CONV9]], ptr [[DOTCAPTURE_EXPR_6]], align 4
...
// CHECK3-NEXT:    [[SUB12:%.*]] = sub i32 [[TMP21]], [[TMP22]]
...
// CHECK3-NEXT:    store i64 [[SUB16]], ptr [[DOTCAPTURE_EXPR_10]], align 8
...
// CHECK3-NEXT:    [[LOADEDV17:%.*]] = trunc i8 [[TMP28]] to i1
// CHECK3-NEXT:    [[TMP29:%.*]] = sext i1 [[LOADEDV17]] to i32
...
// CHECK3-NEXT:    [[TMP32:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_10]], align 8
...
// CHECK3-NEXT:    [[DOTCAPTURE_EXPR_7_I:%.*]] = alloca i64, align 8
// CHECK3-NEXT:    [[I_I:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[J_I:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[I15_I:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[J16_I:%.*]] = alloca i32, align 4
...
// CHECK3-NEXT:    [[ARRAYIDX5_I:%.*]] = getelementptr inbounds b8, ptr [[TMP36]], i64 [[IDXPROM4_I]]
// CHECK3-NEXT:    [[TMP40:%.*]] = load b8, ptr [[ARRAYIDX5_I]], align 1
// CHECK3-NEXT:    [[CONV_I:%.*]] = bytecast b8 [[TMP40]] to i8
// CHECK3-NEXT:    [[CONV6_I:%.*]] = sext i8 [[CONV_I]] to i32
// CHECK3-NEXT:    store i32 [[CONV6_I]], ptr [[DOTCAPTURE_EXPR_3_I]], align 4, !noalias [[META50]]
// CHECK3-NEXT:    [[TMP41:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR__I]], align 4, !noalias [[META50]]
// CHECK3-NEXT:    [[CONV8_I:%.*]] = sext i32 [[TMP41]] to i64
...
// CHECK3-NEXT:    [[SUB9_I:%.*]] = sub i32 [[TMP42]], [[TMP43]]
// CHECK3-NEXT:    [[SUB10_I:%.*]] = sub i32 [[SUB9_I]], 1
// CHECK3-NEXT:    [[CONV12_I:%.*]] = zext i32 [[SUB9_I]] to i64
// CHECK3-NEXT:    [[MUL_I:%.*]] = mul nsw i64 [[CONV8_I]], [[CONV12_I]]
// CHECK3-NEXT:    [[SUB13_I:%.*]] = sub nsw i64 [[MUL_I]], 1
// CHECK3-NEXT:    store i64 [[SUB13_I]], ptr [[DOTCAPTURE_EXPR_7_I]], align 8, !noalias [[META50]]
...
// CHECK3-NEXT:    [[CMP14_I:%.*]] = icmp slt i32 [[TMP46]], [[TMP47]]
// CHECK3-NEXT:    br i1 [[CMP14_I]], label [[TASKLOOP_IF_THEN_I:%.*]], label [[TASKLOOP_IF_END_I]]
...
// CHECK3-NEXT:    [[CMP17_I:%.*]] = icmp ule i64 [[TMP55]], [[TMP56]]
// CHECK3-NEXT:    br i1 [[CMP17_I]], label [[OMP_INNER_FOR_BODY_I:%.*]], label [[OMP_INNER_FOR_END_I:%.*]]
// CHECK3:       omp.inner.for.body.i:
...
// CHECK3-NEXT:    [[SUB18_I:%.*]] = sub i32 [[TMP58]], [[TMP59]]
// CHECK3-NEXT:    [[SUB19_I:%.*]] = sub i32 [[SUB18_I]], 1
// CHECK3-NEXT:    [[CONV23_I:%.*]] = zext i32 [[SUB18_I]] to i64
// CHECK3-NEXT:    [[DIV24_I:%.*]] = sdiv i64 [[TMP57]], [[CONV23_I]]
// CHECK3-NEXT:    [[CONV27_I:%.*]] = trunc i64 [[DIV24_I]] to i32
// CHECK3-NEXT:    store i32 [[CONV27_I]], ptr [[I15_I]], align 4, !noalias [[META50]], !llvm.access.group [[ACC_GRP51]]
// CHECK3-NEXT:    [[TMP60:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_2_I]], align 4, !noalias [[META50]], !llvm.access.group [[ACC_GRP51]]
// CHECK3-NEXT:    [[CONV28_I:%.*]] = sext i32 [[TMP60]] to i64
...
// CHECK3-NEXT:    [[SUB29_I:%.*]] = sub i32 [[TMP63]], [[TMP64]]
// CHECK3-NEXT:    [[SUB30_I:%.*]] = sub i32 [[SUB29_I]], 1
// CHECK3-NEXT:    [[CONV34_I:%.*]] = zext i32 [[SUB29_I]] to i64
// CHECK3-NEXT:    [[DIV35_I:%.*]] = sdiv i64 [[TMP62]], [[CONV34_I]]
...
// CHECK3-NEXT:    [[SUB36_I:%.*]] = sub i32 [[TMP65]], [[TMP66]]
// CHECK3-NEXT:    [[SUB37_I:%.*]] = sub i32 [[SUB36_I]], 1
// CHECK3-NEXT:    [[CONV41_I:%.*]] = zext i32 [[SUB36_I]] to i64
// CHECK3-NEXT:    [[MUL42_I:%.*]] = mul nsw i64 [[DIV35_I]], [[CONV41_I]]
// CHECK3-NEXT:    [[SUB43_I:%.*]] = sub nsw i64 [[TMP61]], [[MUL42_I]]
// CHECK3-NEXT:    [[ADD45_I:%.*]] = add nsw i64 [[CONV28_I]], [[SUB43_I]]
// CHECK3-NEXT:    [[CONV46_I:%.*]] = trunc i64 [[ADD45_I]] to i32
// CHECK3-NEXT:    store i32 [[CONV46_I]], ptr [[J16_I]], align 4, !noalias [[META50]], !llvm.access.group [[ACC_GRP51]]
// CHECK3-NEXT:    [[TMP67:%.*]] = load i64, ptr [[DOTOMP_IV_I]], align 8, !noalias [[META50]], !llvm.access.group [[ACC_GRP51]]
// CHECK3-NEXT:    [[ADD47_I:%.*]] = add nsw i64 [[TMP67]], 1
// CHECK3-NEXT:    store i64 [[ADD47_I]], ptr [[DOTOMP_IV_I]], align 8, !noalias [[META50]], !llvm.access.group [[ACC_GRP51]]
...
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_COND48_I:%.*]]
// CHECK3:       omp.inner.for.cond48.i:
...
// CHECK3-NEXT:    [[CMP49_I:%.*]] = icmp ule i64 [[TMP68]], [[TMP69]]
// CHECK3-NEXT:    br i1 [[CMP49_I]], label [[OMP_INNER_FOR_BODY50_I:%.*]], label [[OMP_INNER_FOR_END83_I:%.*]]
// CHECK3:       omp.inner.for.body50.i:
...
// CHECK3-NEXT:    [[SUB51_I:%.*]] = sub i32 [[TMP71]], [[TMP72]]
// CHECK3-NEXT:    [[SUB52_I:%.*]] = sub i32 [[SUB51_I]], 1
// CHECK3-NEXT:    [[CONV56_I:%.*]] = zext i32 [[SUB51_I]] to i64
// CHECK3-NEXT:    [[DIV57_I:%.*]] = sdiv i64 [[TMP70]], [[CONV56_I]]
// CHECK3-NEXT:    [[CONV60_I:%.*]] = trunc i64 [[DIV57_I]] to i32
// CHECK3-NEXT:    store i32 [[CONV60_I]], ptr [[I15_I]], align 4, !noalias [[META50]]
// CHECK3-NEXT:    [[TMP73:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_2_I]], align 4, !noalias [[META50]]
// CHECK3-NEXT:    [[CONV61_I:%.*]] = sext i32 [[TMP73]] to i64
...
// CHECK3-NEXT:    [[SUB62_I:%.*]] = sub i32 [[TMP76]], [[TMP77]]
// CHECK3-NEXT:    [[SUB63_I:%.*]] = sub i32 [[SUB62_I]], 1
// CHECK3-NEXT:    [[CONV67_I:%.*]] = zext i32 [[SUB62_I]] to i64
// CHECK3-NEXT:    [[DIV68_I:%.*]] = sdiv i64 [[TMP75]], [[CONV67_I]]
...
// CHECK3-NEXT:    [[SUB69_I:%.*]] = sub i32 [[TMP78]], [[TMP79]]
// CHECK3-NEXT:    [[SUB70_I:%.*]] = sub i32 [[SUB69_I]], 1
// CHECK3-NEXT:    [[CONV74_I:%.*]] = zext i32 [[SUB69_I]] to i64
// CHECK3-NEXT:    [[MUL75_I:%.*]] = mul nsw i64 [[DIV68_I]], [[CONV74_I]]
// CHECK3-NEXT:    [[SUB76_I:%.*]] = sub nsw i64 [[TMP74]], [[MUL75_I]]
// CHECK3-NEXT:    [[ADD78_I:%.*]] = add nsw i64 [[CONV61_I]], [[SUB76_I]]
// CHECK3-NEXT:    [[CONV79_I:%.*]] = trunc i64 [[ADD78_I]] to i32
// CHECK3-NEXT:    store i32 [[CONV79_I]], ptr [[J16_I]], align 4, !noalias [[META50]]
// CHECK3-NEXT:    [[TMP80:%.*]] = load i64, ptr [[DOTOMP_IV_I]], align 8, !noalias [[META50]]
// CHECK3-NEXT:    [[ADD82_I:%.*]] = add nsw i64 [[TMP80]], 1
// CHECK3-NEXT:    store i64 [[ADD82_I]], ptr [[DOTOMP_IV_I]], align 8, !noalias [[META50]]
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_COND48_I]], !llvm.loop [[LOOP54:![0-9]+]]
// CHECK3:       omp.inner.for.end83.i:
// CHECK3-NEXT:    br label [[OMP_IF_END_I]]
// CHECK3:       omp_if.end.i:
...
// CHECK5-NEXT:    [[DOTCAPTURE_EXPR_32:%.*]] = alloca i64, align 8
// CHECK5-NEXT:    [[DOTOMP_LB41:%.*]] = alloca i64, align 8
// CHECK5-NEXT:    [[DOTOMP_UB42:%.*]] = alloca i64, align 8
// CHECK5-NEXT:    [[I43:%.*]] = alloca i32, align 4
// CHECK5-NEXT:    [[J:%.*]] = alloca i32, align 4
// CHECK5-NEXT:    [[DOTOMP_IV46:%.*]] = alloca i64, align 8
// CHECK5-NEXT:    [[I47:%.*]] = alloca i32, align 4
// CHECK5-NEXT:    [[J48:%.*]] = alloca i32, align 4
...
// CHECK5-NEXT:    [[ARRAYIDX29:%.*]] = getelementptr inbounds b8, ptr [[TMP18]], i64 [[IDXPROM28]]
// CHECK5-NEXT:    [[TMP20:%.*]] = load b8, ptr [[ARRAYIDX29]], align 1
// CHECK5-NEXT:    [[CONV30:%.*]] = bytecast b8 [[TMP20]] to i8
// CHECK5-NEXT:    [[CONV31:%.*]] = sext i8 [[CONV30]] to i32
// CHECK5-NEXT:    store i32 [[CONV31]], ptr [[DOTCAPTURE_EXPR_27]], align 4
...
// CHECK5-NEXT:    [[CONV33:%.*]] = sext i32 [[DIV]] to i64
// CHECK5-NEXT:    [[TMP22:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_27]], align 4
// CHECK5-NEXT:    [[TMP23:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_26]], align 4
// CHECK5-NEXT:    [[SUB34:%.*]] = sub i32 [[TMP22]], [[TMP23]]
// CHECK5-NEXT:    [[SUB35:%.*]] = sub i32 [[SUB34]], 1
// CHECK5-NEXT:    [[ADD36:%.*]] = add i32 [[SUB35]], 1
// CHECK5-NEXT:    [[DIV37:%.*]] = udiv i32 [[ADD36]], 1
// CHECK5-NEXT:    [[CONV38:%.*]] = zext i32 [[DIV37]] to i64
// CHECK5-NEXT:    [[MUL39:%.*]] = mul nsw i64 [[CONV33]], [[CONV38]]
// CHECK5-NEXT:    [[SUB40:%.*]] = sub nsw i64 [[MUL39]], 1
// CHECK5-NEXT:    store i64 [[SUB40]], ptr [[DOTCAPTURE_EXPR_32]], align 8
// CHECK5-NEXT:    store i64 0, ptr [[DOTOMP_LB41]], align 8
// CHECK5-NEXT:    [[TMP24:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_32]], align 8
// CHECK5-NEXT:    store i64 [[TMP24]], ptr [[DOTOMP_UB42]], align 8
// CHECK5-NEXT:    store i32 0, ptr [[I43]], align 4
...
// CHECK5-NEXT:    [[CMP44:%.*]] = icmp slt i32 0, [[TMP26]]
// CHECK5-NEXT:    br i1 [[CMP44]], label [[LAND_LHS_TRUE:%.*]], label [[SIMD_IF_END:%.*]]
...
// CHECK5-NEXT:    [[CMP45:%.*]] = icmp slt i32 [[TMP27]], [[TMP28]]
// CHECK5-NEXT:    br i1 [[CMP45]], label [[SIMD_IF_THEN:%.*]], label [[SIMD_IF_END]]
// CHECK5:       simd.if.then:
// CHECK5-NEXT:    [[TMP29:%.*]] = load i64, ptr [[DOTOMP_LB41]], align 8
// CHECK5-NEXT:    store i64 [[TMP29]], ptr [[DOTOMP_IV46]], align 8
// CHECK5-NEXT:    [[TMP30:%.*]] = load ptr, ptr [[ARGV_ADDR]], align 8
// CHECK5-NEXT:    call void @llvm.assume(i1 true) [ "align"(ptr [[TMP30]], i64 8) ]
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_COND49:%.*]]
// CHECK5:       omp.inner.for.cond49:
// CHECK5-NEXT:    [[TMP31:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9:![0-9]+]]
// CHECK5-NEXT:    [[TMP32:%.*]] = load i64, ptr [[DOTOMP_UB42]], align 8, !llvm.access.group [[ACC_GRP9]]
// CHECK5-NEXT:    [[CMP50:%.*]] = icmp ule i64 [[TMP31]], [[TMP32]]
// CHECK5-NEXT:    br i1 [[CMP50]], label [[OMP_INNER_FOR_BODY51:%.*]], label [[OMP_INNER_FOR_END84:%.*]]
// CHECK5:       omp.inner.for.body51:
// CHECK5-NEXT:    [[TMP33:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
...
// CHECK5-NEXT:    [[SUB52:%.*]] = sub i32 [[TMP34]], [[TMP35]]
// CHECK5-NEXT:    [[SUB53:%.*]] = sub i32 [[SUB52]], 1
// CHECK5-NEXT:    [[ADD54:%.*]] = add i32 [[SUB53]], 1
// CHECK5-NEXT:    [[DIV55:%.*]] = udiv i32 [[ADD54]], 1
// CHECK5-NEXT:    [[MUL56:%.*]] = mul i32 1, [[DIV55]]
// CHECK5-NEXT:    [[CONV57:%.*]] = zext i32 [[MUL56]] to i64
// CHECK5-NEXT:    [[DIV58:%.*]] = sdiv i64 [[TMP33]], [[CONV57]]
// CHECK5-NEXT:    [[MUL59:%.*]] = mul nsw i64 [[DIV58]], 1
// CHECK5-NEXT:    [[ADD60:%.*]] = add nsw i64 0, [[MUL59]]
// CHECK5-NEXT:    [[CONV61:%.*]] = trunc i64 [[ADD60]] to i32
// CHECK5-NEXT:    store i32 [[CONV61]], ptr [[I47]], align 4, !llvm.access.group [[ACC_GRP9]]
// CHECK5-NEXT:    [[TMP36:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_26]], align 4, !llvm.access.group [[ACC_GRP9]]
// CHECK5-NEXT:    [[CONV62:%.*]] = sext i32 [[TMP36]] to i64
// CHECK5-NEXT:    [[TMP37:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
// CHECK5-NEXT:    [[TMP38:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
...
// CHECK5-NEXT:    [[SUB63:%.*]] = sub i32 [[TMP39]], [[TMP40]]
// CHECK5-NEXT:    [[SUB64:%.*]] = sub i32 [[SUB63]], 1
// CHECK5-NEXT:    [[ADD65:%.*]] = add i32 [[SUB64]], 1
// CHECK5-NEXT:    [[DIV66:%.*]] = udiv i32 [[ADD65]], 1
// CHECK5-NEXT:    [[MUL67:%.*]] = mul i32 1, [[DIV66]]
// CHECK5-NEXT:    [[CONV68:%.*]] = zext i32 [[MUL67]] to i64
// CHECK5-NEXT:    [[DIV69:%.*]] = sdiv i64 [[TMP38]], [[CONV68]]
...
// CHECK5-NEXT:    [[SUB70:%.*]] = sub i32 [[TMP41]], [[TMP42]]
// CHECK5-NEXT:    [[SUB71:%.*]] = sub i32 [[SUB70]], 1
// CHECK5-NEXT:    [[ADD72:%.*]] = add i32 [[SUB71]], 1
// CHECK5-NEXT:    [[DIV73:%.*]] = udiv i32 [[ADD72]], 1
// CHECK5-NEXT:    [[MUL74:%.*]] = mul i32 1, [[DIV73]]
// CHECK5-NEXT:    [[CONV75:%.*]] = zext i32 [[MUL74]] to i64
// CHECK5-NEXT:    [[MUL76:%.*]] = mul nsw i64 [[DIV69]], [[CONV75]]
// CHECK5-NEXT:    [[SUB77:%.*]] = sub nsw i64 [[TMP37]], [[MUL76]]
// CHECK5-NEXT:    [[MUL78:%.*]] = mul nsw i64 [[SUB77]], 1
// CHECK5-NEXT:    [[ADD79:%.*]] = add nsw i64 [[CONV62]], [[MUL78]]
// CHECK5-NEXT:    [[CONV80:%.*]] = trunc i64 [[ADD79]] to i32
// CHECK5-NEXT:    store i32 [[CONV80]], ptr [[J48]], align 4, !llvm.access.group [[ACC_GRP9]]
// CHECK5-NEXT:    br label [[OMP_BODY_CONTINUE81:%.*]]
// CHECK5:       omp.body.continue81:
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_INC82:%.*]]
// CHECK5:       omp.inner.for.inc82:
// CHECK5-NEXT:    [[TMP43:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
// CHECK5-NEXT:    [[ADD83:%.*]] = add nsw i64 [[TMP43]], 1
// CHECK5-NEXT:    store i64 [[ADD83]], ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_COND49]], !llvm.loop [[LOOP10:![0-9]+]]
// CHECK5:       omp.inner.for.end84:
// CHECK5-NEXT:    [[TMP44:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_25]], align 4
// CHECK5-NEXT:    [[SUB85:%.*]] = sub nsw i32 [[TMP44]], 0
// CHECK5-NEXT:    [[DIV86:%.*]] = sdiv i32 [[SUB85]], 1
// CHECK5-NEXT:    [[MUL87:%.*]] = mul nsw i32 [[DIV86]], 1
// CHECK5-NEXT:    [[ADD88:%.*]] = add nsw i32 0, [[MUL87]]
// CHECK5-NEXT:    store i32 [[ADD88]], ptr [[I20]], align 4
...
// CHECK5-NEXT:    [[SUB89:%.*]] = sub i32 [[TMP46]], [[TMP47]]
// CHECK5-NEXT:    [[SUB90:%.*]] = sub i32 [[SUB89]], 1
// CHECK5-NEXT:    [[ADD91:%.*]] = add i32 [[SUB90]], 1
// CHECK5-NEXT:    [[DIV92:%.*]] = udiv i32 [[ADD91]], 1
// CHECK5-NEXT:    [[MUL93:%.*]] = mul i32 [[DIV92]], 1
// CHECK5-NEXT:    [[ADD94:%.*]] = add i32 [[TMP45]], [[MUL93]]
// CHECK5-NEXT:    store i32 [[ADD94]], ptr [[J48]], align 4
...
// CHECK6-NEXT:    [[DOTCAPTURE_EXPR_32:%.*]] = alloca i64, align 8
// CHECK6-NEXT:    [[DOTOMP_LB41:%.*]] = alloca i64, align 8
// CHECK6-NEXT:    [[DOTOMP_UB42:%.*]] = alloca i64, align 8
// CHECK6-NEXT:    [[I43:%.*]] = alloca i32, align 4
// CHECK6-NEXT:    [[J:%.*]] = alloca i32, align 4
// CHECK6-NEXT:    [[DOTOMP_IV46:%.*]] = alloca i64, align 8
// CHECK6-NEXT:    [[I47:%.*]] = alloca i32, align 4
// CHECK6-NEXT:    [[J48:%.*]] = alloca i32, align 4
...
// CHECK6-NEXT:    [[ARRAYIDX29:%.*]] = getelementptr inbounds b8, ptr [[TMP18]], i64 [[IDXPROM28]]
// CHECK6-NEXT:    [[TMP20:%.*]] = load b8, ptr [[ARRAYIDX29]], align 1
// CHECK6-NEXT:    [[CONV30:%.*]] = bytecast b8 [[TMP20]] to i8
// CHECK6-NEXT:    [[CONV31:%.*]] = sext i8 [[CONV30]] to i32
// CHECK6-NEXT:    store i32 [[CONV31]], ptr [[DOTCAPTURE_EXPR_27]], align 4
...
// CHECK6-NEXT:    [[CONV33:%.*]] = sext i32 [[DIV]] to i64
// CHECK6-NEXT:    [[TMP22:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_27]], align 4
// CHECK6-NEXT:    [[TMP23:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_26]], align 4
// CHECK6-NEXT:    [[SUB34:%.*]] = sub i32 [[TMP22]], [[TMP23]]
// CHECK6-NEXT:    [[SUB35:%.*]] = sub i32 [[SUB34]], 1
// CHECK6-NEXT:    [[ADD36:%.*]] = add i32 [[SUB35]], 1
// CHECK6-NEXT:    [[DIV37:%.*]] = udiv i32 [[ADD36]], 1
// CHECK6-NEXT:    [[CONV38:%.*]] = zext i32 [[DIV37]] to i64
// CHECK6-NEXT:    [[MUL39:%.*]] = mul nsw i64 [[CONV33]], [[CONV38]]
// CHECK6-NEXT:    [[SUB40:%.*]] = sub nsw i64 [[MUL39]], 1
// CHECK6-NEXT:    store i64 [[SUB40]], ptr [[DOTCAPTURE_EXPR_32]], align 8
// CHECK6-NEXT:    store i64 0, ptr [[DOTOMP_LB41]], align 8
// CHECK6-NEXT:    [[TMP24:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_32]], align 8
// CHECK6-NEXT:    store i64 [[TMP24]], ptr [[DOTOMP_UB42]], align 8
// CHECK6-NEXT:    store i32 0, ptr [[I43]], align 4
...
// CHECK6-NEXT:    [[CMP44:%.*]] = icmp slt i32 0, [[TMP26]]
// CHECK6-NEXT:    br i1 [[CMP44]], label [[LAND_LHS_TRUE:%.*]], label [[SIMD_IF_END:%.*]]
...
// CHECK6-NEXT:    [[CMP45:%.*]] = icmp slt i32 [[TMP27]], [[TMP28]]
// CHECK6-NEXT:    br i1 [[CMP45]], label [[SIMD_IF_THEN:%.*]], label [[SIMD_IF_END]]
// CHECK6:       simd.if.then:
// CHECK6-NEXT:    [[TMP29:%.*]] = load i64, ptr [[DOTOMP_LB41]], align 8
// CHECK6-NEXT:    store i64 [[TMP29]], ptr [[DOTOMP_IV46]], align 8
// CHECK6-NEXT:    [[TMP30:%.*]] = load ptr, ptr [[ARGV_ADDR]], align 8
// CHECK6-NEXT:    call void @llvm.assume(i1 true) [ "align"(ptr [[TMP30]], i64 8) ]
// CHECK6-NEXT:    br label [[OMP_INNER_FOR_COND49:%.*]]
// CHECK6:       omp.inner.for.cond49:
// CHECK6-NEXT:    [[TMP31:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9:![0-9]+]]
// CHECK6-NEXT:    [[TMP32:%.*]] = load i64, ptr [[DOTOMP_UB42]], align 8, !llvm.access.group [[ACC_GRP9]]
// CHECK6-NEXT:    [[CMP50:%.*]] = icmp ule i64 [[TMP31]], [[TMP32]]
// CHECK6-NEXT:    br i1 [[CMP50]], label [[OMP_INNER_FOR_BODY51:%.*]], label [[OMP_INNER_FOR_END84:%.*]]
// CHECK6:       omp.inner.for.body51:
// CHECK6-NEXT:    [[TMP33:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
...
// CHECK6-NEXT:    [[SUB52:%.*]] = sub i32 [[TMP34]], [[TMP35]]
// CHECK6-NEXT:    [[SUB53:%.*]] = sub i32 [[SUB52]], 1
// CHECK6-NEXT:    [[ADD54:%.*]] = add i32 [[SUB53]], 1
// CHECK6-NEXT:    [[DIV55:%.*]] = udiv i32 [[ADD54]], 1
// CHECK6-NEXT:    [[MUL56:%.*]] = mul i32 1, [[DIV55]]
// CHECK6-NEXT:    [[CONV57:%.*]] = zext i32 [[MUL56]] to i64
// CHECK6-NEXT:    [[DIV58:%.*]] = sdiv i64 [[TMP33]], [[CONV57]]
// CHECK6-NEXT:    [[MUL59:%.*]] = mul nsw i64 [[DIV58]], 1
// CHECK6-NEXT:    [[ADD60:%.*]] = add nsw i64 0, [[MUL59]]
// CHECK6-NEXT:    [[CONV61:%.*]] = trunc i64 [[ADD60]] to i32
// CHECK6-NEXT:    store i32 [[CONV61]], ptr [[I47]], align 4, !llvm.access.group [[ACC_GRP9]]
// CHECK6-NEXT:    [[TMP36:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_26]], align 4, !llvm.access.group [[ACC_GRP9]]
// CHECK6-NEXT:    [[CONV62:%.*]] = sext i32 [[TMP36]] to i64
// CHECK6-NEXT:    [[TMP37:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
// CHECK6-NEXT:    [[TMP38:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
...
// CHECK6-NEXT:    [[SUB63:%.*]] = sub i32 [[TMP39]], [[TMP40]]
// CHECK6-NEXT:    [[SUB64:%.*]] = sub i32 [[SUB63]], 1
// CHECK6-NEXT:    [[ADD65:%.*]] = add i32 [[SUB64]], 1
// CHECK6-NEXT:    [[DIV66:%.*]] = udiv i32 [[ADD65]], 1
// CHECK6-NEXT:    [[MUL67:%.*]] = mul i32 1, [[DIV66]]
// CHECK6-NEXT:    [[CONV68:%.*]] = zext i32 [[MUL67]] to i64
// CHECK6-NEXT:    [[DIV69:%.*]] = sdiv i64 [[TMP38]], [[CONV68]]
...
// CHECK6-NEXT:    [[SUB70:%.*]] = sub i32 [[TMP41]], [[TMP42]]
// CHECK6-NEXT:    [[SUB71:%.*]] = sub i32 [[SUB70]], 1
// CHECK6-NEXT:    [[ADD72:%.*]] = add i32 [[SUB71]], 1
// CHECK6-NEXT:    [[DIV73:%.*]] = udiv i32 [[ADD72]], 1
// CHECK6-NEXT:    [[MUL74:%.*]] = mul i32 1, [[DIV73]]
// CHECK6-NEXT:    [[CONV75:%.*]] = zext i32 [[MUL74]] to i64
// CHECK6-NEXT:    [[MUL76:%.*]] = mul nsw i64 [[DIV69]], [[CONV75]]
// CHECK6-NEXT:    [[SUB77:%.*]] = sub nsw i64 [[TMP37]], [[MUL76]]
// CHECK6-NEXT:    [[MUL78:%.*]] = mul nsw i64 [[SUB77]], 1
// CHECK6-NEXT:    [[ADD79:%.*]] = add nsw i64 [[CONV62]], [[MUL78]]
// CHECK6-NEXT:    [[CONV80:%.*]] = trunc i64 [[ADD79]] to i32
// CHECK6-NEXT:    store i32 [[CONV80]], ptr [[J48]], align 4, !llvm.access.group [[ACC_GRP9]]
// CHECK6-NEXT:    br label [[OMP_BODY_CONTINUE81:%.*]]
// CHECK6:       omp.body.continue81:
// CHECK6-NEXT:    br label [[OMP_INNER_FOR_INC82:%.*]]
// CHECK6:       omp.inner.for.inc82:
// CHECK6-NEXT:    [[TMP43:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
// CHECK6-NEXT:    [[ADD83:%.*]] = add nsw i64 [[TMP43]], 1
// CHECK6-NEXT:    store i64 [[ADD83]], ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
// CHECK6-NEXT:    br label [[OMP_INNER_FOR_COND49]], !llvm.loop [[LOOP10:![0-9]+]]
// CHECK6:       omp.inner.for.end84:
// CHECK6-NEXT:    [[TMP44:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_25]], align 4
// CHECK6-NEXT:    [[SUB85:%.*]] = sub nsw i32 [[TMP44]], 0
// CHECK6-NEXT:    [[DIV86:%.*]] = sdiv i32 [[SUB85]], 1
// CHECK6-NEXT:    [[MUL87:%.*]] = mul nsw i32 [[DIV86]], 1
// CHECK6-NEXT:    [[ADD88:%.*]] = add nsw i32 0, [[MUL87]]
// CHECK6-NEXT:    store i32 [[ADD88]], ptr [[I20]], align 4
...
// CHECK6-NEXT:    [[SUB89:%.*]] = sub i32 [[TMP46]], [[TMP47]]
// CHECK6-NEXT:    [[SUB90:%.*]] = sub i32 [[SUB89]], 1
// CHECK6-NEXT:    [[ADD91:%.*]] = add i32 [[SUB90]], 1
// CHECK6-NEXT:    [[DIV92:%.*]] = udiv i32 [[ADD91]], 1
// CHECK6-NEXT:    [[MUL93:%.*]] = mul i32 [[DIV92]], 1
// CHECK6-NEXT:    [[ADD94:%.*]] = add i32 [[TMP45]], [[MUL93]]
// CHECK6-NEXT:    store i32 [[ADD94]], ptr [[J48]], align 4
...
// CHECK7-NEXT:    [[DOTCAPTURE_EXPR_32:%.*]] = alloca i64, align 8
// CHECK7-NEXT:    [[DOTOMP_LB41:%.*]] = alloca i64, align 8
// CHECK7-NEXT:    [[DOTOMP_UB42:%.*]] = alloca i64, align 8
// CHECK7-NEXT:    [[I43:%.*]] = alloca i32, align 4
// CHECK7-NEXT:    [[J:%.*]] = alloca i32, align 4
// CHECK7-NEXT:    [[DOTOMP_IV46:%.*]] = alloca i64, align 8
// CHECK7-NEXT:    [[I47:%.*]] = alloca i32, align 4
// CHECK7-NEXT:    [[J48:%.*]] = alloca i32, align 4
...
// CHECK7-NEXT:    [[ARRAYIDX29:%.*]] = getelementptr inbounds b8, ptr [[TMP18]], i64 [[IDXPROM28]]
// CHECK7-NEXT:    [[TMP20:%.*]] = load b8, ptr [[ARRAYIDX29]], align 1
// CHECK7-NEXT:    [[CONV30:%.*]] = bytecast b8 [[TMP20]] to i8
// CHECK7-NEXT:    [[CONV31:%.*]] = sext i8 [[CONV30]] to i32
// CHECK7-NEXT:    store i32 [[CONV31]], ptr [[DOTCAPTURE_EXPR_27]], align 4
...
// CHECK7-NEXT:    [[CONV33:%.*]] = sext i32 [[DIV]] to i64
// CHECK7-NEXT:    [[TMP22:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_27]], align 4
// CHECK7-NEXT:    [[TMP23:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_26]], align 4
// CHECK7-NEXT:    [[SUB34:%.*]] = sub i32 [[TMP22]], [[TMP23]]
// CHECK7-NEXT:    [[SUB35:%.*]] = sub i32 [[SUB34]], 1
// CHECK7-NEXT:    [[ADD36:%.*]] = add i32 [[SUB35]], 1
// CHECK7-NEXT:    [[DIV37:%.*]] = udiv i32 [[ADD36]], 1
// CHECK7-NEXT:    [[CONV38:%.*]] = zext i32 [[DIV37]] to i64
// CHECK7-NEXT:    [[MUL39:%.*]] = mul nsw i64 [[CONV33]], [[CONV38]]
// CHECK7-NEXT:    [[SUB40:%.*]] = sub nsw i64 [[MUL39]], 1
// CHECK7-NEXT:    store i64 [[SUB40]], ptr [[DOTCAPTURE_EXPR_32]], align 8
// CHECK7-NEXT:    store i64 0, ptr [[DOTOMP_LB41]], align 8
// CHECK7-NEXT:    [[TMP24:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_32]], align 8
// CHECK7-NEXT:    store i64 [[TMP24]], ptr [[DOTOMP_UB42]], align 8
// CHECK7-NEXT:    store i32 0, ptr [[I43]], align 4
...
// CHECK7-NEXT:    [[CMP44:%.*]] = icmp slt i32 0, [[TMP26]]
// CHECK7-NEXT:    br i1 [[CMP44]], label [[LAND_LHS_TRUE:%.*]], label [[SIMD_IF_END:%.*]]
...
// CHECK7-NEXT:    [[CMP45:%.*]] = icmp slt i32 [[TMP27]], [[TMP28]]
// CHECK7-NEXT:    br i1 [[CMP45]], label [[SIMD_IF_THEN:%.*]], label [[SIMD_IF_END]]
// CHECK7:       simd.if.then:
// CHECK7-NEXT:    [[TMP29:%.*]] = load i64, ptr [[DOTOMP_LB41]], align 8
// CHECK7-NEXT:    store i64 [[TMP29]], ptr [[DOTOMP_IV46]], align 8
...
// CHECK7-NEXT:    [[TMP32:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9:![0-9]+]]
// CHECK7-NEXT:    [[TMP33:%.*]] = load i64, ptr [[DOTOMP_UB42]], align 8, !llvm.access.group [[ACC_GRP9]]
...
// CHECK7-NEXT:    [[TMP34:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
...
// CHECK7-NEXT:    store i32 [[CONV61]], ptr [[I47]], align 4, !llvm.access.group [[ACC_GRP9]]
...
// CHECK7-NEXT:    [[TMP38:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
// CHECK7-NEXT:    [[TMP39:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
...
// CHECK7-NEXT:    store i32 [[CONV80]], ptr [[J48]], align 4, !llvm.access.group [[ACC_GRP9]]
...
// CHECK7-NEXT:    [[TMP44:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
// CHECK7-NEXT:    [[ADD83:%.*]] = add nsw i64 [[TMP44]], 1
// CHECK7-NEXT:    store i64 [[ADD83]], ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
...
// CHECK7-NEXT:    [[TMP45:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8
// CHECK7-NEXT:    [[TMP46:%.*]] = load i64, ptr [[DOTOMP_UB42]], align 8
...
// CHECK7-NEXT:    [[TMP47:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8
...
// CHECK7-NEXT:    store i32 [[CONV97]], ptr [[I47]], align 4
// CHECK7-NEXT:    [[TMP50:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_26]], align 4
// CHECK7-NEXT:    [[CONV98:%.*]] = sext i32 [[TMP50]] to i64
// CHECK7-NEXT:    [[TMP51:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8
// CHECK7-NEXT:    [[TMP52:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8
...
// CHECK7-NEXT:    store i32 [[CONV116]], ptr [[J48]], align 4
...
// CHECK7-NEXT:    [[TMP57:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8
// CHECK7-NEXT:    [[ADD119:%.*]] = add nsw i64 [[TMP57]], 1
// CHECK7-NEXT:    store i64 [[ADD119]], ptr [[DOTOMP_IV46]], align 8
...
// CHECK7-NEXT:    store i32 [[ADD130]], ptr [[J48]], align 4
...
// CHECK8-NEXT:    [[DOTCAPTURE_EXPR_32:%.*]] = alloca i64, align 8
// CHECK8-NEXT:    [[DOTOMP_LB41:%.*]] = alloca i64, align 8
// CHECK8-NEXT:    [[DOTOMP_UB42:%.*]] = alloca i64, align 8
// CHECK8-NEXT:    [[I43:%.*]] = alloca i32, align 4
// CHECK8-NEXT:    [[J:%.*]] = alloca i32, align 4
// CHECK8-NEXT:    [[DOTOMP_IV46:%.*]] = alloca i64, align 8
// CHECK8-NEXT:    [[I47:%.*]] = alloca i32, align 4
// CHECK8-NEXT:    [[J48:%.*]] = alloca i32, align 4
...
// CHECK8-NEXT:    [[ARRAYIDX29:%.*]] = getelementptr inbounds b8, ptr [[TMP18]], i64 [[IDXPROM28]]
// CHECK8-NEXT:    [[TMP20:%.*]] = load b8, ptr [[ARRAYIDX29]], align 1
// CHECK8-NEXT:    [[CONV30:%.*]] = bytecast b8 [[TMP20]] to i8
// CHECK8-NEXT:    [[CONV31:%.*]] = sext i8 [[CONV30]] to i32
// CHECK8-NEXT:    store i32 [[CONV31]], ptr [[DOTCAPTURE_EXPR_27]], align 4
...
// CHECK8-NEXT:    [[CONV33:%.*]] = sext i32 [[DIV]] to i64
// CHECK8-NEXT:    [[TMP22:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_27]], align 4
// CHECK8-NEXT:    [[TMP23:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_26]], align 4
// CHECK8-NEXT:    [[SUB34:%.*]] = sub i32 [[TMP22]], [[TMP23]]
// CHECK8-NEXT:    [[SUB35:%.*]] = sub i32 [[SUB34]], 1
// CHECK8-NEXT:    [[ADD36:%.*]] = add i32 [[SUB35]], 1
// CHECK8-NEXT:    [[DIV37:%.*]] = udiv i32 [[ADD36]], 1
// CHECK8-NEXT:    [[CONV38:%.*]] = zext i32 [[DIV37]] to i64
// CHECK8-NEXT:    [[MUL39:%.*]] = mul nsw i64 [[CONV33]], [[CONV38]]
// CHECK8-NEXT:    [[SUB40:%.*]] = sub nsw i64 [[MUL39]], 1
// CHECK8-NEXT:    store i64 [[SUB40]], ptr [[DOTCAPTURE_EXPR_32]], align 8
// CHECK8-NEXT:    store i64 0, ptr [[DOTOMP_LB41]], align 8
// CHECK8-NEXT:    [[TMP24:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_32]], align 8
// CHECK8-NEXT:    store i64 [[TMP24]], ptr [[DOTOMP_UB42]], align 8
// CHECK8-NEXT:    store i32 0, ptr [[I43]], align 4
...
// CHECK8-NEXT:    [[CMP44:%.*]] = icmp slt i32 0, [[TMP26]]
// CHECK8-NEXT:    br i1 [[CMP44]], label [[LAND_LHS_TRUE:%.*]], label [[SIMD_IF_END:%.*]]
...
// CHECK8-NEXT:    [[CMP45:%.*]] = icmp slt i32 [[TMP27]], [[TMP28]]
// CHECK8-NEXT:    br i1 [[CMP45]], label [[SIMD_IF_THEN:%.*]], label [[SIMD_IF_END]]
// CHECK8:       simd.if.then:
// CHECK8-NEXT:    [[TMP29:%.*]] = load i64, ptr [[DOTOMP_LB41]], align 8
// CHECK8-NEXT:    store i64 [[TMP29]], ptr [[DOTOMP_IV46]], align 8
...
// CHECK8-NEXT:    [[TMP32:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9:![0-9]+]]
// CHECK8-NEXT:    [[TMP33:%.*]] = load i64, ptr [[DOTOMP_UB42]], align 8, !llvm.access.group [[ACC_GRP9]]
...
// CHECK8-NEXT:    [[TMP34:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
...
// CHECK8-NEXT:    store i32 [[CONV61]], ptr [[I47]], align 4, !llvm.access.group [[ACC_GRP9]]
...
// CHECK8-NEXT:    [[TMP38:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
// CHECK8-NEXT:    [[TMP39:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
...
// CHECK8-NEXT:    store i32 [[CONV80]], ptr [[J48]], align 4, !llvm.access.group [[ACC_GRP9]]
...
// CHECK8-NEXT:    [[TMP44:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
// CHECK8-NEXT:    [[ADD83:%.*]] = add nsw i64 [[TMP44]], 1
// CHECK8-NEXT:    store i64 [[ADD83]], ptr [[DOTOMP_IV46]], align 8, !llvm.access.group [[ACC_GRP9]]
...
// CHECK8-NEXT:    [[TMP45:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8
// CHECK8-NEXT:    [[TMP46:%.*]] = load i64, ptr [[DOTOMP_UB42]], align 8
...
// CHECK8-NEXT:    [[TMP47:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8
...
// CHECK8-NEXT:    store i32 [[CONV97]], ptr [[I47]], align 4
// CHECK8-NEXT:    [[TMP50:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_26]], align 4
// CHECK8-NEXT:    [[CONV98:%.*]] = sext i32 [[TMP50]] to i64
// CHECK8-NEXT:    [[TMP51:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8
// CHECK8-NEXT:    [[TMP52:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8
...
// CHECK8-NEXT:    store i32 [[CONV116]], ptr [[J48]], align 4
...
// CHECK8-NEXT:    [[TMP57:%.*]] = load i64, ptr [[DOTOMP_IV46]], align 8
// CHECK8-NEXT:    [[ADD119:%.*]] = add nsw i64 [[TMP57]], 1
// CHECK8-NEXT:    store i64 [[ADD119]], ptr [[DOTOMP_IV46]], align 8
...
// CHECK8-NEXT:    store i32 [[ADD130]], ptr [[J48]], align 4
