...
// CHECK1-NEXT:    [[TMP78:%.*]] = getelementptr b8, ptr [[ARRAYIDX2]], i64 [[TMP11]]
...
// CHECK1-NEXT:    [[TMP79:%.*]] = load b8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST12]], align 1
// CHECK1-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP79]] to i8
// CHECK1-NEXT:    [[CONV13:%.*]] = sext i8 [[CONV]] to i32
// CHECK1-NEXT:    [[TMP80:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1
// CHECK1-NEXT:    [[CONV14:%.*]] = bytecast exact b8 [[TMP80]] to i8
...
// CHECK1-NEXT:    [[TMP81:%.*]] = bitcast i8 [[CONV17]] to b8
// CHECK1-NEXT:    store b8 [[TMP81]], ptr [[OMP_ARRAYCPY_DESTELEMENTPAST12]], align 1
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE19:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT18]], [[TMP78]]
...
// CHECK1-NEXT:    [[TMP84:%.*]] = getelementptr b8, ptr [[ARRAYIDX2]], i64 [[TMP11]]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY21:%.*]] = icmp eq ptr [[ARRAYIDX2]], [[TMP84]]
...
// CHECK1-NEXT:    [[TMP85:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
// CHECK1-NEXT:    [[CONV25:%.*]] = bytecast exact b8 [[TMP85]] to i8
...
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP86:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY22]] ], [ [[TMP93:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    [[TMP87:%.*]] = bitcast i8 [[TMP86]] to b8
// CHECK1-NEXT:    store b8 [[TMP87]], ptr [[_TMP27]], align 1
// CHECK1-NEXT:    [[TMP88:%.*]] = load b8, ptr [[_TMP27]], align 1
// CHECK1-NEXT:    [[CONV28:%.*]] = bytecast exact b8 [[TMP88]] to i8
// CHECK1-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK1-NEXT:    [[TMP89:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
// CHECK1-NEXT:    [[CONV30:%.*]] = bytecast exact b8 [[TMP89]] to i8
...
// CHECK1-NEXT:    [[TMP90:%.*]] = bitcast i8 [[CONV33]] to b8
// CHECK1-NEXT:    store b8 [[TMP90]], ptr [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP91:%.*]] = load i8, ptr [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP92:%.*]] = cmpxchg ptr [[OMP_ARRAYCPY_DESTELEMENTPAST24]], i8 [[TMP86]], i8 [[TMP91]] monotonic monotonic, align 1
// CHECK1-NEXT:    [[TMP93]] = extractvalue { i8, i1 } [[TMP92]], 0
// CHECK1-NEXT:    [[TMP94:%.*]] = extractvalue { i8, i1 } [[TMP92]], 1
// CHECK1-NEXT:    br i1 [[TMP94]], label [[ATOMIC_EXIT]], label [[ATOMIC_CONT]]
// CHECK1:       atomic_exit:
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE36:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT34]], [[TMP84]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYCPY_DONE36]], label [[OMP_ARRAYCPY_DONE37]], label [[OMP_ARRAYCPY_BODY22]]
// CHECK1:       omp.arraycpy.done37:
// CHECK1-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK1:       .omp.reduction.default:
// CHECK1-NEXT:    [[TMP95:%.*]] = load ptr, ptr [[SAVED_STACK]], align 8
// CHECK1-NEXT:    call void @llvm.stackrestore.p0(ptr [[TMP95]])
