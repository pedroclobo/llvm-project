...
// CHECK1-NEXT:    [[TMP91:%.*]] = load b8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST12]], align 1
...
// CHECK1-NEXT:    [[CONV14:%.*]] = bytecast exact b8 [[TMP92]] to i8
...
// CHECK1-NEXT:    [[TMP93:%.*]] = bitcast i8 [[CONV17]] to b8
// CHECK1-NEXT:    store b8 [[TMP93]], ptr [[OMP_ARRAYCPY_DESTELEMENTPAST12]], align 1
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE19:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT18]], [[TMP90]]
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY21:%.*]] = icmp eq ptr [[ARRAYIDX2]], [[TMP96]]
...
// CHECK1-NEXT:    [[TMP97:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
// CHECK1-NEXT:    [[CONV25:%.*]] = bytecast exact b8 [[TMP97]] to i8
...
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP98:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY22]] ], [ [[TMP105:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    [[TMP99:%.*]] = bitcast i8 [[TMP98]] to b8
// CHECK1-NEXT:    store b8 [[TMP99]], ptr [[_TMP27]], align 1
// CHECK1-NEXT:    [[TMP100:%.*]] = load b8, ptr [[_TMP27]], align 1
// CHECK1-NEXT:    [[CONV28:%.*]] = bytecast exact b8 [[TMP100]] to i8
// CHECK1-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK1-NEXT:    [[TMP101:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
// CHECK1-NEXT:    [[CONV30:%.*]] = bytecast exact b8 [[TMP101]] to i8
...
// CHECK1-NEXT:    [[TMP102:%.*]] = bitcast i8 [[CONV33]] to b8
// CHECK1-NEXT:    store b8 [[TMP102]], ptr [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP103:%.*]] = load i8, ptr [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP104:%.*]] = cmpxchg ptr [[OMP_ARRAYCPY_DESTELEMENTPAST24]], i8 [[TMP98]], i8 [[TMP103]] monotonic monotonic, align 1
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE36:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT34]], [[TMP96]]
