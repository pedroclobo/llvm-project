...
// CHECK1-NEXT:    [[_TMP27:%.*]] = alloca b8, align 1
...
// CHECK1-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds nuw b8, ptr [[TMP3]], i64 0
...
// CHECK1-NEXT:    [[ARRAYIDX4:%.*]] = getelementptr inbounds nuw b8, ptr [[TMP7]], i64 [[LB_ADD_LEN]]
...
// CHECK1-NEXT:    [[TMP11:%.*]] = sdiv exact i64 [[TMP10]], ptrtoint (ptr getelementptr (b8, ptr null, i32 1) to i64)
// CHECK1-NEXT:    [[TMP12:%.*]] = add nuw i64 [[TMP11]], 1
// CHECK1-NEXT:    [[TMP13:%.*]] = mul nuw i64 [[TMP12]], ptrtoint (ptr getelementptr (b8, ptr null, i32 1) to i64)
// CHECK1-NEXT:    [[TMP14:%.*]] = call ptr @llvm.stacksave.p0()
// CHECK1-NEXT:    store ptr [[TMP14]], ptr [[SAVED_STACK]], align 8
// CHECK1-NEXT:    [[VLA:%.*]] = alloca b8, i64 [[TMP12]], align 16
// CHECK1-NEXT:    store i64 [[TMP12]], ptr [[__VLA_EXPR0]], align 8
// CHECK1-NEXT:    [[TMP15:%.*]] = getelementptr b8, ptr [[VLA]], i64 [[TMP12]]
...
// CHECK1-NEXT:    [[TMP16:%.*]] = bytecast exact b8 0 to i8
// CHECK1-NEXT:    store i8 [[TMP16]], ptr [[OMP_ARRAYCPY_DESTELEMENTPAST]], align 1
...
// CHECK1-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[TMP1]], align 8
...
// CHECK1-NEXT:    [[TMP22:%.*]] = sdiv exact i64 [[TMP21]], ptrtoint (ptr getelementptr (b8, ptr null, i32 1) to i64)
// CHECK1-NEXT:    [[TMP23:%.*]] = getelementptr b8, ptr [[VLA]], i64 [[TMP22]]
// CHECK1-NEXT:    store ptr [[_TMP5]], ptr [[TMP]], align 8
// CHECK1-NEXT:    store ptr [[TMP23]], ptr [[_TMP5]], align 8
...
// CHECK1-NEXT:    [[TMP31:%.*]] = getelementptr inbounds nuw [[STRUCT_KMP_TASKRED_INPUT_T]], ptr [[DOTRD_INPUT_GEP_6]], i32 0, i32 0
// CHECK1-NEXT:    [[TMP32:%.*]] = load ptr, ptr [[TMP1]], align 8
// CHECK1-NEXT:    [[ARRAYIDX7:%.*]] = getelementptr inbounds nuw ptr, ptr [[TMP32]], i64 0
// CHECK1-NEXT:    [[TMP33:%.*]] = load ptr, ptr [[ARRAYIDX7]], align 8
// CHECK1-NEXT:    [[ARRAYIDX8:%.*]] = getelementptr inbounds nuw b8, ptr [[TMP33]], i64 0
// CHECK1-NEXT:    [[TMP34:%.*]] = load i32, ptr [[TMP0]], align 4
// CHECK1-NEXT:    [[TMP35:%.*]] = sext i32 [[TMP34]] to i64
// CHECK1-NEXT:    [[LB_ADD_LEN9:%.*]] = add nsw i64 -1, [[TMP35]]
// CHECK1-NEXT:    [[TMP36:%.*]] = load ptr, ptr [[TMP1]], align 8
// CHECK1-NEXT:    [[ARRAYIDX10:%.*]] = getelementptr inbounds nuw ptr, ptr [[TMP36]], i64 9
// CHECK1-NEXT:    [[TMP37:%.*]] = load ptr, ptr [[ARRAYIDX10]], align 8
// CHECK1-NEXT:    [[ARRAYIDX11:%.*]] = getelementptr inbounds nuw b8, ptr [[TMP37]], i64 [[LB_ADD_LEN9]]
// CHECK1-NEXT:    store ptr [[VLA]], ptr [[TMP31]], align 8
// CHECK1-NEXT:    [[TMP38:%.*]] = getelementptr inbounds nuw [[STRUCT_KMP_TASKRED_INPUT_T]], ptr [[DOTRD_INPUT_GEP_6]], i32 0, i32 1
// CHECK1-NEXT:    store ptr [[ARRAYIDX8]], ptr [[TMP38]], align 8
// CHECK1-NEXT:    [[TMP39:%.*]] = ptrtoint ptr [[ARRAYIDX11]] to i64
// CHECK1-NEXT:    [[TMP40:%.*]] = ptrtoint ptr [[ARRAYIDX8]] to i64
// CHECK1-NEXT:    [[TMP41:%.*]] = sub i64 [[TMP39]], [[TMP40]]
// CHECK1-NEXT:    [[TMP42:%.*]] = sdiv exact i64 [[TMP41]], ptrtoint (ptr getelementptr (b8, ptr null, i32 1) to i64)
// CHECK1-NEXT:    [[TMP43:%.*]] = add nuw i64 [[TMP42]], 1
// CHECK1-NEXT:    [[TMP44:%.*]] = mul nuw i64 [[TMP43]], ptrtoint (ptr getelementptr (b8, ptr null, i32 1) to i64)
// CHECK1-NEXT:    [[TMP45:%.*]] = getelementptr inbounds nuw [[STRUCT_KMP_TASKRED_INPUT_T]], ptr [[DOTRD_INPUT_GEP_6]], i32 0, i32 2
// CHECK1-NEXT:    store i64 [[TMP44]], ptr [[TMP45]], align 8
// CHECK1-NEXT:    [[TMP46:%.*]] = getelementptr inbounds nuw [[STRUCT_KMP_TASKRED_INPUT_T]], ptr [[DOTRD_INPUT_GEP_6]], i32 0, i32 3
// CHECK1-NEXT:    store ptr @.red_init..1, ptr [[TMP46]], align 8
// CHECK1-NEXT:    [[TMP47:%.*]] = getelementptr inbounds nuw [[STRUCT_KMP_TASKRED_INPUT_T]], ptr [[DOTRD_INPUT_GEP_6]], i32 0, i32 4
// CHECK1-NEXT:    store ptr null, ptr [[TMP47]], align 8
// CHECK1-NEXT:    [[TMP48:%.*]] = getelementptr inbounds nuw [[STRUCT_KMP_TASKRED_INPUT_T]], ptr [[DOTRD_INPUT_GEP_6]], i32 0, i32 5
// CHECK1-NEXT:    store ptr @.red_comb..2, ptr [[TMP48]], align 8
// CHECK1-NEXT:    [[TMP49:%.*]] = getelementptr inbounds nuw [[STRUCT_KMP_TASKRED_INPUT_T]], ptr [[DOTRD_INPUT_GEP_6]], i32 0, i32 6
...
// CHECK1-NEXT:    call void @__kmpc_for_static_init_4(ptr @[[GLOB2:[0-9]+]], i32 [[TMP54]], i32 34, ptr [[DOTOMP_SECTIONS_IL_]], ptr [[DOTOMP_SECTIONS_LB_]], ptr [[DOTOMP_SECTIONS_UB_]], ptr [[DOTOMP_SECTIONS_ST_]], i32 1, i32 1)
// CHECK1-NEXT:    [[TMP55:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_UB_]], align 4
// CHECK1-NEXT:    [[TMP56:%.*]] = icmp slt i32 [[TMP55]], 0
// CHECK1-NEXT:    [[TMP57:%.*]] = select i1 [[TMP56]], i32 [[TMP55]], i32 0
// CHECK1-NEXT:    store i32 [[TMP57]], ptr [[DOTOMP_SECTIONS_UB_]], align 4
// CHECK1-NEXT:    [[TMP58:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_LB_]], align 4
// CHECK1-NEXT:    store i32 [[TMP58]], ptr [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK1:       omp.inner.for.cond:
// CHECK1-NEXT:    [[TMP59:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK1-NEXT:    [[TMP60:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_UB_]], align 4
// CHECK1-NEXT:    [[CMP:%.*]] = icmp sle i32 [[TMP59]], [[TMP60]]
...
// CHECK1-NEXT:    switch i32 [[TMP61]], label [[DOTOMP_SECTIONS_EXIT:%.*]] [
...
// CHECK1-NEXT:    [[TMP65:%.*]] = load ptr, ptr [[TMP]], align 8
...
// CHECK1-NEXT:    [[TMP78:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK1-NEXT:    [[INC:%.*]] = add nsw i32 [[TMP78]], 1
...
// CHECK1-NEXT:    call void @__kmpc_for_static_fini(ptr @[[GLOB2]], i32 [[TMP80]])
...
// CHECK1-NEXT:    [[TMP86:%.*]] = inttoptr i64 [[TMP12]] to ptr
...
// CHECK1-NEXT:    [[TMP89:%.*]] = call i32 @__kmpc_reduce(ptr @[[GLOB3:[0-9]+]], i32 [[TMP88]], i32 2, i64 24, ptr [[DOTOMP_REDUCTION_RED_LIST]], ptr @main.omp_outlined.omp.reduction.reduction_func, ptr @.gomp_critical_user_.reduction.var)
...
// CHECK1-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP90]], [[TMP91]]
// CHECK1-NEXT:    store i32 [[ADD]], ptr [[TMP0]], align 4
// CHECK1-NEXT:    [[TMP92:%.*]] = getelementptr b8, ptr [[ARRAYIDX2]], i64 [[TMP12]]
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DESTELEMENTPAST12:%.*]] = phi ptr [ [[ARRAYIDX2]], [[DOTOMP_REDUCTION_CASE1]] ], [ [[OMP_ARRAYCPY_DEST_ELEMENT18:%.*]], [[OMP_ARRAYCPY_BODY]] ]
// CHECK1-NEXT:    [[TMP93:%.*]] = load b8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST12]], align 1
// CHECK1-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP93]] to i8
// CHECK1-NEXT:    [[CONV13:%.*]] = sext i8 [[CONV]] to i32
// CHECK1-NEXT:    [[TMP94:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1
// CHECK1-NEXT:    [[CONV14:%.*]] = bytecast exact b8 [[TMP94]] to i8
// CHECK1-NEXT:    [[CONV15:%.*]] = sext i8 [[CONV14]] to i32
// CHECK1-NEXT:    [[ADD16:%.*]] = add nsw i32 [[CONV13]], [[CONV15]]
// CHECK1-NEXT:    [[CONV17:%.*]] = trunc i32 [[ADD16]] to i8
// CHECK1-NEXT:    [[TMP95:%.*]] = bitcast i8 [[CONV17]] to b8
// CHECK1-NEXT:    store b8 [[TMP95]], ptr [[OMP_ARRAYCPY_DESTELEMENTPAST12]], align 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DEST_ELEMENT18]] = getelementptr b8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST12]], i32 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_SRC_ELEMENT]] = getelementptr b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], i32 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE19:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT18]], [[TMP92]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYCPY_DONE19]], label [[OMP_ARRAYCPY_DONE20]], label [[OMP_ARRAYCPY_BODY]]
// CHECK1:       omp.arraycpy.done20:
// CHECK1-NEXT:    call void @__kmpc_end_reduce(ptr @[[GLOB3]], i32 [[TMP88]], ptr @.gomp_critical_user_.reduction.var)
...
// CHECK1-NEXT:    [[TMP98:%.*]] = getelementptr b8, ptr [[ARRAYIDX2]], i64 [[TMP12]]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY21:%.*]] = icmp eq ptr [[ARRAYIDX2]], [[TMP98]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYCPY_ISEMPTY21]], label [[OMP_ARRAYCPY_DONE37:%.*]], label [[OMP_ARRAYCPY_BODY22:%.*]]
// CHECK1:       omp.arraycpy.body22:
// CHECK1-NEXT:    [[OMP_ARRAYCPY_SRCELEMENTPAST23:%.*]] = phi ptr [ [[VLA]], [[DOTOMP_REDUCTION_CASE2]] ], [ [[OMP_ARRAYCPY_SRC_ELEMENT35:%.*]], [[ATOMIC_EXIT:%.*]] ]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DESTELEMENTPAST24:%.*]] = phi ptr [ [[ARRAYIDX2]], [[DOTOMP_REDUCTION_CASE2]] ], [ [[OMP_ARRAYCPY_DEST_ELEMENT34:%.*]], [[ATOMIC_EXIT]] ]
// CHECK1-NEXT:    [[TMP99:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
// CHECK1-NEXT:    [[CONV25:%.*]] = bytecast exact b8 [[TMP99]] to i8
// CHECK1-NEXT:    [[CONV26:%.*]] = sext i8 [[CONV25]] to i32
// CHECK1-NEXT:    [[ATOMIC_LOAD:%.*]] = load atomic i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST24]] monotonic, align 1
// CHECK1-NEXT:    br label [[ATOMIC_CONT:%.*]]
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP100:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY22]] ], [ [[TMP107:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    [[TMP101:%.*]] = bitcast i8 [[TMP100]] to b8
// CHECK1-NEXT:    store b8 [[TMP101]], ptr [[_TMP27]], align 1
// CHECK1-NEXT:    [[TMP102:%.*]] = load b8, ptr [[_TMP27]], align 1
// CHECK1-NEXT:    [[CONV28:%.*]] = bytecast exact b8 [[TMP102]] to i8
// CHECK1-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK1-NEXT:    [[TMP103:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
// CHECK1-NEXT:    [[CONV30:%.*]] = bytecast exact b8 [[TMP103]] to i8
// CHECK1-NEXT:    [[CONV31:%.*]] = sext i8 [[CONV30]] to i32
// CHECK1-NEXT:    [[ADD32:%.*]] = add nsw i32 [[CONV29]], [[CONV31]]
// CHECK1-NEXT:    [[CONV33:%.*]] = trunc i32 [[ADD32]] to i8
// CHECK1-NEXT:    [[TMP104:%.*]] = bitcast i8 [[CONV33]] to b8
// CHECK1-NEXT:    store b8 [[TMP104]], ptr [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP105:%.*]] = load i8, ptr [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP106:%.*]] = cmpxchg ptr [[OMP_ARRAYCPY_DESTELEMENTPAST24]], i8 [[TMP100]], i8 [[TMP105]] monotonic monotonic, align 1
...
// CHECK1:       atomic_exit:
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DEST_ELEMENT34]] = getelementptr b8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST24]], i32 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_SRC_ELEMENT35]] = getelementptr b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST23]], i32 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE36:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT34]], [[TMP98]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYCPY_DONE36]], label [[OMP_ARRAYCPY_DONE37]], label [[OMP_ARRAYCPY_BODY22]]
...
// CHECK1-NEXT:    [[TMP110:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP111:%.*]] = load i32, ptr [[TMP110]], align 4
// CHECK1-NEXT:    call void @__kmpc_barrier(ptr @[[GLOB4:[0-9]+]], i32 [[TMP111]])
