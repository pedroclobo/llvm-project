...
// CHECK1-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX10]], align 4
...
// CHECK1-NEXT:    [[TMP23:%.*]] = load double, ptr [[ARRAYIDX15]], align 8
...
// CHECK1-NEXT:    [[TMP25:%.*]] = load double, ptr [[ARRAYIDX18]], align 8
...
// CHECK3-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX10]], align 4
...
// CHECK3-NEXT:    [[TMP23:%.*]] = load double, ptr [[ARRAYIDX15]], align 8
...
// CHECK3-NEXT:    [[TMP25:%.*]] = load double, ptr [[ARRAYIDX18]], align 8
...
// CHECK9-NEXT:    [[TMP19:%.*]] = bitcast i8 [[CONV]] to b8
...
// CHECK9-NEXT:    [[CONV7:%.*]] = fpext float [[TMP21]] to double
...
// CHECK9-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX10]], align 4
// CHECK9-NEXT:    [[CONV11:%.*]] = fpext float [[TMP22]] to double
...
// CHECK9-NEXT:    [[TMP23:%.*]] = load double, ptr [[ARRAYIDX15]], align 8
// CHECK9-NEXT:    [[ADD16:%.*]] = fadd double [[TMP23]], 1.000000e+00
// CHECK9-NEXT:    store double [[ADD16]], ptr [[ARRAYIDX15]], align 8
// CHECK9-NEXT:    [[TMP24:%.*]] = mul nsw i64 1, [[TMP5]]
// CHECK9-NEXT:    [[ARRAYIDX17:%.*]] = getelementptr inbounds double, ptr [[TMP6]], i64 [[TMP24]]
// CHECK9-NEXT:    [[ARRAYIDX18:%.*]] = getelementptr inbounds double, ptr [[ARRAYIDX17]], i64 3
// CHECK9-NEXT:    [[TMP25:%.*]] = load double, ptr [[ARRAYIDX18]], align 8
// CHECK9-NEXT:    [[ADD19:%.*]] = fadd double [[TMP25]], 1.000000e+00
...
// CHECK9-NEXT:    [[ADD20:%.*]] = add nsw i64 [[TMP26]], 1
...
// CHECK9-NEXT:    [[CONV21:%.*]] = bytecast exact b8 [[TMP27]] to i8
// CHECK9-NEXT:    [[CONV22:%.*]] = sext i8 [[CONV21]] to i32
// CHECK9-NEXT:    [[ADD23:%.*]] = add nsw i32 [[CONV22]], 1
// CHECK9-NEXT:    [[CONV24:%.*]] = trunc i32 [[ADD23]] to i8
// CHECK9-NEXT:    [[TMP28:%.*]] = bitcast i8 [[CONV24]] to b8
...
// CHECK9-NEXT:    [[ADD25:%.*]] = add nsw i32 [[TMP29]], 1
// CHECK9-NEXT:    store i32 [[ADD25]], ptr [[DOTOMP_IV]], align 4
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK9:       omp.inner.for.end:
...
// CHECK9-NEXT:    store i32 [[ADD26]], ptr [[DOTOMP_LB]], align 4
// CHECK9-NEXT:    [[TMP32:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK9-NEXT:    [[TMP33:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4
// CHECK9-NEXT:    [[ADD27:%.*]] = add nsw i32 [[TMP32]], [[TMP33]]
// CHECK9-NEXT:    store i32 [[ADD27]], ptr [[DOTOMP_UB]], align 4
// CHECK9-NEXT:    br label [[OMP_DISPATCH_COND]]
...
// CHECK11-NEXT:    [[TMP19:%.*]] = bitcast i8 [[CONV]] to b8
...
// CHECK11-NEXT:    [[CONV7:%.*]] = fpext float [[TMP21]] to double
...
// CHECK11-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX10]], align 4
// CHECK11-NEXT:    [[CONV11:%.*]] = fpext float [[TMP22]] to double
...
// CHECK11-NEXT:    [[TMP23:%.*]] = load double, ptr [[ARRAYIDX15]], align 8
// CHECK11-NEXT:    [[ADD16:%.*]] = fadd double [[TMP23]], 1.000000e+00
// CHECK11-NEXT:    store double [[ADD16]], ptr [[ARRAYIDX15]], align 8
// CHECK11-NEXT:    [[TMP24:%.*]] = mul nsw i32 1, [[TMP5]]
// CHECK11-NEXT:    [[ARRAYIDX17:%.*]] = getelementptr inbounds double, ptr [[TMP6]], i32 [[TMP24]]
// CHECK11-NEXT:    [[ARRAYIDX18:%.*]] = getelementptr inbounds double, ptr [[ARRAYIDX17]], i32 3
// CHECK11-NEXT:    [[TMP25:%.*]] = load double, ptr [[ARRAYIDX18]], align 8
// CHECK11-NEXT:    [[ADD19:%.*]] = fadd double [[TMP25]], 1.000000e+00
...
// CHECK11-NEXT:    [[ADD20:%.*]] = add nsw i64 [[TMP26]], 1
...
// CHECK11-NEXT:    [[CONV21:%.*]] = bytecast exact b8 [[TMP27]] to i8
// CHECK11-NEXT:    [[CONV22:%.*]] = sext i8 [[CONV21]] to i32
// CHECK11-NEXT:    [[ADD23:%.*]] = add nsw i32 [[CONV22]], 1
// CHECK11-NEXT:    [[CONV24:%.*]] = trunc i32 [[ADD23]] to i8
// CHECK11-NEXT:    [[TMP28:%.*]] = bitcast i8 [[CONV24]] to b8
...
// CHECK11-NEXT:    [[ADD25:%.*]] = add nsw i32 [[TMP29]], 1
...
// CHECK11-NEXT:    store i32 [[ADD26]], ptr [[DOTOMP_LB]], align 4
// CHECK11-NEXT:    [[TMP32:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK11-NEXT:    [[TMP33:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4
// CHECK11-NEXT:    [[ADD27:%.*]] = add nsw i32 [[TMP32]], [[TMP33]]
// CHECK11-NEXT:    store i32 [[ADD27]], ptr [[DOTOMP_UB]], align 4
// CHECK11-NEXT:    br label [[OMP_DISPATCH_COND]]
...
// CHECK17-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX10]], align 4
...
// CHECK17-NEXT:    [[TMP23:%.*]] = load double, ptr [[ARRAYIDX15]], align 8
...
// CHECK17-NEXT:    [[TMP25:%.*]] = load double, ptr [[ARRAYIDX18]], align 8
...
// CHECK17-NEXT:    store i32 [[ADD25]], ptr [[DOTOMP_IV]], align 4
// CHECK17-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK17:       omp.inner.for.end:
// CHECK17-NEXT:    br label [[OMP_DISPATCH_INC:%.*]]
// CHECK17:       omp.dispatch.inc:
...
// CHECK17-NEXT:    store i16 [[TMP2]], ptr [[AA_CASTED]], align 2
// CHECK17-NEXT:    [[TMP3:%.*]] = load i64, ptr [[AA_CASTED]], align 8
// CHECK17-NEXT:    [[TMP4:%.*]] = load b8, ptr [[AAA]], align 1
// CHECK17-NEXT:    store b8 [[TMP4]], ptr [[AAA_CASTED]], align 1
...
// CHECK19-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX10]], align 4
...
// CHECK19-NEXT:    [[TMP23:%.*]] = load double, ptr [[ARRAYIDX15]], align 8
...
// CHECK19-NEXT:    [[TMP25:%.*]] = load double, ptr [[ARRAYIDX18]], align 8
...
// CHECK19-NEXT:    store i32 [[ADD25]], ptr [[DOTOMP_IV]], align 4
// CHECK19-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK19:       omp.inner.for.end:
// CHECK19-NEXT:    br label [[OMP_DISPATCH_INC:%.*]]
// CHECK19:       omp.dispatch.inc:
...
// CHECK19-NEXT:    store i16 [[TMP2]], ptr [[AA_CASTED]], align 2
// CHECK19-NEXT:    [[TMP3:%.*]] = load i32, ptr [[AA_CASTED]], align 4
// CHECK19-NEXT:    [[TMP4:%.*]] = load b8, ptr [[AAA]], align 1
// CHECK19-NEXT:    store b8 [[TMP4]], ptr [[AAA_CASTED]], align 1
