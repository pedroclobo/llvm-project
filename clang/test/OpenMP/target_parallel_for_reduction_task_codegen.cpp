...
// CHECK1-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds nuw b8, ptr [[TMP32]], i64 0
...
// CHECK1-NEXT:    [[ARRAYIDX12:%.*]] = getelementptr inbounds nuw b8, ptr [[TMP36]], i64 [[LB_ADD_LEN10]]
...
// CHECK1-NEXT:    [[TMP87:%.*]] = call i32 @__kmpc_reduce_nowait(ptr @[[GLOB3:[0-9]+]], i32 [[TMP86]], i32 2, i64 24, ptr [[DOTOMP_REDUCTION_RED_LIST]], ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l14.omp_outlined.omp.reduction.reduction_func, ptr @.gomp_critical_user_.reduction.var)
...
// CHECK1-NEXT:    [[TMP90:%.*]] = getelementptr b8, ptr [[ARRAYIDX2]], i64 [[TMP11]]
...
// CHECK1-NEXT:    [[TMP91:%.*]] = load b8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST16]], align 1
// CHECK1-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP91]] to i8
// CHECK1-NEXT:    [[CONV17:%.*]] = sext i8 [[CONV]] to i32
// CHECK1-NEXT:    [[TMP92:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1
// CHECK1-NEXT:    [[CONV18:%.*]] = bytecast exact b8 [[TMP92]] to i8
...
// CHECK1-NEXT:    [[TMP93:%.*]] = bitcast i8 [[CONV21]] to b8
// CHECK1-NEXT:    store b8 [[TMP93]], ptr [[OMP_ARRAYCPY_DESTELEMENTPAST16]], align 1
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE23:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT22]], [[TMP90]]
...
// CHECK1-NEXT:    [[TMP96:%.*]] = getelementptr b8, ptr [[ARRAYIDX2]], i64 [[TMP11]]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY25:%.*]] = icmp eq ptr [[ARRAYIDX2]], [[TMP96]]
...
// CHECK1-NEXT:    [[TMP97:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST27]], align 1
// CHECK1-NEXT:    [[CONV29:%.*]] = bytecast exact b8 [[TMP97]] to i8
...
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP98:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY26]] ], [ [[TMP105:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    [[TMP99:%.*]] = bitcast i8 [[TMP98]] to b8
// CHECK1-NEXT:    store b8 [[TMP99]], ptr [[_TMP31]], align 1
// CHECK1-NEXT:    [[TMP100:%.*]] = load b8, ptr [[_TMP31]], align 1
// CHECK1-NEXT:    [[CONV32:%.*]] = bytecast exact b8 [[TMP100]] to i8
// CHECK1-NEXT:    [[CONV33:%.*]] = sext i8 [[CONV32]] to i32
// CHECK1-NEXT:    [[TMP101:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST27]], align 1
// CHECK1-NEXT:    [[CONV34:%.*]] = bytecast exact b8 [[TMP101]] to i8
...
// CHECK1-NEXT:    [[TMP102:%.*]] = bitcast i8 [[CONV37]] to b8
// CHECK1-NEXT:    store b8 [[TMP102]], ptr [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP103:%.*]] = load i8, ptr [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP104:%.*]] = cmpxchg ptr [[OMP_ARRAYCPY_DESTELEMENTPAST28]], i8 [[TMP98]], i8 [[TMP103]] monotonic monotonic, align 1
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE40:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT38]], [[TMP96]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYCPY_DONE40]], label [[OMP_ARRAYCPY_DONE41]], label [[OMP_ARRAYCPY_BODY26]]
// CHECK1:       omp.arraycpy.done41:
// CHECK1-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK1:       .omp.reduction.default:
// CHECK1-NEXT:    [[TMP107:%.*]] = load ptr, ptr [[SAVED_STACK]], align 8
// CHECK1-NEXT:    call void @llvm.stackrestore.p0(ptr [[TMP107]])
// CHECK1-NEXT:    ret void
//
//
