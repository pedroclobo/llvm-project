...
// CHECK1-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds nuw b8, ptr [[TMP31]], i64 0
...
// CHECK1-NEXT:    [[ARRAYIDX12:%.*]] = getelementptr inbounds nuw b8, ptr [[TMP35]], i64 [[LB_ADD_LEN10]]
...
// CHECK1-NEXT:    [[TMP90:%.*]] = load b8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST16]], align 1
// CHECK1-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP90]] to i8
// CHECK1-NEXT:    [[CONV17:%.*]] = sext i8 [[CONV]] to i32
// CHECK1-NEXT:    [[TMP91:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1
// CHECK1-NEXT:    [[CONV18:%.*]] = bytecast exact b8 [[TMP91]] to i8
...
// CHECK1-NEXT:    [[TMP92:%.*]] = bitcast i8 [[CONV21]] to b8
// CHECK1-NEXT:    store b8 [[TMP92]], ptr [[OMP_ARRAYCPY_DESTELEMENTPAST16]], align 1
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE23:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT22]], [[TMP89]]
...
// CHECK1-NEXT:    [[TMP95:%.*]] = getelementptr b8, ptr [[ARRAYIDX2]], i64 [[TMP11]]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY25:%.*]] = icmp eq ptr [[ARRAYIDX2]], [[TMP95]]
...
// CHECK1-NEXT:    [[TMP96:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST27]], align 1
// CHECK1-NEXT:    [[CONV29:%.*]] = bytecast exact b8 [[TMP96]] to i8
...
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP97:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY26]] ], [ [[TMP104:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    [[TMP98:%.*]] = bitcast i8 [[TMP97]] to b8
// CHECK1-NEXT:    store b8 [[TMP98]], ptr [[_TMP31]], align 1
// CHECK1-NEXT:    [[TMP99:%.*]] = load b8, ptr [[_TMP31]], align 1
// CHECK1-NEXT:    [[CONV32:%.*]] = bytecast exact b8 [[TMP99]] to i8
// CHECK1-NEXT:    [[CONV33:%.*]] = sext i8 [[CONV32]] to i32
// CHECK1-NEXT:    [[TMP100:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST27]], align 1
// CHECK1-NEXT:    [[CONV34:%.*]] = bytecast exact b8 [[TMP100]] to i8
...
// CHECK1-NEXT:    [[TMP101:%.*]] = bitcast i8 [[CONV37]] to b8
// CHECK1-NEXT:    store b8 [[TMP101]], ptr [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP102:%.*]] = load i8, ptr [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP103:%.*]] = cmpxchg ptr [[OMP_ARRAYCPY_DESTELEMENTPAST28]], i8 [[TMP97]], i8 [[TMP102]] monotonic monotonic, align 1
// CHECK1-NEXT:    [[TMP104]] = extractvalue { i8, i1 } [[TMP103]], 0
// CHECK1-NEXT:    [[TMP105:%.*]] = extractvalue { i8, i1 } [[TMP103]], 1
// CHECK1-NEXT:    br i1 [[TMP105]], label [[ATOMIC_EXIT]], label [[ATOMIC_CONT]]
// CHECK1:       atomic_exit:
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE40:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT38]], [[TMP95]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYCPY_DONE40]], label [[OMP_ARRAYCPY_DONE41]], label [[OMP_ARRAYCPY_BODY26]]
// CHECK1:       omp.arraycpy.done41:
// CHECK1-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK1:       .omp.reduction.default:
// CHECK1-NEXT:    [[TMP106:%.*]] = load ptr, ptr [[SAVED_STACK]], align 8
// CHECK1-NEXT:    call void @llvm.stackrestore.p0(ptr [[TMP106]])
// CHECK1-NEXT:    ret void
//
//
