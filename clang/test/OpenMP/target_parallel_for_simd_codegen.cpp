...
// CHECK1-NEXT:    [[DOTCAPTURE_EXPR__ADDR:%.*]] = alloca i64, align 8
// CHECK1-NEXT:    [[DOTOMP_IV:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[TMP:%.*]] = alloca b8, align 1
// CHECK1-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[IT:%.*]] = alloca b8, align 1
// CHECK1-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 8
// CHECK1-NEXT:    store i64 [[A]], ptr [[A_ADDR]], align 8
// CHECK1-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 8
...
// CHECK1-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[D_ADDR]], align 8
// CHECK1-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK1-NEXT:    [[CONV:%.*]] = bytecast exact b8 122 to i8
// CHECK1-NEXT:    [[CONV5:%.*]] = sext i8 [[CONV]] to i32
// CHECK1-NEXT:    [[CONV6:%.*]] = bytecast exact b8 97 to i8
// CHECK1-NEXT:    [[CONV7:%.*]] = sext i8 [[CONV6]] to i32
// CHECK1-NEXT:    [[SUB:%.*]] = sub nsw i32 [[CONV7]], 1
// CHECK1-NEXT:    [[SUB8:%.*]] = sub nsw i32 [[CONV5]], [[SUB]]
// CHECK1-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB8]], 1
// CHECK1-NEXT:    [[SUB9:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK1-NEXT:    store i32 [[SUB9]], ptr [[DOTOMP_UB]], align 4
// CHECK1-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4
// CHECK1-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
...
// CHECK1-NEXT:    [[CONV10:%.*]] = bytecast exact b8 122 to i8
// CHECK1-NEXT:    [[CONV11:%.*]] = sext i8 [[CONV10]] to i32
// CHECK1-NEXT:    [[CONV12:%.*]] = bytecast exact b8 97 to i8
// CHECK1-NEXT:    [[CONV13:%.*]] = sext i8 [[CONV12]] to i32
// CHECK1-NEXT:    [[SUB14:%.*]] = sub nsw i32 [[CONV13]], 1
// CHECK1-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[CONV11]], [[SUB14]]
// CHECK1-NEXT:    [[DIV16:%.*]] = sdiv i32 [[SUB15]], 1
// CHECK1-NEXT:    [[SUB17:%.*]] = sub nsw i32 [[DIV16]], 1
// CHECK1-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[TMP11]], [[SUB17]]
// CHECK1-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK1:       cond.true:
// CHECK1-NEXT:    [[CONV18:%.*]] = bytecast exact b8 122 to i8
// CHECK1-NEXT:    [[CONV19:%.*]] = sext i8 [[CONV18]] to i32
// CHECK1-NEXT:    [[CONV20:%.*]] = bytecast exact b8 97 to i8
// CHECK1-NEXT:    [[CONV21:%.*]] = sext i8 [[CONV20]] to i32
// CHECK1-NEXT:    [[SUB22:%.*]] = sub nsw i32 [[CONV21]], 1
// CHECK1-NEXT:    [[SUB23:%.*]] = sub nsw i32 [[CONV19]], [[SUB22]]
...
// CHECK1-NEXT:    br label [[COND_END]]
// CHECK1:       cond.end:
// CHECK1-NEXT:    [[COND:%.*]] = phi i32 [ [[SUB25]], [[COND_TRUE]] ], [ [[TMP12]], [[COND_FALSE]] ]
// CHECK1-NEXT:    store i32 [[COND]], ptr [[DOTOMP_UB]], align 4
...
// CHECK1-NEXT:    br i1 [[CMP26]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]]
// CHECK1:       omp.dispatch.body:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK1:       omp.inner.for.cond:
// CHECK1-NEXT:    [[TMP16:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP42:![0-9]+]]
// CHECK1-NEXT:    [[TMP17:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    [[CMP27:%.*]] = icmp sle i32 [[TMP16]], [[TMP17]]
// CHECK1-NEXT:    br i1 [[CMP27]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK1:       omp.inner.for.body:
// CHECK1-NEXT:    [[CONV28:%.*]] = bytecast exact b8 122 to i8
// CHECK1-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK1-NEXT:    [[TMP18:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP18]], 1
// CHECK1-NEXT:    [[SUB30:%.*]] = sub nsw i32 [[CONV29]], [[MUL]]
// CHECK1-NEXT:    [[CONV31:%.*]] = trunc i32 [[SUB30]] to i8
// CHECK1-NEXT:    [[TMP19:%.*]] = bitcast i8 [[CONV31]] to b8
// CHECK1-NEXT:    store b8 [[TMP19]], ptr [[IT]], align 1, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    [[TMP20:%.*]] = load i32, ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP20]], 1
// CHECK1-NEXT:    store i32 [[ADD]], ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x float], ptr [[TMP0]], i64 0, i64 2
// CHECK1-NEXT:    [[TMP21:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    [[CONV32:%.*]] = fpext float [[TMP21]] to double
// CHECK1-NEXT:    [[ADD33:%.*]] = fadd double [[CONV32]], 1.000000e+00
// CHECK1-NEXT:    [[CONV34:%.*]] = fptrunc double [[ADD33]] to float
// CHECK1-NEXT:    store float [[CONV34]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    [[ARRAYIDX35:%.*]] = getelementptr inbounds float, ptr [[TMP2]], i64 3
// CHECK1-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    [[CONV36:%.*]] = fpext float [[TMP22]] to double
// CHECK1-NEXT:    [[ADD37:%.*]] = fadd double [[CONV36]], 1.000000e+00
// CHECK1-NEXT:    [[CONV38:%.*]] = fptrunc double [[ADD37]] to float
// CHECK1-NEXT:    store float [[CONV38]], ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    [[ARRAYIDX39:%.*]] = getelementptr inbounds [5 x [10 x double]], ptr [[TMP3]], i64 0, i64 1
// CHECK1-NEXT:    [[ARRAYIDX40:%.*]] = getelementptr inbounds [10 x double], ptr [[ARRAYIDX39]], i64 0, i64 2
// CHECK1-NEXT:    [[TMP23:%.*]] = load double, ptr [[ARRAYIDX40]], align 8, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    [[ADD41:%.*]] = fadd double [[TMP23]], 1.000000e+00
// CHECK1-NEXT:    store double [[ADD41]], ptr [[ARRAYIDX40]], align 8, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    [[TMP24:%.*]] = mul nsw i64 1, [[TMP5]]
// CHECK1-NEXT:    [[ARRAYIDX42:%.*]] = getelementptr inbounds double, ptr [[TMP6]], i64 [[TMP24]]
// CHECK1-NEXT:    [[ARRAYIDX43:%.*]] = getelementptr inbounds double, ptr [[ARRAYIDX42]], i64 3
// CHECK1-NEXT:    [[TMP25:%.*]] = load double, ptr [[ARRAYIDX43]], align 8, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    [[ADD44:%.*]] = fadd double [[TMP25]], 1.000000e+00
// CHECK1-NEXT:    store double [[ADD44]], ptr [[ARRAYIDX43]], align 8, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    [[X:%.*]] = getelementptr inbounds nuw [[STRUCT_TT:%.*]], ptr [[TMP7]], i32 0, i32 0
// CHECK1-NEXT:    [[TMP26:%.*]] = load i64, ptr [[X]], align 8, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    [[ADD45:%.*]] = add nsw i64 [[TMP26]], 1
// CHECK1-NEXT:    store i64 [[ADD45]], ptr [[X]], align 8, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TT]], ptr [[TMP7]], i32 0, i32 1
// CHECK1-NEXT:    [[TMP27:%.*]] = load b8, ptr [[Y]], align 8, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    [[CONV46:%.*]] = bytecast exact b8 [[TMP27]] to i8
// CHECK1-NEXT:    [[CONV47:%.*]] = sext i8 [[CONV46]] to i32
// CHECK1-NEXT:    [[ADD48:%.*]] = add nsw i32 [[CONV47]], 1
// CHECK1-NEXT:    [[CONV49:%.*]] = trunc i32 [[ADD48]] to i8
// CHECK1-NEXT:    [[TMP28:%.*]] = bitcast i8 [[CONV49]] to b8
// CHECK1-NEXT:    store b8 [[TMP28]], ptr [[Y]], align 8, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1:       omp.body.continue:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
// CHECK1-NEXT:    [[TMP29:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    [[ADD50:%.*]] = add nsw i32 [[TMP29]], 1
// CHECK1-NEXT:    store i32 [[ADD50]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND]], !llvm.loop [[LOOP43:![0-9]+]]
// CHECK1:       omp.inner.for.end:
// CHECK1-NEXT:    br label [[OMP_DISPATCH_INC:%.*]]
// CHECK1:       omp.dispatch.inc:
// CHECK1-NEXT:    [[TMP30:%.*]] = load i32, ptr [[DOTOMP_LB]], align 4
// CHECK1-NEXT:    [[TMP31:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4
// CHECK1-NEXT:    [[ADD51:%.*]] = add nsw i32 [[TMP30]], [[TMP31]]
// CHECK1-NEXT:    store i32 [[ADD51]], ptr [[DOTOMP_LB]], align 4
// CHECK1-NEXT:    [[TMP32:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK1-NEXT:    [[TMP33:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4
// CHECK1-NEXT:    [[ADD52:%.*]] = add nsw i32 [[TMP32]], [[TMP33]]
// CHECK1-NEXT:    store i32 [[ADD52]], ptr [[DOTOMP_UB]], align 4
// CHECK1-NEXT:    br label [[OMP_DISPATCH_COND]]
// CHECK1:       omp.dispatch.end:
...
// CHECK1:       .omp.final.then:
// CHECK1-NEXT:    [[CONV53:%.*]] = bytecast exact b8 122 to i8
// CHECK1-NEXT:    [[CONV54:%.*]] = sext i8 [[CONV53]] to i32
// CHECK1-NEXT:    [[CONV55:%.*]] = bytecast exact b8 122 to i8
// CHECK1-NEXT:    [[CONV56:%.*]] = sext i8 [[CONV55]] to i32
// CHECK1-NEXT:    [[CONV57:%.*]] = bytecast exact b8 97 to i8
// CHECK1-NEXT:    [[CONV58:%.*]] = sext i8 [[CONV57]] to i32
// CHECK1-NEXT:    [[SUB59:%.*]] = sub nsw i32 [[CONV58]], 1
// CHECK1-NEXT:    [[SUB60:%.*]] = sub nsw i32 [[CONV56]], [[SUB59]]
// CHECK1-NEXT:    [[DIV61:%.*]] = sdiv i32 [[SUB60]], 1
// CHECK1-NEXT:    [[MUL62:%.*]] = mul nsw i32 [[DIV61]], 1
// CHECK1-NEXT:    [[SUB63:%.*]] = sub nsw i32 [[CONV54]], [[MUL62]]
// CHECK1-NEXT:    [[CONV64:%.*]] = trunc i32 [[SUB63]] to i8
// CHECK1-NEXT:    [[TMP36:%.*]] = bitcast i8 [[CONV64]] to b8
// CHECK1-NEXT:    store b8 [[TMP36]], ptr [[IT]], align 1
// CHECK1-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK1:       .omp.final.done:
// CHECK1-NEXT:    ret void
//
...
// CHECK1-NEXT:    store i32 0, ptr [[A]], align 4
// CHECK1-NEXT:    store i16 0, ptr [[AA]], align 2
// CHECK1-NEXT:    [[TMP0:%.*]] = bytecast exact b8 0 to i8
// CHECK1-NEXT:    store i8 [[TMP0]], ptr [[AAA]], align 1
// CHECK1-NEXT:    [[TMP1:%.*]] = load i32, ptr [[A]], align 4
// CHECK1-NEXT:    store i32 [[TMP1]], ptr [[A_CASTED]], align 4
// CHECK1-NEXT:    [[TMP2:%.*]] = load i64, ptr [[A_CASTED]], align 8
// CHECK1-NEXT:    [[TMP3:%.*]] = load i16, ptr [[AA]], align 2
// CHECK1-NEXT:    store i16 [[TMP3]], ptr [[AA_CASTED]], align 2
// CHECK1-NEXT:    [[TMP4:%.*]] = load i64, ptr [[AA_CASTED]], align 8
// CHECK1-NEXT:    [[TMP5:%.*]] = load b8, ptr [[AAA]], align 1
// CHECK1-NEXT:    store b8 [[TMP5]], ptr [[AAA_CASTED]], align 1
// CHECK1-NEXT:    [[TMP6:%.*]] = load i64, ptr [[AAA_CASTED]], align 8
// CHECK1-NEXT:    [[TMP7:%.*]] = load i32, ptr [[N_ADDR]], align 4
// CHECK1-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[TMP7]], 50
// CHECK1-NEXT:    br i1 [[CMP]], label [[OMP_IF_THEN:%.*]], label [[OMP_IF_ELSE:%.*]]
// CHECK1:       omp_if.then:
...
// CHECK1-NEXT:    store ptr @.offload_sizes.7, ptr [[TMP26]], align 8
// CHECK1-NEXT:    [[TMP27:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 5
// CHECK1-NEXT:    store ptr @.offload_maptypes.8, ptr [[TMP27]], align 8
...
// CHECK1-NEXT:    [[TMP35:%.*]] = call i32 @__tgt_target_kernel(ptr @[[GLOB2]], i64 -1, i32 1, i32 0, ptr @.{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__ZL7fstatici_l195.region_id, ptr [[KERNEL_ARGS]])
// CHECK1-NEXT:    [[TMP36:%.*]] = icmp ne i32 [[TMP35]], 0
// CHECK1-NEXT:    br i1 [[TMP36]], label [[OMP_OFFLOAD_FAILED:%.*]], label [[OMP_OFFLOAD_CONT:%.*]]
// CHECK1:       omp_offload.failed:
// CHECK1-NEXT:    call void @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__ZL7fstatici_l195(i64 [[TMP2]], i64 [[TMP4]], i64 [[TMP6]], ptr [[B]]) #[[ATTR3]]
// CHECK1-NEXT:    br label [[OMP_OFFLOAD_CONT]]
// CHECK1:       omp_offload.cont:
// CHECK1-NEXT:    br label [[OMP_IF_END:%.*]]
// CHECK1:       omp_if.else:
...
// CHECK1-NEXT:    br label [[OMP_IF_END]]
// CHECK1:       omp_if.end:
// CHECK1-NEXT:    [[TMP37:%.*]] = load i32, ptr [[A]], align 4
...
// CHECK1-NEXT:    store i16 [[TMP3]], ptr [[AA_CASTED]], align 2
// CHECK1-NEXT:    [[TMP4:%.*]] = load i64, ptr [[AA_CASTED]], align 8
// CHECK1-NEXT:    [[TMP5:%.*]] = load b8, ptr [[AAA_ADDR]], align 1
// CHECK1-NEXT:    store b8 [[TMP5]], ptr [[AAA_CASTED]], align 1
// CHECK1-NEXT:    [[TMP6:%.*]] = load i64, ptr [[AAA_CASTED]], align 8
...
// CHECK3-NEXT:    [[TMP7:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4, !llvm.access.group [[ACC_GRP34]]
// CHECK3-NEXT:    [[CMP:%.*]] = icmp sle i32 [[TMP6]], [[TMP7]]
// CHECK3-NEXT:    br i1 [[CMP]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK3:       omp.inner.for.body:
// CHECK3-NEXT:    [[TMP8:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP34]]
// CHECK3-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP8]], 1
// CHECK3-NEXT:    [[SUB:%.*]] = sub nsw i32 10, [[MUL]]
// CHECK3-NEXT:    store i32 [[SUB]], ptr [[I]], align 4, !llvm.access.group [[ACC_GRP34]]
// CHECK3-NEXT:    [[TMP9:%.*]] = load i64, ptr [[DOTLINEAR_START]], align 8, !llvm.access.group [[ACC_GRP34]]
...
// CHECK3-NEXT:    store i64 [[ADD]], ptr [[K1]], align 8, !llvm.access.group [[ACC_GRP34]]
// CHECK3-NEXT:    [[TMP11:%.*]] = load i32, ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP34]]
// CHECK3-NEXT:    [[ADD3:%.*]] = add nsw i32 [[TMP11]], 1
// CHECK3-NEXT:    store i32 [[ADD3]], ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP34]]
// CHECK3-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK3:       omp.body.continue:
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
// CHECK3-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP34]]
// CHECK3-NEXT:    [[ADD4:%.*]] = add nsw i32 [[TMP12]], 1
// CHECK3-NEXT:    store i32 [[ADD4]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP34]]
...
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK3:       omp.inner.for.cond:
// CHECK3-NEXT:    [[TMP7:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP37:![0-9]+]]
// CHECK3-NEXT:    [[TMP8:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK3-NEXT:    [[CMP4:%.*]] = icmp ule i64 [[TMP7]], [[TMP8]]
// CHECK3-NEXT:    br i1 [[CMP4]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK3:       omp.inner.for.body:
// CHECK3-NEXT:    [[TMP9:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK3-NEXT:    [[MUL:%.*]] = mul i64 [[TMP9]], 400
// CHECK3-NEXT:    [[SUB:%.*]] = sub i64 2000, [[MUL]]
// CHECK3-NEXT:    store i64 [[SUB]], ptr [[IT]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK3-NEXT:    [[TMP10:%.*]] = load i32, ptr [[DOTLINEAR_START]], align 4, !llvm.access.group [[ACC_GRP37]]
// CHECK3-NEXT:    [[CONV:%.*]] = sext i32 [[TMP10]] to i64
// CHECK3-NEXT:    [[TMP11:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK3-NEXT:    [[TMP12:%.*]] = load i64, ptr [[DOTLINEAR_STEP]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK3-NEXT:    [[MUL5:%.*]] = mul i64 [[TMP11]], [[TMP12]]
// CHECK3-NEXT:    [[ADD:%.*]] = add i64 [[CONV]], [[MUL5]]
// CHECK3-NEXT:    [[CONV6:%.*]] = trunc i64 [[ADD]] to i32
// CHECK3-NEXT:    store i32 [[CONV6]], ptr [[LIN2]], align 4, !llvm.access.group [[ACC_GRP37]]
// CHECK3-NEXT:    [[TMP13:%.*]] = load i32, ptr [[DOTLINEAR_START1]], align 4, !llvm.access.group [[ACC_GRP37]]
// CHECK3-NEXT:    [[CONV7:%.*]] = sext i32 [[TMP13]] to i64
// CHECK3-NEXT:    [[TMP14:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK3-NEXT:    [[TMP15:%.*]] = load i64, ptr [[DOTLINEAR_STEP]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK3-NEXT:    [[MUL8:%.*]] = mul i64 [[TMP14]], [[TMP15]]
// CHECK3-NEXT:    [[ADD9:%.*]] = add i64 [[CONV7]], [[MUL8]]
// CHECK3-NEXT:    [[CONV10:%.*]] = trunc i64 [[ADD9]] to i32
// CHECK3-NEXT:    store i32 [[CONV10]], ptr [[A3]], align 4, !llvm.access.group [[ACC_GRP37]]
// CHECK3-NEXT:    [[TMP16:%.*]] = load i16, ptr [[AA_ADDR]], align 2, !llvm.access.group [[ACC_GRP37]]
// CHECK3-NEXT:    [[CONV11:%.*]] = sext i16 [[TMP16]] to i32
// CHECK3-NEXT:    [[ADD12:%.*]] = add nsw i32 [[CONV11]], 1
// CHECK3-NEXT:    [[CONV13:%.*]] = trunc i32 [[ADD12]] to i16
// CHECK3-NEXT:    store i16 [[CONV13]], ptr [[AA_ADDR]], align 2, !llvm.access.group [[ACC_GRP37]]
// CHECK3-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK3:       omp.body.continue:
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
// CHECK3-NEXT:    [[TMP17:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK3-NEXT:    [[ADD14:%.*]] = add i64 [[TMP17]], 1
// CHECK3-NEXT:    store i64 [[ADD14]], ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP37]]
...
// CHECK3-NEXT:    store i16 [[CONV]], ptr [[IT]], align 2, !llvm.access.group [[ACC_GRP40]]
...
// CHECK3-NEXT:    store i16 [[CONV5]], ptr [[AA_ADDR]], align 2, !llvm.access.group [[ACC_GRP40]]
// CHECK3-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK3:       omp.body.continue:
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
...
// CHECK3-NEXT:    store i32 [[ADD6]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP40]]
...
// CHECK3-NEXT:    [[DOTCAPTURE_EXPR__ADDR:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[DOTOMP_IV:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[TMP:%.*]] = alloca b8, align 1
// CHECK3-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK3-NEXT:    [[IT:%.*]] = alloca b8, align 1
// CHECK3-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK3-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 4
// CHECK3-NEXT:    store i32 [[A]], ptr [[A_ADDR]], align 4
// CHECK3-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 4
...
// CHECK3-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[D_ADDR]], align 4
// CHECK3-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK3-NEXT:    [[CONV:%.*]] = bytecast exact b8 122 to i8
// CHECK3-NEXT:    [[CONV5:%.*]] = sext i8 [[CONV]] to i32
// CHECK3-NEXT:    [[CONV6:%.*]] = bytecast exact b8 97 to i8
// CHECK3-NEXT:    [[CONV7:%.*]] = sext i8 [[CONV6]] to i32
// CHECK3-NEXT:    [[SUB:%.*]] = sub nsw i32 [[CONV7]], 1
// CHECK3-NEXT:    [[SUB8:%.*]] = sub nsw i32 [[CONV5]], [[SUB]]
// CHECK3-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB8]], 1
// CHECK3-NEXT:    [[SUB9:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK3-NEXT:    store i32 [[SUB9]], ptr [[DOTOMP_UB]], align 4
// CHECK3-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4
// CHECK3-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
...
// CHECK3-NEXT:    [[CONV10:%.*]] = bytecast exact b8 122 to i8
// CHECK3-NEXT:    [[CONV11:%.*]] = sext i8 [[CONV10]] to i32
// CHECK3-NEXT:    [[CONV12:%.*]] = bytecast exact b8 97 to i8
// CHECK3-NEXT:    [[CONV13:%.*]] = sext i8 [[CONV12]] to i32
// CHECK3-NEXT:    [[SUB14:%.*]] = sub nsw i32 [[CONV13]], 1
// CHECK3-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[CONV11]], [[SUB14]]
// CHECK3-NEXT:    [[DIV16:%.*]] = sdiv i32 [[SUB15]], 1
// CHECK3-NEXT:    [[SUB17:%.*]] = sub nsw i32 [[DIV16]], 1
// CHECK3-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[TMP11]], [[SUB17]]
// CHECK3-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK3:       cond.true:
// CHECK3-NEXT:    [[CONV18:%.*]] = bytecast exact b8 122 to i8
// CHECK3-NEXT:    [[CONV19:%.*]] = sext i8 [[CONV18]] to i32
// CHECK3-NEXT:    [[CONV20:%.*]] = bytecast exact b8 97 to i8
// CHECK3-NEXT:    [[CONV21:%.*]] = sext i8 [[CONV20]] to i32
// CHECK3-NEXT:    [[SUB22:%.*]] = sub nsw i32 [[CONV21]], 1
// CHECK3-NEXT:    [[SUB23:%.*]] = sub nsw i32 [[CONV19]], [[SUB22]]
...
// CHECK3-NEXT:    br label [[COND_END]]
// CHECK3:       cond.end:
// CHECK3-NEXT:    [[COND:%.*]] = phi i32 [ [[SUB25]], [[COND_TRUE]] ], [ [[TMP12]], [[COND_FALSE]] ]
// CHECK3-NEXT:    store i32 [[COND]], ptr [[DOTOMP_UB]], align 4
...
// CHECK3-NEXT:    br i1 [[CMP26]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]]
// CHECK3:       omp.dispatch.body:
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK3:       omp.inner.for.cond:
// CHECK3-NEXT:    [[TMP16:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP43:![0-9]+]]
// CHECK3-NEXT:    [[TMP17:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    [[CMP27:%.*]] = icmp sle i32 [[TMP16]], [[TMP17]]
// CHECK3-NEXT:    br i1 [[CMP27]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK3:       omp.inner.for.body:
// CHECK3-NEXT:    [[CONV28:%.*]] = bytecast exact b8 122 to i8
// CHECK3-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK3-NEXT:    [[TMP18:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP18]], 1
// CHECK3-NEXT:    [[SUB30:%.*]] = sub nsw i32 [[CONV29]], [[MUL]]
// CHECK3-NEXT:    [[CONV31:%.*]] = trunc i32 [[SUB30]] to i8
// CHECK3-NEXT:    [[TMP19:%.*]] = bitcast i8 [[CONV31]] to b8
// CHECK3-NEXT:    store b8 [[TMP19]], ptr [[IT]], align 1, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    [[TMP20:%.*]] = load i32, ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP20]], 1
// CHECK3-NEXT:    store i32 [[ADD]], ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x float], ptr [[TMP0]], i32 0, i32 2
// CHECK3-NEXT:    [[TMP21:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    [[CONV32:%.*]] = fpext float [[TMP21]] to double
// CHECK3-NEXT:    [[ADD33:%.*]] = fadd double [[CONV32]], 1.000000e+00
// CHECK3-NEXT:    [[CONV34:%.*]] = fptrunc double [[ADD33]] to float
// CHECK3-NEXT:    store float [[CONV34]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    [[ARRAYIDX35:%.*]] = getelementptr inbounds float, ptr [[TMP2]], i32 3
// CHECK3-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    [[CONV36:%.*]] = fpext float [[TMP22]] to double
// CHECK3-NEXT:    [[ADD37:%.*]] = fadd double [[CONV36]], 1.000000e+00
// CHECK3-NEXT:    [[CONV38:%.*]] = fptrunc double [[ADD37]] to float
// CHECK3-NEXT:    store float [[CONV38]], ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    [[ARRAYIDX39:%.*]] = getelementptr inbounds [5 x [10 x double]], ptr [[TMP3]], i32 0, i32 1
// CHECK3-NEXT:    [[ARRAYIDX40:%.*]] = getelementptr inbounds [10 x double], ptr [[ARRAYIDX39]], i32 0, i32 2
// CHECK3-NEXT:    [[TMP23:%.*]] = load double, ptr [[ARRAYIDX40]], align 8, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    [[ADD41:%.*]] = fadd double [[TMP23]], 1.000000e+00
// CHECK3-NEXT:    store double [[ADD41]], ptr [[ARRAYIDX40]], align 8, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    [[TMP24:%.*]] = mul nsw i32 1, [[TMP5]]
// CHECK3-NEXT:    [[ARRAYIDX42:%.*]] = getelementptr inbounds double, ptr [[TMP6]], i32 [[TMP24]]
// CHECK3-NEXT:    [[ARRAYIDX43:%.*]] = getelementptr inbounds double, ptr [[ARRAYIDX42]], i32 3
// CHECK3-NEXT:    [[TMP25:%.*]] = load double, ptr [[ARRAYIDX43]], align 8, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    [[ADD44:%.*]] = fadd double [[TMP25]], 1.000000e+00
// CHECK3-NEXT:    store double [[ADD44]], ptr [[ARRAYIDX43]], align 8, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    [[X:%.*]] = getelementptr inbounds nuw [[STRUCT_TT:%.*]], ptr [[TMP7]], i32 0, i32 0
// CHECK3-NEXT:    [[TMP26:%.*]] = load i64, ptr [[X]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    [[ADD45:%.*]] = add nsw i64 [[TMP26]], 1
// CHECK3-NEXT:    store i64 [[ADD45]], ptr [[X]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TT]], ptr [[TMP7]], i32 0, i32 1
// CHECK3-NEXT:    [[TMP27:%.*]] = load b8, ptr [[Y]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    [[CONV46:%.*]] = bytecast exact b8 [[TMP27]] to i8
// CHECK3-NEXT:    [[CONV47:%.*]] = sext i8 [[CONV46]] to i32
// CHECK3-NEXT:    [[ADD48:%.*]] = add nsw i32 [[CONV47]], 1
// CHECK3-NEXT:    [[CONV49:%.*]] = trunc i32 [[ADD48]] to i8
// CHECK3-NEXT:    [[TMP28:%.*]] = bitcast i8 [[CONV49]] to b8
// CHECK3-NEXT:    store b8 [[TMP28]], ptr [[Y]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK3:       omp.body.continue:
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
// CHECK3-NEXT:    [[TMP29:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    [[ADD50:%.*]] = add nsw i32 [[TMP29]], 1
// CHECK3-NEXT:    store i32 [[ADD50]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_COND]], !llvm.loop [[LOOP44:![0-9]+]]
// CHECK3:       omp.inner.for.end:
// CHECK3-NEXT:    br label [[OMP_DISPATCH_INC:%.*]]
// CHECK3:       omp.dispatch.inc:
// CHECK3-NEXT:    [[TMP30:%.*]] = load i32, ptr [[DOTOMP_LB]], align 4
// CHECK3-NEXT:    [[TMP31:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4
// CHECK3-NEXT:    [[ADD51:%.*]] = add nsw i32 [[TMP30]], [[TMP31]]
// CHECK3-NEXT:    store i32 [[ADD51]], ptr [[DOTOMP_LB]], align 4
// CHECK3-NEXT:    [[TMP32:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK3-NEXT:    [[TMP33:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4
// CHECK3-NEXT:    [[ADD52:%.*]] = add nsw i32 [[TMP32]], [[TMP33]]
// CHECK3-NEXT:    store i32 [[ADD52]], ptr [[DOTOMP_UB]], align 4
// CHECK3-NEXT:    br label [[OMP_DISPATCH_COND]]
// CHECK3:       omp.dispatch.end:
...
// CHECK3:       .omp.final.then:
// CHECK3-NEXT:    [[CONV53:%.*]] = bytecast exact b8 122 to i8
// CHECK3-NEXT:    [[CONV54:%.*]] = sext i8 [[CONV53]] to i32
// CHECK3-NEXT:    [[CONV55:%.*]] = bytecast exact b8 122 to i8
// CHECK3-NEXT:    [[CONV56:%.*]] = sext i8 [[CONV55]] to i32
// CHECK3-NEXT:    [[CONV57:%.*]] = bytecast exact b8 97 to i8
// CHECK3-NEXT:    [[CONV58:%.*]] = sext i8 [[CONV57]] to i32
// CHECK3-NEXT:    [[SUB59:%.*]] = sub nsw i32 [[CONV58]], 1
// CHECK3-NEXT:    [[SUB60:%.*]] = sub nsw i32 [[CONV56]], [[SUB59]]
// CHECK3-NEXT:    [[DIV61:%.*]] = sdiv i32 [[SUB60]], 1
// CHECK3-NEXT:    [[MUL62:%.*]] = mul nsw i32 [[DIV61]], 1
// CHECK3-NEXT:    [[SUB63:%.*]] = sub nsw i32 [[CONV54]], [[MUL62]]
// CHECK3-NEXT:    [[CONV64:%.*]] = trunc i32 [[SUB63]] to i8
// CHECK3-NEXT:    [[TMP36:%.*]] = bitcast i8 [[CONV64]] to b8
// CHECK3-NEXT:    store b8 [[TMP36]], ptr [[IT]], align 1
// CHECK3-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK3:       .omp.final.done:
// CHECK3-NEXT:    ret void
//
...
// CHECK3-NEXT:    store i32 0, ptr [[A]], align 4
// CHECK3-NEXT:    store i16 0, ptr [[AA]], align 2
// CHECK3-NEXT:    [[TMP0:%.*]] = bytecast exact b8 0 to i8
// CHECK3-NEXT:    store i8 [[TMP0]], ptr [[AAA]], align 1
// CHECK3-NEXT:    [[TMP1:%.*]] = load i32, ptr [[A]], align 4
// CHECK3-NEXT:    store i32 [[TMP1]], ptr [[A_CASTED]], align 4
// CHECK3-NEXT:    [[TMP2:%.*]] = load i32, ptr [[A_CASTED]], align 4
// CHECK3-NEXT:    [[TMP3:%.*]] = load i16, ptr [[AA]], align 2
// CHECK3-NEXT:    store i16 [[TMP3]], ptr [[AA_CASTED]], align 2
// CHECK3-NEXT:    [[TMP4:%.*]] = load i32, ptr [[AA_CASTED]], align 4
// CHECK3-NEXT:    [[TMP5:%.*]] = load b8, ptr [[AAA]], align 1
// CHECK3-NEXT:    store b8 [[TMP5]], ptr [[AAA_CASTED]], align 1
// CHECK3-NEXT:    [[TMP6:%.*]] = load i32, ptr [[AAA_CASTED]], align 4
// CHECK3-NEXT:    [[TMP7:%.*]] = load i32, ptr [[N_ADDR]], align 4
// CHECK3-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[TMP7]], 50
// CHECK3-NEXT:    br i1 [[CMP]], label [[OMP_IF_THEN:%.*]], label [[OMP_IF_ELSE:%.*]]
// CHECK3:       omp_if.then:
...
// CHECK3-NEXT:    store ptr [[B]], ptr [[TMP18]], align 4
...
// CHECK3-NEXT:    store ptr @.offload_sizes.7, ptr [[TMP26]], align 4
// CHECK3-NEXT:    [[TMP27:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 5
// CHECK3-NEXT:    store ptr @.offload_maptypes.8, ptr [[TMP27]], align 4
...
// CHECK3-NEXT:    [[TMP35:%.*]] = call i32 @__tgt_target_kernel(ptr @[[GLOB2]], i64 -1, i32 1, i32 0, ptr @.{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__ZL7fstatici_l195.region_id, ptr [[KERNEL_ARGS]])
// CHECK3-NEXT:    [[TMP36:%.*]] = icmp ne i32 [[TMP35]], 0
// CHECK3-NEXT:    br i1 [[TMP36]], label [[OMP_OFFLOAD_FAILED:%.*]], label [[OMP_OFFLOAD_CONT:%.*]]
// CHECK3:       omp_offload.failed:
// CHECK3-NEXT:    call void @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__ZL7fstatici_l195(i32 [[TMP2]], i32 [[TMP4]], i32 [[TMP6]], ptr [[B]]) #[[ATTR3]]
// CHECK3-NEXT:    br label [[OMP_OFFLOAD_CONT]]
// CHECK3:       omp_offload.cont:
// CHECK3-NEXT:    br label [[OMP_IF_END:%.*]]
// CHECK3:       omp_if.else:
...
// CHECK3-NEXT:    br label [[OMP_IF_END]]
// CHECK3:       omp_if.end:
// CHECK3-NEXT:    [[TMP37:%.*]] = load i32, ptr [[A]], align 4
...
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK3:       omp.inner.for.cond:
// CHECK3-NEXT:    [[TMP9:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP46:![0-9]+]]
// CHECK3-NEXT:    [[TMP10:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP46]]
// CHECK3-NEXT:    [[CMP3:%.*]] = icmp ule i64 [[TMP9]], [[TMP10]]
// CHECK3-NEXT:    br i1 [[CMP3]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK3:       omp.inner.for.body:
// CHECK3-NEXT:    [[TMP11:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP46]]
// CHECK3-NEXT:    [[MUL:%.*]] = mul i64 [[TMP11]], 400
// CHECK3-NEXT:    [[SUB:%.*]] = sub i64 2000, [[MUL]]
// CHECK3-NEXT:    store i64 [[SUB]], ptr [[IT]], align 8, !llvm.access.group [[ACC_GRP46]]
...
// CHECK3-NEXT:    store double [[ADD]], ptr [[A]], align 4, !llvm.access.group [[ACC_GRP46]]
// CHECK3-NEXT:    [[A4:%.*]] = getelementptr inbounds nuw [[STRUCT_S1]], ptr [[TMP0]], i32 0, i32 0
// CHECK3-NEXT:    [[TMP13:%.*]] = load double, ptr [[A4]], align 4, !llvm.access.group [[ACC_GRP46]]
// CHECK3-NEXT:    [[INC:%.*]] = fadd double [[TMP13]], 1.000000e+00
// CHECK3-NEXT:    store double [[INC]], ptr [[A4]], align 4, !llvm.access.group [[ACC_GRP46]]
...
// CHECK3-NEXT:    store i16 [[CONV5]], ptr [[ARRAYIDX6]], align 2, !llvm.access.group [[ACC_GRP46]]
// CHECK3-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK3:       omp.body.continue:
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
// CHECK3-NEXT:    [[TMP15:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP46]]
// CHECK3-NEXT:    [[ADD7:%.*]] = add i64 [[TMP15]], 1
// CHECK3-NEXT:    store i64 [[ADD7]], ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP46]]
...
// CHECK3-NEXT:    store i16 [[TMP3]], ptr [[AA_CASTED]], align 2
// CHECK3-NEXT:    [[TMP4:%.*]] = load i32, ptr [[AA_CASTED]], align 4
// CHECK3-NEXT:    [[TMP5:%.*]] = load b8, ptr [[AAA_ADDR]], align 1
// CHECK3-NEXT:    store b8 [[TMP5]], ptr [[AAA_CASTED]], align 1
// CHECK3-NEXT:    [[TMP6:%.*]] = load i32, ptr [[AAA_CASTED]], align 4
...
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK3:       omp.inner.for.cond:
// CHECK3-NEXT:    [[TMP6:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP49:![0-9]+]]
// CHECK3-NEXT:    [[TMP7:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP49]]
// CHECK3-NEXT:    [[CMP1:%.*]] = icmp sle i64 [[TMP6]], [[TMP7]]
// CHECK3-NEXT:    br i1 [[CMP1]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK3:       omp.inner.for.body:
// CHECK3-NEXT:    [[TMP8:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP49]]
// CHECK3-NEXT:    [[MUL:%.*]] = mul nsw i64 [[TMP8]], 3
// CHECK3-NEXT:    [[ADD:%.*]] = add nsw i64 -10, [[MUL]]
// CHECK3-NEXT:    store i64 [[ADD]], ptr [[I]], align 8, !llvm.access.group [[ACC_GRP49]]
// CHECK3-NEXT:    [[TMP9:%.*]] = load i32, ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP49]]
// CHECK3-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP9]], 1
// CHECK3-NEXT:    store i32 [[ADD2]], ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP49]]
// CHECK3-NEXT:    [[TMP10:%.*]] = load i16, ptr [[AA_ADDR]], align 2, !llvm.access.group [[ACC_GRP49]]
// CHECK3-NEXT:    [[CONV:%.*]] = sext i16 [[TMP10]] to i32
// CHECK3-NEXT:    [[ADD3:%.*]] = add nsw i32 [[CONV]], 1
// CHECK3-NEXT:    [[CONV4:%.*]] = trunc i32 [[ADD3]] to i16
// CHECK3-NEXT:    store i16 [[CONV4]], ptr [[AA_ADDR]], align 2, !llvm.access.group [[ACC_GRP49]]
// CHECK3-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x i32], ptr [[TMP0]], i32 0, i32 2
// CHECK3-NEXT:    [[TMP11:%.*]] = load i32, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP49]]
// CHECK3-NEXT:    [[ADD5:%.*]] = add nsw i32 [[TMP11]], 1
// CHECK3-NEXT:    store i32 [[ADD5]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP49]]
// CHECK3-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK3:       omp.body.continue:
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
// CHECK3-NEXT:    [[TMP12:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP49]]
// CHECK3-NEXT:    [[ADD6:%.*]] = add nsw i64 [[TMP12]], 1
// CHECK3-NEXT:    store i64 [[ADD6]], ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP49]]
...
// CHECK5-NEXT:    [[DOTCAPTURE_EXPR__ADDR:%.*]] = alloca i64, align 8
// CHECK5-NEXT:    [[DOTOMP_IV:%.*]] = alloca i32, align 4
// CHECK5-NEXT:    [[TMP:%.*]] = alloca b8, align 1
// CHECK5-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK5-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK5-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i32, align 4
// CHECK5-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK5-NEXT:    [[IT:%.*]] = alloca b8, align 1
// CHECK5-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK5-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 8
// CHECK5-NEXT:    store i64 [[A]], ptr [[A_ADDR]], align 8
// CHECK5-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 8
...
// CHECK5-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[D_ADDR]], align 8
// CHECK5-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK5-NEXT:    [[CONV:%.*]] = bytecast exact b8 122 to i8
// CHECK5-NEXT:    [[CONV5:%.*]] = sext i8 [[CONV]] to i32
// CHECK5-NEXT:    [[CONV6:%.*]] = bytecast exact b8 97 to i8
// CHECK5-NEXT:    [[CONV7:%.*]] = sext i8 [[CONV6]] to i32
// CHECK5-NEXT:    [[SUB:%.*]] = sub nsw i32 [[CONV7]], 1
// CHECK5-NEXT:    [[SUB8:%.*]] = sub nsw i32 [[CONV5]], [[SUB]]
// CHECK5-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB8]], 1
// CHECK5-NEXT:    [[SUB9:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK5-NEXT:    store i32 [[SUB9]], ptr [[DOTOMP_UB]], align 4
// CHECK5-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4
// CHECK5-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
...
// CHECK5-NEXT:    [[CONV10:%.*]] = bytecast exact b8 122 to i8
// CHECK5-NEXT:    [[CONV11:%.*]] = sext i8 [[CONV10]] to i32
// CHECK5-NEXT:    [[CONV12:%.*]] = bytecast exact b8 97 to i8
// CHECK5-NEXT:    [[CONV13:%.*]] = sext i8 [[CONV12]] to i32
// CHECK5-NEXT:    [[SUB14:%.*]] = sub nsw i32 [[CONV13]], 1
// CHECK5-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[CONV11]], [[SUB14]]
// CHECK5-NEXT:    [[DIV16:%.*]] = sdiv i32 [[SUB15]], 1
// CHECK5-NEXT:    [[SUB17:%.*]] = sub nsw i32 [[DIV16]], 1
// CHECK5-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[TMP11]], [[SUB17]]
// CHECK5-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK5:       cond.true:
// CHECK5-NEXT:    [[CONV18:%.*]] = bytecast exact b8 122 to i8
// CHECK5-NEXT:    [[CONV19:%.*]] = sext i8 [[CONV18]] to i32
// CHECK5-NEXT:    [[CONV20:%.*]] = bytecast exact b8 97 to i8
// CHECK5-NEXT:    [[CONV21:%.*]] = sext i8 [[CONV20]] to i32
// CHECK5-NEXT:    [[SUB22:%.*]] = sub nsw i32 [[CONV21]], 1
// CHECK5-NEXT:    [[SUB23:%.*]] = sub nsw i32 [[CONV19]], [[SUB22]]
// CHECK5-NEXT:    [[DIV24:%.*]] = sdiv i32 [[SUB23]], 1
// CHECK5-NEXT:    [[SUB25:%.*]] = sub nsw i32 [[DIV24]], 1
// CHECK5-NEXT:    br label [[COND_END:%.*]]
// CHECK5:       cond.false:
// CHECK5-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK5-NEXT:    br label [[COND_END]]
// CHECK5:       cond.end:
// CHECK5-NEXT:    [[COND:%.*]] = phi i32 [ [[SUB25]], [[COND_TRUE]] ], [ [[TMP12]], [[COND_FALSE]] ]
// CHECK5-NEXT:    store i32 [[COND]], ptr [[DOTOMP_UB]], align 4
...
// CHECK5-NEXT:    br i1 [[CMP26]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]]
// CHECK5:       omp.dispatch.body:
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK5:       omp.inner.for.cond:
// CHECK5-NEXT:    [[TMP16:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP42:![0-9]+]]
// CHECK5-NEXT:    [[TMP17:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    [[CMP27:%.*]] = icmp sle i32 [[TMP16]], [[TMP17]]
// CHECK5-NEXT:    br i1 [[CMP27]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK5:       omp.inner.for.body:
// CHECK5-NEXT:    [[CONV28:%.*]] = bytecast exact b8 122 to i8
// CHECK5-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK5-NEXT:    [[TMP18:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP18]], 1
// CHECK5-NEXT:    [[SUB30:%.*]] = sub nsw i32 [[CONV29]], [[MUL]]
// CHECK5-NEXT:    [[CONV31:%.*]] = trunc i32 [[SUB30]] to i8
// CHECK5-NEXT:    [[TMP19:%.*]] = bitcast i8 [[CONV31]] to b8
// CHECK5-NEXT:    store b8 [[TMP19]], ptr [[IT]], align 1, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    [[TMP20:%.*]] = load i32, ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP20]], 1
// CHECK5-NEXT:    store i32 [[ADD]], ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x float], ptr [[TMP0]], i64 0, i64 2
// CHECK5-NEXT:    [[TMP21:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    [[CONV32:%.*]] = fpext float [[TMP21]] to double
// CHECK5-NEXT:    [[ADD33:%.*]] = fadd double [[CONV32]], 1.000000e+00
// CHECK5-NEXT:    [[CONV34:%.*]] = fptrunc double [[ADD33]] to float
// CHECK5-NEXT:    store float [[CONV34]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    [[ARRAYIDX35:%.*]] = getelementptr inbounds float, ptr [[TMP2]], i64 3
// CHECK5-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    [[CONV36:%.*]] = fpext float [[TMP22]] to double
// CHECK5-NEXT:    [[ADD37:%.*]] = fadd double [[CONV36]], 1.000000e+00
// CHECK5-NEXT:    [[CONV38:%.*]] = fptrunc double [[ADD37]] to float
// CHECK5-NEXT:    store float [[CONV38]], ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    [[ARRAYIDX39:%.*]] = getelementptr inbounds [5 x [10 x double]], ptr [[TMP3]], i64 0, i64 1
// CHECK5-NEXT:    [[ARRAYIDX40:%.*]] = getelementptr inbounds [10 x double], ptr [[ARRAYIDX39]], i64 0, i64 2
// CHECK5-NEXT:    [[TMP23:%.*]] = load double, ptr [[ARRAYIDX40]], align 8, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    [[ADD41:%.*]] = fadd double [[TMP23]], 1.000000e+00
// CHECK5-NEXT:    store double [[ADD41]], ptr [[ARRAYIDX40]], align 8, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    [[TMP24:%.*]] = mul nsw i64 1, [[TMP5]]
// CHECK5-NEXT:    [[ARRAYIDX42:%.*]] = getelementptr inbounds double, ptr [[TMP6]], i64 [[TMP24]]
// CHECK5-NEXT:    [[ARRAYIDX43:%.*]] = getelementptr inbounds double, ptr [[ARRAYIDX42]], i64 3
// CHECK5-NEXT:    [[TMP25:%.*]] = load double, ptr [[ARRAYIDX43]], align 8, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    [[ADD44:%.*]] = fadd double [[TMP25]], 1.000000e+00
// CHECK5-NEXT:    store double [[ADD44]], ptr [[ARRAYIDX43]], align 8, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    [[X:%.*]] = getelementptr inbounds nuw [[STRUCT_TT:%.*]], ptr [[TMP7]], i32 0, i32 0
// CHECK5-NEXT:    [[TMP26:%.*]] = load i64, ptr [[X]], align 8, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    [[ADD45:%.*]] = add nsw i64 [[TMP26]], 1
// CHECK5-NEXT:    store i64 [[ADD45]], ptr [[X]], align 8, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TT]], ptr [[TMP7]], i32 0, i32 1
// CHECK5-NEXT:    [[TMP27:%.*]] = load b8, ptr [[Y]], align 8, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    [[CONV46:%.*]] = bytecast exact b8 [[TMP27]] to i8
// CHECK5-NEXT:    [[CONV47:%.*]] = sext i8 [[CONV46]] to i32
// CHECK5-NEXT:    [[ADD48:%.*]] = add nsw i32 [[CONV47]], 1
// CHECK5-NEXT:    [[CONV49:%.*]] = trunc i32 [[ADD48]] to i8
// CHECK5-NEXT:    [[TMP28:%.*]] = bitcast i8 [[CONV49]] to b8
// CHECK5-NEXT:    store b8 [[TMP28]], ptr [[Y]], align 8, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK5:       omp.body.continue:
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK5:       omp.inner.for.inc:
// CHECK5-NEXT:    [[TMP29:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    [[ADD50:%.*]] = add nsw i32 [[TMP29]], 1
// CHECK5-NEXT:    store i32 [[ADD50]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP42]]
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_COND]], !llvm.loop [[LOOP43:![0-9]+]]
// CHECK5:       omp.inner.for.end:
// CHECK5-NEXT:    br label [[OMP_DISPATCH_INC:%.*]]
// CHECK5:       omp.dispatch.inc:
// CHECK5-NEXT:    [[TMP30:%.*]] = load i32, ptr [[DOTOMP_LB]], align 4
// CHECK5-NEXT:    [[TMP31:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4
// CHECK5-NEXT:    [[ADD51:%.*]] = add nsw i32 [[TMP30]], [[TMP31]]
// CHECK5-NEXT:    store i32 [[ADD51]], ptr [[DOTOMP_LB]], align 4
// CHECK5-NEXT:    [[TMP32:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK5-NEXT:    [[TMP33:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4
// CHECK5-NEXT:    [[ADD52:%.*]] = add nsw i32 [[TMP32]], [[TMP33]]
// CHECK5-NEXT:    store i32 [[ADD52]], ptr [[DOTOMP_UB]], align 4
// CHECK5-NEXT:    br label [[OMP_DISPATCH_COND]]
// CHECK5:       omp.dispatch.end:
// CHECK5-NEXT:    call void @__kmpc_for_static_fini(ptr @[[GLOB1]], i32 [[TMP10]])
// CHECK5-NEXT:    [[TMP34:%.*]] = load i32, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK5-NEXT:    [[TMP35:%.*]] = icmp ne i32 [[TMP34]], 0
// CHECK5-NEXT:    br i1 [[TMP35]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK5:       .omp.final.then:
// CHECK5-NEXT:    [[CONV53:%.*]] = bytecast exact b8 122 to i8
// CHECK5-NEXT:    [[CONV54:%.*]] = sext i8 [[CONV53]] to i32
// CHECK5-NEXT:    [[CONV55:%.*]] = bytecast exact b8 122 to i8
// CHECK5-NEXT:    [[CONV56:%.*]] = sext i8 [[CONV55]] to i32
// CHECK5-NEXT:    [[CONV57:%.*]] = bytecast exact b8 97 to i8
// CHECK5-NEXT:    [[CONV58:%.*]] = sext i8 [[CONV57]] to i32
// CHECK5-NEXT:    [[SUB59:%.*]] = sub nsw i32 [[CONV58]], 1
// CHECK5-NEXT:    [[SUB60:%.*]] = sub nsw i32 [[CONV56]], [[SUB59]]
// CHECK5-NEXT:    [[DIV61:%.*]] = sdiv i32 [[SUB60]], 1
// CHECK5-NEXT:    [[MUL62:%.*]] = mul nsw i32 [[DIV61]], 1
// CHECK5-NEXT:    [[SUB63:%.*]] = sub nsw i32 [[CONV54]], [[MUL62]]
// CHECK5-NEXT:    [[CONV64:%.*]] = trunc i32 [[SUB63]] to i8
// CHECK5-NEXT:    [[TMP36:%.*]] = bitcast i8 [[CONV64]] to b8
// CHECK5-NEXT:    store b8 [[TMP36]], ptr [[IT]], align 1
// CHECK5-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK5:       .omp.final.done:
// CHECK5-NEXT:    ret void
//
...
// CHECK5-NEXT:    [[A:%.*]] = alloca i32, align 4
// CHECK5-NEXT:    [[AA:%.*]] = alloca i16, align 2
// CHECK5-NEXT:    [[AAA:%.*]] = alloca b8, align 1
...
// CHECK5-NEXT:    store i32 0, ptr [[A]], align 4
// CHECK5-NEXT:    store i16 0, ptr [[AA]], align 2
// CHECK5-NEXT:    [[TMP0:%.*]] = bytecast exact b8 0 to i8
// CHECK5-NEXT:    store i8 [[TMP0]], ptr [[AAA]], align 1
// CHECK5-NEXT:    [[TMP1:%.*]] = load i32, ptr [[A]], align 4
// CHECK5-NEXT:    store i32 [[TMP1]], ptr [[A_CASTED]], align 4
// CHECK5-NEXT:    [[TMP2:%.*]] = load i64, ptr [[A_CASTED]], align 8
// CHECK5-NEXT:    [[TMP3:%.*]] = load i16, ptr [[AA]], align 2
// CHECK5-NEXT:    store i16 [[TMP3]], ptr [[AA_CASTED]], align 2
// CHECK5-NEXT:    [[TMP4:%.*]] = load i64, ptr [[AA_CASTED]], align 8
// CHECK5-NEXT:    [[TMP5:%.*]] = load b8, ptr [[AAA]], align 1
// CHECK5-NEXT:    store b8 [[TMP5]], ptr [[AAA_CASTED]], align 1
// CHECK5-NEXT:    [[TMP6:%.*]] = load i64, ptr [[AAA_CASTED]], align 8
// CHECK5-NEXT:    [[TMP7:%.*]] = load i32, ptr [[N_ADDR]], align 4
// CHECK5-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[TMP7]], 50
// CHECK5-NEXT:    br i1 [[CMP]], label [[OMP_IF_THEN:%.*]], label [[OMP_IF_ELSE:%.*]]
// CHECK5:       omp_if.then:
// CHECK5-NEXT:    [[TMP8:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 0
// CHECK5-NEXT:    store i64 [[TMP2]], ptr [[TMP8]], align 8
// CHECK5-NEXT:    [[TMP9:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 0
// CHECK5-NEXT:    store i64 [[TMP2]], ptr [[TMP9]], align 8
// CHECK5-NEXT:    [[TMP10:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_MAPPERS]], i64 0, i64 0
// CHECK5-NEXT:    store ptr null, ptr [[TMP10]], align 8
// CHECK5-NEXT:    [[TMP11:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 1
// CHECK5-NEXT:    store i64 [[TMP4]], ptr [[TMP11]], align 8
// CHECK5-NEXT:    [[TMP12:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 1
// CHECK5-NEXT:    store i64 [[TMP4]], ptr [[TMP12]], align 8
...
// CHECK5-NEXT:    store i64 [[TMP6]], ptr [[TMP14]], align 8
// CHECK5-NEXT:    [[TMP15:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 2
// CHECK5-NEXT:    store i64 [[TMP6]], ptr [[TMP15]], align 8
// CHECK5-NEXT:    [[TMP16:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_MAPPERS]], i64 0, i64 2
// CHECK5-NEXT:    store ptr null, ptr [[TMP16]], align 8
// CHECK5-NEXT:    [[TMP17:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 3
// CHECK5-NEXT:    store ptr [[B]], ptr [[TMP17]], align 8
// CHECK5-NEXT:    [[TMP18:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 3
// CHECK5-NEXT:    store ptr [[B]], ptr [[TMP18]], align 8
// CHECK5-NEXT:    [[TMP19:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_MAPPERS]], i64 0, i64 3
// CHECK5-NEXT:    store ptr null, ptr [[TMP19]], align 8
// CHECK5-NEXT:    [[TMP20:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 0
// CHECK5-NEXT:    [[TMP21:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 0
// CHECK5-NEXT:    [[TMP22:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 0
// CHECK5-NEXT:    store i32 3, ptr [[TMP22]], align 4
// CHECK5-NEXT:    [[TMP23:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 1
// CHECK5-NEXT:    store i32 4, ptr [[TMP23]], align 4
// CHECK5-NEXT:    [[TMP24:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 2
// CHECK5-NEXT:    store ptr [[TMP20]], ptr [[TMP24]], align 8
// CHECK5-NEXT:    [[TMP25:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 3
// CHECK5-NEXT:    store ptr [[TMP21]], ptr [[TMP25]], align 8
// CHECK5-NEXT:    [[TMP26:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 4
// CHECK5-NEXT:    store ptr @.offload_sizes.7, ptr [[TMP26]], align 8
// CHECK5-NEXT:    [[TMP27:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 5
// CHECK5-NEXT:    store ptr @.offload_maptypes.8, ptr [[TMP27]], align 8
// CHECK5-NEXT:    [[TMP28:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 6
// CHECK5-NEXT:    store ptr null, ptr [[TMP28]], align 8
// CHECK5-NEXT:    [[TMP29:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 7
// CHECK5-NEXT:    store ptr null, ptr [[TMP29]], align 8
// CHECK5-NEXT:    [[TMP30:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 8
// CHECK5-NEXT:    store i64 0, ptr [[TMP30]], align 8
// CHECK5-NEXT:    [[TMP31:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 9
// CHECK5-NEXT:    store i64 0, ptr [[TMP31]], align 8
// CHECK5-NEXT:    [[TMP32:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 10
// CHECK5-NEXT:    store [3 x i32] [i32 1, i32 0, i32 0], ptr [[TMP32]], align 4
// CHECK5-NEXT:    [[TMP33:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 11
// CHECK5-NEXT:    store [3 x i32] zeroinitializer, ptr [[TMP33]], align 4
// CHECK5-NEXT:    [[TMP34:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 12
// CHECK5-NEXT:    store i32 0, ptr [[TMP34]], align 4
// CHECK5-NEXT:    [[TMP35:%.*]] = call i32 @__tgt_target_kernel(ptr @[[GLOB2]], i64 -1, i32 1, i32 0, ptr @.{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__ZL7fstatici_l195.region_id, ptr [[KERNEL_ARGS]])
// CHECK5-NEXT:    [[TMP36:%.*]] = icmp ne i32 [[TMP35]], 0
// CHECK5-NEXT:    br i1 [[TMP36]], label [[OMP_OFFLOAD_FAILED:%.*]], label [[OMP_OFFLOAD_CONT:%.*]]
// CHECK5:       omp_offload.failed:
// CHECK5-NEXT:    call void @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__ZL7fstatici_l195(i64 [[TMP2]], i64 [[TMP4]], i64 [[TMP6]], ptr [[B]]) #[[ATTR3]]
// CHECK5-NEXT:    br label [[OMP_OFFLOAD_CONT]]
// CHECK5:       omp_offload.cont:
// CHECK5-NEXT:    br label [[OMP_IF_END:%.*]]
// CHECK5:       omp_if.else:
...
// CHECK5-NEXT:    br label [[OMP_IF_END]]
// CHECK5:       omp_if.end:
// CHECK5-NEXT:    [[TMP37:%.*]] = load i32, ptr [[A]], align 4
...
// CHECK5-NEXT:    store i16 [[TMP3]], ptr [[AA_CASTED]], align 2
// CHECK5-NEXT:    [[TMP4:%.*]] = load i64, ptr [[AA_CASTED]], align 8
// CHECK5-NEXT:    [[TMP5:%.*]] = load b8, ptr [[AAA_ADDR]], align 1
// CHECK5-NEXT:    store b8 [[TMP5]], ptr [[AAA_CASTED]], align 1
// CHECK5-NEXT:    [[TMP6:%.*]] = load i64, ptr [[AAA_CASTED]], align 8
...
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK7:       omp.inner.for.cond:
// CHECK7-NEXT:    [[TMP6:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP34:![0-9]+]]
// CHECK7-NEXT:    [[TMP7:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4, !llvm.access.group [[ACC_GRP34]]
// CHECK7-NEXT:    [[CMP:%.*]] = icmp sle i32 [[TMP6]], [[TMP7]]
// CHECK7-NEXT:    br i1 [[CMP]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK7:       omp.inner.for.body:
// CHECK7-NEXT:    [[TMP8:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP34]]
// CHECK7-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP8]], 1
// CHECK7-NEXT:    [[SUB:%.*]] = sub nsw i32 10, [[MUL]]
// CHECK7-NEXT:    store i32 [[SUB]], ptr [[I]], align 4, !llvm.access.group [[ACC_GRP34]]
// CHECK7-NEXT:    [[TMP9:%.*]] = load i64, ptr [[DOTLINEAR_START]], align 8, !llvm.access.group [[ACC_GRP34]]
...
// CHECK7-NEXT:    store i64 [[ADD]], ptr [[K1]], align 8, !llvm.access.group [[ACC_GRP34]]
// CHECK7-NEXT:    [[TMP11:%.*]] = load i32, ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP34]]
// CHECK7-NEXT:    [[ADD3:%.*]] = add nsw i32 [[TMP11]], 1
// CHECK7-NEXT:    store i32 [[ADD3]], ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP34]]
// CHECK7-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK7:       omp.body.continue:
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK7:       omp.inner.for.inc:
...
// CHECK7-NEXT:    store i32 [[ADD4]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP34]]
...
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK7:       omp.inner.for.cond:
// CHECK7-NEXT:    [[TMP7:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP37:![0-9]+]]
// CHECK7-NEXT:    [[TMP8:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK7-NEXT:    [[CMP4:%.*]] = icmp ule i64 [[TMP7]], [[TMP8]]
// CHECK7-NEXT:    br i1 [[CMP4]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK7:       omp.inner.for.body:
// CHECK7-NEXT:    [[TMP9:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK7-NEXT:    [[MUL:%.*]] = mul i64 [[TMP9]], 400
// CHECK7-NEXT:    [[SUB:%.*]] = sub i64 2000, [[MUL]]
// CHECK7-NEXT:    store i64 [[SUB]], ptr [[IT]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK7-NEXT:    [[TMP10:%.*]] = load i32, ptr [[DOTLINEAR_START]], align 4, !llvm.access.group [[ACC_GRP37]]
// CHECK7-NEXT:    [[CONV:%.*]] = sext i32 [[TMP10]] to i64
// CHECK7-NEXT:    [[TMP11:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK7-NEXT:    [[TMP12:%.*]] = load i64, ptr [[DOTLINEAR_STEP]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK7-NEXT:    [[MUL5:%.*]] = mul i64 [[TMP11]], [[TMP12]]
// CHECK7-NEXT:    [[ADD:%.*]] = add i64 [[CONV]], [[MUL5]]
// CHECK7-NEXT:    [[CONV6:%.*]] = trunc i64 [[ADD]] to i32
// CHECK7-NEXT:    store i32 [[CONV6]], ptr [[LIN2]], align 4, !llvm.access.group [[ACC_GRP37]]
// CHECK7-NEXT:    [[TMP13:%.*]] = load i32, ptr [[DOTLINEAR_START1]], align 4, !llvm.access.group [[ACC_GRP37]]
// CHECK7-NEXT:    [[CONV7:%.*]] = sext i32 [[TMP13]] to i64
// CHECK7-NEXT:    [[TMP14:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK7-NEXT:    [[TMP15:%.*]] = load i64, ptr [[DOTLINEAR_STEP]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK7-NEXT:    [[MUL8:%.*]] = mul i64 [[TMP14]], [[TMP15]]
// CHECK7-NEXT:    [[ADD9:%.*]] = add i64 [[CONV7]], [[MUL8]]
// CHECK7-NEXT:    [[CONV10:%.*]] = trunc i64 [[ADD9]] to i32
// CHECK7-NEXT:    store i32 [[CONV10]], ptr [[A3]], align 4, !llvm.access.group [[ACC_GRP37]]
// CHECK7-NEXT:    [[TMP16:%.*]] = load i16, ptr [[AA_ADDR]], align 2, !llvm.access.group [[ACC_GRP37]]
// CHECK7-NEXT:    [[CONV11:%.*]] = sext i16 [[TMP16]] to i32
// CHECK7-NEXT:    [[ADD12:%.*]] = add nsw i32 [[CONV11]], 1
// CHECK7-NEXT:    [[CONV13:%.*]] = trunc i32 [[ADD12]] to i16
// CHECK7-NEXT:    store i16 [[CONV13]], ptr [[AA_ADDR]], align 2, !llvm.access.group [[ACC_GRP37]]
// CHECK7-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK7:       omp.body.continue:
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK7:       omp.inner.for.inc:
// CHECK7-NEXT:    [[TMP17:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK7-NEXT:    [[ADD14:%.*]] = add i64 [[TMP17]], 1
// CHECK7-NEXT:    store i64 [[ADD14]], ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP37]]
...
// CHECK7-NEXT:    store i16 [[CONV]], ptr [[IT]], align 2, !llvm.access.group [[ACC_GRP40]]
...
// CHECK7-NEXT:    store i16 [[CONV5]], ptr [[AA_ADDR]], align 2, !llvm.access.group [[ACC_GRP40]]
// CHECK7-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK7:       omp.body.continue:
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK7:       omp.inner.for.inc:
...
// CHECK7-NEXT:    store i32 [[ADD6]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP40]]
...
// CHECK7-NEXT:    [[DOTCAPTURE_EXPR__ADDR:%.*]] = alloca i32, align 4
// CHECK7-NEXT:    [[DOTOMP_IV:%.*]] = alloca i32, align 4
// CHECK7-NEXT:    [[TMP:%.*]] = alloca b8, align 1
// CHECK7-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK7-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK7-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i32, align 4
// CHECK7-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK7-NEXT:    [[IT:%.*]] = alloca b8, align 1
// CHECK7-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK7-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 4
// CHECK7-NEXT:    store i32 [[A]], ptr [[A_ADDR]], align 4
// CHECK7-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 4
...
// CHECK7-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[D_ADDR]], align 4
// CHECK7-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK7-NEXT:    [[CONV:%.*]] = bytecast exact b8 122 to i8
// CHECK7-NEXT:    [[CONV5:%.*]] = sext i8 [[CONV]] to i32
// CHECK7-NEXT:    [[CONV6:%.*]] = bytecast exact b8 97 to i8
// CHECK7-NEXT:    [[CONV7:%.*]] = sext i8 [[CONV6]] to i32
// CHECK7-NEXT:    [[SUB:%.*]] = sub nsw i32 [[CONV7]], 1
// CHECK7-NEXT:    [[SUB8:%.*]] = sub nsw i32 [[CONV5]], [[SUB]]
// CHECK7-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB8]], 1
// CHECK7-NEXT:    [[SUB9:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK7-NEXT:    store i32 [[SUB9]], ptr [[DOTOMP_UB]], align 4
// CHECK7-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4
// CHECK7-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
...
// CHECK7-NEXT:    [[CONV10:%.*]] = bytecast exact b8 122 to i8
// CHECK7-NEXT:    [[CONV11:%.*]] = sext i8 [[CONV10]] to i32
// CHECK7-NEXT:    [[CONV12:%.*]] = bytecast exact b8 97 to i8
// CHECK7-NEXT:    [[CONV13:%.*]] = sext i8 [[CONV12]] to i32
// CHECK7-NEXT:    [[SUB14:%.*]] = sub nsw i32 [[CONV13]], 1
// CHECK7-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[CONV11]], [[SUB14]]
// CHECK7-NEXT:    [[DIV16:%.*]] = sdiv i32 [[SUB15]], 1
// CHECK7-NEXT:    [[SUB17:%.*]] = sub nsw i32 [[DIV16]], 1
// CHECK7-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[TMP11]], [[SUB17]]
// CHECK7-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK7:       cond.true:
// CHECK7-NEXT:    [[CONV18:%.*]] = bytecast exact b8 122 to i8
// CHECK7-NEXT:    [[CONV19:%.*]] = sext i8 [[CONV18]] to i32
// CHECK7-NEXT:    [[CONV20:%.*]] = bytecast exact b8 97 to i8
// CHECK7-NEXT:    [[CONV21:%.*]] = sext i8 [[CONV20]] to i32
// CHECK7-NEXT:    [[SUB22:%.*]] = sub nsw i32 [[CONV21]], 1
// CHECK7-NEXT:    [[SUB23:%.*]] = sub nsw i32 [[CONV19]], [[SUB22]]
// CHECK7-NEXT:    [[DIV24:%.*]] = sdiv i32 [[SUB23]], 1
// CHECK7-NEXT:    [[SUB25:%.*]] = sub nsw i32 [[DIV24]], 1
// CHECK7-NEXT:    br label [[COND_END:%.*]]
// CHECK7:       cond.false:
// CHECK7-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK7-NEXT:    br label [[COND_END]]
// CHECK7:       cond.end:
// CHECK7-NEXT:    [[COND:%.*]] = phi i32 [ [[SUB25]], [[COND_TRUE]] ], [ [[TMP12]], [[COND_FALSE]] ]
// CHECK7-NEXT:    store i32 [[COND]], ptr [[DOTOMP_UB]], align 4
...
// CHECK7-NEXT:    [[CMP26:%.*]] = icmp sle i32 [[TMP14]], [[TMP15]]
// CHECK7-NEXT:    br i1 [[CMP26]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]]
// CHECK7:       omp.dispatch.body:
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK7:       omp.inner.for.cond:
// CHECK7-NEXT:    [[TMP16:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP43:![0-9]+]]
// CHECK7-NEXT:    [[TMP17:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    [[CMP27:%.*]] = icmp sle i32 [[TMP16]], [[TMP17]]
// CHECK7-NEXT:    br i1 [[CMP27]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK7:       omp.inner.for.body:
// CHECK7-NEXT:    [[CONV28:%.*]] = bytecast exact b8 122 to i8
// CHECK7-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK7-NEXT:    [[TMP18:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP18]], 1
// CHECK7-NEXT:    [[SUB30:%.*]] = sub nsw i32 [[CONV29]], [[MUL]]
// CHECK7-NEXT:    [[CONV31:%.*]] = trunc i32 [[SUB30]] to i8
// CHECK7-NEXT:    [[TMP19:%.*]] = bitcast i8 [[CONV31]] to b8
// CHECK7-NEXT:    store b8 [[TMP19]], ptr [[IT]], align 1, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    [[TMP20:%.*]] = load i32, ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP20]], 1
// CHECK7-NEXT:    store i32 [[ADD]], ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x float], ptr [[TMP0]], i32 0, i32 2
// CHECK7-NEXT:    [[TMP21:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    [[CONV32:%.*]] = fpext float [[TMP21]] to double
// CHECK7-NEXT:    [[ADD33:%.*]] = fadd double [[CONV32]], 1.000000e+00
// CHECK7-NEXT:    [[CONV34:%.*]] = fptrunc double [[ADD33]] to float
// CHECK7-NEXT:    store float [[CONV34]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    [[ARRAYIDX35:%.*]] = getelementptr inbounds float, ptr [[TMP2]], i32 3
// CHECK7-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    [[CONV36:%.*]] = fpext float [[TMP22]] to double
// CHECK7-NEXT:    [[ADD37:%.*]] = fadd double [[CONV36]], 1.000000e+00
// CHECK7-NEXT:    [[CONV38:%.*]] = fptrunc double [[ADD37]] to float
// CHECK7-NEXT:    store float [[CONV38]], ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    [[ARRAYIDX39:%.*]] = getelementptr inbounds [5 x [10 x double]], ptr [[TMP3]], i32 0, i32 1
// CHECK7-NEXT:    [[ARRAYIDX40:%.*]] = getelementptr inbounds [10 x double], ptr [[ARRAYIDX39]], i32 0, i32 2
// CHECK7-NEXT:    [[TMP23:%.*]] = load double, ptr [[ARRAYIDX40]], align 8, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    [[ADD41:%.*]] = fadd double [[TMP23]], 1.000000e+00
// CHECK7-NEXT:    store double [[ADD41]], ptr [[ARRAYIDX40]], align 8, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    [[TMP24:%.*]] = mul nsw i32 1, [[TMP5]]
// CHECK7-NEXT:    [[ARRAYIDX42:%.*]] = getelementptr inbounds double, ptr [[TMP6]], i32 [[TMP24]]
// CHECK7-NEXT:    [[ARRAYIDX43:%.*]] = getelementptr inbounds double, ptr [[ARRAYIDX42]], i32 3
// CHECK7-NEXT:    [[TMP25:%.*]] = load double, ptr [[ARRAYIDX43]], align 8, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    [[ADD44:%.*]] = fadd double [[TMP25]], 1.000000e+00
// CHECK7-NEXT:    store double [[ADD44]], ptr [[ARRAYIDX43]], align 8, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    [[X:%.*]] = getelementptr inbounds nuw [[STRUCT_TT:%.*]], ptr [[TMP7]], i32 0, i32 0
// CHECK7-NEXT:    [[TMP26:%.*]] = load i64, ptr [[X]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    [[ADD45:%.*]] = add nsw i64 [[TMP26]], 1
// CHECK7-NEXT:    store i64 [[ADD45]], ptr [[X]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TT]], ptr [[TMP7]], i32 0, i32 1
// CHECK7-NEXT:    [[TMP27:%.*]] = load b8, ptr [[Y]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    [[CONV46:%.*]] = bytecast exact b8 [[TMP27]] to i8
// CHECK7-NEXT:    [[CONV47:%.*]] = sext i8 [[CONV46]] to i32
// CHECK7-NEXT:    [[ADD48:%.*]] = add nsw i32 [[CONV47]], 1
// CHECK7-NEXT:    [[CONV49:%.*]] = trunc i32 [[ADD48]] to i8
// CHECK7-NEXT:    [[TMP28:%.*]] = bitcast i8 [[CONV49]] to b8
// CHECK7-NEXT:    store b8 [[TMP28]], ptr [[Y]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK7:       omp.body.continue:
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK7:       omp.inner.for.inc:
// CHECK7-NEXT:    [[TMP29:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    [[ADD50:%.*]] = add nsw i32 [[TMP29]], 1
// CHECK7-NEXT:    store i32 [[ADD50]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP43]]
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_COND]], !llvm.loop [[LOOP44:![0-9]+]]
// CHECK7:       omp.inner.for.end:
// CHECK7-NEXT:    br label [[OMP_DISPATCH_INC:%.*]]
// CHECK7:       omp.dispatch.inc:
// CHECK7-NEXT:    [[TMP30:%.*]] = load i32, ptr [[DOTOMP_LB]], align 4
// CHECK7-NEXT:    [[TMP31:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4
// CHECK7-NEXT:    [[ADD51:%.*]] = add nsw i32 [[TMP30]], [[TMP31]]
// CHECK7-NEXT:    store i32 [[ADD51]], ptr [[DOTOMP_LB]], align 4
// CHECK7-NEXT:    [[TMP32:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK7-NEXT:    [[TMP33:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4
// CHECK7-NEXT:    [[ADD52:%.*]] = add nsw i32 [[TMP32]], [[TMP33]]
// CHECK7-NEXT:    store i32 [[ADD52]], ptr [[DOTOMP_UB]], align 4
// CHECK7-NEXT:    br label [[OMP_DISPATCH_COND]]
// CHECK7:       omp.dispatch.end:
// CHECK7-NEXT:    call void @__kmpc_for_static_fini(ptr @[[GLOB1]], i32 [[TMP10]])
// CHECK7-NEXT:    [[TMP34:%.*]] = load i32, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK7-NEXT:    [[TMP35:%.*]] = icmp ne i32 [[TMP34]], 0
// CHECK7-NEXT:    br i1 [[TMP35]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK7:       .omp.final.then:
// CHECK7-NEXT:    [[CONV53:%.*]] = bytecast exact b8 122 to i8
// CHECK7-NEXT:    [[CONV54:%.*]] = sext i8 [[CONV53]] to i32
// CHECK7-NEXT:    [[CONV55:%.*]] = bytecast exact b8 122 to i8
// CHECK7-NEXT:    [[CONV56:%.*]] = sext i8 [[CONV55]] to i32
// CHECK7-NEXT:    [[CONV57:%.*]] = bytecast exact b8 97 to i8
// CHECK7-NEXT:    [[CONV58:%.*]] = sext i8 [[CONV57]] to i32
// CHECK7-NEXT:    [[SUB59:%.*]] = sub nsw i32 [[CONV58]], 1
// CHECK7-NEXT:    [[SUB60:%.*]] = sub nsw i32 [[CONV56]], [[SUB59]]
// CHECK7-NEXT:    [[DIV61:%.*]] = sdiv i32 [[SUB60]], 1
// CHECK7-NEXT:    [[MUL62:%.*]] = mul nsw i32 [[DIV61]], 1
// CHECK7-NEXT:    [[SUB63:%.*]] = sub nsw i32 [[CONV54]], [[MUL62]]
// CHECK7-NEXT:    [[CONV64:%.*]] = trunc i32 [[SUB63]] to i8
// CHECK7-NEXT:    [[TMP36:%.*]] = bitcast i8 [[CONV64]] to b8
// CHECK7-NEXT:    store b8 [[TMP36]], ptr [[IT]], align 1
// CHECK7-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK7:       .omp.final.done:
// CHECK7-NEXT:    ret void
//
...
// CHECK7-NEXT:    [[A:%.*]] = alloca i32, align 4
// CHECK7-NEXT:    [[AA:%.*]] = alloca i16, align 2
// CHECK7-NEXT:    [[AAA:%.*]] = alloca b8, align 1
...
// CHECK7-NEXT:    store i32 0, ptr [[A]], align 4
// CHECK7-NEXT:    store i16 0, ptr [[AA]], align 2
// CHECK7-NEXT:    [[TMP0:%.*]] = bytecast exact b8 0 to i8
// CHECK7-NEXT:    store i8 [[TMP0]], ptr [[AAA]], align 1
// CHECK7-NEXT:    [[TMP1:%.*]] = load i32, ptr [[A]], align 4
// CHECK7-NEXT:    store i32 [[TMP1]], ptr [[A_CASTED]], align 4
// CHECK7-NEXT:    [[TMP2:%.*]] = load i32, ptr [[A_CASTED]], align 4
// CHECK7-NEXT:    [[TMP3:%.*]] = load i16, ptr [[AA]], align 2
// CHECK7-NEXT:    store i16 [[TMP3]], ptr [[AA_CASTED]], align 2
// CHECK7-NEXT:    [[TMP4:%.*]] = load i32, ptr [[AA_CASTED]], align 4
// CHECK7-NEXT:    [[TMP5:%.*]] = load b8, ptr [[AAA]], align 1
// CHECK7-NEXT:    store b8 [[TMP5]], ptr [[AAA_CASTED]], align 1
// CHECK7-NEXT:    [[TMP6:%.*]] = load i32, ptr [[AAA_CASTED]], align 4
// CHECK7-NEXT:    [[TMP7:%.*]] = load i32, ptr [[N_ADDR]], align 4
// CHECK7-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[TMP7]], 50
// CHECK7-NEXT:    br i1 [[CMP]], label [[OMP_IF_THEN:%.*]], label [[OMP_IF_ELSE:%.*]]
// CHECK7:       omp_if.then:
// CHECK7-NEXT:    [[TMP8:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 0
// CHECK7-NEXT:    store i32 [[TMP2]], ptr [[TMP8]], align 4
// CHECK7-NEXT:    [[TMP9:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 0
// CHECK7-NEXT:    store i32 [[TMP2]], ptr [[TMP9]], align 4
// CHECK7-NEXT:    [[TMP10:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_MAPPERS]], i32 0, i32 0
// CHECK7-NEXT:    store ptr null, ptr [[TMP10]], align 4
// CHECK7-NEXT:    [[TMP11:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 1
// CHECK7-NEXT:    store i32 [[TMP4]], ptr [[TMP11]], align 4
// CHECK7-NEXT:    [[TMP12:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 1
// CHECK7-NEXT:    store i32 [[TMP4]], ptr [[TMP12]], align 4
...
// CHECK7-NEXT:    store i32 [[TMP6]], ptr [[TMP14]], align 4
// CHECK7-NEXT:    [[TMP15:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 2
// CHECK7-NEXT:    store i32 [[TMP6]], ptr [[TMP15]], align 4
// CHECK7-NEXT:    [[TMP16:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_MAPPERS]], i32 0, i32 2
// CHECK7-NEXT:    store ptr null, ptr [[TMP16]], align 4
// CHECK7-NEXT:    [[TMP17:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 3
// CHECK7-NEXT:    store ptr [[B]], ptr [[TMP17]], align 4
// CHECK7-NEXT:    [[TMP18:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 3
// CHECK7-NEXT:    store ptr [[B]], ptr [[TMP18]], align 4
// CHECK7-NEXT:    [[TMP19:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_MAPPERS]], i32 0, i32 3
// CHECK7-NEXT:    store ptr null, ptr [[TMP19]], align 4
// CHECK7-NEXT:    [[TMP20:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 0
// CHECK7-NEXT:    [[TMP21:%.*]] = getelementptr inbounds [4 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 0
// CHECK7-NEXT:    [[TMP22:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 0
// CHECK7-NEXT:    store i32 3, ptr [[TMP22]], align 4
// CHECK7-NEXT:    [[TMP23:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 1
// CHECK7-NEXT:    store i32 4, ptr [[TMP23]], align 4
// CHECK7-NEXT:    [[TMP24:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 2
// CHECK7-NEXT:    store ptr [[TMP20]], ptr [[TMP24]], align 4
// CHECK7-NEXT:    [[TMP25:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 3
// CHECK7-NEXT:    store ptr [[TMP21]], ptr [[TMP25]], align 4
// CHECK7-NEXT:    [[TMP26:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 4
// CHECK7-NEXT:    store ptr @.offload_sizes.7, ptr [[TMP26]], align 4
// CHECK7-NEXT:    [[TMP27:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 5
// CHECK7-NEXT:    store ptr @.offload_maptypes.8, ptr [[TMP27]], align 4
// CHECK7-NEXT:    [[TMP28:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 6
// CHECK7-NEXT:    store ptr null, ptr [[TMP28]], align 4
// CHECK7-NEXT:    [[TMP29:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 7
// CHECK7-NEXT:    store ptr null, ptr [[TMP29]], align 4
// CHECK7-NEXT:    [[TMP30:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 8
// CHECK7-NEXT:    store i64 0, ptr [[TMP30]], align 8
// CHECK7-NEXT:    [[TMP31:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 9
// CHECK7-NEXT:    store i64 0, ptr [[TMP31]], align 8
// CHECK7-NEXT:    [[TMP32:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 10
// CHECK7-NEXT:    store [3 x i32] [i32 1, i32 0, i32 0], ptr [[TMP32]], align 4
// CHECK7-NEXT:    [[TMP33:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 11
// CHECK7-NEXT:    store [3 x i32] zeroinitializer, ptr [[TMP33]], align 4
// CHECK7-NEXT:    [[TMP34:%.*]] = getelementptr inbounds nuw [[STRUCT___TGT_KERNEL_ARGUMENTS]], ptr [[KERNEL_ARGS]], i32 0, i32 12
// CHECK7-NEXT:    store i32 0, ptr [[TMP34]], align 4
// CHECK7-NEXT:    [[TMP35:%.*]] = call i32 @__tgt_target_kernel(ptr @[[GLOB2]], i64 -1, i32 1, i32 0, ptr @.{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__ZL7fstatici_l195.region_id, ptr [[KERNEL_ARGS]])
// CHECK7-NEXT:    [[TMP36:%.*]] = icmp ne i32 [[TMP35]], 0
// CHECK7-NEXT:    br i1 [[TMP36]], label [[OMP_OFFLOAD_FAILED:%.*]], label [[OMP_OFFLOAD_CONT:%.*]]
// CHECK7:       omp_offload.failed:
// CHECK7-NEXT:    call void @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__ZL7fstatici_l195(i32 [[TMP2]], i32 [[TMP4]], i32 [[TMP6]], ptr [[B]]) #[[ATTR3]]
// CHECK7-NEXT:    br label [[OMP_OFFLOAD_CONT]]
// CHECK7:       omp_offload.cont:
// CHECK7-NEXT:    br label [[OMP_IF_END:%.*]]
// CHECK7:       omp_if.else:
...
// CHECK7-NEXT:    br label [[OMP_IF_END]]
// CHECK7:       omp_if.end:
// CHECK7-NEXT:    [[TMP37:%.*]] = load i32, ptr [[A]], align 4
...
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK7:       omp.inner.for.cond:
// CHECK7-NEXT:    [[TMP10:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP46:![0-9]+]]
// CHECK7-NEXT:    [[TMP11:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP46]]
...
// CHECK7-NEXT:    [[SUB:%.*]] = sub i64 2000, [[MUL]]
// CHECK7-NEXT:    store i64 [[SUB]], ptr [[IT]], align 8, !llvm.access.group [[ACC_GRP46]]
// CHECK7-NEXT:    [[TMP13:%.*]] = load i32, ptr [[B_ADDR]], align 4, !llvm.access.group [[ACC_GRP46]]
...
// CHECK7-NEXT:    store double [[ADD]], ptr [[A]], align 4, !nontemporal [[META47:![0-9]+]], !llvm.access.group [[ACC_GRP46]]
// CHECK7-NEXT:    [[A4:%.*]] = getelementptr inbounds nuw [[STRUCT_S1]], ptr [[TMP0]], i32 0, i32 0
// CHECK7-NEXT:    [[TMP14:%.*]] = load double, ptr [[A4]], align 4, !nontemporal [[META47]], !llvm.access.group [[ACC_GRP46]]
// CHECK7-NEXT:    [[INC:%.*]] = fadd double [[TMP14]], 1.000000e+00
// CHECK7-NEXT:    store double [[INC]], ptr [[A4]], align 4, !nontemporal [[META47]], !llvm.access.group [[ACC_GRP46]]
...
// CHECK7-NEXT:    store i16 [[CONV5]], ptr [[ARRAYIDX6]], align 2, !llvm.access.group [[ACC_GRP46]]
// CHECK7-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK7:       omp.body.continue:
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK7:       omp.inner.for.inc:
// CHECK7-NEXT:    [[TMP16:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP46]]
// CHECK7-NEXT:    [[ADD7:%.*]] = add i64 [[TMP16]], 1
// CHECK7-NEXT:    store i64 [[ADD7]], ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP46]]
...
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_COND13]], !llvm.loop [[LOOP50:![0-9]+]]
...
// CHECK7-NEXT:    store i16 [[TMP3]], ptr [[AA_CASTED]], align 2
// CHECK7-NEXT:    [[TMP4:%.*]] = load i32, ptr [[AA_CASTED]], align 4
// CHECK7-NEXT:    [[TMP5:%.*]] = load b8, ptr [[AAA_ADDR]], align 1
// CHECK7-NEXT:    store b8 [[TMP5]], ptr [[AAA_CASTED]], align 1
// CHECK7-NEXT:    [[TMP6:%.*]] = load i32, ptr [[AAA_CASTED]], align 4
...
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK7:       omp.inner.for.cond:
// CHECK7-NEXT:    [[TMP6:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP52:![0-9]+]]
// CHECK7-NEXT:    [[TMP7:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP52]]
// CHECK7-NEXT:    [[CMP1:%.*]] = icmp sle i64 [[TMP6]], [[TMP7]]
// CHECK7-NEXT:    br i1 [[CMP1]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK7:       omp.inner.for.body:
// CHECK7-NEXT:    [[TMP8:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP52]]
// CHECK7-NEXT:    [[MUL:%.*]] = mul nsw i64 [[TMP8]], 3
// CHECK7-NEXT:    [[ADD:%.*]] = add nsw i64 -10, [[MUL]]
// CHECK7-NEXT:    store i64 [[ADD]], ptr [[I]], align 8, !llvm.access.group [[ACC_GRP52]]
// CHECK7-NEXT:    [[TMP9:%.*]] = load i32, ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP52]]
// CHECK7-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP9]], 1
// CHECK7-NEXT:    store i32 [[ADD2]], ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP52]]
// CHECK7-NEXT:    [[TMP10:%.*]] = load i16, ptr [[AA_ADDR]], align 2, !llvm.access.group [[ACC_GRP52]]
// CHECK7-NEXT:    [[CONV:%.*]] = sext i16 [[TMP10]] to i32
// CHECK7-NEXT:    [[ADD3:%.*]] = add nsw i32 [[CONV]], 1
// CHECK7-NEXT:    [[CONV4:%.*]] = trunc i32 [[ADD3]] to i16
// CHECK7-NEXT:    store i16 [[CONV4]], ptr [[AA_ADDR]], align 2, !llvm.access.group [[ACC_GRP52]]
// CHECK7-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x i32], ptr [[TMP0]], i32 0, i32 2
// CHECK7-NEXT:    [[TMP11:%.*]] = load i32, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP52]]
// CHECK7-NEXT:    [[ADD5:%.*]] = add nsw i32 [[TMP11]], 1
// CHECK7-NEXT:    store i32 [[ADD5]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP52]]
// CHECK7-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK7:       omp.body.continue:
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK7:       omp.inner.for.inc:
// CHECK7-NEXT:    [[TMP12:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP52]]
// CHECK7-NEXT:    [[ADD6:%.*]] = add nsw i64 [[TMP12]], 1
// CHECK7-NEXT:    store i64 [[ADD6]], ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP52]]
...
// CHECK9-NEXT:    [[_TMP68:%.*]] = alloca b8, align 1
// CHECK9-NEXT:    [[DOTOMP_LB69:%.*]] = alloca i32, align 4
// CHECK9-NEXT:    [[DOTOMP_UB70:%.*]] = alloca i32, align 4
// CHECK9-NEXT:    [[DOTOMP_IV78:%.*]] = alloca i32, align 4
// CHECK9-NEXT:    [[IT79:%.*]] = alloca b8, align 1
...
// CHECK9-NEXT:    [[CONV71:%.*]] = bytecast exact b8 122 to i8
// CHECK9-NEXT:    [[CONV72:%.*]] = sext i8 [[CONV71]] to i32
// CHECK9-NEXT:    [[CONV73:%.*]] = bytecast exact b8 97 to i8
// CHECK9-NEXT:    [[CONV74:%.*]] = sext i8 [[CONV73]] to i32
// CHECK9-NEXT:    [[SUB75:%.*]] = sub nsw i32 [[CONV74]], 1
// CHECK9-NEXT:    [[SUB76:%.*]] = sub nsw i32 [[CONV72]], [[SUB75]]
// CHECK9-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB76]], 1
// CHECK9-NEXT:    [[SUB77:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK9-NEXT:    store i32 [[SUB77]], ptr [[DOTOMP_UB70]], align 4
// CHECK9-NEXT:    [[TMP45:%.*]] = load i32, ptr [[DOTOMP_LB69]], align 4
// CHECK9-NEXT:    store i32 [[TMP45]], ptr [[DOTOMP_IV78]], align 4
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_COND80:%.*]]
// CHECK9:       omp.inner.for.cond80:
// CHECK9-NEXT:    [[TMP46:%.*]] = load i32, ptr [[DOTOMP_IV78]], align 4, !llvm.access.group [[ACC_GRP15:![0-9]+]]
// CHECK9-NEXT:    [[TMP47:%.*]] = load i32, ptr [[DOTOMP_UB70]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[CMP81:%.*]] = icmp sle i32 [[TMP46]], [[TMP47]]
// CHECK9-NEXT:    br i1 [[CMP81]], label [[OMP_INNER_FOR_BODY82:%.*]], label [[OMP_INNER_FOR_END110:%.*]]
// CHECK9:       omp.inner.for.body82:
// CHECK9-NEXT:    [[CONV83:%.*]] = bytecast exact b8 122 to i8
// CHECK9-NEXT:    [[CONV84:%.*]] = sext i8 [[CONV83]] to i32
// CHECK9-NEXT:    [[TMP48:%.*]] = load i32, ptr [[DOTOMP_IV78]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[MUL85:%.*]] = mul nsw i32 [[TMP48]], 1
// CHECK9-NEXT:    [[SUB86:%.*]] = sub nsw i32 [[CONV84]], [[MUL85]]
// CHECK9-NEXT:    [[CONV87:%.*]] = trunc i32 [[SUB86]] to i8
// CHECK9-NEXT:    [[TMP49:%.*]] = bitcast i8 [[CONV87]] to b8
// CHECK9-NEXT:    store b8 [[TMP49]], ptr [[IT79]], align 1, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[TMP50:%.*]] = load i32, ptr [[A]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[ADD88:%.*]] = add nsw i32 [[TMP50]], 1
// CHECK9-NEXT:    store i32 [[ADD88]], ptr [[A]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x float], ptr [[B]], i64 0, i64 2
// CHECK9-NEXT:    [[TMP51:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[CONV89:%.*]] = fpext float [[TMP51]] to double
// CHECK9-NEXT:    [[ADD90:%.*]] = fadd double [[CONV89]], 1.000000e+00
// CHECK9-NEXT:    [[CONV91:%.*]] = fptrunc double [[ADD90]] to float
// CHECK9-NEXT:    store float [[CONV91]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[ARRAYIDX92:%.*]] = getelementptr inbounds float, ptr [[VLA]], i64 3
// CHECK9-NEXT:    [[TMP52:%.*]] = load float, ptr [[ARRAYIDX92]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[CONV93:%.*]] = fpext float [[TMP52]] to double
// CHECK9-NEXT:    [[ADD94:%.*]] = fadd double [[CONV93]], 1.000000e+00
// CHECK9-NEXT:    [[CONV95:%.*]] = fptrunc double [[ADD94]] to float
// CHECK9-NEXT:    store float [[CONV95]], ptr [[ARRAYIDX92]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[ARRAYIDX96:%.*]] = getelementptr inbounds [5 x [10 x double]], ptr [[C]], i64 0, i64 1
// CHECK9-NEXT:    [[ARRAYIDX97:%.*]] = getelementptr inbounds [10 x double], ptr [[ARRAYIDX96]], i64 0, i64 2
// CHECK9-NEXT:    [[TMP53:%.*]] = load double, ptr [[ARRAYIDX97]], align 8, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[ADD98:%.*]] = fadd double [[TMP53]], 1.000000e+00
// CHECK9-NEXT:    store double [[ADD98]], ptr [[ARRAYIDX97]], align 8, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[TMP54:%.*]] = mul nsw i64 1, [[TMP4]]
// CHECK9-NEXT:    [[ARRAYIDX99:%.*]] = getelementptr inbounds double, ptr [[VLA1]], i64 [[TMP54]]
// CHECK9-NEXT:    [[ARRAYIDX100:%.*]] = getelementptr inbounds double, ptr [[ARRAYIDX99]], i64 3
// CHECK9-NEXT:    [[TMP55:%.*]] = load double, ptr [[ARRAYIDX100]], align 8, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[ADD101:%.*]] = fadd double [[TMP55]], 1.000000e+00
// CHECK9-NEXT:    store double [[ADD101]], ptr [[ARRAYIDX100]], align 8, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[X:%.*]] = getelementptr inbounds nuw [[STRUCT_TT]], ptr [[D]], i32 0, i32 0
// CHECK9-NEXT:    [[TMP56:%.*]] = load i64, ptr [[X]], align 8, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[ADD102:%.*]] = add nsw i64 [[TMP56]], 1
// CHECK9-NEXT:    store i64 [[ADD102]], ptr [[X]], align 8, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TT]], ptr [[D]], i32 0, i32 1
// CHECK9-NEXT:    [[TMP57:%.*]] = load b8, ptr [[Y]], align 8, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[CONV103:%.*]] = bytecast exact b8 [[TMP57]] to i8
// CHECK9-NEXT:    [[CONV104:%.*]] = sext i8 [[CONV103]] to i32
// CHECK9-NEXT:    [[ADD105:%.*]] = add nsw i32 [[CONV104]], 1
// CHECK9-NEXT:    [[CONV106:%.*]] = trunc i32 [[ADD105]] to i8
// CHECK9-NEXT:    [[TMP58:%.*]] = bitcast i8 [[CONV106]] to b8
// CHECK9-NEXT:    store b8 [[TMP58]], ptr [[Y]], align 8, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    br label [[OMP_BODY_CONTINUE107:%.*]]
// CHECK9:       omp.body.continue107:
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC108:%.*]]
// CHECK9:       omp.inner.for.inc108:
// CHECK9-NEXT:    [[TMP59:%.*]] = load i32, ptr [[DOTOMP_IV78]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[ADD109:%.*]] = add nsw i32 [[TMP59]], 1
// CHECK9-NEXT:    store i32 [[ADD109]], ptr [[DOTOMP_IV78]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_COND80]], !llvm.loop [[LOOP16:![0-9]+]]
// CHECK9:       omp.inner.for.end110:
// CHECK9-NEXT:    [[CONV111:%.*]] = bytecast exact b8 122 to i8
// CHECK9-NEXT:    [[CONV112:%.*]] = sext i8 [[CONV111]] to i32
// CHECK9-NEXT:    [[CONV113:%.*]] = bytecast exact b8 122 to i8
// CHECK9-NEXT:    [[CONV114:%.*]] = sext i8 [[CONV113]] to i32
// CHECK9-NEXT:    [[CONV115:%.*]] = bytecast exact b8 97 to i8
// CHECK9-NEXT:    [[CONV116:%.*]] = sext i8 [[CONV115]] to i32
// CHECK9-NEXT:    [[SUB117:%.*]] = sub nsw i32 [[CONV116]], 1
// CHECK9-NEXT:    [[SUB118:%.*]] = sub nsw i32 [[CONV114]], [[SUB117]]
// CHECK9-NEXT:    [[DIV119:%.*]] = sdiv i32 [[SUB118]], 1
// CHECK9-NEXT:    [[MUL120:%.*]] = mul nsw i32 [[DIV119]], 1
// CHECK9-NEXT:    [[SUB121:%.*]] = sub nsw i32 [[CONV112]], [[MUL120]]
// CHECK9-NEXT:    [[CONV122:%.*]] = trunc i32 [[SUB121]] to i8
// CHECK9-NEXT:    [[TMP60:%.*]] = bitcast i8 [[CONV122]] to b8
// CHECK9-NEXT:    store b8 [[TMP60]], ptr [[IT79]], align 1
// CHECK9-NEXT:    [[TMP61:%.*]] = load i32, ptr [[A]], align 4
// CHECK9-NEXT:    [[TMP62:%.*]] = load ptr, ptr [[SAVED_STACK]], align 8
// CHECK9-NEXT:    call void @llvm.stackrestore.p0(ptr [[TMP62]])
// CHECK9-NEXT:    ret i32 [[TMP61]]
//
//
...
// CHECK9-NEXT:    [[A:%.*]] = alloca i32, align 4
// CHECK9-NEXT:    [[AA:%.*]] = alloca i16, align 2
// CHECK9-NEXT:    [[AAA:%.*]] = alloca b8, align 1
...
// CHECK9-NEXT:    store i32 0, ptr [[A]], align 4
// CHECK9-NEXT:    store i16 0, ptr [[AA]], align 2
// CHECK9-NEXT:    [[TMP0:%.*]] = bytecast exact b8 0 to i8
// CHECK9-NEXT:    store i8 [[TMP0]], ptr [[AAA]], align 1
// CHECK9-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
...
// CHECK11-NEXT:    [[_TMP68:%.*]] = alloca b8, align 1
// CHECK11-NEXT:    [[DOTOMP_LB69:%.*]] = alloca i32, align 4
// CHECK11-NEXT:    [[DOTOMP_UB70:%.*]] = alloca i32, align 4
// CHECK11-NEXT:    [[DOTOMP_IV78:%.*]] = alloca i32, align 4
// CHECK11-NEXT:    [[IT79:%.*]] = alloca b8, align 1
...
// CHECK11-NEXT:    [[CONV71:%.*]] = bytecast exact b8 122 to i8
// CHECK11-NEXT:    [[CONV72:%.*]] = sext i8 [[CONV71]] to i32
// CHECK11-NEXT:    [[CONV73:%.*]] = bytecast exact b8 97 to i8
// CHECK11-NEXT:    [[CONV74:%.*]] = sext i8 [[CONV73]] to i32
// CHECK11-NEXT:    [[SUB75:%.*]] = sub nsw i32 [[CONV74]], 1
// CHECK11-NEXT:    [[SUB76:%.*]] = sub nsw i32 [[CONV72]], [[SUB75]]
// CHECK11-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB76]], 1
// CHECK11-NEXT:    [[SUB77:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK11-NEXT:    store i32 [[SUB77]], ptr [[DOTOMP_UB70]], align 4
// CHECK11-NEXT:    [[TMP43:%.*]] = load i32, ptr [[DOTOMP_LB69]], align 4
// CHECK11-NEXT:    store i32 [[TMP43]], ptr [[DOTOMP_IV78]], align 4
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_COND80:%.*]]
// CHECK11:       omp.inner.for.cond80:
// CHECK11-NEXT:    [[TMP44:%.*]] = load i32, ptr [[DOTOMP_IV78]], align 4, !llvm.access.group [[ACC_GRP16:![0-9]+]]
// CHECK11-NEXT:    [[TMP45:%.*]] = load i32, ptr [[DOTOMP_UB70]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[CMP81:%.*]] = icmp sle i32 [[TMP44]], [[TMP45]]
// CHECK11-NEXT:    br i1 [[CMP81]], label [[OMP_INNER_FOR_BODY82:%.*]], label [[OMP_INNER_FOR_END110:%.*]]
// CHECK11:       omp.inner.for.body82:
// CHECK11-NEXT:    [[CONV83:%.*]] = bytecast exact b8 122 to i8
// CHECK11-NEXT:    [[CONV84:%.*]] = sext i8 [[CONV83]] to i32
// CHECK11-NEXT:    [[TMP46:%.*]] = load i32, ptr [[DOTOMP_IV78]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[MUL85:%.*]] = mul nsw i32 [[TMP46]], 1
// CHECK11-NEXT:    [[SUB86:%.*]] = sub nsw i32 [[CONV84]], [[MUL85]]
// CHECK11-NEXT:    [[CONV87:%.*]] = trunc i32 [[SUB86]] to i8
// CHECK11-NEXT:    [[TMP47:%.*]] = bitcast i8 [[CONV87]] to b8
// CHECK11-NEXT:    store b8 [[TMP47]], ptr [[IT79]], align 1, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[TMP48:%.*]] = load i32, ptr [[A]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[ADD88:%.*]] = add nsw i32 [[TMP48]], 1
// CHECK11-NEXT:    store i32 [[ADD88]], ptr [[A]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x float], ptr [[B]], i32 0, i32 2
// CHECK11-NEXT:    [[TMP49:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[CONV89:%.*]] = fpext float [[TMP49]] to double
// CHECK11-NEXT:    [[ADD90:%.*]] = fadd double [[CONV89]], 1.000000e+00
// CHECK11-NEXT:    [[CONV91:%.*]] = fptrunc double [[ADD90]] to float
// CHECK11-NEXT:    store float [[CONV91]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[ARRAYIDX92:%.*]] = getelementptr inbounds float, ptr [[VLA]], i32 3
// CHECK11-NEXT:    [[TMP50:%.*]] = load float, ptr [[ARRAYIDX92]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[CONV93:%.*]] = fpext float [[TMP50]] to double
// CHECK11-NEXT:    [[ADD94:%.*]] = fadd double [[CONV93]], 1.000000e+00
// CHECK11-NEXT:    [[CONV95:%.*]] = fptrunc double [[ADD94]] to float
// CHECK11-NEXT:    store float [[CONV95]], ptr [[ARRAYIDX92]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[ARRAYIDX96:%.*]] = getelementptr inbounds [5 x [10 x double]], ptr [[C]], i32 0, i32 1
// CHECK11-NEXT:    [[ARRAYIDX97:%.*]] = getelementptr inbounds [10 x double], ptr [[ARRAYIDX96]], i32 0, i32 2
// CHECK11-NEXT:    [[TMP51:%.*]] = load double, ptr [[ARRAYIDX97]], align 8, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[ADD98:%.*]] = fadd double [[TMP51]], 1.000000e+00
// CHECK11-NEXT:    store double [[ADD98]], ptr [[ARRAYIDX97]], align 8, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[TMP52:%.*]] = mul nsw i32 1, [[TMP2]]
// CHECK11-NEXT:    [[ARRAYIDX99:%.*]] = getelementptr inbounds double, ptr [[VLA1]], i32 [[TMP52]]
// CHECK11-NEXT:    [[ARRAYIDX100:%.*]] = getelementptr inbounds double, ptr [[ARRAYIDX99]], i32 3
// CHECK11-NEXT:    [[TMP53:%.*]] = load double, ptr [[ARRAYIDX100]], align 8, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[ADD101:%.*]] = fadd double [[TMP53]], 1.000000e+00
// CHECK11-NEXT:    store double [[ADD101]], ptr [[ARRAYIDX100]], align 8, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[X:%.*]] = getelementptr inbounds nuw [[STRUCT_TT]], ptr [[D]], i32 0, i32 0
// CHECK11-NEXT:    [[TMP54:%.*]] = load i64, ptr [[X]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[ADD102:%.*]] = add nsw i64 [[TMP54]], 1
// CHECK11-NEXT:    store i64 [[ADD102]], ptr [[X]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TT]], ptr [[D]], i32 0, i32 1
// CHECK11-NEXT:    [[TMP55:%.*]] = load b8, ptr [[Y]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[CONV103:%.*]] = bytecast exact b8 [[TMP55]] to i8
// CHECK11-NEXT:    [[CONV104:%.*]] = sext i8 [[CONV103]] to i32
// CHECK11-NEXT:    [[ADD105:%.*]] = add nsw i32 [[CONV104]], 1
// CHECK11-NEXT:    [[CONV106:%.*]] = trunc i32 [[ADD105]] to i8
// CHECK11-NEXT:    [[TMP56:%.*]] = bitcast i8 [[CONV106]] to b8
// CHECK11-NEXT:    store b8 [[TMP56]], ptr [[Y]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    br label [[OMP_BODY_CONTINUE107:%.*]]
// CHECK11:       omp.body.continue107:
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_INC108:%.*]]
// CHECK11:       omp.inner.for.inc108:
// CHECK11-NEXT:    [[TMP57:%.*]] = load i32, ptr [[DOTOMP_IV78]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[ADD109:%.*]] = add nsw i32 [[TMP57]], 1
// CHECK11-NEXT:    store i32 [[ADD109]], ptr [[DOTOMP_IV78]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_COND80]], !llvm.loop [[LOOP17:![0-9]+]]
// CHECK11:       omp.inner.for.end110:
// CHECK11-NEXT:    [[CONV111:%.*]] = bytecast exact b8 122 to i8
// CHECK11-NEXT:    [[CONV112:%.*]] = sext i8 [[CONV111]] to i32
// CHECK11-NEXT:    [[CONV113:%.*]] = bytecast exact b8 122 to i8
// CHECK11-NEXT:    [[CONV114:%.*]] = sext i8 [[CONV113]] to i32
// CHECK11-NEXT:    [[CONV115:%.*]] = bytecast exact b8 97 to i8
// CHECK11-NEXT:    [[CONV116:%.*]] = sext i8 [[CONV115]] to i32
// CHECK11-NEXT:    [[SUB117:%.*]] = sub nsw i32 [[CONV116]], 1
// CHECK11-NEXT:    [[SUB118:%.*]] = sub nsw i32 [[CONV114]], [[SUB117]]
// CHECK11-NEXT:    [[DIV119:%.*]] = sdiv i32 [[SUB118]], 1
// CHECK11-NEXT:    [[MUL120:%.*]] = mul nsw i32 [[DIV119]], 1
// CHECK11-NEXT:    [[SUB121:%.*]] = sub nsw i32 [[CONV112]], [[MUL120]]
// CHECK11-NEXT:    [[CONV122:%.*]] = trunc i32 [[SUB121]] to i8
// CHECK11-NEXT:    [[TMP58:%.*]] = bitcast i8 [[CONV122]] to b8
// CHECK11-NEXT:    store b8 [[TMP58]], ptr [[IT79]], align 1
// CHECK11-NEXT:    [[TMP59:%.*]] = load i32, ptr [[A]], align 4
// CHECK11-NEXT:    [[TMP60:%.*]] = load ptr, ptr [[SAVED_STACK]], align 4
// CHECK11-NEXT:    call void @llvm.stackrestore.p0(ptr [[TMP60]])
...
// CHECK11-NEXT:    [[A:%.*]] = alloca i32, align 4
// CHECK11-NEXT:    [[AA:%.*]] = alloca i16, align 2
// CHECK11-NEXT:    [[AAA:%.*]] = alloca b8, align 1
...
// CHECK11-NEXT:    store i32 0, ptr [[A]], align 4
// CHECK11-NEXT:    store i16 0, ptr [[AA]], align 2
// CHECK11-NEXT:    [[TMP0:%.*]] = bytecast exact b8 0 to i8
// CHECK11-NEXT:    store i8 [[TMP0]], ptr [[AAA]], align 1
// CHECK11-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
...
// CHECK13-NEXT:    [[_TMP68:%.*]] = alloca b8, align 1
// CHECK13-NEXT:    [[DOTOMP_LB69:%.*]] = alloca i32, align 4
// CHECK13-NEXT:    [[DOTOMP_UB70:%.*]] = alloca i32, align 4
// CHECK13-NEXT:    [[DOTOMP_IV78:%.*]] = alloca i32, align 4
// CHECK13-NEXT:    [[IT79:%.*]] = alloca b8, align 1
...
// CHECK13-NEXT:    [[CONV71:%.*]] = bytecast exact b8 122 to i8
// CHECK13-NEXT:    [[CONV72:%.*]] = sext i8 [[CONV71]] to i32
// CHECK13-NEXT:    [[CONV73:%.*]] = bytecast exact b8 97 to i8
// CHECK13-NEXT:    [[CONV74:%.*]] = sext i8 [[CONV73]] to i32
// CHECK13-NEXT:    [[SUB75:%.*]] = sub nsw i32 [[CONV74]], 1
// CHECK13-NEXT:    [[SUB76:%.*]] = sub nsw i32 [[CONV72]], [[SUB75]]
// CHECK13-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB76]], 1
// CHECK13-NEXT:    [[SUB77:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK13-NEXT:    store i32 [[SUB77]], ptr [[DOTOMP_UB70]], align 4
// CHECK13-NEXT:    [[TMP45:%.*]] = load i32, ptr [[DOTOMP_LB69]], align 4
// CHECK13-NEXT:    store i32 [[TMP45]], ptr [[DOTOMP_IV78]], align 4
// CHECK13-NEXT:    br label [[OMP_INNER_FOR_COND80:%.*]]
// CHECK13:       omp.inner.for.cond80:
// CHECK13-NEXT:    [[TMP46:%.*]] = load i32, ptr [[DOTOMP_IV78]], align 4, !llvm.access.group [[ACC_GRP15:![0-9]+]]
// CHECK13-NEXT:    [[TMP47:%.*]] = load i32, ptr [[DOTOMP_UB70]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    [[CMP81:%.*]] = icmp sle i32 [[TMP46]], [[TMP47]]
// CHECK13-NEXT:    br i1 [[CMP81]], label [[OMP_INNER_FOR_BODY82:%.*]], label [[OMP_INNER_FOR_END110:%.*]]
// CHECK13:       omp.inner.for.body82:
// CHECK13-NEXT:    [[CONV83:%.*]] = bytecast exact b8 122 to i8
// CHECK13-NEXT:    [[CONV84:%.*]] = sext i8 [[CONV83]] to i32
// CHECK13-NEXT:    [[TMP48:%.*]] = load i32, ptr [[DOTOMP_IV78]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    [[MUL85:%.*]] = mul nsw i32 [[TMP48]], 1
// CHECK13-NEXT:    [[SUB86:%.*]] = sub nsw i32 [[CONV84]], [[MUL85]]
// CHECK13-NEXT:    [[CONV87:%.*]] = trunc i32 [[SUB86]] to i8
// CHECK13-NEXT:    [[TMP49:%.*]] = bitcast i8 [[CONV87]] to b8
// CHECK13-NEXT:    store b8 [[TMP49]], ptr [[IT79]], align 1, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    [[TMP50:%.*]] = load i32, ptr [[A]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    [[ADD88:%.*]] = add nsw i32 [[TMP50]], 1
// CHECK13-NEXT:    store i32 [[ADD88]], ptr [[A]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x float], ptr [[B]], i64 0, i64 2
// CHECK13-NEXT:    [[TMP51:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    [[CONV89:%.*]] = fpext float [[TMP51]] to double
// CHECK13-NEXT:    [[ADD90:%.*]] = fadd double [[CONV89]], 1.000000e+00
// CHECK13-NEXT:    [[CONV91:%.*]] = fptrunc double [[ADD90]] to float
// CHECK13-NEXT:    store float [[CONV91]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    [[ARRAYIDX92:%.*]] = getelementptr inbounds float, ptr [[VLA]], i64 3
// CHECK13-NEXT:    [[TMP52:%.*]] = load float, ptr [[ARRAYIDX92]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    [[CONV93:%.*]] = fpext float [[TMP52]] to double
// CHECK13-NEXT:    [[ADD94:%.*]] = fadd double [[CONV93]], 1.000000e+00
// CHECK13-NEXT:    [[CONV95:%.*]] = fptrunc double [[ADD94]] to float
// CHECK13-NEXT:    store float [[CONV95]], ptr [[ARRAYIDX92]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    [[ARRAYIDX96:%.*]] = getelementptr inbounds [5 x [10 x double]], ptr [[C]], i64 0, i64 1
// CHECK13-NEXT:    [[ARRAYIDX97:%.*]] = getelementptr inbounds [10 x double], ptr [[ARRAYIDX96]], i64 0, i64 2
// CHECK13-NEXT:    [[TMP53:%.*]] = load double, ptr [[ARRAYIDX97]], align 8, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    [[ADD98:%.*]] = fadd double [[TMP53]], 1.000000e+00
// CHECK13-NEXT:    store double [[ADD98]], ptr [[ARRAYIDX97]], align 8, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    [[TMP54:%.*]] = mul nsw i64 1, [[TMP4]]
// CHECK13-NEXT:    [[ARRAYIDX99:%.*]] = getelementptr inbounds double, ptr [[VLA1]], i64 [[TMP54]]
// CHECK13-NEXT:    [[ARRAYIDX100:%.*]] = getelementptr inbounds double, ptr [[ARRAYIDX99]], i64 3
// CHECK13-NEXT:    [[TMP55:%.*]] = load double, ptr [[ARRAYIDX100]], align 8, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    [[ADD101:%.*]] = fadd double [[TMP55]], 1.000000e+00
// CHECK13-NEXT:    store double [[ADD101]], ptr [[ARRAYIDX100]], align 8, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    [[X:%.*]] = getelementptr inbounds nuw [[STRUCT_TT]], ptr [[D]], i32 0, i32 0
// CHECK13-NEXT:    [[TMP56:%.*]] = load i64, ptr [[X]], align 8, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    [[ADD102:%.*]] = add nsw i64 [[TMP56]], 1
// CHECK13-NEXT:    store i64 [[ADD102]], ptr [[X]], align 8, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TT]], ptr [[D]], i32 0, i32 1
// CHECK13-NEXT:    [[TMP57:%.*]] = load b8, ptr [[Y]], align 8, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    [[CONV103:%.*]] = bytecast exact b8 [[TMP57]] to i8
// CHECK13-NEXT:    [[CONV104:%.*]] = sext i8 [[CONV103]] to i32
// CHECK13-NEXT:    [[ADD105:%.*]] = add nsw i32 [[CONV104]], 1
// CHECK13-NEXT:    [[CONV106:%.*]] = trunc i32 [[ADD105]] to i8
// CHECK13-NEXT:    [[TMP58:%.*]] = bitcast i8 [[CONV106]] to b8
// CHECK13-NEXT:    store b8 [[TMP58]], ptr [[Y]], align 8, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    br label [[OMP_BODY_CONTINUE107:%.*]]
// CHECK13:       omp.body.continue107:
// CHECK13-NEXT:    br label [[OMP_INNER_FOR_INC108:%.*]]
// CHECK13:       omp.inner.for.inc108:
// CHECK13-NEXT:    [[TMP59:%.*]] = load i32, ptr [[DOTOMP_IV78]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    [[ADD109:%.*]] = add nsw i32 [[TMP59]], 1
// CHECK13-NEXT:    store i32 [[ADD109]], ptr [[DOTOMP_IV78]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK13-NEXT:    br label [[OMP_INNER_FOR_COND80]], !llvm.loop [[LOOP16:![0-9]+]]
// CHECK13:       omp.inner.for.end110:
// CHECK13-NEXT:    [[CONV111:%.*]] = bytecast exact b8 122 to i8
// CHECK13-NEXT:    [[CONV112:%.*]] = sext i8 [[CONV111]] to i32
// CHECK13-NEXT:    [[CONV113:%.*]] = bytecast exact b8 122 to i8
// CHECK13-NEXT:    [[CONV114:%.*]] = sext i8 [[CONV113]] to i32
// CHECK13-NEXT:    [[CONV115:%.*]] = bytecast exact b8 97 to i8
// CHECK13-NEXT:    [[CONV116:%.*]] = sext i8 [[CONV115]] to i32
// CHECK13-NEXT:    [[SUB117:%.*]] = sub nsw i32 [[CONV116]], 1
// CHECK13-NEXT:    [[SUB118:%.*]] = sub nsw i32 [[CONV114]], [[SUB117]]
// CHECK13-NEXT:    [[DIV119:%.*]] = sdiv i32 [[SUB118]], 1
// CHECK13-NEXT:    [[MUL120:%.*]] = mul nsw i32 [[DIV119]], 1
// CHECK13-NEXT:    [[SUB121:%.*]] = sub nsw i32 [[CONV112]], [[MUL120]]
// CHECK13-NEXT:    [[CONV122:%.*]] = trunc i32 [[SUB121]] to i8
// CHECK13-NEXT:    [[TMP60:%.*]] = bitcast i8 [[CONV122]] to b8
// CHECK13-NEXT:    store b8 [[TMP60]], ptr [[IT79]], align 1
// CHECK13-NEXT:    [[TMP61:%.*]] = load i32, ptr [[A]], align 4
// CHECK13-NEXT:    [[TMP62:%.*]] = load ptr, ptr [[SAVED_STACK]], align 8
// CHECK13-NEXT:    call void @llvm.stackrestore.p0(ptr [[TMP62]])
// CHECK13-NEXT:    ret i32 [[TMP61]]
//
//
...
// CHECK13-NEXT:    [[A:%.*]] = alloca i32, align 4
// CHECK13-NEXT:    [[AA:%.*]] = alloca i16, align 2
// CHECK13-NEXT:    [[AAA:%.*]] = alloca b8, align 1
...
// CHECK13-NEXT:    store i32 0, ptr [[A]], align 4
// CHECK13-NEXT:    store i16 0, ptr [[AA]], align 2
// CHECK13-NEXT:    [[TMP0:%.*]] = bytecast exact b8 0 to i8
// CHECK13-NEXT:    store i8 [[TMP0]], ptr [[AAA]], align 1
// CHECK13-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
...
// CHECK15-NEXT:    [[_TMP68:%.*]] = alloca b8, align 1
...
// CHECK15-NEXT:    [[IT79:%.*]] = alloca b8, align 1
...
// CHECK15-NEXT:    [[CONV71:%.*]] = bytecast exact b8 122 to i8
// CHECK15-NEXT:    [[CONV72:%.*]] = sext i8 [[CONV71]] to i32
// CHECK15-NEXT:    [[CONV73:%.*]] = bytecast exact b8 97 to i8
// CHECK15-NEXT:    [[CONV74:%.*]] = sext i8 [[CONV73]] to i32
// CHECK15-NEXT:    [[SUB75:%.*]] = sub nsw i32 [[CONV74]], 1
// CHECK15-NEXT:    [[SUB76:%.*]] = sub nsw i32 [[CONV72]], [[SUB75]]
// CHECK15-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB76]], 1
// CHECK15-NEXT:    [[SUB77:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK15-NEXT:    store i32 [[SUB77]], ptr [[DOTOMP_UB70]], align 4
// CHECK15-NEXT:    [[TMP43:%.*]] = load i32, ptr [[DOTOMP_LB69]], align 4
// CHECK15-NEXT:    store i32 [[TMP43]], ptr [[DOTOMP_IV78]], align 4
// CHECK15-NEXT:    br label [[OMP_INNER_FOR_COND80:%.*]]
// CHECK15:       omp.inner.for.cond80:
// CHECK15-NEXT:    [[TMP44:%.*]] = load i32, ptr [[DOTOMP_IV78]], align 4, !llvm.access.group [[ACC_GRP16:![0-9]+]]
// CHECK15-NEXT:    [[TMP45:%.*]] = load i32, ptr [[DOTOMP_UB70]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    [[CMP81:%.*]] = icmp sle i32 [[TMP44]], [[TMP45]]
// CHECK15-NEXT:    br i1 [[CMP81]], label [[OMP_INNER_FOR_BODY82:%.*]], label [[OMP_INNER_FOR_END110:%.*]]
// CHECK15:       omp.inner.for.body82:
// CHECK15-NEXT:    [[CONV83:%.*]] = bytecast exact b8 122 to i8
// CHECK15-NEXT:    [[CONV84:%.*]] = sext i8 [[CONV83]] to i32
// CHECK15-NEXT:    [[TMP46:%.*]] = load i32, ptr [[DOTOMP_IV78]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    [[MUL85:%.*]] = mul nsw i32 [[TMP46]], 1
// CHECK15-NEXT:    [[SUB86:%.*]] = sub nsw i32 [[CONV84]], [[MUL85]]
// CHECK15-NEXT:    [[CONV87:%.*]] = trunc i32 [[SUB86]] to i8
// CHECK15-NEXT:    [[TMP47:%.*]] = bitcast i8 [[CONV87]] to b8
// CHECK15-NEXT:    store b8 [[TMP47]], ptr [[IT79]], align 1, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    [[TMP48:%.*]] = load i32, ptr [[A]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    [[ADD88:%.*]] = add nsw i32 [[TMP48]], 1
// CHECK15-NEXT:    store i32 [[ADD88]], ptr [[A]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x float], ptr [[B]], i32 0, i32 2
// CHECK15-NEXT:    [[TMP49:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    [[CONV89:%.*]] = fpext float [[TMP49]] to double
// CHECK15-NEXT:    [[ADD90:%.*]] = fadd double [[CONV89]], 1.000000e+00
// CHECK15-NEXT:    [[CONV91:%.*]] = fptrunc double [[ADD90]] to float
// CHECK15-NEXT:    store float [[CONV91]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    [[ARRAYIDX92:%.*]] = getelementptr inbounds float, ptr [[VLA]], i32 3
// CHECK15-NEXT:    [[TMP50:%.*]] = load float, ptr [[ARRAYIDX92]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    [[CONV93:%.*]] = fpext float [[TMP50]] to double
// CHECK15-NEXT:    [[ADD94:%.*]] = fadd double [[CONV93]], 1.000000e+00
// CHECK15-NEXT:    [[CONV95:%.*]] = fptrunc double [[ADD94]] to float
// CHECK15-NEXT:    store float [[CONV95]], ptr [[ARRAYIDX92]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    [[ARRAYIDX96:%.*]] = getelementptr inbounds [5 x [10 x double]], ptr [[C]], i32 0, i32 1
// CHECK15-NEXT:    [[ARRAYIDX97:%.*]] = getelementptr inbounds [10 x double], ptr [[ARRAYIDX96]], i32 0, i32 2
// CHECK15-NEXT:    [[TMP51:%.*]] = load double, ptr [[ARRAYIDX97]], align 8, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    [[ADD98:%.*]] = fadd double [[TMP51]], 1.000000e+00
// CHECK15-NEXT:    store double [[ADD98]], ptr [[ARRAYIDX97]], align 8, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    [[TMP52:%.*]] = mul nsw i32 1, [[TMP2]]
// CHECK15-NEXT:    [[ARRAYIDX99:%.*]] = getelementptr inbounds double, ptr [[VLA1]], i32 [[TMP52]]
// CHECK15-NEXT:    [[ARRAYIDX100:%.*]] = getelementptr inbounds double, ptr [[ARRAYIDX99]], i32 3
// CHECK15-NEXT:    [[TMP53:%.*]] = load double, ptr [[ARRAYIDX100]], align 8, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    [[ADD101:%.*]] = fadd double [[TMP53]], 1.000000e+00
// CHECK15-NEXT:    store double [[ADD101]], ptr [[ARRAYIDX100]], align 8, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    [[X:%.*]] = getelementptr inbounds nuw [[STRUCT_TT]], ptr [[D]], i32 0, i32 0
// CHECK15-NEXT:    [[TMP54:%.*]] = load i64, ptr [[X]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    [[ADD102:%.*]] = add nsw i64 [[TMP54]], 1
// CHECK15-NEXT:    store i64 [[ADD102]], ptr [[X]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TT]], ptr [[D]], i32 0, i32 1
// CHECK15-NEXT:    [[TMP55:%.*]] = load b8, ptr [[Y]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    [[CONV103:%.*]] = bytecast exact b8 [[TMP55]] to i8
// CHECK15-NEXT:    [[CONV104:%.*]] = sext i8 [[CONV103]] to i32
// CHECK15-NEXT:    [[ADD105:%.*]] = add nsw i32 [[CONV104]], 1
// CHECK15-NEXT:    [[CONV106:%.*]] = trunc i32 [[ADD105]] to i8
// CHECK15-NEXT:    [[TMP56:%.*]] = bitcast i8 [[CONV106]] to b8
// CHECK15-NEXT:    store b8 [[TMP56]], ptr [[Y]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    br label [[OMP_BODY_CONTINUE107:%.*]]
// CHECK15:       omp.body.continue107:
// CHECK15-NEXT:    br label [[OMP_INNER_FOR_INC108:%.*]]
// CHECK15:       omp.inner.for.inc108:
// CHECK15-NEXT:    [[TMP57:%.*]] = load i32, ptr [[DOTOMP_IV78]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    [[ADD109:%.*]] = add nsw i32 [[TMP57]], 1
// CHECK15-NEXT:    store i32 [[ADD109]], ptr [[DOTOMP_IV78]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK15-NEXT:    br label [[OMP_INNER_FOR_COND80]], !llvm.loop [[LOOP17:![0-9]+]]
// CHECK15:       omp.inner.for.end110:
// CHECK15-NEXT:    [[CONV111:%.*]] = bytecast exact b8 122 to i8
// CHECK15-NEXT:    [[CONV112:%.*]] = sext i8 [[CONV111]] to i32
// CHECK15-NEXT:    [[CONV113:%.*]] = bytecast exact b8 122 to i8
// CHECK15-NEXT:    [[CONV114:%.*]] = sext i8 [[CONV113]] to i32
// CHECK15-NEXT:    [[CONV115:%.*]] = bytecast exact b8 97 to i8
// CHECK15-NEXT:    [[CONV116:%.*]] = sext i8 [[CONV115]] to i32
// CHECK15-NEXT:    [[SUB117:%.*]] = sub nsw i32 [[CONV116]], 1
// CHECK15-NEXT:    [[SUB118:%.*]] = sub nsw i32 [[CONV114]], [[SUB117]]
// CHECK15-NEXT:    [[DIV119:%.*]] = sdiv i32 [[SUB118]], 1
// CHECK15-NEXT:    [[MUL120:%.*]] = mul nsw i32 [[DIV119]], 1
// CHECK15-NEXT:    [[SUB121:%.*]] = sub nsw i32 [[CONV112]], [[MUL120]]
// CHECK15-NEXT:    [[CONV122:%.*]] = trunc i32 [[SUB121]] to i8
// CHECK15-NEXT:    [[TMP58:%.*]] = bitcast i8 [[CONV122]] to b8
// CHECK15-NEXT:    store b8 [[TMP58]], ptr [[IT79]], align 1
// CHECK15-NEXT:    [[TMP59:%.*]] = load i32, ptr [[A]], align 4
// CHECK15-NEXT:    [[TMP60:%.*]] = load ptr, ptr [[SAVED_STACK]], align 4
// CHECK15-NEXT:    call void @llvm.stackrestore.p0(ptr [[TMP60]])
// CHECK15-NEXT:    ret i32 [[TMP59]]
//
//
...
// CHECK15-NEXT:    [[A:%.*]] = alloca i32, align 4
// CHECK15-NEXT:    [[AA:%.*]] = alloca i16, align 2
// CHECK15-NEXT:    [[AAA:%.*]] = alloca b8, align 1
...
// CHECK15-NEXT:    store i32 0, ptr [[A]], align 4
// CHECK15-NEXT:    store i16 0, ptr [[AA]], align 2
// CHECK15-NEXT:    [[TMP0:%.*]] = bytecast exact b8 0 to i8
// CHECK15-NEXT:    store i8 [[TMP0]], ptr [[AAA]], align 1
// CHECK15-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK15-NEXT:    store i32 429496720, ptr [[DOTOMP_UB]], align 4
// CHECK15-NEXT:    [[TMP1:%.*]] = load i32, ptr [[A]], align 4
// CHECK15-NEXT:    ret i32 [[TMP1]]
//
//
...
// CHECK17-NEXT:    [[DOTCAPTURE_EXPR__ADDR:%.*]] = alloca i64, align 8
// CHECK17-NEXT:    [[DOTOMP_IV:%.*]] = alloca i32, align 4
// CHECK17-NEXT:    [[TMP:%.*]] = alloca b8, align 1
// CHECK17-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK17-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK17-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i32, align 4
// CHECK17-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK17-NEXT:    [[IT:%.*]] = alloca b8, align 1
// CHECK17-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK17-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 8
// CHECK17-NEXT:    store i64 [[A]], ptr [[A_ADDR]], align 8
// CHECK17-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 8
...
// CHECK17-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[D_ADDR]], align 8
// CHECK17-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK17-NEXT:    [[CONV:%.*]] = bytecast exact b8 122 to i8
// CHECK17-NEXT:    [[CONV5:%.*]] = sext i8 [[CONV]] to i32
// CHECK17-NEXT:    [[CONV6:%.*]] = bytecast exact b8 97 to i8
// CHECK17-NEXT:    [[CONV7:%.*]] = sext i8 [[CONV6]] to i32
// CHECK17-NEXT:    [[SUB:%.*]] = sub nsw i32 [[CONV7]], 1
// CHECK17-NEXT:    [[SUB8:%.*]] = sub nsw i32 [[CONV5]], [[SUB]]
// CHECK17-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB8]], 1
// CHECK17-NEXT:    [[SUB9:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK17-NEXT:    store i32 [[SUB9]], ptr [[DOTOMP_UB]], align 4
// CHECK17-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4
// CHECK17-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
...
// CHECK17-NEXT:    [[CONV10:%.*]] = bytecast exact b8 122 to i8
// CHECK17-NEXT:    [[CONV11:%.*]] = sext i8 [[CONV10]] to i32
// CHECK17-NEXT:    [[CONV12:%.*]] = bytecast exact b8 97 to i8
// CHECK17-NEXT:    [[CONV13:%.*]] = sext i8 [[CONV12]] to i32
// CHECK17-NEXT:    [[SUB14:%.*]] = sub nsw i32 [[CONV13]], 1
// CHECK17-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[CONV11]], [[SUB14]]
// CHECK17-NEXT:    [[DIV16:%.*]] = sdiv i32 [[SUB15]], 1
// CHECK17-NEXT:    [[SUB17:%.*]] = sub nsw i32 [[DIV16]], 1
// CHECK17-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[TMP11]], [[SUB17]]
// CHECK17-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK17:       cond.true:
// CHECK17-NEXT:    [[CONV18:%.*]] = bytecast exact b8 122 to i8
// CHECK17-NEXT:    [[CONV19:%.*]] = sext i8 [[CONV18]] to i32
// CHECK17-NEXT:    [[CONV20:%.*]] = bytecast exact b8 97 to i8
// CHECK17-NEXT:    [[CONV21:%.*]] = sext i8 [[CONV20]] to i32
// CHECK17-NEXT:    [[SUB22:%.*]] = sub nsw i32 [[CONV21]], 1
// CHECK17-NEXT:    [[SUB23:%.*]] = sub nsw i32 [[CONV19]], [[SUB22]]
// CHECK17-NEXT:    [[DIV24:%.*]] = sdiv i32 [[SUB23]], 1
// CHECK17-NEXT:    [[SUB25:%.*]] = sub nsw i32 [[DIV24]], 1
// CHECK17-NEXT:    br label [[COND_END:%.*]]
// CHECK17:       cond.false:
// CHECK17-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK17-NEXT:    br label [[COND_END]]
// CHECK17:       cond.end:
// CHECK17-NEXT:    [[COND:%.*]] = phi i32 [ [[SUB25]], [[COND_TRUE]] ], [ [[TMP12]], [[COND_FALSE]] ]
// CHECK17-NEXT:    store i32 [[COND]], ptr [[DOTOMP_UB]], align 4
...
// CHECK17-NEXT:    [[CMP26:%.*]] = icmp sle i32 [[TMP14]], [[TMP15]]
// CHECK17-NEXT:    br i1 [[CMP26]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]]
// CHECK17:       omp.dispatch.body:
// CHECK17-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK17:       omp.inner.for.cond:
// CHECK17-NEXT:    [[TMP16:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP30:![0-9]+]]
// CHECK17-NEXT:    [[TMP17:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4, !llvm.access.group [[ACC_GRP30]]
// CHECK17-NEXT:    [[CMP27:%.*]] = icmp sle i32 [[TMP16]], [[TMP17]]
// CHECK17-NEXT:    br i1 [[CMP27]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK17:       omp.inner.for.body:
// CHECK17-NEXT:    [[CONV28:%.*]] = bytecast exact b8 122 to i8
// CHECK17-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK17-NEXT:    [[TMP18:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP30]]
// CHECK17-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP18]], 1
// CHECK17-NEXT:    [[SUB30:%.*]] = sub nsw i32 [[CONV29]], [[MUL]]
// CHECK17-NEXT:    [[CONV31:%.*]] = trunc i32 [[SUB30]] to i8
// CHECK17-NEXT:    [[TMP19:%.*]] = bitcast i8 [[CONV31]] to b8
// CHECK17-NEXT:    store b8 [[TMP19]], ptr [[IT]], align 1, !llvm.access.group [[ACC_GRP30]]
// CHECK17-NEXT:    [[TMP20:%.*]] = load i32, ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP30]]
// CHECK17-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP20]], 1
// CHECK17-NEXT:    store i32 [[ADD]], ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP30]]
// CHECK17-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x float], ptr [[TMP0]], i64 0, i64 2
// CHECK17-NEXT:    [[TMP21:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP30]]
// CHECK17-NEXT:    [[CONV32:%.*]] = fpext float [[TMP21]] to double
// CHECK17-NEXT:    [[ADD33:%.*]] = fadd double [[CONV32]], 1.000000e+00
// CHECK17-NEXT:    [[CONV34:%.*]] = fptrunc double [[ADD33]] to float
// CHECK17-NEXT:    store float [[CONV34]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP30]]
// CHECK17-NEXT:    [[ARRAYIDX35:%.*]] = getelementptr inbounds float, ptr [[TMP2]], i64 3
// CHECK17-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP30]]
// CHECK17-NEXT:    [[CONV36:%.*]] = fpext float [[TMP22]] to double
// CHECK17-NEXT:    [[ADD37:%.*]] = fadd double [[CONV36]], 1.000000e+00
// CHECK17-NEXT:    [[CONV38:%.*]] = fptrunc double [[ADD37]] to float
// CHECK17-NEXT:    store float [[CONV38]], ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP30]]
// CHECK17-NEXT:    [[ARRAYIDX39:%.*]] = getelementptr inbounds [5 x [10 x double]], ptr [[TMP3]], i64 0, i64 1
// CHECK17-NEXT:    [[ARRAYIDX40:%.*]] = getelementptr inbounds [10 x double], ptr [[ARRAYIDX39]], i64 0, i64 2
// CHECK17-NEXT:    [[TMP23:%.*]] = load double, ptr [[ARRAYIDX40]], align 8, !llvm.access.group [[ACC_GRP30]]
// CHECK17-NEXT:    [[ADD41:%.*]] = fadd double [[TMP23]], 1.000000e+00
// CHECK17-NEXT:    store double [[ADD41]], ptr [[ARRAYIDX40]], align 8, !llvm.access.group [[ACC_GRP30]]
// CHECK17-NEXT:    [[TMP24:%.*]] = mul nsw i64 1, [[TMP5]]
// CHECK17-NEXT:    [[ARRAYIDX42:%.*]] = getelementptr inbounds double, ptr [[TMP6]], i64 [[TMP24]]
// CHECK17-NEXT:    [[ARRAYIDX43:%.*]] = getelementptr inbounds double, ptr [[ARRAYIDX42]], i64 3
// CHECK17-NEXT:    [[TMP25:%.*]] = load double, ptr [[ARRAYIDX43]], align 8, !llvm.access.group [[ACC_GRP30]]
// CHECK17-NEXT:    [[ADD44:%.*]] = fadd double [[TMP25]], 1.000000e+00
// CHECK17-NEXT:    store double [[ADD44]], ptr [[ARRAYIDX43]], align 8, !llvm.access.group [[ACC_GRP30]]
// CHECK17-NEXT:    [[X:%.*]] = getelementptr inbounds nuw [[STRUCT_TT:%.*]], ptr [[TMP7]], i32 0, i32 0
// CHECK17-NEXT:    [[TMP26:%.*]] = load i64, ptr [[X]], align 8, !llvm.access.group [[ACC_GRP30]]
// CHECK17-NEXT:    [[ADD45:%.*]] = add nsw i64 [[TMP26]], 1
// CHECK17-NEXT:    store i64 [[ADD45]], ptr [[X]], align 8, !llvm.access.group [[ACC_GRP30]]
// CHECK17-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TT]], ptr [[TMP7]], i32 0, i32 1
// CHECK17-NEXT:    [[TMP27:%.*]] = load b8, ptr [[Y]], align 8, !llvm.access.group [[ACC_GRP30]]
// CHECK17-NEXT:    [[CONV46:%.*]] = bytecast exact b8 [[TMP27]] to i8
// CHECK17-NEXT:    [[CONV47:%.*]] = sext i8 [[CONV46]] to i32
// CHECK17-NEXT:    [[ADD48:%.*]] = add nsw i32 [[CONV47]], 1
// CHECK17-NEXT:    [[CONV49:%.*]] = trunc i32 [[ADD48]] to i8
// CHECK17-NEXT:    [[TMP28:%.*]] = bitcast i8 [[CONV49]] to b8
// CHECK17-NEXT:    store b8 [[TMP28]], ptr [[Y]], align 8, !llvm.access.group [[ACC_GRP30]]
// CHECK17-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK17:       omp.body.continue:
// CHECK17-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK17:       omp.inner.for.inc:
// CHECK17-NEXT:    [[TMP29:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP30]]
// CHECK17-NEXT:    [[ADD50:%.*]] = add nsw i32 [[TMP29]], 1
// CHECK17-NEXT:    store i32 [[ADD50]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP30]]
...
// CHECK17-NEXT:    [[TMP30:%.*]] = load i32, ptr [[DOTOMP_LB]], align 4
// CHECK17-NEXT:    [[TMP31:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4
// CHECK17-NEXT:    [[ADD51:%.*]] = add nsw i32 [[TMP30]], [[TMP31]]
// CHECK17-NEXT:    store i32 [[ADD51]], ptr [[DOTOMP_LB]], align 4
// CHECK17-NEXT:    [[TMP32:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK17-NEXT:    [[TMP33:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4
// CHECK17-NEXT:    [[ADD52:%.*]] = add nsw i32 [[TMP32]], [[TMP33]]
// CHECK17-NEXT:    store i32 [[ADD52]], ptr [[DOTOMP_UB]], align 4
// CHECK17-NEXT:    br label [[OMP_DISPATCH_COND]]
// CHECK17:       omp.dispatch.end:
// CHECK17-NEXT:    call void @__kmpc_for_static_fini(ptr @[[GLOB1]], i32 [[TMP10]])
// CHECK17-NEXT:    [[TMP34:%.*]] = load i32, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK17-NEXT:    [[TMP35:%.*]] = icmp ne i32 [[TMP34]], 0
// CHECK17-NEXT:    br i1 [[TMP35]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK17:       .omp.final.then:
// CHECK17-NEXT:    [[CONV53:%.*]] = bytecast exact b8 122 to i8
// CHECK17-NEXT:    [[CONV54:%.*]] = sext i8 [[CONV53]] to i32
// CHECK17-NEXT:    [[CONV55:%.*]] = bytecast exact b8 122 to i8
// CHECK17-NEXT:    [[CONV56:%.*]] = sext i8 [[CONV55]] to i32
// CHECK17-NEXT:    [[CONV57:%.*]] = bytecast exact b8 97 to i8
// CHECK17-NEXT:    [[CONV58:%.*]] = sext i8 [[CONV57]] to i32
// CHECK17-NEXT:    [[SUB59:%.*]] = sub nsw i32 [[CONV58]], 1
// CHECK17-NEXT:    [[SUB60:%.*]] = sub nsw i32 [[CONV56]], [[SUB59]]
// CHECK17-NEXT:    [[DIV61:%.*]] = sdiv i32 [[SUB60]], 1
// CHECK17-NEXT:    [[MUL62:%.*]] = mul nsw i32 [[DIV61]], 1
// CHECK17-NEXT:    [[SUB63:%.*]] = sub nsw i32 [[CONV54]], [[MUL62]]
// CHECK17-NEXT:    [[CONV64:%.*]] = trunc i32 [[SUB63]] to i8
// CHECK17-NEXT:    [[TMP36:%.*]] = bitcast i8 [[CONV64]] to b8
// CHECK17-NEXT:    store b8 [[TMP36]], ptr [[IT]], align 1
// CHECK17-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK17:       .omp.final.done:
// CHECK17-NEXT:    ret void
//
...
// CHECK17-NEXT:    [[TMP5:%.*]] = load b8, ptr [[AAA_ADDR]], align 1
// CHECK17-NEXT:    store b8 [[TMP5]], ptr [[AAA_CASTED]], align 1
...
// CHECK17-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK17:       omp.inner.for.cond:
// CHECK17-NEXT:    [[TMP9:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP33:![0-9]+]]
// CHECK17-NEXT:    [[TMP10:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP33]]
// CHECK17-NEXT:    [[CMP3:%.*]] = icmp ule i64 [[TMP9]], [[TMP10]]
// CHECK17-NEXT:    br i1 [[CMP3]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK17:       omp.inner.for.body:
// CHECK17-NEXT:    [[TMP11:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP33]]
// CHECK17-NEXT:    [[MUL:%.*]] = mul i64 [[TMP11]], 400
// CHECK17-NEXT:    [[SUB:%.*]] = sub i64 2000, [[MUL]]
// CHECK17-NEXT:    store i64 [[SUB]], ptr [[IT]], align 8, !llvm.access.group [[ACC_GRP33]]
// CHECK17-NEXT:    [[TMP12:%.*]] = load i32, ptr [[B_ADDR]], align 4, !llvm.access.group [[ACC_GRP33]]
...
// CHECK17-NEXT:    store double [[ADD]], ptr [[A]], align 8, !llvm.access.group [[ACC_GRP33]]
// CHECK17-NEXT:    [[A4:%.*]] = getelementptr inbounds nuw [[STRUCT_S1]], ptr [[TMP0]], i32 0, i32 0
// CHECK17-NEXT:    [[TMP13:%.*]] = load double, ptr [[A4]], align 8, !llvm.access.group [[ACC_GRP33]]
// CHECK17-NEXT:    [[INC:%.*]] = fadd double [[TMP13]], 1.000000e+00
// CHECK17-NEXT:    store double [[INC]], ptr [[A4]], align 8, !llvm.access.group [[ACC_GRP33]]
...
// CHECK17-NEXT:    store i16 [[CONV5]], ptr [[ARRAYIDX6]], align 2, !llvm.access.group [[ACC_GRP33]]
// CHECK17-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK17:       omp.body.continue:
// CHECK17-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK17:       omp.inner.for.inc:
// CHECK17-NEXT:    [[TMP15:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP33]]
// CHECK17-NEXT:    [[ADD7:%.*]] = add i64 [[TMP15]], 1
// CHECK17-NEXT:    store i64 [[ADD7]], ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP33]]
...
// CHECK17-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK17:       omp.inner.for.cond:
// CHECK17-NEXT:    [[TMP6:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP36:![0-9]+]]
// CHECK17-NEXT:    [[TMP7:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP36]]
// CHECK17-NEXT:    [[CMP1:%.*]] = icmp sle i64 [[TMP6]], [[TMP7]]
// CHECK17-NEXT:    br i1 [[CMP1]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK17:       omp.inner.for.body:
// CHECK17-NEXT:    [[TMP8:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP36]]
// CHECK17-NEXT:    [[MUL:%.*]] = mul nsw i64 [[TMP8]], 3
// CHECK17-NEXT:    [[ADD:%.*]] = add nsw i64 -10, [[MUL]]
// CHECK17-NEXT:    store i64 [[ADD]], ptr [[I]], align 8, !llvm.access.group [[ACC_GRP36]]
// CHECK17-NEXT:    [[TMP9:%.*]] = load i32, ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP36]]
// CHECK17-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP9]], 1
// CHECK17-NEXT:    store i32 [[ADD2]], ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP36]]
// CHECK17-NEXT:    [[TMP10:%.*]] = load i16, ptr [[AA_ADDR]], align 2, !llvm.access.group [[ACC_GRP36]]
// CHECK17-NEXT:    [[CONV:%.*]] = sext i16 [[TMP10]] to i32
// CHECK17-NEXT:    [[ADD3:%.*]] = add nsw i32 [[CONV]], 1
// CHECK17-NEXT:    [[CONV4:%.*]] = trunc i32 [[ADD3]] to i16
// CHECK17-NEXT:    store i16 [[CONV4]], ptr [[AA_ADDR]], align 2, !llvm.access.group [[ACC_GRP36]]
// CHECK17-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x i32], ptr [[TMP0]], i64 0, i64 2
// CHECK17-NEXT:    [[TMP11:%.*]] = load i32, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP36]]
// CHECK17-NEXT:    [[ADD5:%.*]] = add nsw i32 [[TMP11]], 1
// CHECK17-NEXT:    store i32 [[ADD5]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP36]]
// CHECK17-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK17:       omp.body.continue:
// CHECK17-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK17:       omp.inner.for.inc:
// CHECK17-NEXT:    [[TMP12:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP36]]
// CHECK17-NEXT:    [[ADD6:%.*]] = add nsw i64 [[TMP12]], 1
// CHECK17-NEXT:    store i64 [[ADD6]], ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP36]]
...
// CHECK19-NEXT:    [[DOTCAPTURE_EXPR__ADDR:%.*]] = alloca i32, align 4
// CHECK19-NEXT:    [[DOTOMP_IV:%.*]] = alloca i32, align 4
// CHECK19-NEXT:    [[TMP:%.*]] = alloca b8, align 1
// CHECK19-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK19-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK19-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i32, align 4
// CHECK19-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK19-NEXT:    [[IT:%.*]] = alloca b8, align 1
// CHECK19-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK19-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 4
// CHECK19-NEXT:    store i32 [[A]], ptr [[A_ADDR]], align 4
// CHECK19-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 4
...
// CHECK19-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[D_ADDR]], align 4
// CHECK19-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK19-NEXT:    [[CONV:%.*]] = bytecast exact b8 122 to i8
// CHECK19-NEXT:    [[CONV5:%.*]] = sext i8 [[CONV]] to i32
// CHECK19-NEXT:    [[CONV6:%.*]] = bytecast exact b8 97 to i8
// CHECK19-NEXT:    [[CONV7:%.*]] = sext i8 [[CONV6]] to i32
// CHECK19-NEXT:    [[SUB:%.*]] = sub nsw i32 [[CONV7]], 1
// CHECK19-NEXT:    [[SUB8:%.*]] = sub nsw i32 [[CONV5]], [[SUB]]
// CHECK19-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB8]], 1
// CHECK19-NEXT:    [[SUB9:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK19-NEXT:    store i32 [[SUB9]], ptr [[DOTOMP_UB]], align 4
// CHECK19-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4
// CHECK19-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
...
// CHECK19-NEXT:    [[CONV10:%.*]] = bytecast exact b8 122 to i8
// CHECK19-NEXT:    [[CONV11:%.*]] = sext i8 [[CONV10]] to i32
// CHECK19-NEXT:    [[CONV12:%.*]] = bytecast exact b8 97 to i8
// CHECK19-NEXT:    [[CONV13:%.*]] = sext i8 [[CONV12]] to i32
// CHECK19-NEXT:    [[SUB14:%.*]] = sub nsw i32 [[CONV13]], 1
// CHECK19-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[CONV11]], [[SUB14]]
// CHECK19-NEXT:    [[DIV16:%.*]] = sdiv i32 [[SUB15]], 1
// CHECK19-NEXT:    [[SUB17:%.*]] = sub nsw i32 [[DIV16]], 1
// CHECK19-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[TMP11]], [[SUB17]]
// CHECK19-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK19:       cond.true:
// CHECK19-NEXT:    [[CONV18:%.*]] = bytecast exact b8 122 to i8
// CHECK19-NEXT:    [[CONV19:%.*]] = sext i8 [[CONV18]] to i32
// CHECK19-NEXT:    [[CONV20:%.*]] = bytecast exact b8 97 to i8
// CHECK19-NEXT:    [[CONV21:%.*]] = sext i8 [[CONV20]] to i32
// CHECK19-NEXT:    [[SUB22:%.*]] = sub nsw i32 [[CONV21]], 1
// CHECK19-NEXT:    [[SUB23:%.*]] = sub nsw i32 [[CONV19]], [[SUB22]]
// CHECK19-NEXT:    [[DIV24:%.*]] = sdiv i32 [[SUB23]], 1
// CHECK19-NEXT:    [[SUB25:%.*]] = sub nsw i32 [[DIV24]], 1
// CHECK19-NEXT:    br label [[COND_END:%.*]]
// CHECK19:       cond.false:
// CHECK19-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK19-NEXT:    br label [[COND_END]]
// CHECK19:       cond.end:
// CHECK19-NEXT:    [[COND:%.*]] = phi i32 [ [[SUB25]], [[COND_TRUE]] ], [ [[TMP12]], [[COND_FALSE]] ]
// CHECK19-NEXT:    store i32 [[COND]], ptr [[DOTOMP_UB]], align 4
...
// CHECK19-NEXT:    [[CMP26:%.*]] = icmp sle i32 [[TMP14]], [[TMP15]]
// CHECK19-NEXT:    br i1 [[CMP26]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]]
// CHECK19:       omp.dispatch.body:
// CHECK19-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK19:       omp.inner.for.cond:
// CHECK19-NEXT:    [[TMP16:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP31:![0-9]+]]
// CHECK19-NEXT:    [[TMP17:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK19-NEXT:    [[CMP27:%.*]] = icmp sle i32 [[TMP16]], [[TMP17]]
// CHECK19-NEXT:    br i1 [[CMP27]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK19:       omp.inner.for.body:
// CHECK19-NEXT:    [[CONV28:%.*]] = bytecast exact b8 122 to i8
// CHECK19-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK19-NEXT:    [[TMP18:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK19-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP18]], 1
// CHECK19-NEXT:    [[SUB30:%.*]] = sub nsw i32 [[CONV29]], [[MUL]]
// CHECK19-NEXT:    [[CONV31:%.*]] = trunc i32 [[SUB30]] to i8
// CHECK19-NEXT:    [[TMP19:%.*]] = bitcast i8 [[CONV31]] to b8
// CHECK19-NEXT:    store b8 [[TMP19]], ptr [[IT]], align 1, !llvm.access.group [[ACC_GRP31]]
// CHECK19-NEXT:    [[TMP20:%.*]] = load i32, ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK19-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP20]], 1
// CHECK19-NEXT:    store i32 [[ADD]], ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK19-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x float], ptr [[TMP0]], i32 0, i32 2
// CHECK19-NEXT:    [[TMP21:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK19-NEXT:    [[CONV32:%.*]] = fpext float [[TMP21]] to double
// CHECK19-NEXT:    [[ADD33:%.*]] = fadd double [[CONV32]], 1.000000e+00
// CHECK19-NEXT:    [[CONV34:%.*]] = fptrunc double [[ADD33]] to float
// CHECK19-NEXT:    store float [[CONV34]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK19-NEXT:    [[ARRAYIDX35:%.*]] = getelementptr inbounds float, ptr [[TMP2]], i32 3
// CHECK19-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK19-NEXT:    [[CONV36:%.*]] = fpext float [[TMP22]] to double
// CHECK19-NEXT:    [[ADD37:%.*]] = fadd double [[CONV36]], 1.000000e+00
// CHECK19-NEXT:    [[CONV38:%.*]] = fptrunc double [[ADD37]] to float
// CHECK19-NEXT:    store float [[CONV38]], ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK19-NEXT:    [[ARRAYIDX39:%.*]] = getelementptr inbounds [5 x [10 x double]], ptr [[TMP3]], i32 0, i32 1
// CHECK19-NEXT:    [[ARRAYIDX40:%.*]] = getelementptr inbounds [10 x double], ptr [[ARRAYIDX39]], i32 0, i32 2
// CHECK19-NEXT:    [[TMP23:%.*]] = load double, ptr [[ARRAYIDX40]], align 8, !llvm.access.group [[ACC_GRP31]]
// CHECK19-NEXT:    [[ADD41:%.*]] = fadd double [[TMP23]], 1.000000e+00
// CHECK19-NEXT:    store double [[ADD41]], ptr [[ARRAYIDX40]], align 8, !llvm.access.group [[ACC_GRP31]]
// CHECK19-NEXT:    [[TMP24:%.*]] = mul nsw i32 1, [[TMP5]]
// CHECK19-NEXT:    [[ARRAYIDX42:%.*]] = getelementptr inbounds double, ptr [[TMP6]], i32 [[TMP24]]
// CHECK19-NEXT:    [[ARRAYIDX43:%.*]] = getelementptr inbounds double, ptr [[ARRAYIDX42]], i32 3
// CHECK19-NEXT:    [[TMP25:%.*]] = load double, ptr [[ARRAYIDX43]], align 8, !llvm.access.group [[ACC_GRP31]]
// CHECK19-NEXT:    [[ADD44:%.*]] = fadd double [[TMP25]], 1.000000e+00
// CHECK19-NEXT:    store double [[ADD44]], ptr [[ARRAYIDX43]], align 8, !llvm.access.group [[ACC_GRP31]]
// CHECK19-NEXT:    [[X:%.*]] = getelementptr inbounds nuw [[STRUCT_TT:%.*]], ptr [[TMP7]], i32 0, i32 0
// CHECK19-NEXT:    [[TMP26:%.*]] = load i64, ptr [[X]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK19-NEXT:    [[ADD45:%.*]] = add nsw i64 [[TMP26]], 1
// CHECK19-NEXT:    store i64 [[ADD45]], ptr [[X]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK19-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TT]], ptr [[TMP7]], i32 0, i32 1
// CHECK19-NEXT:    [[TMP27:%.*]] = load b8, ptr [[Y]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK19-NEXT:    [[CONV46:%.*]] = bytecast exact b8 [[TMP27]] to i8
// CHECK19-NEXT:    [[CONV47:%.*]] = sext i8 [[CONV46]] to i32
// CHECK19-NEXT:    [[ADD48:%.*]] = add nsw i32 [[CONV47]], 1
// CHECK19-NEXT:    [[CONV49:%.*]] = trunc i32 [[ADD48]] to i8
// CHECK19-NEXT:    [[TMP28:%.*]] = bitcast i8 [[CONV49]] to b8
// CHECK19-NEXT:    store b8 [[TMP28]], ptr [[Y]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK19-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK19:       omp.body.continue:
// CHECK19-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK19:       omp.inner.for.inc:
// CHECK19-NEXT:    [[TMP29:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK19-NEXT:    [[ADD50:%.*]] = add nsw i32 [[TMP29]], 1
// CHECK19-NEXT:    store i32 [[ADD50]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP31]]
...
// CHECK19-NEXT:    [[TMP30:%.*]] = load i32, ptr [[DOTOMP_LB]], align 4
// CHECK19-NEXT:    [[TMP31:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4
// CHECK19-NEXT:    [[ADD51:%.*]] = add nsw i32 [[TMP30]], [[TMP31]]
// CHECK19-NEXT:    store i32 [[ADD51]], ptr [[DOTOMP_LB]], align 4
// CHECK19-NEXT:    [[TMP32:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK19-NEXT:    [[TMP33:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4
// CHECK19-NEXT:    [[ADD52:%.*]] = add nsw i32 [[TMP32]], [[TMP33]]
// CHECK19-NEXT:    store i32 [[ADD52]], ptr [[DOTOMP_UB]], align 4
// CHECK19-NEXT:    br label [[OMP_DISPATCH_COND]]
// CHECK19:       omp.dispatch.end:
// CHECK19-NEXT:    call void @__kmpc_for_static_fini(ptr @[[GLOB1]], i32 [[TMP10]])
// CHECK19-NEXT:    [[TMP34:%.*]] = load i32, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK19-NEXT:    [[TMP35:%.*]] = icmp ne i32 [[TMP34]], 0
// CHECK19-NEXT:    br i1 [[TMP35]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK19:       .omp.final.then:
// CHECK19-NEXT:    [[CONV53:%.*]] = bytecast exact b8 122 to i8
// CHECK19-NEXT:    [[CONV54:%.*]] = sext i8 [[CONV53]] to i32
// CHECK19-NEXT:    [[CONV55:%.*]] = bytecast exact b8 122 to i8
// CHECK19-NEXT:    [[CONV56:%.*]] = sext i8 [[CONV55]] to i32
// CHECK19-NEXT:    [[CONV57:%.*]] = bytecast exact b8 97 to i8
// CHECK19-NEXT:    [[CONV58:%.*]] = sext i8 [[CONV57]] to i32
// CHECK19-NEXT:    [[SUB59:%.*]] = sub nsw i32 [[CONV58]], 1
// CHECK19-NEXT:    [[SUB60:%.*]] = sub nsw i32 [[CONV56]], [[SUB59]]
// CHECK19-NEXT:    [[DIV61:%.*]] = sdiv i32 [[SUB60]], 1
// CHECK19-NEXT:    [[MUL62:%.*]] = mul nsw i32 [[DIV61]], 1
// CHECK19-NEXT:    [[SUB63:%.*]] = sub nsw i32 [[CONV54]], [[MUL62]]
// CHECK19-NEXT:    [[CONV64:%.*]] = trunc i32 [[SUB63]] to i8
// CHECK19-NEXT:    [[TMP36:%.*]] = bitcast i8 [[CONV64]] to b8
// CHECK19-NEXT:    store b8 [[TMP36]], ptr [[IT]], align 1
// CHECK19-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK19:       .omp.final.done:
// CHECK19-NEXT:    ret void
//
...
// CHECK19-NEXT:    [[TMP5:%.*]] = load b8, ptr [[AAA_ADDR]], align 1
// CHECK19-NEXT:    store b8 [[TMP5]], ptr [[AAA_CASTED]], align 1
...
// CHECK19-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK19:       omp.inner.for.cond:
// CHECK19-NEXT:    [[TMP9:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP34:![0-9]+]]
// CHECK19-NEXT:    [[TMP10:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP34]]
// CHECK19-NEXT:    [[CMP3:%.*]] = icmp ule i64 [[TMP9]], [[TMP10]]
// CHECK19-NEXT:    br i1 [[CMP3]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK19:       omp.inner.for.body:
// CHECK19-NEXT:    [[TMP11:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP34]]
// CHECK19-NEXT:    [[MUL:%.*]] = mul i64 [[TMP11]], 400
// CHECK19-NEXT:    [[SUB:%.*]] = sub i64 2000, [[MUL]]
// CHECK19-NEXT:    store i64 [[SUB]], ptr [[IT]], align 8, !llvm.access.group [[ACC_GRP34]]
// CHECK19-NEXT:    [[TMP12:%.*]] = load i32, ptr [[B_ADDR]], align 4, !llvm.access.group [[ACC_GRP34]]
...
// CHECK19-NEXT:    store double [[ADD]], ptr [[A]], align 4, !llvm.access.group [[ACC_GRP34]]
// CHECK19-NEXT:    [[A4:%.*]] = getelementptr inbounds nuw [[STRUCT_S1]], ptr [[TMP0]], i32 0, i32 0
// CHECK19-NEXT:    [[TMP13:%.*]] = load double, ptr [[A4]], align 4, !llvm.access.group [[ACC_GRP34]]
// CHECK19-NEXT:    [[INC:%.*]] = fadd double [[TMP13]], 1.000000e+00
// CHECK19-NEXT:    store double [[INC]], ptr [[A4]], align 4, !llvm.access.group [[ACC_GRP34]]
...
// CHECK19-NEXT:    store i16 [[CONV5]], ptr [[ARRAYIDX6]], align 2, !llvm.access.group [[ACC_GRP34]]
// CHECK19-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK19:       omp.body.continue:
// CHECK19-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK19:       omp.inner.for.inc:
// CHECK19-NEXT:    [[TMP15:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP34]]
// CHECK19-NEXT:    [[ADD7:%.*]] = add i64 [[TMP15]], 1
// CHECK19-NEXT:    store i64 [[ADD7]], ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP34]]
...
// CHECK19-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK19:       omp.inner.for.cond:
// CHECK19-NEXT:    [[TMP6:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP37:![0-9]+]]
// CHECK19-NEXT:    [[TMP7:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK19-NEXT:    [[CMP1:%.*]] = icmp sle i64 [[TMP6]], [[TMP7]]
// CHECK19-NEXT:    br i1 [[CMP1]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK19:       omp.inner.for.body:
// CHECK19-NEXT:    [[TMP8:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK19-NEXT:    [[MUL:%.*]] = mul nsw i64 [[TMP8]], 3
// CHECK19-NEXT:    [[ADD:%.*]] = add nsw i64 -10, [[MUL]]
// CHECK19-NEXT:    store i64 [[ADD]], ptr [[I]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK19-NEXT:    [[TMP9:%.*]] = load i32, ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP37]]
// CHECK19-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP9]], 1
// CHECK19-NEXT:    store i32 [[ADD2]], ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP37]]
// CHECK19-NEXT:    [[TMP10:%.*]] = load i16, ptr [[AA_ADDR]], align 2, !llvm.access.group [[ACC_GRP37]]
// CHECK19-NEXT:    [[CONV:%.*]] = sext i16 [[TMP10]] to i32
// CHECK19-NEXT:    [[ADD3:%.*]] = add nsw i32 [[CONV]], 1
// CHECK19-NEXT:    [[CONV4:%.*]] = trunc i32 [[ADD3]] to i16
// CHECK19-NEXT:    store i16 [[CONV4]], ptr [[AA_ADDR]], align 2, !llvm.access.group [[ACC_GRP37]]
// CHECK19-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x i32], ptr [[TMP0]], i32 0, i32 2
// CHECK19-NEXT:    [[TMP11:%.*]] = load i32, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP37]]
// CHECK19-NEXT:    [[ADD5:%.*]] = add nsw i32 [[TMP11]], 1
// CHECK19-NEXT:    store i32 [[ADD5]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP37]]
// CHECK19-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK19:       omp.body.continue:
// CHECK19-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK19:       omp.inner.for.inc:
// CHECK19-NEXT:    [[TMP12:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP37]]
// CHECK19-NEXT:    [[ADD6:%.*]] = add nsw i64 [[TMP12]], 1
// CHECK19-NEXT:    store i64 [[ADD6]], ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP37]]
...
// CHECK21-NEXT:    [[DOTCAPTURE_EXPR__ADDR:%.*]] = alloca i64, align 8
// CHECK21-NEXT:    [[DOTOMP_IV:%.*]] = alloca i32, align 4
// CHECK21-NEXT:    [[TMP:%.*]] = alloca b8, align 1
// CHECK21-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK21-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK21-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i32, align 4
// CHECK21-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK21-NEXT:    [[IT:%.*]] = alloca b8, align 1
// CHECK21-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK21-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 8
// CHECK21-NEXT:    store i64 [[A]], ptr [[A_ADDR]], align 8
// CHECK21-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 8
...
// CHECK21-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[D_ADDR]], align 8
// CHECK21-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK21-NEXT:    [[CONV:%.*]] = bytecast exact b8 122 to i8
// CHECK21-NEXT:    [[CONV5:%.*]] = sext i8 [[CONV]] to i32
// CHECK21-NEXT:    [[CONV6:%.*]] = bytecast exact b8 97 to i8
// CHECK21-NEXT:    [[CONV7:%.*]] = sext i8 [[CONV6]] to i32
// CHECK21-NEXT:    [[SUB:%.*]] = sub nsw i32 [[CONV7]], 1
// CHECK21-NEXT:    [[SUB8:%.*]] = sub nsw i32 [[CONV5]], [[SUB]]
// CHECK21-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB8]], 1
// CHECK21-NEXT:    [[SUB9:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK21-NEXT:    store i32 [[SUB9]], ptr [[DOTOMP_UB]], align 4
// CHECK21-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4
// CHECK21-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
...
// CHECK21-NEXT:    [[CONV10:%.*]] = bytecast exact b8 122 to i8
// CHECK21-NEXT:    [[CONV11:%.*]] = sext i8 [[CONV10]] to i32
// CHECK21-NEXT:    [[CONV12:%.*]] = bytecast exact b8 97 to i8
// CHECK21-NEXT:    [[CONV13:%.*]] = sext i8 [[CONV12]] to i32
// CHECK21-NEXT:    [[SUB14:%.*]] = sub nsw i32 [[CONV13]], 1
// CHECK21-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[CONV11]], [[SUB14]]
// CHECK21-NEXT:    [[DIV16:%.*]] = sdiv i32 [[SUB15]], 1
// CHECK21-NEXT:    [[SUB17:%.*]] = sub nsw i32 [[DIV16]], 1
// CHECK21-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[TMP11]], [[SUB17]]
// CHECK21-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK21:       cond.true:
// CHECK21-NEXT:    [[CONV18:%.*]] = bytecast exact b8 122 to i8
// CHECK21-NEXT:    [[CONV19:%.*]] = sext i8 [[CONV18]] to i32
// CHECK21-NEXT:    [[CONV20:%.*]] = bytecast exact b8 97 to i8
// CHECK21-NEXT:    [[CONV21:%.*]] = sext i8 [[CONV20]] to i32
// CHECK21-NEXT:    [[SUB22:%.*]] = sub nsw i32 [[CONV21]], 1
// CHECK21-NEXT:    [[SUB23:%.*]] = sub nsw i32 [[CONV19]], [[SUB22]]
// CHECK21-NEXT:    [[DIV24:%.*]] = sdiv i32 [[SUB23]], 1
// CHECK21-NEXT:    [[SUB25:%.*]] = sub nsw i32 [[DIV24]], 1
// CHECK21-NEXT:    br label [[COND_END:%.*]]
// CHECK21:       cond.false:
// CHECK21-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK21-NEXT:    br label [[COND_END]]
// CHECK21:       cond.end:
// CHECK21-NEXT:    [[COND:%.*]] = phi i32 [ [[SUB25]], [[COND_TRUE]] ], [ [[TMP12]], [[COND_FALSE]] ]
// CHECK21-NEXT:    store i32 [[COND]], ptr [[DOTOMP_UB]], align 4
...
// CHECK21-NEXT:    [[CMP26:%.*]] = icmp sle i32 [[TMP14]], [[TMP15]]
// CHECK21-NEXT:    br i1 [[CMP26]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]]
// CHECK21:       omp.dispatch.body:
// CHECK21-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK21:       omp.inner.for.cond:
// CHECK21-NEXT:    [[TMP16:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP30:![0-9]+]]
// CHECK21-NEXT:    [[TMP17:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4, !llvm.access.group [[ACC_GRP30]]
// CHECK21-NEXT:    [[CMP27:%.*]] = icmp sle i32 [[TMP16]], [[TMP17]]
// CHECK21-NEXT:    br i1 [[CMP27]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK21:       omp.inner.for.body:
// CHECK21-NEXT:    [[CONV28:%.*]] = bytecast exact b8 122 to i8
// CHECK21-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK21-NEXT:    [[TMP18:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP30]]
// CHECK21-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP18]], 1
// CHECK21-NEXT:    [[SUB30:%.*]] = sub nsw i32 [[CONV29]], [[MUL]]
// CHECK21-NEXT:    [[CONV31:%.*]] = trunc i32 [[SUB30]] to i8
// CHECK21-NEXT:    [[TMP19:%.*]] = bitcast i8 [[CONV31]] to b8
// CHECK21-NEXT:    store b8 [[TMP19]], ptr [[IT]], align 1, !llvm.access.group [[ACC_GRP30]]
// CHECK21-NEXT:    [[TMP20:%.*]] = load i32, ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP30]]
// CHECK21-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP20]], 1
// CHECK21-NEXT:    store i32 [[ADD]], ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP30]]
// CHECK21-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x float], ptr [[TMP0]], i64 0, i64 2
// CHECK21-NEXT:    [[TMP21:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP30]]
// CHECK21-NEXT:    [[CONV32:%.*]] = fpext float [[TMP21]] to double
// CHECK21-NEXT:    [[ADD33:%.*]] = fadd double [[CONV32]], 1.000000e+00
// CHECK21-NEXT:    [[CONV34:%.*]] = fptrunc double [[ADD33]] to float
// CHECK21-NEXT:    store float [[CONV34]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP30]]
// CHECK21-NEXT:    [[ARRAYIDX35:%.*]] = getelementptr inbounds float, ptr [[TMP2]], i64 3
// CHECK21-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP30]]
// CHECK21-NEXT:    [[CONV36:%.*]] = fpext float [[TMP22]] to double
// CHECK21-NEXT:    [[ADD37:%.*]] = fadd double [[CONV36]], 1.000000e+00
// CHECK21-NEXT:    [[CONV38:%.*]] = fptrunc double [[ADD37]] to float
// CHECK21-NEXT:    store float [[CONV38]], ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP30]]
// CHECK21-NEXT:    [[ARRAYIDX39:%.*]] = getelementptr inbounds [5 x [10 x double]], ptr [[TMP3]], i64 0, i64 1
// CHECK21-NEXT:    [[ARRAYIDX40:%.*]] = getelementptr inbounds [10 x double], ptr [[ARRAYIDX39]], i64 0, i64 2
// CHECK21-NEXT:    [[TMP23:%.*]] = load double, ptr [[ARRAYIDX40]], align 8, !llvm.access.group [[ACC_GRP30]]
// CHECK21-NEXT:    [[ADD41:%.*]] = fadd double [[TMP23]], 1.000000e+00
// CHECK21-NEXT:    store double [[ADD41]], ptr [[ARRAYIDX40]], align 8, !llvm.access.group [[ACC_GRP30]]
// CHECK21-NEXT:    [[TMP24:%.*]] = mul nsw i64 1, [[TMP5]]
// CHECK21-NEXT:    [[ARRAYIDX42:%.*]] = getelementptr inbounds double, ptr [[TMP6]], i64 [[TMP24]]
// CHECK21-NEXT:    [[ARRAYIDX43:%.*]] = getelementptr inbounds double, ptr [[ARRAYIDX42]], i64 3
// CHECK21-NEXT:    [[TMP25:%.*]] = load double, ptr [[ARRAYIDX43]], align 8, !llvm.access.group [[ACC_GRP30]]
// CHECK21-NEXT:    [[ADD44:%.*]] = fadd double [[TMP25]], 1.000000e+00
// CHECK21-NEXT:    store double [[ADD44]], ptr [[ARRAYIDX43]], align 8, !llvm.access.group [[ACC_GRP30]]
// CHECK21-NEXT:    [[X:%.*]] = getelementptr inbounds nuw [[STRUCT_TT:%.*]], ptr [[TMP7]], i32 0, i32 0
// CHECK21-NEXT:    [[TMP26:%.*]] = load i64, ptr [[X]], align 8, !llvm.access.group [[ACC_GRP30]]
// CHECK21-NEXT:    [[ADD45:%.*]] = add nsw i64 [[TMP26]], 1
// CHECK21-NEXT:    store i64 [[ADD45]], ptr [[X]], align 8, !llvm.access.group [[ACC_GRP30]]
// CHECK21-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TT]], ptr [[TMP7]], i32 0, i32 1
// CHECK21-NEXT:    [[TMP27:%.*]] = load b8, ptr [[Y]], align 8, !llvm.access.group [[ACC_GRP30]]
// CHECK21-NEXT:    [[CONV46:%.*]] = bytecast exact b8 [[TMP27]] to i8
// CHECK21-NEXT:    [[CONV47:%.*]] = sext i8 [[CONV46]] to i32
// CHECK21-NEXT:    [[ADD48:%.*]] = add nsw i32 [[CONV47]], 1
// CHECK21-NEXT:    [[CONV49:%.*]] = trunc i32 [[ADD48]] to i8
// CHECK21-NEXT:    [[TMP28:%.*]] = bitcast i8 [[CONV49]] to b8
// CHECK21-NEXT:    store b8 [[TMP28]], ptr [[Y]], align 8, !llvm.access.group [[ACC_GRP30]]
// CHECK21-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK21:       omp.body.continue:
// CHECK21-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK21:       omp.inner.for.inc:
// CHECK21-NEXT:    [[TMP29:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP30]]
// CHECK21-NEXT:    [[ADD50:%.*]] = add nsw i32 [[TMP29]], 1
// CHECK21-NEXT:    store i32 [[ADD50]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP30]]
...
// CHECK21-NEXT:    [[TMP30:%.*]] = load i32, ptr [[DOTOMP_LB]], align 4
// CHECK21-NEXT:    [[TMP31:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4
// CHECK21-NEXT:    [[ADD51:%.*]] = add nsw i32 [[TMP30]], [[TMP31]]
// CHECK21-NEXT:    store i32 [[ADD51]], ptr [[DOTOMP_LB]], align 4
// CHECK21-NEXT:    [[TMP32:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK21-NEXT:    [[TMP33:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4
// CHECK21-NEXT:    [[ADD52:%.*]] = add nsw i32 [[TMP32]], [[TMP33]]
// CHECK21-NEXT:    store i32 [[ADD52]], ptr [[DOTOMP_UB]], align 4
// CHECK21-NEXT:    br label [[OMP_DISPATCH_COND]]
// CHECK21:       omp.dispatch.end:
// CHECK21-NEXT:    call void @__kmpc_for_static_fini(ptr @[[GLOB1]], i32 [[TMP10]])
// CHECK21-NEXT:    [[TMP34:%.*]] = load i32, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK21-NEXT:    [[TMP35:%.*]] = icmp ne i32 [[TMP34]], 0
// CHECK21-NEXT:    br i1 [[TMP35]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK21:       .omp.final.then:
// CHECK21-NEXT:    [[CONV53:%.*]] = bytecast exact b8 122 to i8
// CHECK21-NEXT:    [[CONV54:%.*]] = sext i8 [[CONV53]] to i32
// CHECK21-NEXT:    [[CONV55:%.*]] = bytecast exact b8 122 to i8
// CHECK21-NEXT:    [[CONV56:%.*]] = sext i8 [[CONV55]] to i32
// CHECK21-NEXT:    [[CONV57:%.*]] = bytecast exact b8 97 to i8
// CHECK21-NEXT:    [[CONV58:%.*]] = sext i8 [[CONV57]] to i32
// CHECK21-NEXT:    [[SUB59:%.*]] = sub nsw i32 [[CONV58]], 1
// CHECK21-NEXT:    [[SUB60:%.*]] = sub nsw i32 [[CONV56]], [[SUB59]]
// CHECK21-NEXT:    [[DIV61:%.*]] = sdiv i32 [[SUB60]], 1
// CHECK21-NEXT:    [[MUL62:%.*]] = mul nsw i32 [[DIV61]], 1
// CHECK21-NEXT:    [[SUB63:%.*]] = sub nsw i32 [[CONV54]], [[MUL62]]
// CHECK21-NEXT:    [[CONV64:%.*]] = trunc i32 [[SUB63]] to i8
// CHECK21-NEXT:    [[TMP36:%.*]] = bitcast i8 [[CONV64]] to b8
// CHECK21-NEXT:    store b8 [[TMP36]], ptr [[IT]], align 1
// CHECK21-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK21:       .omp.final.done:
// CHECK21-NEXT:    ret void
//
...
// CHECK21-NEXT:    [[TMP5:%.*]] = load b8, ptr [[AAA_ADDR]], align 1
// CHECK21-NEXT:    store b8 [[TMP5]], ptr [[AAA_CASTED]], align 1
...
// CHECK21-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK21:       omp.inner.for.cond:
// CHECK21-NEXT:    [[TMP10:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP33:![0-9]+]]
// CHECK21-NEXT:    [[TMP11:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP33]]
...
// CHECK21-NEXT:    [[SUB:%.*]] = sub i64 2000, [[MUL]]
// CHECK21-NEXT:    store i64 [[SUB]], ptr [[IT]], align 8, !llvm.access.group [[ACC_GRP33]]
// CHECK21-NEXT:    [[TMP13:%.*]] = load i32, ptr [[B_ADDR]], align 4, !llvm.access.group [[ACC_GRP33]]
...
// CHECK21-NEXT:    store double [[ADD]], ptr [[A]], align 8, !nontemporal [[META34:![0-9]+]], !llvm.access.group [[ACC_GRP33]]
// CHECK21-NEXT:    [[A4:%.*]] = getelementptr inbounds nuw [[STRUCT_S1]], ptr [[TMP0]], i32 0, i32 0
// CHECK21-NEXT:    [[TMP14:%.*]] = load double, ptr [[A4]], align 8, !nontemporal [[META34]], !llvm.access.group [[ACC_GRP33]]
// CHECK21-NEXT:    [[INC:%.*]] = fadd double [[TMP14]], 1.000000e+00
// CHECK21-NEXT:    store double [[INC]], ptr [[A4]], align 8, !nontemporal [[META34]], !llvm.access.group [[ACC_GRP33]]
...
// CHECK21-NEXT:    store i16 [[CONV5]], ptr [[ARRAYIDX6]], align 2, !llvm.access.group [[ACC_GRP33]]
// CHECK21-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK21:       omp.body.continue:
// CHECK21-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK21:       omp.inner.for.inc:
// CHECK21-NEXT:    [[TMP16:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP33]]
// CHECK21-NEXT:    [[ADD7:%.*]] = add i64 [[TMP16]], 1
// CHECK21-NEXT:    store i64 [[ADD7]], ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP33]]
...
// CHECK21-NEXT:    br label [[OMP_INNER_FOR_COND13]], !llvm.loop [[LOOP37:![0-9]+]]
...
// CHECK21-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK21:       omp.inner.for.cond:
// CHECK21-NEXT:    [[TMP6:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP39:![0-9]+]]
// CHECK21-NEXT:    [[TMP7:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP39]]
// CHECK21-NEXT:    [[CMP1:%.*]] = icmp sle i64 [[TMP6]], [[TMP7]]
// CHECK21-NEXT:    br i1 [[CMP1]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK21:       omp.inner.for.body:
// CHECK21-NEXT:    [[TMP8:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP39]]
// CHECK21-NEXT:    [[MUL:%.*]] = mul nsw i64 [[TMP8]], 3
// CHECK21-NEXT:    [[ADD:%.*]] = add nsw i64 -10, [[MUL]]
// CHECK21-NEXT:    store i64 [[ADD]], ptr [[I]], align 8, !llvm.access.group [[ACC_GRP39]]
// CHECK21-NEXT:    [[TMP9:%.*]] = load i32, ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP39]]
// CHECK21-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP9]], 1
// CHECK21-NEXT:    store i32 [[ADD2]], ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP39]]
// CHECK21-NEXT:    [[TMP10:%.*]] = load i16, ptr [[AA_ADDR]], align 2, !llvm.access.group [[ACC_GRP39]]
// CHECK21-NEXT:    [[CONV:%.*]] = sext i16 [[TMP10]] to i32
// CHECK21-NEXT:    [[ADD3:%.*]] = add nsw i32 [[CONV]], 1
// CHECK21-NEXT:    [[CONV4:%.*]] = trunc i32 [[ADD3]] to i16
// CHECK21-NEXT:    store i16 [[CONV4]], ptr [[AA_ADDR]], align 2, !llvm.access.group [[ACC_GRP39]]
// CHECK21-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x i32], ptr [[TMP0]], i64 0, i64 2
// CHECK21-NEXT:    [[TMP11:%.*]] = load i32, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP39]]
// CHECK21-NEXT:    [[ADD5:%.*]] = add nsw i32 [[TMP11]], 1
// CHECK21-NEXT:    store i32 [[ADD5]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP39]]
// CHECK21-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK21:       omp.body.continue:
// CHECK21-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK21:       omp.inner.for.inc:
// CHECK21-NEXT:    [[TMP12:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP39]]
// CHECK21-NEXT:    [[ADD6:%.*]] = add nsw i64 [[TMP12]], 1
// CHECK21-NEXT:    store i64 [[ADD6]], ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP39]]
// CHECK21-NEXT:    br label [[OMP_INNER_FOR_COND]], !llvm.loop [[LOOP40:![0-9]+]]
// CHECK21:       omp.inner.for.end:
// CHECK21-NEXT:    br label [[OMP_LOOP_EXIT:%.*]]
// CHECK21:       omp.loop.exit:
...
// CHECK23-NEXT:    [[DOTCAPTURE_EXPR__ADDR:%.*]] = alloca i32, align 4
// CHECK23-NEXT:    [[DOTOMP_IV:%.*]] = alloca i32, align 4
// CHECK23-NEXT:    [[TMP:%.*]] = alloca b8, align 1
// CHECK23-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
// CHECK23-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
// CHECK23-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i32, align 4
// CHECK23-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
// CHECK23-NEXT:    [[IT:%.*]] = alloca b8, align 1
// CHECK23-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK23-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 4
// CHECK23-NEXT:    store i32 [[A]], ptr [[A_ADDR]], align 4
// CHECK23-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 4
...
// CHECK23-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[D_ADDR]], align 4
// CHECK23-NEXT:    store i32 0, ptr [[DOTOMP_LB]], align 4
// CHECK23-NEXT:    [[CONV:%.*]] = bytecast exact b8 122 to i8
// CHECK23-NEXT:    [[CONV5:%.*]] = sext i8 [[CONV]] to i32
// CHECK23-NEXT:    [[CONV6:%.*]] = bytecast exact b8 97 to i8
// CHECK23-NEXT:    [[CONV7:%.*]] = sext i8 [[CONV6]] to i32
// CHECK23-NEXT:    [[SUB:%.*]] = sub nsw i32 [[CONV7]], 1
// CHECK23-NEXT:    [[SUB8:%.*]] = sub nsw i32 [[CONV5]], [[SUB]]
// CHECK23-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB8]], 1
// CHECK23-NEXT:    [[SUB9:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK23-NEXT:    store i32 [[SUB9]], ptr [[DOTOMP_UB]], align 4
// CHECK23-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4
// CHECK23-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
...
// CHECK23-NEXT:    [[CONV10:%.*]] = bytecast exact b8 122 to i8
// CHECK23-NEXT:    [[CONV11:%.*]] = sext i8 [[CONV10]] to i32
// CHECK23-NEXT:    [[CONV12:%.*]] = bytecast exact b8 97 to i8
// CHECK23-NEXT:    [[CONV13:%.*]] = sext i8 [[CONV12]] to i32
// CHECK23-NEXT:    [[SUB14:%.*]] = sub nsw i32 [[CONV13]], 1
// CHECK23-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[CONV11]], [[SUB14]]
// CHECK23-NEXT:    [[DIV16:%.*]] = sdiv i32 [[SUB15]], 1
// CHECK23-NEXT:    [[SUB17:%.*]] = sub nsw i32 [[DIV16]], 1
// CHECK23-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[TMP11]], [[SUB17]]
// CHECK23-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK23:       cond.true:
// CHECK23-NEXT:    [[CONV18:%.*]] = bytecast exact b8 122 to i8
// CHECK23-NEXT:    [[CONV19:%.*]] = sext i8 [[CONV18]] to i32
// CHECK23-NEXT:    [[CONV20:%.*]] = bytecast exact b8 97 to i8
// CHECK23-NEXT:    [[CONV21:%.*]] = sext i8 [[CONV20]] to i32
// CHECK23-NEXT:    [[SUB22:%.*]] = sub nsw i32 [[CONV21]], 1
// CHECK23-NEXT:    [[SUB23:%.*]] = sub nsw i32 [[CONV19]], [[SUB22]]
// CHECK23-NEXT:    [[DIV24:%.*]] = sdiv i32 [[SUB23]], 1
// CHECK23-NEXT:    [[SUB25:%.*]] = sub nsw i32 [[DIV24]], 1
// CHECK23-NEXT:    br label [[COND_END:%.*]]
// CHECK23:       cond.false:
// CHECK23-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK23-NEXT:    br label [[COND_END]]
// CHECK23:       cond.end:
// CHECK23-NEXT:    [[COND:%.*]] = phi i32 [ [[SUB25]], [[COND_TRUE]] ], [ [[TMP12]], [[COND_FALSE]] ]
// CHECK23-NEXT:    store i32 [[COND]], ptr [[DOTOMP_UB]], align 4
...
// CHECK23-NEXT:    [[CMP26:%.*]] = icmp sle i32 [[TMP14]], [[TMP15]]
// CHECK23-NEXT:    br i1 [[CMP26]], label [[OMP_DISPATCH_BODY:%.*]], label [[OMP_DISPATCH_END:%.*]]
// CHECK23:       omp.dispatch.body:
// CHECK23-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK23:       omp.inner.for.cond:
// CHECK23-NEXT:    [[TMP16:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP31:![0-9]+]]
// CHECK23-NEXT:    [[TMP17:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK23-NEXT:    [[CMP27:%.*]] = icmp sle i32 [[TMP16]], [[TMP17]]
// CHECK23-NEXT:    br i1 [[CMP27]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK23:       omp.inner.for.body:
// CHECK23-NEXT:    [[CONV28:%.*]] = bytecast exact b8 122 to i8
// CHECK23-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK23-NEXT:    [[TMP18:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK23-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP18]], 1
// CHECK23-NEXT:    [[SUB30:%.*]] = sub nsw i32 [[CONV29]], [[MUL]]
// CHECK23-NEXT:    [[CONV31:%.*]] = trunc i32 [[SUB30]] to i8
// CHECK23-NEXT:    [[TMP19:%.*]] = bitcast i8 [[CONV31]] to b8
// CHECK23-NEXT:    store b8 [[TMP19]], ptr [[IT]], align 1, !llvm.access.group [[ACC_GRP31]]
// CHECK23-NEXT:    [[TMP20:%.*]] = load i32, ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK23-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP20]], 1
// CHECK23-NEXT:    store i32 [[ADD]], ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK23-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x float], ptr [[TMP0]], i32 0, i32 2
// CHECK23-NEXT:    [[TMP21:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK23-NEXT:    [[CONV32:%.*]] = fpext float [[TMP21]] to double
// CHECK23-NEXT:    [[ADD33:%.*]] = fadd double [[CONV32]], 1.000000e+00
// CHECK23-NEXT:    [[CONV34:%.*]] = fptrunc double [[ADD33]] to float
// CHECK23-NEXT:    store float [[CONV34]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK23-NEXT:    [[ARRAYIDX35:%.*]] = getelementptr inbounds float, ptr [[TMP2]], i32 3
// CHECK23-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK23-NEXT:    [[CONV36:%.*]] = fpext float [[TMP22]] to double
// CHECK23-NEXT:    [[ADD37:%.*]] = fadd double [[CONV36]], 1.000000e+00
// CHECK23-NEXT:    [[CONV38:%.*]] = fptrunc double [[ADD37]] to float
// CHECK23-NEXT:    store float [[CONV38]], ptr [[ARRAYIDX35]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK23-NEXT:    [[ARRAYIDX39:%.*]] = getelementptr inbounds [5 x [10 x double]], ptr [[TMP3]], i32 0, i32 1
// CHECK23-NEXT:    [[ARRAYIDX40:%.*]] = getelementptr inbounds [10 x double], ptr [[ARRAYIDX39]], i32 0, i32 2
// CHECK23-NEXT:    [[TMP23:%.*]] = load double, ptr [[ARRAYIDX40]], align 8, !llvm.access.group [[ACC_GRP31]]
// CHECK23-NEXT:    [[ADD41:%.*]] = fadd double [[TMP23]], 1.000000e+00
// CHECK23-NEXT:    store double [[ADD41]], ptr [[ARRAYIDX40]], align 8, !llvm.access.group [[ACC_GRP31]]
// CHECK23-NEXT:    [[TMP24:%.*]] = mul nsw i32 1, [[TMP5]]
// CHECK23-NEXT:    [[ARRAYIDX42:%.*]] = getelementptr inbounds double, ptr [[TMP6]], i32 [[TMP24]]
// CHECK23-NEXT:    [[ARRAYIDX43:%.*]] = getelementptr inbounds double, ptr [[ARRAYIDX42]], i32 3
// CHECK23-NEXT:    [[TMP25:%.*]] = load double, ptr [[ARRAYIDX43]], align 8, !llvm.access.group [[ACC_GRP31]]
// CHECK23-NEXT:    [[ADD44:%.*]] = fadd double [[TMP25]], 1.000000e+00
// CHECK23-NEXT:    store double [[ADD44]], ptr [[ARRAYIDX43]], align 8, !llvm.access.group [[ACC_GRP31]]
// CHECK23-NEXT:    [[X:%.*]] = getelementptr inbounds nuw [[STRUCT_TT:%.*]], ptr [[TMP7]], i32 0, i32 0
// CHECK23-NEXT:    [[TMP26:%.*]] = load i64, ptr [[X]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK23-NEXT:    [[ADD45:%.*]] = add nsw i64 [[TMP26]], 1
// CHECK23-NEXT:    store i64 [[ADD45]], ptr [[X]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK23-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TT]], ptr [[TMP7]], i32 0, i32 1
// CHECK23-NEXT:    [[TMP27:%.*]] = load b8, ptr [[Y]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK23-NEXT:    [[CONV46:%.*]] = bytecast exact b8 [[TMP27]] to i8
// CHECK23-NEXT:    [[CONV47:%.*]] = sext i8 [[CONV46]] to i32
// CHECK23-NEXT:    [[ADD48:%.*]] = add nsw i32 [[CONV47]], 1
// CHECK23-NEXT:    [[CONV49:%.*]] = trunc i32 [[ADD48]] to i8
// CHECK23-NEXT:    [[TMP28:%.*]] = bitcast i8 [[CONV49]] to b8
// CHECK23-NEXT:    store b8 [[TMP28]], ptr [[Y]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK23-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK23:       omp.body.continue:
// CHECK23-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK23:       omp.inner.for.inc:
// CHECK23-NEXT:    [[TMP29:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP31]]
// CHECK23-NEXT:    [[ADD50:%.*]] = add nsw i32 [[TMP29]], 1
// CHECK23-NEXT:    store i32 [[ADD50]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP31]]
...
// CHECK23-NEXT:    [[TMP30:%.*]] = load i32, ptr [[DOTOMP_LB]], align 4
// CHECK23-NEXT:    [[TMP31:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4
// CHECK23-NEXT:    [[ADD51:%.*]] = add nsw i32 [[TMP30]], [[TMP31]]
// CHECK23-NEXT:    store i32 [[ADD51]], ptr [[DOTOMP_LB]], align 4
// CHECK23-NEXT:    [[TMP32:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4
// CHECK23-NEXT:    [[TMP33:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4
// CHECK23-NEXT:    [[ADD52:%.*]] = add nsw i32 [[TMP32]], [[TMP33]]
// CHECK23-NEXT:    store i32 [[ADD52]], ptr [[DOTOMP_UB]], align 4
// CHECK23-NEXT:    br label [[OMP_DISPATCH_COND]]
// CHECK23:       omp.dispatch.end:
// CHECK23-NEXT:    call void @__kmpc_for_static_fini(ptr @[[GLOB1]], i32 [[TMP10]])
// CHECK23-NEXT:    [[TMP34:%.*]] = load i32, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK23-NEXT:    [[TMP35:%.*]] = icmp ne i32 [[TMP34]], 0
// CHECK23-NEXT:    br i1 [[TMP35]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK23:       .omp.final.then:
// CHECK23-NEXT:    [[CONV53:%.*]] = bytecast exact b8 122 to i8
// CHECK23-NEXT:    [[CONV54:%.*]] = sext i8 [[CONV53]] to i32
// CHECK23-NEXT:    [[CONV55:%.*]] = bytecast exact b8 122 to i8
// CHECK23-NEXT:    [[CONV56:%.*]] = sext i8 [[CONV55]] to i32
// CHECK23-NEXT:    [[CONV57:%.*]] = bytecast exact b8 97 to i8
// CHECK23-NEXT:    [[CONV58:%.*]] = sext i8 [[CONV57]] to i32
// CHECK23-NEXT:    [[SUB59:%.*]] = sub nsw i32 [[CONV58]], 1
// CHECK23-NEXT:    [[SUB60:%.*]] = sub nsw i32 [[CONV56]], [[SUB59]]
// CHECK23-NEXT:    [[DIV61:%.*]] = sdiv i32 [[SUB60]], 1
// CHECK23-NEXT:    [[MUL62:%.*]] = mul nsw i32 [[DIV61]], 1
// CHECK23-NEXT:    [[SUB63:%.*]] = sub nsw i32 [[CONV54]], [[MUL62]]
// CHECK23-NEXT:    [[CONV64:%.*]] = trunc i32 [[SUB63]] to i8
// CHECK23-NEXT:    [[TMP36:%.*]] = bitcast i8 [[CONV64]] to b8
// CHECK23-NEXT:    store b8 [[TMP36]], ptr [[IT]], align 1
// CHECK23-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK23:       .omp.final.done:
// CHECK23-NEXT:    ret void
//
...
// CHECK23-NEXT:    [[TMP5:%.*]] = load b8, ptr [[AAA_ADDR]], align 1
// CHECK23-NEXT:    store b8 [[TMP5]], ptr [[AAA_CASTED]], align 1
...
// CHECK23-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK23:       omp.inner.for.cond:
// CHECK23-NEXT:    [[TMP10:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP34:![0-9]+]]
// CHECK23-NEXT:    [[TMP11:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP34]]
...
// CHECK23-NEXT:    [[SUB:%.*]] = sub i64 2000, [[MUL]]
// CHECK23-NEXT:    store i64 [[SUB]], ptr [[IT]], align 8, !llvm.access.group [[ACC_GRP34]]
// CHECK23-NEXT:    [[TMP13:%.*]] = load i32, ptr [[B_ADDR]], align 4, !llvm.access.group [[ACC_GRP34]]
...
// CHECK23-NEXT:    store double [[ADD]], ptr [[A]], align 4, !nontemporal [[META35:![0-9]+]], !llvm.access.group [[ACC_GRP34]]
// CHECK23-NEXT:    [[A4:%.*]] = getelementptr inbounds nuw [[STRUCT_S1]], ptr [[TMP0]], i32 0, i32 0
// CHECK23-NEXT:    [[TMP14:%.*]] = load double, ptr [[A4]], align 4, !nontemporal [[META35]], !llvm.access.group [[ACC_GRP34]]
// CHECK23-NEXT:    [[INC:%.*]] = fadd double [[TMP14]], 1.000000e+00
// CHECK23-NEXT:    store double [[INC]], ptr [[A4]], align 4, !nontemporal [[META35]], !llvm.access.group [[ACC_GRP34]]
...
// CHECK23-NEXT:    store i16 [[CONV5]], ptr [[ARRAYIDX6]], align 2, !llvm.access.group [[ACC_GRP34]]
// CHECK23-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK23:       omp.body.continue:
// CHECK23-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK23:       omp.inner.for.inc:
// CHECK23-NEXT:    [[TMP16:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP34]]
// CHECK23-NEXT:    [[ADD7:%.*]] = add i64 [[TMP16]], 1
// CHECK23-NEXT:    store i64 [[ADD7]], ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP34]]
...
// CHECK23-NEXT:    br label [[OMP_INNER_FOR_COND13]], !llvm.loop [[LOOP38:![0-9]+]]
...
// CHECK23-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK23:       omp.inner.for.cond:
// CHECK23-NEXT:    [[TMP6:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP40:![0-9]+]]
// CHECK23-NEXT:    [[TMP7:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP40]]
// CHECK23-NEXT:    [[CMP1:%.*]] = icmp sle i64 [[TMP6]], [[TMP7]]
// CHECK23-NEXT:    br i1 [[CMP1]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK23:       omp.inner.for.body:
// CHECK23-NEXT:    [[TMP8:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP40]]
// CHECK23-NEXT:    [[MUL:%.*]] = mul nsw i64 [[TMP8]], 3
// CHECK23-NEXT:    [[ADD:%.*]] = add nsw i64 -10, [[MUL]]
// CHECK23-NEXT:    store i64 [[ADD]], ptr [[I]], align 8, !llvm.access.group [[ACC_GRP40]]
// CHECK23-NEXT:    [[TMP9:%.*]] = load i32, ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP40]]
// CHECK23-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP9]], 1
// CHECK23-NEXT:    store i32 [[ADD2]], ptr [[A_ADDR]], align 4, !llvm.access.group [[ACC_GRP40]]
// CHECK23-NEXT:    [[TMP10:%.*]] = load i16, ptr [[AA_ADDR]], align 2, !llvm.access.group [[ACC_GRP40]]
// CHECK23-NEXT:    [[CONV:%.*]] = sext i16 [[TMP10]] to i32
// CHECK23-NEXT:    [[ADD3:%.*]] = add nsw i32 [[CONV]], 1
// CHECK23-NEXT:    [[CONV4:%.*]] = trunc i32 [[ADD3]] to i16
// CHECK23-NEXT:    store i16 [[CONV4]], ptr [[AA_ADDR]], align 2, !llvm.access.group [[ACC_GRP40]]
// CHECK23-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x i32], ptr [[TMP0]], i32 0, i32 2
// CHECK23-NEXT:    [[TMP11:%.*]] = load i32, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP40]]
// CHECK23-NEXT:    [[ADD5:%.*]] = add nsw i32 [[TMP11]], 1
// CHECK23-NEXT:    store i32 [[ADD5]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP40]]
// CHECK23-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK23:       omp.body.continue:
// CHECK23-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK23:       omp.inner.for.inc:
// CHECK23-NEXT:    [[TMP12:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP40]]
// CHECK23-NEXT:    [[ADD6:%.*]] = add nsw i64 [[TMP12]], 1
// CHECK23-NEXT:    store i64 [[ADD6]], ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP40]]
