...
// CHECK1-NEXT:    [[TMP73:%.*]] = inttoptr i64 [[TMP11]] to ptr
...
// CHECK1-NEXT:    [[TMP76:%.*]] = call i32 @__kmpc_reduce_nowait(ptr @[[GLOB2:[0-9]+]], i32 [[TMP75]], i32 2, i64 24, ptr [[DOTOMP_REDUCTION_RED_LIST]], ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l14.omp_outlined.omp.reduction.reduction_func, ptr @.gomp_critical_user_.reduction.var)
...
// CHECK1-NEXT:    [[TMP79:%.*]] = getelementptr b8, ptr [[ARRAYIDX2]], i64 [[TMP11]]
...
// CHECK1-NEXT:    [[TMP80:%.*]] = load b8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST12]], align 1
// CHECK1-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP80]] to i8
// CHECK1-NEXT:    [[CONV13:%.*]] = sext i8 [[CONV]] to i32
// CHECK1-NEXT:    [[TMP81:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1
// CHECK1-NEXT:    [[CONV14:%.*]] = bytecast exact b8 [[TMP81]] to i8
...
// CHECK1-NEXT:    [[TMP82:%.*]] = bitcast i8 [[CONV17]] to b8
// CHECK1-NEXT:    store b8 [[TMP82]], ptr [[OMP_ARRAYCPY_DESTELEMENTPAST12]], align 1
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE19:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT18]], [[TMP79]]
...
// CHECK1-NEXT:    [[TMP84:%.*]] = atomicrmw add ptr [[TMP0]], i32 [[TMP83]] monotonic, align 4
// CHECK1-NEXT:    [[TMP85:%.*]] = getelementptr b8, ptr [[ARRAYIDX2]], i64 [[TMP11]]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY21:%.*]] = icmp eq ptr [[ARRAYIDX2]], [[TMP85]]
...
// CHECK1-NEXT:    [[TMP86:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
// CHECK1-NEXT:    [[CONV25:%.*]] = bytecast exact b8 [[TMP86]] to i8
...
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP87:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY22]] ], [ [[TMP94:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    [[TMP88:%.*]] = bitcast i8 [[TMP87]] to b8
// CHECK1-NEXT:    store b8 [[TMP88]], ptr [[_TMP27]], align 1
// CHECK1-NEXT:    [[TMP89:%.*]] = load b8, ptr [[_TMP27]], align 1
// CHECK1-NEXT:    [[CONV28:%.*]] = bytecast exact b8 [[TMP89]] to i8
// CHECK1-NEXT:    [[CONV29:%.*]] = sext i8 [[CONV28]] to i32
// CHECK1-NEXT:    [[TMP90:%.*]] = load b8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
// CHECK1-NEXT:    [[CONV30:%.*]] = bytecast exact b8 [[TMP90]] to i8
...
// CHECK1-NEXT:    [[TMP91:%.*]] = bitcast i8 [[CONV33]] to b8
// CHECK1-NEXT:    store b8 [[TMP91]], ptr [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP92:%.*]] = load i8, ptr [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP93:%.*]] = cmpxchg ptr [[OMP_ARRAYCPY_DESTELEMENTPAST24]], i8 [[TMP87]], i8 [[TMP92]] monotonic monotonic, align 1
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE36:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT34]], [[TMP85]]
