...
// CHECK1-NEXT:    [[CONV20:%.*]] = bytecast b8 [[TMP23]] to i8
...
// CHECK1-NEXT:    [[CONV13:%.*]] = bytecast b8 [[TMP22]] to i8
...
// CHECK3-NEXT:    [[CONV20:%.*]] = bytecast b8 [[TMP23]] to i8
...
// CHECK3-NEXT:    [[CONV13:%.*]] = bytecast b8 [[TMP22]] to i8
...
// CHECK5-NEXT:    [[CONV13:%.*]] = bytecast b8 [[TMP22]] to i8
...
// CHECK7-NEXT:    [[CONV13:%.*]] = bytecast b8 [[TMP22]] to i8
...
// CHECK9-NEXT:    [[CONV79:%.*]] = bytecast b8 [[TMP44]] to i8
...
// CHECK9-NEXT:    [[CONV12:%.*]] = bytecast b8 [[TMP15]] to i8
...
// CHECK11-NEXT:    [[CONV79:%.*]] = bytecast b8 [[TMP42]] to i8
...
// CHECK11-NEXT:    [[CONV12:%.*]] = bytecast b8 [[TMP15]] to i8
...
// CHECK13-NEXT:    [[CONV79:%.*]] = bytecast b8 [[TMP44]] to i8
...
// CHECK13-NEXT:    [[CONV12:%.*]] = bytecast b8 [[TMP15]] to i8
...
// CHECK15-NEXT:    [[CONV79:%.*]] = bytecast b8 [[TMP42]] to i8
...
// CHECK15-NEXT:    [[CONV12:%.*]] = bytecast b8 [[TMP15]] to i8
...
// CHECK17-NEXT:    [[CONV20:%.*]] = bytecast b8 [[TMP23]] to i8
...
// CHECK17-NEXT:    [[CONV13:%.*]] = bytecast b8 [[TMP22]] to i8
...
// CHECK19-NEXT:    [[CONV20:%.*]] = bytecast b8 [[TMP23]] to i8
...
// CHECK19-NEXT:    [[CONV13:%.*]] = bytecast b8 [[TMP22]] to i8
...
// CHECK21-NEXT:    [[CONV13:%.*]] = bytecast b8 [[TMP22]] to i8
...
// CHECK23-NEXT:    [[CONV13:%.*]] = bytecast b8 [[TMP22]] to i8
