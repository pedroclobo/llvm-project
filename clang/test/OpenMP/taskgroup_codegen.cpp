...
// CHECK1-NEXT:    call void @__clang_call_terminate(ptr [[TMP4]]) #[[ATTR8:[0-9]+]]
...
// DEBUG1-NEXT:    [[TMP1:%.*]] = bytecast exact b8 2 to i8, !dbg [[DBG14:![0-9]+]]
// DEBUG1-NEXT:    store i8 [[TMP1]], ptr [[A]], align 1, !dbg [[DBG14]]
...
// DEBUG1-NEXT:    [[TMP2:%.*]] = load b8, ptr [[A]], align 1, !dbg [[DBG18:![0-9]+]]
// DEBUG1-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP2]] to i8, !dbg [[DBG18]]
...
// DEBUG1-NEXT:    [[TMP4:%.*]] = extractvalue { ptr, i32 } [[TMP3]], 0, !dbg [[DBG17]]
// DEBUG1-NEXT:    call void @__clang_call_terminate(ptr [[TMP4]]) #[[ATTR8:[0-9]+]], !dbg [[DBG17]]
...
// CHECK2-NEXT:    [[TMP0:%.*]] = bytecast exact b8 2 to i8
// CHECK2-NEXT:    store i8 [[TMP0]], ptr [[A]], align 1
...
// CHECK2-NEXT:    [[TMP1:%.*]] = load b8, ptr [[A]], align 1
// CHECK2-NEXT:    [[CONV:%.*]] = bytecast exact b8 [[TMP1]] to i8
