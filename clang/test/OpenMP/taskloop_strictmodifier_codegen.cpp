...
// CHECK-NEXT:    [[CONV10:%.*]] = sext i8 [[TMP17]] to i32
...
// CHECK-NEXT:    store i64 [[SUB17]], ptr [[TMP23]], align 8, !tbaa [[TBAA15]]
...
// CHECK-SAME: i32 [[TMP0:%.*]], ptr noalias nocapture noundef readonly [[TMP1:%.*]]) #[[ATTR3:[0-9]+]] {
// CHECK-NEXT:  [[ENTRY:.*]]:
// CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP1]], i64 40
// CHECK-NEXT:    [[TMP3:%.*]] = load i64, ptr [[TMP2]], align 8, !tbaa [[TBAA27:![0-9]+]]
// CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP1]], i64 48
// CHECK-NEXT:    [[TMP5:%.*]] = load i64, ptr [[TMP4]], align 8, !tbaa [[TBAA28:![0-9]+]]
...
// CHECK-SAME: i32 noundef [[TMP0:%.*]], ptr noalias nocapture noundef readonly [[TMP1:%.*]]) #[[ATTR4:[0-9]+]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
...
// CHECK-SAME: i32 [[TMP0:%.*]], ptr noalias nocapture noundef readonly [[TMP1:%.*]]) #[[ATTR3]] {
// CHECK-NEXT:  [[ENTRY:.*]]:
// CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP1]], i64 40
// CHECK-NEXT:    [[TMP3:%.*]] = load i64, ptr [[TMP2]], align 8, !tbaa [[TBAA27]]
// CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP1]], i64 48
// CHECK-NEXT:    [[TMP5:%.*]] = load i64, ptr [[TMP4]], align 8, !tbaa [[TBAA28]]
// CHECK-NEXT:    [[SEXT:%.*]] = shl i64 [[TMP3]], 32
// CHECK-NEXT:    [[TMP6:%.*]] = ashr exact i64 [[SEXT]], 32
// CHECK-NEXT:    br label %[[OMP_INNER_FOR_COND_I:.*]]
// CHECK:       [[OMP_INNER_FOR_COND_I]]:
...
// CHECK-SAME: i32 [[TMP0:%.*]], ptr noalias nocapture noundef readonly [[TMP1:%.*]]) #[[ATTR5:[0-9]+]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[TMP1]], align 8, !tbaa [[TBAA20]]
// CHECK-NEXT:    [[TMP3:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP1]], i64 40
// CHECK-NEXT:    [[TMP4:%.*]] = load i64, ptr [[TMP3]], align 8, !tbaa [[TBAA27]]
// CHECK-NEXT:    [[TMP5:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP1]], i64 48
// CHECK-NEXT:    [[TMP6:%.*]] = load i64, ptr [[TMP5]], align 8, !tbaa [[TBAA28]]
// CHECK-NEXT:    tail call void @llvm.experimental.noalias.scope.decl(metadata [[META29:![0-9]+]])
// CHECK-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[TMP2]], align 8, !tbaa [[TBAA32:![0-9]+]], !alias.scope [[META29]]
// CHECK-NEXT:    [[TMP8:%.*]] = load i32, ptr [[TMP7]], align 4, !tbaa [[TBAA3]], !noalias [[META29]]
...
// CHECK-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[TMP9]], align 8, !tbaa [[TBAA34:![0-9]+]], !alias.scope [[META29]]
// CHECK-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[TMP10]], align 8, !tbaa [[TBAA7]], !noalias [[META29]]
...
// CHECK-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[ARRAYIDX_I]], align 8, !tbaa [[TBAA17]], !noalias [[META29]]
// CHECK-NEXT:    [[ARRAYIDX5_I:%.*]] = getelementptr inbounds nuw b8, ptr [[TMP12]], i64 [[IDXPROM_I]]
// CHECK-NEXT:    [[TMP13:%.*]] = load i8, ptr [[ARRAYIDX5_I]], align 1, !tbaa [[TBAA19]], !noalias [[META29]]
// CHECK-NEXT:    [[CONV6_I:%.*]] = sext i8 [[TMP13]] to i32
...
// CHECK-SAME: i32 noundef [[TMP0:%.*]], ptr noalias nocapture noundef readonly [[TMP1:%.*]]) #[[ATTR4]] {
// CHECK-NEXT:  [[ENTRY:.*]]:
// CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP1]], i64 40
// CHECK-NEXT:    [[TMP3:%.*]] = load i64, ptr [[TMP2]], align 8, !tbaa [[TBAA27]]
// CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP1]], i64 48
...
// CHECK-SAME: i32 [[TMP0:%.*]], ptr noalias nocapture noundef readonly [[TMP1:%.*]]) #[[ATTR5]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[TMP1]], align 8, !tbaa [[TBAA20]]
// CHECK-NEXT:    [[TMP3:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP1]], i64 40
// CHECK-NEXT:    [[TMP4:%.*]] = load i64, ptr [[TMP3]], align 8, !tbaa [[TBAA27]]
...
// CHECK-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[TMP7]], align 8, !tbaa [[TBAA42:![0-9]+]], !alias.scope [[META39]]
// CHECK-NEXT:    [[TMP9:%.*]] = load i32, ptr [[TMP8]], align 4, !tbaa [[TBAA3]], !noalias [[META39]]
...
// CHECK: [[TBAA10]] = !{[[META11:![0-9]+]], [[META4]], i64 40}
// CHECK: [[META11]] = !{!"_ZTS24kmp_task_t_with_privates", [[META12:![0-9]+]], i64 0, [[META14:![0-9]+]], i64 40}
// CHECK: [[META12]] = !{!"_ZTS10kmp_task_t", [[META13:![0-9]+]], i64 0, [[META9]], i64 8, [[META4]], i64 16, [[META5]], i64 24, [[META5]], i64 32}
// CHECK: [[META13]] = !{!"p1 void", [[META9]], i64 0}
...
// CHECK: [[META18]] = !{!"p1 omnipotent char", [[META9]], i64 0}
// CHECK: [[TBAA19]] = !{[[META5]], [[META5]], i64 0}
// CHECK: [[TBAA20]] = !{[[META21:![0-9]+]], [[META13]], i64 0}
// CHECK: [[META21]] = !{!"_ZTS24kmp_task_t_with_privates", [[META22:![0-9]+]], i64 0}
// CHECK: [[META22]] = !{!"_ZTS10kmp_task_t", [[META13]], i64 0, [[META9]], i64 8, [[META4]], i64 16, [[META5]], i64 24, [[META5]], i64 32, [[META16]], i64 40, [[META16]], i64 48, [[META16]], i64 56, [[META4]], i64 64, [[META13]], i64 72}
// CHECK: [[TBAA23]] = !{[[META24:![0-9]+]], [[META24]], i64 0}
// CHECK: [[META24]] = !{!"p1 int", [[META9]], i64 0}
// CHECK: [[TBAA25]] = !{[[META26:![0-9]+]], [[META26]], i64 0}
// CHECK: [[META26]] = !{!"p3 omnipotent char", [[META9]], i64 0}
// CHECK: [[TBAA27]] = !{[[META21]], [[META16]], i64 40}
// CHECK: [[TBAA28]] = !{[[META21]], [[META16]], i64 48}
...
// CHECK: [[TBAA32]] = !{[[META33:![0-9]+]], [[META24]], i64 0}
// CHECK: [[META33]] = !{!"_ZTSZ4mainE3$_3", [[META24]], i64 0, [[META26]], i64 8}
// CHECK: [[TBAA34]] = !{[[META33]], [[META26]], i64 8}
// CHECK: [[TBAA35]] = !{[[META36:![0-9]+]], [[META4]], i64 0}
// CHECK: [[META36]] = !{!"_ZTS1S", [[META4]], i64 0}
// CHECK: [[TBAA37]] = !{[[META38:![0-9]+]], [[META38]], i64 0}
// CHECK: [[META38]] = !{!"p1 _ZTS1S", [[META9]], i64 0}
// CHECK: [[META39]] = !{[[META40:![0-9]+]]}
// CHECK: [[META40]] = distinct !{[[META40]], [[META41:![0-9]+]], !".omp_outlined..9: %__context"}
// CHECK: [[META41]] = distinct !{[[META41]], !".omp_outlined..9"}
// CHECK: [[TBAA42]] = !{[[META43:![0-9]+]], [[META24]], i64 8}
// CHECK: [[META43]] = !{!"_ZTSZN1SC1EiEUt_", [[META38]], i64 0, [[META24]], i64 8}
//.
