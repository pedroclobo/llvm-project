...
/// represent the built-in integer types: Byte1Ty, Byte8Ty, Byte16Ty, Byte32Ty
/// and Byte64Ty.
...
public:
  ...
  enum {
    ...
    MAX_BYTE_BITS = (1<<23)   ///< Maximum number of bits that can be specified
      ///< Note that bit width is stored in the Type classes SubclassData field
      ///< which has 24 bits. SelectionDAG type legalization can require a
      ///< power of 2 ByteType, so limit to the largest representable power
      ///< of 2, 8388608.
  };
