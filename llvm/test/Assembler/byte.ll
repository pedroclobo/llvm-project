...
; CHECK: bytecast <2 x b128> %{{.*}} to <2 x i32>
; CHECK: bytecast <2 x b128> %{{.*}} to <2 x float>
; CHECK: bytecast <2 x b128> %{{.*}} to <2 x ptr>
...
define void @vector_bytecasts(<2 x b64> %b1, <2 x b128> %b2, b64 %b3) {
  ...
  %4 = bytecast <2 x b128> %b2 to <2 x i32>
  %5 = bytecast <2 x b128> %b2 to <2 x float>
  %6 = bytecast <2 x b128> %b2 to <2 x ptr>
  %7 = bytecast b64 %b3 to <2 x i32>
  %8 = bytecast b64 %b3 to <1 x ptr>
