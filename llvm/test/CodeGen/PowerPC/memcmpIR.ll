...
entry:
  ...
  ; CHECK-NEXT: [[FREEZE1:%[0-9]+]] = freeze b64 [[LOAD1]]
  ; CHECK-NEXT: [[FREEZE2:%[0-9]+]] = freeze b64 [[LOAD2]]
  ; CHECK-NEXT: [[CAST1:%[0-9]+]] = bytecast b64 [[FREEZE1]] to i64
  ; CHECK-NEXT: [[CAST2:%[0-9]+]] = bytecast b64 [[FREEZE2]] to i64
  ...
  ; CHECK-BE-NEXT: [[FREEZE1:%[0-9]+]] = freeze b64 [[LOAD1]]
  ; CHECK-BE-NEXT: [[FREEZE2:%[0-9]+]] = freeze b64 [[LOAD2]]
  ; CHECK-BE-NEXT: [[CAST1:%[0-9]+]] = bytecast b64 [[FREEZE1]] to i64
  ; CHECK-BE-NEXT: [[CAST2:%[0-9]+]] = bytecast b64 [[FREEZE2]] to i64
...
define signext i32 @test2(ptr nocapture readonly %buffer1, ptr nocapture readonly %buffer2)  {
  ...
  ; CHECK-NEXT: [[FREEZE1:%[0-9]+]] = freeze b32 [[LOAD1]]
  ; CHECK-NEXT: [[FREEZE2:%[0-9]+]] = freeze b32 [[LOAD2]]
  ; CHECK-NEXT: [[CAST1:%[0-9]+]] = bytecast b32 [[FREEZE1]] to i32
  ; CHECK-NEXT: [[CAST2:%[0-9]+]] = bytecast b32 [[FREEZE2]] to i32
  ...
  ; CHECK-BE-NEXT: [[FREEZE1:%[0-9]+]] = freeze b32 [[LOAD1]]
  ; CHECK-BE-NEXT: [[FREEZE2:%[0-9]+]] = freeze b32 [[LOAD2]]
  ; CHECK-BE-NEXT: [[CAST1:%[0-9]+]] = bytecast b32 [[FREEZE1]] to i32
  ; CHECK-BE-NEXT: [[CAST2:%[0-9]+]] = bytecast b32 [[FREEZE2]] to i32
...
define signext i32 @test3(ptr nocapture readonly %buffer1, ptr nocapture readonly %buffer2)  {
  ...
  ; CHECK-NEXT: [[FREEZE1:%[0-9]+]] = freeze b16 [[LOAD1]]
  ; CHECK-NEXT: [[FREEZE2:%[0-9]+]] = freeze b16 [[LOAD2]]
  ; CHECK-NEXT: [[CAST1:%[0-9]+]] = bytecast b16 [[FREEZE1]] to i16
  ; CHECK-NEXT: [[CAST2:%[0-9]+]] = bytecast b16 [[FREEZE2]] to i16
  ...
  ; CHECK-NEXT: [[FREEZE1:%[0-9]+]] = freeze b8 [[LOAD1]]
  ; CHECK-NEXT: [[FREEZE2:%[0-9]+]] = freeze b8 [[LOAD2]]
  ; CHECK-NEXT: [[CAST1:%[0-9]+]] = bytecast b8 [[FREEZE1]] to i8
  ; CHECK-NEXT: [[CAST2:%[0-9]+]] = bytecast b8 [[FREEZE2]] to i8
  ...
  ; CHECK-BE-NEXT: [[FREEZE1:%[0-9]+]] = freeze b16 [[LOAD1]]
  ; CHECK-BE-NEXT: [[FREEZE2:%[0-9]+]] = freeze b16 [[LOAD2]]
  ; CHECK-BE-NEXT: [[CAST1:%[0-9]+]] = bytecast b16 [[FREEZE1]] to i16
  ; CHECK-BE-NEXT: [[CAST2:%[0-9]+]] = bytecast b16 [[FREEZE2]] to i16
  ...
  ; CHECK-BE-NEXT: [[FREEZE1:%[0-9]+]] = freeze b8 [[LOAD1]]
  ; CHECK-BE-NEXT: [[FREEZE2:%[0-9]+]] = freeze b8 [[LOAD2]]
  ; CHECK-BE-NEXT: [[CAST1:%[0-9]+]] = bytecast b8 [[FREEZE1]] to i8
  ; CHECK-BE-NEXT: [[CAST2:%[0-9]+]] = bytecast b8 [[FREEZE2]] to i8
