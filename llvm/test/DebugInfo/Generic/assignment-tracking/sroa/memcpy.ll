...
; CHECK: entry:
; CHECK-NEXT: %To.sroa.0.0.copyload = load b96, ptr @From, align 4,
; CHECK-NEXT: %To.sroa.3.0.copyload = load b32, ptr getelementptr inbounds (i8, ptr @From, i64 12), align 4,
; CHECK-NEXT: %To.sroa.4.0.copyload = load b96, ptr getelementptr inbounds (i8, ptr @From, i64 16), align 4,
; CHECK-NEXT: #dbg_value(b96 %To.sroa.0.0.copyload, ![[TO:[0-9]+]], !DIExpression(DW_OP_LLVM_fragment, 0, 96),
; CHECK-NEXT: #dbg_value(b32 %To.sroa.3.0.copyload, ![[TO]], !DIExpression(DW_OP_LLVM_fragment, 96, 32),
; CHECK-NEXT: #dbg_value(b96 %To.sroa.4.0.copyload, ![[TO]], !DIExpression(DW_OP_LLVM_fragment, 128, 96),
; CHECK-NEXT: %{{.*}} = bytecast b32 %To.sroa.3.0.copyload to i32,
