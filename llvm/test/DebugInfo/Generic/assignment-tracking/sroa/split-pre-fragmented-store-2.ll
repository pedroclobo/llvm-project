...
; CHECK: store b64 %[[v:.*]], ptr %var.sroa.0,{{.*}}!DIAssignID ![[id_3:[0-9]+]]
; CHECK-NEXT: #dbg_assign(b64 %{{.*var\.sroa\.0.*}}, ![[var]], !DIExpression(DW_OP_LLVM_fragment, 32, 32), ![[id_4:[0-9]+]], ptr %var.sroa.0, !DIExpression(),
; #dbg_assign(b64 %[[v]], ![[var]], !DIExpression(DW_OP_LLVM_fragment, 64, 32), ![[id_4]], ptr %var.sroa.0, !DIExpression(),
