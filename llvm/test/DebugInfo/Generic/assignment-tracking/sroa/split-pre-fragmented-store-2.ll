...
; CHECK-NEXT: #dbg_assign(i1 undef, ![[var:[0-9]+]], !DIExpression(DW_OP_LLVM_fragment, 32, 64), ![[id_1]], ptr %var.sroa.0, !DIExpression(), ![[LOC:[0-9]+]])
...
; CHECK: store b64 %[[v:.*]], ptr %var.sroa.0, align 8, !dbg !{{[0-9]+}}, !DIAssignID ![[id_2:[0-9]+]]
; CHECK-NEXT: #dbg_assign(b64 %[[v]], ![[var]], !DIExpression(DW_OP_LLVM_fragment, 32, 32), ![[id_2]], ptr %var.sroa.0, !DIExpression(), ![[LOC]])
; CHECK-NEXT: #dbg_assign(b64 %[[v]], ![[var]], !DIExpression(DW_OP_LLVM_fragment, 64, 32), ![[id_2]], ptr %var.sroa.0, !DIExpression(DW_OP_plus, DW_OP_constu, 4), ![[LOC]])
