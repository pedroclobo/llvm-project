...
; X32-LABEL: @cmp2(
; X32-NEXT:    [[TMP1:%.*]] = load b16, ptr [[X:%.*]], align 1
; X32-NEXT:    [[TMP2:%.*]] = load b16, ptr [[Y:%.*]], align 1
; X32-NEXT:    [[TMP10:%.*]] = freeze b16 [[TMP1]]
; X32-NEXT:    [[TMP11:%.*]] = freeze b16 [[TMP2]]
; X32-NEXT:    [[TMP3:%.*]] = bytecast b16 [[TMP10]] to i16
; X32-NEXT:    [[TMP4:%.*]] = bytecast b16 [[TMP11]] to i16
...
; X32-NEXT:    [[TMP1:%.*]] = load b16, ptr [[X:%.*]], align 2
; X32-NEXT:    [[TMP2:%.*]] = load b16, ptr [[Y:%.*]], align 2
; X32-NEXT:    [[TMP10:%.*]] = freeze b16 [[TMP1]]
; X32-NEXT:    [[TMP11:%.*]] = freeze b16 [[TMP2]]
; X32-NEXT:    [[TMP3:%.*]] = bytecast b16 [[TMP10]] to i16
; X32-NEXT:    [[TMP4:%.*]] = bytecast b16 [[TMP11]] to i16
...
; X32:       loadbb:
; X32-NEXT:    [[TMP3:%.*]] = load b16, ptr [[X:%.*]], align 1
; X32-NEXT:    [[TMP4:%.*]] = load b16, ptr [[Y:%.*]], align 1
; X32-NEXT:    [[TMP19:%.*]] = freeze b16 [[TMP3]]
; X32-NEXT:    [[TMP20:%.*]] = freeze b16 [[TMP4]]
; X32-NEXT:    [[TMP5:%.*]] = bytecast b16 [[TMP19]] to i16
; X32-NEXT:    [[TMP6:%.*]] = bytecast b16 [[TMP20]] to i16
...
; X32:       loadbb1:
; X32-NEXT:    [[TMP10:%.*]] = getelementptr b8, ptr [[X]], i64 2
; X32-NEXT:    [[TMP11:%.*]] = getelementptr b8, ptr [[Y]], i64 2
; X32-NEXT:    [[TMP17:%.*]] = load b8, ptr [[TMP10]], align 1
; X32-NEXT:    [[TMP18:%.*]] = load b8, ptr [[TMP11]], align 1
; X32-NEXT:    [[TMP21:%.*]] = freeze b8 [[TMP17]]
; X32-NEXT:    [[TMP22:%.*]] = freeze b8 [[TMP18]]
; X32-NEXT:    [[TMP12:%.*]] = bytecast b8 [[TMP21]] to i8
; X32-NEXT:    [[TMP13:%.*]] = bytecast b8 [[TMP22]] to i8
...
; X32-LABEL: @cmp4(
; X32-NEXT:    [[TMP1:%.*]] = load b32, ptr [[X:%.*]], align 1
; X32-NEXT:    [[TMP2:%.*]] = load b32, ptr [[Y:%.*]], align 1
; X32-NEXT:    [[TMP7:%.*]] = freeze b32 [[TMP1]]
; X32-NEXT:    [[TMP8:%.*]] = freeze b32 [[TMP2]]
; X32-NEXT:    [[TMP3:%.*]] = bytecast b32 [[TMP7]] to i32
; X32-NEXT:    [[TMP4:%.*]] = bytecast b32 [[TMP8]] to i32
...
; X32-NEXT:    br label [[ENDBLOCK:%.*]]
; X32:       loadbb:
; X32-NEXT:    [[TMP3:%.*]] = load b32, ptr [[X:%.*]], align 1
; X32-NEXT:    [[TMP4:%.*]] = load b32, ptr [[Y:%.*]], align 1
; X32-NEXT:    [[TMP19:%.*]] = freeze b32 [[TMP3]]
; X32-NEXT:    [[TMP20:%.*]] = freeze b32 [[TMP4]]
; X32-NEXT:    [[TMP5:%.*]] = bytecast b32 [[TMP19]] to i32
; X32-NEXT:    [[TMP6:%.*]] = bytecast b32 [[TMP20]] to i32
...
; X32-NEXT:    br i1 [[TMP9]], label [[LOADBB1:%.*]], label [[RES_BLOCK:%.*]]
; X32:       loadbb1:
; X32-NEXT:    [[TMP10:%.*]] = getelementptr b8, ptr [[X]], i64 4
; X32-NEXT:    [[TMP11:%.*]] = getelementptr b8, ptr [[Y]], i64 4
; X32-NEXT:    [[TMP17:%.*]] = load b8, ptr [[TMP10]], align 1
; X32-NEXT:    [[TMP18:%.*]] = load b8, ptr [[TMP11]], align 1
; X32-NEXT:    [[TMP21:%.*]] = freeze b8 [[TMP17]]
; X32-NEXT:    [[TMP22:%.*]] = freeze b8 [[TMP18]]
...
; X32-NEXT:    [[TMP3:%.*]] = load b32, ptr [[X:%.*]], align 1
; X32-NEXT:    [[TMP4:%.*]] = load b32, ptr [[Y:%.*]], align 1
; X32-NEXT:    [[TMP21:%.*]] = freeze b32 [[TMP3]]
; X32-NEXT:    [[TMP22:%.*]] = freeze b32 [[TMP4]]
; X32-NEXT:    [[TMP5:%.*]] = bytecast b32 [[TMP21]] to i32
; X32-NEXT:    [[TMP6:%.*]] = bytecast b32 [[TMP22]] to i32
; X32-NEXT:    [[TMP7]] = call i32 @llvm.bswap.i32(i32 [[TMP5]])
; X32-NEXT:    [[TMP8]] = call i32 @llvm.bswap.i32(i32 [[TMP6]])
; X32-NEXT:    [[TMP9:%.*]] = icmp eq i32 [[TMP7]], [[TMP8]]
; X32-NEXT:    br i1 [[TMP9]], label [[LOADBB1]], label [[RES_BLOCK:%.*]]
...
; X32-NEXT:    [[TMP10:%.*]] = getelementptr b8, ptr [[X]], i64 4
; X32-NEXT:    [[TMP11:%.*]] = getelementptr b8, ptr [[Y]], i64 4
; X32-NEXT:    [[TMP12:%.*]] = load b16, ptr [[TMP10]], align 1
; X32-NEXT:    [[TMP13:%.*]] = load b16, ptr [[TMP11]], align 1
; X32-NEXT:    [[TMP23:%.*]] = freeze b16 [[TMP12]]
; X32-NEXT:    [[TMP24:%.*]] = freeze b16 [[TMP13]]
; X32-NEXT:    [[TMP14:%.*]] = bytecast b16 [[TMP23]] to i16
; X32-NEXT:    [[TMP15:%.*]] = bytecast b16 [[TMP24]] to i16
...
; X32-NEXT:    br i1 [[TMP9]], label [[LOADBB1]], label [[RES_BLOCK:%.*]]
; X32:       loadbb1:
; X32-NEXT:    [[TMP10:%.*]] = getelementptr b8, ptr [[X]], i64 3
; X32-NEXT:    [[TMP11:%.*]] = getelementptr b8, ptr [[Y]], i64 3
; X32-NEXT:    [[TMP12:%.*]] = load b32, ptr [[TMP10]], align 1
; X32-NEXT:    [[TMP13:%.*]] = load b32, ptr [[TMP11]], align 1
; X32-NEXT:    [[TMP21:%.*]] = freeze b32 [[TMP12]]
; X32-NEXT:    [[TMP22:%.*]] = freeze b32 [[TMP13]]
; X32-NEXT:    [[TMP14:%.*]] = bytecast b32 [[TMP21]] to i32
; X32-NEXT:    [[TMP15:%.*]] = bytecast b32 [[TMP22]] to i32
...
; X32-NEXT:    [[TMP1:%.*]] = load b16, ptr [[X:%.*]], align 1
; X32-NEXT:    [[TMP2:%.*]] = load b16, ptr [[Y:%.*]], align 1
; X32-NEXT:    [[TMP7:%.*]] = freeze b16 [[TMP1]]
; X32-NEXT:    [[TMP8:%.*]] = freeze b16 [[TMP2]]
; X32-NEXT:    [[TMP3:%.*]] = bytecast b16 [[TMP7]] to i16
; X32-NEXT:    [[TMP4:%.*]] = bytecast b16 [[TMP8]] to i16
...
; X32-NEXT:    [[TMP1:%.*]] = load b16, ptr [[X:%.*]], align 1
; X32-NEXT:    [[TMP2:%.*]] = load b16, ptr [[Y:%.*]], align 1
; X32-NEXT:    [[TMP18:%.*]] = freeze b16 [[TMP1]]
; X32-NEXT:    [[TMP19:%.*]] = freeze b16 [[TMP2]]
; X32-NEXT:    [[TMP3:%.*]] = bytecast b16 [[TMP18]] to i16
; X32-NEXT:    [[TMP4:%.*]] = bytecast b16 [[TMP19]] to i16
; X32-NEXT:    [[TMP5:%.*]] = xor i16 [[TMP3]], [[TMP4]]
; X32-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 2
; X32-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 2
; X32-NEXT:    [[TMP16:%.*]] = load b8, ptr [[TMP6]], align 1
; X32-NEXT:    [[TMP17:%.*]] = load b8, ptr [[TMP7]], align 1
; X32-NEXT:    [[TMP20:%.*]] = freeze b8 [[TMP16]]
; X32-NEXT:    [[TMP21:%.*]] = freeze b8 [[TMP17]]
; X32-NEXT:    [[TMP8:%.*]] = bytecast b8 [[TMP20]] to i8
; X32-NEXT:    [[TMP9:%.*]] = bytecast b8 [[TMP21]] to i8
...
; X32-NEXT:    [[TMP1:%.*]] = load b32, ptr [[X:%.*]], align 1
; X32-NEXT:    [[TMP2:%.*]] = load b32, ptr [[Y:%.*]], align 1
; X32-NEXT:    [[TMP18:%.*]] = freeze b32 [[TMP1]]
; X32-NEXT:    [[TMP19:%.*]] = freeze b32 [[TMP2]]
; X32-NEXT:    [[TMP3:%.*]] = bytecast b32 [[TMP18]] to i32
; X32-NEXT:    [[TMP4:%.*]] = bytecast b32 [[TMP19]] to i32
; X32-NEXT:    [[TMP5:%.*]] = xor i32 [[TMP3]], [[TMP4]]
; X32-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 4
; X32-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 4
; X32-NEXT:    [[TMP16:%.*]] = load b8, ptr [[TMP6]], align 1
; X32-NEXT:    [[TMP17:%.*]] = load b8, ptr [[TMP7]], align 1
; X32-NEXT:    [[TMP20:%.*]] = freeze b8 [[TMP16]]
; X32-NEXT:    [[TMP21:%.*]] = freeze b8 [[TMP17]]
...
; X32-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 4
; X32-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 4
; X32-NEXT:    [[TMP8:%.*]] = load b16, ptr [[TMP6]], align 1
; X32-NEXT:    [[TMP9:%.*]] = load b16, ptr [[TMP7]], align 1
; X32-NEXT:    [[TMP20:%.*]] = freeze b16 [[TMP8]]
; X32-NEXT:    [[TMP21:%.*]] = freeze b16 [[TMP9]]
; X32-NEXT:    [[TMP10:%.*]] = bytecast b16 [[TMP20]] to i16
; X32-NEXT:    [[TMP11:%.*]] = bytecast b16 [[TMP21]] to i16
...
; X32-NEXT:    [[TMP1:%.*]] = load b32, ptr [[X:%.*]], align 4
; X32-NEXT:    [[TMP2:%.*]] = load b32, ptr [[Y:%.*]], align 4
; X32-NEXT:    [[TMP18:%.*]] = freeze b32 [[TMP1]]
; X32-NEXT:    [[TMP19:%.*]] = freeze b32 [[TMP2]]
; X32-NEXT:    [[TMP3:%.*]] = bytecast b32 [[TMP18]] to i32
; X32-NEXT:    [[TMP4:%.*]] = bytecast b32 [[TMP19]] to i32
...
; X32-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 4
; X32-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 4
; X32-NEXT:    [[TMP8:%.*]] = load b16, ptr [[TMP6]], align 4
; X32-NEXT:    [[TMP9:%.*]] = load b16, ptr [[TMP7]], align 4
; X32-NEXT:    [[TMP20:%.*]] = freeze b16 [[TMP8]]
; X32-NEXT:    [[TMP21:%.*]] = freeze b16 [[TMP9]]
; X32-NEXT:    [[TMP10:%.*]] = bytecast b16 [[TMP20]] to i16
; X32-NEXT:    [[TMP11:%.*]] = bytecast b16 [[TMP21]] to i16
...
; X32-NEXT:    [[TMP1:%.*]] = load b32, ptr [[X:%.*]], align 1
; X32-NEXT:    [[TMP2:%.*]] = load b32, ptr [[Y:%.*]], align 1
; X32-NEXT:    [[TMP16:%.*]] = freeze b32 [[TMP1]]
; X32-NEXT:    [[TMP17:%.*]] = freeze b32 [[TMP2]]
; X32-NEXT:    [[TMP3:%.*]] = bytecast b32 [[TMP16]] to i32
; X32-NEXT:    [[TMP4:%.*]] = bytecast b32 [[TMP17]] to i32
; X32-NEXT:    [[TMP5:%.*]] = xor i32 [[TMP3]], [[TMP4]]
; X32-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 3
; X32-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 3
; X32-NEXT:    [[TMP8:%.*]] = load b32, ptr [[TMP6]], align 1
; X32-NEXT:    [[TMP9:%.*]] = load b32, ptr [[TMP7]], align 1
; X32-NEXT:    [[TMP18:%.*]] = freeze b32 [[TMP8]]
; X32-NEXT:    [[TMP19:%.*]] = freeze b32 [[TMP9]]
; X32-NEXT:    [[TMP10:%.*]] = bytecast b32 [[TMP18]] to i32
; X32-NEXT:    [[TMP11:%.*]] = bytecast b32 [[TMP19]] to i32
; X32-NEXT:    [[TMP12:%.*]] = xor i32 [[TMP10]], [[TMP11]]
; X32-NEXT:    [[TMP13:%.*]] = or i32 [[TMP5]], [[TMP12]]
; X32-NEXT:    [[TMP14:%.*]] = icmp ne i32 [[TMP13]], 0
; X32-NEXT:    [[TMP15:%.*]] = zext i1 [[TMP14]] to i32
