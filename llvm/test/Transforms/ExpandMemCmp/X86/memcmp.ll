...
; X64-LABEL: @cmp2(
; X64-NEXT:    [[TMP1:%.*]] = load b16, ptr [[X:%.*]], align 1
; X64-NEXT:    [[TMP2:%.*]] = load b16, ptr [[Y:%.*]], align 1
; X64-NEXT:    [[TMP10:%.*]] = freeze b16 [[TMP1]]
; X64-NEXT:    [[TMP11:%.*]] = freeze b16 [[TMP2]]
; X64-NEXT:    [[TMP3:%.*]] = bytecast b16 [[TMP10]] to i16
; X64-NEXT:    [[TMP4:%.*]] = bytecast b16 [[TMP11]] to i16
...
; X64-NEXT:    [[TMP1:%.*]] = load b16, ptr [[X:%.*]], align 2
; X64-NEXT:    [[TMP2:%.*]] = load b16, ptr [[Y:%.*]], align 2
; X64-NEXT:    [[TMP10:%.*]] = freeze b16 [[TMP1]]
; X64-NEXT:    [[TMP11:%.*]] = freeze b16 [[TMP2]]
; X64-NEXT:    [[TMP3:%.*]] = bytecast b16 [[TMP10]] to i16
; X64-NEXT:    [[TMP4:%.*]] = bytecast b16 [[TMP11]] to i16
...
; X64:       loadbb:
; X64-NEXT:    [[TMP3:%.*]] = load b16, ptr [[X:%.*]], align 1
; X64-NEXT:    [[TMP4:%.*]] = load b16, ptr [[Y:%.*]], align 1
; X64-NEXT:    [[TMP19:%.*]] = freeze b16 [[TMP3]]
; X64-NEXT:    [[TMP20:%.*]] = freeze b16 [[TMP4]]
; X64-NEXT:    [[TMP5:%.*]] = bytecast b16 [[TMP19]] to i16
; X64-NEXT:    [[TMP6:%.*]] = bytecast b16 [[TMP20]] to i16
...
; X64:       loadbb1:
; X64-NEXT:    [[TMP10:%.*]] = getelementptr b8, ptr [[X]], i64 2
; X64-NEXT:    [[TMP11:%.*]] = getelementptr b8, ptr [[Y]], i64 2
; X64-NEXT:    [[TMP17:%.*]] = load b8, ptr [[TMP10]], align 1
; X64-NEXT:    [[TMP18:%.*]] = load b8, ptr [[TMP11]], align 1
; X64-NEXT:    [[TMP21:%.*]] = freeze b8 [[TMP17]]
; X64-NEXT:    [[TMP22:%.*]] = freeze b8 [[TMP18]]
; X64-NEXT:    [[TMP12:%.*]] = bytecast b8 [[TMP21]] to i8
; X64-NEXT:    [[TMP13:%.*]] = bytecast b8 [[TMP22]] to i8
...
; X64-LABEL: @cmp4(
; X64-NEXT:    [[TMP1:%.*]] = load b32, ptr [[X:%.*]], align 1
; X64-NEXT:    [[TMP2:%.*]] = load b32, ptr [[Y:%.*]], align 1
; X64-NEXT:    [[TMP7:%.*]] = freeze b32 [[TMP1]]
; X64-NEXT:    [[TMP8:%.*]] = freeze b32 [[TMP2]]
; X64-NEXT:    [[TMP3:%.*]] = bytecast b32 [[TMP7]] to i32
; X64-NEXT:    [[TMP4:%.*]] = bytecast b32 [[TMP8]] to i32
...
; X64-NEXT:    br label [[ENDBLOCK:%.*]]
; X64:       loadbb:
; X64-NEXT:    [[TMP3:%.*]] = load b32, ptr [[X:%.*]], align 1
; X64-NEXT:    [[TMP4:%.*]] = load b32, ptr [[Y:%.*]], align 1
; X64-NEXT:    [[TMP19:%.*]] = freeze b32 [[TMP3]]
; X64-NEXT:    [[TMP20:%.*]] = freeze b32 [[TMP4]]
; X64-NEXT:    [[TMP5:%.*]] = bytecast b32 [[TMP19]] to i32
; X64-NEXT:    [[TMP6:%.*]] = bytecast b32 [[TMP20]] to i32
...
; X64-NEXT:    br i1 [[TMP9]], label [[LOADBB1:%.*]], label [[RES_BLOCK:%.*]]
; X64:       loadbb1:
; X64-NEXT:    [[TMP10:%.*]] = getelementptr b8, ptr [[X]], i64 4
; X64-NEXT:    [[TMP11:%.*]] = getelementptr b8, ptr [[Y]], i64 4
; X64-NEXT:    [[TMP17:%.*]] = load b8, ptr [[TMP10]], align 1
; X64-NEXT:    [[TMP18:%.*]] = load b8, ptr [[TMP11]], align 1
; X64-NEXT:    [[TMP21:%.*]] = freeze b8 [[TMP17]]
; X64-NEXT:    [[TMP22:%.*]] = freeze b8 [[TMP18]]
...
; X64-NEXT:    [[TMP3:%.*]] = load b32, ptr [[X:%.*]], align 1
; X64-NEXT:    [[TMP4:%.*]] = load b32, ptr [[Y:%.*]], align 1
; X64-NEXT:    [[TMP21:%.*]] = freeze b32 [[TMP3]]
; X64-NEXT:    [[TMP22:%.*]] = freeze b32 [[TMP4]]
; X64-NEXT:    [[TMP5:%.*]] = bytecast b32 [[TMP21]] to i32
; X64-NEXT:    [[TMP6:%.*]] = bytecast b32 [[TMP22]] to i32
; X64-NEXT:    [[TMP7]] = call i32 @llvm.bswap.i32(i32 [[TMP5]])
; X64-NEXT:    [[TMP8]] = call i32 @llvm.bswap.i32(i32 [[TMP6]])
; X64-NEXT:    [[TMP9:%.*]] = icmp eq i32 [[TMP7]], [[TMP8]]
; X64-NEXT:    br i1 [[TMP9]], label [[LOADBB1]], label [[RES_BLOCK:%.*]]
...
; X64-NEXT:    [[TMP10:%.*]] = getelementptr b8, ptr [[X]], i64 4
; X64-NEXT:    [[TMP11:%.*]] = getelementptr b8, ptr [[Y]], i64 4
; X64-NEXT:    [[TMP12:%.*]] = load b16, ptr [[TMP10]], align 1
; X64-NEXT:    [[TMP13:%.*]] = load b16, ptr [[TMP11]], align 1
; X64-NEXT:    [[TMP23:%.*]] = freeze b16 [[TMP12]]
; X64-NEXT:    [[TMP24:%.*]] = freeze b16 [[TMP13]]
; X64-NEXT:    [[TMP14:%.*]] = bytecast b16 [[TMP23]] to i16
; X64-NEXT:    [[TMP15:%.*]] = bytecast b16 [[TMP24]] to i16
...
; X64-NEXT:    br i1 [[TMP9]], label [[LOADBB1]], label [[RES_BLOCK:%.*]]
; X64:       loadbb1:
; X64-NEXT:    [[TMP10:%.*]] = getelementptr b8, ptr [[X]], i64 3
; X64-NEXT:    [[TMP11:%.*]] = getelementptr b8, ptr [[Y]], i64 3
; X64-NEXT:    [[TMP12:%.*]] = load b32, ptr [[TMP10]], align 1
; X64-NEXT:    [[TMP13:%.*]] = load b32, ptr [[TMP11]], align 1
; X64-NEXT:    [[TMP21:%.*]] = freeze b32 [[TMP12]]
; X64-NEXT:    [[TMP22:%.*]] = freeze b32 [[TMP13]]
; X64-NEXT:    [[TMP14:%.*]] = bytecast b32 [[TMP21]] to i32
; X64-NEXT:    [[TMP15:%.*]] = bytecast b32 [[TMP22]] to i32
...
; X64-NEXT:    [[TMP7:%.*]] = freeze b64 [[TMP1]]
; X64-NEXT:    [[TMP8:%.*]] = freeze b64 [[TMP2]]
; X64-NEXT:    [[TMP3:%.*]] = bytecast b64 [[TMP7]] to i64
; X64-NEXT:    [[TMP4:%.*]] = bytecast b64 [[TMP8]] to i64
...
; X64-NEXT:    br label [[ENDBLOCK:%.*]]
; X64:       loadbb:
; X64-NEXT:    [[TMP3:%.*]] = load b64, ptr [[X:%.*]], align 1
; X64-NEXT:    [[TMP4:%.*]] = load b64, ptr [[Y:%.*]], align 1
; X64-NEXT:    [[TMP19:%.*]] = freeze b64 [[TMP3]]
; X64-NEXT:    [[TMP20:%.*]] = freeze b64 [[TMP4]]
; X64-NEXT:    [[TMP5:%.*]] = bytecast b64 [[TMP19]] to i64
; X64-NEXT:    [[TMP6:%.*]] = bytecast b64 [[TMP20]] to i64
...
; X64-NEXT:    br i1 [[TMP9]], label [[LOADBB1:%.*]], label [[RES_BLOCK:%.*]]
; X64:       loadbb1:
; X64-NEXT:    [[TMP10:%.*]] = getelementptr b8, ptr [[X]], i64 8
; X64-NEXT:    [[TMP11:%.*]] = getelementptr b8, ptr [[Y]], i64 8
; X64-NEXT:    [[TMP17:%.*]] = load b8, ptr [[TMP10]], align 1
; X64-NEXT:    [[TMP18:%.*]] = load b8, ptr [[TMP11]], align 1
; X64-NEXT:    [[TMP21:%.*]] = freeze b8 [[TMP17]]
; X64-NEXT:    [[TMP22:%.*]] = freeze b8 [[TMP18]]
...
; X64-NEXT:    [[TMP3:%.*]] = load b64, ptr [[X:%.*]], align 1
; X64-NEXT:    [[TMP4:%.*]] = load b64, ptr [[Y:%.*]], align 1
; X64-NEXT:    [[TMP21:%.*]] = freeze b64 [[TMP3]]
; X64-NEXT:    [[TMP22:%.*]] = freeze b64 [[TMP4]]
; X64-NEXT:    [[TMP5:%.*]] = bytecast b64 [[TMP21]] to i64
; X64-NEXT:    [[TMP6:%.*]] = bytecast b64 [[TMP22]] to i64
; X64-NEXT:    [[TMP7]] = call i64 @llvm.bswap.i64(i64 [[TMP5]])
; X64-NEXT:    [[TMP8]] = call i64 @llvm.bswap.i64(i64 [[TMP6]])
; X64-NEXT:    [[TMP9:%.*]] = icmp eq i64 [[TMP7]], [[TMP8]]
; X64-NEXT:    br i1 [[TMP9]], label [[LOADBB1]], label [[RES_BLOCK:%.*]]
...
; X64-NEXT:    [[TMP10:%.*]] = getelementptr b8, ptr [[X]], i64 3
; X64-NEXT:    [[TMP11:%.*]] = getelementptr b8, ptr [[Y]], i64 3
; X64-NEXT:    [[TMP12:%.*]] = load b64, ptr [[TMP10]], align 1
; X64-NEXT:    [[TMP13:%.*]] = load b64, ptr [[TMP11]], align 1
; X64-NEXT:    [[TMP21:%.*]] = freeze b64 [[TMP12]]
; X64-NEXT:    [[TMP22:%.*]] = freeze b64 [[TMP13]]
; X64-NEXT:    [[TMP14:%.*]] = bytecast b64 [[TMP21]] to i64
; X64-NEXT:    [[TMP15:%.*]] = bytecast b64 [[TMP22]] to i64
...
; X64-NEXT:    [[TMP12:%.*]] = load b32, ptr [[TMP10]], align 1
; X64-NEXT:    [[TMP13:%.*]] = load b32, ptr [[TMP11]], align 1
; X64-NEXT:    [[TMP23:%.*]] = freeze b32 [[TMP12]]
; X64-NEXT:    [[TMP24:%.*]] = freeze b32 [[TMP13]]
; X64-NEXT:    [[TMP14:%.*]] = bytecast b32 [[TMP23]] to i32
; X64-NEXT:    [[TMP15:%.*]] = bytecast b32 [[TMP24]] to i32
; X64-NEXT:    [[TMP16:%.*]] = call i32 @llvm.bswap.i32(i32 [[TMP14]])
; X64-NEXT:    [[TMP17:%.*]] = call i32 @llvm.bswap.i32(i32 [[TMP15]])
...
; X64-NEXT:    br i1 [[TMP9]], label [[LOADBB1]], label [[RES_BLOCK:%.*]]
; X64:       loadbb1:
; X64-NEXT:    [[TMP10:%.*]] = getelementptr b8, ptr [[X]], i64 5
; X64-NEXT:    [[TMP11:%.*]] = getelementptr b8, ptr [[Y]], i64 5
; X64-NEXT:    [[TMP12:%.*]] = load b64, ptr [[TMP10]], align 1
; X64-NEXT:    [[TMP13:%.*]] = load b64, ptr [[TMP11]], align 1
; X64-NEXT:    [[TMP21:%.*]] = freeze b64 [[TMP12]]
; X64-NEXT:    [[TMP22:%.*]] = freeze b64 [[TMP13]]
...
; X64-NEXT:    br i1 [[TMP9]], label [[LOADBB1]], label [[RES_BLOCK:%.*]]
; X64:       loadbb1:
; X64-NEXT:    [[TMP10:%.*]] = getelementptr b8, ptr [[X]], i64 6
; X64-NEXT:    [[TMP11:%.*]] = getelementptr b8, ptr [[Y]], i64 6
; X64-NEXT:    [[TMP12:%.*]] = load b64, ptr [[TMP10]], align 1
; X64-NEXT:    [[TMP13:%.*]] = load b64, ptr [[TMP11]], align 1
; X64-NEXT:    [[TMP21:%.*]] = freeze b64 [[TMP12]]
; X64-NEXT:    [[TMP22:%.*]] = freeze b64 [[TMP13]]
...
; X64-NEXT:    br i1 [[TMP9]], label [[LOADBB1]], label [[RES_BLOCK:%.*]]
; X64:       loadbb1:
; X64-NEXT:    [[TMP10:%.*]] = getelementptr b8, ptr [[X]], i64 7
; X64-NEXT:    [[TMP11:%.*]] = getelementptr b8, ptr [[Y]], i64 7
; X64-NEXT:    [[TMP12:%.*]] = load b64, ptr [[TMP10]], align 1
; X64-NEXT:    [[TMP13:%.*]] = load b64, ptr [[TMP11]], align 1
; X64-NEXT:    [[TMP21:%.*]] = freeze b64 [[TMP12]]
; X64-NEXT:    [[TMP22:%.*]] = freeze b64 [[TMP13]]
...
; X64-NEXT:    [[TMP1:%.*]] = load b16, ptr [[X:%.*]], align 1
; X64-NEXT:    [[TMP2:%.*]] = load b16, ptr [[Y:%.*]], align 1
; X64-NEXT:    [[TMP7:%.*]] = freeze b16 [[TMP1]]
; X64-NEXT:    [[TMP8:%.*]] = freeze b16 [[TMP2]]
; X64-NEXT:    [[TMP3:%.*]] = bytecast b16 [[TMP7]] to i16
; X64-NEXT:    [[TMP4:%.*]] = bytecast b16 [[TMP8]] to i16
...
; X64_1LD:       loadbb:
; X64_1LD-NEXT:    [[TMP1:%.*]] = load b16, ptr [[X:%.*]], align 1
; X64_1LD-NEXT:    [[TMP2:%.*]] = load b16, ptr [[Y:%.*]], align 1
; X64_1LD-NEXT:    [[TMP14:%.*]] = freeze b16 [[TMP1]]
; X64_1LD-NEXT:    [[TMP15:%.*]] = freeze b16 [[TMP2]]
; X64_1LD-NEXT:    [[TMP3:%.*]] = bytecast b16 [[TMP14]] to i16
; X64_1LD-NEXT:    [[TMP4:%.*]] = bytecast b16 [[TMP15]] to i16
; X64_1LD-NEXT:    [[TMP5:%.*]] = icmp ne i16 [[TMP3]], [[TMP4]]
; X64_1LD-NEXT:    br i1 [[TMP5]], label [[RES_BLOCK:%.*]], label [[LOADBB1:%.*]]
; X64_1LD:       loadbb1:
; X64_1LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 2
; X64_1LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 2
; X64_1LD-NEXT:    [[TMP11:%.*]] = load b8, ptr [[TMP6]], align 1
; X64_1LD-NEXT:    [[TMP12:%.*]] = load b8, ptr [[TMP7]], align 1
; X64_1LD-NEXT:    [[TMP16:%.*]] = freeze b8 [[TMP11]]
; X64_1LD-NEXT:    [[TMP13:%.*]] = freeze b8 [[TMP12]]
; X64_1LD-NEXT:    [[TMP8:%.*]] = bytecast b8 [[TMP16]] to i8
; X64_1LD-NEXT:    [[TMP9:%.*]] = bytecast b8 [[TMP13]] to i8
...
; X64_2LD-NEXT:    [[TMP1:%.*]] = load b16, ptr [[X:%.*]], align 1
; X64_2LD-NEXT:    [[TMP2:%.*]] = load b16, ptr [[Y:%.*]], align 1
; X64_2LD-NEXT:    [[TMP18:%.*]] = freeze b16 [[TMP1]]
; X64_2LD-NEXT:    [[TMP19:%.*]] = freeze b16 [[TMP2]]
; X64_2LD-NEXT:    [[TMP3:%.*]] = bytecast b16 [[TMP18]] to i16
; X64_2LD-NEXT:    [[TMP4:%.*]] = bytecast b16 [[TMP19]] to i16
; X64_2LD-NEXT:    [[TMP5:%.*]] = xor i16 [[TMP3]], [[TMP4]]
; X64_2LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 2
; X64_2LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 2
; X64_2LD-NEXT:    [[TMP16:%.*]] = load b8, ptr [[TMP6]], align 1
; X64_2LD-NEXT:    [[TMP17:%.*]] = load b8, ptr [[TMP7]], align 1
; X64_2LD-NEXT:    [[TMP20:%.*]] = freeze b8 [[TMP16]]
; X64_2LD-NEXT:    [[TMP21:%.*]] = freeze b8 [[TMP17]]
; X64_2LD-NEXT:    [[TMP8:%.*]] = bytecast b8 [[TMP20]] to i8
; X64_2LD-NEXT:    [[TMP9:%.*]] = bytecast b8 [[TMP21]] to i8
...
; X64_1LD-NEXT:    br label [[ENDBLOCK:%.*]]
; X64_1LD:       loadbb:
; X64_1LD-NEXT:    [[TMP1:%.*]] = load b32, ptr [[X:%.*]], align 1
; X64_1LD-NEXT:    [[TMP2:%.*]] = load b32, ptr [[Y:%.*]], align 1
; X64_1LD-NEXT:    [[TMP14:%.*]] = freeze b32 [[TMP1]]
; X64_1LD-NEXT:    [[TMP15:%.*]] = freeze b32 [[TMP2]]
; X64_1LD-NEXT:    [[TMP3:%.*]] = bytecast b32 [[TMP14]] to i32
; X64_1LD-NEXT:    [[TMP4:%.*]] = bytecast b32 [[TMP15]] to i32
; X64_1LD-NEXT:    [[TMP5:%.*]] = icmp ne i32 [[TMP3]], [[TMP4]]
; X64_1LD-NEXT:    br i1 [[TMP5]], label [[RES_BLOCK:%.*]], label [[LOADBB1:%.*]]
; X64_1LD:       loadbb1:
; X64_1LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 4
; X64_1LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 4
; X64_1LD-NEXT:    [[TMP11:%.*]] = load b8, ptr [[TMP6]], align 1
; X64_1LD-NEXT:    [[TMP12:%.*]] = load b8, ptr [[TMP7]], align 1
; X64_1LD-NEXT:    [[TMP16:%.*]] = freeze b8 [[TMP11]]
; X64_1LD-NEXT:    [[TMP13:%.*]] = freeze b8 [[TMP12]]
...
; X64_2LD-NEXT:    [[TMP1:%.*]] = load b32, ptr [[X:%.*]], align 1
; X64_2LD-NEXT:    [[TMP2:%.*]] = load b32, ptr [[Y:%.*]], align 1
; X64_2LD-NEXT:    [[TMP18:%.*]] = freeze b32 [[TMP1]]
; X64_2LD-NEXT:    [[TMP19:%.*]] = freeze b32 [[TMP2]]
; X64_2LD-NEXT:    [[TMP3:%.*]] = bytecast b32 [[TMP18]] to i32
; X64_2LD-NEXT:    [[TMP4:%.*]] = bytecast b32 [[TMP19]] to i32
; X64_2LD-NEXT:    [[TMP5:%.*]] = xor i32 [[TMP3]], [[TMP4]]
; X64_2LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 4
; X64_2LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 4
; X64_2LD-NEXT:    [[TMP16:%.*]] = load b8, ptr [[TMP6]], align 1
; X64_2LD-NEXT:    [[TMP17:%.*]] = load b8, ptr [[TMP7]], align 1
; X64_2LD-NEXT:    [[TMP20:%.*]] = freeze b8 [[TMP16]]
; X64_2LD-NEXT:    [[TMP21:%.*]] = freeze b8 [[TMP17]]
...
; X64_1LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 4
; X64_1LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 4
; X64_1LD-NEXT:    [[TMP8:%.*]] = load b16, ptr [[TMP6]], align 1
; X64_1LD-NEXT:    [[TMP9:%.*]] = load b16, ptr [[TMP7]], align 1
; X64_1LD-NEXT:    [[TMP16:%.*]] = freeze b16 [[TMP8]]
; X64_1LD-NEXT:    [[TMP13:%.*]] = freeze b16 [[TMP9]]
; X64_1LD-NEXT:    [[TMP10:%.*]] = bytecast b16 [[TMP16]] to i16
; X64_1LD-NEXT:    [[TMP11:%.*]] = bytecast b16 [[TMP13]] to i16
...
; X64_2LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 4
; X64_2LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 4
; X64_2LD-NEXT:    [[TMP8:%.*]] = load b16, ptr [[TMP6]], align 1
; X64_2LD-NEXT:    [[TMP9:%.*]] = load b16, ptr [[TMP7]], align 1
; X64_2LD-NEXT:    [[TMP20:%.*]] = freeze b16 [[TMP8]]
; X64_2LD-NEXT:    [[TMP21:%.*]] = freeze b16 [[TMP9]]
; X64_2LD-NEXT:    [[TMP10:%.*]] = bytecast b16 [[TMP20]] to i16
; X64_2LD-NEXT:    [[TMP11:%.*]] = bytecast b16 [[TMP21]] to i16
...
; X64_1LD-NEXT:    br label [[ENDBLOCK:%.*]]
; X64_1LD:       loadbb:
; X64_1LD-NEXT:    [[TMP1:%.*]] = load b32, ptr [[X:%.*]], align 4
; X64_1LD-NEXT:    [[TMP2:%.*]] = load b32, ptr [[Y:%.*]], align 4
; X64_1LD-NEXT:    [[TMP14:%.*]] = freeze b32 [[TMP1]]
; X64_1LD-NEXT:    [[TMP15:%.*]] = freeze b32 [[TMP2]]
; X64_1LD-NEXT:    [[TMP3:%.*]] = bytecast b32 [[TMP14]] to i32
; X64_1LD-NEXT:    [[TMP4:%.*]] = bytecast b32 [[TMP15]] to i32
...
; X64_1LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 4
; X64_1LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 4
; X64_1LD-NEXT:    [[TMP8:%.*]] = load b16, ptr [[TMP6]], align 4
; X64_1LD-NEXT:    [[TMP9:%.*]] = load b16, ptr [[TMP7]], align 4
; X64_1LD-NEXT:    [[TMP16:%.*]] = freeze b16 [[TMP8]]
; X64_1LD-NEXT:    [[TMP13:%.*]] = freeze b16 [[TMP9]]
; X64_1LD-NEXT:    [[TMP10:%.*]] = bytecast b16 [[TMP16]] to i16
; X64_1LD-NEXT:    [[TMP11:%.*]] = bytecast b16 [[TMP13]] to i16
...
; X64_2LD-NEXT:    [[TMP1:%.*]] = load b32, ptr [[X:%.*]], align 4
; X64_2LD-NEXT:    [[TMP2:%.*]] = load b32, ptr [[Y:%.*]], align 4
; X64_2LD-NEXT:    [[TMP18:%.*]] = freeze b32 [[TMP1]]
; X64_2LD-NEXT:    [[TMP19:%.*]] = freeze b32 [[TMP2]]
; X64_2LD-NEXT:    [[TMP3:%.*]] = bytecast b32 [[TMP18]] to i32
; X64_2LD-NEXT:    [[TMP4:%.*]] = bytecast b32 [[TMP19]] to i32
...
; X64_2LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 4
; X64_2LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 4
; X64_2LD-NEXT:    [[TMP8:%.*]] = load b16, ptr [[TMP6]], align 4
; X64_2LD-NEXT:    [[TMP9:%.*]] = load b16, ptr [[TMP7]], align 4
; X64_2LD-NEXT:    [[TMP20:%.*]] = freeze b16 [[TMP8]]
; X64_2LD-NEXT:    [[TMP21:%.*]] = freeze b16 [[TMP9]]
; X64_2LD-NEXT:    [[TMP10:%.*]] = bytecast b16 [[TMP20]] to i16
; X64_2LD-NEXT:    [[TMP11:%.*]] = bytecast b16 [[TMP21]] to i16
...
; X64_1LD-NEXT:    br i1 [[TMP5]], label [[RES_BLOCK:%.*]], label [[LOADBB1:%.*]]
; X64_1LD:       loadbb1:
; X64_1LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 3
; X64_1LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 3
; X64_1LD-NEXT:    [[TMP8:%.*]] = load b32, ptr [[TMP6]], align 1
; X64_1LD-NEXT:    [[TMP9:%.*]] = load b32, ptr [[TMP7]], align 1
; X64_1LD-NEXT:    [[TMP16:%.*]] = freeze b32 [[TMP8]]
; X64_1LD-NEXT:    [[TMP13:%.*]] = freeze b32 [[TMP9]]
; X64_1LD-NEXT:    [[TMP10:%.*]] = bytecast b32 [[TMP16]] to i32
; X64_1LD-NEXT:    [[TMP11:%.*]] = bytecast b32 [[TMP13]] to i32
...
; X64_2LD-NEXT:    [[TMP1:%.*]] = load b32, ptr [[X:%.*]], align 1
; X64_2LD-NEXT:    [[TMP2:%.*]] = load b32, ptr [[Y:%.*]], align 1
; X64_2LD-NEXT:    [[TMP16:%.*]] = freeze b32 [[TMP1]]
; X64_2LD-NEXT:    [[TMP17:%.*]] = freeze b32 [[TMP2]]
; X64_2LD-NEXT:    [[TMP3:%.*]] = bytecast b32 [[TMP16]] to i32
; X64_2LD-NEXT:    [[TMP4:%.*]] = bytecast b32 [[TMP17]] to i32
; X64_2LD-NEXT:    [[TMP5:%.*]] = xor i32 [[TMP3]], [[TMP4]]
; X64_2LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 3
; X64_2LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 3
; X64_2LD-NEXT:    [[TMP8:%.*]] = load b32, ptr [[TMP6]], align 1
; X64_2LD-NEXT:    [[TMP9:%.*]] = load b32, ptr [[TMP7]], align 1
; X64_2LD-NEXT:    [[TMP18:%.*]] = freeze b32 [[TMP8]]
; X64_2LD-NEXT:    [[TMP19:%.*]] = freeze b32 [[TMP9]]
; X64_2LD-NEXT:    [[TMP10:%.*]] = bytecast b32 [[TMP18]] to i32
; X64_2LD-NEXT:    [[TMP11:%.*]] = bytecast b32 [[TMP19]] to i32
; X64_2LD-NEXT:    [[TMP12:%.*]] = xor i32 [[TMP10]], [[TMP11]]
; X64_2LD-NEXT:    [[TMP13:%.*]] = or i32 [[TMP5]], [[TMP12]]
; X64_2LD-NEXT:    [[TMP14:%.*]] = icmp ne i32 [[TMP13]], 0
; X64_2LD-NEXT:    [[TMP15:%.*]] = zext i1 [[TMP14]] to i32
...
; X64_1LD-NEXT:    br label [[ENDBLOCK:%.*]]
; X64_1LD:       loadbb:
; X64_1LD-NEXT:    [[TMP1:%.*]] = load b64, ptr [[X:%.*]], align 1
; X64_1LD-NEXT:    [[TMP2:%.*]] = load b64, ptr [[Y:%.*]], align 1
; X64_1LD-NEXT:    [[TMP14:%.*]] = freeze b64 [[TMP1]]
; X64_1LD-NEXT:    [[TMP15:%.*]] = freeze b64 [[TMP2]]
; X64_1LD-NEXT:    [[TMP3:%.*]] = bytecast b64 [[TMP14]] to i64
; X64_1LD-NEXT:    [[TMP4:%.*]] = bytecast b64 [[TMP15]] to i64
; X64_1LD-NEXT:    [[TMP5:%.*]] = icmp ne i64 [[TMP3]], [[TMP4]]
; X64_1LD-NEXT:    br i1 [[TMP5]], label [[RES_BLOCK:%.*]], label [[LOADBB1:%.*]]
; X64_1LD:       loadbb1:
; X64_1LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 8
; X64_1LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 8
; X64_1LD-NEXT:    [[TMP11:%.*]] = load b8, ptr [[TMP6]], align 1
; X64_1LD-NEXT:    [[TMP12:%.*]] = load b8, ptr [[TMP7]], align 1
; X64_1LD-NEXT:    [[TMP16:%.*]] = freeze b8 [[TMP11]]
; X64_1LD-NEXT:    [[TMP13:%.*]] = freeze b8 [[TMP12]]
...
; X64_2LD-NEXT:    [[TMP1:%.*]] = load b64, ptr [[X:%.*]], align 1
; X64_2LD-NEXT:    [[TMP2:%.*]] = load b64, ptr [[Y:%.*]], align 1
; X64_2LD-NEXT:    [[TMP18:%.*]] = freeze b64 [[TMP1]]
; X64_2LD-NEXT:    [[TMP19:%.*]] = freeze b64 [[TMP2]]
; X64_2LD-NEXT:    [[TMP3:%.*]] = bytecast b64 [[TMP18]] to i64
; X64_2LD-NEXT:    [[TMP4:%.*]] = bytecast b64 [[TMP19]] to i64
; X64_2LD-NEXT:    [[TMP5:%.*]] = xor i64 [[TMP3]], [[TMP4]]
; X64_2LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 8
; X64_2LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 8
; X64_2LD-NEXT:    [[TMP16:%.*]] = load b8, ptr [[TMP6]], align 1
; X64_2LD-NEXT:    [[TMP17:%.*]] = load b8, ptr [[TMP7]], align 1
; X64_2LD-NEXT:    [[TMP20:%.*]] = freeze b8 [[TMP16]]
; X64_2LD-NEXT:    [[TMP21:%.*]] = freeze b8 [[TMP17]]
...
; X64_1LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 3
; X64_1LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 3
; X64_1LD-NEXT:    [[TMP8:%.*]] = load b64, ptr [[TMP6]], align 1
; X64_1LD-NEXT:    [[TMP9:%.*]] = load b64, ptr [[TMP7]], align 1
; X64_1LD-NEXT:    [[TMP16:%.*]] = freeze b64 [[TMP8]]
; X64_1LD-NEXT:    [[TMP13:%.*]] = freeze b64 [[TMP9]]
; X64_1LD-NEXT:    [[TMP10:%.*]] = bytecast b64 [[TMP16]] to i64
; X64_1LD-NEXT:    [[TMP11:%.*]] = bytecast b64 [[TMP13]] to i64
...
; X64_2LD-NEXT:    [[TMP1:%.*]] = load b64, ptr [[X:%.*]], align 1
; X64_2LD-NEXT:    [[TMP2:%.*]] = load b64, ptr [[Y:%.*]], align 1
; X64_2LD-NEXT:    [[TMP16:%.*]] = freeze b64 [[TMP1]]
; X64_2LD-NEXT:    [[TMP17:%.*]] = freeze b64 [[TMP2]]
; X64_2LD-NEXT:    [[TMP3:%.*]] = bytecast b64 [[TMP16]] to i64
; X64_2LD-NEXT:    [[TMP4:%.*]] = bytecast b64 [[TMP17]] to i64
; X64_2LD-NEXT:    [[TMP5:%.*]] = xor i64 [[TMP3]], [[TMP4]]
; X64_2LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 3
; X64_2LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 3
; X64_2LD-NEXT:    [[TMP8:%.*]] = load b64, ptr [[TMP6]], align 1
; X64_2LD-NEXT:    [[TMP9:%.*]] = load b64, ptr [[TMP7]], align 1
; X64_2LD-NEXT:    [[TMP18:%.*]] = freeze b64 [[TMP8]]
; X64_2LD-NEXT:    [[TMP19:%.*]] = freeze b64 [[TMP9]]
; X64_2LD-NEXT:    [[TMP10:%.*]] = bytecast b64 [[TMP18]] to i64
; X64_2LD-NEXT:    [[TMP11:%.*]] = bytecast b64 [[TMP19]] to i64
; X64_2LD-NEXT:    [[TMP12:%.*]] = xor i64 [[TMP10]], [[TMP11]]
; X64_2LD-NEXT:    [[TMP13:%.*]] = or i64 [[TMP5]], [[TMP12]]
; X64_2LD-NEXT:    [[TMP14:%.*]] = icmp ne i64 [[TMP13]], 0
; X64_2LD-NEXT:    [[TMP15:%.*]] = zext i1 [[TMP14]] to i32
...
; X64_2LD-NEXT:    [[TMP8:%.*]] = load b32, ptr [[TMP6]], align 1
; X64_2LD-NEXT:    [[TMP9:%.*]] = load b32, ptr [[TMP7]], align 1
; X64_2LD-NEXT:    [[TMP20:%.*]] = freeze b32 [[TMP8]]
; X64_2LD-NEXT:    [[TMP21:%.*]] = freeze b32 [[TMP9]]
; X64_2LD-NEXT:    [[TMP10:%.*]] = bytecast b32 [[TMP20]] to i32
; X64_2LD-NEXT:    [[TMP11:%.*]] = bytecast b32 [[TMP21]] to i32
...
; X64_1LD-NEXT:    br i1 [[TMP5]], label [[RES_BLOCK:%.*]], label [[LOADBB1:%.*]]
; X64_1LD:       loadbb1:
; X64_1LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 5
; X64_1LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 5
; X64_1LD-NEXT:    [[TMP8:%.*]] = load b64, ptr [[TMP6]], align 1
; X64_1LD-NEXT:    [[TMP9:%.*]] = load b64, ptr [[TMP7]], align 1
; X64_1LD-NEXT:    [[TMP16:%.*]] = freeze b64 [[TMP8]]
; X64_1LD-NEXT:    [[TMP13:%.*]] = freeze b64 [[TMP9]]
...
; X64_2LD-NEXT:    [[TMP4:%.*]] = bytecast b64 [[TMP17]] to i64
; X64_2LD-NEXT:    [[TMP5:%.*]] = xor i64 [[TMP3]], [[TMP4]]
; X64_2LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 5
; X64_2LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 5
; X64_2LD-NEXT:    [[TMP8:%.*]] = load b64, ptr [[TMP6]], align 1
; X64_2LD-NEXT:    [[TMP9:%.*]] = load b64, ptr [[TMP7]], align 1
; X64_2LD-NEXT:    [[TMP18:%.*]] = freeze b64 [[TMP8]]
; X64_2LD-NEXT:    [[TMP19:%.*]] = freeze b64 [[TMP9]]
...
; X64_1LD-NEXT:    br i1 [[TMP5]], label [[RES_BLOCK:%.*]], label [[LOADBB1:%.*]]
; X64_1LD:       loadbb1:
; X64_1LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 6
; X64_1LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 6
; X64_1LD-NEXT:    [[TMP8:%.*]] = load b64, ptr [[TMP6]], align 1
; X64_1LD-NEXT:    [[TMP9:%.*]] = load b64, ptr [[TMP7]], align 1
; X64_1LD-NEXT:    [[TMP16:%.*]] = freeze b64 [[TMP8]]
; X64_1LD-NEXT:    [[TMP13:%.*]] = freeze b64 [[TMP9]]
...
; X64_2LD-NEXT:    [[TMP4:%.*]] = bytecast b64 [[TMP17]] to i64
; X64_2LD-NEXT:    [[TMP5:%.*]] = xor i64 [[TMP3]], [[TMP4]]
; X64_2LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 6
; X64_2LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 6
; X64_2LD-NEXT:    [[TMP8:%.*]] = load b64, ptr [[TMP6]], align 1
; X64_2LD-NEXT:    [[TMP9:%.*]] = load b64, ptr [[TMP7]], align 1
; X64_2LD-NEXT:    [[TMP18:%.*]] = freeze b64 [[TMP8]]
; X64_2LD-NEXT:    [[TMP19:%.*]] = freeze b64 [[TMP9]]
...
; X64_1LD-NEXT:    br i1 [[TMP5]], label [[RES_BLOCK:%.*]], label [[LOADBB1:%.*]]
; X64_1LD:       loadbb1:
; X64_1LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 7
; X64_1LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 7
; X64_1LD-NEXT:    [[TMP8:%.*]] = load b64, ptr [[TMP6]], align 1
; X64_1LD-NEXT:    [[TMP9:%.*]] = load b64, ptr [[TMP7]], align 1
; X64_1LD-NEXT:    [[TMP16:%.*]] = freeze b64 [[TMP8]]
; X64_1LD-NEXT:    [[TMP13:%.*]] = freeze b64 [[TMP9]]
...
; X64_2LD-NEXT:    [[TMP4:%.*]] = bytecast b64 [[TMP17]] to i64
; X64_2LD-NEXT:    [[TMP5:%.*]] = xor i64 [[TMP3]], [[TMP4]]
; X64_2LD-NEXT:    [[TMP6:%.*]] = getelementptr b8, ptr [[X]], i64 7
; X64_2LD-NEXT:    [[TMP7:%.*]] = getelementptr b8, ptr [[Y]], i64 7
; X64_2LD-NEXT:    [[TMP8:%.*]] = load b64, ptr [[TMP6]], align 1
; X64_2LD-NEXT:    [[TMP9:%.*]] = load b64, ptr [[TMP7]], align 1
; X64_2LD-NEXT:    [[TMP18:%.*]] = freeze b64 [[TMP8]]
; X64_2LD-NEXT:    [[TMP19:%.*]] = freeze b64 [[TMP9]]
...
; X64-LABEL: @cmp_eq16(
; X64-NEXT:    [[TMP1:%.*]] = load b128, ptr [[X:%.*]], align 1
; X64-NEXT:    [[TMP2:%.*]] = load b128, ptr [[Y:%.*]], align 1
; X64-NEXT:    [[TMP7:%.*]] = freeze b128 [[TMP1]]
; X64-NEXT:    [[TMP8:%.*]] = freeze b128 [[TMP2]]
; X64-NEXT:    [[TMP3:%.*]] = bytecast b128 [[TMP7]] to i128
; X64-NEXT:    [[TMP4:%.*]] = bytecast b128 [[TMP8]] to i128
