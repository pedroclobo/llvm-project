...
; CHECK:       bb1:
; CHECK-NEXT:    [[TMP1:%.*]] = load b64, ptr [[P:%.*]], align 4
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast b64 [[TMP1]] to <2 x b32>
...
; CHECK-NEXT:    [[TMP6:%.*]] = bitcast b64 [[TMP5]] to <2 x b32>
; CHECK-NEXT:    [[TMP7:%.*]] = bytecast exact b64 [[TMP5]] to ptr
; CHECK-NEXT:    [[TMP8:%.*]] = bytecast exact <2 x b32> [[TMP6]] to <2 x i32>
...
define <2 x ptr> @_i64-2ptr-use-both(ptr %p, i1 %cond) {
; CHECK-LABEL: @_i64-2ptr-use-both(
; CHECK-NEXT:    br i1 [[COND:%.*]], label [[BB1:%.*]], label [[BB2:%.*]]
; CHECK:       bb1:
...
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast b128 [[TMP1]] to <2 x b64>
; CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <2 x b64> [[TMP2]] to <2 x ptr>
; CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact b128 [[TMP1]] to i64
...
; CHECK-NEXT:    [[TMP1:%.*]] = load b128, ptr [[P:%.*]], align 4
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast b128 [[TMP1]] to <2 x b64>
; CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact <2 x b64> [[TMP2]] to <2 x double>
; CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact b128 [[TMP1]] to ptr
...
; CHECK-NEXT:    [[TMP6:%.*]] = bitcast b128 [[TMP5]] to <2 x b64>
; CHECK-NEXT:    [[TMP7:%.*]] = bytecast exact <2 x b64> [[TMP6]] to <2 x double>
; CHECK-NEXT:    [[TMP8:%.*]] = bytecast exact b128 [[TMP5]] to ptr
; CHECK-NEXT:    br label [[MERGE]]
; CHECK:       merge:
...
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast b64 [[TMP1]] to <2 x b32>
; CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact b64 [[TMP1]] to ptr
; CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact <2 x b32> [[TMP2]] to <2 x i8>
...
; CHECK-NEXT:    [[TMP1:%.*]] = load b64, ptr [[P:%.*]], align 4
; CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact b64 [[TMP1]] to double
; CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact b64 [[TMP1]] to float
; CHECK-NEXT:    call void @use(double [[TMP2]])
