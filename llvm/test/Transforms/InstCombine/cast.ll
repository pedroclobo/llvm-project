...
define <4 x b8> @test112(<4 x b8> %b) {
; ALL-LABEL: @test112(
...
define <4 x b32> @test113(<4 x b32> %b) {
; ALL-LABEL: @test113(
...
define <2 x i64> @test114(<16 x b8> %b) {
; ALL-LABEL: @test114(
...
define <2 x i64> @test115(<16 x b8> %a) {
; ALL-LABEL: @test115(
; ALL-NEXT:    [[TMP1:%.*]] = bytecast exact <16 x b8> [[B:%.*]] to <2 x i64>
; ALL-NEXT:    ret <2 x i64> [[TMP1]]
;
