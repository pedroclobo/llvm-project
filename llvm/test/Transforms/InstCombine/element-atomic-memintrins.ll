...
; CHECK-NEXT:    store atomic b8 bitcast (i8 1 to b8), ptr [[DEST:%.*]] unordered, align 1
...
; CHECK-NEXT:    store atomic b8 bitcast (i8 1 to b8), ptr [[DEST:%.*]] unordered, align 2
; CHECK-NEXT:    store atomic b16 bitcast (i16 257 to b16), ptr [[DEST]] unordered, align 2
...
; CHECK-NEXT:    store atomic b8 bitcast (i8 1 to b8), ptr [[DEST:%.*]] unordered, align 4
; CHECK-NEXT:    store atomic b16 bitcast (i16 257 to b16), ptr [[DEST]] unordered, align 4
; CHECK-NEXT:    store atomic b32 bitcast (i32 16843009 to b32), ptr [[DEST]] unordered, align 4
...
; CHECK-NEXT:    store atomic b8 bitcast (i8 1 to b8), ptr [[DEST:%.*]] unordered, align 8
; CHECK-NEXT:    store atomic b16 bitcast (i16 257 to b16), ptr [[DEST]] unordered, align 8
; CHECK-NEXT:    store atomic b32 bitcast (i32 16843009 to b32), ptr [[DEST]] unordered, align 8
; CHECK-NEXT:    store atomic b64 bitcast (i64 72340172838076673 to b64), ptr [[DEST]] unordered, align 8
...
; CHECK-NEXT:    store atomic b8 bitcast (i8 1 to b8), ptr [[DEST:%.*]] unordered, align 16
; CHECK-NEXT:    store atomic b16 bitcast (i16 257 to b16), ptr [[DEST]] unordered, align 16
; CHECK-NEXT:    store atomic b32 bitcast (i32 16843009 to b32), ptr [[DEST]] unordered, align 16
; CHECK-NEXT:    store atomic b64 bitcast (i64 72340172838076673 to b64), ptr [[DEST]] unordered, align 16
