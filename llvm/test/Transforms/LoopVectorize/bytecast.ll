...
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr inbounds b32, ptr [[TMP0]], i32 0
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <4 x b32>, ptr [[TMP1]], align 4
; CHECK-NEXT:    [[TMP2:%.*]] = bytecast exact <4 x b32> [[WIDE_LOAD]] to <4 x i32>
; CHECK-NEXT:    [[TMP3:%.*]] = add <4 x i32> [[TMP2]], splat (i32 1)
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds i32, ptr [[TMP0]], i32 0
