...
; CHECK-NEXT:    [[TMP1:%.*]] = shufflevector <4 x float> [[TMP0]], <4 x float> <float 0xFFF8000000000000, float 0xFFF8000000000000, float poison, float poison>, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
