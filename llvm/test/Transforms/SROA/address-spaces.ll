...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p1.i32(ptr align 2 [[AA]], ptr addrspace(1) align 2 [[A:%.*]], i32 16, i1 false)
; CHECK-NEXT:    call void @llvm.memcpy.p1.p0.i32(ptr addrspace(1) align 2 [[B:%.*]], ptr align 2 [[AA]], i32 16, i1 false)
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:  for.end:
; CHECK-NEXT:    [[IN_SROA_2:%.*]] = alloca i64, align 8
...
; CHECK-NEXT:    store i64 [[IN_COERCE_FCA_2_EXTRACT]], ptr [[IN_SROA_2]], align 8
...
; CHECK-NEXT:    [[IN_SROA_2_20_SCEVGEP9_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[IN_SROA_2]], i64 4
; CHECK-NEXT:    call void @llvm.memcpy.p1.p0.i32(ptr addrspace(1) align 4 [[PTR:%.*]], ptr align 4 [[IN_SROA_2_20_SCEVGEP9_SROA_IDX]], i32 4, i1 false)
; CHECK-NEXT:    [[IN_SROA_4_20_PTR_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr addrspace(1) [[PTR]], i16 4
; CHECK-NEXT:    call void @llvm.memcpy.p1.p0.i32(ptr addrspace(1) align 4 [[IN_SROA_4_20_PTR_SROA_IDX]], ptr align 8 [[IN_SROA_4]], i32 8, i1 false)
; CHECK-NEXT:    [[IN_SROA_5_20_PTR_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr addrspace(1) [[PTR]], i16 12
; CHECK-NEXT:    call void @llvm.memcpy.p1.p0.i32(ptr addrspace(1) align 4 [[IN_SROA_5_20_PTR_SROA_IDX]], ptr align 8 [[IN_SROA_5]], i32 4, i1 false)
; CHECK-NEXT:    ret void
;
for.end:
