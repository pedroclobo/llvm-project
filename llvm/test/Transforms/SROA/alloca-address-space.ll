...
; CHECK-NEXT:    store <2 x b64> [[AA_0_COPYLOAD]], ptr addrspace(2) [[AA]], align 16
; CHECK-NEXT:    [[AA_0_COPYLOAD1:%.*]] = load <2 x b64>, ptr addrspace(2) [[AA]], align 16
...
; CHECK-NEXT:    store <2 x b64> [[AA_0_COPYLOAD]], ptr addrspace(2) [[AA]], align 16
; CHECK-NEXT:    [[AA_0_COPYLOAD1:%.*]] = load <2 x b64>, ptr addrspace(2) [[AA]], align 16
; CHECK-NEXT:    store <2 x b64> [[AA_0_COPYLOAD1]], ptr addrspace(2) [[B:%.*]], align 2
; CHECK-NEXT:    ret void
;
  %aa = alloca <2 x i64>, align 16, addrspace(2)
  call void @llvm.memcpy.p2.p1.i32(ptr addrspace(2) align 2 %aa, ptr addrspace(1) align 2 %a, i32 16, i1 false)
...
; CHECK-NEXT:    [[AA:%.*]] = alloca <2 x i64>, align 16, addrspace(2)
; CHECK-NEXT:    [[AA_0_COPYLOAD:%.*]] = load <2 x b64>, ptr addrspace(2) [[A:%.*]], align 2
; CHECK-NEXT:    store <2 x b64> [[AA_0_COPYLOAD]], ptr addrspace(2) [[AA]], align 16
; CHECK-NEXT:    [[AA_0_COPYLOAD1:%.*]] = load <2 x b64>, ptr addrspace(2) [[AA]], align 16
; CHECK-NEXT:    store <2 x b64> [[AA_0_COPYLOAD1]], ptr addrspace(1) [[B:%.*]], align 2
; CHECK-NEXT:    ret void
...
; CHECK-NEXT:    [[IN_SROA_4_20_COPYLOAD:%.*]] = load b64, ptr addrspace(2) [[IN_SROA_4]], align 8
...
; CHECK-NEXT:    [[IN_SROA_5_20_COPYLOAD:%.*]] = load b32, ptr addrspace(2) [[IN_SROA_5]], align 8
