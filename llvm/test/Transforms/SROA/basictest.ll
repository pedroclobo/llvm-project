...
; CHECK-NEXT:    [[A_SROA_2_SROA_4_0_COPYLOAD:%.*]] = load b56, ptr [[A_SROA_2_SROA_4_0_A_SROA_2_0_SRC_SROA_IDX_SROA_IDX]], align 1, !tbaa [[TBAA0]]
...
; CHECK-NEXT:    [[A_SROA_31_SROA_5_0_COPYLOAD:%.*]] = load b56, ptr [[A_SROA_31_SROA_5_0_A_SROA_31_0_SRC_SROA_IDX_SROA_IDX]], align 1, !tbaa [[TBAA0]]
...
; CHECK-NEXT:    [[A_SROA_6_SROA_4_0_COPYLOAD:%.*]] = load b56, ptr [[A_SROA_6_SROA_4_0_A_SROA_6_0_SRC_SROA_IDX_SROA_IDX]], align 1, !tbaa [[TBAA0]]
...
; CHECK-NEXT:    store b56 [[A_SROA_2_SROA_4_0_COPYLOAD]], ptr [[A_SROA_2_SROA_4_0_A_SROA_2_0_DST_SROA_IDX_SROA_IDX]], align 1, !tbaa [[TBAA7]]
...
; CHECK-NEXT:    store b16 [[A_SROA_6_SROA_0_0_COPYLOAD]], ptr [[A_SROA_31_0_DST_SROA_IDX]], align 1, !tbaa [[TBAA7]]
...
; CHECK-NEXT:    store b8 [[A_SROA_6_SROA_3_0_COPYLOAD]], ptr [[A_SROA_31_SROA_4_0_A_SROA_31_0_DST_SROA_IDX_SROA_IDX]], align 1, !tbaa [[TBAA7]]
...
; CHECK-NEXT:    store b56 [[A_SROA_6_SROA_4_0_COPYLOAD]], ptr [[A_SROA_31_SROA_5_0_A_SROA_31_0_DST_SROA_IDX_SROA_IDX]], align 1, !tbaa [[TBAA7]]
...
; CHECK-NEXT:    store b56 [[A_SROA_6_SROA_4_0_COPYLOAD]], ptr [[A_SROA_6_SROA_4_0_A_SROA_6_0_DST_SROA_IDX_SROA_IDX]], align 1, !tbaa [[TBAA7]]
...
; CHECK-NEXT:    [[A_SROA_0_0_A_SROA_0_0_COPYLOAD1:%.*]] = load volatile b32, ptr [[A_SROA_0]], align 4, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    store b24 0, ptr [[DST:%.*]], align 1, !tbaa [[TBAA5]]
; CHECK-NEXT:    ret void
;
entry:
  %a = alloca [3 x i8]
...
; CHECK-LABEL: @test18(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[A_SROA_33_SROA_0:%.*]] = alloca b288, align 8
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 8 [[A_SROA_33_SROA_0]], ptr [[SRC]], i32 [[SIZE:%.*]], i1 false), !tbaa [[TBAA3]]
; CHECK-NEXT:    call void @llvm.memset.p0.i32(ptr align 8 [[A_SROA_33_SROA_0]], i8 42, i32 [[SIZE]], i1 false), !tbaa [[TBAA5]]
; CHECK-NEXT:    store b32 42, ptr [[DST:%.*]], align 1, !tbaa [[TBAA9]]
; CHECK-NEXT:    [[A_SROA_3_0_DST_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 4
; CHECK-NEXT:    store b32 [[A_SROA_3_0_COPYLOAD]], ptr [[A_SROA_3_0_DST_SROA_IDX]], align 1, !tbaa [[TBAA9]]
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr [[DST]], ptr align 8 [[A_SROA_33_SROA_0]], i32 [[SIZE]], i1 false), !tbaa [[TBAA11]]
; CHECK-NEXT:    ret void
;
entry:
  %a = alloca [42 x i8]
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact b64 undef to i64
...
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast i64 [[X_SROA_0_I_0_INSERT_INSERT]] to b64
...
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast i64 [[X_SROA_0_I_2_INSERT_INSERT]] to b64
; CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact b64 [[TMP3]] to i64
; CHECK-NEXT:    [[X_SROA_0_I_4_COPYLOAD:%.*]] = load i32, ptr [[D:%.*]], align 1
; CHECK-NEXT:    [[TMP5:%.*]] = bytecast exact b64 0 to i64
...
; CHECK-NEXT:    [[TMP6:%.*]] = bitcast i64 [[X_SROA_0_I_4_INSERT_INSERT4]] to b64
; CHECK-NEXT:    [[TMP7:%.*]] = bytecast exact b64 [[TMP6]] to i64
...
; CHECK-NEXT:    [[TMP9:%.*]] = bitcast i64 [[X_SROA_0_I_4_INSERT_INSERT]] to b64
; CHECK-NEXT:    [[TMP8:%.*]] = bytecast exact b64 [[TMP9]] to double
...
; CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact b8 [[B_SROA_0_0_B_SROA_0_0_FOO]] to i8
...
; CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact b8 [[B_SROA_1_0_B_SROA_1_2_]] to i8
; CHECK-NEXT:    unreachable
;
entry:
...
; CHECK-NEXT:    [[A_SROA_0_0_A_SROA_0_0_COPYLOAD1:%.*]] = load volatile b64, ptr [[A_SROA_0]], align 16, !tbaa [[TBAA3]]
; CHECK-NEXT:    store volatile b64 [[A_SROA_0_0_A_SROA_0_0_COPYLOAD1]], ptr [[DST:%.*]], align 1, !tbaa [[TBAA3]]
; CHECK-NEXT:    ret void
;
entry:
...
; CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact b64 [[TMPDATA_SROA_0_0_TMPDATA_SROA_0_0_]] to i64
