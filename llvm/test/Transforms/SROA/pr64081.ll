...
; CHECK-NEXT:    [[TMP_SROA_1:%.*]] = alloca b8, align 1
; CHECK-NEXT:    store i7 [[X]], ptr [[TMP_SROA_1]], align 1
; CHECK-NEXT:    store b8 undef, ptr [[RES]], align 1
; CHECK-NEXT:    [[TMP_SROA_1_0_RES_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[RES]], i64 1
; CHECK-NEXT:    [[TMP_SROA_1_0_TMP_SROA_1_0_COPYLOAD:%.*]] = load b8, ptr [[TMP_SROA_1]], align 1
; CHECK-NEXT:    store b8 [[TMP_SROA_1_0_TMP_SROA_1_0_COPYLOAD]], ptr [[TMP_SROA_1_0_RES_SROA_IDX]], align 1
