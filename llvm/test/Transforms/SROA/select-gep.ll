...
; CHECK-NEXT:    [[ALLOCA_SROA_0_0_COPYLOAD:%.*]] = load b32, ptr [[P:%.*]], align 1
; CHECK-NEXT:    [[ALLOCA_SROA_2_0_P_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[P]], i64 4
; CHECK-NEXT:    [[ALLOCA_SROA_2_0_COPYLOAD:%.*]] = load b160, ptr [[ALLOCA_SROA_2_0_P_SROA_IDX]], align 1
; CHECK-NEXT:    [[ALLOCA_SROA_22_0_P_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[P]], i64 24
; CHECK-NEXT:    [[ALLOCA_SROA_22_0_COPYLOAD:%.*]] = load b32, ptr [[ALLOCA_SROA_22_0_P_SROA_IDX]], align 1
; CHECK-NEXT:    [[ALLOCA_SROA_3_0_P_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[P]], i64 28
; CHECK-NEXT:    [[ALLOCA_SROA_3_0_COPYLOAD:%.*]] = load b1056, ptr [[ALLOCA_SROA_3_0_P_SROA_IDX]], align 1
; CHECK-NEXT:    [[IDX:%.*]] = select i1 [[C:%.*]], i64 24, i64 0
; CHECK-NEXT:    [[TMP1:%.*]] = bytecast b32 [[ALLOCA_SROA_22_0_COPYLOAD]] to i32
; CHECK-NEXT:    [[TMP2:%.*]] = bytecast b32 [[ALLOCA_SROA_0_0_COPYLOAD]] to i32
; CHECK-NEXT:    [[RES:%.*]] = select i1 [[C]], i32 [[TMP1]], i32 [[TMP2]]
