...
; CHECK-NEXT:    [[TMP_SROA_2:%.*]] = alloca i32, align 8
; CHECK-NEXT:    [[TMP_SROA_3:%.*]] = alloca [4 x i8], align 4
; CHECK-NEXT:    [[TMP_SROA_0_0_COPYLOAD1:%.*]] = load b64, ptr [[WISHART:%.*]], align 8, !tbaa [[TBAA0:![0-9]+]]
; CHECK-NEXT:    store b64 [[TMP_SROA_0_0_COPYLOAD1]], ptr [[TMP_SROA_0]], align 8, !tbaa [[TBAA0]]
; CHECK-NEXT:    [[TMP_SROA_2_0_WISHART_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[WISHART]], i64 8
; CHECK-NEXT:    [[TMP_SROA_2_0_COPYLOAD1:%.*]] = load b32, ptr [[TMP_SROA_2_0_WISHART_SROA_IDX]], align 8, !tbaa [[TBAA4:![0-9]+]]
; CHECK-NEXT:    store b32 [[TMP_SROA_2_0_COPYLOAD1]], ptr [[TMP_SROA_2]], align 8, !tbaa [[TBAA4]]
...
; CHECK-NEXT:    [[TMP_SROA_0_0_COPYLOAD:%.*]] = load double, ptr [[TMP_SROA_0]], align 8, !tbaa [[TBAA7:![0-9]+]]
; CHECK-NEXT:    [[TMP_SROA_2_0_COPYLOAD:%.*]] = load i32, ptr [[TMP_SROA_2]], align 8, !tbaa [[TBAA9:![0-9]+]]
...
; CHECK: [[TBAA_STRUCT6]] = !{}
; CHECK: [[TBAA7]] = !{[[META8:![0-9]+]], [[META8]], i64 0, i64 0}
; CHECK: [[META8]] = !{!"double", [[META2]]}
; CHECK: [[TBAA9]] = !{[[META10:![0-9]+]], [[META10]], i64 0, i64 0}
; CHECK: [[META10]] = !{!"int", [[META2]]}
;.
