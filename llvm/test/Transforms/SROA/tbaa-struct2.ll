...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[TMP_SROA_0]], ptr align 8 [[WISHART:%.*]], i64 8, i1 false), !tbaa.struct [[TBAA_STRUCT0:![0-9]+]]
; CHECK-NEXT:    [[TMP_SROA_2_0_WISHART_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[WISHART]], i64 8
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[TMP_SROA_2]], ptr align 8 [[TMP_SROA_2_0_WISHART_SROA_IDX]], i64 4, i1 false), !tbaa.struct [[TBAA_STRUCT7:![0-9]+]]
...
; CHECK-NEXT:    [[TMP_SROA_0_0_COPYLOAD:%.*]] = load double, ptr [[TMP_SROA_0]], align 8, !tbaa [[TBAA9:![0-9]+]]
; CHECK-NEXT:    [[TMP_SROA_2_0_COPYLOAD:%.*]] = load i32, ptr [[TMP_SROA_2]], align 8
...
;.
; CHECK: [[TBAA_STRUCT0]] = !{i64 0, i64 8, [[META1:![0-9]+]], i64 8, i64 4, [[META5:![0-9]+]]}
...
; CHECK: [[TBAA_STRUCT7]] = !{i64 0, i64 4, [[META5]]}
; CHECK: [[TBAA_STRUCT8]] = !{}
; CHECK: [[TBAA9]] = !{[[META10:![0-9]+]], [[META10]], i64 0, i64 0}
; CHECK: [[META10]] = !{!"double", [[META3]]}
;.
