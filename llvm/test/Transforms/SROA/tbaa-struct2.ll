...
; CHECK-NEXT:    [[TMP_SROA_0_0_COPYLOAD1:%.*]] = load b64, ptr [[WISHART]], align 8, !tbaa [[DOUBLE_TBAA0:![0-9]+]]
; CHECK-NEXT:    [[TMP_SROA_2_0_WISHART_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[WISHART]], i64 8
; CHECK-NEXT:    [[TMP_SROA_2_0_COPYLOAD1:%.*]] = load b32, ptr [[TMP_SROA_2_0_WISHART_SROA_IDX]], align 8, !tbaa [[INT_TBAA4:![0-9]+]]
; CHECK-NEXT:    [[TMP_SROA_3_0_WISHART_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[WISHART]], i64 12
; CHECK-NEXT:    [[TMP_SROA_3_0_COPYLOAD:%.*]] = load b32, ptr [[TMP_SROA_3_0_WISHART_SROA_IDX]], align 4
; CHECK-NEXT:    [[TMP_SROA_0_0_COPYLOAD:%.*]] = bytecast b64 [[TMP_SROA_0_0_COPYLOAD1]] to double
; CHECK-NEXT:    [[TMP_SROA_2_0_COPYLOAD:%.*]] = bytecast b32 [[TMP_SROA_2_0_COPYLOAD1]] to i32
