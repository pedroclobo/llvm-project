...
; CHECK-NEXT:    store b32 [[TMP0]], ptr [[L_PTR]], align 1, !tbaa [[TBAA0]]
; CHECK-NEXT:    [[TMP_SROA_2_0_L_PTR_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[L_PTR]], i64 4
; CHECK-NEXT:    store b32 [[TMP1]], ptr [[TMP_SROA_2_0_L_PTR_SROA_IDX]], align 1, !tbaa [[TBAA0]]
; CHECK-NEXT:    ret void
;
entry:
  %tmp = alloca { float, float }, align 4
...
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast float [[B]] to b32
; CHECK-NEXT:    [[L_PTR:%.*]] = load ptr, ptr [[RES]], align 8
; CHECK-NEXT:    store b32 [[TMP2]], ptr [[L_PTR]], align 1, !tbaa [[TBAA0]]
; CHECK-NEXT:    [[TMP_SROA_2_0_L_PTR_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[L_PTR]], i64 4
...
; CHECK-NEXT:    store b32 [[TMP1]], ptr [[Y2]], align 8, !tbaa [[TBAA0]]
...
; CHECK-NEXT:    [[TMP_SROA_0_0_TMP_SROA_0_0_LG1:%.*]] = load b64, ptr [[TMP_SROA_0]], align 8, !tbaa [[TBAA5]]
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[A_SROA_0:%.*]] = alloca b32, align 4
; CHECK-NEXT:    store b32 123, ptr [[A_SROA_0]], align 4, !tbaa [[TBAA0]]
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[A_SROA_0:%.*]] = alloca b32, align 4
; CHECK-NEXT:    store b32 123, ptr [[A_SROA_0]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[A_SROA_0_0_A_SROA_0_0_L1:%.*]] = load b32, ptr [[A_SROA_0]], align 4
; CHECK-NEXT:    [[A_SROA_0_0_A_SROA_0_0_L:%.*]] = bytecast exact b32 [[A_SROA_0_0_A_SROA_0_0_L1]] to i32
; CHECK-NEXT:    [[A_SROA_0_0_A_SROA_0_0_COPYLOAD:%.*]] = load volatile b32, ptr [[A_SROA_0]], align 4
; CHECK-NEXT:    store volatile b32 [[A_SROA_0_0_A_SROA_0_0_COPYLOAD]], ptr [[DST]], align 1
...
; CHECK-NEXT:    [[A3_SROA_0_0_A3_SROA_0_0_LOAD4_FCA_0_LOAD1:%.*]] = load b16, ptr [[A3_SROA_0]], align 8, !tbaa [[TBAA5]]
...
; CHECK-NEXT:    [[A3_SROA_33_0_A3_SROA_33_4_LOAD4_FCA_1_LOAD1:%.*]] = load b32, ptr [[A3_SROA_33]], align 4, !tbaa [[TBAA5]]
...
; CHECK-NEXT:    [[A3_SROA_4_0_A3_SROA_4_8_LOAD4_FCA_2_LOAD1:%.*]] = load b8, ptr [[A3_SROA_4]], align 8, !tbaa [[TBAA5]]
