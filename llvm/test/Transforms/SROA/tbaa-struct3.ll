...
; CHECK-SAME: ptr dereferenceable(24) [[RES:%.*]], float [[A:%.*]], float [[B:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = bitcast float [[A]] to b32
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast float [[B]] to b32
; CHECK-NEXT:    [[L_PTR:%.*]] = load ptr, ptr [[RES]], align 8
; CHECK-NEXT:    store b32 [[TMP0]], ptr [[L_PTR]], align 1, !tbaa [[FLOAT_TBAA0]]
; CHECK-NEXT:    [[TMP_SROA_2_0_L_PTR_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[L_PTR]], i64 4
; CHECK-NEXT:    store b32 [[TMP1]], ptr [[TMP_SROA_2_0_L_PTR_SROA_IDX]], align 1, !tbaa [[FLOAT_TBAA0]]
; CHECK-NEXT:    ret void
;
entry:
  %tmp = alloca { float, float }, align 4
...
; CHECK-SAME: ptr dereferenceable(24) [[RES:%.*]], float [[A:%.*]], float [[B:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP_SROA_2:%.*]] = alloca b32, align 4
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast float [[A]] to b32
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast float [[B]] to b32
; CHECK-NEXT:    store b32 [[TMP1]], ptr [[TMP_SROA_2]], align 4
; CHECK-NEXT:    [[L_PTR:%.*]] = load ptr, ptr [[RES]], align 8
; CHECK-NEXT:    store b32 [[TMP2]], ptr [[L_PTR]], align 1, !tbaa [[FLOAT_TBAA0]]
; CHECK-NEXT:    [[TMP_SROA_2_0_L_PTR_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[L_PTR]], i64 4
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 1 [[TMP_SROA_2_0_L_PTR_SROA_IDX]], ptr align 4 [[TMP_SROA_2]], i64 2, i1 false), !tbaa.struct [[TBAA_STRUCT4:![0-9]+]]
; CHECK-NEXT:    ret void
;
entry:
  %tmp = alloca { float, float }, align 4
...
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x float> [[V_1]] to b64
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast float [[F]] to b32
; CHECK-NEXT:    store b64 [[TMP1]], ptr [[Y2]], align 8, !tbaa [[V2F32_TBAA6:![0-9]+]]
; CHECK-NEXT:    [[X7_SROA_2_0_Y2_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[Y2]], i64 8
; CHECK-NEXT:    store b32 [[TMP2]], ptr [[X7_SROA_2_0_Y2_SROA_IDX]], align 8, !tbaa [[FLOAT_TBAA0]]
; CHECK-NEXT:    ret void
;
...
; CHECK-SAME: ptr [[Y2:%.*]], float [[F:%.*]]) {
; CHECK-NEXT:    [[V_1:%.*]] = call <2 x float> @foo(ptr [[Y2]])
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast float [[F]] to b32
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast <2 x float> [[V_1]] to b64
; CHECK-NEXT:    store b32 [[TMP1]], ptr [[Y2]], align 8, !tbaa [[FLOAT_TBAA0]]
; CHECK-NEXT:    [[X7_SROA_2_0_Y2_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[Y2]], i64 4
; CHECK-NEXT:    store b64 [[TMP2]], ptr [[X7_SROA_2_0_Y2_SROA_IDX]], align 4, !tbaa [[V2F32_TBAA6]]
; CHECK-NEXT:    ret void
;
  %x7 = alloca { float, float, float, float }
  %v.1 = call <2 x float> @foo(ptr %y2)
...
; CHECK-NEXT:    [[V_1:%.*]] = call <2 x float> @foo(ptr [[Y2]])
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x float> [[V_1]] to b64
; CHECK-NEXT:    store b64 [[TMP1]], ptr [[Y2]], align 4, !tbaa [[V2F32_TBAA6]]
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[A_SROA_0:%.*]] = alloca b56, align 8
; CHECK-NEXT:    [[A_SROA_3:%.*]] = alloca b16, align 2
; CHECK-NEXT:    [[A_SROA_4:%.*]] = alloca b80, align 8
; CHECK-NEXT:    [[A_SROA_0_0_COPYLOAD:%.*]] = load b56, ptr [[SRC]], align 8
; CHECK-NEXT:    store b56 [[A_SROA_0_0_COPYLOAD]], ptr [[A_SROA_0]], align 8
; CHECK-NEXT:    [[A_SROA_3_0_SRC_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[SRC]], i64 7
; CHECK-NEXT:    [[A_SROA_3_0_COPYLOAD:%.*]] = load b16, ptr [[A_SROA_3_0_SRC_SROA_IDX]], align 1
; CHECK-NEXT:    store b16 [[A_SROA_3_0_COPYLOAD]], ptr [[A_SROA_3]], align 2
; CHECK-NEXT:    [[A_SROA_4_0_SRC_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[SRC]], i64 9
; CHECK-NEXT:    [[A_SROA_4_0_COPYLOAD:%.*]] = load b80, ptr [[A_SROA_4_0_SRC_SROA_IDX]], align 1
; CHECK-NEXT:    store b80 [[A_SROA_4_0_COPYLOAD]], ptr [[A_SROA_4]], align 8
; CHECK-NEXT:    store b16 1, ptr [[A_SROA_3]], align 2
...
; CHECK-NEXT:    store b16 10794, ptr [[A_SROA_3]], align 2, !tbaa [[FLOAT_TBAA0]]
; CHECK-NEXT:    [[A_SROA_0_0_A_SROA_0_0_COPYLOAD1:%.*]] = load volatile b56, ptr [[A_SROA_0]], align 8
; CHECK-NEXT:    store volatile b56 [[A_SROA_0_0_A_SROA_0_0_COPYLOAD1]], ptr [[DST]], align 1
; CHECK-NEXT:    [[A_SROA_3_0_DST_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 7
; CHECK-NEXT:    [[A_SROA_3_0_A_SROA_3_0_COPYLOAD2:%.*]] = load volatile b16, ptr [[A_SROA_3]], align 2
; CHECK-NEXT:    store volatile b16 [[A_SROA_3_0_A_SROA_3_0_COPYLOAD2]], ptr [[A_SROA_3_0_DST_SROA_IDX]], align 1
; CHECK-NEXT:    [[A_SROA_4_0_DST_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 9
; CHECK-NEXT:    [[A_SROA_4_0_A_SROA_4_0_COPYLOAD3:%.*]] = load volatile b80, ptr [[A_SROA_4]], align 8
; CHECK-NEXT:    store volatile b80 [[A_SROA_4_0_A_SROA_4_0_COPYLOAD3]], ptr [[A_SROA_4_0_DST_SROA_IDX]], align 1
; CHECK-NEXT:    ret void
;
entry:
  %a = alloca [19 x i8]
...
; CHECK-NEXT:    call void @llvm.memset.p0.i32(ptr align 1 [[A_SROA_0_202_A_202_SROA_IDX2]], i8 42, i32 7, i1 false), !tbaa [[V2F32_TBAA6]]
; CHECK-NEXT:    store i8 42, ptr [[A_SROA_3]], align 1, !tbaa [[V2F32_TBAA6]]
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[A_SROA_0:%.*]] = alloca b48, align 8
; CHECK-NEXT:    [[A_SROA_2:%.*]] = alloca b32, align 4
; CHECK-NEXT:    [[A_SROA_0_0_COPYLOAD:%.*]] = load b48, ptr [[SRC]], align 8
; CHECK-NEXT:    store b48 [[A_SROA_0_0_COPYLOAD]], ptr [[A_SROA_0]], align 8
; CHECK-NEXT:    [[A_SROA_2_0_SRC_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[SRC]], i64 6
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[A_SROA_2]], ptr align 2 [[A_SROA_2_0_SRC_SROA_IDX]], i32 2, i1 false)
; CHECK-NEXT:    store b32 123, ptr [[A_SROA_2]], align 4
; CHECK-NEXT:    [[A_SROA_2_SROA_0_0_A_SROA_2_SROA_0_0_A_SROA_2_6_V_4:%.*]] = load <2 x i8>, ptr [[A_SROA_2]], align 4
; CHECK-NEXT:    store <2 x i8> [[A_SROA_2_SROA_0_0_A_SROA_2_SROA_0_0_A_SROA_2_6_V_4]], ptr [[DST_2]], align 2
; CHECK-NEXT:    [[A_SROA_0_0_A_SROA_0_0_COPYLOAD1:%.*]] = load volatile b48, ptr [[A_SROA_0]], align 8
; CHECK-NEXT:    store volatile b48 [[A_SROA_0_0_A_SROA_0_0_COPYLOAD1]], ptr [[DST]], align 1
; CHECK-NEXT:    [[A_SROA_2_0_DST_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 6
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 1 [[A_SROA_2_0_DST_SROA_IDX]], ptr align 4 [[A_SROA_2]], i32 2, i1 true)
; CHECK-NEXT:    ret void
;
entry:
  %a = alloca [20 x i8]
...
; CHECK-NEXT:    [[A_SROA_4:%.*]] = alloca b40, align 8
; CHECK-NEXT:    [[A_SROA_0_1_A_1_SROA_IDX1:%.*]] = getelementptr inbounds i8, ptr [[A_SROA_0]], i64 1
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 1 [[A_SROA_0_1_A_1_SROA_IDX1]], ptr align 8 [[SRC]], i32 3, i1 false)
; CHECK-NEXT:    [[A_SROA_4_1_SRC_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[SRC]], i64 3
; CHECK-NEXT:    [[A_SROA_4_1_COPYLOAD:%.*]] = load b40, ptr [[A_SROA_4_1_SRC_SROA_IDX]], align 1
; CHECK-NEXT:    store b40 [[A_SROA_4_1_COPYLOAD]], ptr [[A_SROA_4]], align 8
; CHECK-NEXT:    store b32 123, ptr [[A_SROA_0]], align 4
; CHECK-NEXT:    [[A_SROA_0_1_A_1_SROA_IDX4:%.*]] = getelementptr inbounds i8, ptr [[A_SROA_0]], i64 1
; CHECK-NEXT:    [[A_SROA_0_SROA_1_0_A_SROA_0_SROA_1_1_A_SROA_0_1_V_4:%.*]] = load <2 x i8>, ptr [[A_SROA_0_1_A_1_SROA_IDX4]], align 1
; CHECK-NEXT:    store <2 x i8> [[A_SROA_0_SROA_1_0_A_SROA_0_SROA_1_1_A_SROA_0_1_V_4]], ptr [[DST_2]], align 2
; CHECK-NEXT:    [[A_SROA_0_1_A_1_SROA_IDX2:%.*]] = getelementptr inbounds i8, ptr [[A_SROA_0]], i64 1
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 1 [[DST]], ptr align 1 [[A_SROA_0_1_A_1_SROA_IDX2]], i32 3, i1 true)
; CHECK-NEXT:    [[A_SROA_4_1_DST_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 3
; CHECK-NEXT:    [[A_SROA_4_0_A_SROA_4_1_COPYLOAD3:%.*]] = load volatile b40, ptr [[A_SROA_4]], align 8
; CHECK-NEXT:    store volatile b40 [[A_SROA_4_0_A_SROA_4_1_COPYLOAD3]], ptr [[A_SROA_4_1_DST_SROA_IDX]], align 1
; CHECK-NEXT:    ret void
;
entry:
  %a = alloca [20 x i8]
...
; CHECK-NEXT:    [[TMP_SROA_0:%.*]] = alloca b64, align 8
; CHECK-NEXT:    [[TMP_SROA_3:%.*]] = alloca b64, align 8
; CHECK-NEXT:    [[TMP_SROA_0_0_COPYLOAD:%.*]] = load b64, ptr [[SRC]], align 8
; CHECK-NEXT:    store b64 [[TMP_SROA_0_0_COPYLOAD]], ptr [[TMP_SROA_0]], align 8
...
; CHECK-NEXT:    store b64 [[TMP_SROA_3_0_COPYLOAD]], ptr [[TMP_SROA_3]], align 8
; CHECK-NEXT:    [[TMP_SROA_0_0_TMP_SROA_0_0_LG1:%.*]] = load b64, ptr [[TMP_SROA_0]], align 8, !tbaa [[V2F32_TBAA6]]
; CHECK-NEXT:    [[TMP_SROA_0_0_TMP_SROA_0_0_LG:%.*]] = bytecast b64 [[TMP_SROA_0_0_TMP_SROA_0_0_LG1]] to double
; CHECK-NEXT:    [[TMP_SROA_0_0_TMP_SROA_0_0_COPYLOAD1:%.*]] = load volatile b64, ptr [[TMP_SROA_0]], align 8
; CHECK-NEXT:    store volatile b64 [[TMP_SROA_0_0_TMP_SROA_0_0_COPYLOAD1]], ptr [[DST]], align 8
; CHECK-NEXT:    [[TMP_SROA_3_0_DST_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 8
; CHECK-NEXT:    [[TMP_SROA_3_0_TMP_SROA_3_0_COPYLOAD2:%.*]] = load volatile b64, ptr [[TMP_SROA_3]], align 8
; CHECK-NEXT:    store volatile b64 [[TMP_SROA_3_0_TMP_SROA_3_0_COPYLOAD2]], ptr [[TMP_SROA_3_0_DST_SROA_IDX]], align 8
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[A_SROA_0:%.*]] = alloca b32, align 4
; CHECK-NEXT:    store b32 123, ptr [[A_SROA_0]], align 4, !tbaa [[FLOAT_TBAA0]]
; CHECK-NEXT:    [[A_SROA_0_0_A_SROA_0_0_L1:%.*]] = load b32, ptr [[A_SROA_0]], align 4
; CHECK-NEXT:    [[A_SROA_0_0_A_SROA_0_0_L:%.*]] = bytecast b32 [[A_SROA_0_0_A_SROA_0_0_L1]] to i32
; CHECK-NEXT:    [[A_SROA_0_0_A_SROA_0_0_COPYLOAD:%.*]] = load volatile b32, ptr [[A_SROA_0]], align 4
; CHECK-NEXT:    store volatile b32 [[A_SROA_0_0_A_SROA_0_0_COPYLOAD]], ptr [[DST]], align 1
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[A_SROA_0:%.*]] = alloca b32, align 4
; CHECK-NEXT:    store b32 123, ptr [[A_SROA_0]], align 4, !tbaa [[V2F32_TBAA6]]
; CHECK-NEXT:    [[A_SROA_0_0_A_SROA_0_0_L1:%.*]] = load b32, ptr [[A_SROA_0]], align 4
; CHECK-NEXT:    [[A_SROA_0_0_A_SROA_0_0_L:%.*]] = bytecast b32 [[A_SROA_0_0_A_SROA_0_0_L1]] to i32
; CHECK-NEXT:    [[A_SROA_0_0_A_SROA_0_0_COPYLOAD:%.*]] = load volatile b32, ptr [[A_SROA_0]], align 4
; CHECK-NEXT:    store volatile b32 [[A_SROA_0_0_A_SROA_0_0_COPYLOAD]], ptr [[DST]], align 1
...
; CHECK-SAME: ptr [[DST:%.*]], ptr [[DST_2:%.*]], ptr [[SRC:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[A_SROA_0:%.*]] = alloca b64, align 8
; CHECK-NEXT:    store b64 bitcast (<2 x i32> <i32 1, i32 2> to b64), ptr [[A_SROA_0]], align 8
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[A3_SROA_0:%.*]] = alloca b16, align 8
; CHECK-NEXT:    [[A3_SROA_3:%.*]] = alloca b16, align 2
; CHECK-NEXT:    [[A3_SROA_33:%.*]] = alloca b32, align 4
; CHECK-NEXT:    [[A3_SROA_4:%.*]] = alloca b8, align 8
; CHECK-NEXT:    [[A3_SROA_5:%.*]] = alloca b8, align 1
; CHECK-NEXT:    [[A3_SROA_0_0_COPYLOAD:%.*]] = load b16, ptr [[SRC]], align 1
; CHECK-NEXT:    store b16 [[A3_SROA_0_0_COPYLOAD]], ptr [[A3_SROA_0]], align 8
...
; CHECK-NEXT:    store b16 [[A3_SROA_3_0_COPYLOAD]], ptr [[A3_SROA_3]], align 2
; CHECK-NEXT:    [[A3_SROA_33_0_SRC_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[SRC]], i64 4
; CHECK-NEXT:    [[A3_SROA_33_0_COPYLOAD:%.*]] = load b32, ptr [[A3_SROA_33_0_SRC_SROA_IDX]], align 1
; CHECK-NEXT:    store b32 [[A3_SROA_33_0_COPYLOAD]], ptr [[A3_SROA_33]], align 4
; CHECK-NEXT:    [[A3_SROA_4_0_SRC_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[SRC]], i64 8
; CHECK-NEXT:    [[A3_SROA_4_0_COPYLOAD:%.*]] = load b8, ptr [[A3_SROA_4_0_SRC_SROA_IDX]], align 1
; CHECK-NEXT:    store b8 [[A3_SROA_4_0_COPYLOAD]], ptr [[A3_SROA_4]], align 8
...
; CHECK-NEXT:    store b8 [[A3_SROA_5_0_COPYLOAD]], ptr [[A3_SROA_5]], align 1
; CHECK-NEXT:    [[A3_SROA_0_0_A3_SROA_0_0_LOAD4_FCA_0_LOAD1:%.*]] = load b16, ptr [[A3_SROA_0]], align 8, !tbaa [[V2F32_TBAA6]]
; CHECK-NEXT:    [[A3_SROA_0_0_A3_SROA_0_0_LOAD4_FCA_0_LOAD:%.*]] = bytecast b16 [[A3_SROA_0_0_A3_SROA_0_0_LOAD4_FCA_0_LOAD1]] to i16
; CHECK-NEXT:    [[LOAD4_FCA_0_INSERT:%.*]] = insertvalue { i16, float, i8 } poison, i16 [[A3_SROA_0_0_A3_SROA_0_0_LOAD4_FCA_0_LOAD]], 0
; CHECK-NEXT:    [[A3_SROA_33_0_A3_SROA_33_4_LOAD4_FCA_1_LOAD1:%.*]] = load b32, ptr [[A3_SROA_33]], align 4, !tbaa [[V2F32_TBAA6]]
; CHECK-NEXT:    [[A3_SROA_33_0_A3_SROA_33_4_LOAD4_FCA_1_LOAD:%.*]] = bytecast b32 [[A3_SROA_33_0_A3_SROA_33_4_LOAD4_FCA_1_LOAD1]] to float
...
; CHECK-NEXT:    [[A3_SROA_4_0_A3_SROA_4_8_LOAD4_FCA_2_LOAD1:%.*]] = load b8, ptr [[A3_SROA_4]], align 8, !tbaa [[V2F32_TBAA6]]
; CHECK-NEXT:    [[A3_SROA_4_0_A3_SROA_4_8_LOAD4_FCA_2_LOAD:%.*]] = bytecast b8 [[A3_SROA_4_0_A3_SROA_4_8_LOAD4_FCA_2_LOAD1]] to i8
...
; CHECK-NEXT:    [[A3_SROA_0_0_A3_SROA_0_0_COPYLOAD1:%.*]] = load volatile b16, ptr [[A3_SROA_0]], align 8
; CHECK-NEXT:    store volatile b16 [[A3_SROA_0_0_A3_SROA_0_0_COPYLOAD1]], ptr [[DST]], align 1
; CHECK-NEXT:    [[A3_SROA_3_0_DST_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 2
; CHECK-NEXT:    [[A3_SROA_3_0_A3_SROA_3_0_COPYLOAD2:%.*]] = load volatile b16, ptr [[A3_SROA_3]], align 2
; CHECK-NEXT:    store volatile b16 [[A3_SROA_3_0_A3_SROA_3_0_COPYLOAD2]], ptr [[A3_SROA_3_0_DST_SROA_IDX]], align 1
; CHECK-NEXT:    [[A3_SROA_33_0_DST_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 4
; CHECK-NEXT:    [[A3_SROA_33_0_A3_SROA_33_0_COPYLOAD4:%.*]] = load volatile b32, ptr [[A3_SROA_33]], align 4
; CHECK-NEXT:    store volatile b32 [[A3_SROA_33_0_A3_SROA_33_0_COPYLOAD4]], ptr [[A3_SROA_33_0_DST_SROA_IDX]], align 1
; CHECK-NEXT:    [[A3_SROA_4_0_DST_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 8
; CHECK-NEXT:    [[A3_SROA_4_0_A3_SROA_4_0_COPYLOAD5:%.*]] = load volatile b8, ptr [[A3_SROA_4]], align 8
; CHECK-NEXT:    store volatile b8 [[A3_SROA_4_0_A3_SROA_4_0_COPYLOAD5]], ptr [[A3_SROA_4_0_DST_SROA_IDX]], align 1
; CHECK-NEXT:    [[A3_SROA_5_0_DST_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 9
; CHECK-NEXT:    [[A3_SROA_5_0_A3_SROA_5_0_COPYLOAD6:%.*]] = load volatile b8, ptr [[A3_SROA_5]], align 1
; CHECK-NEXT:    store volatile b8 [[A3_SROA_5_0_A3_SROA_5_0_COPYLOAD6]], ptr [[A3_SROA_5_0_DST_SROA_IDX]], align 1
...
; CHECK-NEXT:    [[TMP0:%.*]] = bitcast i16 [[I_3_FCA_0_EXTRACT]] to b16
; CHECK-NEXT:    store b16 [[TMP0]], ptr [[A3_SROA_0]], align 8, !tbaa [[V2F32_TBAA6]]
; CHECK-NEXT:    [[I_3_FCA_1_EXTRACT:%.*]] = extractvalue { i16, float, i8 } [[I_3]], 1
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast float [[I_3_FCA_1_EXTRACT]] to b32
; CHECK-NEXT:    store b32 [[TMP1]], ptr [[A3_SROA_33]], align 4, !tbaa [[V2F32_TBAA6]]
; CHECK-NEXT:    [[I_3_FCA_2_EXTRACT:%.*]] = extractvalue { i16, float, i8 } [[I_3]], 2
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast i8 [[I_3_FCA_2_EXTRACT]] to b8
; CHECK-NEXT:    store b8 [[TMP2]], ptr [[A3_SROA_4]], align 8, !tbaa [[V2F32_TBAA6]]
; CHECK-NEXT:    [[A3_SROA_0_0_A3_SROA_0_0_COPYLOAD1:%.*]] = load volatile b16, ptr [[A3_SROA_0]], align 8
; CHECK-NEXT:    store volatile b16 [[A3_SROA_0_0_A3_SROA_0_0_COPYLOAD1]], ptr [[DST]], align 1
; CHECK-NEXT:    [[A3_SROA_3_0_DST_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 2
; CHECK-NEXT:    [[A3_SROA_3_0_A3_SROA_3_0_COPYLOAD2:%.*]] = load volatile b16, ptr [[A3_SROA_3]], align 2
...
; CHECK: [[TBAA_STRUCT4]] = !{i64 0, i64 4, [[FLOAT_TBAA0]]}
; CHECK: [[TBAA_STRUCT5]] = !{i64 0, i64 4, [[FLOAT_TBAA0]], i64 4, i64 4, [[FLOAT_TBAA0]]}
; CHECK: [[V2F32_TBAA6]] = !{[[META7:![0-9]+]], [[META7]], i64 0}
