...
>>>>>>> dd4870d6161f ([SROA] Lower `memcpy` to byte load/store)
; CHECK-NEXT:    ret void
;
entry:
  %tmp = alloca { float, float }, align 4
...
>>>>>>> dd4870d6161f ([SROA] Lower `memcpy` to byte load/store)
; CHECK-NEXT:    [[TMP_SROA_2_0_L_PTR_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[L_PTR]], i64 4
; CHECK-NEXT:    [[TMP0:%.*]] = bytecast exact b32 [[TMP1]] to i32
...
; CHECK-NEXT:    [[A_SROA_2_SROA_0:%.*]] = alloca b16, align 4
...
; CHECK-NEXT:    [[A_SROA_2_SROA_0_0_COPYLOAD:%.*]] = load b16, ptr [[A_SROA_2_0_SRC_SROA_IDX]], align 2
; CHECK-NEXT:    store b16 [[A_SROA_2_SROA_0_0_COPYLOAD]], ptr [[A_SROA_2_SROA_0]], align 4
; CHECK-NEXT:    store b16 123, ptr [[A_SROA_2_SROA_0]], align 4
; CHECK-NEXT:    [[A_SROA_2_SROA_0_0_A_SROA_2_SROA_0_0_A_SROA_2_6_V_5:%.*]] = load b16, ptr [[A_SROA_2_SROA_0]], align 4
; CHECK-NEXT:    [[A_SROA_2_SROA_0_0_A_SROA_2_SROA_0_0_A_SROA_2_6_V_4:%.*]] = bytecast exact b16 [[A_SROA_2_SROA_0_0_A_SROA_2_SROA_0_0_A_SROA_2_6_V_5]] to <2 x i8>
...
; CHECK-NEXT:    [[A_SROA_2_SROA_0_0_A_SROA_2_SROA_0_0_COPYLOAD1:%.*]] = load volatile b16, ptr [[A_SROA_2_SROA_0]], align 4
; CHECK-NEXT:    store volatile b16 [[A_SROA_2_SROA_0_0_A_SROA_2_SROA_0_0_COPYLOAD1]], ptr [[A_SROA_2_0_DST_SROA_IDX]], align 1
; CHECK-NEXT:    ret void
;
entry:
  %a = alloca [20 x i8]
...
; CHECK-NEXT:    [[TMP_SROA_0_0_TMP_SROA_0_0_LG1:%.*]] = load b64, ptr [[TMP_SROA_0]], align 8, !tbaa [[V2F32_TBAA5]]
; CHECK-NEXT:    [[TMP_SROA_0_0_TMP_SROA_0_0_LG:%.*]] = bytecast exact b64 [[TMP_SROA_0_0_TMP_SROA_0_0_LG1]] to double
...
; CHECK-NEXT:    [[A_SROA_0_0_A_SROA_0_0_L:%.*]] = bytecast exact b32 [[A_SROA_0_0_A_SROA_0_0_L1]] to i32
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[A_SROA_0:%.*]] = alloca b32, align 4
; CHECK-NEXT:    store b32 123, ptr [[A_SROA_0]], align 4, !tbaa [[V2F32_TBAA5]]
; CHECK-NEXT:    [[A_SROA_0_0_A_SROA_0_0_L1:%.*]] = load b32, ptr [[A_SROA_0]], align 4
; CHECK-NEXT:    [[A_SROA_0_0_A_SROA_0_0_L:%.*]] = bytecast exact b32 [[A_SROA_0_0_A_SROA_0_0_L1]] to i32
; CHECK-NEXT:    [[A_SROA_0_0_A_SROA_0_0_COPYLOAD:%.*]] = load volatile b32, ptr [[A_SROA_0]], align 4
; CHECK-NEXT:    store volatile b32 [[A_SROA_0_0_A_SROA_0_0_COPYLOAD]], ptr [[DST]], align 1
...
; CHECK-NEXT:    [[A3_SROA_0_0_A3_SROA_0_0_LOAD4_FCA_0_LOAD1:%.*]] = load b16, ptr [[A3_SROA_0]], align 8, !tbaa [[V2F32_TBAA5]]
; CHECK-NEXT:    [[A3_SROA_0_0_A3_SROA_0_0_LOAD4_FCA_0_LOAD:%.*]] = bytecast exact b16 [[A3_SROA_0_0_A3_SROA_0_0_LOAD4_FCA_0_LOAD1]] to i16
; CHECK-NEXT:    [[LOAD4_FCA_0_INSERT:%.*]] = insertvalue { i16, float, i8 } poison, i16 [[A3_SROA_0_0_A3_SROA_0_0_LOAD4_FCA_0_LOAD]], 0
; CHECK-NEXT:    [[A3_SROA_33_0_A3_SROA_33_4_LOAD4_FCA_1_LOAD1:%.*]] = load b32, ptr [[A3_SROA_33]], align 4, !tbaa [[V2F32_TBAA5]]
; CHECK-NEXT:    [[A3_SROA_33_0_A3_SROA_33_4_LOAD4_FCA_1_LOAD:%.*]] = bytecast exact b32 [[A3_SROA_33_0_A3_SROA_33_4_LOAD4_FCA_1_LOAD1]] to float
; CHECK-NEXT:    [[LOAD4_FCA_1_INSERT:%.*]] = insertvalue { i16, float, i8 } [[LOAD4_FCA_0_INSERT]], float [[A3_SROA_33_0_A3_SROA_33_4_LOAD4_FCA_1_LOAD]], 1
; CHECK-NEXT:    [[A3_SROA_4_0_A3_SROA_4_8_LOAD4_FCA_2_LOAD1:%.*]] = load b8, ptr [[A3_SROA_4]], align 8, !tbaa [[V2F32_TBAA5]]
; CHECK-NEXT:    [[A3_SROA_4_0_A3_SROA_4_8_LOAD4_FCA_2_LOAD:%.*]] = bytecast exact b8 [[A3_SROA_4_0_A3_SROA_4_8_LOAD4_FCA_2_LOAD1]] to i8
>>>>>>> dd4870d6161f ([SROA] Lower `memcpy` to byte load/store)
...
; CHECK-NEXT:    store b16 [[TMP0]], ptr [[A3_SROA_0]], align 8, !tbaa [[V2F32_TBAA5]]
; CHECK-NEXT:    [[I_3_FCA_1_EXTRACT:%.*]] = extractvalue { i16, float, i8 } [[I_3]], 1
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast float [[I_3_FCA_1_EXTRACT]] to b32
; CHECK-NEXT:    store b32 [[TMP1]], ptr [[A3_SROA_33]], align 4, !tbaa [[V2F32_TBAA5]]
; CHECK-NEXT:    [[I_3_FCA_2_EXTRACT:%.*]] = extractvalue { i16, float, i8 } [[I_3]], 2
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast i8 [[I_3_FCA_2_EXTRACT]] to b8
; CHECK-NEXT:    store b8 [[TMP2]], ptr [[A3_SROA_4]], align 8, !tbaa [[V2F32_TBAA5]]
; CHECK-NEXT:    [[A3_SROA_0_0_A3_SROA_0_0_COPYLOAD1:%.*]] = load volatile b16, ptr [[A3_SROA_0]], align 8
; CHECK-NEXT:    store volatile b16 [[A3_SROA_0_0_A3_SROA_0_0_COPYLOAD1]], ptr [[DST]], align 1
>>>>>>> dd4870d6161f ([SROA] Lower `memcpy` to byte load/store)
; CHECK-NEXT:    [[A3_SROA_3_0_DST_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 2
