...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 1 [[L_PTR]], ptr align 4 [[TMP_SROA_0]], i64 4, i1 false), !tbaa.struct [[TBAA_STRUCT4:![0-9]+]]
; CHECK-NEXT:    [[TMP_SROA_2_0_L_PTR_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[L_PTR]], i64 4
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 1 [[TMP_SROA_2_0_L_PTR_SROA_IDX]], ptr align 4 [[TMP_SROA_2]], i64 4, i1 false), !tbaa.struct [[TBAA_STRUCT5:![0-9]+]]
; CHECK-NEXT:    ret void
;
entry:
  %tmp = alloca { float, float }, align 4
...
; CHECK-NEXT:    store float [[B]], ptr [[TMP_SROA_2]], align 4
; CHECK-NEXT:    [[L_PTR:%.*]] = load ptr, ptr [[RES]], align 8
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 1 [[L_PTR]], ptr align 4 [[TMP_SROA_0]], i64 4, i1 false), !tbaa.struct [[TBAA_STRUCT4]]
; CHECK-NEXT:    [[TMP_SROA_2_0_L_PTR_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[L_PTR]], i64 4
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 1 [[TMP_SROA_2_0_L_PTR_SROA_IDX]], ptr align 4 [[TMP_SROA_2]], i64 2, i1 false), !tbaa.struct [[TBAA_STRUCT5]]
; CHECK-NEXT:    ret void
;
entry:
  %tmp = alloca { float, float }, align 4
...
; CHECK-NEXT:    [[TMP_0_L1:%.*]] = load i62, ptr [[TMP]], align 4, !tbaa.struct [[TBAA_STRUCT4]]
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[Y2]], ptr align 8 [[X7_SROA_0]], i64 8, i1 false), !tbaa.struct [[TBAA_STRUCT6:![0-9]+]]
; CHECK-NEXT:    [[X7_SROA_2_0_Y2_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[Y2]], i64 8
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[X7_SROA_2_0_Y2_SROA_IDX]], ptr align 8 [[X7_SROA_2]], i64 4, i1 false), !tbaa.struct [[TBAA_STRUCT5]]
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[Y2]], ptr align 8 [[X7_SROA_0]], i64 4, i1 false), !tbaa.struct [[TBAA_STRUCT9:![0-9]+]]
; CHECK-NEXT:    [[X7_SROA_2_0_Y2_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[Y2]], i64 4
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[X7_SROA_2_0_Y2_SROA_IDX]], ptr align 8 [[X7_SROA_2]], i64 8, i1 false), !tbaa.struct [[TBAA_STRUCT10:![0-9]+]]
; CHECK-NEXT:    ret void
;
  %x7 = alloca { float, float, float, float }
  %v.1 = call <2 x float> @foo(ptr %y2)
...
; CHECK-NEXT:    [[V_1:%.*]] = call <2 x float> @foo(ptr [[Y2]])
; CHECK-NEXT:    store <2 x float> [[V_1]], ptr [[X7_SROA_0]], align 8
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[Y2]], ptr align 8 [[X7_SROA_0]], i64 8, i1 false), !tbaa.struct [[TBAA_STRUCT11:![0-9]+]]
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 2 [[A_SROA_3]], ptr align 1 [[A_SROA_3_0_SRC_SROA_IDX]], i32 2, i1 false)
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 1 [[A_SROA_3_0_DST_SROA_IDX]], ptr align 2 [[A_SROA_3]], i32 2, i1 true)
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 1 [[A_SROA_3]], ptr align 1 [[A_SROA_3_0_SRC_SROA_IDX]], i32 1, i1 false)
...
; CHECK-NEXT:    call void @llvm.memset.p0.i32(ptr align 1 [[A_SROA_0_202_A_202_SROA_IDX2]], i8 42, i32 7, i1 false), !tbaa [[TBAA7:![0-9]+]]
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 1 [[A_SROA_3_0_DST_SROA_IDX]], ptr align 1 [[A_SROA_3]], i32 1, i1 true)
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[A_SROA_2_SROA_0]], ptr align 2 [[A_SROA_2_0_SRC_SROA_IDX]], i32 2, i1 false)
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 1 [[A_SROA_2_0_DST_SROA_IDX]], ptr align 4 [[A_SROA_2_SROA_0]], i32 2, i1 true)
; CHECK-NEXT:    ret void
;
entry:
  %a = alloca [20 x i8]
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 2 [[A_SROA_0_SROA_1]], ptr align 8 [[SRC]], i32 2, i1 false)
; CHECK-NEXT:    [[A_SROA_0_SROA_4_1_SRC_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[SRC]], i64 2
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 1 [[A_SROA_0_SROA_4]], ptr align 2 [[A_SROA_0_SROA_4_1_SRC_SROA_IDX]], i32 1, i1 false)
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 1 [[DST]], ptr align 2 [[A_SROA_0_SROA_1]], i32 2, i1 true)
; CHECK-NEXT:    [[A_SROA_0_SROA_4_1_DST_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 2
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 1 [[A_SROA_0_SROA_4_1_DST_SROA_IDX]], ptr align 1 [[A_SROA_0_SROA_4]], i32 1, i1 true)
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[TMP_SROA_0]], ptr align 8 [[SRC]], i64 8, i1 false)
; CHECK-NEXT:    [[TMP_SROA_3_0_SRC_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[SRC]], i64 8
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[TMP_SROA_3]], ptr align 8 [[TMP_SROA_3_0_SRC_SROA_IDX]], i64 8, i1 false)
; CHECK-NEXT:    [[TMP_SROA_0_0_TMP_SROA_0_0_LG:%.*]] = load double, ptr [[TMP_SROA_0]], align 8, !tbaa [[TBAA7]]
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[DST]], ptr align 8 [[TMP_SROA_0]], i64 8, i1 true)
; CHECK-NEXT:    [[TMP_SROA_3_0_DST_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 8
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[TMP_SROA_3_0_DST_SROA_IDX]], ptr align 8 [[TMP_SROA_3]], i64 8, i1 true)
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 1 [[DST]], ptr align 4 [[A_SROA_0]], i32 4, i1 true)
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[A3_SROA_0]], ptr align 1 [[SRC]], i64 2, i1 false)
; CHECK-NEXT:    [[A3_SROA_3_0_SRC_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[SRC]], i64 2
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 2 [[A3_SROA_3]], ptr align 1 [[A3_SROA_3_0_SRC_SROA_IDX]], i64 2, i1 false)
; CHECK-NEXT:    [[A3_SROA_33_0_SRC_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[SRC]], i64 4
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[A3_SROA_33]], ptr align 1 [[A3_SROA_33_0_SRC_SROA_IDX]], i64 4, i1 false)
; CHECK-NEXT:    [[A3_SROA_4_0_SRC_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[SRC]], i64 8
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[A3_SROA_4]], ptr align 1 [[A3_SROA_4_0_SRC_SROA_IDX]], i64 1, i1 false)
; CHECK-NEXT:    [[A3_SROA_5_0_SRC_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[SRC]], i64 9
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 1 [[A3_SROA_5]], ptr align 1 [[A3_SROA_5_0_SRC_SROA_IDX]], i64 1, i1 false)
; CHECK-NEXT:    [[A3_SROA_0_0_A3_SROA_0_0_LOAD4_FCA_0_LOAD:%.*]] = load i16, ptr [[A3_SROA_0]], align 8, !tbaa [[TBAA7]]
; CHECK-NEXT:    [[LOAD4_FCA_0_INSERT:%.*]] = insertvalue { i16, float, i8 } poison, i16 [[A3_SROA_0_0_A3_SROA_0_0_LOAD4_FCA_0_LOAD]], 0
; CHECK-NEXT:    [[A3_SROA_33_0_A3_SROA_33_4_LOAD4_FCA_1_LOAD:%.*]] = load float, ptr [[A3_SROA_33]], align 4, !tbaa [[TBAA7]]
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 1 [[DST]], ptr align 8 [[A3_SROA_0]], i64 2, i1 true)
; CHECK-NEXT:    [[A3_SROA_3_0_DST_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 2
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 1 [[A3_SROA_3_0_DST_SROA_IDX]], ptr align 2 [[A3_SROA_3]], i64 2, i1 true)
; CHECK-NEXT:    [[A3_SROA_33_0_DST_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 4
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 1 [[A3_SROA_33_0_DST_SROA_IDX]], ptr align 4 [[A3_SROA_33]], i64 4, i1 true)
; CHECK-NEXT:    [[A3_SROA_4_0_DST_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 8
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 1 [[A3_SROA_4_0_DST_SROA_IDX]], ptr align 8 [[A3_SROA_4]], i64 1, i1 true)
; CHECK-NEXT:    [[A3_SROA_5_0_DST_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 9
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 1 [[A3_SROA_5_0_DST_SROA_IDX]], ptr align 1 [[A3_SROA_5]], i64 1, i1 true)
...
; CHECK-NEXT:    store i16 [[I_3_FCA_0_EXTRACT]], ptr [[A3_SROA_0]], align 8, !tbaa [[TBAA7]]
; CHECK-NEXT:    [[I_3_FCA_1_EXTRACT:%.*]] = extractvalue { i16, float, i8 } [[I_3]], 1
; CHECK-NEXT:    store float [[I_3_FCA_1_EXTRACT]], ptr [[A3_SROA_33]], align 4, !tbaa [[TBAA7]]
...
; CHECK: [[TBAA_STRUCT5]] = !{i64 0, i64 4, [[TBAA0]]}
; CHECK: [[TBAA_STRUCT6]] = !{i64 0, i64 8, [[TBAA7]], i64 8, i64 4, [[TBAA0]]}
; CHECK: [[TBAA7]] = !{[[META8:![0-9]+]], [[META8]], i64 0}
; CHECK: [[META8]] = !{!"v2f32", [[META2]], i64 0}
; CHECK: [[TBAA_STRUCT9]] = !{i64 0, i64 4, [[TBAA0]], i64 4, i64 8, [[TBAA7]]}
; CHECK: [[TBAA_STRUCT10]] = !{i64 0, i64 8, [[TBAA7]]}
; CHECK: [[TBAA_STRUCT11]] = !{i64 0, i64 8, [[TBAA7]], i64 4, i64 8, [[TBAA0]]}
;.
