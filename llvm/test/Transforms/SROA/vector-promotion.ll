...
; CHECK-NEXT:    [[TMP3:%.*]] = bytecast exact b128 [[TMP1]] to i128
; CHECK-NEXT:    [[A_SROA_0_8_EXTRACT_SHIFT:%.*]] = lshr i128 [[TMP3]], 64
; CHECK-NEXT:    [[A_SROA_0_8_VEC_EXTRACT:%.*]] = trunc i128 [[A_SROA_0_8_EXTRACT_SHIFT]] to i32
; CHECK-NEXT:    [[TMP4:%.*]] = bytecast exact b128 [[TMP1]] to i128
; CHECK-NEXT:    [[A_SROA_4_12_EXTRACT_SHIFT:%.*]] = lshr i128 [[TMP4]], 96
; CHECK-NEXT:    [[A_SROA_4_12_VEC_EXTRACT:%.*]] = trunc i128 [[A_SROA_4_12_EXTRACT_SHIFT]] to i32
; CHECK-NEXT:    [[TMP5:%.*]] = bytecast exact b128 [[TMP1]] to i128
; CHECK-NEXT:    [[A_SROA_4_0_VEC_EXTRACT:%.*]] = trunc i128 [[TMP5]] to i32
...
; DEBUG-NEXT:    [[TMP3:%.*]] = bytecast exact b128 [[TMP1]] to i128, !dbg [[DBG155:![0-9]+]]
; DEBUG-NEXT:    [[A_SROA_0_8_EXTRACT_SHIFT:%.*]] = lshr i128 [[TMP3]], 64, !dbg [[DBG155]]
; DEBUG-NEXT:    [[A_SROA_0_8_EXTRACT_TRUNC:%.*]] = trunc i128 [[A_SROA_0_8_EXTRACT_SHIFT]] to i32, !dbg [[DBG155]]
; DEBUG-NEXT:      #dbg_value(i32 [[A_SROA_0_8_EXTRACT_TRUNC]], [[META141:![0-9]+]], !DIExpression(), [[DBG155]])
; DEBUG-NEXT:      #dbg_value(ptr undef, [[META142:![0-9]+]], !DIExpression(), [[META156:![0-9]+]])
; DEBUG-NEXT:    [[TMP4:%.*]] = bytecast exact b128 [[TMP1]] to i128, !dbg [[DBG157:![0-9]+]]
; DEBUG-NEXT:    [[A_SROA_4_12_EXTRACT_SHIFT:%.*]] = lshr i128 [[TMP4]], 96, !dbg [[DBG157]]
; DEBUG-NEXT:    [[A_SROA_4_12_EXTRACT_TRUNC:%.*]] = trunc i128 [[A_SROA_4_12_EXTRACT_SHIFT]] to i32, !dbg [[DBG157]]
; DEBUG-NEXT:      #dbg_value(i32 [[A_SROA_4_12_EXTRACT_TRUNC]], [[META143:![0-9]+]], !DIExpression(), [[DBG157]])
; DEBUG-NEXT:      #dbg_value(ptr undef, [[META144:![0-9]+]], !DIExpression(), [[META158:![0-9]+]])
; DEBUG-NEXT:    [[TMP5:%.*]] = bytecast exact b128 [[TMP1]] to i128, !dbg [[DBG159:![0-9]+]]
; DEBUG-NEXT:    [[A_SROA_4_0_EXTRACT_TRUNC:%.*]] = trunc i128 [[TMP5]] to i32, !dbg [[DBG159]]
; DEBUG-NEXT:      #dbg_value(i32 [[A_SROA_4_0_EXTRACT_TRUNC]], [[META145:![0-9]+]], !DIExpression(), [[DBG159]])
; DEBUG-NEXT:    [[TMP4:%.*]] = add i32 [[A_SROA_0_8_EXTRACT_TRUNC]], [[A_SROA_4_12_EXTRACT_TRUNC]], !dbg [[DBG160:![0-9]+]]
; DEBUG-NEXT:      #dbg_value(i32 [[TMP4]], [[META146:![0-9]+]], !DIExpression(), [[DBG160]])
; DEBUG-NEXT:    [[TMP5:%.*]] = add i32 [[A_SROA_4_0_EXTRACT_TRUNC]], [[TMP4]], !dbg [[DBG161:![0-9]+]]
; DEBUG-NEXT:      #dbg_value(i32 [[TMP5]], [[META147:![0-9]+]], !DIExpression(), [[DBG161]])
; DEBUG-NEXT:    ret i32 [[TMP5]], !dbg [[DBG162:![0-9]+]]
;
entry:
  %a = alloca [2 x <4 x i32>]
